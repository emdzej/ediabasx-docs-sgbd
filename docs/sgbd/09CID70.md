...
| Field | Value |
| --- | --- |
| ECU | Sonder SGBD fuer Hrn. Scholz zum FLASHEN |
| ORIGIN | BMW EI-42 Scholz |
| REVISION | 0.003 |
| AUTHOR | BMW EI-42 Scholz |
| COMMENT | N/A |
| PACKAGE | 1.35 |
| SPRACHE | @sprache@ |
...
- [ADAPT_HELL](#job-adapt-hell) - Anpassung der Helligkeitssteuerung im Kaltstartverhalten KWP2000: $3D WriteMemoryByAddress Modus  : Default
...
<a id="job-adapt-hell"></a>
### ADAPT_HELL

Anpassung der Helligkeitssteuerung im Kaltstartverhalten KWP2000: $3D WriteMemoryByAddress Modus  : Default
