...
- [STATUS_BETR_H_LM](#job-status-betr-h-lm) - KWP2000: $30 InputOutputControlByLocalIdentifier $01 ReportCurrentState $03 Betriebsstunden fuer LM Status von LM-E6X lesen
...
- [STATUS_LAMPEN_DIGITAL](#job-status-lampen-digital) - KWP2000: $30 InputOutputControlByLocalIdentifier $01 ReportCurrentState $09 digitalen Status aller Lampen auslesen Status von LM-E6X lesen
- [STEUERN_LAMPEN_DIGITAL](#job-steuern-lampen-digital) - KWP2000: $30 InputOutputControlByLocalIdentifier $07 ShortTermAdjustment $01 Dimmwert an PWM-Port Status von LM-E6X schreiben
- [STATUS_DIMMWERT](#job-status-dimmwert) - KWP2000: $30 InputOutputControlByLocalIdentifier $01 ReportCurrentState $02 alle Dimmwert an PWM-Ports Status von LM-E6X lesen
- [STEUERN_DIMMWERT](#job-steuern-dimmwert) - KWP2000: $30 InputOutputControlByLocalIdentifier $07 ShortTermAdjustment $01 Dimmwert an PWM-Port Status von LM-E6X schreiben
- [STEUERN_LAMPEN_PWM](#job-steuern-lampen-pwm) - KWP2000: $30 InputOutputControlByLocalIdentifier $07 ShortTermAdjustment $01 Dimmwert an PWM-Port Status von LM-E6X schreiben
- [_STEUERN_TEST_DIMMWERT_LEAR](#job-steuern-test-dimmwert-lear) - KWP2000: $30 InputOutputControlByLocalIdentifier $07 ShortTermAdjustment $01 Dimmwert an PWM-Port Status von LM-E65 schreiben
- [_CODIERDATEN_BLOCK_LESEN_LEAR](#job-codierdaten-block-lesen-lear) - Auslesen eines Blockes der Codierdaten KWP2000: $22 ReadDataByCommonIdentifier $xxxx Codierdaten je nach Block lesen Modus  : Default
- [_CODIERDATEN_BLOCK_SCHREIBEN_LEAR](#job-codierdaten-block-schreiben-lear) - Beschreiben der Codierdaten je nach Block KWP2000: $2E WriteDataByCommonIdentifier $xxxx Codierdaten schreiben Modus  : Codieren je nach Block
- [_CODIERDATEN_3000_LESEN_KOMPLETT_LEAR](#job-codierdaten-3000-lesen-komplett-lear) - Auslesen der kompletten Codierdaten im 3000-Bereich Auslesen der AHL-Codierdaten KWP 2000: $22 ReadDataByCommonIdentifier Modus  : Default
- [_CODIERDATEN_3400_LESEN_KOMPLETT_LEAR](#job-codierdaten-3400-lesen-komplett-lear) - Auslesen der kompletten Codierdaten im 3400-Bereich Auslesen der LM-Codierdaten KWP 2000: $22 ReadDataByCommonIdentifier Modus  : Default
...
- [_CODIERDATEN_3000_SCHREIBEN_AUS_DATEI_LEAR](#job-codierdaten-3000-schreiben-aus-datei-lear) - Beschreiben der Default-Codierdaten Beschreiben der AHL-Codierdaten KWP2000: $2E WriteDataByCommonIdentifier $30xx Codierdaten, Default Modus  : Default
- [_CODIERDATEN_3400_SCHREIBEN_AUS_DATEI_LEAR](#job-codierdaten-3400-schreiben-aus-datei-lear) - Beschreiben der Default-Codierdaten Beschreiben der LM-Codierdaten KWP2000: $2E WriteDataByCommonIdentifier $34xx Codierdaten, Default Modus  : Default
...
- [_CODIERDATEN_KOMPLETT_SCHREIBEN_LEAR](#job-codierdaten-komplett-schreiben-lear) - Beschreiben der Default-Codierdaten KWP2000: $2E WriteDataByCommonIdentifier $30xx Codierdaten ALC schreiben $31xx Code in EEPROM schreiben $34xx Codierdaten LM schreiben Modus  : Default
...
- [_IDENT_SSECUSON](#job-ident-ssecuson) - SystemSupplierECUSoftwareNumber KWP2000: $1A ReadECUIdentification Modus  : SystemSupplierECUSoftwareNumber
...
- [STATUS_SZL_VERBUNDEN](#job-status-szl-verbunden) - Auslesen der Stati von den analogen Eingaengen KWP2000: $30 InputOutputControlByLocalIdentifier $01 ReportCurrentState $07 Analoge Inputs
- [STATUS_ZUSATZ_BLINKER](#job-status-zusatz-blinker) - Senseausgang fuer ausgewaehlte Lampe lesen KWP2000: $30 InputOutputControlByLocalIdentifier $01 ReportCurrentState $0D Senseausgang lesen Modus  : Default
...
- [STATUS_LAMPEN_DEFEKTE](#job-status-lampen-defekte) - KWP2000: $30 InputOutputControlByLocalIdentifier $01 ReportCurrentState $0B Lampenfehler auslesen Status Defektbits (explizit) von LM-E6X lesen
...
- [_AUTHENTISIERUNG_EINFACH_LEAR](#job-authentisierung-einfach-lear) - Authentisierung einfach fuer Development KWP2000: $31 StartRoutineByLocalIdentifier $07 RequestForAuthentication $08 ReleaseAuthentication Modus  : Default
- [STATUS_SENSE_LESEN](#job-status-sense-lesen) - Senseausgang fuer ausgewaehlte Lampe lesen, LM-E6X KWP2000: $30 InputOutputControlByLocalIdentifier $01 ReportCurrentState $0D Senseausgang lesen Modus  : Default
- [_HERSTELLER_DATEN_SCHREIBEN_LEAR](#job-hersteller-daten-schreiben-lear) - Schreiben der Herstellerdaten KWP2000: $2E WriteDataByCommonIdentifier $0004 Herstellerdaten schreiben
- [_HERSTELLER_DATEN_LESEN_LEAR](#job-hersteller-daten-lesen-lear) - Auslesen der Herstellerdaten KWP2000: $22 ReadDataByCommonIdentifier $0004 Herstellerdaten lesen
- [_CBD_ZEICHN_INDEX_LESEN_LEAR](#job-cbd-zeichn-index-lesen-lear) - Auslesen des Aenderungsindex aus den Codierdaten KWP 2000: $22 ReadDataByCommonIdentifier Modus  : Default
- [CKM_AUF_DEFAULT](#job-ckm-auf-default) - CAR and KEY auf Default-Codierdaten setzen KWP2000: $2E WriteDataByCommonIdentifier $0005 CAR and KEY auf default setzen
- [CKM_SCHREIBEN](#job-ckm-schreiben) - CAR and KEY schreiben KWP2000: $2E WriteDataByCommonIdentifier $0006 CAR and KEY schreiben
- [CKM_LESEN](#job-ckm-lesen) - Auslesen von CAR and KEY aus EEPROM KWP2000: $22 ReadDataByCommonIdentifier $0006 CAR and KEY lesen
- [CKM_AKTUELL_LESEN](#job-ckm-aktuell-lesen) - Auslesen von CAR and KEY aus RAM KWP2000: $22 ReadDataByCommonIdentifier $0007 CAR and KEY lesen
- [STATUS_XENON_AL_EINSCHALTVERSUCHE](#job-status-xenon-al-einschaltversuche) - KWP2000: $30 InputOutputControlByLocalIdentifier $01 ReportCurrentState $0E Xenon-AL-Einschaltversuche
- [STEUERN_XENON_AL_EINSCHALTVERSUCHE_LOESCHEN](#job-steuern-xenon-al-einschaltversuche-loeschen) - KWP2000: $30 InputOutputControlByLocalIdentifier $07 ShortTermAdjustment $0E Xenon-AL-Einschaltversuche
- [STATUS_GANG_RUECKWAERTS](#job-status-gang-rueckwaerts) - KWP2000: $30 InputOutputControlByLocalIdentifier $01 ReportCurrentState $10 STATUS_GANG_RUECKWAERTS
- [STATUS_FLC_ALC](#job-status-flc-alc) - KWP2000: $30 InputOutputControlByLocalIdentifier $01 ReportCurrentState $11 STATUS_FLC_ALC
- [STATUS_FAHRZEUGNEIGUNG](#job-status-fahrzeugneigung) - KWP2000: $30 InputOutputControlByLocalIdentifier $01 ReportCurrentState $19 STATUS_FAHRZEUGNEIGUNG
- [STATUS_FASTA_DATEN_LM](#job-status-fasta-daten-lm) - KWP2000: $30 InputOutputControlByLocalIdentifier $01 ReportCurrentState Stati von LM-E6X lesen
- [_STEUERN_LAMPEN_ALLE_LEAR](#job-steuern-lampen-alle-lear) - KWP2000: $30 InputOutputControlByLocalIdentifier $07 ShortTermAdjustment $01 Dimmwert an PWM-Port Status von LM-E6X schreiben
- [_FLASH_PROG_STATUS_SCHREIBEN_LEAR](#job-flash-prog-status-schreiben-lear) - Flashprogrammierstatus schreiben KWP2000: $3B WriteDataByLocalIdentifier $02 FlashProgrammierstatus auf 1 setzen Modus  : Default
- [STEUERN_AL_EINSCHALTEN](#job-steuern-al-einschalten) - Abblendlicht ueber Diagnose ein- bzw. ausschalten KWP2000: $30 InputOutputControlByLocalIdentifier $07 ShortTermAdjustment $12 Abblendlicht ein- bzw. ausschalten Status von LM-E6X schreiben
- [_RESET_KURZSCHLUSS_SPERRE](#job-reset-kurzschluss-sperre) - Kurzschlusssperre ueber Diagnose ausschalten KWP2000: $30 InputOutputControlByLocalIdentifier $07 ShortTermAdjustment $13 Kurzschlusssperre ausschalten Status von LM-E6X schreiben
- [STATUS_LAMPEN_KURZSCHLUSS](#job-status-lampen-kurzschluss) - KWP2000: $30 InputOutputControlByLocalIdentifier $01 ReportCurrentState $14 Lampenkurzschluss auslesen Status Lampenkurzschluesse (explizit) von LM-E6X lesen
- [STATUS_LAMPEN_KURZSCHLUSS_WIEDERHOL_COUNTER](#job-status-lampen-kurzschluss-wiederhol-counter) - KWP2000: $30 InputOutputControlByLocalIdentifier $01 ReportCurrentState $15 Lampenkurzschluss Wiederholzaehler auslesen Status Lampenkurzschluesse (explizit) von LM-E6X lesen
- [STATUS_LAMPEN_KURZSCHLUSS_COUNTER](#job-status-lampen-kurzschluss-counter) - KWP2000: $30 InputOutputControlByLocalIdentifier $01 ReportCurrentState $16 Lampenkurzschluss Zaehler auslesen Status Lampenkurzschluesse (explizit) von LM-E6X lesen
- [STATUS_LAMPEN_KURZSCHLUSS_COUNTER_MAX](#job-status-lampen-kurzschluss-counter-max) - KWP2000: $30 InputOutputControlByLocalIdentifier $01 ReportCurrentState $17 Lampenkurzschluss Zaehler Maxwert auslesen Status Lampenkurzschluesse (explizit) von LM-E6X lesen
- [_READ_NOTLAUF_FALLBACK_COUNTER_LEAR](#job-read-notlauf-fallback-counter-lear) - KWP 2000: $21 ReadDataByLocalIdentifier $05 NOTLAUF_FALLBACK_COUNTER Modus   : Default
- [_CLR_NOTLAUF_FALLBACK_COUNTER_LEAR](#job-clr-notlauf-fallback-counter-lear) - KWP2000: $3B WriteDataByLocalIdentifier $05 NOTLAUF_FALLBACK_COUNTER Modus  : Default
- [_CLR_RESET_COUNTER_LEAR](#job-clr-reset-counter-lear) - KWP2000: $3B WriteDataByLocalIdentifier $06 RESET_COUNTER Modus  : Default
- [READ_DIAG_RINGSPEICHER](#job-read-diag-ringspeicher) - KWP 2000: $21 ReadDataByLocalIdentifier $07 DIAG_RINGSPEICHER Modus   : Default
- [_CLR_DIAG_RINGSPEICHER_LEAR](#job-clr-diag-ringspeicher-lear) - KWP2000: $3B WriteDataByLocalIdentifier $07 DIAG_RINGSPEICHER Modus  : Default
...
- [STEUERN_SMC_BESTROMEN](#job-steuern-smc-bestromen) - KWP2000: $30 InputOutputControlByLocalIdentifier $07 ShortTermAdjustment $18 SMC bestromen Status von LM-AHL schreiben Bestromung der SMCs einschalten
...
- [STATUS_SPANNUNG_VERSORGUNG_SMC](#job-status-spannung-versorgung-smc) - Auslesen der Versorgungsspannung der SMCs KWP2000: $30 ReadMemoryByAddress
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_AUSGANG_FL_LINKS_EIN | int | Fernlicht links ein/aus |
| STAT_AUSGANG_FL_RECHTS_EIN | int | Fernlicht rechts ein/aus |
| STAT_AUSGANG_AL_LINKS_EIN | int | Abblendlicht links ein/aus |
| STAT_AUSGANG_AL_RECHTS_EIN | int | Abblendlicht rechts ein/aus |
| STAT_AUSGANG_BEGRL_LINKS_EIN | int | Begrenzungslicht links ein/aus |
| STAT_AUSGANG_BEGRL_RECHTS_EIN | int | Begrenzungslicht rechts ein/aus |
| STAT_AUSGANG_NSW_LINKS_EIN | int | Nebelscheinwerfer links ein/aus |
| STAT_AUSGANG_NSW_RECHTS_EIN | int | Nebelscheinwerfer rechts ein/aus |
| STAT_AUSGANG_FRA_LINKS_VORN_1_EIN | int | Fahrtrichtungsanzeiger links vorne 1 ein/aus |
| STAT_AUSGANG_FRA_RECHTS_VORN_1_EIN | int | Fahrtrichtungsanzeiger rechts vorne 1 ein/aus |
| STAT_AUSGANG_FRA_LINKS_HINTEN_EIN | int | Fahrtrichtungsanzeiger links hinten ein/aus |
| STAT_AUSGANG_FRA_RECHTS_HINTEN_EIN | int | Fahrtrichtungsanzeiger rechts hinten ein/aus |
| STAT_AUSGANG_FRA_LINKS_VORN_2_EIN | int | Fahrtrichtungsanzeiger links vorne 2 ein/aus |
| STAT_AUSGANG_FRA_RECHTS_VORN_2_EIN | int | Fahrtrichtungsanzeiger rechts vorne 2 ein/aus |
| STAT_AUSGANG_BREMSLICHT_LINKS_EIN | int | Bremslicht links ein/aus |
| STAT_AUSGANG_BREMSLICHT_RECHTS_EIN | int | Bremslicht rechts ein/aus |
| STAT_AUSGANG_BREMSLICHT_MITTE_EIN | int | Bremslicht mitte ein/aus |
| STAT_AUSGANG_SL_BL_LINKS_EIN | int | Schlusslicht/Bremslicht links ein/aus |
| STAT_AUSGANG_SL_BL_RECHTS_EIN | int | Schlusslicht/Bremslicht rechts ein/aus |
| STAT_AUSGANG_SL_BL_LINKS_2_EIN | int | Schlusslicht/Bremslicht links 2 ein/aus |
| STAT_AUSGANG_SL_BL_RECHTS_2_EIN | int | Schlusslicht/Bremslicht rechts 2ein/aus |
| STAT_AUSGANG_KZL_LINKS_EIN | int | Kennzeichenlicht links ein/aus |
| STAT_AUSGANG_KZL_RECHTS_EIN | int | Kennzeichenlicht rechts ein/aus |
| STAT_AUSGANG_NSL_LINKS_EIN | int | Nebelschlusslicht links ein/aus |
| STAT_AUSGANG_NSL_RECHTS_EIN | int | Nebelschlusslicht rechts ein/aus |
| STAT_AUSGANG_RFL_LINKS_EIN | int | Rueckfahrlicht links ein/aus |
| STAT_AUSGANG_RFL_RECHTS_EIN | int | Rueckfahrlicht rechts ein/aus |
| STAT_AUSGANG_FRA_ZUSATZ_LINKS_EIN | int | Zusatzfahrtrichtungsanzeiger links ein/aus |
| STAT_AUSGANG_FRA_ZUSATZ_RECHTS_EIN | int | Zusatzfahrtrichtungsanzeiger rechts ein/aus |
| STAT_AUSGANG_SML_2_EIN | int | Seitenmarkierungslicht 2 ein/aus |
| STAT_AUSGANG_SML_VORN_EIN | int | Seitenmarkierungslicht vorne ein/aus |
| STAT_AUSGANG_RESERVE_4_EIN | int | Reserve-Ausgang 4 ein/aus |
| STAT_AUSGANG_SML_1_EIN | int | Seitenmarkierungslicht 1 ein/aus |
| STAT_AUSGANG_SML_HINTEN_EIN | int | Seitenmarkierungslicht hinten ein/aus |
| STAT_AUSGANG_BEGRL_LINKS_AUSSEN_EIN | int | Begrenzungslicht links aussen ein/aus |
| STAT_AUSGANG_BEGRL_RECHTS_AUSSEN_EIN | int | Begrenzungslicht rechts aussen ein/aus |
| STAT_AUSGANG_BEGRL_LINKS_INNEN_EIN | int | Begrenzungslicht links innen ein/aus |
| STAT_AUSGANG_BEGRL_RECHTS_INNEN_EIN | int | Begrenzungslicht rechts innen ein/aus |
| STAT_FAHRZEUG | string | gibt an auf welches Fahrzeug das LM codiert ist |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| STAT_AUSGANG_SL_BL_LINKS_WERT | int | Dimmwert Schlusslicht links |
| STAT_AUSGANG_SL_BL_RECHTS_WERT | int | Dimmwert Schlusslicht rechts |
...
| STAT_AUSGANG_SML_2_WERT | int | Dimmwert Seitenmarkierungslicht 2 |
...
| STAT_AUSGANG_SML_1_WERT | int | Dimmwert Seitenmarkierungslicht 1 |
...
| STAT_AUSGANG_BEGRL_LINKS_AUSSEN_WERT | int | Dimmwert Begrenzungslicht links aussen |
| STAT_AUSGANG_BEGRL_RECHTS_AUSSEN_WERT | int | Dimmwert Begrenzungslicht rechts aussen |
| STAT_AUSGANG_BEGRL_LINKS_INNEN_WERT | int | Dimmwert Begrenzungslicht links innen |
| STAT_AUSGANG_BEGRL_RECHTS_INNEN_WERT | int | Dimmwert Begrenzungslicht rechts innen |
| STAT_FAHRZEUG | string | gibt an auf welches Fahrzeug das LM codiert ist |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| Name | Type | Comment |
| --- | --- | --- |
| CODIERDATEN_AHL | string | die kompletten Codierdaten im 3000-Bereich (AHL) |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| Name | Type | Comment |
| --- | --- | --- |
| CODIERDATEN_LM | string | die kompletten Codierdaten im 3400-Bereich (LM) |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| STAT_SCHALTER_WBL_EIN | int | Schalter Warnblinklicht betaetigt |
...
<a id="job-status-szl-verbunden"></a>
...
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_SPANNUNG_LENKSTOCKSCHALTER_WERT | real | Spannung Lenkstockschalter Bereich: 0 V bis 5 V |
| STAT_SZL_VERBUNDEN | string |  |
| STAT_SZL_VERBUNDEN_OK | int | HW-Leitung zu SZL vorhanden |
| STAT_SPANNUNG_EINH | string | Einheit fuer Spannung Lenkstockschalter: Volt |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |

<a id="job-status-zusatz-blinker"></a>
...
| Name | Type | Comment |
| --- | --- | --- |
| STAT_FRA_ZUSATZ_LINKS_DEFEKT | string | Fehler bei Zusatzblinker links |
| STAT_FRA_ZUSATZ_RECHTS_DEFEKT | string | Fehler bei Zusatzblinker rechts |
| STAT_FRA_ZUSATZ_LINKS_DEFEKT_VORHANDEN | int | Fehler bei Zusatzblinker links 0 = kein Fehler, 1 = Fehler |
| STAT_FRA_ZUSATZ_RECHTS_DEFEKT_VORHANDEN | int | Fehler bei Zusatzblinker rechts 0 = kein Fehler, 1 = Fehler |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_FL_LINKS_DEFEKT | int | Fernlicht links defekt ja/nein |
| STAT_FL_RECHTS_DEFEKT | int | Fernlicht rechts defekt ja/nein |
| STAT_AL_LINKS_DEFEKT | int | Abblendlicht links defekt ja/nein |
| STAT_AL_RECHTS_DEFEKT | int | Abblendlicht rechts defekt ja/nein |
| STAT_BEGRL_LINKS_DEFEKT | int | Begrenzungslicht links defekt ja/nein |
| STAT_BEGRL_RECHTS_DEFEKT | int | Begrenzungslicht rechts defekt ja/nein |
| STAT_NSW_LINKS_DEFEKT | int | Nebelscheinwerfer links defekt ja/nein |
| STAT_NSW_RECHTS_DEFEKT | int | Nebelscheinwerfer rechts defekt ja/nein |
| STAT_FRA_LINKS_VORN_1_DEFEKT | int | Fahrtrichtungsanzeiger links vorne defekt ja/nein |
| STAT_FRA_RECHTS_VORN_1_DEFEKT | int | Fahrtrichtungsanzeiger rechts vorne defekt ja/nein |
| STAT_FRA_LINKS_HINTEN_DEFEKT | int | Fahrtrichtungsanzeiger links hinten defekt ja/nein |
| STAT_FRA_RECHTS_HINTEN_DEFEKT | int | Fahrtrichtungsanzeiger rechts hinten defekt ja/nein |
| STAT_FRA_LINKS_VORN_2_DEFEKT | int | Fahrtrichtungsanzeiger links vorne 2 defekt ja/nein |
| STAT_FRA_RECHTS_VORN_2_DEFEKT | int | Fahrtrichtungsanzeiger rechts vorne 2 defekt ja/nein |
| STAT_BREMSLICHT_LINKS_DEFEKT | int | Bremslicht links defekt ja/nein |
| STAT_BREMSLICHT_RECHTS_DEFEKT | int | Bremslicht rechts defekt ja/nein |
| STAT_BREMSLICHT_MITTE_DEFEKT | int | Bremslicht mitte defekt ja/nein |
| STAT_SL_BL_LINKS_DEFEKT | int | Schlusslicht innen links defekt ja/nein |
| STAT_SL_BL_RECHTS_DEFEKT | int | Schlusslicht innen rechts defekt ja/nein |
| STAT_SL_BL_LINKS_2_DEFEKT | int | Schlusslicht links aussen defekt ja/nein |
| STAT_SL_BL_RECHTS_2_DEFEKT | int | Schlusslicht rechts aussen defekt ja/nein |
| STAT_KZL_LINKS_DEFEKT | int | Kennzeichenlicht links defekt ja/nein |
| STAT_KZL_RECHTS_DEFEKT | int | Kennzeichenlicht rechts defekt ja/nein |
| STAT_NSL_LINKS_DEFEKT | int | Nebelschlusslicht links defekt ja/nein |
| STAT_NSL_RECHTS_DEFEKT | int | Nebelschlusslicht rechts defekt ja/nein |
| STAT_RFL_LINKS_DEFEKT | int | Rueckfahrlicht links defekt ja/nein |
| STAT_RFL_RECHTS_DEFEKT | int | Rueckfahrlicht rechts defekt ja/nein |
| STAT_FRA_ZUSATZ_LINKS_DEFEKT | int | Zusatzfahrtrichtungsanzeiger links defekt ja/nein |
| STAT_FRA_ZUSATZ_RECHTS_DEFEKT | int | Zusatzfahrtrichtungsanzeiger rechts defekt ja/nein |
| STAT_SML_2_DEFEKT | int | Seitenmarkierungslicht 2 defekt ja/nein |
| STAT_SML_VORN_DEFEKT | int | Seitenmarkierungslicht vorne defekt ja/nein |
| STAT_AUSGANG_RESERVE_4_DEFEKT | int | Reserve-Ausgang 4 defekt ja/nein |
| STAT_SML_1_DEFEKT | int | Seitenmarkierungslicht 1 defekt ja/nein |
| STAT_SML_HINTEN_DEFEKT | int | Seitenmarkierungslicht hinten defekt ja/nein |
| STAT_BEGRL_LINKS_AUSSEN_DEFEKT | int | Begrenzungslicht links aussen defekt ja/nein |
| STAT_BEGRL_RECHTS_AUSSEN_DEFEKT | int | Begrenzungslicht rechts aussen defekt ja/nein |
| STAT_BEGRL_LINKS_INNEN_DEFEKT | int | Begrenzungslicht links innen defekt ja/nein |
| STAT_BEGRL_RECHTS_INNEN_DEFEKT | int | Begrenzungslicht rechts innen defekt ja/nein |
| STAT_FAHRZEUG | string | gibt an auf welches Fahrzeug das LM codiert ist |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| LICHT_OPTISCH_ENTRIEGELN_CKM | string | optische Signalisierung bei Entriegeln |
| LICHT_OPTISCH_VERRIEGELN_CKM | string | optische Signalisierung bei Verriegeln |
| LICHT_ANZAHL_BLINKEN_TIPPEN_CKM | string | Anzahl Blinkzyklen bei Tippblinken |
| LICHT_DAUER_HEIMLEUCHTEN_CKM | string | Dauer Heimleuchten |
| LICHT_DAUER_HEIMLEUCHTEN_CKM_EINH | string | Einheit fuer Heimleuchten |
| LICHT_TAGFAHRLICHT_CKM | string | Tagfahrlicht an bzw. aus |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |

<a id="job-ckm-aktuell-lesen"></a>
### CKM_AKTUELL_LESEN
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| LICHT_OPTISCH_ENTRIEGELN_CKM_AKT | string | optische Signalisierung bei Entriegeln |
| LICHT_OPTISCH_VERRIEGELN_CKM_AKT | string | optische Signalisierung bei Verriegeln |
| LICHT_ANZAHL_BLINKEN_TIPPEN_CKM_AKT | string | Anzahl Blinkzyklen bei Tippblinken |
| LICHT_DAUER_HEIMLEUCHTEN_CKM_AKT | string | Dauer Heimleuchten |
| LICHT_DAUER_HEIMLEUCHTEN_CKM_AKT_EINH | string | Einheit fuer Heimleuchten |
| LICHT_TAGFAHRLICHT_CKM_AKT | string | Tagfahrlicht an bzw. aus |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
<a id="job-status-gang-rueckwaerts"></a>
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_GANG_RUECKWAERTS_EIN | int | STATUS_GANG_RUECKWAERTS auslesen |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |

<a id="job-status-flc-alc"></a>
### STATUS_FLC_ALC
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_FLC_EIN | int | STATUS_FLC_ALC auslesen |
| STAT_ALC_EIN | int | STATUS_FLC_ALC auslesen |
| STAT_ALC_ERROR | int | STATUS_FLC_ALC auslesen |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
<a id="job-status-fasta-daten-lm"></a>
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_BETRIEBSZEIT_LM_WERT | unsigned int | Betriebsstunden LM auslesen |
| STAT_BETRIEBSZEIT_AL_WERT | unsigned int | Betriebsstunden Abblendlicht auslesen |
| STAT_BETRIEBSZEIT_FL_WERT | unsigned int | Betriebsstunden Fernlicht auslesen |
| STAT_BETRIEBSZEIT_SL_WERT | unsigned int | Betriebsstunden Standlicht auslesen |
| STAT_BETRIEBSZEIT_NSW_WERT | unsigned int | Betriebsstunden Nebelscheinwerfer auslesen |
| STAT_BETRIEBSZEIT_15A_25A_WERT | unsigned int | Betriebszeit mit 15A bis 25A |
| STAT_BETRIEBSZEIT_25A_30A_WERT | unsigned int | Betriebszeit mit 25A bis 30A |
| STAT_BETRIEBSZEIT_30A_37A_WERT | unsigned int | Betriebszeit mit 30A bis 37A |
| STAT_BETRIEBSZEIT_37A_WERT | unsigned int | Betriebszeit mit &gt; 37A |
| STAT_BETRIEBSZEIT_EINH | string | Einheit fuer Betriebszeit [h] |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |

<a id="job-steuern-lampen-alle-lear"></a>
...
| STAT_BEGRL_LINKS_SHORT_CIRCUIT | int | Begrenzungslicht links (E60, E65), aussen (E60-Halogen) SHORT_CIRCUIT ja/nein |
| STAT_BEGRL_RECHTS_SHORT_CIRCUIT | int | Begrenzungslicht rechts (E60, E65), aussen (E60-Halogen) SHORT_CIRCUIT ja/nein |
...
| STAT_FRA_LINKS_VORN_2_SHORT_CIRCUIT | int | Fahrtrichtungsanzeiger links vorne 2 SHORT_CIRCUIT ja/nein |
| STAT_FRA_RECHTS_VORN_2_SHORT_CIRCUIT | int | Fahrtrichtungsanzeiger rechts vorne 2 SHORT_CIRCUIT ja/nein |
...
| STAT_SL_BL_LINKS_SHORT_CIRCUIT | int | Schlusslicht innen links SHORT_CIRCUIT ja/nein |
| STAT_SL_BL_RECHTS_SHORT_CIRCUIT | int | Schlusslicht innen rechts SHORT_CIRCUIT ja/nein |
| STAT_SL_BEGRL_LINKS_INNEN_SHORT_CIRCUIT | int | Schlusslicht (E65), Begrenzungslicht (E60-Halogen), links innen SHORT_CIRCUIT ja/nein |
| STAT_SL_BEGRL_RECHTS_INNEN_SHORT_CIRCUIT | int | Schlusslicht (E65), Begrenzungslicht (E60-Halogen), rechts innen SHORT_CIRCUIT ja/nein |
| STAT_KZL_LINKS_SHORT_CIRCUIT | int | Kennzeichenlicht links SHORT_CIRCUIT ja/nein |
| STAT_KZL_RECHTS_SHORT_CIRCUIT | int | Kennzeichenlicht rechts SHORT_CIRCUIT ja/nein |
...
| STAT_FRA_ZUSATZ_LINKS_SHORT_CIRCUIT | int | Zusatzfahrtrichtungsanzeiger links SHORT_CIRCUIT ja/nein |
| STAT_FRA_ZUSATZ_RECHTS_SHORT_CIRCUIT | int | Zusatzfahrtrichtungsanzeiger rechts SHORT_CIRCUIT ja/nein |
| STAT_SML_2_SHORT_CIRCUIT | int | Seitenmarkierungslicht 2 SHORT_CIRCUIT ja/nein |
| STAT_SML_VORN_SHORT_CIRCUIT | int | Seitenmarkierungslicht vorne SHORT_CIRCUIT ja/nein |
| STAT_AUSGANG_RESERVE_4_SHORT_CIRCUIT | int | Reserve-Ausgang 4 SHORT_CIRCUIT ja/nein |
| STAT_SML_1_SHORT_CIRCUIT | int | Seitenmarkierungslicht 1 SHORT_CIRCUIT ja/nein |
| STAT_SML_HINTEN_SHORT_CIRCUIT | int | Seitenmarkierungslicht hinten SHORT_CIRCUIT ja/nein |
| STAT_KLEMME_58G_SHORT_CIRCUIT | int | Klemme 58g SHORT_CIRCUIT ja/nein |
| STAT_BI_XENON_SHORT_CIRCUIT | int | Bi-Xenon SHORT_CIRCUIT ja/nein |
...
| STAT_BEGRL_LINKS_SHORT_CIRCUIT_WIEDERHOL | int | Begrenzungslicht links (E60, E65), aussen (E60-Halogen) SHORT_CIRCUIT_WIEDERHOL |
| STAT_BEGRL_RECHTS_SHORT_CIRCUIT_WIEDERHOL | int | Begrenzungslicht rechts (E60, E65), aussen (E60-Halogen) SHORT_CIRCUIT_WIEDERHOL |
...
| STAT_FRA_LINKS_VORN_2_SHORT_CIRCUIT_WIEDERHOL | int | Fahrtrichtungsanzeiger links vorne 2 SHORT_CIRCUIT_WIEDERHOL |
| STAT_FRA_RECHTS_VORN_2_SHORT_CIRCUIT_WIEDERHOL | int | Fahrtrichtungsanzeiger rechts vorne 2 SHORT_CIRCUIT_WIEDERHOL |
...
| STAT_SL_BL_LINKS_SHORT_CIRCUIT_WIEDERHOL | int | Schlusslicht innen links SHORT_CIRCUIT_WIEDERHOL |
| STAT_SL_BL_RECHTS_SHORT_CIRCUIT_WIEDERHOL | int | Schlusslicht innen rechts SHORT_CIRCUIT_WIEDERHOL |
| STAT_SL_BEGRL_LINKS_INNEN_SHORT_CIRCUIT_WIEDERHOL | int | Schlusslicht (E65), Begrenzungslicht (E60-Halogen), links innen SHORT_CIRCUIT_WIEDERHOL |
| STAT_SL_BEGRL_RECHTS_INNEN_SHORT_CIRCUIT_WIEDERHOL | int | Schlusslicht (E65), Begrenzungslicht (E60-Halogen), rechts innen SHORT_CIRCUIT_WIEDERHOL |
| STAT_KZL_LINKS_SHORT_CIRCUIT_WIEDERHOL | int | Kennzeichenlicht links SHORT_CIRCUIT_WIEDERHOL |
| STAT_KZL_RECHTS_SHORT_CIRCUIT_WIEDERHOL | int | Kennzeichenlicht rechts SHORT_CIRCUIT_WIEDERHOL |
...
| STAT_FRA_ZUSATZ_LINKS_SHORT_CIRCUIT_WIEDERHOL | int | Zusatzfahrtrichtungsanzeiger links SHORT_CIRCUIT_WIEDERHOL |
| STAT_FRA_ZUSATZ_RECHTS_SHORT_CIRCUIT_WIEDERHOL | int | Zusatzfahrtrichtungsanzeiger rechts SHORT_CIRCUIT_WIEDERHOL |
| STAT_SML_2_SHORT_CIRCUIT_WIEDERHOL | int | Seitenmarkierungslicht 2 SHORT_CIRCUIT_WIEDERHOL |
| STAT_SML_VORN_SHORT_CIRCUIT_WIEDERHOL | int | Seitenmarkierungslicht vorne SHORT_CIRCUIT_WIEDERHOL |
| STAT_AUSGANG_RESERVE_4_SHORT_CIRCUIT_WIEDERHOL | int | Reserve-Ausgang 4 SHORT_CIRCUIT_WIEDERHOL |
| STAT_SML_1_SHORT_CIRCUIT_WIEDERHOL | int | Seitenmarkierungslicht 1 SHORT_CIRCUIT_WIEDERHOL |
| STAT_SML_HINTEN_SHORT_CIRCUIT_WIEDERHOL | int | Seitenmarkierungslicht hinten SHORT_CIRCUIT_WIEDERHOL |
| STAT_KLEMME_58G_SHORT_CIRCUIT_WIEDERHOL | int | Klemme 58g SHORT_CIRCUIT_WIEDERHOL |
| STAT_BI_XENON_SHORT_CIRCUIT_WIEDERHOL | int | Bi-Xenon SHORT_CIRCUIT_WIEDERHOL |
...
| STAT_BEGRL_LINKS_SHORT_CIRCUIT_COUNTER | int | Begrenzungslicht links (E60, E65), aussen (E60-Halogen) SHORT_CIRCUIT_COUNTER |
| STAT_BEGRL_RECHTS_SHORT_CIRCUIT_COUNTER | int | Begrenzungslicht rechts (E60, E65), aussen (E60-Halogen) SHORT_CIRCUIT_COUNTER |
...
| STAT_FRA_LINKS_VORN_2_SHORT_CIRCUIT_COUNTER | int | Fahrtrichtungsanzeiger links vorne 2 SHORT_CIRCUIT_COUNTER |
| STAT_FRA_RECHTS_VORN_2_SHORT_CIRCUIT_COUNTER | int | Fahrtrichtungsanzeiger rechts vorne 2 SHORT_CIRCUIT_COUNTER |
...
| STAT_SL_BL_LINKS_SHORT_CIRCUIT_COUNTER | int | Schlusslicht innen links SHORT_CIRCUIT_COUNTER |
| STAT_SL_BL_RECHTS_SHORT_CIRCUIT_COUNTER | int | Schlusslicht innen rechts SHORT_CIRCUIT_COUNTER |
| STAT_SL_BEGRL_LINKS_INNEN_SHORT_CIRCUIT_COUNTER | int | Schlusslicht (E65), Begrenzungslicht (E60-Halogen), links innen SHORT_CIRCUIT_COUNTER |
| STAT_SL_BEGRL_RECHTS_INNEN_SHORT_CIRCUIT_COUNTER | int | Schlusslicht (E65), Begrenzungslicht (E60-Halogen), rechts innen SHORT_CIRCUIT_COUNTER |
| STAT_KZL_LINKS_SHORT_CIRCUIT_COUNTER | int | Kennzeichenlicht links SHORT_CIRCUIT_COUNTER |
| STAT_KZL_RECHTS_SHORT_CIRCUIT_COUNTER | int | Kennzeichenlicht rechts SHORT_CIRCUIT_COUNTER |
...
| STAT_FRA_ZUSATZ_LINKS_SHORT_CIRCUIT_COUNTER | int | Zusatzfahrtrichtungsanzeiger links SHORT_CIRCUIT_COUNTER |
| STAT_FRA_ZUSATZ_RECHTS_SHORT_CIRCUIT_COUNTER | int | Zusatzfahrtrichtungsanzeiger rechts SHORT_CIRCUIT_COUNTER |
| STAT_SML_2_SHORT_CIRCUIT_COUNTER | int | Seitenmarkierungslicht 2 SHORT_CIRCUIT_COUNTER |
| STAT_SML_VORN_SHORT_CIRCUIT_COUNTER | int | Seitenmarkierungslicht vorne SHORT_CIRCUIT_COUNTER |
| STAT_AUSGANG_RESERVE_4_SHORT_CIRCUIT_COUNTER | int | Reserve-Ausgang 4 SHORT_CIRCUIT_COUNTER |
| STAT_SML_1_SHORT_CIRCUIT_COUNTER | int | Seitenmarkierungslicht 1 SHORT_CIRCUIT_COUNTER |
| STAT_SML_HINTEN_SHORT_CIRCUIT_COUNTER | int | Seitenmarkierungslicht hinten SHORT_CIRCUIT_COUNTER |
| STAT_KLEMME_58G_SHORT_CIRCUIT_COUNTER | int | Klemme 58g SHORT_CIRCUIT_COUNTER |
| STAT_BI_XENON_SHORT_CIRCUIT_COUNTER | int | Bi-Xenon SHORT_CIRCUIT_COUNTER |
...
| STAT_BEGRL_LINKS_SHORT_CIRCUIT_COUNTER_MAX | int | Begrenzungslicht links (E60, E65), aussen (E60-Halogen) SHORT_CIRCUIT_COUNTER_MAX |
| STAT_BEGRL_RECHTS_SHORT_CIRCUIT_COUNTER_MAX | int | Begrenzungslicht rechts (E60, E65), aussen (E60-Halogen) SHORT_CIRCUIT_COUNTER_MAX |
...
| STAT_FRA_LINKS_VORN_2_SHORT_CIRCUIT_COUNTER_MAX | int | Fahrtrichtungsanzeiger links vorne 2 SHORT_CIRCUIT_COUNTER_MAX |
| STAT_FRA_RECHTS_VORN_2_SHORT_CIRCUIT_COUNTER_MAX | int | Fahrtrichtungsanzeiger rechts vorne 2 SHORT_CIRCUIT_COUNTER_MAX |
...
| STAT_SL_BL_LINKS_SHORT_CIRCUIT_COUNTER_MAX | int | Schlusslicht innen links SHORT_CIRCUIT_COUNTER_MAX |
| STAT_SL_BL_RECHTS_SHORT_CIRCUIT_COUNTER_MAX | int | Schlusslicht innen rechts SHORT_CIRCUIT_COUNTER_MAX |
| STAT_SL_BEGRL_LINKS_INNEN_SHORT_CIRCUIT_COUNTER_MAX | int | Schlusslicht (E65), Begrenzungslicht (E60-Halogen), links innen SHORT_CIRCUIT_COUNTER_MAX |
| STAT_SL_BEGRL_RECHTS_INNEN_SHORT_CIRCUIT_COUNTER_MAX | int | Schlusslicht (E65), Begrenzungslicht (E60-Halogen), rechts innen SHORT_CIRCUIT_COUNTER_MAX |
| STAT_KZL_LINKS_SHORT_CIRCUIT_COUNTER_MAX | int | Kennzeichenlicht links SHORT_CIRCUIT_COUNTER_MAX |
| STAT_KZL_RECHTS_SHORT_CIRCUIT_COUNTER_MAX | int | Kennzeichenlicht rechts SHORT_CIRCUIT_COUNTER_MAX |
...
| STAT_FRA_ZUSATZ_LINKS_SHORT_CIRCUIT_COUNTER_MAX | int | Zusatzfahrtrichtungsanzeiger links SHORT_CIRCUIT_COUNTER_MAX |
| STAT_FRA_ZUSATZ_RECHTS_SHORT_CIRCUIT_COUNTER_MAX | int | Zusatzfahrtrichtungsanzeiger rechts SHORT_CIRCUIT_COUNTER_MAX |
| STAT_SML_2_SHORT_CIRCUIT_COUNTER_MAX | int | Seitenmarkierungslicht 2 SHORT_CIRCUIT_COUNTER_MAX |
| STAT_SML_VORN_SHORT_CIRCUIT_COUNTER_MAX | int | Seitenmarkierungslicht vorne SHORT_CIRCUIT_COUNTER_MAX |
| STAT_AUSGANG_RESERVE_4_SHORT_CIRCUIT_COUNTER_MAX | int | Reserve-Ausgang 4 SHORT_CIRCUIT_COUNTER_MAX |
| STAT_SML_1_SHORT_CIRCUIT_COUNTER_MAX | int | Seitenmarkierungslicht 1 SHORT_CIRCUIT_COUNTER_MAX |
| STAT_SML_HINTEN_SHORT_CIRCUIT_COUNTER_MAX | int | Seitenmarkierungslicht hinten SHORT_CIRCUIT_COUNTER_MAX |
| STAT_KLEMME_58G_SHORT_CIRCUIT_COUNTER_MAX | int | Klemme 58g SHORT_CIRCUIT_COUNTER_MAX |
| STAT_BI_XENON_SHORT_CIRCUIT_COUNTER_MAX | int | Bi-Xenon SHORT_CIRCUIT_COUNTER_MAX |
| STAT_FLC_LED_SHORT_CIRCUIT_COUNTER_MAX | int | FLC LED SHORT_CIRCUIT_COUNTER_MAX |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |

<a id="job-read-notlauf-fallback-counter-lear"></a>
...
| RESET_COUNTER | int | gibt die Anzahl der Resets, entprellt an |
| RESET_COUNTER_KM_STAND | long | gibt den km-Stand beim letzten Reset an |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |

<a id="job-clr-notlauf-fallback-counter-lear"></a>
...
<a id="job-clr-reset-counter-lear"></a>
...
| Name | Type | Comment |
| --- | --- | --- |
| RING_SPEICHER | binary | kompletter Ringspeicher im Rohformat |
...
| CAN_BUS_ERROR_ABGESPEICHERT | string | gibt an welcher CAN-Fehler beim Eintrag der Fehlers aktiv war |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
<a id="job-status-spannung-versorgung-smc"></a>
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_SPANNUNG_VERSORGUNG_SMC_WERT | real | Spannung Versorgung SMCs Bereich: 0 V bis 18 V |
| STAT_SPANNUNG_EINH | string | Einheit fuer alle Analogwerte: Volt |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
- [FORTTEXTE](#table-forttexte) (45 × 2)
- [FUMWELTMATRIX](#table-fumweltmatrix) (6 × 5)
- [TIEFENTL](#table-tiefentl) (1 × 9)
- [FUMWELTTEXTE](#table-fumwelttexte) (10 × 9)
- [ERR_LAMPE](#table-err-lampe) (36 × 2)
- [IORTTEXTE](#table-iorttexte) (84 × 2)
- [IDETAILSTRUKTUR](#table-idetailstruktur) (4 × 2)
- [IUMWELTMATRIX](#table-iumweltmatrix) (90 × 5)
...
- [NOTL](#table-notl) (1 × 7)
- [LAMPNRTEXTE](#table-lampnrtexte) (39 × 3)
- [FUNKTIONNRTEXTE](#table-funktionnrtexte) (13 × 3)
- [ZUSATZOUT](#table-zusatzout) (13 × 3)
