...
| COMMENT | SGBD für PL2 ab Mü 09/09, E84 ab SOP |
| PACKAGE | 1.52 |
| SPRACHE | deutsch |
...
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_REST | unsigned char | Aktueller Zustand der Restwärme/ALL-Taste |
...
| STAT_ECO | unsigned char | Aktueller Zustand der ECO-PRO-Taste |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
