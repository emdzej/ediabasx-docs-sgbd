...
- [IDENT](#job-ident) - PARTIAL Ident Data for MEMS3
- [SECURITY_ACCESS](#job-security-access) - Wake-up and security-access for MEMS3
...
| Name | Type | Comment |
| --- | --- | --- |
| SESSION | int | Optional Diagnostics session (0x85 for programming, else TotalAccess) |
