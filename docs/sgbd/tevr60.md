...
| STAT_ZK_1_ZUENDKAPAZITAET_NIO | unsigned int | Bit 0: Zuendkapazitaet ZK_1 n.i.O. Bit 7: frei |
| STAT_ZK_1_CODIERUNG_UNSTIMMIG | unsigned int | Bit 1: Codierung / Konfiguration ZK_1 unstimmig Bit 7: frei |
| STAT_ZK_1_UNTERBRECHUNG_ENTLADEKREIS | unsigned int | Bit 2: Unterbrechung Entladekreis ZK_1 Bit 7: frei |
| STAT_ZK_1_KS_UNTERBR_L_SIDE_SCHALTER | unsigned int | Bit 3: Kurzschluss oder Unterbrechung Low-Side-Schalter ZK_1 Bit 7: frei |
| STAT_ZK_1_KS_UNTERBR_H_SIDE_SCHALTER | unsigned int | Bit 4: Kurzschluss oder Unterbrechung High-Side-Schalter ZK_1 Bit 7: frei |
| STAT_ZK_1_FEHLER_IM_ALARMPFAD | unsigned int | Bit 5: Fehler im Alarmpfad ZK_1 Bit 7: frei |
| STAT_ZK_1_BUSSTOERUNG_ALARM_PHASE_1 | unsigned int | Bit 6: Busstoerung/Alarm in Phase 1 ZK_1 Bit 7: frei |
...
| 0x96b2 | Timeout ID 06H (SASL) |
| 0x96b3 | Timeout ID 07H (SBSR) |
| 0x96b4 | Timeout ID 08H (SASR) |
| 0x96b5 | Timeout ID 09H (SFZ) |
| 0x96b6 | Timeout ID 0AH (SIM) |
| 0x96b7 | Timeout ID 0BH (SASL) |
| 0x96b8 | Timeout ID 0CH (SASR) |
| 0x96b9 | Timeout ID 0DH (SFZ) |
| 0x96ba | Timeout ID 0EH |
| 0x96bb | Timeout ID 0FH |
| 0x96bc | Timeout ID 20H (SSFA) |
| 0x96bd | Timeout ID 21H (SSBF) |
| 0x96be | Timeout ID 22H (SSH) |
...
| 0x96ce | Zuendkapazitaet ZK1 n.i.O. |
...
| 0x96d9 | Zuendkapazitaet ZK2 n.i.O. |
