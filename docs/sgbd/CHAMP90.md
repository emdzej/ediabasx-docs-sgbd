...
- [STATUS_LESEN_LAUFWERK](#job-status-lesen-laufwerk) - Auslesen des im RAD1 verbauten Laufwerkes KWP2000: $21 ReadDataByLocalIdentifier $B1 recordLocalIdentifier Modus  : Default
...
- [STATUS_RDS](#job-status-rds) - Auslesen, RDS TP STATUS "on" oder "off" ist KWP2000: $21 ReadDataByLocalIdentifier $B6 recordLocalIdentifier - RDS state Modus  : Default
- [STATUS_AUX](#job-status-aux) - Auslesen, ob AUX "on" oder "off" ist KWP2000: $21 ReadDataByLocalIdentifier $BC recordLocalIdentifier - telephonemute state Modus  : Default
...
- [STATUS_FETRAWE](#job-status-fetrawe) - Auslesen des FETRAWE Modes KWP2000: $22 ReadDataByLocalIdentifier $100A recordLocalIdentifier - FTW Code Modus  : Default
- [ENERGIESPARMODE](#job-energiesparmode) - Einstellen des Energiesparmodes KWP2000: $31 StartRoutineByLocalIdentifier $0C ControlEnergySavingMode Modus  : Default
- [_WRITE_COMPLETE_EEPROM](#job-write-complete-eeprom) - Motorola S-Record Datei "..\Ediabas\BIN\eeprom.hex" lesen und Datenblock ins EEProm schreiben  Die Bereiche fuer UIF ProgrammReferenz Backup und RANDOM werden NICHT überschrieben !  KWP2000: $31 StartRoutineByLocalIdentifier $FA systemSupplierSpecific $37 localIdentifier Modus  : Default
...
- [STATUS_ANT_EIGEN_DIAG](#job-status-ant-eigen-diag) - Auslesen der Laendervariante KWP2000: $21 ReadDataByLocalIdentifier $B9 recordLocalIdentifier - antenna state Modus  : Default
- [STEUERN_TEST_TONE](#job-steuern-test-tone) - ANSTEUERN eines Testtones bestimmter Frequenz KWP2000: $30 InputOutputControlByLocalIdentifier $07 inputOutputLocalIdentifier - RDS switch $07 ShortTermAdjustment Modus  : Default
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_FETRAWE | string | STAT FETRAWE |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
<a id="job-write-complete-eeprom"></a>
...
| Name | Type | Comment |
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei ERROR_TIMEOUT_ABBRUCH, sonst |
| _TEL_AUFTRAG | binary | Hex-Auftrag an SG |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| SWITCHRESULT | string | which antenna was swhitched on? |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_ANTENNA | string | STAT ANTENNA |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |

<a id="job-steuern-test-tone"></a>
### STEUERN_TEST_TONE
...
- [TAUDIOVOLUME](#table-taudiovolume) (57 × 2)
...
- [TANTENNA_STATE](#table-tantenna-state) (3 × 2)
- [TSCAN_ANTENNA](#table-tscan-antenna) (3 × 2)
- [TTONE_SET](#table-ttone-set) (6 × 3)
