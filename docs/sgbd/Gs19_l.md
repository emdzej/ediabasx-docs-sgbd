...
| Field | Value |
| --- | --- |
| ECU | GS19.0 9600 kBaud C Muster |
| ORIGIN | BMW EA-71 Burkhardt |
| REVISION | 0.08 |
| AUTHOR | BMW EA-71 Burkhardt |
| COMMENT | SGBD fuer Integrationsstufe 5 9600 kBaud |
| PACKAGE | 0.12 |
| SPRACHE | deutsch |
...
- [ALLE_MESSWERTE_AUSGEBEN](#job-alle-messwerte-ausgeben) - Auslesen aller Messwerte 0x01..0x7E KWP2000: $21 ReadDataByLocalIdentifier Modus  : Default
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_KURVENERKENNUNG_AGS | string | Kurvenerkennung Bereich: 0:keine Kurve erkannt 1:Kurve erkannt |
| STAT_SCHALTDIAGRAMM_AGS | string | Schaltdiagramm AGS Bereich:0b0000...0b1111 |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |

<a id="job-alle-messwerte-ausgeben"></a>
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| F_ORT_NR | unsigned int | Index fuer Fehlerort |
| F_ORT_TEXT | string | Fehlerort als Text table FOrtTexte ORTTEXT |
