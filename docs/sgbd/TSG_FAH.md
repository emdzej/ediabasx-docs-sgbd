...
| Field | Value |
| --- | --- |
| ECU | Türsteuergerät Fahrer hinten |
...
| --- | --- | --- | --- |
| 0x027500 | Energiesparmode aktiv | 0 | - |
| 0x027508 | Codierung: Steuergerät ist nicht codiert | 0 | - |
| 0x027509 | Codierung: Codierdaten passen nicht zum Fahrzeug | 0 | - |
| 0x02750A | Codierung: Codierdaten nicht qualifiziert | 0 | - |
| 0x027580 | ZERTIFIKATE_UND_BINDINGS_TYP1_WERK_NICHT_BEREIT | 0 | - |
| 0x027581 | ONLINE_ZERTIFIKATE_UND_BINDINGS_TYP2_NICHT_BEREIT | 0 | - |
| 0x027582 | Secure Feature Activation: Tokenprüfung fehlgeschlagen | 0 | - |
| 0x027583 | Secure Feature Activation: Tokenprüfung läuft aktuell oder ungeprüfte Tokens sind gespeichert | 0 | - |
| 0x027584 | Locking Configuration Switch: Einer oder mehrere Schalter nicht gesetzt. | 0 | - |
| 0x027585 | Secure ECU Modes: ECU not in field mode. | 0 | - |
| 0x02FF75 | Dummy-Fehlerspeichereintrag im Komponentenfehlerbereich nur für Testzwecke | 1 | - |
...
| 0x030113 | FH FAH: Ungültige Position, Normierungsverlust | 0 | - |
...
| 0x030140 | FH FAH: Hall oder Motor defekt | 0 | - |
| 0x030141 | FH FAH: lokaler Taster defekt | 0 | - |
| 0x807E80 | Unterspannung erkannt | 1 | - |
| 0x807E81 | Überspannung erkannt | 1 | - |
| 0x807E82 | TSG-FAH: HW defekt | 0 | - |
| 0x807E89 | FAH-TSG-LIN, Schalterblock SitzErweiterteFunktionen (SB_SitzExt_FAH): falsche Variante | 0 | - |
| 0x807E90 | FAH-TSG-LIN, Schalterblock SitzErweiterteFunktionen (SB_SitzExt_FAH): fehlender LIN-Slave | 0 | - |
| 0x807E91 | FAH-TSG-LIN, Schalterblock SitzErweiterteFunktionen (SB_SitzExt_FAH): unerwarteter LIN-Slave | 0 | - |
| 0xE6452B | BODY3-CAN Physikalischer Busfehler | 0 | - |
| 0xE6452C | BODY3-CAN Control Module Bus OFF | 0 | - |
| 0xE64BFF | Dummy-Fehlerspeichereintrag im Netzwerkfehlerbereich nur für Testzwecke | 1 | - |
| 0xE64C00 | FAH-TSG LIN Master: Kommunikation fehlt oder gestört | 0 | - |
| 0xE64C01 | FAH-TSG LIN Master: Kurzschluss | 0 | - |
