...
| Field | Value |
| --- | --- |
| ECU | Short Range Radar hinten links |
...
- [FORTTEXTE](#table-forttexte) (10 × 4)
...
| --- | --- | --- | --- |
| 0x022A00 | Energiesparmode aktiv | 0 | - |
| 0x022A08 | Codierung: Steuergerät ist nicht codiert | 0 | - |
| 0x022A09 | Codierung: Fehler bei Codierdatentransaktion aufgetreten | 0 | - |
| 0x022A0A | Codierung: Signatur der Codierdaten ungültig | 0 | - |
| 0x022A0B | Codierung: Codierdaten passen nicht zum Fahrzeug | 0 | - |
| 0x022A0C | Codierung: Unplausible Daten während Codierdatentransaktion | 0 | - |
| 0x022A0D | Codierung: Codierdaten nicht qualifiziert | 0 | - |
| 0x02FF2A | Dummy-Fehlerspeichereintrag im Komponentenfehlerbereich nur für Testzwecke | 1 | - |
| 0xD38BFF | Dummy-Fehlerspeichereintrag im Netzwerkfehlerbereich nur für Testzwecke | 1 | - |
