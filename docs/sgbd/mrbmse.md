...
| --- | --- |
| ECU | MRBMSE |
| ORIGIN | BMW_Motorrad UX-EE-1 Stefan_Krimmer |
| REVISION | 1.015 |
...
- [STATUS_DIGITAL_AUTOMATISCHE_GANGADAPTION](#job-status-digital-automatische-gangadaption) - Status automatische Gangadaption KWP2000: $22 ReadDataByCommonIdentifier $0140 Status Digital Automatische Gangadaption Modus  : Default
...
- [STATUS_DIGITAL_MOTORSTARTUNTERDRUECKUNG](#job-status-digital-motorstartunterdrueckung) - Status Motorstartunterdrueckung KWP2000: $22 ReadDataByCommonIdentifier $0150 Status Digital Motorstartunterdrueckung Modus  : Default
- [STATUS_MM_ISO](#job-status-mm-iso) - Status ISO Code KWP2000: $22 ReadDataByCommonIdentifier $0200 ISO Code Modus  : Default
- [STATUS_MM_SW_NUM](#job-status-mm-sw-num) - Status Sw Num KWP2000: $22 ReadDataByCommonIdentifier $0201 Software Number Modus  : Default
- [STATUS_MM_DRAW](#job-status-mm-draw) - Status Draw Code KWP2000: $22 ReadDataByCommonIdentifier $0202 Draw Code Modus  : Default
- [STATUS_MM_HW_NUM](#job-status-mm-hw-num) - Status Hw Num KWP2000: $22 ReadDataByCommonIdentifier $0203 Hardware Number Modus  : Default
- [STATUS_MM_APPROVAL](#job-status-mm-approval) - Status Approval KWP2000: $22 ReadDataByCommonIdentifier $0204 Approval Type Modus  : Default
- [STATUS_DIGITAL_ROM_CHECKSUM](#job-status-digital-rom-checksum) - Status ROM checksum KWP2000: $22 ReadDataByCommonIdentifier $0211 Status Digital ROM Checksum Modus  : Default
...
- [STEUERN_MOTORSTARTUNTERDRUECKUNG](#job-steuern-motorstartunterdrueckung) - Steuern Motorstartunterdrueckung KWP2000: $31 StartRoutineByLocalIdentifier $24 Start Routine Activation of the Motorstartunterdrueckung
- [STEUERN_ENDE_MOTORSTARTUNTERDRUECKUNG](#job-steuern-ende-motorstartunterdrueckung) - Steuern Ende Motorstartunterdrueckung KWP2000: $32 StopRoutineByLocalIdentifier $24 Stop Routine Activation of the Motorstartunterdrueckung
...
<a id="job-status-digital-automatische-gangadaption"></a>
### STATUS_DIGITAL_AUTOMATISCHE_GANGADAPTION

Status automatische Gangadaption KWP2000: $22 ReadDataByCommonIdentifier $0140 Status Digital Automatische Gangadaption Modus  : Default
...
| Name | Type | Comment |
| --- | --- | --- |
| STAT_STATUS_AUTOMATISCHE_GANGADAPTION_WERT | string | Status automatische Gangadaption Value: 0-127 |
| STAT_STATUS_AUTOMATISCHE_GANGADAPTION_EINH | string | Einheit = - |
| STAT_STATUS_AUTOMATISCHE_GANGADAPTION_BIT0_TEXT | string | Value "0" --&gt; "Gang N = nicht gelernt" Value "1" --&gt; "Gang N = gelernt" |
| STAT_STATUS_AUTOMATISCHE_GANGADAPTION_BIT1_TEXT | string | Value "0" --&gt; "Gang 1 = nicht gelernt" Value "1" --&gt; "Gang 1 = gelernt" |
| STAT_STATUS_AUTOMATISCHE_GANGADAPTION_BIT2_TEXT | string | Value "0" --&gt; "Gang 2 = nicht gelernt" Value "1" --&gt; "Gang 2 = gelernt" |
| STAT_STATUS_AUTOMATISCHE_GANGADAPTION_BIT3_TEXT | string | Value "0" --&gt; "Gang 3 = nicht gelernt" Value "1" --&gt; "Gang 3 = gelernt" |
| STAT_STATUS_AUTOMATISCHE_GANGADAPTION_BIT4_TEXT | string | Value "0" --&gt; "Gang 4 = nicht gelernt" Value "1" --&gt; "Gang 4 = gelernt" |
| STAT_STATUS_AUTOMATISCHE_GANGADAPTION_BIT5_TEXT | string | Value "0" --&gt; "Gang 5 = nicht gelernt" Value "1" --&gt; "Gang 5 = gelernt" |
| STAT_STATUS_AUTOMATISCHE_GANGADAPTION_BIT6_TEXT | string | Value "0" --&gt; "Gang 6 = nicht gelernt" Value "1" --&gt; "Gang 6 = gelernt" |
| JOB_STATUS | string | OKAY, no error table JobResult STATUS_TEXT |
| _TEL_AUFTRAG | binary | Hex-answer an SG |
| _TEL_ANTWORT | binary | Hex-answer von SG |
...
<a id="job-status-digital-motorstartunterdrueckung"></a>
### STATUS_DIGITAL_MOTORSTARTUNTERDRUECKUNG

Status Motorstartunterdrueckung KWP2000: $22 ReadDataByCommonIdentifier $0150 Status Digital Motorstartunterdrueckung Modus  : Default
...
| Name | Type | Comment |
| --- | --- | --- |
| STAT_STATUS_MOTORSTARTUNTERDRUECKUNG_WERT | unsigned int | Status Motorstartunterdrueckung Value: 0-1 |
| STAT_STATUS_MOTORSTARTUNTERDRUECKUNG_EINH | string | Einheit = - |
| STAT_STATUS_MOTORSTARTUNTERDRUECKUNG_TEXT | string | Value "0" --&gt; "Motorstartunterdrueckung = nicht aktiv" Value "1" --&gt; "Motorstartunterdrueckung = aktiv" |
| JOB_STATUS | string | OKAY, no error table JobResult STATUS_TEXT |
| _TEL_AUFTRAG | binary | Hex-answer an SG |
| _TEL_ANTWORT | binary | Hex-answer von SG |

<a id="job-status-mm-iso"></a>
### STATUS_MM_ISO

Status ISO Code KWP2000: $22 ReadDataByCommonIdentifier $0200 ISO Code Modus  : Default
...
| Name | Type | Comment |
| --- | --- | --- |
| STAT_STATUS_ISO_CODE | string | Status ISO Code |
| JOB_STATUS | string | OKAY, no-error table JobResult STATUS_TEXT |
| _TEL_AUFTRAG | binary | Hex-answer an SG |
| _TEL_ANTWORT | binary | Hex-answer von SG |

<a id="job-status-mm-sw-num"></a>
### STATUS_MM_SW_NUM

Status Sw Num KWP2000: $22 ReadDataByCommonIdentifier $0201 Software Number Modus  : Default
...
| Name | Type | Comment |
| --- | --- | --- |
| STAT_STATUS_SW_NUM | string | Status Sw Num |
| JOB_STATUS | string | OKAY, no-error table JobResult STATUS_TEXT |
| _TEL_AUFTRAG | binary | Hex-answer an SG |
| _TEL_ANTWORT | binary | Hex-answer von SG |

<a id="job-status-mm-draw"></a>
### STATUS_MM_DRAW

Status Draw Code KWP2000: $22 ReadDataByCommonIdentifier $0202 Draw Code Modus  : Default
...
| Name | Type | Comment |
| --- | --- | --- |
| STAT_STATUS_DRAW_CODE | string | Status Draw Code |
| JOB_STATUS | string | OKAY, no-error table JobResult STATUS_TEXT |
| _TEL_AUFTRAG | binary | Hex-answer an SG |
| _TEL_ANTWORT | binary | Hex-answer von SG |

<a id="job-status-mm-hw-num"></a>
### STATUS_MM_HW_NUM

Status Hw Num KWP2000: $22 ReadDataByCommonIdentifier $0203 Hardware Number Modus  : Default
...
| Name | Type | Comment |
| --- | --- | --- |
| STAT_STATUS_HW_NUM | string | Status Hw Num |
| JOB_STATUS | string | OKAY, no-error table JobResult STATUS_TEXT |
| _TEL_AUFTRAG | binary | Hex-answer an SG |
| _TEL_ANTWORT | binary | Hex-answer von SG |

<a id="job-status-mm-approval"></a>
### STATUS_MM_APPROVAL

Status Approval KWP2000: $22 ReadDataByCommonIdentifier $0204 Approval Type Modus  : Default
...
| Name | Type | Comment |
| --- | --- | --- |
| STAT_STATUS_APPROVAL | string | Status Approval |
| JOB_STATUS | string | OKAY, no-error table JobResult STATUS_TEXT |
| _TEL_AUFTRAG | binary | Hex-answer an SG |
| _TEL_ANTWORT | binary | Hex-answer von SG |

<a id="job-status-digital-rom-checksum"></a>
### STATUS_DIGITAL_ROM_CHECKSUM

Status ROM checksum KWP2000: $22 ReadDataByCommonIdentifier $0211 Status Digital ROM Checksum Modus  : Default
...
| Name | Type | Comment |
| --- | --- | --- |
| STAT_STATUS_ROM_CHECKSUM_WERT | unsigned int | Status ROM checksum Value: 0-1 |
| STAT_STATUS_ROM_CHECKSUM_EINH | string | Einheit = - |
| STAT_STATUS_ROM_CHECKSUM_TEXT | string | Value "0" --&gt; "ROM checksum computation not yet done" Value "1" --&gt; "ROM checksum computation done" |
| JOB_STATUS | string | OKAY, no error table JobResult STATUS_TEXT |
| _TEL_AUFTRAG | binary | Hex-answer an SG |
| _TEL_ANTWORT | binary | Hex-answer von SG |
...
<a id="job-steuern-motorstartunterdrueckung"></a>
### STEUERN_MOTORSTARTUNTERDRUECKUNG

Steuern Motorstartunterdrueckung KWP2000: $31 StartRoutineByLocalIdentifier $24 Start Routine Activation of the Motorstartunterdrueckung
...
<a id="job-steuern-ende-motorstartunterdrueckung"></a>
### STEUERN_ENDE_MOTORSTARTUNTERDRUECKUNG

Steuern Ende Motorstartunterdrueckung KWP2000: $32 StopRoutineByLocalIdentifier $24 Stop Routine Activation of the Motorstartunterdrueckung
...
- [FUMWELTMATRIX](#table-fumweltmatrix) (58 × 5)
...
| ORT | ORTTEXT |
| --- | --- |
| 0x2710 | EWS4: nicht authentifizierte Response erhalten |
| 0x2720 | EWS4: CAN-Timeout |
| 0x2730 | EWS4: kein Secret-Key programmiert |
| 0x2740 | EWS4: Datenspeicherung - Schreibfehler |
| 0x2741 | EWS4: Datenspeicherung - Plausibilitaetsfehler |
| 0x2760 | Einspritzventil 1 Stromkreis Fehlfunktion |
| 0x2761 | Einspritzventil 2 Stromkreis Fehlfunktion |
| 0x2762 | Zündspule 1 Stromkreis Fehlfunktion |
| 0x2763 | Zündspule 2 Stromkreis Fehlfunktion |
| 0x2764 | Kurbelwellengeber Fehlfunktion |
| 0x2765 | HEGO1 Sensor Heizung - Kurzschluss gegen UB |
| 0x2766 | HEGO1 Sensor Heizung - Kurzschluss gegen Masse oder Leitungsunterbrechung |
| 0x2767 | HEGO1 Sensor Stromkreis Fehlfunktion |
| 0x2768 | Drosselklappenstellung-Sensor - Spannung zu niedrig |
| 0x2769 | Drosselklappenstellung-Sensor - Spannung zu hoch |
| 0x2770 | Umgebungsdruckfuehler - Spannung zu niedrig |
| 0x2771 | Umgebungsdruckfuehler - Spannung zu hoch |
| 0x2772 | Ansaugluft Temperatursensor - Spannung zu niedrig |
| 0x2773 | Ansaugluft Temperatursensor - Spannung zu hoch |
| 0x2774 | Motorkuehlmitteltemperaturfuehler - Spannung zu niedrig |
| 0x2775 | Motorkuehlmitteltemperaturfuehler - Spannung zu hoch |
| 0x2776 | Ansteuerung Kraftstoffpumpenrelais - Kurzschluss gegen UB |
| 0x2777 | Ansteuerung Kraftstoffpumpenrelais - Kurzschluss gegen Masse oder Leitungsunterbrechung |
| 0x2778 | Lastrelais - Kurzschluss gegen UB oder Leitungsunterbrechung |
| 0x2779 | Lastrelais - Kurzschluss gegen Masse |
| 0x2780 | Starter-Relais - Kurzschluss gegen UB |
| 0x2781 | Starter-Relais - Kurzschluss gegen Masse oder Leitungsunterbrechung |
| 0x2782 | Ansteuerung E.-Luefterrelais - Kurzschluss gegen UB |
| 0x2783 | Ansteuerung E.-Luefterrelais - Kurzschluss gegen Masse |
| 0x2784 | Ansteuerung E.-Luefterrelais - Leitungsunterbrechung |
| 0x2785 | Fehlfunktion vom STH Motor |
| 0x2786 | Systemspannung Stromkreis Fehlfunktion |
| 0x2787 | Steuergeraet - Interner EEPROM Fehler |
| 0x2788 | Säuberung Kanister Magnetventil - Kurzschluss gegen UB |
| 0x2789 | Säuberung Kanister Magnetventil - Kurzschluss gegen Masse oder Leitungsunterbrechung |
| 0x2790 | Oel Temperaturesensor - Spannung zu niedrig |
| 0x2791 | Oel Temperaturesensor - Spannung zu hoch |
| 0x2792 | Seitenständer-Schalter - Spannung zu hoch |
| 0x2793 | Nockenwellengeber - Signal nicht plausibel |
| 0x2794 | Leerlaufregelung - Signal nicht plausibel |
| 0x2795 | RAM Test - Signal nicht plausibel |
| 0x2796 | ROM Test - Signal nicht plausibel |
| 0x2799 | Warnlampe Stromkreis Fehlfunktion |
| 0x2803 | Fahrzeuggeschwindigkeit zu hoch |
| 0x2804 | Fahrzeuggeschwindigkeit nicht plausibel |
| 0x2805 | Tachometer Stromkreis Fehlfunktion |
| 0x2806 | Gangsensor - Spannung zu hoch |
| 0x2807 | Gangsensor - Spannung zu niedrig |
| 0x2808 | Gangsensor - Signal nicht plausibel |
| 0x2809 | Ausstellungsmode aktiv |
| 0x2810 | Fehlfunktion des Auslassventils |
| 0x2811 | Ungültige Hinterradgeschwindigkeit für Powertrain-Funktionalität |
| 0xCD84 | EWS4: CAN Frame Fehler |
| 0xCD85 | CAN BUS off |
| 0xCD86 | Kein Rx ABS Frame |
| 0xCD87 | Kein Rx KOMBI 0x3FF Frame |
| 0xCD88 | Kein Rx KOMBI 0x2B4 Frame |
| 0xCD89 | Kein Rx SPEED MBK 0x2A8 Frame |
| 0xFFFF | Unbekannter Fehlercode |
...
| 0x2810 | 0x01 | 0x02 | 0x03 | 0x04 |
| 0x2811 | 0x01 | 0x02 | 0x03 | 0x04 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 0x01 | Motordrehzahl | rpm | - | unsigned char | - | 50 | 1 | 0 |
| 0x02 | Kühlmitteltemperatur | °C | - | unsigned char | - | 1 | 1 | -40 |
| 0x03 | Drosselklappenstellung | % | - | unsigned char | - | 0,5 | 1 | 0 |
| 0x04 | Batteriespannung | V | - | unsigned char | - | 0,1 | 1 | 0 |
