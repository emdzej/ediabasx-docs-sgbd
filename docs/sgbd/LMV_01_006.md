...
| REVISION | 1.000 |
| AUTHOR | Magna_Steyr HES G._Suppan, Magna_Steyr EES N._Feulner |
| COMMENT | N/A |
| PACKAGE | 1.05 |
| SPRACHE | deutsch |
...
| STAT_HO_INTEGRATOR_KM_WERT | unsigned long | Intervall Km Zähler seit letztem Ölwechsel |
...
| ARG_HO_INTEGRATOR_KM | unsigned long | EE_kmVehServOil = Argument_3 |
...
| STAT_LT_INTEGRATOR_KM_WERT | unsigned long | Intervall Km Zähler seit letztem Ölwechsel |
...
| ARG_INTEGRATOR_KM | unsigned long | EE_kmVehServOil = Argument_3 |
...
- [FORTTEXTE](#table-forttexte) (87 × 3)
...
- [TAB_LMV_BAUREIHE](#table-tab-lmv-baureihe) (11 × 2)
...
| 0x440081 | VTG Gesamtsystem: Systemtakt-Fehler | 0 |
| 0x440082 | Steuergeät: interner Fehler (HW-Register) | 0 |
...
| 0x440107 | Diagnostic-Session: Programmiervorbedingung verletzt | 0 |
...
| 0xcf5491 | Schnittstelle DME1 (Dehzahl Getriebestrang, 38.1.4): Signal ungültig | 1 |
...
| UWNR | UWTEXT | UW_EINH | L/H | UWTYP | NAME | MUL | DIV | ADD |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 0x1703 | Bordnetzspannung LMV Klemme 30 | V | - | unsigned char | - | - | 8 | - |
| 0x1704 | Bordnetzspannung LMV Klemme30b | V | - | unsigned char | - | - | 8 | - |
...
| 0x1709 | DSC Sollwertvorgabe Moment | Nm | - | unsigned char | - | 8 | - | - |
| 0x170A | DSC Status | 0-n | - | 0xff | TAB_4002_3_U | - | - | - |
| 0x170B | DSC Signal Qualifier | 0-n | - | 0xff | TAB_4002_2_U | - | - | - |
| 0x170C | LMV Sollwertumsetzung Moment | Nm | - | unsigned char | - | 8 | - | - |
...
| 0x1710 | Brueckentemperatur | ° | - | unsigned char | - | - | - | -40 |
...
| 0x1717 | S_phiSM | - | high | unsigned int | - | - | - | - |
...
| 0x44010e | Steuergerät: internern Fehler (VTG Software: Systemüberlastung) | 0 |
