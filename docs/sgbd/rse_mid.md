...
| ORIGIN | BMW EI-41 Lamberty,Hans |
| REVISION | 6.000 |
...
- [STATUS_DIAGNOSE_AUX2](#job-status-diagnose-aux2) - KWP2000: $31 StartRoutineByLocalIdentifier
...
- [STATUS_PARAMETER_FOMO_1](#job-status-parameter-fomo-1) - KWP2000: $31 StartRoutineByLocalIdentifier
- [STATUS_PARAMETER_FOMO_2](#job-status-parameter-fomo-2) - KWP2000: $31 StartRoutineByLocalIdentifier
- [STATUS_RSE](#job-status-rse) - KWP2000: $31 StartRoutineByLocalIdentifier
- [STATUS_RSE_VARIANTE](#job-status-rse-variante) - KWP2000: $31 StartRoutineByLocalIdentifier
...
- [STEUERN_FONDMONITOR](#job-steuern-fondmonitor) - KWP2000: $31 StartRoutineByLocalIdentifier $XX STEU_FOMO_1 $YY STEU_FOMO_2
...
- [STEUERN_LVDS](#job-steuern-lvds) - KWP2000: $31 StartRoutineByLocalIdentifier $XX STEU_LVDS_1 $YY STEU_LVDS_2
- [STEUERN_NEXT_ENTSOURCE](#job-steuern-next-entsource) - KWP2000: $31 StartRoutineByLocalIdentifier $XX STEU_ENTSOURCE
- [STEUERN_OSD_SPRACHE](#job-steuern-osd-sprache) - KWP2000: $31 StartRoutineByLocalIdentifier $XX STEU_AKTIVE_SPRACHE
...
- [_STATUS_UIC_EEPROM_LAYOUT](#job-status-uic-eeprom-layout) - KWP2000: $31 StartRoutineByLocalIdentifier
...
<a id="job-status-diagnose-aux2"></a>
### STATUS_DIAGNOSE_AUX2
...
| Name | Type | Comment |
| --- | --- | --- |
| STAT_VIDEO_R | int | Status des AUX2-Videoeingangs (R-Komponente) HEX value $00 to $02 HEX value $00: AUX2-Videoeingang (R-Komponente) fehlerfrei HEX value $01: Kurzschluss Kl.30 am AUX2-Videoeingang (R-Komponente) HEX value $02: Kurzschluss Kl.31 am AUX2-Videoeingang (R-Komponente) |
| STAT_VIDEO_R_STRING | string | Status des AUX2-Videoeingangs (R-Komponente) value OK: AUX2-Videoeingang (R-Komponente) fehlerfrei value KURZSCHLUSS Kl.30: Kurzschluss Kl.30 am AUX2-Videoeingang (R-Komponente) value KURZSCHLUSS Kl.31: Kurzschluss Kl.31 am AUX2-Videoeingang (R-Komponente) |
| STAT_VIDEO_G | int | Status des AUX2-Videoeingangs (G-Komponente) HEX value $00 to $02 HEX value $00: AUX2-Videoeingang (G-Komponente) fehlerfrei HEX value $01: Kurzschluss Kl.30 am AUX2-Videoeingang (G-Komponente) HEX value $02: Kurzschluss Kl.31 am AUX2-Videoeingang (G-Komponente) |
| STAT_VIDEO_G_STRING | string | Status des AUX2-Videoeingangs (G-Komponente) value OK: AUX2-Videoeingang (G-Komponente) fehlerfrei value KURZSCHLUSS Kl.30: Kurzschluss Kl.30 am AUX2-Videoeingang (G-Komponente) value KURZSCHLUSS Kl.31: Kurzschluss Kl.31 am AUX2-Videoeingang (G-Komponente) |
| STAT_VIDEO_B | int | Status des AUX2-Videoeingangs (B-Komponente) HEX value $00 to $02 HEX value $00: AUX2-Videoeingang (B-Komponente) fehlerfrei HEX value $01: Kurzschluss Kl.30 am AUX2-Videoeingang (B-Komponente) HEX value $02: Kurzschluss Kl.31 am AUX2-Videoeingang (B-Komponente) |
| STAT_VIDEO_B_STRING | string | Status des AUX2-Videoeingangs (B-Komponente) value OK: AUX2-Videoeingang (B-Komponente) fehlerfrei value KURZSCHLUSS Kl.30: Kurzschluss Kl.30 am AUX2-Videoeingang (B-Komponente) value KURZSCHLUSS Kl.31: Kurzschluss Kl.31 am AUX2-Videoeingang (B-Komponente) |
| STAT_AUDIO_L | int | Status des AUX2-Audioeingangs links HEX value $00 to $03 HEX value $00: AUX2-Audioeingang links fehlerfrei HEX value $01: Kurzschluss Kl.30 am AUX2-Audioeingang links HEX value $02: Kurzschluss Kl.31 am AUX2-Audioeingang links HEX value $03: KHM defekt oder Leitungsfehler am AUX2-Audioeingang links |
| STAT_AUDIO_L_STRING | string | Status des AUX2-Audioeingangs links value OK: AUX2-Audioeingang links fehlerfrei value KURZSCHLUSS Kl.30: Kurzschluss Kl.30 am AUX2-Audioeingang links value FEHLER KHM / LEITUNG: KHM defekt oder Leitungsfehler am AUX2-Audioeingang links |
| STAT_AUDIO_R | int | Status des AUX2-Audioeingangs rechts HEX value $00 to $03 HEX value $00: AUX2-Audioeingang rechts fehlerfrei HEX value $01: Kurzschluss Kl.30 am AUX2-Audioeingang rechts HEX value $02: Kurzschluss Kl.31 am AUX2-Audioeingang rechts HEX value $03: KHM defekt oder Leitungsfehler am AUX2-Audioeingang rechts |
| STAT_AUDIO_R_STRING | string | Status des AUX2-Audioeingangs rechts value OK: AUX2-Audioeingang rechts fehlerfrei value KURZSCHLUSS Kl.30: Kurzschluss Kl.30 am AUX2-Audioeingang rechts value KURZSCHLUSS Kl.31: Kurzschluss Kl.31 am AUX2-Audioeingang rechts value FEHLER KHM / LEITUNG: KHM defekt oder Leitungsfehler am AUX2-Audioeingang rechts |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| Name | Type | Comment |
| --- | --- | --- |
| STAT_MMI_LEITSPRACHE | int | Status der codierten MMI-Leitsprache HEX value $01 to $0C value $01: Deutsch value $02: Englisch GB value $03: Englisch US value $04: Französisch value $05: Spanisch value $06: Italienisch value $07: Japanisch value $08: Koreanisch value $09: Chinesisch Traditional value $0A: Chinesisch GBA 18030 value $0B: Niederländisch value $0C: Russisch |
| STAT_MMI_NEBENSPRACHE_1 | int | Status der codierten MMI-Nebensprache_1 HEX value $01 to $0C value $01: Deutsch value $02: Englisch GB value $03: Englisch US value $04: Französisch value $05: Spanisch value $06: Italienisch value $07: Japanisch value $08: Koreanisch value $09: Chinesisch Traditional value $0A: Chinesisch GBA 18030 value $0B: Niederländisch value $0C: Russisch |
| STAT_MMI_NEBENSPRACHE_2 | int | Status der codierten MMI-Nebensprache_2 HEX value $01 to $0C value $01: Deutsch value $02: Englisch GB value $03: Englisch US value $04: Französisch value $05: Spanisch value $06: Italienisch value $07: Japanisch value $08: Koreanisch value $09: Chinesisch Traditional value $0A: Chinesisch GBA 18030 value $0B: Niederländisch value $0C: Russisch |
| STAT_AKTIVE_MMI_SPRACHE | int | Status der aktiven MMI-Sprache HEX value $01 to $0C value $01: Deutsch value $02: Englisch GB value $03: Englisch US value $04: Französisch value $05: Spanisch value $06: Italienisch value $07: Japanisch value $08: Koreanisch value $09: Chinesisch Traditional value $0A: Chinesisch GBA 18030 value $0B: Niederländisch value $0C: Russisch |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |

<a id="job-status-parameter-fomo-1"></a>
### STATUS_PARAMETER_FOMO_1
...
| Name | Type | Comment |
| --- | --- | --- |
| STAT_KLAPP | int | Klappstatus von Fond-Monitor 1 HEX value $00 to $01, $FF HEX value $00: Fond-Monitor 1 eingeklappt HEX value $01: Fond-Monitor 1 ausgeklappt HEX value $FF: Klappstatus ungültig |
| STAT_KLAPP_STRING | string | Klappstatus von Fond-Monitor 1 value AUSGEKLAPPT: Fond-Monitor 1 ausgeklappt value EINGEKLAPPT: Fond-Monitor 1 eingeklappt value UNGÜLTIG:	   Klappstatus ungültig |
| STAT_BILDANZEIGE | int | Status der Bildanzeige von Fond-Monitor 1 HEX value $00 to $01, $FF HEX value $00: Fond-Monitor 1 zeigt kein Bild an HEX value $01: Fond-Monitor 1 zeigt Bild an HEX value $FF: Bildanzeigestatus ungültig |
| STAT_BILDANZEIGE_STRING | string | Status der Bildanzeige von Fond-Monitor 1 value BILD WIRD NICHT ANGEZEIGT: Fond-Monitor 1 zeigt kein Bild an value BILD WIRD ANGEZEIGT: Fond-Monitor 1 zeigt Bild an value UNGÜLTIG: Bildanzeigestatus ungültig |
| STAT_BEREITSCHAFT | int | Status der Anzeigebereitschaft von Fond-Monitor 1 HEX value $00 to $01, $FF HEX value $00: Fond-Monitor 1 ist nicht anzeigebereit HEX value $01: Fond-Monitor 1 ist anzeigebereit HEX value $FF: Bereitschaftsstatus ungültig |
| STAT_BEREITSCHAFT_STRING | string | Status der Anzeigebereitschaft von Fond-Monitor 1 value KEINE ANZEIGEBEREITSCHAFT: Fond-Monitor 1 ist nicht anzeigebereit value ANZEIGEBEREITSCHAFT: Fond-Monitor 1 ist anzeigebereit value UNGÜLTIG: Bereitschaftsstatus ungültig |
| STAT_AUFLOESUNG | int | Status der Auflösung von Fond-Monitor 1 HEX value $00 to $03, $FF HEX value $00: Monitorauflösung 400x240 HEX value $01: Monitorauflösung 640x280 HEX value $02: Monitorauflösung 800x480 HEX value $03: Monitorauflösung 1280x480 HEX value $FF: Monitorauflösung ungültig |
| STAT_AUFLOESUNG_STRING | string | Status der Auflösung von Fond-Monitor 1 value 400x240 value 640x280 value 800x480 value 1280x480 value UNGÜLTIG: Monitorauflösung ungültig |
| STAT_HELLIGKEIT | int | Status der Helligkeit von Fond-Monitor 1 HEX value $00 to $FF value $00: min. Monitorhelligkeit value $FE: max. Monitorhelligkeit value $FF: Helligkeitsstatus ungültig |
| STAT_HELLIGKEIT_STRING | string | Status der Helligkeit von Fond-Monitor 1 value 0x00: min. Monitorhelligkeit value 0xFE: max. Monitorhelligkeit value UNGÜLTIG: Helligkeitsstatus ungültig |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |

<a id="job-status-parameter-fomo-2"></a>
### STATUS_PARAMETER_FOMO_2
...
| Name | Type | Comment |
| --- | --- | --- |
| STAT_KLAPP | int | Klappstatus von Fond-Monitor 2 HEX value $00 to $01, $FF HEX value $01: Fond-Monitor 2 ausgeklappt HEX value $00: Fond-Monitor 2 eingeklappt HEX value $FF: Klappstatus ungültig |
| STAT_KLAPP_STRING | string | Klappstatus von Fond-Monitor 2 value AUSGEKLAPPT: Fond-Monitor 2 ausgeklappt value EINGEKLAPPT: Fond-Monitor 2 eingeklappt value UNGÜLTIG:	   Klappstatus ungültig |
| STAT_BILDANZEIGE | int | Status der Bildanzeige von Fond-Monitor 2 HEX value $00 to $01, $FF HEX value $00: Fond-Monitor 2 zeigt kein Bild an HEX value $01: Fond-Monitor 2 zeigt Bild an HEX value $FF: Bildanzeigestatus ungültig |
| STAT_BILDANZEIGE_STRING | string | Status der Bildanzeige von Fond-Monitor 2 value BILD WIRD NICHT ANGEZEIGT: Fond-Monitor 2 zeigt kein Bild an value BILD WIRD ANGEZEIGT: Fond-Monitor 2 zeigt Bild an value UNGÜLTIG: Bildanzeigestatus ungültig |
| STAT_BEREITSCHAFT | int | Status der Anzeigebereitschaft von Fond-Monitor 2 HEX value $00 to $01, $FF HEX value $00: Fond-Monitor 2 ist nicht anzeigebereit HEX value $01: Fond-Monitor 2 ist anzeigebereit HEX value $FF: Bereitschaftsstatus ungültig |
| STAT_BEREITSCHAFT_STRING | string | Status der Anzeigebereitschaft von Fond-Monitor 2 value KEINE ANZEIGEBEREITSCHAFT: Fond-Monitor 2 ist nicht anzeigebereit value ANZEIGEBEREITSCHAFT: Fond-Monitor 2 ist anzeigebereit value UNGÜLTIG: Bereitschaftsstatus ungültig |
| STAT_AUFLOESUNG | int | Status der Auflösung von Fond-Monitor 2 HEX value $00 to $03, $FF HEX value $00: Monitorauflösung 400x240 HEX value $01: Monitorauflösung 640x280 HEX value $02: Monitorauflösung 800x480 HEX value $03: Monitorauflösung 1280x480 HEX value $FF: Monitorauflösung ungültig |
| STAT_AUFLOESUNG_STRING | string | Status der Auflösung von Fond-Monitor 2 value 400x240 value 640x280 value 800x480 value 1280x480 value UNGÜLTIG: Monitorauflösung ungültig |
| STAT_HELLIGKEIT | int | Status der Helligkeit von Fond-Monitor 2 HEX value $00 to $FF value $00: min. Monitorhelligkeit value $FE: max. Monitorhelligkeit value $FF: Helligkeitsstatus ungültig |
| STAT_HELLIGKEIT_STRING | string | Status der Helligkeit von Fond-Monitor 2 value 0x00: min. Monitorhelligkeit value 0xFE: max. Monitorhelligkeit value UNGÜLTIG: Helligkeitsstatus ungültig |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
<a id="job-status-rse-variante"></a>
### STATUS_RSE_VARIANTE
...
| Name | Type | Comment |
| --- | --- | --- |
| STAT_RSE_VARIANTE | int | Status der Variante des RSE-SGs HEX value $00 to $01 HEX value $00: RSE Mid HEX value $01: RSE Mid+ |
| STAT_RSE_VARIANTE_TEXT | string | Status der Variante des RSE-SGs value RSE Mid:  RSE Mid value RSE Mid+: RSE Mid+ |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
KWP2000: $31 StartRoutineByLocalIdentifier $XX STEU_FOMO_1 $YY STEU_FOMO_2

#### Arguments

| Name | Type | Comment |
| --- | --- | --- |
| STEU_FOMO_1 | int | HEX value $00 to $01 HEX value $00: Fond-Monitor 1 ausschalten HEX value $01: Fond-Monitor 1 einschalten |
| STEU_FOMO_2 | int | HEX value $00 to $01 HEX value $00: Fond-Monitor 2 ausschalten HEX value $01: Fond-Monitor 2 einschalten |
...
| Name | Type | Comment |
| --- | --- | --- |
| STEU_ENTSOURCE | int | neue gewünschte Entertainmentquelle HEX value $00 to $02 HEX value $00: Laufwerk HEX value $01: AUX HEX value $02: TV (optional, nur bei RSE Mid+) |
...
KWP2000: $31 StartRoutineByLocalIdentifier $XX STEU_AKTIVE_SPRACHE

#### Arguments

| Name | Type | Comment |
| --- | --- | --- |
| STEU_AKTIVE_SPRACHE | int | neue aktive Sprache des OSDs HEX value $01 to $03 HEX value $01: MMI-Leitsprache HEX value $02: MMI-Nebensprache 1 HEX value $03: MMI-Nebensprache 2 |
...
<a id="job-status-uic-eeprom-layout"></a>
### _STATUS_UIC_EEPROM_LAYOUT
...
| Name | Type | Comment |
| --- | --- | --- |
| STAT_UIC_EEPROM_LAYOUT_VERSION | string | aktuelle UIC Eeprom Layout Version (SW) |
| STAT_UIC_EEPROM_LAYOUT | string | aktuelles UIC Eeprom Layout |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
- [IARTTEXTEINDIVIDUELL](#table-iarttexteindividuell) (13 × 2)
...
- [FAHRZEUGSTATUS](#table-fahrzeugstatus) (1 × 9)
...
| --- | --- | --- | --- | --- |
| default | 0x01 | 0x02 | Fahrzeugstatus | - |
...
| 0x50 | Fahrzeugstatus 1 | hex | - | unsigned char | - | - | - | - |
| 0x51 | Fahrzeugstatus 2 | hex | - | unsigned char | - | - | - | - |
| 0x52 | Fahrzeugstatus 3 | hex | - | unsigned char | - | - | - | - |
| 0x53 | Fahrzeugstatus 4 | hex | - | unsigned char | - | - | - | - |
| 0x54 | Fahrzeugstatus 5 | hex | - | unsigned char | - | - | - | - |
| 0x55 | Fahrzeugstatus 6 | hex | - | unsigned char | - | - | - | - |
| 0x56 | Fahrzeugstatus 7 | hex | - | unsigned char | - | - | - | - |
| 0x57 | Fahrzeugstatus 8 | hex | - | unsigned char | - | - | - | - |
...
| 0xA7EF | 0x000F | 0x0010 | 0xFFFF | 0xFFFF |
| 0xA7F1 | 0x000C | 0xFFFF | 0xFFFF | 0xFFFF |
| 0xA7F3 | 0x000D | 0x000E | 0xFFFF | 0xFFFF |
| 0xA7F4 | 0x0013 | 0xFFFF | 0xFFFF | 0xFFFF |
| 0xA7F5 | 0x0011 | 0x0012 | 0x0014 | 0xFFFF |
...
| 0x000F | RSE_SG Diagnose: Kurzschluss Kl.30 Video In |
| 0x0010 | RSE_SG Diagnose: Kurzschluss Kl.31 Video In |
| 0x0011 | RSE_SG Diagnose: Kurzschluss Kl.30 Audio In |
| 0x0012 | RSE_SG Diagnose: Kurzschluss Kl.31 Audio In |
| 0x0013 | RSE_SG Diagnose: Codierung auf nicht vorhandene Sprachversion |
| 0x0014 | RSE_SG Diagnose: KHM defekt oder Leitungsfehler |
...
| ORT | UW1_NR | UW2_NR | UW3_NR | UW4_NR |
| --- | --- | --- | --- | --- |
| 0x9314 | 0x01 | 0x02 | Fahrzeugstatus | Trimedia_Fehler |
| 0x9315 | 0x01 | 0x02 | Fahrzeugstatus | SWDL_Fehler |
| 0x9316 | 0x01 | 0x02 | Fahrzeugstatus | Betriebsspannungen_Fehler |
| 0x9317 | 0x01 | 0x02 | Fahrzeugstatus | VGC_STATE_Fehler |
| default | 0x01 | 0x02 | Fahrzeugstatus | - |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 8 | 0x50 | 0x51 | 0x52 | 0x53 | 0x54 | 0x55 | 0x56 | 0x57 |
