...
- [LESEN_TELEFONNUMMERN](#job-lesen-telefonnummern) - Auslesen der im MASK gespeicherten Telefonnummern für - Bereitschaftsdienst - Heimathändler - Passo - Hotline KWP2000: $21 readDataByLocalIdentifier $A2 recordLocalIdentifier Modus  : Default
...
| Name | Type | Comment |
| --- | --- | --- |
| LAENDERVARIANTE_TUNER | string |  |
| TP_FUNKTION | string |  |
| RDS_AF_FUNKTION | string |  |
| PTY_TABELLE | string |  |
| REGIONALISIERUNG | string |  |
| HIGH_CUT | string |  |
| SENDER_TAB | string |  |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| Name | Type | Comment |
| --- | --- | --- |
| RET_MODUS | unsigned char | Aktuell aktiver Flottenmodus 0x00	Keine NAVI-DVD Sperrung 0x01	NAVI-DVD ist mit PIN-Code gesperrt 0x02	NAVI-DVD ist immer gesperrt. |
| RET_MODUS_TEXT | string | Aktuell aktiver Flottenmodus als Text (s.o.) Werte aus table TFlottenmodus |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
- [TLAUFWERKSVARIANTE](#table-tlaufwerksvariante) (4 × 2)
...
| INQY_LEN | INQY_DATA | RESP_LEN | RESP_DATA | COMMENT |
| --- | --- | --- | --- | --- |
| 08 | 7100022201020000 | 0x0B | 0000646464570020FF03FF | Climate.AirConditionDRStatus |
| 08 | 7100022301020000 | 0x0B | 0000FF6463FF0320FF03FF | Climate.AirConditionPSStatus |
| 08 | 7100020001020000 | 0x03 | 000200 | Climate.ACFront |
| 08 | 7100020101020000 | 0x03 | 000200 | Climate.ACFrontFunctions |
| 08 | 7100040001020000 | 0x0A | 03030102010000020007 | Climate.ConfigIHKA |
| 08 | 05000C1001020000 | 0x01 | 03 | Vehicle.ConfigZV |
| 08 | 05000C3501020000 | 0x06 | 000100000101 | Vehicle.ConfigLM |
| 08 | 05000C2001020000 | 0x06 | 000100000101 | Vehicle.ConfigDWA |
| 05 | 2200020301 | 0x01 | FA | AudioAmplifier.Treble |
| 05 | 2200020201 | 0x01 | 06 | AudioAmplifier.Bass |
| 08 | 1000020201020000 | 0x03 | 060003 | MMI.CurrentUnits |
| 05 | 2000022201 | 0x01 | 09 | AM.Bass |
| 08 | 7100022202020000 | 0x0B | 0000646464570020FF03FF | Climate.AirConditionDRStatus |
| 08 | 7100022302020000 | 0x0B | 0000FF6463FF0320FF03FF | Climate.AirConditionPSStatus |
| 08 | 7100020002020000 | 0x03 | 000200 | Climate.ACFront |
| 08 | 7100020102020000 | 0x03 | 000200 | Climate.ACFrontFunctions |
| 08 | 7100040002020000 | 0x0A | 03030102010000020007 | Climate.ConfigIHKA |
| 08 | 05000C1002020000 | 0x01 | 03 | Vehicle.ConfigZV |
| 08 | 05000C3502020000 | 0x06 | 000100000101 | Vehicle.ConfigLM |
| 08 | 05000C2002020000 | 0x06 | 000100000101 | Vehicle.ConfigDWA |
| 05 | 2200020302 | 0x01 | Fb | AudioAmplifier.Treble |
| 05 | 2200020202 | 0x01 | 03 | AudioAmplifier.Bass |
| 08 | 1000020202020000 | 0x03 | 060003 | MMI.CurrentUnits |
| 05 | 2000022202 | 0x01 | 02 | AM.Bass |
