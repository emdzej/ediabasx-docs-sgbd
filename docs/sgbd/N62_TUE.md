...
- [STEUERN_MIL](#job-steuern-mil) - Ansteuerung MIL (MIL blinken)
- [STEUERN_MIL_AUS](#job-steuern-mil-aus) - Beenden der MIL-Ansteuerung
- [STEUERN_EML](#job-steuern-eml) - Stellgliedansteuerung EML
- [STEUERN_EML_AUS](#job-steuern-eml-aus) - Beenden der Stellgliedansteuerung EML
...
- [STEUERN_DMTLH](#job-steuern-dmtlh) - Ansteuerung DMTL-Heizung (nur bei US-Fahrzeugen)
- [STEUERN_DMTLH_AUS](#job-steuern-dmtlh-aus) - Beenden Ansteuerung DMTL-Heizung
...
- [STEUERN_EVAUSBL_AUS](#job-steuern-evausbl-aus) - Ende Systemtest Einspritzventile ausblenden
- [STATUS_MESSWERTE](#job-status-messwerte) - Auslesen von Messwerten
- [STATUS_MESSWERTE_OEL](#job-status-messwerte-oel) - Auslesen von Oelwerten
...
- [STEUERN_VVT](#job-steuern-vvt) - Stellgliedansteuerung VVT Für die VVT-Ansteuerung gibt es 2 Möglichkeiten: (1) Anst. durch Verstellung der NW auf einen vorgegebenen Winkel (2) Anst. durch Fahren einer Rampe von NW-Position f. LL -&gt; Maxhub -&gt; LL
- [STEUERN_VVT_AUS](#job-steuern-vvt-aus) - beenden Stellgliedansteuerung VVT
- [STEUERN_VVT_ENABLE](#job-steuern-vvt-enable) - Generieren eines Testsignals auf der VVT-Enable-Leitung
...
- [STEUERN_KVA](#job-steuern-kva) - Korrekturfaktor Kraftstoffverbrauch kva_korr programmieren
- [STATUS_READINESS](#job-status-readiness) - Auslesen des Readinessbyte
- [STATUS_FGR](#job-status-fgr) - Auslesen der FGR-Stati
...
- [STATUS_LRP](#job-status-lrp) - Auslesen Funktionseingriffe bei der Laufruheprüfung
- [STEUERN_LRP](#job-steuern-lrp) - Funktionseingriffe für die Laufruheprüfung vorgeben
- [STEUERN_LRP_STOP](#job-steuern-lrp-stop) - Vorgabe Funktionseingriffe für die Laufruheprüfung stoppen
- [STEUERN_LRP_PROG](#job-steuern-lrp-prog) - Prüfeingriffe für die Laufruheprüfung programmieren
- [STATUS_MESSWERTE_LRP](#job-status-messwerte-lrp) - Ausgelesen der Messwerte Laufruheprüfung
...
- [STATUS_FASTA10](#job-status-fasta10) - Auslesen FASTA-Messwertblock 10
...
- [STATUS_DIAGNOSE_LSV](#job-status-diagnose-lsv) - Status LSV-Diagnose auslesen
...
- [STATUS_MINHUB](#job-status-minhub) - Auslesen VVT-Minhub
- [STEUERN_MINHUB](#job-steuern-minhub) - VVT-Minhub vorgeben
- [STEUERN_MINHUB_PROGRAMM](#job-steuern-minhub-programm) - Programmieren VVT-Minhub
- [STATUS_BANKABGLEICH](#job-status-bankabgleich) - Auslesen des VVT-Bankabgleiches
- [STEUERN_BANKABGLEICH_PROGRAMM](#job-steuern-bankabgleich-programm) - Programmieren des Winkeloffset Excenterwelle (ofwnktest) Verstellbereich Bank1: 0°...5° Verstellbereich Bank2: 0°...-5°
...
- [STATUS_DIGITAL](#job-status-digital) - Auslesen der Schalter- und Funktionsstati
...
| --- | --- | --- |
| JOB_STATUS | string | "OKAY", wenn fehlerfrei |
| STAT_NOMINATOR_ANWS | int | Nominator NKW-Auslaß Bank1 |
| STAT_DENOMINATOR_ANWS | int | Denominator NKW-Auslaß Bank1 |
| STAT_NOMINATOR_ANWS2 | int | Nominator NKW-Auslaß Bank2 |
| STAT_DENOMINATOR_ANWS2 | int | Denominator NKW-Auslaß Bank2 |
| STAT_NOMINATOR_DMTK | int | Nominator Tankdiagnose Feinstleck |
| STAT_DENOMINATOR_DMTK | int | Denominator Tankdiagnose Feinstleck |
| STAT_NOMINATOR_DMTL | int | Nominator Tankdiagnose Modulfehler |
| STAT_DENOMINATOR_DMTL | int | Denominator Tankdiagnose Modulfehler |
| STAT_NOMINATOR_DYLSU | int | Nominator LSU dynamisch zu langsam Bank1 |
| STAT_DENOMINATOR_DYLSU | int | Denominator LSU dynamisch zu langsam Bank1 |
| STAT_NOMINATOR_DYLSU2 | int | Nominator LSU dynamisch zu langsam Bank2 |
| STAT_DENOMINATOR_DYLSU2 | int | Denominator LSU dynamisch zu langsam Bank2 |
| STAT_NOMINATOR_ENWS | int | Nominator NKW-Einlaß Bank1 |
| STAT_DENOMINATOR_ENWS | int | Denominator NKW-Einlaß Bank1 |
| STAT_NOMINATOR_ENWS2 | int | Nominator NKW-Einlaß Bank2 |
| STAT_DENOMINATOR_ENWS2 | int | Denominator NKW-Einlaß Bank2 |
| STAT_NOMINATOR_KAT | int | Nominator Katalysator Bank1 |
| STAT_DENOMINATOR_KAT | int | Denominator Katalysator Bank1 |
| STAT_NOMINATOR_KAT2 | int | Nominator Katalysator Bank2 |
| STAT_DENOMINATOR_KAT2 | int | Denominator Katalysator Bank2 |
| STAT_NOMINATOR_PLLSU | int | Nominator Plausibilität LSU Bank1 |
| STAT_DENOMINATOR_PLLSU | int | Denominator Plausibilität LSU Bank1 |
| STAT_NOMINATOR_PLLSU2 | int | Nominator Plausibilität LSU Bank2 |
| STAT_DENOMINATOR_PLLSU2 | int | Denominator Plausibilität LSU Bank2 |
| STAT_NOMINATOR_TES | int | Nominator Tankentlüftungssystem |
| STAT_DENOMINATOR_TES | int | Denominator Tankentlüftungssystem |
| STAT_NOMINATOR_TESG | int | Nominator Tankdiagnose Grobleck |
| STAT_DENOMINATOR_TESG | int | Denominator Tankdiagnose Grobleck |
| STAT_NOMINATOR_ULSU | int | Nominator Spannungsüberwachung LSU Bank1 |
| STAT_DENOMINATOR_ULSU | int | Denominator Spannungsüberwachung LSU Bank1 |
| STAT_NOMINATOR_ULSU2 | int | Nominator Spannungsüberwachung LSU Bank2 |
| STAT_DENOMINATOR_ULSU2 | int | Denominator Spannungsüberwachung LSU Bank2 |
| STAT_NOMINATOR_ENWSAD | int | Nominator Einlassnockenwellensteuerung Anschlagsadaption |
| STAT_DENOMINATOR_ENWSAD | int | Denominator Einlassnockenwellensteuerung Anschlagsadaption |
| STAT_NOMINATOR_ENWSAD2 | int | Nominator Einlassnockenwellensteuerung 2 Anschlagsadaption |
| STAT_DENOMINATOR_ENWSAD2 | int | Denominator Einlassnockenwellensteuerung 2 Anschlagsadaption |
| STAT_NOMINATOR_ANWSAD | int | Nominator Auslassnockenwellensteuerung Anschlagsadaption |
| STAT_DENOMINATOR_ANWSAD | int | Denominator Auslassnockenwellensteuerung Anschlagsadaption |
| STAT_NOMINATOR_ANWSAD2 | int | Nominator Auslassnockenwellensteuerung 2 Anschlagsadaption |
| STAT_DENOMINATOR_ANWSAD2 | int | Denominator Auslassnockenwellensteuerung 2 Anschlagsadaption |
| STAT_NOMINATOR_NWEKW | int | Nominator Zuordnung Einlassnockenwelle zu Kurbelwelle |
| STAT_DENOMINATOR_NWEKW | int | Denominator Zuordnung Einlassnockenwelle zu Kurbelwelle |
| STAT_NOMINATOR_NWEKW2 | int | Nominator Zuordnung Einlassnockenwelle Bank2 zu Kurbelwelle |
| STAT_DENOMINATOR_NWEKW2 | int | Denominator Zuordnung Einlassnockenwelle Bank2 zu Kurbelwelle |
| STAT_NOMINATOR_NWAKW | int | Nominator Zuordnung Auslassnockenwelle zu Kurbelwelle |
| STAT_DENOMINATOR_NWAKW | int | Denominator Zuordnung Auslassnockenwelle zu Kurbelwelle |
| STAT_NOMINATOR_NWAKW2 | int | Nominator Zuordnung Auslassnockenwelle Bank2 zu Kurbelwelle |
| STAT_DENOMINATOR_NWAKW2 | int | Denominator Zuordnung Auslassnockenwelle Bank2 zu Kurbelwelle |
| STAT_NOMINATOR_DVPMN | int | Numerator Leistungsbegrenzung |
| STAT_DENOMINATOR_DVPMN | int | Denominator Leistungsbegrenzung |
| STAT_NOMINATOR_MNHUB | int | Numerator Minhub |
| STAT_DENOMINATOR_MNHUB | int | Denominator Minhub |
| STAT_NOMINATOR_VVTLU | int | Numerator Lagereglerüberwachung VVT-Steller |
| STAT_DENOMINATOR_VVTLU | int | Denominator Lagereglerüberwachung VVT-Steller |
| STAT_NOMINATOR_HFMPL | int | Numerator Plausibilisierung Luftmassenmesser |
| STAT_DENOMINATOR_HFMPL | int | Denominator Plausibilisierung Luftmassenmesser |
| STAT_NOMINATOR_DPSPL | int | Numerator Plausibilisierung Drucksensor Saugrohr |
| STAT_DENOMINATOR_DPSPL | int | Denominator Plausibilisierung Drucksensor Saugrohr |
| STAT_NOMINATOR_TEVPL | int | Numerator Plausibilisierung Tankentlüftunghsventil |
| STAT_DENOMINATOR_TEVPL | int | Denominator Plausibilisierung Tankentlüftungsventil |
| STAT_NOMINATOR_HSVS | int | Numerator Heizung Lambdasonde vor Kat Start |
| STAT_DENOMINATOR_HSVS | int | Denominator Heizung Lambdasonde vor Kat Start |
| STAT_NOMINATOR_HSVS2 | int | Numerator Heizung Lambdasonde vor Kat Start Bank2 |
| STAT_DENOMINATOR_HSVS2 | int | Denominator Heizung Lambdasonde vor Kat Start Bank2 |
| _TEL_AUFTRAG | binary | Hex-Auftrag an SG |
...
| STAT_SBBHK2_EIN | int | Status B_sbbhk2 (Bedingung Lambdasondenbereitschaft hinter Kat Bank2) |
| STAT_SBBHK_EIN | int | Status B_sbbhk (Bedingung Lambdasondenbereitschaft hinter Kat) |
| STAT_SBBVK2_EIN | int | Status B_sbbvk2 (Bedingung Lambdasondenbereitschaft vor Kat Bank2) |
| STAT_SBBVK_EIN | int | Status B_sbbvk (Bedingung Lambdasondenbereitschaft vor Kat) |
| STAT_LR2_EIN | int | Status B_lr2 (Bedingung Lambdaregelung Bank2 ein) |
| STAT_LR_EIN | int | Status B_lr (Bedingung Lambdaregelung ein) |
| STAT_KD_EIN | int | Status B_kd (Bedingung KickDown ein) |
| STAT_PN_EIN | int | Status B_pn (Bedingung Park-Neutral ein) |
...
| --- | --- | --- |
| JOB_STATUS | string | "OKAY", wenn fehlerfrei |
| STAT_EXWNK_AUSGANGSPOS_WERT | real | Excenterwinkel exwinki_w bei Ausgangsposition Verstellung NW über Rampe = 0, wenn keine Rampe gefahren wird |
| STAT_EXWNK_AUSGANGSPOS_EINH | string | Einheit exwinki_w [Grad] = 0, wenn keine Rampe gefahren wird |
| STAT_EXWNK_MAXVERSTELLUNG_WERT | real | Excenterwinkel exwinki_w bei Maximalverstellung NW über Rampe = 0, wenn keine Rampe gefahren wird |
| STAT_EXWNK_MAXVERSTELLUNG_EINH | string | Einheit exwinki_w [Grad] = 0, wenn keine Rampe gefahren wird |
| STAT_EXWNK_ENDPOS_WERT | real | Excenterwinkel exwinki_w bei Endposition Verstellung NW über Rampe = 0, wenn keine Rampe gefahren wird |
| STAT_EXWNK_ENDPOS_EINH | string | Einheit exwinki_w [Grad] = 0, wenn keine Rampe gefahren wird |
| _TEL_AUFTRAG | binary | Hex-Auftrag an SG |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| STAT_HSVE2_EIN | int | Bedingung Heizung LS vor Kat Bank2 ein (B_hsve) |
| STAT_HSHE_EIN | int | Bedingung Heizung LS hinter Kat ein (B_hshe) |
| STAT_HSHE2_EIN | int | Bedingung Heizung LS hinter Kat Bank2 ein (B_hshe2) |
...
| STAT_DNSLBV_WERT | real | Abgleichswert LL bei niedriger UBatt |
...
- [FUMWELTMATRIX](#table-fumweltmatrix) (282 × 5)
- [FUMWELTTEXTE](#table-fumwelttexte) (166 × 9)
- [FARTTYP](#table-farttyp) (270 × 5)
