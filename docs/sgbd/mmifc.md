...
| Field | Value |
| --- | --- |
| ECU | MMI-Fond CAN Zugang (MMIFC) |
| ORIGIN | BMW EE-45 Schreiber |
| REVISION | 1.00 |
| AUTHOR | BMW EE-45 Schreiber, BMW TI-430 Gelfert |
| COMMENT | Fuer die komplette Diagnose des MMI/GT Fond ist die SGBD mmifond notwendig |
| PACKAGE | 1.32 |
| SPRACHE | deutsch |
...
- [TMOSTDEVICE](#table-tmostdevice) (18 × 2)
...
| ORT | ORTTEXT |
| --- | --- |
| 0xA5C8 | Fehler MOST/CAN-Gateway |
| 0xA5C9 | Fehler LCD/Inverter MMIGT |
| 0xA5CB | FeTraWe-Mode für MOST-Verbund ist aktiv |
| 0xD584 | CAN-Low, Physikalischer Busfehler |
| 0xD587 | Controller, Bus off |
| 0xD58E | Obwohl Shutdown(Execute) geschickt wurde ging das Licht nicht aus. (Error_Light_Not_Off). |
| 0xD590 | Ringbruchdiagnose wurde durchgefuehrt (Error_Ring_Diagnose). |
| 0xD591 | Lange und/oder haeufige Unlocks (Error_Unlock_Long). |
| 0xD592 | Ein Device hat sich wegen Uebertemperatur abgeschaltet (Error_Temp_Shutdown). |
...
| --- | --- | --- | --- | --- |
| 0xA5C8 | 0x01 | 0x03 | 0x04 | -- |
| 0xA5C9 | 0x01 | 0x02 | 0x03 | 0x04 |
| 0xD590 | 0x21 | -- | -- | -- |
| default | -- | -- | -- | -- |
...
| WERT | UWTEXT |
| --- | --- |
| 0xA5D0 | Fehler IPC Startup (DTC 0xA5D0) |
| 0xA5D1 | Fehler IPC Operation (DTC 0xA5D1) |
| 0xA5D2 | Fehler Laden FPGA (DTC 0xA5D2) |
| 0xA5D3 | Fehler OS8104 (DTC 0xA5D3) |
| 0xA5D4 | Fehler FLASH-ROM (DTC 0xA5D4) |
| 0xA5D5 | Fehler RAM (DTC 0xA5D5) |
| 0xA5D6 | Fehler EEPROM (DTC 0xA5D6) |
| 0xA5D7 | MMI-Rechner Temperatur zu hoch (DTC 0xA5D7) |
| 0xA5DA | Fehler Ausgang FPGA (DTC 0xA5DA) |
...
| ORT | ORTTEXT |
| --- | --- |
| 0xA5D0 | Fehler IPC Startup |
| 0xA5D1 | Fehler IPC Operation |
| 0xA5D2 | Fehler Laden FPGA |
| 0xA5D3 | Fehler OS8104 |
| 0xA5D4 | Fehler FLASH-ROM |
| 0xA5D5 | Fehler RAM |
| 0xA5D6 | Fehler EEPROM |
| 0xA5D7 | MMI-Rechner Temperatur zu hoch |
| 0xA5DA | Fehler Ausgang FPGA |
