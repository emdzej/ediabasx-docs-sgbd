...
| --- | --- |
| ECU | KOMBI E60 |
| ORIGIN | BMW EE-42 Janus Cogiel |
| REVISION | 0.2 |
| AUTHOR | BMW EE-42 Janus Cogiel |
| COMMENT | SGBD fuer E60 Kombi |
| PACKAGE | 1.10 |
| SPRACHE | deutsch |
...
- [SG_RESET_OHNE_UHR_DATUM](#job-sg-reset-ohne-uhr-datum) - Steuergeraete Reset ausloesen Uhrzeit und Datum bleibt dabei im Kombi erhalten KWP2000: $11, $02 :Soll noch geaendert werden
- [C_CHECKSUMME](#job-c-checksumme) - Checksumme generieren und in BINAER_BUFFER schreiben Optionaler Codierjob
- [STEUERN_LEUCHTE](#job-steuern-leuchte) - Kontrolleuchten einzeln ansteuern Fuer Service-und Testzwecke Uebergeben wird ein Argument im Bereich von 0x00-0xFF Dieser Argument definiert die Leuchte Im Kombi LH Teil 3.1 Kapitel "Diagnose" sind die Übergabeparameter des Diagnosebefehls $30 $07 ausführlich dokumentiert KWP2000: $30 $07 InputOutputControlByLocalIdentifier Modus  : Default
- [STEUERN_BLINKER](#job-steuern-blinker) - Blinker ansteuern, fuer Service-und Testzwecke Es muessen immer alle zwei Argumente übergeben werden Dieser Jobs muss durch STEUERN_BLINKER_AUS beendet werden KWP2000: $30 $2B  Beschreibung der Arumente: BYTE 0: xxxx xx00 = Blinker statisch ein xxxx xx01 = Normalblinken xxxx xx10 = Defektblinken xxxx xx11 = Doppelblinken  BYTE 1: xxxx xx00 = Beide Blinker aus xxxx xx01 = Rechter Blinker xxxx xx10 = Linker Blinker xxxx xx11 = Beide Blinker
...
- [STEUERN_IO_FUJITSU](#job-steuern-io-fujitsu) - I/O Ports des Fujitsu schreiben, fuer Service-und Testzwecke Uebergeben werden zwei Argumente im Bereich von 0x00-0xFF Dieser Argumente definieren den Port(1-9) und Pin(0-7) KWP2000: $30,$29,$06, InputOutputControlByLocalIdentifier Modus  : Default
- [STEUERN_IO_FUJITSU_ENDE](#job-steuern-io-fujitsu-ende) - Der Job gibt die Kontrolle wieder an das Kombi zurueck KWP2000: $30, $29, $00
- [LESEN_IO_FUJITSU](#job-lesen-io-fujitsu) - I/O Ports des Fujitsu lesen, fuer Service-und Testzwecke KWP2000: $30,$29,$01, InputOutputControlByLocalIdentifier
- [STEUERN_SELBSTTEST_EIN](#job-steuern-selbsttest-ein) - Schaltet den Selbttest ein Beschreibung der Arumente BYTE 0: xxxx xxx1 = Test ein xxxx xxx0 = Test aus xxxx xx1x = Dauerlauf xxxx xx0x = Nur 1 Durchlauf KWP2000: $31, $23
...
- [STEUERN_DREHZAHL](#job-steuern-drehzahl) - DZM in U/min vorgeben KWP2000: $30 InputOutputControlByLocalIdentifier
...
- [STEUERN_VWF_BENZIN](#job-steuern-vwf-benzin) - Drehzahl fuer DZM-Vorwarnfeld-Zeiger in U/min vorgeben KWP2000: $30 InputOutputControlByLocalIdentifier
- [STEUERN_VWF_DIESEL](#job-steuern-vwf-diesel) - Drehzahl fuer DZM-Vorwarnfeld-Zeiger in U/min vorgeben KWP2000: $30 InputOutputControlByLocalIdentifier
- [STEUERN_VWF_AUS](#job-steuern-vwf-aus) - Schaltet den VWF-Zeiger-Vorgabemodus wieder aus KWP2000: $30, $25, $00
- [STATUS_TANKINHALT_LESEN](#job-status-tankinhalt-lesen) - Literwerte der Tank Hebelgeber 1+2, Summenwert ungedämpft und gedämpft KWP2000: $21,$0A
- [UHRZEIT_DATUM_STELLEN](#job-uhrzeit-datum-stellen) - Uhrzeit und Datum stellen KWP2000: $3B
- [STATUS_WASCHWASSER](#job-status-waschwasser) - Digitalen Eingang Waschwasser lesen Fuer Service-und Testzwecke KWP2000: $30,$94,$01, $0D -&gt; InputOutputControlByLocalIdentifier
- [STATUS_KUEHLMITTELSTAND](#job-status-kuehlmittelstand) - Digitalen Eingang Kuehlmittelstand lesen Fuer Service-und Testzwecke KWP2000: $30,$94,$01, $03 -&gt; InputOutputControlByLocalIdentifier
- [STATUS_PARKBREMSE](#job-status-parkbremse) - Digitalen Eingang Parkbremse lesen Fuer Service-und Testzwecke KWP2000: $30,$94,$01, $03 -&gt; InputOutputControlByLocalIdentifier
- [STATUS_A_TMEMP_LESEN](#job-status-a-tmemp-lesen) - A-Temp, Anzeige und Rohwert lesen Fuer Service-und Testzwecke KWP2000: $30,$94,$01, $03 -&gt; InputOutputControlByLocalIdentifier
...
Steuergeraete Reset ausloesen Uhrzeit und Datum bleibt dabei im Kombi erhalten KWP2000: $11, $02 :Soll noch geaendert werden
...
Kontrolleuchten einzeln ansteuern Fuer Service-und Testzwecke Uebergeben wird ein Argument im Bereich von 0x00-0xFF Dieser Argument definiert die Leuchte Im Kombi LH Teil 3.1 Kapitel "Diagnose" sind die Übergabeparameter des Diagnosebefehls $30 $07 ausführlich dokumentiert KWP2000: $30 $07 InputOutputControlByLocalIdentifier Modus  : Default
...
Blinker ansteuern, fuer Service-und Testzwecke Es muessen immer alle zwei Argumente übergeben werden Dieser Jobs muss durch STEUERN_BLINKER_AUS beendet werden KWP2000: $30 $2B  Beschreibung der Arumente: BYTE 0: xxxx xx00 = Blinker statisch ein xxxx xx01 = Normalblinken xxxx xx10 = Defektblinken xxxx xx11 = Doppelblinken  BYTE 1: xxxx xx00 = Beide Blinker aus xxxx xx01 = Rechter Blinker xxxx xx10 = Linker Blinker xxxx xx11 = Beide Blinker
...
<a id="job-steuern-io-fujitsu"></a>
### STEUERN_IO_FUJITSU

I/O Ports des Fujitsu schreiben, fuer Service-und Testzwecke Uebergeben werden zwei Argumente im Bereich von 0x00-0xFF Dieser Argumente definieren den Port(1-9) und Pin(0-7) KWP2000: $30,$29,$06, InputOutputControlByLocalIdentifier Modus  : Default

#### Arguments

| Name | Type | Comment |
| --- | --- | --- |
| BYTE0 | int | Angabe des Ports (0..9) |
...
<a id="job-steuern-io-fujitsu-ende"></a>
### STEUERN_IO_FUJITSU_ENDE

Der Job gibt die Kontrolle wieder an das Kombi zurueck KWP2000: $30, $29, $00
...
<a id="job-lesen-io-fujitsu"></a>
### LESEN_IO_FUJITSU

I/O Ports des Fujitsu lesen, fuer Service-und Testzwecke KWP2000: $30,$29,$01, InputOutputControlByLocalIdentifier
...
| Name | Type | Comment |
| --- | --- | --- |
| PORT_VALUE | int | Hex-Wert des Ports |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| _TEL_ANTWORT | binary | Antwort von SG |
...
Schaltet den Selbttest ein Beschreibung der Arumente BYTE 0: xxxx xxx1 = Test ein xxxx xxx0 = Test aus xxxx xx1x = Dauerlauf xxxx xx0x = Nur 1 Durchlauf KWP2000: $31, $23
...
| Name | Type | Comment |
| --- | --- | --- |
| BYTE0 | int | Geschwindigkeitsvorgabe in km/h (0..300 km/h) |
...
DZM in U/min vorgeben KWP2000: $30 InputOutputControlByLocalIdentifier

#### Arguments

| Name | Type | Comment |
| --- | --- | --- |
| BYTE0 | int | Drehzahlvorgabe in U/min |
...
<a id="job-steuern-vwf-benzin"></a>
### STEUERN_VWF_BENZIN

Drehzahl fuer DZM-Vorwarnfeld-Zeiger in U/min vorgeben KWP2000: $30 InputOutputControlByLocalIdentifier

#### Arguments

| Name | Type | Comment |
| --- | --- | --- |
| BYTE0 | int | Drehzahl in U/min |
...
Literwerte der Tank Hebelgeber 1+2, Summenwert ungedämpft und gedämpft KWP2000: $21,$0A
...
Uhrzeit und Datum stellen KWP2000: $3B
...
Digitalen Eingang Waschwasser lesen Fuer Service-und Testzwecke KWP2000: $30,$94,$01, $0D -&gt; InputOutputControlByLocalIdentifier
...
| Name | Type | Comment |
| --- | --- | --- |
| STAT_WASCHWASSER | int | 00 = Leer, 01 = Voll |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| _TEL_ANTWORT | binary | Antwort von SG |
...
Digitalen Eingang Kuehlmittelstand lesen Fuer Service-und Testzwecke KWP2000: $30,$94,$01, $03 -&gt; InputOutputControlByLocalIdentifier
...
| Name | Type | Comment |
| --- | --- | --- |
| STAT_KUEHLMITTELSTAND | int | 00 = Leer, 01 = Voll |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| _TEL_ANTWORT | binary | Antwort von SG |
...
Digitalen Eingang Parkbremse lesen Fuer Service-und Testzwecke KWP2000: $30,$94,$01, $03 -&gt; InputOutputControlByLocalIdentifier
...
<a id="job-status-a-tmemp-lesen"></a>
### STATUS_A_TMEMP_LESEN

A-Temp, Anzeige und Rohwert lesen Fuer Service-und Testzwecke KWP2000: $30,$94,$01, $03 -&gt; InputOutputControlByLocalIdentifier
...
| Name | Type | Comment |
| --- | --- | --- |
| STAT_A_TEMP_ANZEIGE | int | Anzeigewert der Aussentemperatur |
| STAT_A_TEMP_ROHWERT | int | Rohwert der Aussentemperatur |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| _TEL_ANTWORT | binary | Antwort von SG |
...
| Name | Type | Comment |
| --- | --- | --- |
| BLOCK_NR | unsigned int | HEX-Wert muß folgendermaßen eingegeben werden: 0x"Wert" |
...
- [FUMWELTMATRIX](#table-fumweltmatrix) (14 × 5)
...
| 0x9308 | HEBELGEBER1 |
| 0x9309 | HEBELGEBER2 |
| 0x930A | AUSSENTEMPERATUR |
| 0x930B | TEMPERATURFÜHLER_LCD |
| 0x930C | KURZSCHUSS_DISPLAYHEIZUNG |
| 0x930D | EEPROM: CHECKSUM ERROR CODING DATA BMW |
| 0x930E | EEPROM: CHECKSUM ERROR CODING DATA VDO |
| 0x930F | GWSZ_FEHLER_EEPROM |
| 0x9310 | GWSZ_FEHLER_CAS_ODER_KOMBI |
| 0x9311 | BORDNETZSPANNUNG, UEBERSPANNUNG ODER UNTERSPANNUNG |
...
| 0xA3B3 | CAN_ID_0BE_ERROR_Ausfall_Botschaft_ARS_Alive_Zaehler |
| 0xA3B4 | CAN_ID_21A_ERROR_Ausfall_Botschaft_Lampenzustand |
| 0xA3B5 | CAN_ID_???_ERROR_Ausfall_Botschaft_AFS |
...
| 0xA3BA | CAN_ID_211_ERROR_Ausfall_Botschaft_Alive_HUD |
...
| 0x17 | FAh INTERVALL VERKUERZUNG | 0/1 | - | 0x0080 | - | - | - | - |
