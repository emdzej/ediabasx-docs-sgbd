...
| COMMENT | RDC-SGBD fuer E65, E6x, E9x, E88, E70, E71, RR01, RR2, R56  |
| PACKAGE | 1.29 |
| SPRACHE | deutsch |
...
| STAT_TEST_EIGENRAD | int | Test-Eigenraderkennung wurde gestartet |
...
| STAT_REIFENDRUCKWERT_RE0_WERT | real | Reifendruckwert der RE0 Bereich: 0 bis 6,375 bar |
| STAT_REIFENDRUCKWERT_RE0_EINH | string | bar |
| STAT_REIFENTEMPERATURWERT_RE0_WERT | char | Reifentemperaturwert der RE0 Bereich: -40 bis 120 Grad C |
...
| STAT_BEFUELLDRUCKWERT_RE0_WERT | real | Befuelldruckwert der RE0 Bereich: 0 bis 6,375 bar |
| STAT_BEFUELLDRUCKWERT_RE0_EINH | string | bar |
| STAT_BEFUELLTEMPERATURWERT_RE0_WERT | char | Befuelltemperaturwert der RE0 Bereich: -40 bis 120 Grad C |
| STAT_BEFUELLTEMPERATURWERT_RE0_EINH | string | Grad C |
...
| STAT_REIFENDRUCKWERT_RE1_WERT | real | Reifendruckwert der RE1 Bereich: 0 bis 6,375 bar |
| STAT_REIFENDRUCKWERT_RE1_EINH | string | bar |
| STAT_REIFENTEMPERATURWERT_RE1_WERT | char | Reifentemperaturwert der RE1 Bereich: -40 bis 120 Grad C |
...
| STAT_BEFUELLDRUCKWERT_RE1_WERT | real | Befuelldruckwert der RE1 Bereich: 0 bis 6,375 bar |
| STAT_BEFUELLDRUCKWERT_RE1_EINH | string | bar |
| STAT_BEFUELLTEMPERATURWERT_RE1_WERT | char | Befuelltemperaturwert der RE1 Bereich: -40 bis 120 Grad C |
| STAT_BEFUELLTEMPERATURWERT_RE1_EINH | string | Grad C |
...
| STAT_REIFENDRUCKWERT_RE2_WERT | real | Reifendruckwert der RE2 Bereich: 0 bis 6,375 bar |
| STAT_REIFENDRUCKWERT_RE2_EINH | string | bar |
| STAT_REIFENTEMPERATURWERT_RE2_WERT | char | Reifentemperaturwert der RE2 Bereich: -40 bis 120 Grad C |
...
| STAT_BEFUELLDRUCKWERT_RE2_WERT | real | Befuelldruckwert der RE2 Bereich: 0 bis 6,375 bar |
| STAT_BEFUELLDRUCKWERT_RE2_EINH | string | bar |
| STAT_BEFUELLTEMPERATURWERT_RE2_WERT | char | Befuelltemperaturwert der RE2 Bereich: -40 bis 120 Grad C |
| STAT_BEFUELLTEMPERATURWERT_RE2_EINH | string | Grad C |
...
| STAT_REIFENDRUCKWERT_RE3_WERT | real | Reifendruckwert der RE3 Bereich: 0 bis 6,375 bar |
| STAT_REIFENDRUCKWERT_RE3_EINH | string | bar |
| STAT_REIFENTEMPERATURWERT_RE3_WERT | char | Reifentemperaturwert der RE3 Bereich: -40 bis 120 Grad C |
...
| STAT_BEFUELLDRUCKWERT_RE3_WERT | real | Befuelldruckwert der RE3 Bereich: 0 bis 6,375 bar |
| STAT_BEFUELLDRUCKWERT_RE3_EINH | string | bar |
| STAT_BEFUELLTEMPERATURWERT_RE3_WERT | char | Befuelltemperaturwert der RE3 Bereich: -40 bis 120 Grad C |
| STAT_BEFUELLTEMPERATURWERT_RE3_EINH | string | Grad C |
...
| STAT_REIFENDRUCKWERT_RE4_WERT | real | Reifendruckwert der RE4 Bereich: 0 bis 6,375 bar |
| STAT_REIFENDRUCKWERT_RE4_EINH | string | bar |
| STAT_REIFENTEMPERATURWERT_RE4_WERT | char | Reifentemperaturwert der RE4 Bereich: -40 bis 120 Grad C |
| STAT_REIFENTEMPERATURWERT_RE4_EINH | string | Grad C |
...
| STAT_BEFUELLDRUCKWERT_RE4_WERT | real | Befuelldruckwert der RE4 Bereich: 0 bis 6,375 bar |
| STAT_BEFUELLDRUCKWERT_RE4_EINH | string | bar |
| STAT_BEFUELLTEMPERATURWERT_RE4_WERT | char | Befuelltemperaturwert der RE4 Bereich: -40 bis 120 Grad C |
| STAT_BEFUELLTEMPERATURWERT_RE4_EINH | string | Grad C |
...
- [FARTTEXTEERWEITERT](#table-farttexteerweitert) (59 × 3)
...
- [SGZUSTAND](#table-sgzustand) (6 × 4)
- [KONFIGSTATUS](#table-konfigstatus) (3 × 4)
- [BANDMODE](#table-bandmode) (7 × 4)
