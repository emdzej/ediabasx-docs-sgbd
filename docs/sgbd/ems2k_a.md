...
- [AIF_LESEN](#job-aif-lesen) - Read the AIF record
...
- [STATUS_ANA_CAN_ASC1](#job-status-ana-can-asc1) - Read Analogue Input and Output States for LID 01 Read Anti Slip Control 1 analogue information
...
- [STATUS_ANA_CAN_DME_ZZ](#job-status-ana-can-dme-zz) - Read Analogue Input and Output States for LID 0A Read Market and Engine information
...
| Name | Type | Comment |
| --- | --- | --- |
| AIF_FG_NR | string | Fahrgestellnummer VIN |
| AIF_DATUM | string | Fertigungsdatum Production date |
| AIF_ZB_NR | string | Zusbaunummer Assembly number |
| AIF_BEHOERDEN_NR | long | Behoerdennummer Homologation test number |
| AIF_PROGG_NR | string | Programming unit serial number |
| AIF_WERKSCODE | string | Plant / Workshop number (Dealer number ?) |
| AIF_KM_STAND | long | km-Stand |
| AIF_PROG_STATUS | string | Program Status |
| _TEL_ANTWORT | binary | Hex-Antwort von SG ECU response packet |
| JOB_STATUS | string | Status der Kommunikation - OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
...
| JOB_STATUS | string | Status der Kommunikation - OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| _TEL_ANTWORT | binary | Hex-Antwort von SG ECU response packet |
| STAT_CAN_VS_BAS_WERT | real | Vehicle speed |
| STAT_CAN_VS_BAS_EINH | string |  |
| STAT_CAN_TQI_ASR_WERT | real | Torque reduction |
| STAT_CAN_TQI_ASR_EINH | string |  |
...
| STAT_CAN_VRD_LH_ASC_WERT | real | Left rear wheel speed |
| STAT_CAN_VRD_LH_ASC_EINH | string |  |
...
| JOB_STATUS | string | Status der Kommunikation - OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| _TEL_ANTWORT | binary | Hex-Antwort von SG ECU response packet |
| STAT_TQ_COR_STATE_WERT | real | Torque reduction status |
| STAT_TQ_COR_STATE_EINH | string |  |
| STAT_CAN_TQI_AV_WERT | real | Actual Engine torque (includes overrides) |
| STAT_CAN_TQI_AV_EINH | string |  |
| STAT_CAN_N_WERT | real | Engine speed |
| STAT_CAN_N_EINH | string |  |
| STAT_CAN_TQI_BAS_WERT | real | Maximum engine torque |
| STAT_CAN_TQI_BAS_EINH | string |  |
...
| JOB_STATUS | string | Status der Kommunikation - OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| _TEL_ANTWORT | binary | Hex-Antwort von SG ECU response packet |
| STAT_MARKET_CONF_WERT | real | Market Information |
| STAT_MARKET_CONF_EINH | string |  |
...
| JOB_STATUS | string | Status der Kommunikation - OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| _TEL_ANTWORT | binary | Hex-Antwort von SG ECU response packet |
| STAT_CAN_DIST_WERT | real | Kilometer reading |
...
| JOB_STATUS | string | Status der Kommunikation - OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| _TEL_ANTWORT | binary | Hex-Antwort von SG ECU response packet |
| STAT_LV_ASR_REQ_ACTIVE | int | ASC torque reduction request |
| STAT_LV_MSR_REQ_ACTIVE | int | MSR torque increase request |
| STAT_LV_ASC_PAS_ACTIVE | int | ASC activity status |
| STAT_LV_GS_INH_ACTIVE | int | ASC gear shift inhibit status |
...
| JOB_STATUS | string | Status der Kommunikation - OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| _TEL_ANTWORT | binary | Hex-Antwort von SG ECU response packet |
| STAT_LV_BLS_3_ON | int | Handbrake switch |
...
| STAT_LV_CS_ACTIVE | int | Clutch switch |
...
| STAT_LV_CS_1_ACTIVE | int | Cruise suspension byte 1 - clutch pedal |
| STAT_LV_DRIV_1_ACTIVE | int | Cruise suspension byte 1 - P/N/D engaged or no valid forward ratio |
| STAT_LV_CRU_N_INH_1_ACTIVE | int | Cruise suspension byte 1 - engine speed outside of operating range |
| STAT_LV_CRU_VS_INH_1_ACTIVE | int | Cruise suspension byte 1 - road speed outside of operating range |
| STAT_LV_TCS_AUTH_1_ACTIVE | int | Cruise suspension byte 1 - traction control active |
...
| STAT_LV_CS_2_ACTIVE | int | Cruise suspension byte 2 - clutch pedal |
| STAT_LV_DRIV_2_ACTIVE | int | Cruise suspension byte 2 - P/N/D engaged or no valid forward ratio |
| STAT_LV_CRU_N_INH_2_ACTIVE | int | Cruise suspension byte 2 - engine speed outside of operating range |
| STAT_LV_CRU_VS_INH_2_ACTIVE | int | Cruise suspension byte 2 - road speed outside of operating range |
| STAT_LV_TCS_AUTH_2_ACTIVE | int | Cruise suspension byte 2 - traction control active |
...
| STAT_LV_CS_3_ACTIVE | int | Cruise suspension byte 3 - clutch pedal |
| STAT_LV_DRIV_3_ACTIVE | int | Cruise suspension byte 3 - P/N/D engaged or no valid forward ratio |
| STAT_LV_CRU_N_INH_3_ACTIVE | int | Cruise suspension byte 3 - engine speed outside of operating range |
| STAT_LV_CRU_VS_INH_3_ACTIVE | int | Cruise suspension byte 3 - road speed outside of operating range |
| STAT_LV_TCS_AUTH_3_ACTIVE | int | Cruise suspension byte 3 - traction control active |
...
| STAT_LV_CS_4_ACTIVE | int | Cruise suspension byte 4 - clutch pedal |
| STAT_LV_DRIV_4_ACTIVE | int | Cruise suspension byte 4 - P/N/D engaged or no valid forward ratio |
| STAT_LV_CRU_N_INH_4_ACTIVE | int | Cruise suspension byte 4 - engine speed outside of operating range |
| STAT_LV_CRU_VS_INH_4_ACTIVE | int | Cruise suspension byte 4 - road speed outside of operating range |
| STAT_LV_TCS_AUTH_4_ACTIVE | int | Cruise suspension byte 4 - traction control active |
...
| STAT_LV_CS_5_ACTIVE | int | Cruise suspension byte 5 - clutch pedal |
| STAT_LV_DRIV_5_ACTIVE | int | Cruise suspension byte 5 - P/N/D engaged or no valid forward ratio |
| STAT_LV_CRU_N_INH_5_ACTIVE | int | Cruise suspension byte 5 - engine speed outside of operating range |
| STAT_LV_CRU_VS_INH_5_ACTIVE | int | Cruise suspension byte 5 - road speed outside of operating range |
| STAT_LV_TCS_AUTH_5_ACTIVE | int | Cruise suspension byte 5 - traction control active |
...
- [DIGITAL](#table-digital) (180 × 4)
- [ANALOG](#table-analog) (146 × 4)
- [FORTTEXTE](#table-forttexte) (142 × 2)
- [FUMWELTMATRIX](#table-fumweltmatrix) (140 × 7)
