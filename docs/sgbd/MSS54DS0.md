...
| Field | Value |
| --- | --- |
| ECU | MSS52/MSS54/MSS54HP fuer S54B32 |
| ORIGIN | BMW TI-431 Schaller |
| REVISION | 2.09 |
| AUTHOR | BMW EE-32 Schaffert, BMW TI-431 Schiefer, BMW TI-431 Schaller |
| COMMENT | N/A |
| PACKAGE | 1.03 |
| SPRACHE | deutsch |
...
- [STEUERN_EKP_AUS](#job-steuern-ekp-aus) - Kraftstoffpumpe (Relais) ausschalten
- [ADAPT_GERAEUSCHKLAPPE](#job-adapt-geraeuschklappe) - GKS oeffnen und Position adaptieren
- [STEUERN_DMTL_HEATER](#job-steuern-dmtl-heater) - DMTL Heizung ansteuern
...
- [START_SYSTEMCHECK_TANK_LECK](#job-start-systemcheck-tank-leck) - Funktionsueberpruefung DMTL anstossen - erwarte Ergebnis ausserhalb Job
- [START_SYSTEMCHECK_DMTL](#job-start-systemcheck-dmtl) - Funktionsueberpruefung DMTL anstossen - erwarte Ergebnis ausserhalb Job
- [START_SYSTEMCHECK_DMTL_ECOS](#job-start-systemcheck-dmtl-ecos) - Funktionsueberpruefung DMTL anstossen - erwarte Ergebnis ausserhalb Job
...
- [STATUS_SYSTEMCHECK_LAUFUNRUHE](#job-status-systemcheck-laufunruhe) - Laufunruheabweichung nach physikalischer Zylinderanordnung lesen Laufunruheabweichung wird nicht nach Zuendreihenfolge (1-5-3-6-2-4) ausgegeben
- [LESEN_SYSTEMCHECK_LAUFUNRUHE](#job-lesen-systemcheck-laufunruhe) - Segmentzeitabweichung des Geberrades nach physikalischer Zylinderanordnung lesen Segmentzeitabweichung wird nicht nach Zuendreihenfolge (1-5-3-6-2-4) ausgegeben
- [STEUERN_SLS_CHECK](#job-steuern-sls-check) - Funktionsueberpruefung SLS anstossen - erwarte Ergebnis im Job
- [STEUERN_TEV_CHECK](#job-steuern-tev-check) - Funktionsueberpruefung TEV anstossen - erwarte Ergebnis im Job
- [START_SYSTEMCHECK_TEV_FUNC](#job-start-systemcheck-tev-func) - Funktionsueberpruefung TEV anstossen
- [LESEN_SYSTEMCHECK_TEV_FUNC](#job-lesen-systemcheck-tev-func) - Funktionsueberpruefung TEV auslesen
- [STATUS_TANK_DICHTHEIT](#job-status-tank-dichtheit) - Tankleckpruefung mit DMTL anstossen - erwarte Ergebnis im Job
- [STEUERN_UEBERGABE](#job-steuern-uebergabe) - Quittierung der Uebergabedurchsicht durch den Haendler
- [STATUS_UEBERGABE](#job-status-uebergabe) - Aktueller Status der Uebergabedurchsicht
- [STEUERN_VENTIL_SAUGSTRAHLPUMPE](#job-steuern-ventil-saugstrahlpumpe) - Oeffnen des Ventils der Saugstrahlpumpe fuer den Bremskraftverstaerker und schliessen nach 2 sec.
- [STEUERN_VENTIL_KURBELGEHAEUSEENTLUEFTUNG](#job-steuern-ventil-kurbelgehaeuseentlueftung) - Oeffnen des Ventils der der Kurbelgehaeuseentlueftung und schliessen nach 2 sec.
- [STATUS_ADAPTIONSBLOCK_06](#job-status-adaptionsblock-06) - Adaption Auswahlbyte 06
- [STATUS_ADAPTIONSBLOCK_16](#job-status-adaptionsblock-16) - Adaption Auswahlbyte 16
...
| Name | Type | Comment |
| --- | --- | --- |
| SCHALTEN | string | Werte: 'ein', 'aus' oder '1', '0' |
...
| STAT_REEDSWITCH_EIN | int | Status Leckerkennungsschalter Tank |
...
| --- | --- | --- |
| JOB_STATUS | string |  |
| STATUS_GEBERRAD_ADAPTION_WERT | unsigned int | Motortemperatur Wert |
...
| --- | --- | --- |
| JOB_STATUS | string |  |
| STAT_LAA_REGLER1_WERT | real | Lambdaregleradaption 1 |
| STAT_LAA_REGLER2_WERT | real | Lambdaregleradaption 2 |
| STAT_LAA_F1_WERT | real | Lambdaadaptionsfaktor 1 |
| STAT_LAA_F2_WERT | real | Lambdaadaptionsfaktor 2 |
| STAT_LAA_OFFSET1_WERT | real | Lambdaadaptionsoffset 1 in ms |
| STAT_LAA_OFFSET2_WERT | real | Lambdaadaptionsoffset 2 in ms |
| STAT_MD_LLRA_WERT | real | Leerlaufregler Adaptionsmoment in Nm |
| STAT_V_MAX_WERT | unsigned int | erreichte Maximalgeschwindigkeit in km/h |
| STAT_N_MAX_WERT | unsigned int | erreichte Maximaldrehzahl in 1/min |
| STAT_T_NBEGR_WERT | real | Gesamtzeit Ueberdrehzahl in s |
| STAT_PWG1_A0_WERT | real | Pedalwertgeber 1 Null-Lage in V |
| STAT_PWG2_A0_WERT | real | Pedalwertgeber 2 Null-Lage in V |
| STAT_WDK1_NORM_WERT | real | Drosselklappensteigung 1 in %/V |
| STAT_WDK2_NORM_WERT | real | Drosselklappensteigung 1 in %/V |
| STAT_KKOS_ST_VERBAUT_WERT | unsigned int | Klimaanlage erkannt |
| STAT_WDK1_A0_WERT | real | Drosselklappe 1 Null-Lage in V |
| STAT_WDK2_A0_WERT | real | Drosselklappe 2 Null-Lage in V |
| STAT_LFRA_MD_START_WERT | real | Startmoment Leerlaufregler in Nm |
| STAT_LFRA_KO_MD_START_WERT | real | Startmoment Leerlaufregler mit Klimakompressor in Nm |
| STAT_FRA_ML_START_WERT | real | Startmoment Leerlaufregler in kg/h |
| STAT_TDME_MIN_WERT | int | Steuergeraeteminimaltemperatur in °C |
| STAT_TDME_MAX_WERT | int | Steuergeraetemaximaltemperatur in °C |
| STAT_WDK_ADAPT_WERT | unsigned int | Zustand Drosselklappenadaption mit 0 = ok |
| STAT_WDK_MAX_DIFF_ADAPT_WERT | real | gelernte Differenz Drosselklappenpotis in % |
| STAT_PWG_MAX_DIFF_ADAPT_WERT | real | gelernte Differenz Pedalwertgeberpotis in % |
| STAT_LU_ADAPT1_WERT | real | Segmentabweichung Geberrad Zyl.1 in ppm |
| STAT_LU_ADAPT2_WERT | real | Segmentabweichung Geberrad Zyl.2 in ppm |
| STAT_LU_ADAPT3_WERT | real | Segmentabweichung Geberrad Zyl.3 in ppm |
| STAT_LU_ADAPT4_WERT | real | Segmentabweichung Geberrad Zyl.4 in ppm |
| STAT_LU_ADAPT5_WERT | real | Segmentabweichung Geberrad Zyl.5 in ppm |
| STAT_LU_ADAPT6_WERT | real | Segmentabweichung Geberrad Zyl.6 in ppm |
| STAT_LU_ADAPT7_WERT | real | Segmentabweichung Geberrad Zyl.7 in ppm |
| STAT_LU_ADAPT8_WERT | real | Segmentabweichung Geberrad Zyl.8 in ppm |
| STAT_LU_ADAP_CNT_WERT | unsigned int | Arbeitsspiele Geberradmessung |
| STAT_FSP_BS_NOW_WERT | real | interner Betriebsstundenzaehler in min |
| STAT_T_ML_WERT | real | Motorbetriebszeit in s |
| STAT_TDME_TIME_ZAEHLER_WERT | real | Zeit SG-Temperatur ueber Schwelle in s |
| STAT_TDME_ZYKLEN_WERT | unsigned int | Driving-Cycles mit Steuergeraetetemperatur ueber Schwelle |
| STAT_VVDP_VERBAUT_WERT | unsigned int | Druckspeicherventil verbaut |
| STAT_LDPH_VERBAUT_WERT | unsigned int | DMTL_Heizung verbaut |
| STAT_EVAN1_ADAP_WERT | real | Adaptionswert Einlaß-Vanos Bank 1 in °KW |
| STAT_AVAN1_ADAP_WERT | real | Adaptionswert Auslaß-Vanos Bank 1 in °KW |
| STAT_VAN_ADAP_ST_WERT | unsigned int | Status der VANOS-Adaption Bit0 = Einlaß-Vanos Bank 1 adaptiert Bit1 = Auslaß-Vanos Bank 1 adaptiert |
| STAT_FGR_MFL_VERBAUT_WERT | unsigned int | Status Fahrgeschwindigkeitsregler |
| STAT_EKP_CFG_VERBAUT_WERT | unsigned int | welche EKP wurde verbaut |
| STAT_TI_EINFAHR_ST_WERT | unsigned int | Einfahrbegrenzer |
| STAT_GKS_A0_WERT | real | Geraeuschklappe Null-Lage in V |
| STAT_PSAU_ADAPT_WERT | real | Adaption Saugrohrdruck in mbar |
...
| --- | --- | --- |
| JOB_STATUS | string |  |
| STAT_AUSS_SUM_ADAP0_WERT | unsigned long | Aussetzerzaehler Lebensdauer Zylinder 1 |
| STAT_AUSS_SUM_ADAP1_WERT | unsigned long | Aussetzerzaehler Lebensdauer Zylinder 2 |
| STAT_AUSS_SUM_ADAP2_WERT | unsigned long | Aussetzerzaehler Lebensdauer Zylinder 3 |
| STAT_AUSS_SUM_ADAP3_WERT | unsigned long | Aussetzerzaehler Lebensdauer Zylinder 4 |
| STAT_AUSS_SUM_ADAP4_WERT | unsigned long | Aussetzerzaehler Lebensdauer Zylinder 5 |
| STAT_AUSS_SUM_ADAP5_WERT | unsigned long | Aussetzerzaehler Lebensdauer Zylinder 6 |
| STAT_AUSS_SUM_ADAP6_WERT | unsigned long | Aussetzerzaehler Lebensdauer Zylinder 7 |
| STAT_AUSS_SUM_ADAP7_WERT | unsigned long | Aussetzerzaehler Lebensdauer Zylinder 8 |
| STAT_AUSS_SUM_DC0_WERT | unsigned int | Aussetzerzaehler Driving-Cycle Zylinder 1 |
| STAT_AUSS_SUM_DC1_WERT | unsigned int | Aussetzerzaehler Driving-Cycle Zylinder 2 |
| STAT_AUSS_SUM_DC2_WERT | unsigned int | Aussetzerzaehler Driving-Cycle Zylinder 3 |
| STAT_AUSS_SUM_DC3_WERT | unsigned int | Aussetzerzaehler Driving-Cycle Zylinder 4 |
| STAT_AUSS_SUM_DC4_WERT | unsigned int | Aussetzerzaehler Driving-Cycle Zylinder 5 |
| STAT_AUSS_SUM_DC5_WERT | unsigned int | Aussetzerzaehler Driving-Cycle Zylinder 6 |
| STAT_AUSS_SUM_DC6_WERT | unsigned int | Aussetzerzaehler Driving-Cycle Zylinder 7 |
| STAT_AUSS_SUM_DC7_WERT | unsigned int | Aussetzerzaehler Driving-Cycle Zylinder 8 |
| STAT_KA_ADAP_TZ0_WERT | real | Klopfadaption Zylinder 1 in °KW |
| STAT_KA_ADAP_TZ1_WERT | real | Klopfadaption Zylinder 2 in °KW |
| STAT_KA_ADAP_TZ2_WERT | real | Klopfadaption Zylinder 3 in °KW |
| STAT_KA_ADAP_TZ3_WERT | real | Klopfadaption Zylinder 4 in °KW |
| STAT_KA_ADAP_TZ4_WERT | real | Klopfadaption Zylinder 5 in °KW |
| STAT_KA_ADAP_TZ5_WERT | real | Klopfadaption Zylinder 6 in °KW |
| STAT_KA_ADAP_TZ6_WERT | real | Klopfadaption Zylinder 7 in °KW |
| STAT_KA_ADAP_TZ7_WERT | real | Klopfadaption Zylinder 8 in °KW |
| STAT_A_QUER_L_SEC_WERT | unsigned int | Querbeschleunigungszaehler links in s |
...
| --- | --- | --- |
| JOB_STATUS | string |  |
| STAT_FF_FF_RDY_WERT | unsigned int | Readinessmaske |
| STAT_FF_FF_DCY_CNT_WERT | unsigned int | Anzahl Driving-Cycles seit Ruecksetzen |
| STAT_FF_FF_WUC_CNT_WERT | unsigned int | Anzahl Warm Up Cycles seit Ruecksetzen |
| STAT_FF_FF_DCY_CLR_WERT | unsigned int | Anzahl Driving-Cycles seit Fehlerspeicher loeschen |
| STAT_FF_FF_WUC_CLR_WERT | unsigned int | Anzahl Warm Up Cycles seit Fehlerspeicher loeschen |
| STAT_FF_FF_KM_WERT | real | Kilometerstand Freeze Frame in km |
| STAT_FF_FF_TIME_WERT | real | Steuergeraetezeit Freeze Frame in min |
| STAT_FF_FF_RDY_CNT0_WERT | unsigned int | Anzahl Readiness erreicht fuer Diagnostic Function 1 seit Ruecksetzen |
| STAT_FF_FF_RDY_CNT1_WERT | unsigned int | Anzahl Readiness erreicht fuer Diagnostic Function 2 seit Ruecksetzen |
| STAT_FF_FF_RDY_CNT2_WERT | unsigned int | Anzahl Readiness erreicht fuer Diagnostic Function 3 seit Ruecksetzen |
| STAT_FF_FF_RDY_CNT3_WERT | unsigned int | Anzahl Readiness erreicht fuer Diagnostic Function 4 seit Ruecksetzen |
| STAT_FF_FF_RDY_CNT4_WERT | unsigned int | Anzahl Readiness erreicht fuer Diagnostic Function 5 seit Ruecksetzen |
| STAT_FF_FF_RDY_CNT5_WERT | unsigned int | Anzahl Readiness erreicht fuer Diagnostic Function 6 seit Ruecksetzen |
| STAT_FF_FF_RDY_CNT6_WERT | unsigned int | Anzahl Readiness erreicht fuer Diagnostic Function 7 seit Ruecksetzen |
| STAT_FF_FF_RDY_CNT7_WERT | unsigned int | Anzahl Readiness erreicht fuer Diagnostic Function 8 seit Ruecksetzen |
| STAT_FF_FF_RDY_CNT8_WERT | unsigned int | Anzahl Readiness erreicht fuer Diagnostic Function 9 seit Ruecksetzen |
| STAT_FF_FF_RDY_CNT9_WERT | unsigned int | Anzahl Readiness erreicht fuer Diagnostic Function 10 seit Ruecksetzen |
| STAT_FF_FF_RDY_CNT10_WERT | unsigned int | Anzahl Readiness erreicht fuer Diagnostic Function 11 seit Ruecksetzen |
| STAT_FF_FF_RDY_CNT11_WERT | unsigned int | Anzahl Readiness erreicht fuer Diagnostic Function 12 seit Ruecksetzen |
| STAT_FF_FF_RDY_CNT12_WERT | unsigned int | Anzahl Readiness erreicht fuer Diagnostic Function 13 seit Ruecksetzen |
| STAT_FF_FF_RDY_CNT13_WERT | unsigned int | Anzahl Readiness erreicht fuer Diagnostic Function 14 seit Ruecksetzen |
| STAT_FF_FF_RDY_CNT14_WERT | unsigned int | Anzahl Readiness erreicht fuer Diagnostic Function 15 seit Ruecksetzen |
| STAT_FF_FF_RDY_CNT15_WERT | unsigned int | Anzahl Readiness erreicht fuer Diagnostic Function 16 seit Ruecksetzen |
| STAT_KSD_LAA_OFFSET1_WERT | real | Adaptionsoffset fuer Kraftstoffsystemdiagnose Bank 1 |
| STAT_KSD_LAA_OFFSET2_WERT | real | Adaptionsoffset fuer Kraftstoffsystemdiagnose Bank 2 |
| STAT_KSD_LAA_F1_WERT | real | Adaptionsfaktor fuer Kraftstoffsystemdiagnose Bank 1 |
| STAT_KSD_LAA_F2_WERT | real | Adaptionsfaktor fuer Kraftstoffsystemdiagnose Bank 2 |
| STAT_KSD_OEL_SPERR_WERT | unsigned int | Zaehler fuer Oelverduennung |
| STAT_TEA1_F_WERT | real | Tankentlueftungsadaption Bank 1 |
| STAT_TEA2_F_WERT | real | Tankentlueftungsadaption Bank 2 |
| STAT_KSD_LAM1_WERT | real | Gesamtabweichung Lambda Bank 1 |
| STAT_KSD_LAM2_WERT | real | Gesamtabweichung Lambda Bank 2 |
| STAT_KSD_OFFSET1_DELTA_WERT | real | Abweichung Adaptionsoffset Bank 1 |
| STAT_KSD_OFFSET2_DELTA_WERT | real | Abweichung Adaptionsoffset Bank 2 |
| STAT_KSD_F1_DELTA_WERT | real | Abweichung Adaptionsfaktor Bank 1 |
| STAT_KSD_F2_DELTA_WERT | real | Abweichung Adaptionsfaktor Bank 2 |
| STAT_KSD_LL_MAX_T1_WERT | real | Ueberschreitungszeit Leerlauf Bank 1 in s |
| STAT_KSD_LL_MAX_T2_WERT | real | Ueberschreitungszeit Leerlauf Bank 2 in s |
| STAT_KSD_LL_MIN_T1_WERT | real | Ueberschreitungszeit Leerlauf Bank 1 in s |
| STAT_KSD_LL_MIN_T2_WERT | real | Ueberschreitungszeit Leerlauf Bank 2 in s |
| STAT_KSD_TL_MAX_T1_WERT | real | Ueberschreitungszeit Teillast Bank 1 in s |
| STAT_KSD_TL_MAX_T2_WERT | real | Ueberschreitungszeit Teillast Bank 2 in s |
| STAT_KSD_TL_MIN_T1_WERT | real | Ueberschreitungszeit Teillast Bank 1 in s |
| STAT_KSD_TL_MIN_T2_WERT | real | Ueberschreitungszeit Teillast Bank 2 in s |
| STAT_KSD_LL_MAX_TRIG1_WERT | unsigned int | Ueberschreitungen Leerlauf Bank 1 |
| STAT_KSD_LL_MAX_TRIG2_WERT | unsigned int | Ueberschreitungen Leerlauf Bank 2 |
| STAT_KSD_LL_MIN_TRIG1_WERT | unsigned int | Ueberschreitungen Leerlauf Bank 1 |
| STAT_KSD_LL_MIN_TRIG2_WERT | unsigned int | Ueberschreitungen Leerlauf Bank 2 |
| STAT_KSD_TL_MAX_TRIG1_WERT | unsigned int | Ueberschreitungen Teillast Bank 1 |
| STAT_KSD_TL_MAX_TRIG2_WERT | unsigned int | Ueberschreitungen Teillast Bank 2 |
| STAT_KSD_TL_MIN_TRIG1_WERT | unsigned int | Ueberschreitungen Teillast Bank 1 |
| STAT_KSD_TL_MIN_TRIG2_WERT | unsigned int | Ueberschreitungen Teillast Bank 2 |
...
| --- | --- | --- |
| JOB_STATUS | string |  |
| STAT_LA_ALTER_ST_WERT | unsigned int | Hilfsstatus TV-LA-Alterungsueberwachung Bit0: allgem. Ausschaltbedingung Bank1 Bit1: allgem. Ausschaltbedingung Bank2 Bit2: max. Schwelle ueberschritten Bit3: max. Schwelle ueberschritten Bit4: min. Schwelle unterschritten Bit5: min. Schwelle unterschritten Bit6: TV-Diagnose VKAT1 laeuft Bit7: TV-Diagnose VKAT2 laeuft |
| STAT_LA_ALT_P_ST_WERT | unsigned int | Hilfsstatus Period.-LA-Alterungsueberwachung Bit0: Diagnosebedingungen erfuellt - VKAT1 Bit1: Diagnosebedingungen erfuellt - VKAT2 Bit2: Sperrzeit nach FETT-MAGER-Spr. fuer VKAT1 ist abgelaufen Bit3: Sperrzeit nach FETT-MAGER-Spr. fuer VKAT2 ist abgelaufen Bit4: Period.dauer zu groß - VKAT1 Bit5: Period.dauer zu groß - VKAT2 Bit6: Period.dauer zu klein - VKAT1 Bit7: Period.dauer zu klein - VKAT2 |
| STAT_LA_ALT_P_MESS1_WERT | unsigned int | Lambdasondenalterunguebw. Periodendauer mit Filterung Bank 1 in ms |
| STAT_LA_ALT_P_MESS2_WERT | unsigned int | Lambdasondenalterunguebw. Periodendauer mit Filterung Bank 2 in ms |
| STAT_LA_ALT_P_ANZ_SPR1_WERT | unsigned int | Lambdasondenalterunguebw. Anzahl auzublendender Perioden B1 |
| STAT_LA_ALT_P_ANZ_SPR2_WERT | unsigned int | Lambdasondenalterunguebw. Anzahl auzublendender Perioden B2 |
| STAT_LA_ALT_P_ANZ_DIAG1_WERT | unsigned int | Lambdasondenalterunguebw. Anzahl max. gem. Perioden B1 |
| STAT_LA_ALT_P_ANZ_DIAG2_WERT | unsigned int | Lambdasondenalterunguebw. Anzahl max. gem. Perioden B2 |
| STAT_LA_ALT_NKAT_ST_WERT | unsigned int | Hilfsstatus Schwingungspr.-LA-Alterungsueberwachung Bit0: FETT-MAGER-Sprung - Periodendauermessung Bit1: FETT-MAGER-Sprung - Periodendauermessung Bit2: Sondensp. NKAT1 liegt im Fetten vor SA Bit3: Sondensp. NKAT2 liegt im Fetten vor SA Bit4: allgem. Diagnose/Bank1 ist aktiv Bit5: allgem. Diagnose/Bank2 ist aktiv Bit6: Sondensp- NKAT1 fett, aber nicht ueber MAX-Fett-Schwelle Bit7: Sondensp- NKAT2 fett, aber nicht ueber MAX-Fett-Schwelle |
| STAT_LA_ALTER_S_COUNT1_WERT | unsigned int | Lambdasondenalterungsuebw. Fehlerzaehler für NKAT-Diagnose B1 |
| STAT_LA_ALTER_S_COUNT2_WERT | unsigned int | Lambdasondenalterungsuebw. Fehlerzaehler für NKAT-Diagnose B2 |
| STAT_LA_ALT_SPR_ST_WERT | unsigned int | Lambdasondenalterungsuebw. Status fuer Sprungzeitueberwachung Bit0: Diagnosebedingungen erfuellt -VKAT1 Bit1: Diagnosebedingungen erfuellt - VKAT2 Bit2: Referenzschwellen für VKAT1 werden ermittelt Bit3: Referenzschwellen für VKAT2 werden ermittelt Bit4: Sprungzeitermittlung FETT-&gt;MAGER findet statt - VKAT1 Bit5: Sprungzeitermittlung FETT-&gt;MAGER findet statt - VKAT2 Bit6: Sprungzeitermittlung MAGER-&gt;FETT findet statt - VKAT1 Bit7: Sprungzeitermittlung MAGER-&gt;FETT findet statt - VKAT2 |
| STAT_LA_ALT_SPR_ANZ_M1_WERT | unsigned int | Anzahl der Mager-Spruenge Bank 1 |
| STAT_LA_ALT_SPR_ANZ_M2_WERT | unsigned int | Anzahl der Mager-Spruenge Bank 2 |
| STAT_LA_ALT_SPR_ANZ_F1_WERT | unsigned int | Anzahl der Fett-Spruenge Bank 1 |
| STAT_LA_ALT_SPR_ANZ_F2_WERT | unsigned int | Anzahl der Fett-Spruenge Bank 2 |
| STAT_USV_SPR_MAGER_GEM1_WERT | real | Guetemerkmal Sprungszeit Mager Bank 1 |
| STAT_USV_SPR_MAGER_GEM2_WERT | real | Guetemerkmal Sprungszeit Mager Bank 2 |
| STAT_USV_SPR_FETT_GEM1_WERT | real | Guetemerkmal Sprungszeit Fett Bank 1 |
| STAT_USV_SPR_FETT_GEM2_WERT | real | Guetemerkmal Sprungszeit Fett Bank 2 |
| STAT_USV_SPR_MAX_REF1_WERT | unsigned int | Referenzschwelle max = 90% vom Signalhub Bank 1 in mV |
| STAT_USV_SPR_MAX_REF2_WERT | unsigned int | Referenzschwelle max = 90% vom Signalhub Bank 2 in mV |
| STAT_USV_SPR_MIN_REF1_WERT | unsigned int | Referenzschwelle min = 10% vom Signalhub Bank 1 in mV |
| STAT_USV_SPR_MIN_REF2_WERT | unsigned int | Referenzschwelle min = 10% vom Signalhub Bank 2 in mV |
| STAT_LA_KONV1_AD_1_1_WERT | real | la_konv1_ad(1,1) |
| STAT_LA_KONV1_AD_1_2_WERT | real | la_konv1_ad(1,2) |
| STAT_LA_KONV1_AD_1_3_WERT | real | la_konv1_ad(1,3) |
| STAT_LA_KONV1_AD_2_1_WERT | real | la_konv1_ad(2,1) |
| STAT_LA_KONV1_AD_2_2_WERT | real | la_konv1_ad(2,2) |
| STAT_LA_KONV1_AD_2_3_WERT | real | la_konv1_ad(2,3) |
| STAT_LA_KONV1_AD_3_1_WERT | real | la_konv1_ad(3,1) |
| STAT_LA_KONV1_AD_3_2_WERT | real | la_konv1_ad(3,2) |
| STAT_LA_KONV1_AD_3_3_WERT | real | la_konv1_ad(3,3) |
| STAT_LA_KONV2_AD_1_1_WERT | real | la_konv2_ad(1,1) |
| STAT_LA_KONV2_AD_1_2_WERT | real | la_konv2_ad(1,2) |
| STAT_LA_KONV2_AD_1_3_WERT | real | la_konv2_ad(1,3) |
| STAT_LA_KONV2_AD_2_1_WERT | real | la_konv2_ad(2,1) |
| STAT_LA_KONV2_AD_2_2_WERT | real | la_konv2_ad(2,2) |
| STAT_LA_KONV2_AD_2_3_WERT | real | la_konv2_ad(2,3) |
| STAT_LA_KONV2_AD_3_1_WERT | real | la_konv2_ad(3,1) |
| STAT_LA_KONV2_AD_3_2_WERT | real | la_konv2_ad(3,2) |
| STAT_LA_KONV2_AD_3_3_WERT | real | la_konv2_ad(3,3) |
| STAT_LA_KONV_ST_WERT | unsigned int | Status fuer KAT-Konvertierung Bit0: Ausschaltbedingung Bank1 ist vorhanden Bit1: Ausschaltbedingung Bank2 ist vorhanden Bit2: Diagnosezeit Bank1 ist abgelaufen Bit3: Diagnosezeit Bank2 ist abgelaufen Bit4: Diagnosebedingungen sind erfuellt (Bank1) Bit5: Diagnosebedingungen sind erfuellt (Bank2) Bit6: n-/rf-Bereichserkennung Bank1 ist aktiv Bit7: n-/rf-Bereichserkennung Bank2 ist aktiv |
| STAT_LA_KONV_ANZ_GRENZ1_WERT | unsigned int | Anzahl der Verletzten KAT_KONV_Bereiche Bank 1 |
| STAT_LA_KONV_ANZ_GRENZ2_WERT | unsigned int | Anzahl der Verletzten KAT_KONV_Bereiche Bank 2 |
| STAT_LA_KONV_V_ERR_WERT | unsigned int | ERR-Status fuer KAT-Konvertierung |
| STAT_LA_KONV_DIAG_TIME1_WERT | real | Diagnosezeit KAT-KONV Bank 1 in s |
| STAT_LA_KONV_DIAG_TIME2_WERT | real | Diagnosezeit KAT-KONV Bank 2 in s |
| STAT_SLS_DIAG_WERT | unsigned int | Anzahl der Mindestdurchflussmessungen |
| STAT_SLS_DIAG_USV1_WERT | unsigned int | Anzahl der Magermessungen Bank 1 |
| STAT_SLS_DIAG_USV2_WERT | unsigned int | Anzahl der Magermessungen Bank 2 |
| STAT_SLV_STARTS_WERT | unsigned int | Anzahl der Wiederholt-Start |
| STAT_SLV_STARTS_ADAPT_WERT | unsigned int | Abgespeicherte Anzahl der Wiederholt-Start |
| STAT_SLS_ST1_WERT | unsigned int | Status1 Sekundaerluftsystem |
| STAT_SLS_ST2_WERT | unsigned int | Status2 Sekundaerluftsystem |
| STAT_SLS_TI_F_DIAG_WERT | real | Anfettung fuer SLS-Diagnose |
| STAT_LDP_ABBR_FEUCHT_WERT | unsigned int | Anzahl abgebr. Diags. wegen Feuchtigkeitsverdacht |
| STAT_LA_ALT_TV_MAX1_WERT | unsigned int | Lambdasondenalterungsuebw. TV-Ueberwachung: Ueberschreitungscounter Bank 1 |
| STAT_LA_ALT_TV_MAX2_WERT | unsigned int | Lambdasondenalterungsuebw. TV-Ueberwachung: Ueberschreitungscounter Bank 2 |
| STAT_LA_ALT_TV_MIN1_WERT | unsigned int | Lambdasondenalterungsuebw. TV-Ueberwachung: Ueberschreitungscounter Bank 1 |
| STAT_LA_ALT_TV_MIN2_WERT | unsigned int | Lambdasondenalterungsuebw. TV-Ueberwachung: Ueberschreitungscounter Bank 2 |
| STAT_LANK_I_TV_GEM1_WERT | real | gem. Verzoegerungszeit - I-Anteil Bank 1 in ms |
| STAT_LANK_I_TV_GEM2_WERT | real | gem. Verzoegerungszeit - I-Anteil Bank 2 in ms |
| STAT_LANK_TV1_WERT | real | PI-Regler NKAT Bank 1 in ms |
| STAT_LANK_TV2_WERT | real | PI-Regler NKAT Bank 2 in ms |
| STAT_LANK_I_AD1_WERT | real | Adaptionswert - I-Anteil Bank 1 in ms |
| STAT_LANK_I_AD2_WERT | real | Adaptionswert - I-Anteil Bank 2 in ms |
| STAT_LANK_I_TV1_WERT | real | Verzoegerungszeit - I-Anteil Bank 1 in ms |
| STAT_LANK_I_TV2_WERT | real | Verzoegerungszeit - I-Anteil Bank 2 in ms |
| STAT_LANK_P_TV1_WERT | real | Verzoegerungszeit - P-Anteil Bank 1 in ms |
| STAT_LANK_P_TV2_WERT | real | Verzoegerungszeit - P-Anteil Bank 2 in ms |

## Tables

### Index

- [BETRIEBSWTAB](#table-betriebswtab) (79 × 17)
- [BITS](#table-bits) (51 × 4)
- [FORTTEXTE](#table-forttexte) (226 × 6)
- [PROGRESULT](#table-progresult) (16 × 2)
- [FARTMATRIX](#table-fartmatrix) (114 × 17)
- [FARTTEXTE](#table-farttexte) (122 × 2)
- [FUMWELTTEXTE](#table-fumwelttexte) (80 × 5)
...
| mw_tev_cur | 12050B13 | 04 | 0 | 0x00 | 58 | 5 | -- | 0.009 | 0 | 0x00 | 0x00 | 6.2f |  |   | TEV Messstrom | TEV Messstrom |
...
| 0x0E | LDP-Heizung | 0x0A | 0x04 | 0x02 | 0x03 |
| 0x0F | NW-Geber 1 Synchronisation gegen KW | 0x00 | 0x01 | 0x08 | 0x09 |
| 0x10 | KW-Induktivgeber | 0x00 | 0x01 | 0x02 | 0x03 |
| 0x11 | SMG Schaltablauf | 0x00 | 0x01 | 0x1A | 0x1B |
| 0x12 | GKS-Treiber | 0x03 | 0x0A | 0x0B | 0x14 |
| 0x13 | Sekundaerluftpumpenrelais | 0x00 | 0x01 | 0x02 | 0x03 |
...
| 0x1B | Ventil Tankleckdiagnose | 0x00 | 0x0A | 0x05 | 0x03 |
| 0x1C | GKS-Regler | 0x13 | 0x14 | 0x0A | 0x0B |
...
| 0x44 | SMG Sicherheitskonzept | 0x00 | 0x01 | 0x05 | 0x1B |
...
| 0x5A | Vorkatsonde 1 TV-Verschiebung | 0x00 | 0x01 | 0x2B | 0x26 |
| 0x5B | Vorkatsonde 2 TV-Verschiebung | 0x00 | 0x01 | 0x2C | 0x27 |
| 0x5C | Nachkatsonde 1 Spannungsueberw. | 0x3B | 0x01 | 0x1E | 0x3A |
| 0x5D | Nachkatsonde 2 Spannungsueberw. | 0x3B | 0x01 | 0x1F | 0x3A |
| 0x5E | interner Index 241 | 0x00 | 0x01 | 0x02 | 0x03 |
| 0x5F | interner Index 242 | 0x00 | 0x01 | 0x02 | 0x03 |
| 0x60 | Plausibilisierung Kühleraustrittstemp. | 0x00 | 0x0A | 0x02 | 0x0C |
...
| 0x78 | Drosselklappenpotis Vergleich | 0x00 | 0x01 | 0x02 | 0x03 |
| 0x79 | Beide Drosselklappenpotis | 0x00 | 0x01 | 0x02 | 0x03 |
| 0x7A | intern: Prozessorkontrolle Master | 0x00 | 0x01 | 0x02 | 0x03 |
| 0x7B | Bus-Off lokaler SMG-CAN | 0x00 | 0x01 | 0x02 | 0x03 |
| 0x7C | Poti Geräuschklappe GKS | 0x13 | 0x14 | 0x0A | 0x0B |
| 0x7D | Spoilerverstellung/TOG-Lampe | 0x00 | 0x01 | 0x02 | 0x03 |
| 0x7E | EKP-Crash-Abschaltung | 0x00 | 0x01 | 0x02 | 0x03 |
| 0x7F | Modul Tankleckdiagnose | 0x37 | 0x46 | 0x47 | 0x39 |
| 0x80 | Abweichung Leerlaufdrehzahl | 0x00 | 0x01 | 0x02 | 0x03 |
| 0x81 | KAT-Schutz aktiv bei leerem Tank | 0x00 | 0x01 | 0x4A | 0x4B |
...
| 0x8E | System Saugstrahlpumpe | 0x00 | 0x01 | 0x02 | 0x03 |
| 0x8F | E-Box-Luefter | 0x00 | 0x01 | 0x02 | 0x03 |
| 0x90 | Lambdaregler 1 | 0x00 | 0x01 | 0x2B | 0x2D |
| 0x91 | Lambdaregler 2 | 0x00 | 0x01 | 0x2C | 0x2E |
| 0x92 | interner Index 105 | 0x00 | 0x01 | 0x02 | 0x03 |
| 0x93 | interner Index 106 | 0x00 | 0x01 | 0x02 | 0x03 |
| 0x94 | interner Index 107 | 0x00 | 0x01 | 0x02 | 0x03 |
| 0x95 | Fehler bei leerem Tank | 0x00 | 0x01 | 0x02 | 0x39 |
...
| 0x9A | Kurbelgehäuseentlüftung | 0x00 | 0x01 | 0x02 | 0x03 |
...
| 0x9E | intern: Resets Slave | 0x00 | 0x01 | 0x02 | 0x03 |
...
| 0xA3 | intern: Resets Master | 0x00 | 0x01 | 0x02 | 0x03 |
...
| 0xAB | Sekundaerluftventil klemmt | 0x00 | 0x01 | 0x02 | 0x03 |
| 0xAC | Vanos-Druckspeicherventil | 0x00 | 0x01 | 0x02 | 0x03 |
| 0xAD | KL50 Anlasserschalter0 | 0x00 | 0x01 | 0x02 | 0x03 |
| 0xAE | Kraftstoffsystemdiagnose 1 | 0x48 | 0x0B | 0x02 | 0x2D |
| 0xAF | Kraftstoffsystemdiagnose 2 | 0x49 | 0x0B | 0x02 | 0x2E |
| 0xB0 | interner Index 174 | 0x00 | 0x01 | 0x02 | 0x29 |
| 0xB1 | MIL-Extern-Info | 0x00 | 0x01 | 0x02 | 0x2A |
| 0xB2 | KAT-Konvertierung 1 | 0x00 | 0x01 | 0x2F | 0x33 |
| 0xB3 | KAT-Konvertierung 2 | 0x00 | 0x01 | 0x30 | 0x34 |
| 0xB4 | Tankleck | 0x39 | 0x37 | 0x38 | 0x46 |
| 0xB5 | Info Tankdeckel fehlt | 0x39 | 0x37 | 0x38 | 0x46 |
...
| 0xC2 | Sicherheitsabschaltung FGR | 0x00 | 0x01 | 0x02 | 0x03 |
| 0xC3 | Ueberwachung Momentenmanager | 0x00 | 0x01 | 0x02 | 0x28 |
| 0xC4 | Aussetzer Zyl.1 KAT-sch. | 0x00 | 0x01 | 0x02 | 0x03 |
| 0xC5 | Aussetzer Zyl.2 KAT-sch. | 0x00 | 0x01 | 0x02 | 0x03 |
| 0xC6 | Aussetzer Zyl.3 KAT-sch. | 0x00 | 0x01 | 0x02 | 0x03 |
| 0xC7 | Aussetzer Zyl.4 KAT-sch. | 0x00 | 0x01 | 0x02 | 0x03 |
| 0xC8 | Aussetzer Zyl.5 KAT-sch. | 0x00 | 0x01 | 0x02 | 0x03 |
| 0xC9 | Aussetzer Zyl.6 KAT-sch. | 0x00 | 0x01 | 0x02 | 0x03 |
| 0xCA | Aussetzer Zyl.7 KAT-sch. | 0x00 | 0x01 | 0x02 | 0x03 |
| 0xCB | Aussetzer Zyl.8 KAT-sch. | 0x00 | 0x01 | 0x02 | 0x03 |
| 0xCC | Aussetzer mehr Zylinder KAT-sch. | 0x00 | 0x01 | 0x02 | 0x03 |
| 0xCD | Aussetzer Zyl.1 Abgas | 0x00 | 0x01 | 0x02 | 0x03 |
| 0xCE | Aussetzer Zyl.2 Abgas | 0x00 | 0x01 | 0x02 | 0x03 |
| 0xCF | Aussetzer Zyl.3 Abgas | 0x00 | 0x01 | 0x02 | 0x03 |
| 0xD0 | Aussetzer Zyl.4 Abgas | 0x00 | 0x01 | 0x02 | 0x03 |
| 0xD1 | Aussetzer Zyl.5 Abgas | 0x00 | 0x01 | 0x02 | 0x03 |
| 0xD2 | Aussetzer Zyl.6 Abgas | 0x00 | 0x01 | 0x02 | 0x03 |
| 0xD3 | Aussetzer Zyl.7 Abgas | 0x00 | 0x01 | 0x02 | 0x03 |
| 0xD4 | Aussetzer Zyl.8 Abgas | 0x00 | 0x01 | 0x02 | 0x03 |
| 0xD5 | Aussetzer mehr Zylinder Abgas | 0x00 | 0x01 | 0x02 | 0x03 |
| 0xD6 | Vorkatsonde 1 Periodendauer | 0x00 | 0x01 | 0x2B | 0x24 |
| 0xD7 | Vorkatsonde 2 Periodendauer | 0x00 | 0x01 | 0x2C | 0x25 |
| 0xD8 | Vorkatsonde 1 Sprungzeit | 0x00 | 0x01 | 0x42 | 0x44 |
| 0xD9 | Vorkatsonde 2 Sprungzeit | 0x00 | 0x01 | 0x43 | 0x45 |
| 0xDA | Vorkatsonde 1 Signalhub | 0x00 | 0x01 | 0x3E | 0x40 |
| 0xDB | Vorkatsonde 2 Signalhub | 0x00 | 0x01 | 0x3F | 0x41 |
| 0xDC | interner Index 235 | 0x00 | 0x01 | 0x02 | 0x03 |
| 0xDD | Systemcheck Kurbelgehäuseentlüftung | 0x00 | 0x01 | 0x02 | 0x06 |
| 0xDE | CAN-Timeout ZSG | 0x00 | 0x01 | 0x02 | 0x03 |
| 0xDF | Saugrohrdruck | 0x00 | 0x01 | 0x36 | 0x17 |
| 0xE0 | Plausibilität Lastsignal | 0x00 | 0x01 | 0x36 | 0x17 |
| 0xE1 | Umgebungstemperatur | 0x02 | 0x0A | 0x0B | 0x0C |
| 0xE2 | Kombi-Relativzeit | 0x02 | 0x0A | 0x0B | 0x0C |
...
| 0xE8 | Funktionspruefung TEV | 0x12 | 0x0A | 0x3C | 0x3D |
...
| 0x17 | 0x00 | 0x14 | 0x00 | 0x15 | 0x00 | 0x08 | 0x00 | 0x09 | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
| 0x18 | 0x00 | 0x14 | 0x00 | 0x15 | 0x00 | 0x08 | 0x00 | 0x09 | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
| 0x19 | 0x00 | 0x14 | 0x00 | 0x15 | 0x00 | 0x08 | 0x00 | 0x09 | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
| 0x1A | 0x00 | 0x14 | 0x00 | 0x15 | 0x00 | 0x08 | 0x00 | 0x09 | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
| 0x1C | 0x00 | 0xE1 | 0x00 | 0xE0 | 0x00 | 0x08 | 0x00 | 0x09 | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
...
| 0x32 | 0x00 | 0x14 | 0x00 | 0x15 | 0x00 | 0x08 | 0x00 | 0x09 | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
| 0x33 | 0x00 | 0x14 | 0x00 | 0x15 | 0x00 | 0x08 | 0x00 | 0x09 | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
| 0x34 | 0x00 | 0x14 | 0x00 | 0x15 | 0x00 | 0x08 | 0x00 | 0x09 | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
| 0x37 | 0x00 | 0x14 | 0x00 | 0x15 | 0x00 | 0x08 | 0x00 | 0x09 | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
...
| 0x51 | 0x00 | 0xB4 | 0x00 | 0x0E | 0x00 | 0xB6 | 0x00 | 0xB7 | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
| 0x56 | 0x00 | 0x0D | 0x00 | 0x07 | 0x00 | 0x08 | 0x00 | 0x09 | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
| 0x5A | 0x00 | 0xDC | 0x00 | 0xDD | 0x00 | 0x08 | 0x00 | 0x09 | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
| 0x5B | 0x00 | 0xDC | 0x00 | 0xDD | 0x00 | 0x08 | 0x00 | 0x09 | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
| 0x5C | 0x00 | 0x06 | 0x00 | 0x07 | 0x00 | 0xDE | 0x00 | 0xDF | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
| 0x5D | 0x00 | 0x06 | 0x00 | 0x07 | 0x00 | 0xDE | 0x00 | 0xDF | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
| 0x60 | 0x00 | 0x06 | 0x00 | 0x07 | 0x00 | 0x08 | 0x00 | 0x50 | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
| 0x6B | 0x00 | 0xE0 | 0x00 | 0x20 | 0x00 | 0x21 | 0x00 | 0x22 | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
| 0x6F | 0x00 | 0x06 | 0x00 | 0xB5 | 0x00 | 0x08 | 0x00 | 0x09 | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
| 0x70 | 0x00 | 0x06 | 0x00 | 0xB5 | 0x00 | 0x08 | 0x00 | 0x09 | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
...
| 0x78 | 0x00 | 0x06 | 0x00 | 0xB5 | 0x00 | 0x08 | 0x00 | 0x09 | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
| 0x79 | 0x00 | 0x06 | 0x00 | 0xB5 | 0x00 | 0x08 | 0x00 | 0x09 | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
| 0x7A | 0x00 | 0x06 | 0x00 | 0x07 | 0x00 | 0xFA | 0x00 | 0x09 | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
| 0x7C | 0x00 | 0x06 | 0x00 | 0x07 | 0x00 | 0x08 | 0x00 | 0x09 | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
| 0x7D | 0x00 | 0x06 | 0x00 | 0x07 | 0x00 | 0x08 | 0x00 | 0x09 | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
| 0x7F | 0x00 | 0x06 | 0x00 | 0xEB | 0x00 | 0xFE | 0x00 | 0xFF | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
| 0x81 | 0x00 | 0x06 | 0x00 | 0x07 | 0x00 | 0x08 | 0x00 | 0x09 | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
| 0x82 | 0x00 | 0x10 | 0x00 | 0x11 | 0x00 | 0x12 | 0x00 | 0x13 | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
...
| 0x87 | 0x00 | 0x08 | 0x00 | 0x08 | 0x00 | 0x08 | 0x00 | 0x08 | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
| 0x88 | 0x00 | 0xE0 | 0x00 | 0xE1 | 0x00 | 0xE2 | 0x00 | 0x09 | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
| 0x8B | 0x00 | 0xB0 | 0x00 | 0xB1 | 0x00 | 0xB2 | 0x00 | 0xB3 | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
| 0x8C | 0x00 | 0x17 | 0x00 | 0x07 | 0x00 | 0xF7 | 0x00 | 0x09 | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
...
| 0x96 | 0x00 | 0xF3 | 0x00 | 0xF4 | 0x00 | 0xFC | 0x00 | 0xFD | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
...
| 0x9A | 0x00 | 0x06 | 0x00 | 0x07 | 0x00 | 0x08 | 0x00 | 0x09 | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
| 0x9B | 0x00 | 0xF6 | 0x00 | 0xF0 | 0x00 | 0xF1 | 0x00 | 0xF2 | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
| 0x9C | 0x00 | 0xF6 | 0x00 | 0xF0 | 0x00 | 0xF1 | 0x00 | 0xF2 | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
| 0x9D | 0x00 | 0xF3 | 0x00 | 0xF4 | 0x00 | 0xFC | 0x00 | 0xFD | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
| 0x9E | 0x00 | 0xF8 | 0x00 | 0xF9 | 0x00 | 0xFA | 0x00 | 0x09 | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
...
| 0xA3 | 0x00 | 0xF8 | 0x00 | 0xF9 | 0x00 | 0xFA | 0x00 | 0x09 | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
| 0xAA | 0x00 | 0x23 | 0x00 | 0x24 | 0x00 | 0x25 | 0x00 | 0x09 | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
...
| 0xAE | 0x00 | 0xC9 | 0x00 | 0xCA | 0x00 | 0xCB | 0x00 | 0xCC | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
| 0xAF | 0x00 | 0xC9 | 0x00 | 0xCA | 0x00 | 0xCB | 0x00 | 0xCC | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
| 0xB1 | 0x00 | 0x06 | 0x00 | 0x07 | 0x00 | 0x08 | 0x00 | 0x30 | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
...
| 0xB4 | 0x00 | 0xD8 | 0x00 | 0xD9 | 0x00 | 0x08 | 0x00 | 0xDA | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
| 0xB5 | 0x00 | 0xD8 | 0x00 | 0xD8 | 0x00 | 0xD8 | 0x00 | 0xD8 | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
...
| 0xB8 | 0x00 | 0x18 | 0x00 | 0x19 | 0x00 | 0xC6 | 0x00 | 0x09 | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
| 0xB9 | 0x00 | 0x18 | 0x00 | 0x19 | 0x00 | 0x1A | 0x00 | 0x09 | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
| 0xC3 | 0x00 | 0xC2 | 0x00 | 0xC3 | 0x00 | 0xC4 | 0x00 | 0xC5 | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
| 0xC4 | 0x00 | 0xBD | 0x00 | 0xBA | 0x00 | 0xBB | 0x00 | 0xBC | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
| 0xC5 | 0x00 | 0xBD | 0x00 | 0xBA | 0x00 | 0xBB | 0x00 | 0xBC | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
| 0xC6 | 0x00 | 0xBD | 0x00 | 0xBA | 0x00 | 0xBB | 0x00 | 0xBC | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
| 0xC7 | 0x00 | 0xBD | 0x00 | 0xBA | 0x00 | 0xBB | 0x00 | 0xBC | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
| 0xC8 | 0x00 | 0xBD | 0x00 | 0xBA | 0x00 | 0xBB | 0x00 | 0xBC | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
| 0xC9 | 0x00 | 0xBD | 0x00 | 0xBA | 0x00 | 0xBB | 0x00 | 0xBC | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
| 0xCA | 0x00 | 0xBD | 0x00 | 0xBA | 0x00 | 0xBB | 0x00 | 0xBC | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
| 0xCB | 0x00 | 0xBD | 0x00 | 0xBA | 0x00 | 0xBB | 0x00 | 0xBC | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
| 0xCC | 0x00 | 0xBD | 0x00 | 0xBA | 0x00 | 0xBB | 0x00 | 0xBC | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
| 0xCD | 0x00 | 0xBD | 0x00 | 0xBF | 0x00 | 0xBE | 0x00 | 0xBC | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
| 0xCE | 0x00 | 0xBD | 0x00 | 0xBF | 0x00 | 0xBE | 0x00 | 0xBC | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
| 0xCF | 0x00 | 0xBD | 0x00 | 0xBF | 0x00 | 0xBE | 0x00 | 0xBC | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
| 0xD0 | 0x00 | 0xBD | 0x00 | 0xBF | 0x00 | 0xBE | 0x00 | 0xBC | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
| 0xD1 | 0x00 | 0xBD | 0x00 | 0xBF | 0x00 | 0xBE | 0x00 | 0xBC | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
| 0xD2 | 0x00 | 0xBD | 0x00 | 0xBF | 0x00 | 0xBE | 0x00 | 0xBC | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
| 0xD3 | 0x00 | 0xBD | 0x00 | 0xBF | 0x00 | 0xBE | 0x00 | 0xBC | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
| 0xD4 | 0x00 | 0xBD | 0x00 | 0xBF | 0x00 | 0xBE | 0x00 | 0xBC | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
| 0xD5 | 0x00 | 0xBD | 0x00 | 0xBF | 0x00 | 0xBE | 0x00 | 0xBC | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
| 0xD6 | 0x00 | 0xD2 | 0x00 | 0xD3 | 0x00 | 0x08 | 0x00 | 0x09 | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
| 0xD7 | 0x00 | 0xD2 | 0x00 | 0xD3 | 0x00 | 0x08 | 0x00 | 0x09 | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
| 0xD8 | 0x00 | 0xCD | 0x00 | 0xCE | 0x00 | 0x08 | 0x00 | 0x09 | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
| 0xD9 | 0x00 | 0xCD | 0x00 | 0xCE | 0x00 | 0x08 | 0x00 | 0x09 | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
| 0xDA | 0x00 | 0xCF | 0x00 | 0x07 | 0x00 | 0x08 | 0x00 | 0x09 | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
| 0xDB | 0x00 | 0xCF | 0x00 | 0x07 | 0x00 | 0x08 | 0x00 | 0x09 | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
| 0xDD | 0x00 | 0x06 | 0x00 | 0xEA | 0x00 | 0x08 | 0x00 | 0x09 | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
| 0xDE | 0x00 | 0x06 | 0x00 | 0x07 | 0x00 | 0x0C | 0x00 | 0x09 | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
| 0xDF | 0x00 | 0x06 | 0x00 | 0x07 | 0x00 | 0x08 | 0x00 | 0x40 | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
| 0xE0 | 0x00 | 0x06 | 0x00 | 0x07 | 0x00 | 0x08 | 0x00 | 0x09 | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
| 0xE1 | 0x00 | 0x06 | 0x00 | 0x07 | 0x00 | 0x60 | 0x00 | 0x61 | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
| 0xE2 | 0x00 | 0x06 | 0x00 | 0x07 | 0x00 | 0x62 | 0x00 | 0x63 | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
| 0xE6 | 0x00 | 0xE0 | 0x00 | 0xE1 | 0x00 | 0x1F | 0x00 | 0x1A | 0x00 | 0x0A | 0x00 | 0x01 | 0x03 | 0x02 | 0x04 | 0x05 |
...
| 0x06 | 0001 - Kurzschluss UBatt o. Wert zu gross |
| 0x07 | 0010 - Kurzschluss Masse o. Wert zu klein |
| 0x08 | 0100 - Leitungsbruch o. Wert fehlt |
| 0x09 | 1000 - Zustand/Wert unplausibel o. Uebertemperatur |
| 0x0A | Fehler abgasrelevant OBD |
| 0x0B | Telegramminhalt unplausibel |
| 0x0C | Telegramm nicht empfangen |
| 0x0D | zu viele Botschaften |
| 0x0E | Timeout |
| 0x0F | Unterbrechung o. Kurzschluss |
| 0x10 | Startwert defekt |
| 0x11 | Wechselcode verloren |
| 0x12 | Startwert leer |
| 0x13 | Manipulation |
| 0x14 | Sekundaerkreis |
| 0x15 | Primaerkreis |
...
| 0x1F | schliessen nicht richtig |
| 0x20 | Fehler Sicherheitsabschaltung |
| 0x21 | Schliessfedern defekt |
| 0x22 | Fehler Soll-Istvergleich |
| 0x23 | Bank 1 zu klein |
| 0x24 | Bank 2 zu klein |
| 0x25 | beide Baenke zu klein |
| 0x30 | MIL-Anforderung durch SMG |
| 0x40 | Ansaugdruck &gt; Umgebungsdruck bei laufendem Motor |
| 0x50 | T-Erhöhung zu gering oder Kühler wärmer als Motor |
| 0x60 | Fehlerkennzeichnung T_Umg. in CAN-Botschaft |
| 0x61 | Erkennung hängender Sensor nach längerer Fzg.-Standzeit |
| 0x62 | unplausible Fzg.-Standzeit |
| 0x63 | unplausible Relativzeit während Motor läuft |
| 0xB0 | Hochlauf n zu v |
| 0xB1 | Verzoegerungsabschaltung |
| 0xB2 | Maximaldrehzahl |
| 0xB3 | v-Signal unplausibel |
| 0xB4 | Formatfehler |
| 0xB5 | Redundanzvergleich |
| 0xB6 | unerwarteter Code |
| 0xB7 | kein Togglebit |
| 0xBA | innerhalb FTP-Zyklus |
| 0xBB | ausserhalb FTP-Zyklus |
| 0xBC | im 1. Messintervall Warmlauf |
| 0xBD | im Betriebsintervall Warmlauf |
| 0xBE | im 1. Messintervall |
| 0xBF | im Betriebsintervall |
| 0xC0 | KAT-schaedigend |
| 0xC1 | abgasverschlechternd |
| 0xC2 | Ueberwachung Nullmomentenvorgabe |
| 0xC3 | Ueberwachung Soll-/Istmoment |
| 0xC4 | Bereichsueberwachung minimales Motormoment |
| 0xC5 | Bereichsueberschreitung Momentenberechnung |
| 0xC6 | kein Druck |
| 0xC9 | Leerlauf-MAX-Fehler |
| 0xCA | Leerlauf-MIN-Fehler |
| 0xCB | Teillast-MAX-Fehler |
| 0xCC | Teillast-MIN-Fehler |
| 0xCD | Magersprungzeit zu lang |
| 0xCE | Fettsprungzeit zu lang |
| 0xCF | Sondenhub zu klein |
...
| 0xD6 | Sondenspannung nach Schub unplausibel |
| 0xD7 | Grenzwert ueberschritten |
| 0xD8 | Grobleck |
| 0xD9 | Feinleck |
| 0xDA | Stromverlauf unplausibel |
| 0xDB | Sondenspannung bei Wiedereinsetzen |
| 0xDC | TV-Wert zu gross |
| 0xDD | TV-Wert zu klein |
| 0xDE | Sondenspannung zu fett nach Schubabschalten |
| 0xDF | Sondenspannung zu mager nach Wiedereinsetzen |
| 0xE0 | klemmt offen |
...
| 0x08 | AVANOS 2 Soll | Grad KW | 0.8 | 0 |
| 0x09 | AVANOS 2 Ist | Grad KW | 0.8 | 0 |
...
| 0x20 | Sondenheizwiderst. 1 v. Kat | Ohm | 0.1 | 0 |
| 0x21 | Sondenheizwiderst. 2 v. Kat | Ohm | 0.1 | 0 |
| 0x22 | Sondenheizwiderst. 1 n. Kat | Ohm | 0.1 | 0 |
| 0x23 | Sondenheizwiderst. 2 n. Kat | Ohm | 0.1 | 0 |
| 0x24 | Periodendauermessung 1 | ms | 128.0 | 0 |
| 0x25 | Periodendauermessung 2 | ms | 128.0 | 0 |
| 0x26 | Integral TV-Versch. n. Kat 1 | ms | 5 | 0 |
| 0x27 | Integral TV-Versch. n. Kat 2 | ms | 5 | 0 |
...
| 0x2F | Guete KAT-Konvertierung 1 | - | 0.0078431 | 0 |
| 0x30 | Guete KAT-Konvertierung 2 | - | 0.0078431 | 0 |
...
| 0x4C | Abweichung Lambda-Adapt.fak. Bank1 | - | 0.0078125 | -1 |
| 0x4D | Abweichung Lambda-Adapt.fak. Bank2 | - | 0.0078125 | -1 |
| 0x4E | Tankfuellstand | l | 1 | 0 |
| 0xF0 | Fahrstrecke seit Auftreten des Fehlers | km | 1 | 0 |
...
| --- | --- | --- |
| 0x00 | BRK | 0 ABBRUCH_GRUNDZUSTAND |
| 0x01 | STATE | 1_STATUS_SEKUNDAERLUFT |
| 0x02 | STATE | 2_STATUS_KATHEIZEN |
| 0x03 | STATE | 3_STATUS_TEVAKTIV |
| 0x04 | STATE | 4_STATUS_LENKWINKELDYNAMIK |
| 0x05 | STATE | 5_STATUS_GESCHWINDIGKEIT |
| 0x06 | STATE | 6_STATUS_KLIMAKOMPRESSOR |
| 0x07 | STATE | 7_STATUS_KEIN_LEERLAUF |
| 0x08 | STATE | 8_STATUS_FREMDE_FEHLER |
| 0x09 | STATE | 9_STATUS_LL_STABIL |
| 0x0a | STATE | 10_STATUS_PRECOND_SCHLIESSEN |
| 0x0b | STATE | 11_STATUS_PRECOND_ZU |
| 0x0c | STATE | 12_STATUS_TEV_RAMPE_AUF |
| 0x0d | STATE | 13_STATUS_WARTE_AUF |
| 0x0e | STATE | 14_STATUS_TEV_RAMPE_ZU |
| 0x0f | STATE | 15_STATUS_WARTE_ZU |
| 0x10 | RSLT | 16_ERGEBNIS_TEV_OK |
| 0x11 | RSLT | 17_ERGEBNIS_LL_OK |
