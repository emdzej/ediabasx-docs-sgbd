...
| Name | Type | Comment |
| --- | --- | --- |
| DATEN | binary | Zu speichernde Daten (16 Byte, Bereich 0x00-0xFF) |
...
| STAT_ANA_U_BB_SLOW_WERT | real | Mittlere Spannung Bordbatterie |
| STAT_ANA_U_BB_SLOW_EINH | string | Einheit von Mittlere Spannung Bordbatterie |
| STAT_ANA_U_SB_SLOW_WERT | real | Mittlere Spannung Starterbatterie |
