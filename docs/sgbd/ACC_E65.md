...
| Field | Value |
| --- | --- |
| ECU | Active Cruise Control E65 |
| ORIGIN | BMW EF-62 Freistadt |
| REVISION | 3.00 |
| AUTHOR | BERTRANDT Florian Postl, TI-431 Helmich |
| COMMENT | Prototyp fuer E65 |
| PACKAGE | 1.28 |
| SPRACHE | deutsch |
...
- [EOL_KONFIGURATION_LESEN](#job-eol-konfiguration-lesen) - Lesen der Bandende-Konfiguration Modi: Default
...
- [STATUS_JUSTAGEDATEN_NEU](#job-status-justagedaten-neu) - Justagedaten lesen, auszuwertende Spektrallinie frei waehlbar Modus: BMW-Default
- [STATUS_JUSTAGEDATEN](#job-status-justagedaten) - auszuwertende Spektrallinie = 2 Modus: BMW-Default
...
- [TESTCHECKSUMCODIERDATENSPU](#job-testchecksumcodierdatenspu) - Test der Checksumme der SPU-Codierdaten Modi: Default
- [TESTCHECKSUMCODIERDATENRPU](#job-testchecksumcodierdatenrpu) - Test der Checksumme der RPU-Codierdaten Modi: Default
...
<a id="job-eol-konfiguration-lesen"></a>
### EOL_KONFIGURATION_LESEN
...
| LENKWINKEL_OFFSET | real | Offset des Lenkwinkels in rad |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
Justagedaten lesen, auszuwertende Spektrallinie frei waehlbar Modus: BMW-Default
...
auszuwertende Spektrallinie = 2 Modus: BMW-Default
...
<a id="job-testchecksumcodierdatenspu"></a>
### TESTCHECKSUMCODIERDATENSPU

Test der Checksumme der SPU-Codierdaten Modi: Default
...
<a id="job-testchecksumcodierdatenrpu"></a>
### TESTCHECKSUMCODIERDATENRPU

Test der Checksumme der RPU-Codierdaten Modi: Default
...
- [FUMWELTMATRIX](#table-fumweltmatrix) (9 × 6)
- [ANALOG](#table-analog) (1 × 5)
- [DIGITAL](#table-digital) (1 × 5)
- [ZUSAETZE1](#table-zusaetze1) (1 × 2)
- [ZUSAETZE2](#table-zusaetze2) (1 × 2)
- [DEGRAD](#table-degrad) (5 × 2)
- [CANID](#table-canid) (291 × 2)
...
| --- | --- | --- | --- | --- | --- |
| 0xCD38 | ANALOG | DIGITAL | ZUSAETZE1 | ZUSAETZE2 | - |
| 0xCD39 | ANALOG | DIGITAL | ZUSAETZE1 | ZUSAETZE2 | - |
| 0xD17C | ANALOG | DIGITAL | ZUSAETZE1 | ZUSAETZE2 | - |
| 0xD17D | ANALOG | DIGITAL | ZUSAETZE1 | ZUSAETZE2 | - |
| 0xD17E | ANALOG | DIGITAL | ZUSAETZE1 | ZUSAETZE2 | - |
| 0xD181 | ANALOG | DIGITAL | ZUSAETZE1 | ZUSAETZE2 | - |
| 0xD182 | ANALOG | DIGITAL | ZUSAETZE1 | ZUSAETZE2 | - |
| 0x5D0F | ANALOG | DIGITAL | ZUSAETZE1 | ZUSAETZE2 | - |
...
| WERT | UWTEXT |
| --- | --- |
| 0x00 | Dejustagegrad des Sensors: nicht vorhanden: 0 |
| 0x01 | Dejustagegrad des Sensors: wenig: 1 |
| 0x02 | Dejustagegrad des Sensors: mittel: 2 |
| 0x03 | Dejustagegrad des Sensors: stark: 3 |
| 0xXY | Dejustagegrad: unplausibel |
...
| 0x00A8 | 168 (0x00A8) - Drehmoment_1 (DDE,DME) |
| 0x00A9 | 169 (0x00A9) - Drehmoment_2 (DDE,DME) |
| 0x00AA | 170 (0x00AA) - Drehmoment_3 (DDE,DME) |
| 0x00AD | 173 (0x00AD) - Verzoegerungsanforderung_ACC (ACC) |
| 0x00AE | 174 (0x00AE) - Verzoegerungsanforderung_EMF (EMF) |
| 0x00B7 | 183 (0x00B7) - Drehmomentanforderung_ACC (ACC) |
| 0x00BA | 186 (0x00BA) - Getriebedaten (EGS,SMG) |
| 0x00BB | 187 (0x00BB) - Sollmomentanforderung (DXC) |
| 0x00C4 | 196 (0x00C4) - Lenkradwinkel (DSC,DXC) |
| 0x00CE | 206 (0x00CE) - Radgeschwindigkeit (DSC,DXC) |
| 0x0130 | 304 (0x0130) - Klemmenstatus (CAS) |
| 0x0190 | 400 (0x0190) - Anzeige_ACC (ACC) |
| 0x0194 | 404 (0x0194) - Bedienung_Tempomat/ACC (SZL) |
| 0x019E | 414 (0x019E) - Status_DSC (DSC,DXC) |
| 0x01A0 | 416 (0x01A0) - Geschwindigkeit (DSC,DXC) |
| 0x01B4 | 436 (0x01B4) - Status_Kombi (Kombi) |
| 0x01D0 | 464 (0x01D0) - Motordaten (DDE,DME) |
| 0x01D2 | 466 (0x01D2) - Anzeige_Getriebedaten (EGS,SMG) |
| 0x01F6 | 502 (0x01F6) - Blinken (LM) |
| 0x021A | 538 (0x021A) - Lampenzustand (LM) |
| 0x0226 | 550 (0x0226) - Regensensor-Wischergeschwindigkeit (RLS) |
| 0x024A | 586 (0x024A) - Status_PDC (PDC) |
| 0x02B2 | 690 (0x02B2) - Raddruecke (DSC,DXC) |
| 0x02E4 | 740 (0x02E4) - Status_Anhaenger (AHM) |
| 0x02F8 | 760 (0x02F8) - Uhrzeit/Datum (Kombi) |
| 0x02FA | 762 (0x02FA) - Sitzbelegung_Gurtkontakte (SBSL,SBSR) |
| 0x0310 | 784 (0x0310) - Aussentemperatur/Relativzeit (Kombi) |
| 0x0330 | 816 (0x0330) - Kilometerstand/Reichweite (Kombi) |
| 0x0332 | 818 (0x0332) - Fahreranzeige_Drehzahlbereich (DDE,DME) |
| 0x0374 | 884 (0x0374) - Radtoleranzabgleich (DSC,DXC) |
| 0x0388 | 904 (0x0388) - Fahrzeugtyp (CAS) |
| 0x0398 | 920 (0x0398) - Bedienung_Fahrwerk (CCC,M_ASK) |
| 0x03B0 | 944 (0x03B0) - Status_Gang_Rueckwaerts (LM) |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 0x01 | Betriebsstundenzaehler | Stunden | low | unsigned int | - | 1 | 8 | 0 |
...
| 0x05 | Dejustagegrad des Sensors | 0-n | - | 0x03 | DeGrad | - | - | - |
| 0x06 | Linsenheizung | 0/1 | - | 0x04 | - | - | - | - |
| 0x07 | Verschmutzung der Linse | 0/1 | - | 0x08 | - | - | - | - |
| 0x08 | Abschaltung durch SPU (CANSTOP) | 0/1 | - | 0x10 | - | - | - | - |
| 0x09 | CAN-ID: | 0-n | L | 0xFFFF | CANId | - | - | - |
| 0x0A | Error code: | hex | - | unsigned int | - | - | - | - |
