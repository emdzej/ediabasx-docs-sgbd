...
- [STATUS_DRIVE_CD](#job-status-drive-cd) - Status of CD Drive
- [STATUS_DRIVE_FLASHSPEICHER](#job-status-drive-flashspeicher) - Returns information about the Flashdrive
...
- [STATUS_USB_TEST_TEL](#job-status-usb-test-tel) - Returns status of USB mass storage recognition for USB Interface (KDZ) OR Tele-phone Snap In Adapter (SIA)
...
- [STATUS_BT](#job-status-bt) - Returns the Bluetooth activation state.
- [STATUS_BT_ERKENNUNGSMODUS](#job-status-bt-erkennungsmodus) - Returns the activation state of the Bluetooth discovery mode
- [STATUS_BT_FIRMWARE](#job-status-bt-firmware) - Returns the Bluetooth firmware
...
- [STATUS_BT_GERAETEADRESSE](#job-status-bt-geraeteadresse) - Returns the Bluetooth address
- [STATUS_BT_GERAETENAME](#job-status-bt-geraetename) - Reads the Bluetooth device name
- [STATUS_BT_READ_PHONE_ID](#job-status-bt-read-phone-id) - Returns information about the phone selected as argument
- [STEUERN_BT_DELETE_ALL_PHONE_ID](#job-steuern-bt-delete-all-phone-id) - Deletes all phone information that is readable with the job status_bt_read_phone_id
- [STEUERN_BT_ERKENNUNGSMODUS](#job-steuern-bt-erkennungsmodus) - Controls the activation state of the Bluetooth discovery mode
- [STEUERN_BT_GERAETENAME](#job-steuern-bt-geraetename) - Writes the Bluetooth device name
- [STEUERN_RESET_TO_BASIC_STATE](#job-steuern-reset-to-basic-state) - Deletes personal information related to the phone or to API functions
...
- [STATUS_LESEN_SYSTEMAUDIO_VARIANTE](#job-status-lesen-systemaudio-variante) - This job reads which audio variant and system is currently coded
...
- [STATUS_PKR](#job-status-pkr) - Check, if HU is Champ2 PKR or not
...
<a id="job-status-drive-flashspeicher"></a>
### STATUS_DRIVE_FLASHSPEICHER

Returns information about the Flashdrive
...
| Name | Type | Comment |
| --- | --- | --- |
| STAT_FREE_DISKSPACE_PERCENT_WERT | unsigned char | Free diskspace of the drive in percent |
| STAT_FREE_DISKSPACE_MBYTE_WERT | unsigned long | Free diskspace of the HDD in Mbytes |
...
| STAT_GPS_PDOP_TEXT | string | GPS (Position) Dilution Of Position |
| STAT_GPS_HDOP_TEXT | string | GPS Horizontal Dilution Of Position |
| STAT_GPS_VDOP_TEXT | string | GPS Vertical Dilution Of Position |
| JOB_STATUS | string | "OKAY", wenn fehlerfrei |
| _REQUEST | binary | Hex-Auftrag an SG |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| Name | Type | Comment |
| --- | --- | --- |
| ARG_COMMAND | unsigned int | Command that must be spoken out values from table TNaviOutput |
...
| STAT_USB_TEST_TEL_KDZ | unsigned char | test result of KDZ |
| STAT_USB_TEST_TEL_KDZ_TEXT | string | test result KDZ text |
...
| STAT_USB_TEST_TEL_SIA | unsigned char | test result of KDZ |
| STAT_USB_TEST_TEL_SIA_TEXT | string | test result KDZ text |
...
| STAT_HU_COMBOX_ETHERNET_CONNECTION_STATE | unsigned char | State of the Ethernet connection for flash process values from table TEthernetActivationState |
| STAT_HU_COMBOX_ETHERNET_CONNECTION_STATE_TEXT | string | State of the Ethernet connection for flash process values from table TEthernetActivationState |
| STAT_RSE_COMBOX_ETHERNET_CONNECTION_STATE | unsigned char | State of the Ethernet connection for flash process values from table TEthernetActivationState |
| STAT_RSE_COMBOX_ETHERNET_CONNECTION_STATE_TEXT | string | State of the Ethernet connection for flash process values from table TEthernetActivationState |
| JOB_STATUS | string | "OKAY", wenn fehlerfrei |
| _REQUEST | binary | Hex-Auftrag an SG |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| Name | Type | Comment |
| --- | --- | --- |
| STAT_BT | unsigned char | Bluetooth activation state value from table TBluetoothActivationState |
...
Returns the activation state of the Bluetooth discovery mode
...
| Name | Type | Comment |
| --- | --- | --- |
| STAT_BT_ERKENNUNGSMODUS | unsigned char | Activation state of the Bluetooth discovery mode value from table TBtDiscoveryModeActivationState |
...
<a id="job-status-bt-firmware"></a>
### STATUS_BT_FIRMWARE

Returns the Bluetooth firmware
...
| Name | Type | Comment |
| --- | --- | --- |
| STAT_BT_FIRMWARE | string | Bluetooth firmware |
| JOB_STATUS | string | "OKAY", wenn fehlerfrei |
| _REQUEST | binary | Hex-Auftrag an SG |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
Reads the Bluetooth device name
...
Deletes all phone information that is readable with the job status_bt_read_phone_id
...
Controls the activation state of the Bluetooth discovery mode

#### Arguments

| Name | Type | Comment |
| --- | --- | --- |
| ARG_BT_ERKENNUNGSMODUS | unsigned char | Activation state of the Bluetooth discovery mode value from table TBtDiscoveryModeActivationState 0x00	discovery mode off 0x01	discovery mode on |
...
Writes the Bluetooth device name

#### Arguments

| Name | Type | Comment |
| --- | --- | --- |
| ARG_BT_GERAETENAME | string | Bluetooth device name The Bluetooth device name has a maximum of 18 characters |
...
Deletes personal information related to the phone or to API functions

#### Arguments

| Name | Type | Comment |
| --- | --- | --- |
| ARG_DATA_TO_RESET | unsigned long | Data that must be deleted value from table TPersonalPhoneData |
...
<a id="job-status-lesen-systemaudio-variante"></a>
### STATUS_LESEN_SYSTEMAUDIO_VARIANTE

This job reads which audio variant and system is currently coded
...
| --- | --- | --- |
| STAT_AUDIO_SYSTEM | unsigned char | Currently coded Audio System, 0	STEREO, 1	HIFI, 2	TOP-HIFI |
| STAT_AUDIO_SYSTEM_TEXT | string | Currently coded Audio System from table TAudioSystem |
| STAT_AUDIO_VARIANTE | unsigned char | Currently coded Audio Variante |
| STAT_AUDIO_VARIANTE_TEXT | string | Currently coded Audio Variante from table TAudioVariante |
| JOB_STATUS | string | "OKAY", wenn fehlerfrei |
| _REQUEST | binary | Hex-Auftrag an SG |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
<a id="job-status-pkr"></a>
### STATUS_PKR

Check, if HU is Champ2 PKR or not
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei |
| STAT_PKR | unsigned char | 0x00 kein PKR 0x01 PKR 0xFF ungültig |
| _TEL_AUFTRAG | binary | Hex-Auftrag an SG |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
- [LIEFERANTEN](#table-lieferanten) (130 × 2)
...
| 0x1161 | 0x1701 | 0x420C | - | - |
| 0x1160 | 0x420D | 0x4214 | - | - |
| 0xFFFF | - | - | - | - |
...
| 0xC50F | Verbindung Head-Unit zum DAB L-Band Antennenfuß: Kurzschluss nach Masse |
| 0xC511 | Verbindung Head-Unit zum DAB Band III Antennenfuß: Leitungsunterbrechung |
| 0xC513 | Verbindung Head-Unit zum DAB Band III Antennenfuß: Kurzschluss nach Masse |
...
| 0xE1EA | Default GW Tabelle lässt Flashen und Kodieren vor der ersten Kodierung nicht zu |
...
| 0xC53C | Verbindung Head-Unit zum Aux-In Box: Leitungsunterbrechung |
...
| 0xC562 | FBAS-Eingang 3: kein Signal vorhanden |
| 0xC566 | A4A: interner Steuergerätefehler (DRM-Chip defekt) |
...
| 0xC5B1 | Flashspeicher (SD-Karte/INAND) Hardware Fehler |
| 0xC5B2 | Verbindung Head-Unit zum Bluetooth Antennenfuß: Leitungsunterbrechung |
| 0xC5B5 | Bluetooth Chip: defekt |
| 0xC5B6 | CD Laufwerk Hardware Fehler |
| 0xC5B7 | Medium Fehler im CD Laufwerk |
| 0xC5B8 | ATC Test negativ: CD Laufwerk defekt |
| 0xE1E9 | Ausfall von dem forderen Bildschirm |
| 0xC580 | FB Hardware Fehler |
| 0xC583 | Lüfter Fehler |
| 0xC585 | Interner Temperaturfehler (Temp. über 85 C) |
| 0xC587 | Das Einschlafen von der Head-Unit wird verhindert |
...
| 0xC58C | Verbindung Head-Unit zur USB Benutzer Schnittstelle: Kurzschluss nach Masse |
...
| 0x10B2 | access is denied |
| 0x10B3 | the handle is invalid |
| 0x10B4 | the storage control blocks were destroyed |
| 0x10B5 | not enough storage is available to process this command |
| 0x10B6 | the access code is invalid |
| 0x10B7 | the data is invalid |
| 0x10B8 | the system cannot find the drive specified |
| 0x10B9 | the directory cannot be removed |
| 0x10BA | the media ist write protected |
| 0x10BB | the system cannot find the device specified |
| 0x10BC | data error (cyclic redundancy check) |
| 0x10BD | the drive cannot locate a specific area or track on the disc |
| 0x10BE | the system cannot find a file specified |
| 0x10BF | The system cannot write to the specified device |
| 0x1140 | The system cannot read from the specified device |
| 0x1141 | The process cannot access the file because it is being used by another process |
| 0x1142 | The disk is full |
| 0x1143 | The file exists |
| 0x1144 | The directory or file cannot be created |
| 0x1145 | Other error |
...
| 0x10D1 | Communication Timeout with SDARS |
| 0x10D2 | Myra Communication Timeout |
| 0x10E0 | Software Fehler für den Fehler Tracking Mechanismus |
| 0x1155 | Positionierung über 10 Minuten nicht möglich |
| 0x1156 | Kurzzeitiger Zusammenbruch der Kommunikation zwischen INIC und FR |
| 0x1157 | Video Watch Dog wurde ausgelöst |
| 0x1158 | Abbruch des laufenden PIA-Ablaufs wegen Fahrzeugzustandsänderung |
| 0x1101 | Partial address space was erased |
| 0x1102 | The read only section of The CSD does not match the card content |
| 0x1103 | A general or an unknown error |
| 0x1104 | Internal card controller error |
| 0x1105 | Card internal ECC failed to correct the data |
| 0x1106 | Command not legal for the card state |
| 0x1107 | The CRC check of the previous command failed |
| 0x1108 | A sequence or password error has been detected in lock/unlock card command |
| 0x1109 | Write to a protected block or to write protected card |
| 0x110A | An invalid selection of write-blocks for erase occurred |
| 0x110B | An error in the sequence of erase commands occurred |
| 0x110C | The block length is not allowed |
| 0x110D | A misaligned address which did not match the block length was used |
| 0x110E | The command's argument was out of the allowed range for this card |
| 0x1161 | Illegal attempt to access coding area |
| 0x1160 | Status_Funkschlüssel vom CAS-Steuergerät nicht erhalten |
| 0x1162 | Illegaler Zugriffsversuch auf den Codierbereich backup |
| 0xFFFF | unbekannter Fehlerort |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 0x0000 | 0x00 | 01 | 63 | 02 | 000C | 01 | 00 | 06 | 10020000000A | 00 |  | 06 | 10020000000A | 00 |  | Aktives Profil ohne Adressbuch |
| 0x0001 | 0xFF | 01 | 63 | 02 | 000C | 01 | 00 | 06 | 100200000005 | 00 |  | 06 | 100200000005 | 00 |  | Globales Adressbuch |
