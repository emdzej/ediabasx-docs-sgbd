...
| 0xB7F492 | Ungültige Codierdaten für Equalizing | 1 |
...
| 0xB7F4E4 | Lastteil: Versorgungsspannung unterbrochen | 0 |
| 0xB7F4A0 | Steuergerät: Übertemperatur erkannt | 1 |
| 0xB7F4E2 | Logikteil: Unterspannung erkannt | 1 |
| 0xD6C445 | Host hat bei fatalem Fehler vom INIC einen Reset ausgelöst | 0 |
| 0xD6C446 | MOST-Knoten: nicht auf Monitoringanfrage geantwortet | 0 |
| 0xD6C440 | Überwachungsschaltung hat Reset ausgelöst | 0 |
| 0x023700 | Energiesparmode aktiv | 1 |
| 0xD6C444 | MOST: Ring wacht nicht auf | 0 |
| 0xD6C448 | MOST-Knoten: zentrale Funktionsblockdatenbank unvollständig | 0 |
| 0x930011 | MOST: Ringbruch | 1 |
| 0xD6C447 | MOST-Knoten: alle Funktionsblöcke abgemeldet | 0 |
| 0xD6C442 | Sender- Empfängerbaustein (FOT): Temperatur übersteigt kritische Schwelle | 1 |
| 0xD6C443 | Sender- Empfängerbaustein (FOT): Temperatur übersteigt kritische Schwelle in anderem SG | 0 |
| 0xD6C43F | Empfängerknoten: hat Nachricht nicht abgenommen; Puffer voll | 1 |
| 0xD6CBFF | DM_TEST_COM | 0 |
| 0x02FF37 | DM_TEST_APPL | 0 |
...
| UWNR | UWTEXT | UW_EINH | L/H | UWTYP | NAME | MUL | DIV | ADD |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 0x4001 | Spannung | Volt | - | unsigned int | - | 1 | 1000 | 0 |
