...
| Field | Value |
| --- | --- |
| ECU | ME9 fuer N45-Motoren  |
| ORIGIN | BMW EA-53 Rigl |
| REVISION | 5.001 |
| AUTHOR | BMW EA-53 S.Rigl |
| COMMENT | SGBD fuer N45  |
| PACKAGE | 1.29 |
| SPRACHE | deutsch |
...
- [STEUERN_ELUP](#job-steuern-elup)
- [STEUERN_ELUP_AUS](#job-steuern-elup-aus)
...
| --- | --- | --- |
| JOB_STATUS | string | "OKAY", wenn fehlerfrei |
| STAT_L_SONDE_2_WERT | real | Wert der Lambdasonden Spannung |
| STAT_L_SONDE_2_EINH | string | Einheit der Lambdasonden Spannung |
| _TEL_AUFTRAG | binary | Hex-Auftrag an SG |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
- [FORTTEXTE](#table-forttexte) (187 × 2)
- [FDETAILSTRUKTUR](#table-fdetailstruktur) (7 × 2)
- [FARTTEXTEERWEITERT](#table-farttexteerweitert) (12 × 3)
- [FUMWELTMATRIX](#table-fumweltmatrix) (187 × 5)
- [FUMWELTTEXTE](#table-fumwelttexte) (211 × 9)
- [FARTTYP](#table-farttyp) (178 × 5)
...
| 0x29E5 | CDKFRAO - LR-Adaption multiplikativ Bereich2 |
...
| 0x2DEC | CDKPMBATT - Powermanagement Batterie |
...
| 0x2E8B | CDKDIBS1 - IBS Kommunikation |
| 0x2E8C | CDKDIBS2 - IBS Allgemeine Fehler |
| 0x2E8D | CDKDIBS3 - IBS Plausibilitaet |
| 0x2E95 | CDKDGENBS - Generatorkommunikation |
| 0x2E97 | CDKDGEN/CDKGEN - BSD Generator |
| 0x2E9F | CDKOEZS - Fehler Oelzustandssensor |
| 0x2EA0 | CDKQLT - Fehler Oelqualitätssensor |
...
| 0x2FB2 | CDKBKVPE - Saugstrahlpumpe für Bremskraftverstärker |
| 0x2FB7 | CDKBKVSPE - elektr. Unterdruckpumpe für Bremskraftverstärker |
...
| 0x2BB6 | 0x14 | 0xDF | 0x0A | 0x12 |
| 0x2C24 | 0x12 | 0x8C | 0x06 | 0x08 |
| 0x2C45 | 0x29 | 0x8C | 0x31 | 0x16 |
...
| 0x2DEB | 0x14 | 0xDD | 0xDE | 0xDF |
| 0x2DEC | 0x14 | 0xDD | 0xDE | 0xDF |
...
| 0x2FB2 | 0x35 | 0x14 | 0x24 | 0x1A |
| 0x2FB7 | 0x0A | 0x14 | 0x11 | 0x35 |
...
| 0x1F | egaspfad | bin | - | unsigned char | - | 1 | 1 | 0 |
...
| 0xD5 | intelligenter Batteriesensor Fehler 2(ibsderrs2_u) |   | - | unsigned char | - | 1 | 1 | 0 |
...
| 0x29EB | 0xFF | 0xFF | 0x97 | 0x96 |
| 0x29ED | 0xFF | 0xFF | 0x96 | 0x97 |
| 0x29EE | 0xFF | 0xFF | 0x96 | 0x97 |
| 0x29F4 | 0xFF | 0xFF | 0xFF | 0x7D |
| 0x29F5 | 0xFF | 0xFF | 0xFF | 0x7D |
| 0x29F8 | 0xFF | 0xFF | 0xFF | 0x7D |
| 0x29F9 | 0xFF | 0xFF | 0xFF | 0x7D |
| 0x29FE | 0xFF | 0xFF | 0x98 | 0xFF |
| 0x29FF | 0xFF | 0xFF | 0x98 | 0xFF |
| 0x2A02 | 0xFF | 0x22 | 0x07 | 0x08 |
| 0x2A03 | 0xFF | 0x22 | 0x07 | 0x08 |
| 0x2A0E | 0xFF | 0x22 | 0x07 | 0x08 |
...
| 0x2D6F | 0xAC | 0xFF | 0xFF | 0xFF |
| 0x2D70 | 0xA9 | 0xAA | 0xAB | 0xAC |
| 0x2D71 | 0xAD | 0xAE | 0xFF | 0xFF |
| 0x2D72 | 0xFF | 0xFF | 0xFF | 0xAF |
...
| 0x2DDA | 0xE5 | 0xC6 | 0xFF | 0xFF |
| 0x2DDB | 0xFF | 0xC6 | 0xFF | 0xFF |
| 0x2DDC | 0xC9 | 0xC6 | 0xC5 | 0xFF |
| 0x2DEB | 0xE4 | 0xE3 | 0xE1 | 0xE2 |
...
| 0x2E8D | 0xCE | 0xE0 | 0xFF | 0x07 |
| 0x2E95 | 0x0F | 0x10 | 0xFF | 0xFF |
| 0x2E97 | 0x0C | 0x0D | 0xFF | 0x0E |
| 0x2E9F | 0x15 | 0x16 | 0x17 | 0x14 |
| 0x2EA0 | 0x17 | 0x16 | 0x15 | 0xFF |
| 0x2EE0 | 0x9E | 0x9F | 0x9C | 0x07 |
| 0x2EEA | 0x29 | 0xFF | 0x9C | 0x07 |
| 0x2EF4 | 0x04 | 0x03 | 0xA0 | 0x01 |
| 0x2EF5 | 0xFF | 0x22 | 0x07 | 0x08 |
| 0x2EF6 | 0x04 | 0x22 | 0x07 | 0x08 |
| 0x2EFE | 0xFF | 0x22 | 0x07 | 0x08 |
| 0x2F08 | 0x3E | 0xFF | 0x08 | 0x07 |
| 0x2F12 | 0xFF | 0x22 | 0x07 | 0x08 |
| 0x2F17 | 0xFF | 0xFF | 0xFF | 0x3D |
...
| 0x2F99 | 0xA2 | 0xFF | 0xFF | 0xFF |
| 0x2F9E | 0x15 | 0x16 | 0x17 | 0xFF |
| 0x2FA3 | 0x36 | 0xFF | 0xFF | 0xFF |
| 0x2FB2 | 0xFF | 0x22 | 0x07 | 0x08 |
| 0x2FB7 | 0xFF | 0x22 | 0x07 | 0x08 |
| 0xCD87 | 0xFF | 0x35 | 0xFF | 0x33 |
...
| 0x28 | Sonde defekt |
| 0x29 | Kühlertemperatur unplausibel oder hängender Sensor |
...
| 0x3D | Zwangshochschaltung Getriebe |
| 0x3E | Ansauglufttemperatur unplausibel |
...
| 0xE4 | Ruhestrom |
| 0xE5 | Checksumme oder Alivefehler |
