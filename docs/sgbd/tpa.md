...
| Field | Value |
| --- | --- |
| ECU | Telematic Platform Accessory  |
| ORIGIN | BMW VP-23 Hans-Juergen Winkler |
| REVISION | 0.003 |
| AUTHOR | ASKON_CG EI-43 H.Kloess_nicht_mehr_im_Projekt, Bertrandt EI-41  |
| COMMENT | N/A |
| PACKAGE | 1.50 |
| SPRACHE | deutsch |
...
- [STEUERN_TRIGGER_SELFTEST](#job-steuern-trigger-selftest) - Triggers TPA self test KWP2000 and UDS: $2E WriteDataByCommonId $FD DataID $00 TriggerSelftest Modus  : Default
- [STATUS_TRIGGER_SELFTEST](#job-status-trigger-selftest) - Read status of TPA self test KWP2000 and UDS: $22 ReadDataByCommonId $FD DataID $01 Request ID - RequestSelftest Modus  : Default
- [LESEN_TEILENUMMER](#job-lesen-teilenummer) - Read BMW part number / Laendervariante KWP2000 and UDS: $22 ReadDataByCommonId $FD DataID $02 Request ID - Request BMW Part Number Modus  : Default
- [LESEN_SERIENNUMMER](#job-lesen-seriennummer) - Read SERIENNUMMER KWP2000 and UDS: $22 ReadDataByCommonId $FD DataID (a) $03 Request ID - SERIENNUMMER part 1 (b) $04 Request ID - SERIENNUMMER part 2 (c) $05 Request ID - SERIENNUMMER part 3 Modus  : Default
...
| Name | Type | Comment |
| --- | --- | --- |
| BUS_SETTING | int | 0 - BN2000 1 - BN2020 |
| IMMOBILIZE | int | 0 - no (relay closed) 1 - yes (relay open) |
...
| Name | Type | Comment |
| --- | --- | --- |
| STAT_KL30 | int | 0 - Kl.30 not available 1 - Kl.30 available |
| STAT_KL15 | int | 0 - Kl.15 not available 1 - Kl.15 available |
| STAT_ENGINE | int | 0 - Engine off 1 - Engine running |
| STAT_GSM | int | 0 - GSM antenna open/short 1 - GSM antenna connected |
| STAT_GPS | int | 0 - GPS antenna open/short 1 - GPS antenna connected |
| STAT_BATTERY | int | 0 - Backup battery missing 1 - Backup battery connected |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| Name | Type | Comment |
| --- | --- | --- |
| BMW_PART_NUMBER | string | BMW part number (7 bytes) |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| Name | Type | Comment |
| --- | --- | --- |
| SERIENNUMMER | string | SERIENNUMMER (18 bytes) |
| SERIAL_NUMBER | string | SERIAL_NUMBER (18 bytes) |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
