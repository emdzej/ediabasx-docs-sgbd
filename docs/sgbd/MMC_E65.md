...
| REVISION | 1.051 |
| AUTHOR | ALPINE AOGE Nordalm, BMW EE-412 Maack, BMW TI-431 Rochal, EUROSPACE EE-41 Carre, ALPINE_Electronics AOGE-MN Duenzelmann |
| COMMENT | MMC_E65  |
| PACKAGE | 1.29 |
| SPRACHE | deutsch |
...
- [BETRIEBSSTUNDEN_LESEN](#job-betriebsstunden-lesen) - Auslesen des Betriebsstunden Zählers KWP2000: $21 ReadDataByLocalIdentifier $01 RLI Modus: Default
- [CD_LADEZYCLEN_LESEN](#job-cd-ladezyclen-lesen) - Auslesen des CD ladezyclen Zählers KWP2000: $21 ReadDataByLocalIdentifier $02 RLI Modus: Default
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STUNDEN | string | Betriebsstunden |
| EINHEIT | string | Einheit der Betriebsstunden |
| TEXT | string | Erklärung |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |

<a id="job-cd-ladezyclen-lesen"></a>
### CD_LADEZYCLEN_LESEN
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| ZYCLEN | string | Ladezyclen |
| EINHEIT | string | Einheit der Ladezyclen |
| TEXT | string | Erklärung |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
- [UWTEMP](#table-uwtemp) (161 × 2)
- [UWRESET](#table-uwreset) (5 × 2)
...
| 0x9D2C | Fehler Security Access |
| 0xD54E | Obwohl Shutdown(Execute) geschickt wurde, ging das Licht nicht aus (Error_Light_Not_Off). |
| 0xD550 | Ringbruchdiagnose wurde durchgefuehrt (Error_Ring_Diagnose). |
| 0xD551 | Lange und/oder häufige Unlocks (Error_Unlock_Long). |
| 0xD552 | Abgeschaltet wegen zu hoher Temperatur im Gerät (Error_TempShutDown). |
...
| 0x11 | Temperatur Pickup | 0-n | -- | 0xFF | UWTemp | - | - | - |
| 0xXY | unbek. erw. Umweltbed. | 1 | -- | unsigned char | -- | 1 | 1 | 0 |
...
| 0x05 | Reset - Trigger | 0-n | - | 0xFF | UWReset | - | - | - |
...
| WERT | UWTEXT |
| --- | --- |
| 0x00 | normale Betriebsspannung 9 bis 16 Volt |
| 0x01 | Ueberspannung  &gt; 16 Volt |
...
| WERT | UWTEXT |
| --- | --- |
| 0x00 | MOST Steuergerät |
| 0x01 | Mechanik |
| 0x02 | Unterspannung |
| 0xFF | Resetgrund unbekannt |
| 0xXY | Wert unplausibel |
