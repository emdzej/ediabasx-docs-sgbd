...
| Field | Value |
| --- | --- |
| ECU | Bedienzentrale Mittelkonsole Gangwahlschalter |
| ORIGIN | BMW EI-841 Uzun |
| REVISION | 1.008 |
| AUTHOR | PREH-GMBH EI-510 Braun |
| COMMENT | I-400 Lieferant Qualifizirungsstand |
| PACKAGE | 1.984 |
| SPRACHE | deutsch |
...
- [FORTTEXTE](#table-forttexte) (40 × 4)
- [FUMWELTTEXTE](#table-fumwelttexte) (4 × 9)
- [IDETAILSTRUKTUR](#table-idetailstruktur) (5 × 2)
- [IORTTEXTE](#table-iorttexte) (35 × 4)
...
- [RES_0XD5AC_D](#table-res-0xd5ac-d) (6 × 10)
...
| 0x025E08 | Codierung: Steuergerät ist nicht codiert | 0 | - |
| 0x025E09 | Codierung: Fehler bei Codierdatentransaktion aufgetreten | 0 | - |
| 0x025E0A | Codierung: Signatur der Codierdaten ungültig | 0 | - |
| 0x025E0B | Codierung: Codierdaten passen nicht zum Fahrzeug | 0 | - |
| 0x025E0C | Codierung: Unplausible Daten während Codierdatentransaktion | 0 | - |
...
| 0x802681 | Spielschutz Tasten mit aktiver Haptik in der Bedieneiheit Mittelkonsole | 1 | - |
...
| 0xE0940E | Botschaft (Geschwindigkeit Fahrzeug, 0x1A1) fehlt, Empfänger GWS (LP-CAN), Sender DSC_IB_VIP (LP-CAN) | 1 | - |
| 0xE09410 | Botschaft (Geschwindigkeit Fahrzeug, 0x1A1) nicht aktuelle, Empfänger GWS (FA-CAN), Sender DSC_IB_VIP (FA-CAN) | 1 | - |
...
| ORT | ORTTEXT | EREIGNIS_DTC | FEHLERKLASSE |
| --- | --- | --- | --- |
| 0x5E0100 | EPB_Backlight_Error | 1 | - |
| 0x5E0200 | CbBckIllError | 1 | - |
| 0x5E0300 | HwInfoEOLError | 0 | - |
| 0x5E0310 | ActiveHapticCurveFail | 0 | - |
| 0x5E0311 | MotorCurveFail | 0 | - |
| 0x5E0400 | CORTST_E_CORE_FAILURE | 0 | - |
| 0x5E0401 | HallMagnetsDiverse | 0 | - |
| 0x5E0402 | SwarovskiError | 0 | - |
| 0x5E0403 | Dummy3 | 0 | - |
| 0x5E0404 | Dummy4 | 0 | - |
| 0x5E0405 | Dummy5 | 0 | - |
| 0x5E0406 | Dummy6 | 0 | - |
...
| RESULTNAME | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_HALLSENSORIK_1_X_WERT | - | high | signed int | - | - | 1.0 | 1.0 | 0.0 | Positionswert des Hallsensors für diese Raumkoordinate |
| STAT_HALLSENSORIK_1_Y_WERT | - | high | signed int | - | - | 1.0 | 1.0 | 0.0 | Positionswert des Hallsensors für diese Raumkoordinate |
| STAT_HALLSENSORIK_1_Z_WERT | - | high | signed int | - | - | 1.0 | 1.0 | 0.0 | Positionswert des Hallsensors für diese Raumkoordinate |
| STAT_HALLSENSORIK_2_X_WERT | - | high | signed int | - | - | 1.0 | 1.0 | 0.0 | Positionswert des Hallsensors für diese Raumkoordinate |
| STAT_HALLSENSORIK_2_Y_WERT | - | high | signed int | - | - | 1.0 | 1.0 | 0.0 | Positionswert des Hallsensors für diese Raumkoordinate |
| STAT_HALLSENSORIK_2_Z_WERT | - | high | signed int | - | - | 1.0 | 1.0 | 0.0 | Positionswert des Hallsensors für diese Raumkoordinate |
...
| FIELDERRORBLOCK | 0x4712 | STAT__DATA | Data_Field for FEB | DATA | - | High | data[130] | - | 1.0 | 1.0 | 0.0 | - | 22 | - | - |
...
| HALLSENSORIK_WERT | 0xD5AC | - | Bitmuster der Hallsensorik | - | - | - | - | - | - | - | - | - | 22 | - | RES_0xD5AC_D |
