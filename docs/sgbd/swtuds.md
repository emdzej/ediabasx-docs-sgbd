...
| Field | Value |
| --- | --- |
| ECU | Spezial SGBD nur für SWT UDS SG's |
| ORIGIN | BMW TI-431 Seitz,Weber |
| REVISION | 0.910 |
| AUTHOR | BMW TI-431 Seitz(js), BMW TI-431 Weber(fw), ALTEN UX-EA-8 Ulbri |
| COMMENT | SG Adresse wird über Job SWT_PARAMETER_SETZEN in globaler Variable abgelegt |
| PACKAGE | 1.70 |
| SPRACHE | deutsch |
...
- [ZERTIFIKAT_LESEN](#job-zertifikat-lesen) - Lesen das Zertifikat im SG UDS:     $31 Routine Control Request $01 Start Routine $0F SweepingTechnologies $1F SweepingTechnologies $03 SWTGetSigSID
- [FREISCHALTCODE_LESEN](#job-freischaltcode-lesen) - Freischaltcode lesen UDS:     $31 Routine Control Request $01 Start Routine $0F SweepingTechnologies $1F SweepingTechnologies $03 SWTGetSigSID
- [SG_DATEN_LESEN](#job-sg-daten-lesen) - Lesen SG spezifischer Daten UDS:     $31 Routine Control Request $01 Start Routine $0F SweepingTechnologies $1F SweepingTechnologies $0D SWTGetSGData
...
- [FAHRGESTELLNUMMER_LESEN](#job-fahrgestellnummer-lesen) - FGN lesen im Steuergeraet UDS:     $22 Read data by local identifier $F1 VIN17 $90 VIN17
- [FAHRGESTELLNUMMER_SCHREIBEN](#job-fahrgestellnummer-schreiben) - FGN schreiben im Steuergeraet UDS:     $2E Write data by local identifier $F1 VIN17 $90 VIN17
- [FREISCHALTCODE_SCHREIBEN](#job-freischaltcode-schreiben) - Software Signature im SG lesen UDS:     $31 Routine Control Request $01 Start Routine $0F SweepingTechnologies $1F SweepingTechnologies $03 SWTGetSigSID
- [FREISCHALTCODE_PRUEFEN](#job-freischaltcode-pruefen) - Freischaltcode nach dem Einspielen prüfen UDS:     $31 Routine Control Request $01 Start Routine $0F SweepingTechnologies $1F SweepingTechnologies $09 SWTCheckFSC
...
| FSC_TYP | binary | 1 Byte Hex Format |
...
| FSC_TYP2 | binary | 1 Byte Hex Format |
| _REQUEST | binary | Hex-Auftrag an SG |
| _RESPONSE | binary | Hex-Antwort von SG |
...
Lesen das Zertifikat im SG UDS:     $31 Routine Control Request $01 Start Routine $0F SweepingTechnologies $1F SweepingTechnologies $03 SWTGetSigSID
...
Freischaltcode lesen UDS:     $31 Routine Control Request $01 Start Routine $0F SweepingTechnologies $1F SweepingTechnologies $03 SWTGetSigSID
...
| JOB_STATUS_CODE | string | 1 Byte Hex Format Eingangspunkt im table SwtFehler |
| FSC | binary | Daten des FSCs |
| _REQUEST | binary | Hex-Auftrag an SG |
| _RESPONSE | binary | Hex-Antwort von SG |

<a id="job-sg-daten-lesen"></a>
### SG_DATEN_LESEN

Lesen SG spezifischer Daten UDS:     $31 Routine Control Request $01 Start Routine $0F SweepingTechnologies $1F SweepingTechnologies $0D SWTGetSGData
...
| JOB_STATUS_CODE | string | 1 Byte Hex Format Eingangspunkt im table SwtFehler |
| SGDATA | binary | SG spezifische Daten |
| _REQUEST | binary | Hex-Auftrag an SG |
| _RESPONSE | binary | Hex-Antwort von SG |
...
| Name | Type | Comment |
| --- | --- | --- |
| MODE | string | gewuenschter Diagnose-Modus tabelle DiagMode MODE MODE_TEXT Defaultwert: DEFAULT (DefaultMode) |
...
FGN lesen im Steuergeraet UDS:     $22 Read data by local identifier $F1 VIN17 $90 VIN17
...
| JOB_STATUS_CODE | string | 1 Byte Hex Format Eingangspunkt im table SwtFehler |
| FG_NR | string | Fahrgestellnummer 17 Bytes |
| _REQUEST | binary | Hex-Auftrag an SG |
| _RESPONSE | binary | Hex-Antwort von SG |
...
FGN schreiben im Steuergeraet UDS:     $2E Write data by local identifier $F1 VIN17 $90 VIN17
...
Software Signature im SG lesen UDS:     $31 Routine Control Request $01 Start Routine $0F SweepingTechnologies $1F SweepingTechnologies $03 SWTGetSigSID
...
| --- | --- | --- |
| SW_ID | string | string hex Format 4 Bytes |
| FREISCHALTCODE | string | 1023 Maxi Das erste Byte stellt den Index des gesendeten Telegramms dar  Die zwei naechsten Bytes stellen die CALL_ID dar und werden im data Format eingetragen ID Nummer bei SG geliefert verbindet die 2 Funktionen $F2 und $F1 |
...
Freischaltcode nach dem Einspielen prüfen UDS:     $31 Routine Control Request $01 Start Routine $0F SweepingTechnologies $1F SweepingTechnologies $09 SWTCheckFSC
