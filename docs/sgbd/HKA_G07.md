...
| ORIGIN | BMW EI-833 Manfred_Hanselmann |
| REVISION | 1.000 |
...
| ARG | STR | STPR | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | MIN | MAX | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ABSPERRVENTIL | + | - | 0-n | high | unsigned char | - | TAB_ABSPERRVENTIL_KLIMA_HKA | - | - | - | - | - | Absperrventil HKA/Klimatisierung 3. Sitzreihe |
...
| 0x801880 | Motor Luftverteilung 3. Sitzreihe: Blockierung | 0 | - |
| 0x801881 | Motor Luftverteilung 3. Sitzreihe: interner Motorfehler | 0 | - |
| 0x801882 | Motor Luftverteilung 3. Sitzreihe: Initialisierungsfehler | 0 | - |
| 0x801886 | Motor Mischluft 3. Sitzreihe: Blockierung | 0 | - |
| 0x801887 | Motor Mischluft 3. Sitzreihe: interner Motorfehler | 0 | - |
| 0x801888 | Motor Mischluft 3. Sitzreihe: Initialisierungsfehler | 0 | - |
...
| 0x8018A0 | Gebläseendstufe 3. Sitzreihe: Interner Fehler | 0 | - |
| 0x8018A1 | Gebläseendstufe 3. Sitzreihe: Kurzschluss oder blockiert | 0 | - |
| 0x8018A2 | Gebläseendstufe 3. Sitzreihe: Übertemperaturbegrenzung aktiv | 1 | - |
| 0x8018A4 | Gebläseendstufe 3. Sitzreihe: Unterbrechung zum Motor | 0 | - |
| 0x8018B0 | Kältemittelabsperrventil hinten: Kurzschluss nach Plus oder Unterbrechung | 0 | - |
| 0x8018B1 | Kältemittelabsperrventil hinten: Kurzschluss nach Minus | 0 | - |
| 0x8018B2 | Kältemittelabsperrventil vorn: Kurzschluss nach Plus oder Unterbrechung | 0 | - |
| 0x8018B3 | Kältemittelabsperrventil vorn: Kurzschluss nach Minus | 0 | - |
...
| 0xE7CC00 | ACF-LIN: Motor Luftverteilung 3. Sitzreihe antwortet nicht | 0 | - |
| 0xE7CC02 | ACF-LIN: Motor Mischluft 3. Sitzreihe antwortet nicht | 0 | - |
| 0xE7CC10 | AC-LIN: Gebläseendstufe 3. Sitzreihe antwortet nicht | 0 | - |
...
| ORT | ORTTEXT | EREIGNIS_DTC | FEHLERKLASSE |
| --- | --- | --- | --- |
| 0x8018A3 | Gebläseendstufe 3. Sitzreihe: Unter- oder Überspannung erkannt | 1 | - |
| 0x8018A5 | Gebläseendstufe 3. Sitzreihe: Strombegrenzung aktiv | 1 | - |
| 0xFFFFFF | unbekannter Fehlerort | 0 | - |
...
| RESULTNAME | STR | STPR | RRR | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_ISTPOSITION_LUFTVERTEILUNG_3_SITZREIHE_WERT | - | - | + | % | high | unsigned char | - | - | 1.0 | 1.0 | 0.0 | Istwert Klappenöffnung: 0...100 %  (255 = Klappe nicht codiert) |
| STAT_ISTPOSITION_MISCHLUFT_3_SITZREIHE_WERT | - | - | + | % | high | unsigned char | - | - | 1.0 | 1.0 | 0.0 | Istwert Klappenöffnung: 0...100 %  (255 = Klappe nicht codiert) |
| STAT_RESERVE_1_WERT | - | - | + | % | high | unsigned char | - | - | 1.0 | 1.0 | 0.0 | Istwert Klappenöffnung: 0...100 %  (255 = Klappe nicht codiert) |
| STAT_RESERVE_2_WERT | - | - | + | % | high | unsigned char | - | - | 1.0 | 1.0 | 0.0 | Istwert Klappenöffnung: 0...100 %  (255 = Klappe nicht codiert) |
...
| STAT_ADRESSIERUNG_LUFTVERTEILUNG_3_SITZREIHE | - | - | + | 0-n | high | unsigned char | - | TAB_STATUS_AUTOADRESSIERUNG | - | - | - | Status der Autoadressierung. Siehe Tabelle TAB_STATUS_AUTOADRESSIERUNG |
| STAT_ADRESSIERUNG_MISCHLUFT_3_SITZREIHE | - | - | + | 0-n | high | unsigned char | - | TAB_STATUS_AUTOADRESSIERUNG | - | - | - | Status der Autoadressierung. Siehe Tabelle TAB_STATUS_AUTOADRESSIERUNG |
| STAT_ADRESSIERUNG_RESERVE_1 | - | - | + | 0-n | high | unsigned char | - | TAB_STATUS_AUTOADRESSIERUNG | - | - | - | Status der Autoadressierung. Siehe Tabelle TAB_STATUS_AUTOADRESSIERUNG |
| STAT_ADRESSIERUNG_RESERVE_2 | - | - | + | 0-n | high | unsigned char | - | TAB_STATUS_AUTOADRESSIERUNG | - | - | - | Status der Autoadressierung. Siehe Tabelle TAB_STATUS_AUTOADRESSIERUNG |
...
| RESULTNAME | STR | STPR | RRR | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_KAELTEMITTELABSPERRVENTIL_KLIMA_HINTEN_NR | - | - | + | 0-n | high | unsigned char | - | TAB_STATUS_ABSPERRVENTIL | - | - | - | Status Kältemittelabsperrventil hinten der Heckklimaanlage: 0 = geschlossen, 1 = offen, 3 = Fehler |
| STAT_KAELTEMITTELABSPERRVENTIL_KLIMA_VORNE_NR | - | - | + | 0-n | high | unsigned char | - | TAB_STATUS_ABSPERRVENTIL | - | - | - | Status Kältemittelabsperrventil vorne der Heckklimaanlage: 0 = geschlossen, 1 = offen, 3 = Fehler |
...
| STAT_TEMP_RESERVE_1_WERT | °C | high | signed char | - | - | 1.0 | 1.0 | 0.0 | Reserve 1 |
| STAT_TEMP_RESERVE_2_WERT | °C | high | signed char | - | - | 1.0 | 1.0 | 0.0 | Reserve 2 |
...
| KAELTEMITTEL_ABSPERRVENTILE_KLIMA | 0xA12D | - | Absperrventile Kältekreislauf Klima HKA/Klimatisierung 3. Sitzreihe | - | - | - | - | - | - | - | - | - | 31 | ARG_0xA12D_R | RES_0xA12D_R |
...
| WERT | TEXT |
| --- | --- |
| 0x01 | KAELTEMITTELABSPERRVENTIL_HKA_HINTEN |
| 0x02 | KAELTEMITTELABSPERRVENTIL_HKA_VORN |
...
| WERT | TEXT |
| --- | --- |
| 0x01 | LUFTVERTEILUNG_3_SITZREIHE |
| 0x02 | MISCHLUFT_3_SITZREIHE |
| 0x03 | RESERVE_1 |
| 0x04 | RESERVE_2 |
