...
| REVISION | 0.01 |
| AUTHOR | BMW EE-42 Mangold  |
| COMMENT | SGBD for NVC E65 |
| PACKAGE | 1.22 |
| SPRACHE | deutsch |
...
- [_STEUERN_TASTER](#job-steuern-taster) - set ADC-channel xx of Star12 pushbutton will be simulated KWP2000: $30 InputOutputControlByLocalIdentifier $90 $07 Anforderung $90 $06 $kk $hh $ll Durchführung $pp: Kanalnummer $hh: High Byte $ll: Low Byte
- [STATUS_TASTER](#job-status-taster) - read ADC-channel Nr.x of Star12 3,3V pushbutton pressed 4,2V pushbutton not pressed 5,0V pushbutton not connected KWP2000: $30 InputOutputControlByLocalIdentifier $91 $01 $xx xx: channel number
- [STATUS_HEIZUNG_TEMPERATUR](#job-status-heizung-temperatur) - Read out Heater Temperature from Camera
- [STATUS_KLEMMEN](#job-status-klemmen) - read clamp status
- [STATUS_BORDNETZSPANNUNG](#job-status-bordnetzspannung) - read out board net voltage via AD-channel 4 of Star12 KWP2000: $30 InputOutputControlByLocalIdentifier $91 $01 $04
- [STATUS_ENERGIESPARMODUS](#job-status-energiesparmodus) - read out status of energy saving mode
- [STEUERN_STEUERGERAETE_RESET](#job-steuern-steuergeraete-reset) - Seuergeraete reset ausloesen KWP2000: $11 ECUReset $01 PowerOn Modus  : Default  After the job one has to wait the component reset time After that the component is ready for diagnostics again  siehe Job FLASH_ZEITEN_LESEN Result FLASH_RESETZEIT
...
set ADC-channel xx of Star12 pushbutton will be simulated KWP2000: $30 InputOutputControlByLocalIdentifier $90 $07 Anforderung $90 $06 $kk $hh $ll Durchführung $pp: Kanalnummer $hh: High Byte $ll: Low Byte
...
read ADC-channel Nr.x of Star12 3,3V pushbutton pressed 4,2V pushbutton not pressed 5,0V pushbutton not connected KWP2000: $30 InputOutputControlByLocalIdentifier $91 $01 $xx xx: channel number
...
<a id="job-status-heizung-temperatur"></a>
### STATUS_HEIZUNG_TEMPERATUR

Read out Heater Temperature from Camera
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_HEAT_TEMP_WERT | real | Temperatur Heizung |
| STAT_HEAT_TEMP_EINH | string | Grad Celsius |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
read out board net voltage via AD-channel 4 of Star12 KWP2000: $30 InputOutputControlByLocalIdentifier $91 $01 $04
...
Seuergeraete reset ausloesen KWP2000: $11 ECUReset $01 PowerOn Modus  : Default  After the job one has to wait the component reset time After that the component is ready for diagnostics again  siehe Job FLASH_ZEITEN_LESEN Result FLASH_RESETZEIT
...
| 0xA749 | Heizung Kamera |
| 0xA74A | FPGA Kamera |
| 0xA74B | Videosignal |
| 0xA74C | Schutzfenster |
| 0xA74D | Bordnetzspannung, Überspannung oder Unterspannung |
| 0xA74E | Temperaturfühler Linsenheizung |
...
| 0xA755 | CAN: Ausfall Telegramm Status Kombi |
...
| 0xA75A | CAN: Ausfall Telegramm Motordaten |
| 0xA75B | CAN: Ausfall Telegramm Relativzeit |
| 0xA75C | CAN: Ausfall Telegramm Status Gang |
| 0xA75D | CAN: Ausfall Telegramm Status Gang Rückwärts |
| 0xA75E | CAN: kein Acknowledge |
| 0xA760 | CAN: Bus off |
| 0xA761 | CAN: Signal ungültig |
| 0xA762 | CAN: Ausfall Telegramm Status Funkschlüssel |
| 0xA763 | CAN: No Answer to Request (580h+3Dh) |
| 0xA764 | CAN: LIN Kommunikation |
| 0xA75F | Energiesparmode aktiv |
| 0xDEC4 | CAN: Low |
| 0xDEC5 | CAN: High |
...
| 0x03 | Temperatur Kamera | 0-n | -- | 0xFF | LEDFarbe | 1 | 1 | 0 |
| 0x04 | Codierdatenfehler | 0-n | -- | 0xFF | CDBError | 1 | 1 | 0 |
| 0x0B | Temperatur Kamera | Grad C | H | signed int | -- | 1 | 1 | 0 |
...
| ORT | UW1_NR | UW2_NR | UW3_NR | UW4_NR |
| --- | --- | --- | --- | --- |
| 0xA800 | 0x09 | 0x0A | 0x01 | LeerUW_3 |
| default | 0x01 | - | - | - |
...
| 0x0A | Temperatur Kamera | Grad C | H | signed int | -- | 1 | 1 | 0 |
| 0xAA | ohne Bedeutung | Hex | - | unsigned char | - | 1 | 1 | 0 |
| 0xXY | unbekannte Umweltbedingung | 1 | -- | unsigned char | -- | 1 | 1 | 0 |
