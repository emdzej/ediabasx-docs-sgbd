...
| Field | Value |
| --- | --- |
| ECU | Tuerelektronik Fahrertuer |
| ORIGIN | BMW EE-52 Gerald Bergmann |
| REVISION | 1.20 |
| AUTHOR | BMW EE-52 Gerald Bergmann, ESG Christian Windmueller |
| COMMENT | N/A |
| PACKAGE | 1.32 |
| SPRACHE | deutsch |
...
- [STATUS_DIGITAL](#job-status-digital) - Status eines digitalen Signals auslesen
- [STATUS_ANALOG](#job-status-analog) - Status eines analogen Signals auslesen
...
- [STEUERN_ANALOG](#job-steuern-analog) - Ansteuern von jedem analogen Signal 
- [STEUERN_CFL](#job-steuern-cfl) - Steuern der CFL-modul KWP2000: $31 startRoutineByLocalIdentifier Modus  : Default
- [STATUS_ANALOG_ALL](#job-status-analog-all) - Auslesen aller analogen Werte ohne Argument KWP2000: $30 InputOutputControlByLocalIdentifier $10 all analog values $01 ReportCurrentState Modus  : Default
- [STEUERN_DIGIO](#job-steuern-digio) - Ansteuern von jedem digitalen Signal ueber Index
- [STATUS_DIGIO](#job-status-digio) - Status eines digitalen Signals ueber Index auslesen
- [LESEN_FH_DATEN](#job-lesen-fh-daten) - Auslesen der Rohdaten des Fensterheber-Moduls
- [STATUS_FH](#job-status-fh) - Status des Fensterhebers auslesen
- [LESEN_TEMIC_EEPROM](#job-lesen-temic-eeprom) - Freien eeprom Bereich auslesen
- [SCHREIBEN_TEMIC_EEPROM](#job-schreiben-temic-eeprom) - Freien eeprom Bereich byteweise schreiben
- [STEUERN_ANAIO](#job-steuern-anaio) - Ansteuern von jedem analogen Signal ueber Index
- [STATUS_ANAIO](#job-status-anaio) - Status eines analogen Signals ueber Index auslesen
- [LESEN_FH_LOG](#job-lesen-fh-log) - Lesen der Fensterheber Log-Daten aus EEPROM
- [LOESCHEN_FH_LOG](#job-loeschen-fh-log) - Loeschen der Fensterheber Log-Daten aus EEPROM
- [SG_LOW_HIGH](#job-sg-low-high) - Auslesen ob SG Low oder High Variante ist Ermittlung durch Tabellenauswertung der HW-Referenz (PPP)
...
- [STEUERN_SELBSTTEST_DRUCKSENSOR](#job-steuern-selbsttest-drucksensor) - Selbsttest Drucksensor anstossen KWP2000: $31 Steuergeraetespezifische Routine starten $28 Selbsttest Drucksensor anstossen Modus  : Default
...
- [STATUS_SBLK](#job-status-sblk) - Auslesen aller Schalterblockwerte KWP2000: $30 InputOutputControlByLocalIdentifier $05 Schalterblock $01 ReportCurrentState Modus  : Default
- [STATUS_DIGITAL_ALL](#job-status-digital-all) - Auslesen aller digitalen Werte ohne Argument KWP2000: $30 InputOutputControlByLocalIdentifier $01 all digital signals $01 ReportCurrentState Modus  : Default
...
| Name | Type | Comment |
| --- | --- | --- |
| SIGNAL_NAME | string | Werte: all possible signal names (s. table DigitalIOSignal) table DigitalIOSignals TEXT |
...
Status eines digitalen Signals auslesen

#### Arguments

| Name | Type | Comment |
| --- | --- | --- |
| SIGNAL_NAME | string | Werte: all possible signal names (s. table DigitalIOSignal) table DigitalIOSignal TEXT |

#### Results

| Name | Type | Comment |
| --- | --- | --- |
| STAT_WERT | char | 1 = ein, 0 = aus |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
Status eines analogen Signals auslesen

#### Arguments

| Name | Type | Comment |
| --- | --- | --- |
| SIGNAL_NAME | string | Werte: In AnalogIOSignal definierte Signale table AnalogIOSignal TEXT |

#### Results

| Name | Type | Comment |
| --- | --- | --- |
| STAT_WERT | unsigned char | Wert des Signals (Wertebereich 0-255) |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| STAT_AD_0_0 | unsigned char | Wert AD-Wandler 0 Klemme 30 |
| STAT_AD_0_1 | unsigned char | Wert AD-Wandler 1 ASP Poti hor. |
| STAT_AD_0_2 | unsigned char | Wert AD-Wandler 2 ASP Poti vert. |
| STAT_AD_0_3 | unsigned char | Wert AD-Wandler 3 ASP Poti Versorgung |
| STAT_AD_0_4 | unsigned char | Wert AD-Wandler 4 FH Hall Versorgung |
| STAT_AD_0_5 | unsigned char | Wert AD-Wandler 5 FH - |
| STAT_AD_0_6 | unsigned char | Wert AD-Wandler 6 FH + |
| STAT_AD_0_7 | unsigned char | Wert AD-Wandler 7 Amb. Beleuchtung |
| STAT_AD_1_0 | unsigned char | Wert AD-Wandler 8 U_ASE hinter Schalter |
| STAT_AD_1_1 | unsigned char | Wert AD-Wandler 9 nicht verwendet |
| STAT_AD_1_2 | unsigned char | Wert AD-Wandler 10 U_ASE |
| STAT_AD_1_3 | unsigned char | Wert AD-Wandler 11 Elmos 100.37 Diag |
| STAT_AD_1_4 | unsigned char | Wert AD-Wandler 12 Vorfeldbeleuchtung |
| STAT_AD_1_5 | unsigned char | Wert AD-Wandler 13 nicht verwendet |
| STAT_AD_1_6 | unsigned char | Wert AD-Wandler 14 Strommessung ASP_Treiber |
| STAT_AD_1_7 | unsigned char | Wert AD-Wandler 15 SBLK Versorgung |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |

<a id="job-steuern-analog"></a>
### STEUERN_ANALOG

Ansteuern von jedem analogen Signal 
...
| --- | --- | --- |
| SIGNAL_NAME | string | Werte: In AnalogIOSignal definierte Signale table AnalogIOSignal TEXT |
| ANALOGWERT | unsigned char | Wert des Signals (Wertebereich 0-255) |
...
| Name | Type | Comment |
| --- | --- | --- |
| GERAET | string | nur ein dummy, von E65 uebernommen muss ECU sein |
| FUNKTION | string | gewuenschte Funktion table Funktion_CFL CFL_FUNKTION TEXT |
| WERT | string | Baureihe table WindowLength ENO TEXT |
...
<a id="job-status-analog-all"></a>
### STATUS_ANALOG_ALL

Auslesen aller analogen Werte ohne Argument KWP2000: $30 InputOutputControlByLocalIdentifier $10 all analog values $01 ReportCurrentState Modus  : Default
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_U_BATT | unsigned char | Spannung Klemme 30 |
| STAT_ASP_POS_HOR | unsigned char | Aussenspiegel Position Horizontal |
| STAT_ASP_POS_VER | unsigned char | Aussenspiegel Position Vertikal |
| STAT_U_ASP_POTI | unsigned char | Spannung Aussenspiegel Potentiometer Versorgung |
| STAT_U_FH_HALL | unsigned char | Spannung Fensterheber Hall Versorgung |
| STAT_U_FH_MOT_M | unsigned char | Spannung Fensterheber Motor Minus (bei hochfahren) |
| STAT_U_FH_MOT_P | unsigned char | Spannung Fensterheber Motor Plus (bei hochfahren) |
| STAT_U_AMB_BEL | unsigned char | Spannung Ambiente Beleuchtung |
| STAT_U_ASE | unsigned char | Spannung ASE |
| STAT_U_VFBEL | unsigned char | Spannung Vorfeldbeleuchtung |
| STAT_U_SBLK | unsigned char | Spannung Versorgung Schalterblock |
| STAT_PWM_AMB_BEL | unsigned char | PWM-Wert Ambiente Beleuchtung |
| STAT_PWM_VFBEL | unsigned char | PWM-Wert Vorfeld-Beleuchtung |
| STAT_PWM_EST_BEL | unsigned char | PWM-Wert Einstiegs-Beleuchtung |
| STAT_PWM_ASP_HEIZ | unsigned char | PWM-Wert Aussenspiegel-Heizung Wert 0-100 % |
| STAT_U_BATT_WERT | real | Spannung Klemme 30 in Volt |
| STAT_U_ASP_POTI_WERT | real | Spannung Aussenspiegel Potentiometer Versorgung in Volt |
| STAT_U_FH_HALL_WERT | real | Spannung Fensterheber Hall Versorgung in Volt |
| STAT_U_FH_MOT_M_WERT | real | Spannung Fensterheber Motor Minus (bei hochfahren) in Volt |
| STAT_U_FH_MOT_P_WERT | real | Spannung Fensterheber Motor Plus (bei hochfahren) in Volt |
| STAT_U_AMB_BEL_WERT | real | Spannung Ambiente Beleuchtung in Volt |
| STAT_U_ASE_WERT | real | Spannung ASE in Volt |
| STAT_U_VFBEL_WERT | real | Spannung Vorfeldbeleuchtung in Volt |
| STAT_U_SBLK_WERT | real | Spannung Versorgung Schalterblock in Volt |
| STAT_U_BATT_EINH | string | Einheit Spannung Klemme 30 (Volt) |
| STAT_U_ASP_POTI_EINH | string | Einheit Spannung Aussenspiegel Potentiometer Versorgung (Volt) |
| STAT_U_FH_HALL_EINH | string | Einheit Spannung Fensterheber Hall Versorgung (Volt) |
| STAT_U_FH_MOT_M_EINH | string | Einheit Spannung Fensterheber Motor Minus (bei hochfahren) (Volt) |
| STAT_U_FH_MOT_P_EINH | string | Einheit Spannung Fensterheber Motor Plus (bei hochfahren) (Volt) |
| STAT_U_AMB_BEL_EINH | string | Einheit Spannung Ambiente Beleuchtung (Volt) |
| STAT_U_ASE_EINH | string | Einheit Spannung ASE (Volt) |
| STAT_U_VFBEL_EINH | string | Einheit Spannung Vorfeldbeleuchtung (Volt) |
| STAT_U_SBLK_EINH | string | Einheit Spannung Versorgung Schalterblock (Volt) |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |

<a id="job-steuern-digio"></a>
### STEUERN_DIGIO

Ansteuern von jedem digitalen Signal ueber Index

#### Arguments

| Name | Type | Comment |
| --- | --- | --- |
| SIGNAL | unsigned char | Index des Signals im Array DigIO |
| DIGITALWERT | string | logical value Werte: true, false table DigitalArgument TEXT |
...
<a id="job-status-digio"></a>
### STATUS_DIGIO

Status eines digitalen Signals ueber Index auslesen
...
<a id="job-lesen-fh-daten"></a>
### LESEN_FH_DATEN

Auslesen der Rohdaten des Fensterheber-Moduls
...
<a id="job-status-fh"></a>
### STATUS_FH

Status des Fensterhebers auslesen
...
| Name | Type | Comment |
| --- | --- | --- |
| STAT_NORMIERT | char | 1 = FH normiert, 0 = FH nicht normiert |
| STAT_POSITION | int | Position des Fensters, 0 = oberer Block sinnvolle Werte nur bei normiertem Fensterheber |
| STAT_INITLAUF | string | Status des letzten, per Diagnose angestossenen, Initialisierungslaufes wird durch SG-Reset geloescht |
| STAT_THERMOSCHUTZ | string | Status der Uebertemperaturschutzfunktion des FH-Antriebes |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |

<a id="job-lesen-temic-eeprom"></a>
### LESEN_TEMIC_EEPROM

Freien eeprom Bereich auslesen
...
| Name | Type | Comment |
| --- | --- | --- |
| VALUE | binary | Inhalt des freien eeprom-Bereiches |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |

<a id="job-schreiben-temic-eeprom"></a>
### SCHREIBEN_TEMIC_EEPROM

Freien eeprom Bereich byteweise schreiben

#### Arguments

| Name | Type | Comment |
| --- | --- | --- |
| OFFSET | unsigned char | Index des zu schreibenden Wertes |
| VALUE | unsigned char | Zu schreibender Wert |
...
<a id="job-steuern-anaio"></a>
### STEUERN_ANAIO

Ansteuern von jedem analogen Signal ueber Index

#### Arguments

| Name | Type | Comment |
| --- | --- | --- |
| SIGNAL | unsigned char | Index des Signals im Array AnaIO |
| ANALOGWERT | unsigned char | vorgegebener Wert 0-255 |
...
<a id="job-status-anaio"></a>
### STATUS_ANAIO

Status eines analogen Signals ueber Index auslesen
...
| Name | Type | Comment |
| --- | --- | --- |
| STAT_WERT | unsigned char | Analogwert 0-255 |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |

<a id="job-lesen-fh-log"></a>
### LESEN_FH_LOG

Lesen der Fensterheber Log-Daten aus EEPROM
...
| Name | Type | Comment |
| --- | --- | --- |
| VALUE | binary | Logdaten im Rohformat |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |

<a id="job-loeschen-fh-log"></a>
### LOESCHEN_FH_LOG

Loeschen der Fensterheber Log-Daten aus EEPROM
...
<a id="job-sg-low-high"></a>
### SG_LOW_HIGH

Auslesen ob SG Low oder High Variante ist Ermittlung durch Tabellenauswertung der HW-Referenz (PPP)
...
<a id="job-steuern-selbsttest-drucksensor"></a>
### STEUERN_SELBSTTEST_DRUCKSENSOR

Selbsttest Drucksensor anstossen KWP2000: $31 Steuergeraetespezifische Routine starten $28 Selbsttest Drucksensor anstossen Modus  : Default
...
| STAT_DRUCKSENSOR_TIMEOUT_FEHLER | unsigned int | Status-Flags des Drucksensors Bit 0: allgemeines TimeOut beim Selbsttest |
| STAT_DRUCKSENSOR_DIAG3_FEHLER | unsigned int | Status-Flags des Drucksensors Bit 1: DIAG3 Fehler (Filtertest) |
| STAT_DRUCKSENSOR_DIAG1A_FEHLER | unsigned int | Status-Flags des Drucksensors Bit 2: DIAG1 Fehler (Druckwertfehler beim Einschwingen) |
| STAT_DRUCKSENSOR_DIAG2_FEHLER | unsigned int | Status-Flags des Drucksensors Bit 3: DIAG2 Fehler (Arraytest) |
| STAT_DRUCKSENSOR_DIAG1B_FEHLER | unsigned int | Status-Flags des Drucksensors Bit 4: DIAG1 Fehler (Druckdeltafehler beim Einschwingen) |
| STAT_DRUCKSENSOR_PARITYFEHLER | unsigned int | Status-Flags des Drucksensors Bit 5: Parity-Fehler in IPS-Kommunikation |
| STAT_DRUCKSENSOR_SPI_FEHLER | unsigned int | Status-Flags des Drucksensors Bit 6: SPI overrun (2. Byte zu spaet geholt) |
| STAT_DRUCKSENSOR_SRDY_FEHLER | unsigned int | Status-Flags des Drucksensors Bit 7: zu viele oder zu wenige SRDY |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |

<a id="job-status-sblk"></a>
### STATUS_SBLK

Auslesen aller Schalterblockwerte KWP2000: $30 InputOutputControlByLocalIdentifier $05 Schalterblock $01 ReportCurrentState Modus  : Default
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_FH_FAT_AUF | char | Status Taste Fensterheber Fahrertuer Auf 1 = ein, 0 = aus |
| STAT_FH_FAT_ZU | char | Status Taste Fensterheber Fahrertuer Zu 1 = ein, 0 = aus |
| STAT_FH_FAT_AUTO | char | Status Taste Fensterheber Fahrertuer Auto 1 = ein, 0 = aus |
| STAT_FH_FATH_AUF | char | Status Taste Fensterheber Fahrertuer Hinten Auf 1 = ein, 0 = aus |
| STAT_FH_FATH_ZU | char | Status Taste Fensterheber Fahrertuer Hinten Zu 1 = ein, 0 = aus |
| STAT_FH_FATH_AUTO | char | Status Taste Fensterheber Fahrertuer Hinten Auto 1 = ein, 0 = aus |
| STAT_FH_BFT_AUF | char | Status Taste Fensterheber Beifahrertuer Auf 1 = ein, 0 = aus |
| STAT_FH_BFT_ZU | char | Status Taste Fensterheber Beifahrertuer Zu 1 = ein, 0 = aus |
| STAT_FH_BFT_AUTO | char | Status Taste Fensterheber Beifahrertuer Auto 1 = ein, 0 = aus |
| STAT_FH_BFTH_AUF | char | Status Taste Fensterheber Beifahrertuer Hinten Auf 1 = ein, 0 = aus |
| STAT_FH_BFTH_ZU | char | Status Taste Fensterheber Beifahrertuer Hinten Zu 1 = ein, 0 = aus |
| STAT_FH_BFTH_AUTO | char | Status Taste Fensterheber Beifahrertuer Hinten Auto 1 = ein, 0 = aus |
| STAT_ASP_LINKS | char | Status Taste Aussenspiegel Links 1 = ein, 0 = aus |
| STAT_ASP_RECHTS | char | Status Taste Aussenspiegel Rechts 1 = ein, 0 = aus |
| STAT_ASP_OBEN | char | Status Taste Aussenspiegel Oben 1 = ein, 0 = aus |
| STAT_ASP_UNTEN | char | Status Taste Aussenspiegel Unten 1 = ein, 0 = aus |
| STAT_ASP_BKLP | char | Status Taste Aussenspiegel Beiklappen 1 = ein, 0 = aus |
| STAT_ASP_FTBFT | char | Status Schalter Aussenspiegel FAT/BFT 1 = BFT, 0 = FAT |
| STAT_FUNKTION_1 | char | Status Funktionstaste 1 1 = ein, 0 = aus |
| STAT_FUNKTION_2 | char | Status Funktionstaste 2 1 = ein, 0 = aus |
| STAT_FUNKTION_1_LED | char | Status Funktions-LED 1 1 = ein, 0 = aus |
| STAT_FUNKTION_2_LED | char | Status Funktions-LED 2 1 = ein, 0 = aus |
| STAT_KOMMUNIKATION | char | Status Kommunikation SG-SBLK 1 = Fehler, 0 = ok |
| STAT_FH_FAT_GESAMT | char | Status Taste Fensterheber Fahrertuer 0 = aus, 1 = zu, 2 = auf, 3 = auto |
| STAT_FH_FATH_GESAMT | char | Status Taste Fensterheber Fahrertuer Hinten 0 = aus, 1 = zu, 2 = auf, 3 = auto |
| STAT_FH_BFT_GESAMT | char | Status Taste Fensterheber Beifahrertuer 0 = aus, 1 = zu, 2 = auf, 3 = auto |
| STAT_FH_BFTH_GESAMT | char | Status Taste Fensterheber Beifahrertuer Hinten 0 = aus, 1 = zu, 2 = auf, 3 = auto |
| STAT_SPIEGEL_GESAMT | char | Status Taste Aussenspiegel 0 = aus, 1 = rechts, 2 = links, 3 = oben, 4 = unten |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |

<a id="job-status-digital-all"></a>
### STATUS_DIGITAL_ALL

Auslesen aller digitalen Werte ohne Argument KWP2000: $30 InputOutputControlByLocalIdentifier $01 all digital signals $01 ReportCurrentState Modus  : Default
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_SBLK_VERS | char | Status Schalterblock Versorgung 1 = ein, 0 = aus |
| STAT_FH_HALL_VERS | char | Status Fensterheber Hall Versorgung 1 = ein, 0 = aus |
| STAT_FH_MOTOR_P | char | Status Fensterheber Motor Plus 1 = ein, 0 = aus |
| STAT_FH_MOTOR_M | char | Status Fensterheber Motor Minus 1 = ein, 0 = aus |
| STAT_ZV_VR | char | Status Zentralverriegelung Verriegeln 1 = ein, 0 = aus |
| STAT_ZV_SICH | char | Status Zentralverriegelung Sichern 1 = ein, 0 = aus |
| STAT_ZV_ER | char | Status Zentralverriegelung Entriegeln 1 = ein, 0 = aus |
| STAT_ZV_ENTSICH | char | Status Zentralverriegelung Entsichern 1 = ein, 0 = aus |
| STAT_ZV_STOP | char | Status Zentralverriegelung Stop 1 = ein, 0 = aus |
| STAT_EST_BEL | char | Status Einstiegsbeleuchtung 1 = ein, 0 = aus |
| STAT_ASP_LINKS | char | Status Aussenspiegelverstellung Links 1 = ein, 0 = aus |
| STAT_ASP_RECHTS | char | Status Aussenspiegelverstellung Rechts 1 = ein, 0 = aus |
| STAT_ASP_OBEN | char | Status Aussenspiegelverstellung Oben 1 = ein, 0 = aus |
| STAT_ASP_UNTEN | char | Status Aussenspiegelverstellung Unten 1 = ein, 0 = aus |
| STAT_ASP_BEIKLAPP | char | Status Aussenspiegel Beiklappen 1 = ein, 0 = aus |
| STAT_ASP_AUSKLAPP | char | Status Aussenspiegelverstellung Ausklappen 1 = ein, 0 = aus |
| STAT_ASP_HEIZ | char | Status Aussenspiegel Heizung 1 = ein, 0 = aus |
| STAT_ASP_STOP | char | Status Aussenspiegel Stop 1 = ein, 0 = aus |
| STAT_ASP_POTI_VERS | char | Status Aussenspiegel Poti Versorgung 1 = ein, 0 = aus |
| STAT_VF_BEL | char | Status Vorfeldbeleuchtung 1 = ein, 0 = aus |
| STAT_HALL_SNU_1 | char | Status Hall Schaltnuss 1 1 = ein, 0 = aus |
| STAT_HALL_SNU_2 | char | Status Hall Schaltnuss 2 1 = ein, 0 = aus |
| STAT_HALL_TK | char | Status Hall Tuerkontakt 1 = ein (Tuer offen), 0 = aus (Tuer geschlossen) |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| Name | Type | Comment |
| --- | --- | --- |
| STAT_ZK1_AKTIV | int | 0=ZK1_NICHT_AKTIV 1=ZK1_AKTIV Thorax-Airbag vorn |
...
- [DIGITALIOSIGNAL](#table-digitaliosignal) (27 × 3)
- [ANALOGIOSIGNAL](#table-analogiosignal) (4 × 2)
- [FUNKTION_CFL](#table-funktion-cfl) (3 × 2)
- [PPP_LH](#table-ppp-lh) (5 × 2)
- [WINDOWLENGTH](#table-windowlength) (5 × 2)
...
| ASP_HEIZ | 0x07 | 0x31 |
| ASP_STOP | 0x08 | 0x31 |
| ASP_ALL_HIGH | 0x09 | 0x31 |
| ASP_ALL_LOW | 0x0A | 0x31 |
| ASP_POT_5V | 0x01 | 0x32 |
| ZV_ER | 0x01 | 0x33 |
| ZV_VR | 0x02 | 0x33 |
| ZV_ESi | 0x03 | 0x33 |
| ZV_Si | 0x04 | 0x33 |
| ZV_ER_ESi | 0x05 | 0x33 |
| ZV_STOP | 0x06 | 0x33 |
| ZV_ALL_HIGH | 0x07 | 0x33 |
| ZV_ALL_LOW | 0x08 | 0x33 |
| FH_HALL | 0x01 | 0x35 |
| FH_AUF | 0x01 | 0x36 |
| FH_ZU | 0x02 | 0x36 |
| FH_AUTO | 0x03 | 0x36 |
...
| CFL_FUNKTION | PARAM |
| --- | --- |
| AUTOINIT_VORMONTAGE | 0x0000 |
| AUTOINIT_ENDMONTAGE | 0x0001 |
| AUTOINIT_NACHBEARB. | 0x0002 |
...
| 0x9b61 | Fensterheber Panik-Modus CC-Meldung aktiv |
| 0x???? | unbekannter Fehlerort |
