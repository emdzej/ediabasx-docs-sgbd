...
| --- | --- |
| ECU | Siemens-CCM |
| ORIGIN | BMW EE-430 Zametzer |
| REVISION | 0.5 |
| AUTHOR | ERD PSE PRO CDA4 |
...
- [MOST_Version](#job-most-version) - MostIdentIdentdaten KWP2000: $21 ReadDataByLocalIdetnifier Modus  : Default
- [Conf_Switsch](#job-conf-switsch) - MostIdentIdentdaten KWP2000: $21 ReadDataByLocalIdetnifier Modus  : Default
- [FS_Alle_Lesen](#job-fs-alle-lesen) - Fehlerspeicherauslesen KWP2000: $18 ReadDTCByStatus Modus  : Default
- [SBDH_Logoff](#job-sbdh-logoff) - Hörerabmelden KWP2000: $31 StartroutineByLocalID Modus  : Default
- [FS_Alle_Loeschen](#job-fs-alle-loeschen) - FehlerspeicherLoeschen KWP2000: $14 ClearDiagnosticInformation Modus  : Default
...
<a id="job-most-version"></a>
### MOST_Version

MostIdentIdentdaten KWP2000: $21 ReadDataByLocalIdetnifier Modus  : Default
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| MOSTVers | int | MOSTVersi |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |

<a id="job-conf-switsch"></a>
### Conf_Switsch
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| MOSTConfigurationSwitch | int | MOSTConfigSwitch |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |

<a id="job-fs-alle-lesen"></a>
### FS_Alle_Lesen

Fehlerspeicherauslesen KWP2000: $18 ReadDTCByStatus Modus  : Default
...
<a id="job-fs-alle-loeschen"></a>
### FS_Alle_Loeschen

FehlerspeicherLoeschen KWP2000: $14 ClearDiagnosticInformation Modus  : Default
...
| ORT | ORTTEXT |
| --- | --- |
| 0xCA8C | Fehler MOST_NAK |
| 0xCA90 | Fehler MOST_RING_DIAG |
| 0xCA91 | Fehler MOST_DEV_NO_ANS |
| 0x0006 | Fehler MOST_RESET |
| 0x0007 | Fehler MOST_NSINIT_TIM |
| 0x0009 | Fehler MOST_UNLOCK_LONG |
| 0x000A | Fehler MOST_UNLOCK_SHORT |
| 0x000B | Fehler MOST_T_CFGSTAT |
| 0x000C | Fehler MOST_WAKEUP_FAIL |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 0x01 | Adresse nicht annehmendes Dev | 1 | - | unsigned char | - | 1 | 1 | 0 |
| 0x02 | Adresse | 1 | - | unsigned char | - | 1 | 1 | 0 |
| 0x03 | Position im NOD Reg | 1 | - | unsigned char | - | 1 | 1 | 0 |
