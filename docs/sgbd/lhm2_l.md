...
<a id="job-status-serialnumber"></a>
### STATUS_SERIALNUMBER
...
| 0x805980 | Abblendlicht defekt | 0 |
| 0x805981 | Fernlicht defekt | 0 |
| 0x805982 | Abbiegelicht defekt | 0 |
| 0x805983 | Tagfahrlicht defekt | 0 |
| 0x80599E | Ausfall Temperatursensor intern | 0 |
| 0x80599F | Ausfall Temperatursensor 1 | 0 |
| 0x8059A0 | Ausfall Temperatursensor 2 | 0 |
| 0x8059A1 | Ausfall Temperatursensor 3 | 0 |
| 0x8059A2 | Ausfall Temperatursensor 4 | 0 |
| 0x8059A3 | Übertemperatur | 0 |
| 0x8059A4 | Übertemperaturabschaltung Abblendlicht | 0 |
| 0x8059A9 | Lüfter 1 defekt | 0 |
| 0x8059AA | Lüfter 2 defekt | 0 |
| 0x8059C6 | Ausfall Rechts-Linkserkennung | 0 |
| 0x8059C7 | Fehler Hardwarecodierung LED Binning 1 | 0 |
| 0x8059C8 | interner Steuergerätefehler | 0 |
| 0x8059C9 | Unterspannung | 0 |
| 0x8059CA | Überspannung | 0 |
| 0x8059CB | Codierdaten passen nicht zum Verbauort (Fahrer- /Beifahrerseite) | 0 |
| 0x8059CC | Fehler Hardwarecodierung LED Binning 3 | 0 |
| 0x8059CD | Fehler Hardwarecodierung LED Binning 4 | 0 |
| 0x8059CE | Fehler Hardwarecodierung LED Binning 5 | 0 |
| 0x8059CF | Fehler Hardwarecodierung LED Binning 6 | 0 |
| 0x8059D0 | Fehler Hardwarecodierung LED Binning 7 | 0 |
| 0x8059D1 | CRC-Fehler Codierdaten | 0 |
| 0x8059D2 | Fehler Hardwarecodierung LED Binning 2 | 0 |
...
| 0xD9D400 | Botschaft 0x1E4 (CTR_LP_EX_2) - Timeout | 1 |
| 0xD9D401 | Botschaft 0x1E4 (CTR_LP_EX_2) - CRC-Fehler | 1 |
| 0xD9D402 | Botschaft 0x1E4 (CTR_LP_EX_2) - Fehler Alive-Counter | 1 |
| 0xD9D403 | Botschaft 0x2EB (CTR_LP_EX) - Timeout | 1 |
| 0xD9D406 | Botschaft 0x1E4 (CTR_LP_EX_2) - Signal CTR_FN_DIPB_LH ungültig | 1 |
| 0xD9D407 | Botschaft 0x1E4 (CTR_LP_EX_2) - Signal CTR_LDSTR_LOWB_LH ungültig | 1 |
...
| 0xD9D40C | Botschaft 0x12F (KLEMMEN) - Timeout | 1 |
| 0xD9D40D | Botschaft 0x12F (KLEMMEN) - CRC-Fehler | 1 |
| 0xD9D40E | Botschaft 0x12F (KLEMMEN) - Fehler Alive-Counter | 1 |
| 0xD9D40F | Botschaft 0x12F (KLEMMEN) - Signal ST_KL ungültig | 1 |
| 0xD9D410 | Botschaft 0x1AE (ST_OP_LP_EX) - Timeout | 1 |
| 0xD9D411 | Botschaft 0x1AE (ST_OP_LP_EX) - Signal ST_LP_SW ungültig | 1 |
...
| SystembusDTC | D9C473 | D9C47C | Zulässiger Bereich wird mittels Formel berechnet. Enthält physikalische Fehler bzw. Protokollfehler des Systembusses. |
| SystembusDTC | D9C487 | D9C48F | Zulässiger Bereich wird mittels Formel berechnet. Enthält physikalische Fehler bzw. Protokollfehler des Systembusses. |
| SystembusDTC | D9C401 | D9C40A | Zulässiger Bereich wird mittels Formel berechnet. Enthält physikalische Fehler bzw. Protokollfehler des Systembusses. |
| SystembusDTC | D9C45F | D9C468 | Zulässiger Bereich wird mittels Formel berechnet. Enthält physikalische Fehler bzw. Protokollfehler des Systembusses. |
| SystembusDTC | D9C41F | D9C43E | Zulässiger Bereich wird mittels Formel berechnet. Enthält physikalische Fehler bzw. Protokollfehler des Systembusses. |
| SystembusDTC | D9C50B | D9C514 | Zulässiger Bereich wird mittels Formel berechnet. Enthält physikalische Fehler bzw. Protokollfehler des Systembusses. |
| SystembusDTC | D9C47D | D9C486 | Zulässiger Bereich wird mittels Formel berechnet. Enthält physikalische Fehler bzw. Protokollfehler des Systembusses. |
| SystembusDTC | D9C469 | D9C472 | Zulässiger Bereich wird mittels Formel berechnet. Enthält physikalische Fehler bzw. Protokollfehler des Systembusses. |
| SystembusDTC | D9C415 | D9C41E | Zulässiger Bereich wird mittels Formel berechnet. Enthält physikalische Fehler bzw. Protokollfehler des Systembusses. |
| SystembusDTC | D9C43F | D9C449 | Zulässiger Bereich wird mittels Formel berechnet. Enthält physikalische Fehler bzw. Protokollfehler des Systembusses. |
| SystembusDTC | D9C501 | D9C50A | Zulässiger Bereich wird mittels Formel berechnet. Enthält physikalische Fehler bzw. Protokollfehler des Systembusses. |
...
| SystembusDTC | D9C40B | D9C414 | Zulässiger Bereich wird mittels Formel berechnet. Enthält physikalische Fehler bzw. Protokollfehler des Systembusses. |
| SubbusDTC | D9CC00 | D9D3FF | Zulässiger Bereich wird mittels Formel berechnet. Enthält physikalische Fehler bzw. Protokollfehler des Systembusses. |
| SignalDTC | D9CBFF | D9CBFF | Ist aus einem vorgegebenen Offset-Bereich frei wählbar. Enthält Signalfehler, die SG-spezifisch sind. |
| SignalDTC | D9D400 | DA03FF | Ist aus einem vorgegebenen Offset-Bereich frei wählbar. Enthält Signalfehler, die SG-spezifisch sind. |
| SignalDTC | D9D400 | DA03FF | Ist aus einem vorgegebenen Offset-Bereich frei wählbar. Enthält Signalfehler, die SG-spezifisch sind. |
| KomponentenDTC | 805980 | 805A7F | Die zulässigen Bereiche sind für jedes Steuergerät festgelegt. Es können mehrere gültige Bereiche (Kacheln) definiert werden. |
...
| ORT | ORTTEXT | EREIGNIS_DTC |
| --- | --- | --- |
| 0x430001 | CODING_EVENT_TRANSACTION_ERROR | 0 |
| 0x430002 | ECUM_E_RAM_CHECK_FAILED | 0 |
| 0x430005 | SBC_E_OVERTEMPPREWARNING | 0 |
| 0x430006 | VSM_EVENTID_VEHICLESTATE_ERR | 0 |
| 0x430007 | SBC_E_OVERTEMPERATUREVCC2 | 0 |
| 0x430008 | SBC_E_SPI_FAIL_ERR | 0 |
| 0x430009 | SBC_E_OVERCURRENTVCC3 | 0 |
| 0x43000A | SBC_E_RESETCLAMP | 0 |
| 0x43000B | SBC_E_WRONG_WD_SET | 0 |
| 0x43000C | SBC_E_CAN1_FAILURE | 0 |
| 0x43000D | ECUMA_RESET_ECC_EXEPTION | 0 |
| 0x43000E | FSFY_INTERNAL_ECU_SW_FAILURE | 0 |
| 0x43000F | ECUMA_INT_INVALID_ISR | 0 |
| 0x430010 | FSFY_CPU_MAIN_DEFECT | 0 |
| 0x430011 | SWSEC_REGMON_SYS_REG | 0 |
| 0x430012 | SWSEC_REGMON_IO_REG | 0 |
| 0x430013 | ECUMA_RESET_CODETRAP | 0 |
| 0x430014 | ECUMA_RESET_ILEGADR | 0 |
| 0x430015 | NM_E_NETWORK_TIMEOUT | 0 |
| 0x430016 | PDUR_E_INIT_FAILED | 0 |
| 0x430017 | SPI_E_DATA_FAILURE | 0 |
| 0x430018 | MCU_E_QUARTZ_FAILURE | 0 |
| 0x430019 | MCU_E_TIMEOUT_TRANSITION | 0 |
| 0x43001A | WDG_E_MISS_TRIGGER | 0 |
| 0x43001B | IOHWAB_E_IO_SEQUENCE | 0 |
| 0x43001C | MCU_E_CLOCK_FAILURE | 0 |
| 0x43001D | FR_E_ACCESS | 0 |
| 0x43001E | FLS_E_ERASE_FAILED | 0 |
| 0x43001F | WDGM_E_ALIVE_SUPERVISION | 0 |
| 0x430020 | ECUM_E_ALL_RUN_REQUESTS_KILLED | 0 |
| 0x430021 | CANIF_E_INVALID_RXPDUID | 0 |
| 0x430022 | CANTP_E_COMM | 0 |
| 0x430023 | LINIF_E_RESPONSE | 0 |
| 0x430024 | FRTRCV_10_TJA1080_E_FR_NO_TRCV_C | 0 |
| 0x430025 | COMM_E_STOP_Tx_TIMEOUT_C1 | 0 |
| 0x430026 | NVM_E_INTEGRITY_FAILED | 0 |
| 0x430027 | COMM_E_START_Tx_TIMEOUT_C0 | 0 |
| 0x430028 | WDGM_E_SET_MODE | 0 |
| 0x430029 | COMM_E_NET_START_IND_CHANNEL_1 | 0 |
| 0x43002A | COMM_E_START_Tx_TIMEOUT_C1 | 0 |
| 0x43002B | CAN_E_TIMEOUT | 0 |
| 0x43002C | COMM_E_NET_START_IND_CHANNEL_0 | 0 |
| 0x43002D | LINIF_E_NC_NO_RESPONSE | 0 |
| 0x43002E | COMM_E_STOP_Tx_TIMEOUT_C0 | 0 |
| 0x43002F | FLS_E_COMPARE_FAILED | 0 |
| 0x430030 | FRIF_E_JLE_SYNC | 0 |
| 0x430031 | MCU_E_LOCK_FAILURE | 0 |
| 0x430032 | CANNM_E_CANIF_TRANSMIT_ERROR | 0 |
| 0x430033 | FLS_E_READ_FAILED | 0 |
| 0x430034 | WDG_E_DISABLE_REJECTED | 0 |
| 0x430035 | CANIF_E_FULL_TX_BUFFER | 0 |
| 0x430036 | CNM_E_NETWORK_TIMEOUT | 0 |
| 0x430037 | CNM_E_TX_PATH_FAILED | 0 |
| 0x430038 | IPDUM_E_TRANSMIT_FAILED | 0 |
| 0x430039 | CANIF_E_STOPPED | 0 |
| 0x43003A | FLS_E_WRITE_FAILED | 0 |
| 0x43003B | CANIF_E_INVALID_TXPDUID | 0 |
| 0x43003C | CANNM_E_INIT_FAILED | 0 |
| 0x43003D | NVM_E_REQ_FAILED | 0 |
| 0x43003E | WDG_E_MODE_SWITCH_FAILED | 0 |
| 0x430040 | Fehler konnte nach maximaler Anzahl von Versuchen nicht gesendet werden | 1 |
| 0x430041 | Puffer für ausgehende Fehlermeldungen ist voll | 1 |
| 0x430042 | PIA_E_IO_ERROR | 0 |
| 0x430043 | Botschaft (Fahrzeugzustand, 0x3A0) fehlt | 1 |
| 0x430044 | Signal (Zeit_Sekunde_Zaehler_Relativ, 0x328): ungültig | 1 |
| 0x430045 | KANAL1_DEFEKT | 0 |
| 0x430046 | KANAL2_DEFEKT | 0 |
| 0x430047 | KANAL3_DEFEKT | 0 |
| 0x430048 | KANAL4_DEFEKT | 0 |
| 0x430049 | KANAL5_DEFEKT | 0 |
| 0x43004A | KANAL6_DEFEKT | 0 |
| 0x43004B | KANAL7_DEFEKT | 0 |
| 0x43004C | NTC1_KURZSCHLUSS | 0 |
| 0x43004D | NTC2_KURZSCHLUSS | 0 |
| 0x43004E | NTC3_KURZSCHLUSS | 0 |
| 0x43004F | NTC4_KURZSCHLUSS | 0 |
| 0x430050 | NTC5_KURZSCHLUSS | 0 |
| 0x430051 | NTC1_UNTERBRECHUNG | 0 |
| 0x430052 | NTC2_UNTERBRECHUNG | 0 |
| 0x430053 | NTC3_UNTERBRECHUNG | 0 |
| 0x430054 | NTC4_UNTERBRECHUNG | 0 |
| 0x430055 | NTC5_UNTERBRECHUNG | 0 |
| 0x430057 | FUSI_FEHLER | 0 |
| 0x430058 | FUSI_LEISTUNGSPLAUSIB1 | 0 |
| 0x430059 | FUSI_LEISTUNGSPLAUSIB2 | 0 |
| 0x43005A | SBC_E_UV_RESET | 0 |
| 0x43005B | DAUERSPANNUNG_AN_KATHODE | 0 |
| 0x43005C | LICHTNOTLAUF_BEI_10V_BEENDET | 0 |
| 0x43005D | SAFESTATE_LOWBEAM_ACTIVE | 0 |
| 0x430060 | FAN_CTR_UNTERBRECHUNG | 0 |
| 0x430061 | FAN_CTR_KURZSCHLUSS | 0 |
| 0x430062 | FAN_CTR_FEHLER | 0 |
| 0x430063 | FAN_SUPPLY_KURZSCHLUSS | 0 |
| 0x430064 | FAN_SUPPLY_UNTERBRECHUNG | 0 |
| 0x430065 | CTR_FN_CORNL_LH_INVALID | 1 |
| 0x430066 | CTR_MOD_FN_SPFLS_INVALID | 1 |
| 0x430067 | CTR_PHA_FN_SPFLS_INVALID | 1 |
| 0x430068 | CTR_FN_REMLI_INVALID | 1 |
| 0x430069 | CTR_FN_FMH_INVALID | 1 |
| 0x43006A | CTR_FN_DRL_INVALID | 1 |
| 0x43006B | CTR_FN_WELL_INVALID | 1 |
| 0x430070 | MCU_E_MODE_TRANSITION_FAILURE | 0 |
| 0x430071 | MCU_E_LVD45_EVENT | 0 |
| 0x430072 | MCU_E_FLASH_ERROR | 0 |
| 0x430073 | MCU_E_CORE_RESET_EVENT | 0 |
| 0x430074 | MCU_E_JTAG_RESET_EVENT | 0 |
| 0x430075 | MCU_E_DMA_TIMEOUT | 0 |
| 0x430076 | ADC_E_TIMEOUT | 0 |
| 0x430077 | GND_KURZSCHLUSS_AN_KATHODE | 0 |
| 0x430078 | CODING1_KURZSCHLUSS | 0 |
| 0x430079 | CODING2_KURZSCHLUSS | 0 |
| 0x43007A | CODING3_KURZSCHLUSS | 0 |
| 0x43007B | CODING4_KURZSCHLUSS | 0 |
| 0x43007C | CODING5_KURZSCHLUSS | 0 |
| 0x43007D | CODING6_KURZSCHLUSS | 0 |
| 0x43007E | CODING7_KURZSCHLUSS | 0 |
| 0x43007F | CODING1_UNTERBRECHUNG | 0 |
| 0x430080 | CODING2_UNTERBRECHUNG | 0 |
| 0x430081 | CODING3_UNTERBRECHUNG | 0 |
| 0x430082 | CODING4_UNTERBRECHUNG | 0 |
| 0x430083 | CODING5_UNTERBRECHUNG | 0 |
| 0x430084 | CODING6_UNTERBRECHUNG | 0 |
| 0x430085 | CODING7_UNTERBRECHUNG | 0 |
| 0xFFFFFF | unbekannter Fehlerort | 0 |
...
<a id="table-tab-fusi-component"></a>
### TAB_FUSI_COMPONENT
