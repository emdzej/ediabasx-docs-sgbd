...
| Field | Value |
| --- | --- |
| ECU | CHAMP MMI / Tuner / ASK  |
| ORIGIN | BMW EI-44 Bubb |
| REVISION | 1.000 |
| AUTHOR | BMW EI-44 Hr.Bubb |
| COMMENT | Fuer die komplette Diagnose des CHAMP ist auch die SGBD CHAMPGW notwendig.  |
| PACKAGE | 1.29 |
| SPRACHE | deutsch |
...
- [STATUS_ANALOG_SPANNUNG](#job-status-analog-spannung) - Auslesen der Spannungswerte von Board, SH3 und FPGA KWP2000: $30 InputOutputControlByLocalIdentifier $06 inputOutputLocalIdentifier $07 shortTermAdjustment Modus  : Default
- [STATUS_ANALOG_TEMPERATUR](#job-status-analog-temperatur) - Status der Temperaturwerte FOT Board, Mod4020 und Endstufe KWP2000: $30 InputOutputControlByLocalIdentifier $07 inputOutputLocalIdentifier $01 reportCurrentState Modus  : Default
...
- [STATUS_FAN_HISTORY](#job-status-fan-history) - Lesen des Lüfteransteuerungsverlaufs für den Normalbetrieb KWP2000: $21 ReadDataByLocalIdentifier $21 recordLocalIdentifier Modus  : Default
...
- [STATUS_LUEFTER](#job-status-luefter) - Lesen der Lüfterwerte KWP2000: $21 ReadDataByLocalIdentifier $09 recordLocalIdentifier Modus  : Default
- [STATUS_LUEFTER_CTRL_DATA](#job-status-luefter-ctrl-data) - Lesen der Lüftersteuerungsparameter KWP2000: $21 ReadDataByLocalIdentifier $08 recordLocalIdentifier Modus  : Default
- [STATUS_RADON](#job-status-radon) - Reads the status of the RADON control lead KWP2000: $30 InputOutputControlByLocalIdentifier $1A inputOutputLocalIdentifier $01 inputOutputControlParameter Modus  : Default
...
- [STATUS_SELBSTTEST](#job-status-selbsttest) - Inquires the status of the self test  KWP2000: $21 ReadDataByLocalIdentifier $B8 RecordLocalIdentifier
- [STATUS_TASTE_GEDRUECKT](#job-status-taste-gedrueckt) - Auslesen, ob gerade eine Taste gedrueckt ist KWP2000: $21 ReadDataByLocalIdentifier $06 recordLocalIdentifier - any key pressed Modus  : Default
- [STATUS_TEL_MUTE](#job-status-tel-mute) - Ausgabe, ob Tel-Mute-Leitung aktiv oder inaktiv ist KWP2000: $21 ReadDataByLocalIdentifier $07 recordLocalIdentifier Modus  : Default
- [STATUS_TEMPERATURABSCHALTWERTE](#job-status-temperaturabschaltwerte) - Lesen der Temperaturabschaltwerte KWP2000: $21 ReadDataByLocalIdentifier $05 recordLocalIdentifier Modus  : Default
...
- [STEUERN_AUTOSTORE](#job-steuern-autostore) - Initiates the autostore function of the tuner preset lists over all frequency bands KWP2000: $31 StartRoutineByLocalIdentifier $20 RoutineLocalIdentifier (autostore) Modus  : Default
...
- [STEUERN_CLEAR_FAN_HISTORY](#job-steuern-clear-fan-history) - Löschen des Lüfteransteuerungsverlaufs KWP2000: $31 StartRoutineByLocalIdentifier $21 routineLocalID Modus  : Default
...
- [STEUERN_LUEFTER](#job-steuern-luefter) - Setzen der Lüfterwerte KWP2000: $30 InputOutputControlByLocalIdentifier $08 inputOutputLocalIdentifier Modus  : Default
- [STEUERN_LUEFTER_CTRL_DATA](#job-steuern-luefter-ctrl-data) - Setzen der Lüfter Steuer Daten KWP2000: $3B WriteDataByLocalIdentifier $08 localIdentifier Modus  : Default
...
- [STEUERN_RADON](#job-steuern-radon) - Sets the RADON control lead to logical High or Low KWP2000: $30 InputOutputControlByLocalIdentifier $1A inputOutputLocalIdentifier $07 inputOutputControlParameter Modus  : Default
...
- [STEUERN_TEMPERATURABSCHALTWERTE](#job-steuern-temperaturabschaltwerte) - Setzen der Temperaturabschaltwerte Alle Werte sind in °C anzugeben KWP2000: $3B WriteDataByLocalIdentifier $05 localIdentifier Modus  : Default
...
- [LLDATENRETTUNG](#job-lldatenrettung) - LowLevel MOST Datenrettungsschnittstelle KWP2000: $31 RoutineLocalIdentifier $22 RoutineIdentifier Modus  : Default
- [STATUS_FB_TASTE](#job-status-fb-taste) - Check if a bezel button is pressed or touched KWP2000: $21 ReadDataByLocalIdentifier $16 recordLocalIdentifier Modus  : Default
- [STEUERN_FB_RESET](#job-steuern-fb-reset) - This job resets/restarts the bezel KWP2000: $31 StartRoutineByLocalIdentifier $30 routineLocalIdentifier Modus  : Default
- [STATUS_DRIVE_FIRMWARE](#job-status-drive-firmware) - Reads the Firmwareversion of the drive KWP2000: $21 ReadDatabyLocalIdentifier $BC LocalIdentifier Modus  : Default
...
Auslesen der Spannungswerte von Board, SH3 und FPGA KWP2000: $30 InputOutputControlByLocalIdentifier $06 inputOutputLocalIdentifier $07 shortTermAdjustment Modus  : Default
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_BATTERY_VOLTAGE | unsigned int | Zahlenwert der Battery Spannung in mVolt Byteorder: High / Low |
| STAT_5V_SW | unsigned int | Zahlenwert der ??? in mVolt Byteorder: High / Low |
| STAT_3V_SW | unsigned int | Zahlenwert der ??? in mVolt Byteorder: High / Low |
| STAT_3_3V_SW1 | unsigned int | Zahlenwert der ??? in mVolt Byteorder: High / Low |
| STAT_3_3V_SW2 | unsigned int | Zahlenwert der ??? in mVolt Byteorder: High / Low |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |

<a id="job-status-analog-temperatur"></a>
### STATUS_ANALOG_TEMPERATUR

Status der Temperaturwerte FOT Board, Mod4020 und Endstufe KWP2000: $30 InputOutputControlByLocalIdentifier $07 inputOutputLocalIdentifier $01 reportCurrentState Modus  : Default
...
| STAT_FIELDSTRENGTH_EXACT | int | Fieldstrength Bereich: 0..60 and more (1dB-Schritte von 0..60 and more dBµV) |
...
Lesen des Lüfteransteuerungsverlaufs für den Normalbetrieb KWP2000: $21 ReadDataByLocalIdentifier $21 recordLocalIdentifier Modus  : Default
...
| STAT_TIME_FAN_OFF | unsigned long | Zeit Lüfter aus in Sekunden |
| STAT_TIME_FAN_1 | unsigned long | Zeit Lüfterstufe 1 in Sekunden |
| STAT_TIME_FAN_2 | unsigned long | Zeit Lüfterstufe 2 in Sekunden |
| STAT_TIME_FAN_3 | unsigned long | Zeit Lüfterstufe 3 in Sekunden |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
Lesen der Lüfterwerte KWP2000: $21 ReadDataByLocalIdentifier $09 recordLocalIdentifier Modus  : Default
...
| STAT_LUEFTER_LEVEL | unsigned char | Level des Lüfters |
| STAT_LUEFTER_HZ | unsigned char | Frequenz des Lüfters in Hz |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
Lesen der Lüftersteuerungsparameter KWP2000: $21 ReadDataByLocalIdentifier $08 recordLocalIdentifier Modus  : Default
...
| Name | Type | Comment |
| --- | --- | --- |
| STAT_FAN_VAL1_UP | unsigned char | FOT TempValue Degree Celsius for FAN switches from Level 0-&gt;1 |
| STAT_FAN_VAL2_UP | unsigned char | FOT TempValue Degree Celsius for FAN switches from Level 1-&gt;2 |
| STAT_FAN_VAL3_UP | unsigned char | FOT TempValue Degree Celsius for FAN switches from Level 2-&gt;3 |
| STAT_FAN_VAL3_DOWN | unsigned char | FOT TempValue Degree Celsius for FAN switches from Level 3-&gt;2 |
| STAT_FAN_VAL2_DOWN | unsigned char | FOT TempValue Degree Celsius for FAN switches from Level 2-&gt;1 |
| STAT_FAN_VAL1_DOWN | unsigned char | FOT TempValue Degree Celsius for FAN switches from Level 1-&gt;0 |
| STAT_FAN_HZ_LEVEL1 | unsigned char | Frequency in Herz of Level 1 |
| STAT_FAN_HZ_LEVEL2 | unsigned char | Frequency in Herz of Level 2 |
| STAT_FAN_HZ_LEVEL3 | unsigned char | Frequency in Herz of Level 3 |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
Reads the status of the RADON control lead KWP2000: $30 InputOutputControlByLocalIdentifier $1A inputOutputLocalIdentifier $01 inputOutputControlParameter Modus  : Default
...
| Name | Type | Comment |
| --- | --- | --- |
| STAT_RADON | string | Evaluation of the RADON signal, logical High or Low |
| STAT_RADON_VALUE | int | Value of the RADON signal, logical 1 or 0 |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
Inquires the status of the self test  KWP2000: $21 ReadDataByLocalIdentifier $B8 RecordLocalIdentifier
...
| Name | Type | Comment |
| --- | --- | --- |
| STAT_SELBSTTEST | string | Current status, active or ended |
| STAT_SELBSTTEST_WERT | int | Current status, 1 or 0 |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
Auslesen, ob gerade eine Taste gedrueckt ist KWP2000: $21 ReadDataByLocalIdentifier $06 recordLocalIdentifier - any key pressed Modus  : Default
...
Ausgabe, ob Tel-Mute-Leitung aktiv oder inaktiv ist KWP2000: $21 ReadDataByLocalIdentifier $07 recordLocalIdentifier Modus  : Default
...
| STAT_TEL_MUTE_WERT | int | Tel-Mute-Leitung aktiv 1 oder inaktiv 0 |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
Lesen der Temperaturabschaltwerte KWP2000: $21 ReadDataByLocalIdentifier $05 recordLocalIdentifier Modus  : Default
...
<a id="job-steuern-autostore"></a>
### STEUERN_AUTOSTORE

Initiates the autostore function of the tuner preset lists over all frequency bands KWP2000: $31 StartRoutineByLocalIdentifier $20 RoutineLocalIdentifier (autostore) Modus  : Default
...
Löschen des Lüfteransteuerungsverlaufs KWP2000: $31 StartRoutineByLocalIdentifier $21 routineLocalID Modus  : Default
...
Setzen der Lüfterwerte KWP2000: $30 InputOutputControlByLocalIdentifier $08 inputOutputLocalIdentifier Modus  : Default
...
Setzen der Lüfter Steuer Daten KWP2000: $3B WriteDataByLocalIdentifier $08 localIdentifier Modus  : Default

#### Arguments

| Name | Type | Comment |
| --- | --- | --- |
| FAN_PARAM_SET | unsigned char | Nummer des Fan Parametersatzes 0: Default 1: tbd 2: tbd |
...
Sets the RADON control lead to logical High or Low KWP2000: $30 InputOutputControlByLocalIdentifier $1A inputOutputLocalIdentifier $07 inputOutputControlParameter Modus  : Default

#### Arguments

| Name | Type | Comment |
| --- | --- | --- |
| RADON | string | High or Low Values from table TSchaltmodi NAME |
...
| Name | Type | Comment |
| --- | --- | --- |
| SCHALTMODUS | string | EIN/AUS-Schalten des Radios (Default=off) table TSchaltmodi NAME |
...
Setzen der Temperaturabschaltwerte Alle Werte sind in °C anzugeben KWP2000: $3B WriteDataByLocalIdentifier $05 localIdentifier Modus  : Default
...
LowLevel MOST Datenrettungsschnittstelle KWP2000: $31 RoutineLocalIdentifier $22 RoutineIdentifier Modus  : Default

#### Arguments

| Name | Type | Comment |
| --- | --- | --- |
| ARG_SEQUENCE | string | String for Reading and Writing via MOST |

#### Results

| Name | Type | Comment |
| --- | --- | --- |
| RET_DATA | binary | MOST Response |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
Check if a bezel button is pressed or touched KWP2000: $21 ReadDataByLocalIdentifier $16 recordLocalIdentifier Modus  : Default
...
| Name | Type | Comment |
| --- | --- | --- |
| STAT_FB_TASTE_NO | int | Button number from 1 to 8 of button touched or pressed -1 for none |
| STAT_FB_TASTE | unsigned char | 0x01 button touched 0x02 button pressed 0xFF for none |
| STAT_FB_TASTE_TEXT | string | Text of button pressed or touched Value from table TFBTaste_gedrueckt |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
This job resets/restarts the bezel KWP2000: $31 StartRoutineByLocalIdentifier $30 routineLocalIdentifier Modus  : Default
...
<a id="job-status-drive-firmware"></a>
### STATUS_DRIVE_FIRMWARE

Reads the Firmwareversion of the drive KWP2000: $21 ReadDatabyLocalIdentifier $BC LocalIdentifier Modus  : Default
...
| Name | Type | Comment |
| --- | --- | --- |
| STAT_DRIVE_FIRMWARE | string | Firmwareversion of the drive |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
- [FUMWELTMATRIX](#table-fumweltmatrix) (8 × 5)
...
- [TAUDIOVOLUME](#table-taudiovolume) (50 × 2)
...
- [TSCHALTMODI](#table-tschaltmodi) (7 × 3)
- [LOOKCONNTABLE](#table-lookconntable) (66 × 2)
- [LOOKCONNTABLEDETAIL](#table-lookconntabledetail) (7 × 2)
- [TKLANGZEICHEN](#table-tklangzeichen) (7 × 3)
...
- [TTASTE_GEDRUECKT](#table-ttaste-gedrueckt) (5 × 2)
- [TENTSOURCE](#table-tentsource) (16 × 2)
- [TTELMUTE](#table-ttelmute) (2 × 2)
- [TFBTASTE_GEDRUECKT](#table-tfbtaste-gedrueckt) (3 × 2)
- [TINDIVIDUALDATALISTE](#table-tindividualdataliste) (35 × 17)
...
| ORT | ORTTEXT |
| --- | --- |
| 0xABC8 | 0xABC8 HOST_Micro_Fault |
| 0xABC9 | 0xABC9 HOST_ROM_Fault |
| 0xABCA | 0xABCA Madre_Fault |
| 0xABCB | 0xABCB TopHiFi_Fault |
| 0xABCC | 0xABCC Diversity_Antenna_Wiring_Fault |
| 0xABCD | 0xABCD Diversity_ Antenna_Power_Supply_Fault |
| 0xABCE | 0xABCE RadOn_Fault |
| 0xABCF | 0xABCF HMI_Startup_Fault |
| 0xABD0 | 0xABD0 CD_Startup_Fault |
| 0xABD1 | 0xABD1 Amplifier_LS_Fault |
| 0xABD2 | 0xABD2 Drive_Eject_Fault |
| 0xABD3 | 0xABD3 FB_Communication_Error |
| 0xABD4 | 0xABD4 FB_Defect_Error |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 0x01 | Temperatur FOT | Grad C | - | signed char | -- | -- | -- | -- |
| 0x02 | Bordnetzspannung | mVolt | high | unsigned int | -- | 1 | 1 | -- |
| 0x03 | Fehlerursache | Hex | - | unsigned char | - | -- | -- | -- |
| 0xXY | unbekannte Umweltbedingung | 1 | -- | unsigned int | -- | -- | -- | -- |
...
| ORT | ORTTEXT |
| --- | --- |
| 0xABE0 | ABE0 HOST_RAM_Fault |
| 0xABE1 | ABE1 DSP_Fault |
| 0xABE2 | ABE2 HOST_Micro_Initialization_Fault |
| 0xABE3 | ABE3 LCD_Controller_Fault |
| 0xABE4 | ABE4 Graphics_Startup_Fault |
| 0xABE5 | ABE5 Model_Block_Startup_Fault |
| 0xABE6 | ABE6 Graphics_Component_Fault |
| 0xABE7 | ABE7 Climate_Component_Fault |
| 0xABE8 | ABE8 Communications_Component_Fault |
| 0xABE9 | ABE9 Board_Computer_Component_Fault |
| 0xABEA | ABEA Language_Component_Fault |
| 0xABEB | ABEB Settings_Component_Fault |
| 0xABEC | ABEC System_Component_Fault |
| 0xABED | ABED Variants_PIA_Component_Fault |
| 0xABEE | ABEE Wrong_Drive_Fault |
| 0xABEF | ABEF Watchdog_Reset_Fault |
| 0xABF0 | ABF0 FB_Protocol_Error |
| 0xABF1 | ABF1 FB_Alive_Error |
| 0xABF2 | ABF2 FB_Version_Error |
| 0xABF3 | ABF3 FB_Software_Error |
| 0xFFFF | unbekannter Fehlerort |
...
| UWNR | UWTEXT | UW_EINH | L/H | UWTYP | NAME | MUL | DIV | ADD |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 0x01 | Fehlerursache | Hex | - | unsigned char | - | -- | -- | -- |
| 0xXY | unbekannte Umweltbedingung | 1 | -- | u int | -- | -- | -- | -- |
...
<a id="table-tfbtaste-gedrueckt"></a>
### TFBTASTE_GEDRUECKT
...
| 0x0022 | 0xFF | 01 | 63 | 02 | 000F | 01 | 00 | 05 | 1001025301 | 04 | 10010253 | 05 | 1001025300 | 00 |  | MMI.ActionSpecialFunctionButtonMFL |
