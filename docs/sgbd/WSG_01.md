...
| Field | Value |
| --- | --- |
| ECU | Wassersteuergerät |
| ORIGIN | BMW EA-722 Adrian_Friedrich |
| REVISION | 0.001 |
| AUTHOR | BMW EA-722 Friedrich |
| COMMENT | - |
| PACKAGE | 1.986 |
| SPRACHE | deutsch |
...
| 0xCBC523 | INFRA-CAN Physikalischer Busfehler | 0 | - |
| 0xCBC524 | INFRA-CAN Control Module Bus OFF | 0 | - |
