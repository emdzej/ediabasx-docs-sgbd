...
| Field | Value |
| --- | --- |
| ECU | Top-Hifi Verstaerker E65 |
| ORIGIN | BMW TI-431 Weber |
| REVISION | 1.03 |
| AUTHOR | BMW EI-41 Busch, BMW TI-431 Krueger, BMW TI-431 Rochal |
| COMMENT | AMP_E65 |
| PACKAGE | 1.32 |
| SPRACHE | deutsch |
...
| ORT | ORTTEXT |
| --- | --- |
| 0xD6CC | Ein Device hat die Monitoringnachricht nicht abgenommen oder bestätigt. (Error_Monitoring). |
| 0xD6CD | Weckendes Device hat 3 mal erfolglos versucht das Netzwerk zu wecken. (Error_WakeUp_Failed). |
| 0xD6CE | Obwohl Shutdown(Execute) geschickt wurde, ging das Licht nicht aus. (Error_Light_Not_Off). |
| 0xD6CF | Zentrale Registry stimmt nicht mit der Sollkonfiguration ueberein (Error_Registry_New). |
| 0xD6D0 | Ringbruchdiagnose wurde durchgefuehrt (Error_Ring_Diagnose). |
| 0xD6D1 | Lange und/oder häufige Unlocks (Error_Unlock_Long). |
| 0xD6D2 | Ein Device hat sich wegen Uebertemperatur abgeschaltet (Error_Temp_Shutdown). |
| 0xA1A8 | DSP defekt (Error_DSP_Funktion)  |
| 0xA1A9 | Endstufen IC defekt (Error_Audio_Amplifier_IC)  |
...
| --- | --- | --- | --- | --- |
| 0xD6CC | 0x01 | 0x04 | 0x05 | 0x06 |
| 0xD6CF | 0x01 | 0xFF | 0xFF | 0xFF |
| 0xD6CD | 0x01 | 0xFF | 0xFF | 0xFF |
| 0xD6D0 | 0x02 | 0xFF | 0xFF | 0xFF |
| 0xD6D2 | 0xFF | 0xFF | 0xFF | 0xFF |
...
| 0x9311 | Error_CS: TH hat beim Aufstarten einen Checksummenfehler erkannt |
| 0x9312 | Error_UT: TH hat Uebertemperatur erkannt |
| 0x9313 | Error_SPG: TH hat bei Selbsttest Unterspannung Klemme 30 erkannt |
| 0xFFFF | unbekannter Fehlerort |
