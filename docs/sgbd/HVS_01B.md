...
- [RES_0XAE76_R](#table-res-0xae76-r) (1 × 13)
- [RES_0XAE77_R](#table-res-0xae77-r) (1 × 13)
- [RES_0XAE79_R](#table-res-0xae79-r) (6 × 13)
- [RES_0XAE7C_R](#table-res-0xae7c-r) (1 × 13)
- [RES_0XDDBC_D](#table-res-0xddbc-d) (3 × 10)
- [RES_0XDDC0_D](#table-res-0xddc0-d) (4 × 10)
- [RES_0XDFA3_D](#table-res-0xdfa3-d) (2 × 10)
- [RES_0XE541_D](#table-res-0xe541-d) (14 × 10)
- [RES_0XE542_D](#table-res-0xe542-d) (2 × 10)
- [RES_0XE543_D](#table-res-0xe543-d) (24 × 10)
...
- [RES_0XE57D_D](#table-res-0xe57d-d) (9 × 10)
- [RES_0XE57E_D](#table-res-0xe57e-d) (8 × 10)
- [RES_0XE57F_D](#table-res-0xe57f-d) (15 × 10)
- [RES_0XE580_D](#table-res-0xe580-d) (7 × 10)
- [RES_0XE581_D](#table-res-0xe581-d) (2 × 10)
- [RES_0XE582_D](#table-res-0xe582-d) (7 × 10)
- [RES_0XE587_D](#table-res-0xe587-d) (6 × 10)
- [RES_0XE599_D](#table-res-0xe599-d) (85 × 10)
...
- [SG_FUNKTIONEN](#table-sg-funktionen) (128 × 16)
...
Dimensions: 537 rows × 4 columns

| ORT | ORTTEXT | EREIGNIS_DTC | FEHLERKLASSE |
| --- | --- | --- | --- |
| 0x002736 | SecOC: Freshness Value Synchronisation fehlgeschlagen | 0 | 0x00000020 |
...
| 0x21F2BA | Montagemode aktiv - Energie bereitstellen | 0 | 0x00000080 |
...
| 0x21F329 | Battery Management Unit (BMU) - Vorladung - Zwischenkreis - Kurzschluss nach Plus/Masse | 0 | 0x00000080 |
...
| 0xCAD437 | Signal (Außentemperatur, ID: A_TEMP) ungültig | 1 | 0x00008000 |
| 0xCAD444 | Botschaft (CombinedChargerUnit1000msNo1, ID: CombinedChargerUnit1000msNo1) fehlt | 1 | 0x00004000 |
| 0xCAD447 | Signal (CombinedChargerUnit1000msNo1, ID: CombinedChargerUnit1000msNo1) ungültig | 1 | 0x00008000 |
...
| 0xCAD44B | Signal (CombinedChargerUnit100msNo1, ID: CombinedChargerUnit100msNo1) ungültig | 1 | 0x00008000 |
| 0xCAD450 | Botschaft (CombinedChargerUnit10msNo2, ID: CombinedChargerUnit10msNo2) fehlt | 1 | 0x00004000 |
| 0xCAD453 | Signal (CombinedChargerUnit10msNo2, ID: CombinedChargerUnit10msNo2) ungültig | 1 | 0x00008000 |
...
| 0xCAD457 | Signal (CombinedChargerUnit20msNo1, ID: CombinedChargerUnit20msNo1) ungültig | 1 | 0x00008000 |
| 0xCAD490 | Botschaft (Fahrgestellnummer, ID: FAHRGESTELLNUMMER) fehlt | 1 | 0x00004000 |
| 0xCAD493 | Signal (Fahrgestellnummer, ID: FAHRGESTELLNUMMER) ungültig | 1 | 0x00008000 |
| 0xCAD498 | Botschaft (Fahrzeugzustand, ID: FZZSTD) fehlt | 1 | 0x00004000 |
| 0xCAD49B | Signal (Fahrzeugzustand, ID: FZZSTD) ungültig | 1 | 0x00008000 |
| 0xCAD4A0 | Botschaft (Freigabe Kühlung Hochvoltspeicher, ID: RLS_COOL_HVSTO) fehlt | 1 | 0x00004000 |
| 0xCAD4A3 | Signal (Freigabe Kühlung Hochvoltspeicher, ID: RLS_COOL_HVSTO) ungültig | 1 | 0x00008000 |
...
| 0xCAD4B3 | Signal (Geschwindigkeit Fahrzeug, ID: V_VEH) ungültig | 1 | 0x00008000 |
...
| 0xCAD4BB | Signal (HighVoltagePowerManagement200msNo1, ID: HighVoltagePowerManagement200msNo1) ungültig | 1 | 0x00008000 |
...
| 0xCAD5C3 | Signal (Netzwerkmanagement-3 AE_CAN_FD, ID: NM3_AE_CAN_FD) ungültig | 1 | 0x00008000 |
| 0xCAD5F8 | Botschaft (Relativzeit BN2020, ID: RELATIVZEIT) fehlt | 1 | 0x00004000 |
| 0xCAD5FB | Signal (Relativzeit BN2020, ID: RELATIVZEIT) ungültig | 1 | 0x00008000 |
| 0xCAD5FC | Botschaft (Sicher Fahrgestellnummer, ID: SECU_FAHRGESTELLNUMMER) fehlt | 1 | 0x00004000 |
| 0xCAD5FF | Signal (Sicher Fahrgestellnummer, ID: SECU_FAHRGESTELLNUMMER) ungültig | 1 | 0x00008000 |
| 0xCAD600 | Botschaft (Sicher Response, ID: SECU_RESP) fehlt | 1 | 0x00004000 |
| 0xCAD603 | Signal (Sicher Response, ID: SECU_RESP) ungültig | 1 | 0x00008000 |
| 0xCAD618 | Botschaft (Status Crash, ID: ST_CR) fehlt | 1 | 0x00004000 |
| 0xCAD61B | Signal (Status Crash, ID: ST_CR) ungültig | 1 | 0x00008000 |
...
| 0xCAD717 | Signal (Zustand Fahrzeug, ID: CON_VEH) ungültig | 1 | 0x00008000 |
| 0xCAD720 | Botschaft (Wärmemanagement Motorsteuerung, ID: HT_MGT_ENG_CTR) fehlt | 1 | 0x00004000 |
| 0xCAD723 | Signal (Wärmemanagement Motorsteuerung, ID: HT_MGT_ENG_CTR) ungültig | 1 | 0x00008000 |
...
| 0x21F30A | Speicher - SOC - Wert unplausibel | 0 | 0x00000000 |
...
| STAT_MAX_DELTA_U_CELL_1_WERT | V | high | unsigned int | - | - | 1.0 | 1000.0 | 0.0 | Maximales Spannungsdelta der Zellen VOR erstem Kapazitätstest |
| STAT_MAX_DELTA_SOC_NENN_1_WERT | % | high | unsigned int | - | - | 1.0 | 100.0 | 0.0 | Maximales SoC-Delta der Zellen VOR erstem Kapazitätstest |
...
| STAT_MAX_DELTA_SOC_NENN_2_WERT | % | high | unsigned int | - | - | 1.0 | 100.0 | 0.0 | Maximales SoC-Delta der Zellen VOR zweitem Kapazitätstest |
...
| STAT_MAX_DELTA_U_CELL_3_WERT | V | high | unsigned int | - | - | 1.0 | 1000.0 | 0.0 | Maximales Spannungsdelta der Zellen VOR drittem Kapazitätstest |
| STAT_MAX_DELTA_SOC_NENN_3_WERT | % | high | unsigned int | - | - | 1.0 | 100.0 | 0.0 | Maximales SoC-Delta der Zellen VOR drittem Kapazitätstest |
...
| RESULTNAME | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_TEMP_KUEHLMITTEL_1_WERT | °C | high | signed int | - | - | 1.0 | 100.0 | 0.0 | Temperatur des Kühlmediums an Sensor 1 in °C (327,67 = unplausibel) |
| STAT_TEMP_KUEHLMITTEL_2_WERT | °C | high | signed int | - | - | 1.0 | 100.0 | 0.0 | Temperatur des Kühlmediums an Sensor 2 in °C (327,67 = unplausibel) |
...
| RESULTNAME | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_SPANNUNG_CSC1_WERT | V | high | unsigned int | - | - | 1.0 | 1000.0 | 0.0 | Spannung CSC1 (65,535 = nicht verbaut) |
| STAT_SPANNUNG_CSC2_WERT | V | high | unsigned int | - | - | 1.0 | 1000.0 | 0.0 | Spannung CSC2 (65,535 = nicht verbaut) |
| STAT_SPANNUNG_CSC3_WERT | V | high | unsigned int | - | - | 1.0 | 1000.0 | 0.0 | Spannung CSC3 (65,535 = nicht verbaut) |
| STAT_SPANNUNG_CSC4_WERT | V | high | unsigned int | - | - | 1.0 | 1000.0 | 0.0 | Spannung CSC4 (65,535 = nicht verbaut) |
| STAT_SPANNUNG_CSC5_WERT | V | high | unsigned int | - | - | 1.0 | 1000.0 | 0.0 | Spannung CSC5 (65,535 = nicht verbaut) |
| STAT_SPANNUNG_CSC6_WERT | V | high | unsigned int | - | - | 1.0 | 1000.0 | 0.0 | Spannung CSC6 (65,535 = nicht verbaut) |
| STAT_SPANNUNG_CSC7_WERT | V | high | unsigned int | - | - | 1.0 | 1000.0 | 0.0 | Spannung CSC7 (65,535 = nicht verbaut) |
...
Dimensions: 128 rows × 16 columns
...
| FIXSPG_SYMMETRIERUNG | 0xAE76 | - | Anstoßen der spannungsgesteuerte Symmetrierung per Zielspannungsvorgabe | - | - | - | - | - | - | - | - | - | 31 | ARG_0xAE76_R | RES_0xAE76_R |
| SYMMETRIERUNG_VALUE | 0xAE77 | - | Symmetrierung ansteueren | - | - | - | - | - | - | - | - | - | 31 | - | RES_0xAE77_R |
| HISTOGRAMM_SPANNUNG_NOP_MOD | 0xAE79 | - | Zeit in Minuten in verschiedenen Spannungsklassen von einzelnen Modulen während Speicher nicht im Betrieb | - | - | - | - | - | - | - | - | - | 31 | - | RES_0xAE79_R |
| MONTAGE_MODUS | 0xAE7C | - | Aktivierung, Beenden und Auslesen des Status vom Montagemodus | - | - | - | - | - | - | - | - | - | 31 | - | RES_0xAE7C_R |
...
| HV_SPEICHERIDENTIFIKATIONSNUMMER | 0xE541 | - | Abschnittweises Lesen der Speicheridentifikationsnummer des HV-Speichers | - | - | - | - | - | - | - | - | - | 22 | - | RES_0xE541_D |
...
| RB_KAPAZITAETSTEST | 0xE543 | - | Rückgabe der Ergebnisse der letzten 3 HVS-Offboard-Kapatests (Ringspeicher) | - | - | - | - | - | - | - | - | - | 22 | - | RES_0xE543_D |
...
| KUEHLMITTEL_HVS_TEMP | 0xE54E | - | Temperatur des Kühlmediums an Sensor 1 und Sensor 2 in °C | - | - | - | - | - | - | - | - | - | 22 | - | RES_0xE54E_D |
...
| TIME_SOC_CLASS | 0xE555 | - | Liefert die Aufenthaltsdauer des SoC in SoC-Klassen über Lebensdauer / Gesamtdauer (schlafen + wach) | - | - | - | - | - | - | - | - | - | 22 | - | RES_0xE555_D |
| TIME_SOC_CLASS_RESET | 0xE556 | - | Zurücksetzen des Histogramms, das ausgelesen wird mit dem Job: STATUS_ZEIT_SOC_KLASSE &gt;&gt; auszuführen bei Modultausch | - | - | - | - | - | - | - | - | - | 2E | ARG_0xE556_D | - |
| LADEZEIT_KENNFELD | 0xE557 | - | Auslesen des Kennfeldes von Lernfaktoren zur Korrektur des Ladezeitprognose-Rohwerts | - | - | - | - | - | - | - | - | - | 22 | - | RES_0xE557_D |
| LADEZEIT_ADAPT_KENNFELD_RESET | 0xE558 | - | Rücksetzen der Lernfaktoren des Ladezeitkennfeldes auf Initialwert (100%). Der Job ist bei jedem Modultausch auszuführen. | - | - | - | - | - | - | - | - | - | 2E | ARG_0xE558_D | - |
| REKALIBRIERUNG_RB_SOC | 0xE559 | - | Auslesen des Betteriezustandes VOR und NACH der letzten 5 SOC Rekalibrierungen | - | - | - | - | - | - | - | - | - | 22 | - | RES_0xE559_D |
...
| MAX_ALPHA_LONG_MOD | 0xE560 | - | Auslesen des aktuellen maximalen Innenwiderstandsfaktors ALLER Module, (Faktor= 1-5 mit zwei Nachkommastellen; Faktor &gt;1  entspricht dem Vielfachen des Zellwiderstands von min. einer Zelle gegenüber dem Moduldurchschnitt) | - | - | - | - | - | - | - | - | - | 22 | - | RES_0xE560_D |
...
| HISTOGRAMM_SYM_DAUER | 0xE57D | - | Auslesen der Anzahl von Symmetriervorgängen in den jeweiligen Zeitklassen (Ist-Zeit in der die Symmetrierwiderstände aktiv waren) | - | - | - | - | - | - | - | - | - | 22 | - | RES_0xE57D_D |
| HISTOGRAMM_SYM_ZELLANZAHL | 0xE57E | - | Häufigkeit über Lebensdauer der Zellenanzahl, die zur Symmetrierung angewiesen wurden. Inkrementieren falls Symmertrierbedarf bei Einschlafen nach ERSTEM zyklischen Aufwachen. | - | - | - | - | - | - | - | - | - | 22 | - | RES_0xE57E_D |
| MAX_SYMMETRIE_DAUER | 0xE57F | - | Maximale Symmetriedauer der 5 letzen Symmetriervorgänge | - | - | - | - | - | - | - | - | - | 22 | - | RES_0xE57F_D |
| HISTOGRAMM_ABWEICHUNG_PROG_LADEZEIT | 0xE580 | - | Darstellung der Häufigkeit einer relative Abweichung der Ladezeitprognose vom realen Wert (fact = (t_prog-t_ist) / t_ist * 100%). t_prog =  zu Beginn der Ladephase prognostizierte Wert. t_ist =  tatsächlich bis zum Erreichen des Ladeziels benötigte Zeit | - | - | - | - | - | - | - | - | - | 22 | - | RES_0xE580_D |
...
| HISTOGRAMM_TEMP_KUEHLMITTEL | 0xE582 | - | Temperaturhistogramm des Kühlmittels in verschiedenen Klassen | - | - | - | - | - | - | - | - | - | 22 | - | RES_0xE582_D |
...
| HV_SPANNUNG_PYRO | 0xE5AC | STAT_SPANNUNG_PYRO_WERT | Pyrospannung | V | - | High | unsigned int | - | 1.0 | 100.0 | 0.0 | - | 22 | - | - |
