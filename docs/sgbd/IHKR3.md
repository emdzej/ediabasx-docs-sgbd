...
| Field | Value |
| --- | --- |
| ECU | Integrierte Heiz- Klimaregelung E34 |
...
- [INITIALISIERUNG](#job-initialisierung) - Kommunikationsparameter fuer IHKR3 E34
- [IDENT](#job-ident) - Identifikation fuer IHKR E36
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei |
| STAT_GEBLAESE | int | -30..184 [%] |
| STAT_GEBLAESE_TEXT | string |  |
| STAT_KLEMME_30 | real | 0.74..19.38 [Volt] |
| STAT_SCHICHTUNG | int | -97..226 [%] |
| STAT_SCHICHTUNG_TEXT | string |  |
| STAT_TAUSCHER_R | real | 0..90 [Grad Celsius] |
| STAT_TAUSCHER_L | real | 0..90 [Grad Celsius] |
| STAT_VERDAMPFER | real | -4.5..25.6 [Grad Celsius] |
| STAT_INNENTEMP | real | 10.0..40.0 [Grad Celsius] |
| STAT_AUSSENTEMP | real | -40.0..40.0 [Grad Celsius] |
| STAT_SOLL_R | real | 11.50..34.01 [Grad Celsius] |
| STAT_SOLL_L | real | 11.50..34.01 [Grad Celsius] |
| STAT_TACHO | int | 0..255 [km/h] |
| STAT_WV_R | int | 0..3600 [ms] |
| STAT_WV_L | int | 0..3600 [ms] |
| STAT_MOTOR_SCH | int | 0..100 [%] |
| STAT_MOTOR_UML | int | 0..100 [%] |
| STAT_MOTOR_FRI | int | 0..100 [%] |
| TELEGRAMM | binary | Antworttelegramm |
