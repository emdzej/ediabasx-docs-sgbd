...
| --- | --- |
| ECU | 07TELUSE |
| ORIGIN | BMW EE-21 Knoebl |
| REVISION | 1.00 |
| AUTHOR | BMW EE-21 Knoebl |
| COMMENT | Erweiterte SGBD für Everest E65 basierend auf 07flash.prg |
| PACKAGE | 1.15 |
| SPRACHE | deutsch |
...
| Name | Type | Comment |
| --- | --- | --- |
| ACOUSTIC_PROFILES | int | OKAY, wenn fehlerfrei |
