...
| --- | --- |
| ECU | FRM_E81 |
| ORIGIN | BMW EE-54 Zeller |
| REVISION | 0.1 |
| AUTHOR | Lear Entwicklung Hoffmann, Lear Entwicklung Ahrens |
| COMMENT | SGBD fuer FRMFA-E81 |
| PACKAGE | 1.17 |
| SPRACHE | deutsch |
...
- [READ_IDENT_94_SSECUSON](#job-read-ident-94-ssecuson) - SystemSupplierECUSoftwareNumber KWP2000: $1A ReadECUIdentification Modus  : $94 SystemSupplierECUSoftwareNumber
...
- [WRITE_IDENT_9C_VMDI](#job-write-ident-9c-vmdi) - Schreiben der SystemSupplierECUHardwareVersionNumber KWP2000: $3B WriteDataByLocalIdentifier $9C VehicleManufacturerDiagnosticIndex Modus  : Default
...
- [HERSTELLER_DATEN_LESEN_LEAR](#job-hersteller-daten-lesen-lear) - Auslesen der Herstellerdaten KWP2000: $22 ReadDataByCommonIdentifier $0004 Herstellerdaten
- [CBD_ZEICHN_INDEX_LESEN_LEAR](#job-cbd-zeichn-index-lesen-lear) - Auslesen des Aenderungsindex aus den Codierdaten KWP 2000: $22 ReadDataByCommonIdentifier $3004 Aenderungs-Index Modus  : Default
- [CODIERDATEN_BLOCK_LESEN_LEAR](#job-codierdaten-block-lesen-lear) - Auslesen der Loeschzeit KWP2000: $22 ReadDataByCommonIdentifier $xxxx Codierdaten je nach Block Modus  : Default
...
- [HERSTELLER_DATEN_SCHREIBEN_LEAR](#job-hersteller-daten-schreiben-lear) - Beschreiben der Codierdaten je nach Block KWP2000: $2E WriteDataByCommonIdentifier $0004 Herstellerdaten
- [CODIERDATEN_BLOCK_SCHREIBEN_LEAR](#job-codierdaten-block-schreiben-lear) - Beschreiben der Codierdaten je nach Block KWP2000: $2E WriteDataByCommonIdentifier $xxxx Codierdaten Modus  : Codieren je nach Block
- [CODIERDATEN_DEFAULT_SCHREIBEN_LEAR](#job-codierdaten-default-schreiben-lear) - Beschreiben der Default-Codierdaten KWP2000: $2E WriteDataByCommonIdentifier $30xx Codierdaten, Default Modus  : Default
- [CODE_IN_EEPROM_SCHREIBEN_LEAR](#job-code-in-eeprom-schreiben-lear) - Beschreiben der Default-Codierdaten KWP2000: $2E WriteDataByCommonIdentifier $31xx Code in EEPROM Modus  : Default
...
<a id="job-read-ident-94-ssecuson"></a>
### READ_IDENT_94_SSECUSON
...
<a id="job-write-ident-9c-vmdi"></a>
### WRITE_IDENT_9C_VMDI

Schreiben der SystemSupplierECUHardwareVersionNumber KWP2000: $3B WriteDataByLocalIdentifier $9C VehicleManufacturerDiagnosticIndex Modus  : Default

#### Arguments

| Name | Type | Comment |
| --- | --- | --- |
| BMW_E_NUMMER | string | table BMW_ENumber NAME TEXT |
...
Auslesen des Aenderungsindex aus den Codierdaten KWP 2000: $22 ReadDataByCommonIdentifier $3004 Aenderungs-Index Modus  : Default
...
Auslesen der Loeschzeit KWP2000: $22 ReadDataByCommonIdentifier $xxxx Codierdaten je nach Block Modus  : Default
...
Beschreiben der Default-Codierdaten KWP2000: $2E WriteDataByCommonIdentifier $30xx Codierdaten, Default Modus  : Default
...
Beschreiben der Default-Codierdaten KWP2000: $2E WriteDataByCommonIdentifier $31xx Code in EEPROM Modus  : Default
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 0x01 |  | 0-n | - | 0xFFFF | Canid | 1 | 1 | 0 |
| 0x02 |  | 0-n | - | 0xFFFF | Canid | 1 | 1 | 0 |
| 0x03 |  | 0-n | - | 0xFFFF | Canid | 1 | 1 | 0 |
| 0x04 |  | 0-n | - | 0xFFFF | Canid | 1 | 1 | 0 |
...
| LAMPNR | NAME | TEXT |
| --- | --- | --- |
| 0x00 | AUSGANG_FL_LINKS |  |
| 0x01 | AUSGANG_FL_RECHTS |  |
| 0x02 | AUSGANG_AL_LINKS |  |
| 0x03 | AUSGANG_AL_RECHTS |  |
| 0x04 | AUSGANG_BEGRL_LINKS |  |
| 0x05 | AUSGANG_BEGRL_RECHTS |  |
| 0x06 | AUSGANG_NSW_LINKS |  |
| 0x07 | AUSGANG_NSW_RECHTS |  |
| 0x08 | AUSGANG_FRA_LINKS_VORN_1 |  1 |
| 0x09 | AUSGANG_FRA_RECHTS_VORN_1 |  1 |
| 0x0A | AUSGANG_FRA_LINKS_HINTEN |  |
| 0x0B | AUSGANG_FRA_RECHTS_HINTEN |  |
| 0x0C | AUSGANG_FRA_LINKS_VORN_2 |  2 |
| 0x0D | AUSGANG_FRA_RECHTS_VORN_2 |  2 |
| 0x0E | AUSGANG_BREMSLICHT_LINKS |  |
| 0x0F | AUSGANG_BREMSLICHT_RECHTS |  |
| 0x10 | AUSGANG_BREMSLICHT_MITTE |  |
| 0x11 | AUSGANG_SL_BL_LINKS_1 |  1 |
| 0x12 | AUSGANG_SL_BL_RECHTS_1 |  1 |
| 0x13 | AUSGANG_SL_BL_LINKS_2 |  2 |
| 0x14 | AUSGANG_SL_BL_RECHTS_2 |  2 |
| 0x15 | AUSGANG_KZL_LINKS |  |
| 0x16 | AUSGANG_KZL_RECHTS |  |
| 0x17 | AUSGANG_NSL_LINKS |  |
| 0x18 | AUSGANG_NSL_RECHTS |  |
| 0x19 | AUSGANG_RFL_LINKS |  |
| 0x1A | AUSGANG_RFL_RECHTS |  |
| 0x1B | AUSGANG_FRA_ZUSATZ_LINKS |  |
| 0x1C | AUSGANG_FRA_ZUSATZ_RECHTS |  |
| 0x1D | AUSGANG_SML_VORN |  |
| 0x1E | AUSGANG_RESERVE_4 |  |
| 0x1F | AUSGANG_SML_HINTEN |  |
| 0xFF | UNKNOWN |  |
...
| OUTNR | NAME | TEXT |
| --- | --- | --- |
| 0x00 | AUSGANG_NOTLAUF |  |
| 0x01 | AUSGANG_BED_BEL |  |
| 0x02 | AUSGANG_KL_R |  |
| 0x03 | AUSGANG_KL_58G |  |
| 0x04 | AUSGANG_BEL_WBL_TASTE |  |
| 0x05 | AUSGANG_BI_XENON |  |
| 0x06 | AUSGANG_RESERVE_1 |  |
| 0x07 | AUSGANG_RESERVE_2 |  |
| 0x08 | AUSGANG_RESERVE_3 |  |
| 0x09 | AUSGANG_DIAG_XENON_LINKS |  |
| 0x0A | AUSGANG_DIAG_XENON_RECHTS |  |
| 0x0B | AUSGANG_FLC_LED |  |
| 0x0C | AUSGANG_LWR_ENABLE |  |
| 0x0D | UNKNOWN |  |
| 0x0E | UNKNOWN |  |
| 0x0F | UNKNOWN |  |
...
| 0x00 | FLAGS_FLAGS |  |
| 0x01 | FLAGS_ANFORD |  |
| 0x02 | FLAGS_CAN_ANFORDERUNG |  |
| 0x03 | LAMPEN_FEHLER_FLAGS |  |
| 0x04 | LAMPEN_FEHLER_ZAEHLER |  |
| 0x05 | TEST_ATD |  |
| 0x06 | UNKNOWN |  |
| 0x07 | UNKNOWN |  |
...
| E_MODE | NAME | TEXT |
| --- | --- | --- |
| 0x00 | ENERGY_MODE_AUS |  |
| 0x01 | ENERGY_MODE_PRODUCTION |  |
| 0x02 | ENERGY_MODE_SHIPMENT |  |
| 0x04 | ENERGY_MODE_REPAIR_SHOP |  |
| 0x08 | ERROR |  |
...
| XENON_ERR | NAME | TEXT |
| --- | --- | --- |
| 0x01 | FEHLER_1_KURZSCHLUSS_LAMPENKREIS_GND |  |
| 0x02 | FEHLER_2_LAMPENFEHLER |  |
| 0x03 | FEHLER_3_KURZSCHLUSS_LAMPENKREIS |  |
| 0x04 | FEHLER_4_ZUENDFEHLER_0 |  |
| 0x05 | FEHLER_5_ZUENDFEHLER_1 |  |
| 0xF0 | XENON_UNGUELTIG |  |
| 0xFA | XENON_KURZSCHLUSS |  |
| 0xFB | XENON_SIGNAL_FALSCH |  |
| 0xFD | XENON_SIGNAL_FEHLT |  |
| 0xFE | XENON_KEIN_FEHLER |  |
| 0xFF | XENON_UNDEFINIERT |  |

<a id="table-bmw-enumber"></a>
### BMW_ENUMBER
