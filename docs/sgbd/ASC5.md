...
| Field | Value |
| --- | --- |
| ECU | Antiblockiersystem u. Autom. Stabilitaets Control 5 E31,E32,E34,E38 |
...
- [TEST_A_STELLGLIED](#job-test-a-stellglied) - Drosselklappen-Reduzierung ABS_ASC5
...
| --- | --- | --- |
| E_OR_W | string | Einmal = E, Wiederholung = W |
| BEFEHL_1 | int | Max. Stellung der Droselklappe in % |
| W_ZEIT | int | Wartezeit vor Ansteuerung 3. u. 4. Stellglied |
| BEFEHL_2 | int | Max. Stellung der Droselklappe in % |
