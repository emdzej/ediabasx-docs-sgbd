...
| Field | Value |
| --- | --- |
| ECU | Sitz-Pneumatik-Modul vorne rechts mit Gateway |
...
| --- | --- | --- |
| 0x025900 | Energiesparmode aktiv | 0 |
| 0x025908 | Codierung: Steuergerät ist nicht codiert | 0 |
| 0x025909 | Codierung: Fehler bei Codierdatentransaktion aufgetreten | 0 |
| 0x02590A | Codierung: Signatur der Codierdaten ungültig | 0 |
| 0x02590B | Codierung: Codierdaten passen nicht zum Fahrzeug | 0 |
| 0x02590C | Codierung: Unplausible Daten während Codierdatentransaktion | 0 |
| 0x02590D | Codierung: Codierdaten nicht qualifiziert | 0 |
| 0x025920 | CAN-Fehler (Sammelfehler) | 0 |
| 0x025923 | Flash Memory Fehler (Sammelfehler) | 0 |
| 0x025929 | Softwarefehler (Sammelfehler) | 0 |
| 0x02FF59 | Dummy-Fehlerspeichereintrag im Komponentenfehlerbereich nur für Testzwecke | 1 |
| 0x806900 | Überspannung erkannt | 1 |
| 0x806901 | Unterspannung erkannt | 1 |
| 0x806902 | SPNM_VR: Verbauort unplausibel | 0 |
| 0x806903 | SPNM Pumpe: Leitungsunterbrechung | 0 |
| 0x806904 | SPNM Pumpe: Überlast oder Kurzschluss | 0 |
| 0x806905 | Lordose, obere Blase (Ventil 1): Zieldruck wird nicht erreicht | 0 |
| 0x806906 | Lordose, untere Blase (Ventil 2): Zieldruck wird nicht erreicht | 0 |
| 0x806907 | Aktivsitz, linke Blase (Ventil 3): Zieldruck wird nicht erreicht | 0 |
| 0x806908 | Aktivsitz, rechte Blase (Ventil 4): Zieldruck wird nicht erreicht | 0 |
| 0x806909 | Massage, Blase 1 (Ventil 5): Zieldruck wird nicht erreicht | 0 |
| 0x80690A | Massage, Blase 2 (Ventil 6): Zieldruck wird nicht erreicht | 0 |
| 0x80690B | Massage, Blase 3 (Ventil 7): Zieldruck wird nicht erreicht | 0 |
| 0x80690C | Massage, Blase 4 (Ventil 8): Zieldruck wird nicht erreicht | 0 |
| 0x80690D | Massage, Blase 5 (Ventil 9): Zieldruck wird nicht erreicht | 0 |
| 0x80690E | Massage, Blase 6 (Ventil 10): Zieldruck wird nicht erreicht | 0 |
| 0x80690F | Rotationsblase mitte links (Ventil 11): Zieldruck wird nicht erreicht | 0 |
| 0x806910 | Rotationsblase mitte rechts (Ventil 12): Zieldruck wird nicht erreicht | 0 |
| 0x806911 | Rotationsblase oben rechts (Ventil 13): Zieldruck wird nicht erreicht | 0 |
| 0x806912 | Rotationsblase oben links (Ventil 14): Zieldruck wird nicht erreicht | 0 |
| 0x806913 | Taster Lordose: Taster hängt | 0 |
| 0x806915 | Taster Lordose: Leitungsfehler | 0 |
| 0x806916 | Taste Massage: Taste hängt | 0 |
| 0x806917 | SPNM: interner Hardwarefehler (Sammelfehler für Ventile und Drucksensoren) | 0 |
| 0x806919 | Lordose, obere Blase (Ventil 1): Zieldruck wird zu schnell erreicht | 0 |
| 0x80691A | Lordose, untere Blase (Ventil 2): Zieldruck wird zu schnell erreicht | 0 |
| 0x80691B | Aktivsitz, linke Blase (Ventil 3): Zieldruck wird zu schnell erreicht | 0 |
| 0x80691C | Aktivsitz, rechte Blase (Ventil 4): Zieldruck wird zu schnell erreicht | 0 |
| 0x80691D | Massage, Blase 1 (Ventil 5): Zieldruck wird zu schnell erreicht | 0 |
| 0x80691E | Massage, Blase 2 (Ventil 6): Zieldruck wird zu schnell erreicht | 0 |
| 0x80691F | Massage, Blase 3 (Ventil 7): Zieldruck wird zu schnell erreicht | 0 |
| 0x806920 | Massage, Blase 4 (Ventil 8): Zieldruck wird zu schnell erreicht | 0 |
| 0x806921 | Massage, Blase 5 (Ventil 9): Zieldruck wird zu schnell erreicht | 0 |
| 0x806922 | Massage, Blase 6 (Ventil 10): Zieldruck wird zu schnell erreicht | 0 |
| 0x806923 | Rotationsblase mitte links (Ventil 11): Zieldruck wird zu schnell erreicht | 0 |
| 0x806924 | Rotationsblase mitte rechts (Ventil 12): Zieldruck wird zu schnell erreicht | 0 |
| 0x806925 | Rotationsblase oben rechts (Ventil 13): Zieldruck wird zu schnell erreicht | 0 |
| 0x806926 | Rotationsblase oben links (Ventil 14): Zieldruck wird zu schnell erreicht | 0 |
| 0x806927 | SPNM_VR: Verbauort nicht angelernt | 0 |
| 0x806928 | Temperatur im Steuergerät ausserhalb des Betriebsbereichs | 1 |
| 0x806929 | Umgebungsdruck ausserhalb des Betriebsbereichs | 1 |
| 0x80692A | SPNM: Vordruckkanal undicht | 0 |
| 0x80692B | Drucksensor Vordruckkanal: Druck ausserhalb des zulässigen Bereichs | 1 |
| 0x80692C | Drucksensor Rotationsblase oben rechts: Druck ausserhalb des zulässigen Bereichs | 1 |
| 0x80692D | Drucksensor Rotationsblase oben links: Druck ausserhalb des zulässigen Bereichs | 1 |
| 0xDF4468 | BODY-CAN Control Module Bus OFF | 0 |
| 0xDF4BFF | Dummy-Fehlerspeichereintrag im Netzwerkfehlerbereich nur für Testzwecke | 1 |
| 0xDF5400 | Botschaft (0x1A1, Geschwindigkeit Fahrzeug): Ausfall | 1 |
| 0xDF5401 | Botschaft (0x19A, Querbeschleunigung Schwerpunkt): Ausfall | 1 |
| 0xDF5402 | Botschaft (0xAB, Status Crash): Ausfall | 1 |
| 0xDF5403 | Botschaft (0x3C, Zustand Fahrzeug): Ausfall | 1 |
...
| ORT | ORTTEXT | EREIGNIS_DTC |
| --- | --- | --- |
| 0x590015 | Ventil  M1 defekt | 0 |
| 0x590016 | Ventil  M2 defekt | 0 |
| 0x590017 | Ventil  M3 defekt | 0 |
| 0x590018 | Ventil  M4 defekt | 0 |
| 0x590019 | Ventil  M5 defekt | 0 |
| 0x590020 | Ventil  M6 defekt | 0 |
| 0x590021 | Ventil  R1 defekt | 0 |
| 0x590022 | Ventil  R2 defekt | 0 |
| 0x590023 | Ventil  R1 AS2 defekt | 0 |
| 0x590024 | Ventil  R2 AS1 defekt | 0 |
| 0x590025 | Ventil  LD1 defekt | 0 |
| 0x590026 | Ventil  LD2 defekt | 0 |
| 0x590027 | Ventil  AS1 defekt | 0 |
| 0x590028 | Ventil  AS2 defekt | 0 |
| 0x590029 | Drucksensor Umgebungsdruck defekt | 0 |
| 0x590030 | Drucksensor Vordruck defekt | 0 |
| 0x590031 | Drucksensor Rotationsblase oben rechts defekt | 0 |
| 0x590032 | Drucksensor Rotationsblase oben links defekt | 0 |
| 0x590033 | Temperatursensor defekt | 0 |
| 0x590125 | Codierwert über Grenzwert des Systems | 0 |
| 0xFFFFFF | unbekannter Fehlerort | 0 |
