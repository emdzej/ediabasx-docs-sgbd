...
| ID_DATUM_KW | binary | Herstelldatum KW |
...
| ID_ROVER_ECU_SW_NR | long | Rover ECU Software number |
| ID_ROVER_TUNE_PART_NR | long | Rover tune part number |
| ID_SW_NR | string | Part of Siemens ECU software number |
| ID_AI_NR | string | Part of Siemens ECU software number |
| _TEL_ANTWORT | binary | Hex-Antwort von SG ECU response packet |
| JOB_STATUS | string | Status der Kommunikation - OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
...
| JOB_STATUS | string | Status der Kommunikation - OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| MARKET_CONFIG | int | Market Configuration |
| LEADED_FUEL | int | Leaded fuel |
| CRUISE | int | Cruise control |
| AIRCON | int | Air Conditioning |
| AIRCON_DISABLE_PVS | int | Aircon disable based on PVS |
| COOLING_FAN_CONFIG | int | Cooling Fan Configuration |
| ENGINE_TYPE | int | Engine type |
| TRANSMISSION | int | Transmission |
| ASR_MSR_DSC | int | TCS configuration |
| CVT_HYBRID_MODE | int | CVT Hybrid Mode |
| CVT_SHIFT_INTERLOCK | int | CVT Shift Interlock (SIL) |
...
| STAT_LV_TCO_EX_ERR_ACTIVE | int | Error currently present on radiator coolant temp |
...
| STAT_LV_READY_LS_UP_1_ACTIVE | int | Readiness flag of UP O2 |
| STAT_LV_READY_LS_DOWN_1_ACTIVE | int | Readiness flag of DOWN O2 |
...
| STAT_KLIMA_VORHANDEN | int | Aircon installed - LV_ACC_OPT in Siemens configuation data Klima verbaut 0=Nein / 1=Ja |
| STAT_LAMBDAREGELUNG_1_EIN | int | Oxygen  monitoring ? Lambdaregelung 0=Nein / 1=Ja |
...
| STAT_RDY_LS | int | Oxygen  monitoring completed Readiness flags of upstream and downstream O2 s set Lambdasondenueberwachung (DATA D, Byte 9, xx1x xxxx) |
...
- [FORTTEXTE](#table-forttexte) (164 × 2)
...
| 0x0106 | Manifold Air Pressure Sensor Range/Performance |
...
| 0x0236 | Secondary Upstream Manifold Air Pressure Sensor Range/Performance |
...
| 0x1113 | Engine Coolant Temperature Radiator Outlet Sensor Intermittent |
...
| 0x0444 | Evaporative Emission Control System Purge Control Valve Circuit Open |
| 0x0445 | Evaporative Emission Control System Purge Control Valve Circuit Shorted |
| 0x0448 | Leakage Diagnostic Pump Signal High |
| 0x0447 | Leakage Diagnostic Pump Signal Low |
| 0x0452 | Reed Switch Does Not Close/Pump Problem |
| 0x0453 | Reed Switch Does Not Open |
| 0x1441 | Evaporative Emission Control System Incorrect Purge Flow |
| 0x1442 | Leakage Diagnostic Pump Clamped Tube |
...
| 0x1636 | Electronic Control Module H Bridge Controller |
| 0x1649 | Electronic Throttle Control Monitor Level 2/3 Torque Loss Calculation |
| 0x1650 | Electronic Throttle Control Monitor Level 2/3 ADC Processor Fault |
| 0x1651 | Electronic Throttle Control Monitor Level 2/3 Engine Speed Calculation Error |
| 0x1652 | Electronic Throttle Control Monitor Level 2/3 Idle Speed A Calculation Fault |
| 0x1653 | Electronic Throttle Control Monitor Level 2/3 Idle Speed B Calculation Fault |
| 0x1655 | Electronic Throttle Control Monitor Level 2/3 Clutch Torque Max Error |
| 0x1654 | Electronic Throttle Control Monitor Level 2/3 Clutch Torque Min Error |
| 0x1656 | Electronic Throttle Control Monitor Level 2/3 Pedal Position Sensor Diagnostic Error |
| 0x1657 | Electronic Throttle Control Monitor Level 2/3 Throttle Position Sensor Diagnostic Error |
| 0x1658 | Electronic Throttle Control Monitor Level 2/3 Mass Air Flow Calculation |
| 0x1659 | Electronic Throttle Control Monitor Level 2/3 Torque Calculation Error |
| 0x1660 | Electronic Throttle Control Monitor Level 2/3 Motorised Throttle Control Engine Speed Limitation Error |
| 0x1661 | Electronic Throttle Control Monitor Level 2/3 Motorised Throttle Control and Fuel Injection Switch Off 'A' |
| 0x1662 | Electronic Throttle Control Monitor Level 2/3 Motorised Throttle Control and Fuel Injection Switch Off 'B' |
...
| 0x1816 | Downshift Selector/Wheel Minus Switch Error Low Input |
| 0x1815 | Upshift Selector/Wheel Plus Switch Error Low Input |
| 0x0790 | Normal/Performance Switch Circuit  |
| 0x1606 | Transmission Control Module Control Error |
...
| 0x1785 | Transmission Ratio Control Actuator Circuit Malfunction |
| 0x1840 | Transmission Control Unit (GIB) Communication Error |
...
| 0x0748 | Secondary Pressure Solenoid Short Circuit |
| 0x1666 | Timeout EWS-Telegram |
| 0x1672 | EWS Wrong Code |
| 0x0604 | Internal/External Control Module Random Access Memory (RAM) Error |
...
| 0x0608 | Electronic Control Module Sensor Supply A |
| 0x0609 | Electronic Control Module Sensor Supply B |
| 0x1611 | Main Relay Control Circuit Low Input |
| 0x1610 | Main Relay Control Circuit High Input |
| 0x1685 | Serial Communication Link ASC |
| 0x1687 | Serial Communication Link Instrument Pack |
