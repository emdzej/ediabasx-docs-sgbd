...
| Field | Value |
| --- | --- |
| ECU | Virtuelle Integrationsplattform |
| ORIGIN | BMW EF-512 Schedlbauer |
| REVISION | 6.000 |
...
- [FORTTEXTE](#table-forttexte) (470 × 4)
- [FSCSM_ERRORCODE_TAB](#table-fscsm-errorcode-tab) (18 × 2)
- [FUMWELTTEXTE](#table-fumwelttexte) (266 × 9)
- [IDETAILSTRUKTUR](#table-idetailstruktur) (5 × 2)
- [IORTTEXTE](#table-iorttexte) (84 × 4)
- [IUMWELTTEXTE](#table-iumwelttexte) (266 × 9)
...
- [SG_FUNKTIONEN](#table-sg-funktionen) (78 × 16)
...
- [TAB_FEHLERURSACHE_FZD](#table-tab-fehlerursache-fzd) (4 × 2)
...
Dimensions: 470 rows × 4 columns

| ORT | ORTTEXT | EREIGNIS_DTC | FEHLERKLASSE |
| --- | --- | --- | --- |
| 0x023900 | Energiesparmode aktiv | 0 | - |
| 0x023903 | Externe SWT-Prüfbedingung nicht erfüllt | 1 | - |
| 0x023904 | Interne SWT-Prüfung fehlgeschlagen | 0 | - |
| 0x023908 | Codierung: Steuergerät ist nicht codiert | 0 | - |
| 0x023909 | Codierung: Fehler bei Codierdatentransaktion aufgetreten | 0 | - |
| 0x02390A | Codierung: Signatur der Codierdaten ungültig | 0 | - |
| 0x02390B | Codierung: Codierdaten passen nicht zum Fahrzeug | 0 | - |
| 0x02390C | Codierung: Unplausible Daten während Codierdatentransaktion | 0 | - |
...
| 0x03064F | QDM-SKR - Radradius Lernalgorithmus langfristig inaktiv | 1 | - |
...
| 0x483900 | Steuergerät intern - Error Mode VIP | 0 | - |
| 0x483901 | Spannungsversorgung - Globale Überspannung extern | 1 | - |
| 0x483903 | Spannungsversorgung - Globale Unterspannung extern | 1 | - |
| 0x483907 | Steuergerät intern - ROM / Flash Fehler | 0 | - |
| 0x483908 | Steuergerät intern - EEPROM Fehler | 0 | - |
| 0x483909 | Steuergerät intern - P2P Fehler | 0 | - |
| 0x48390A | Steuergerät intern - Elektronischer Fehler | 0 | - |
| 0x483917 | Steuergerät intern - RAM / ECC Fehler (Flexray) | 0 | - |
| 0x48391D | Steuergerät intern - Security Zugriff geöffnet | 0 | - |
| 0xD7441F | FLEXRAY Physical bus error | 0 | - |
| 0xD74420 | FLEXRAY controller error | 0 | - |
| 0xD74517 | FAS-CAN Physikalischer Busfehler | 0 | - |
...
| 0xD754F9 | Signal(Status Funkschlüssel, ID: STAT_FUNKSCHLUESSEL) ungültig | 1 | - |
...
| 0xD7554A | Botschaft(Konfiguration Stellhebel Anzeige Fahrerlebnis, ID: SU_CLE_DISP_DXP) fehlt | 1 | - |
| 0xD7554D | Signal(Konfiguration Stellhebel Anzeige Fahrerlebnis, ID: SU_CLE_DISP_DXP) ungültig | 1 | - |
...
| 0xD7557A | Botschaft(Regensensor-Wischergeschwindigkeit, ID: WISCHERGESCHWINDIGKEIT) fehlt | 1 | - |
| 0xD7557D | Signal(Regensensor-Wischergeschwindigkeit, ID: WISCHERGESCHWINDIGKEIT) ungültig | 1 | - |
...
| 0xD7568A | Botschaft(Steuerung Funktionen Blinken, ID: CTR_FN_IDC) nicht aktuell | 1 | - |
| 0xD7568B | Botschaft(Steuerung Funktionen Blinken, ID: CTR_FN_IDC) Prüfsumme falsch | 1 | - |
...
| 0xD7578B | Botschaft(GNSS Rohdaten 1, ID: GNSS_RWDT_1) fehlt | 1 | - |
| 0xD7578E | Signal(GNSS Rohdaten 1, ID: GNSS_RWDT_1) ungültig | 1 | - |
...
| 0xD7579A | Botschaft(GNSS Rohdaten 2, ID: GNSS_RWDT_2) fehlt | 1 | - |
| 0xD7579D | Signal(GNSS Rohdaten 2, ID: GNSS_RWDT_2) ungültig | 1 | - |
| 0xD7579F | Botschaft(GNSS Rohdaten Zeitbasis, ID: GNSS_RWDT_TBS) fehlt | 1 | - |
| 0xD757A2 | Signal(GNSS Rohdaten Zeitbasis, ID: GNSS_RWDT_TBS) ungültig | 1 | - |
...
| 0xD75865 | Botschaft(Daten Fahrermodell, ID: DT_DVMOD) fehlt | 1 | - |
...
| 0xD7586B | Signal(Daten Fahrermodell, ID: DT_DVMOD) ungültig | 1 | - |
| 0xD7586D | Signal(Status M-Drive 3, ID: ST_MDRV_3) ungültig | 1 | - |
| 0xD75873 | Signal(Navigationsgraph Erweitert, ID: NAVGRPH_EXT) ungültig | 1 | - |
...
| 0xD7587F | Botschaft (GNSS Rohdaten 3, ID: GNSS_RWDT_3) fehlt | 1 | - |
| 0xD75882 | Signal (GNSS Rohdaten 3, ID: GNSS_RWDT_3) ungültig | 1 | - |
...
Dimensions: 266 rows × 9 columns

| UWNR | UWTEXT | UW_EINH | L/H | UWTYP | NAME | MUL | DIV | ADD |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 0x0001 | QuFzgDynDatGschzt | 0/1 | - | 0x00000001 | - | - | - | - |
| 0x0002 | QuFzgDynDatGschztErweit | 0/1 | - | 0x00000002 | - | - | - | - |
| 0x0003 | QuSchwmwnklLinr | 0/1 | - | 0x00000004 | - | - | - | - |
| 0x0004 | QuEinspurmdlErweit | 0/1 | - | 0x00000008 | - | - | - | - |
| 0x0005 | QuGschwFzgLngs | 0/1 | - | 0x00000010 | - | - | - | - |
| 0x0006 | QuGiergschwFzgTempKomp | 0/1 | - | 0x00000020 | - | - | - | - |
| 0x0007 | QuGierrateAusHntrraedr | 0/1 | - | 0x00000040 | - | - | - | - |
| 0x0008 | QuGierrateAusVrdrraedr | 0/1 | - | 0x00000080 | - | - | - | - |
| 0x0009 | QuIstAnzhlGebrflankRadVL | 0/1 | - | 0x00000100 | - | - | - | - |
| 0x000A | QuIstAnzhlGebrflankRadVR | 0/1 | - | 0x00000200 | - | - | - | - |
| 0x000B | QuIstAnzhlGebrflankRadHL | 0/1 | - | 0x00000400 | - | - | - | - |
| 0x000C | QuIstAnzhlGebrflankRadHR | 0/1 | - | 0x00000800 | - | - | - | - |
| 0x000D | QuLenkwnklVachsRad | 0/1 | - | 0x00001000 | - | - | - | - |
| 0x000E | QuLenkwnklVachseffkt | 0/1 | - | 0x00002000 | - | - | - | - |
| 0x000F | QuIstLngsneigFhrbahn | 0/1 | - | 0x00004000 | - | - | - | - |
| 0x0010 | QuIstQuerneigFhrbahn | 0/1 | - | 0x00008000 | - | - | - | - |
| 0x0011 | QuQuerbschlSchwpkt | 0/1 | - | 0x00010000 | - | - | - | - |
| 0x0012 | QuZahlrSyncGschwFzgSchwpkt | 0/1 | - | 0x00020000 | - | - | - | - |
| 0x0013 | I_Odo_Aktiv | 0/1 | - | 0x00040000 | - | - | - | - |
| 0x0014 | I_beta_Aktiv | 0/1 | - | 0x00080000 | - | - | - | - |
| 0x0015 | I_kappa_Aktiv | 0/1 | - | 0x00100000 | - | - | - | - |
| 0x0016 | Reserve_21 | 0/1 | - | 0x00200000 | - | - | - | - |
| 0x0017 | Reserve_22 | 0/1 | - | 0x00400000 | - | - | - | - |
| 0x0018 | Reserve_23 | 0/1 | - | 0x00800000 | - | - | - | - |
| 0x0019 | iBrake | 0/1 | - | 0x0001 | - | - | - | - |
| 0x001A | Kamerabasierte Auffahrwarnung (FCW_CCM) | 0/1 | - | 0x0002 | - | - | - | - |
| 0x001B | Querverkehrsassistent (QVA) | 0/1 | - | 0x0004 | - | - | - | - |
| 0x001C | Präventiver Fußgängerschutz (pFGS) | 0/1 | - | 0x0008 | - | - | - | - |
| 0x001D | Night-Vision (NiVi) | 0/1 | - | 0x0010 | - | - | - | - |
| 0x001E | Vorfahrtswarner (VFW) | 0/1 | - | 0x0020 | - | - | - | - |
| 0x001F | Unklassifiziertes Kameraobjekt (OBJ) | 0/1 | - | 0x0040 | - | - | - | - |
| 0x0020 | Anfahrverhinderung (QVA) | 0/1 | - | 0x0080 | - | - | - | - |
| 0x0021 | Linksabbiegeassistent | 0/1 | - | 0x0100 | - | - | - | - |
| 0x0022 | Anfahrverhinderung (Linksabbiegeassistent) | 0/1 | - | 0x0200 | - | - | - | - |
| 0x0023 | Wrong Way Assist (WWA) | 0/1 | - | 0x0400 | - | - | - | - |
| 0x0024 | Unklassifiziertes Radarobjekt (OBJ) | 0/1 | - | 0x0800 | - | - | - | - |
| 0x0025 | Ausfall DSC | 0/1 | - | 0x0001 | - | - | - | - |
| 0x0026 | Ausfall CHC | 0/1 | - | 0x0002 | - | - | - | - |
| 0x0027 | Ausfall emARS | 0/1 | - | 0x0004 | - | - | - | - |
| 0x0028 | Ausfall VDC | 0/1 | - | 0x0008 | - | - | - | - |
| 0x0029 | Ausfall/Schutz LMV | 0/1 | - | 0x0010 | - | - | - | - |
| 0x002A | Reifendruckverlust | 0/1 | - | 0x0020 | - | - | - | - |
| 0x002B | Ausfall Heckspoiler | 0/1 | - | 0x0040 | - | - | - | - |
| 0x002C | FAS Wechsel Betriebsart | 0/1 | - | 0x0080 | - | - | - | - |
| 0x002D | FAS Sperrung Bedienung | 0/1 | - | 0x0100 | - | - | - | - |
| 0x002E | Bedarf Stabilisierung | 0/1 | - | 0x0200 | - | - | - | - |
| 0x002F | State of Charge low | 0/1 | - | 0x0400 | - | - | - | - |
| 0x0030 | Care Key Ausschluss DSC-OFF | 0/1 | - | 0x0800 | - | - | - | - |
| 0x0031 | Care Key TRACTION nur bei Anfahren | 0/1 | - | 0x1000 | - | - | - | - |
| 0x0032 | Ausfall EHC | 0/1 | - | 0x2000 | - | - | - | - |
| 0x0033 | Ausfall GSD-Ansteuerung | 0/1 | - | 0x4000 | - | - | - | - |
| 0x0034 | Ausfall LMV-Ansteuerung | 0/1 | - | 0x8000 | - | - | - | - |
| 0x0035 | Hybrid power Managment Zustand | 0-n | High | 0xFF | TAB_STATUS_LADEN_HOCHSPANNUNG_POWERMANAGEMENT | - | - | - |
...
| 0x5050 | ERROR_MODE_DETAIL_INFO | TEXT | High | 25 | - | 1.0 | 1.0 | 0.0 |
| 0x5051 | PIA_FEHLER_INTERNE_INFO | TEXT | High | 10 | - | 1.0 | 1.0 | 0.0 |
| 0x5052 | HW_CANCELATION_DETAIL_INFO | TEXT | High | 25 | - | 1.0 | 1.0 | 0.0 |
...
| 0x6812 | STAT_FAHRZUSTAND_WERT | HEX | High | unsigned int | - | 1.0 | 1.0 | 0.0 |
...
| 0x68FA | ERROR_DUMP_DTC030800 | HEX | - | unsigned long | - | - | - | - |
| 0x68FB | ERROR_DUMP_DTC030801 | HEX | - | unsigned long | - | - | - | - |
| 0x68FD | ERROR_DUMP_DTC030804 | HEX | - | unsigned long | - | - | - | - |
...
| 0x48391C | Steuergerät intern - PIA Daten ungültig | 0 | - |
| 0x48391E | Steuergerät intern - Flexray controller (HW Cancelation) | 0 | - |
| 0xFFFFFF | unbekannter Fehlerort | 0 | - |
...
Dimensions: 78 rows × 16 columns

| ARG | ID | RESULTNAME | INFO | EINHEIT | LABEL | L/H | DATENTYP | NAME | MUL | DIV | ADD | SG_ADR | SERVICE | ARG_TABELLE | RES_TABELLE |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| FLASH_TIMING_PARAMETER | 0x2504 | - | Programmierspezifische Timing Parameter | - | - | - | - | - | - | - | - | - | 22 | - | RES_0x2504_D |
| MILE_KM_EEPROM | 0x2540 | STAT_MILE_KM_EEPROM_DATA | Im EEPROM abgelegter Kilometerstand. | DATA | - | High | data[3] | - | 1.0 | 1.0 | 0.0 | - | 22 | - | - |
| _SW_IDENTIFIKATION | 0x4000 | STAT_SW_DATA | 36 Bytes SW-Identifikation | DATA | - | High | data[36] | - | 1.0 | 1.0 | 0.0 | - | 22 | - | - |
...
<a id="table-tab-fehlerursache-fzd"></a>
### TAB_FEHLERURSACHE_FZD

Dimensions: 4 rows × 2 columns

| WERT | TEXT |
| --- | --- |
| 0x00 | Kamerakalibrierung nicht abgeschlossen |
| 0x01 | Geschwindigkeitsschwelle nicht erreicht |
| 0x02 | Kundenfehlbedienung |
| 0xFF | Wert ungültig |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 16 | 0x0025 | 0x0026 | 0x0027 | 0x0028 | 0x0029 | 0x002A | 0x002B | 0x002C | 0x002D | 0x002E | 0x002F | 0x0030 | 0x0031 | 0x0032 | 0x0033 | 0x0034 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 24 | 0x0001 | 0x0002 | 0x0003 | 0x0004 | 0x0005 | 0x0006 | 0x0007 | 0x0008 | 0x0009 | 0x000A | 0x000B | 0x000C | 0x000D | 0x000E | 0x000F | 0x0010 | 0x0011 | 0x0012 | 0x0013 | 0x0014 | 0x0015 | 0x0016 | 0x0017 | 0x0018 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 12 | 0x0019 | 0x001A | 0x001B | 0x001C | 0x001D | 0x001E | 0x001F | 0x0020 | 0x0021 | 0x0022 | 0x0023 | 0x0024 |
