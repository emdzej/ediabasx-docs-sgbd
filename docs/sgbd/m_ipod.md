...
| Field | Value |
| --- | --- |
| ECU | MOST_CDC_IPOD_Interface |
| ORIGIN | BMW EI-41 Alexander Busch |
| REVISION | 0.006 |
| AUTHOR | Alpine Electronics AOGE-MN Michael Ramtke |
| COMMENT | iPod Interface which uses the CDC FBlocks |
| PACKAGE | 1.35 |
| SPRACHE | deutsch |
...
- [SER_NR_DOM_LESEN](#job-ser-nr-dom-lesen) - read serial number (14 digits) KWP2000: $21 ReadDataByLocalldentifier $E0 recordLocalIdentifier - serial# DOM Modus  : Default
- [LESEN_SER_NR_IPOD](#job-lesen-ser-nr-ipod) - read serial number which iPod has KWP2000: $21 readDataByLocalIdentifier $E2 recordLocalIdentifier Modus  : Default
- [LESEN_SW_VER_IPOD](#job-lesen-sw-ver-ipod) - read current SW version of iPod KWP2000: $21 readDataByLocalIdentifier $E3 recordLocalIdentifier Modus  : Default
- [LESEN_BAUD_RATE](#job-lesen-baud-rate) - read status of baud rate between iPod I/F and iPod KWP2000: $21 ReadDataByLocalIdentifier $E1 recordLocalIdentifier - baud rate Modus  : Default
...
read serial number (14 digits) KWP2000: $21 ReadDataByLocalldentifier $E0 recordLocalIdentifier - serial# DOM Modus  : Default
...
<a id="job-lesen-ser-nr-ipod"></a>
### LESEN_SER_NR_IPOD

read serial number which iPod has KWP2000: $21 readDataByLocalIdentifier $E2 recordLocalIdentifier Modus  : Default
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| SNR_IPOD | string | iPod serial number |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |

<a id="job-lesen-sw-ver-ipod"></a>
### LESEN_SW_VER_IPOD

read current SW version of iPod KWP2000: $21 readDataByLocalIdentifier $E3 recordLocalIdentifier Modus  : Default
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| IPOD_MAJOR_VER_NUMBER | string | iPod Software Major Version Number |
| IPOD_MINOR_VER_NUMBER | string | iPod Software Minor Version Number |
| IPOD_REVISION_VER_NUMBER | string | iPod Software Revision Version Number |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |

<a id="job-lesen-baud-rate"></a>
### LESEN_BAUD_RATE

read status of baud rate between iPod I/F and iPod KWP2000: $21 ReadDataByLocalIdentifier $E1 recordLocalIdentifier - baud rate Modus  : Default
...
- [T_BAUD_RATE](#table-t-baud-rate) (8 × 2)
...
| ORT | ORTTEXT |
| --- | --- |
| 0xD80C | Device_No_Answer Error |
| 0xD80E | Light_Not_Off Error |
| 0xD810 | Ring_Diagnosis Error |
| 0xD812 | Temp_ShutDown Error |
| 0xD813 | MOST_Audio_Channel Error |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 0x01 | Logical Node Address | Hex | high | unsigned int | - | 1 | 1 | 0 |
| 0x02 | FBlockID | Hex | - | unsigned char | - | 1 | 1 | 0 |
| 0x03 | InstID | Hex | - | unsigned char | - | 1 | 1 | 0 |
| 0x04 | FktID | Hex | high | unsigned int | - | 1 | 1 | 0 |
| 0x05 | Diagnosis Address | Hex | - | unsigned char | - | 1 | 1 | 0 |
| 0x06 | NPR | Hex | - | unsigned char | - | 1 | 1 | 0 |
| 0x10 | Voltage Kl30 | Hex | - | unsigned int | - | - | - | - |
| 0x11 | Exterior Temperature | Grad C | high | unsigned char | - | 1 | 1 | 0 |
| 0xXY | Unknown ext. Environmental Condition | 1 | - | unsigned char | - | 1 | 1 | 0 |
...
| --- | --- |
| 0x9308 | Reset Error |
| 0x9309 | NS_Init_Timeout Error |
| 0x930A | Sudden_Light_Off Error |
| 0x930B | Unlock_Long Error |
| 0x930C | Unlock_Short Error |
| 0x930D | Configuration_Status Error |
| 0x9408 | Temperature Error |
| 0x9409 | Voltage Error |
| 0x940C | EEPROM_Checksum Error |
| 0x940D | RAM Error |
| 0x940E | External_RAM Error |
| 0xFFFF | unbekannter Fehlerort |
...
| --- | --- |
| 0x00 | not defined |
| 0x01 | Baudrate 9.6 kBaud |
| 0x02 | Baudrate 19.2 kBaud |
| 0x03 | Baudrate 38.4 kBaud |
| 0x04 | Baudrate 57.6 kBaud |
| 0x05 | Baudrate 115.2 kBaud |
| 0x06 | Specific Baudrate |
| 0xXY | unbekannte Baudrate |
