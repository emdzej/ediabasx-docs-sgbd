...
| Field | Value |
| --- | --- |
| ECU | Dynamische Stabilitaets Control DXC8 E83/84, E53 (ab 9/03) |
| ORIGIN | BMW EF-43 Barbet |
| REVISION | 9.00 |
| AUTHOR | BMW EF-43 Barbet, BMW EF-43 Kusch |
| COMMENT | Version Robert Bosch DXC8 KWP 2000 star E83/84, E53 (ab 9/03) |
| PACKAGE | 1.14 |
| SPRACHE | deutsch |
...
- [STATUS_RADGESCHWINDIGKEIT](#job-status-radgeschwindigkeit) - Radgeschwindigkeiten auslesen KWP2000 star: $21,$01 ReadDataByLocalIdentifier service Modus  : Default
- [STATUS_ANALOG](#job-status-analog) - Status analoge Eingaenge DXC_8 KWP2000 star: $21,$02 ReadDataByLocalIdentifier service
- [STATUS_IO_LESEN_ANALOG](#job-status-io-lesen-analog) - Status analoge Eingaenge DXC_8 KWP2000 star: $21,$02 ReadDataByLocalIdentifier service identisch mit dem Job STATUS_ANALOG
- [STATUS_DIGITAL](#job-status-digital) - Status digitale Eingaenge DXC_8 KWP2000 star: $21,$03 ReadDataByLocalIdentifier service
...
- [IDENT_SCHREIBEN](#job-ident-schreiben) - KWP2000 star: $3B WriteDataByLocalIdentifier $80 BMW Identifikation schreiben
...
- [COD_LESEN_DSC](#job-cod-lesen-dsc) - Auslesen der Codierdaten KWP2000 star: $22 ReadDataByCommonIdentifier $3000 Codierdaten Modus  : Default
- [COD_SCHREIBEN_DSC](#job-cod-schreiben-dsc) - Codierdaten schreiben Es muessen 4 Codierbyte als Hex_String uebergeben werden Argument: z.B.: 01,07,02,AB, die CS wird in der ECU berechnet KWP2000 star: $2E WriteDataByCommonIdentifier $3000 codingDataSet Modus  : Default
- [COD_LESEN_RPA_1](#job-cod-lesen-rpa-1) - Auslesen der Codierdaten KWP2000: $22 ReadDataByCommonIdentifier $3001 Codierdaten Modus  : Default
- [COD_SCHREIBEN_RPA_1](#job-cod-schreiben-rpa-1) - Codierdaten schreiben KWP2000: $2E WriteDataByCommonIdentifier $3001 codingDataSet Modus  : Default
...
| --- | --- | --- |
| ID_DIAG_INDEX | int | Diagnose-Index |
| STAT_UMCODIERUNG_WERT | int | Umcodierungs-index |
| STAT_UMCODIERUNG_TEXT | string | Umcodierungs-text |
| STAT_HPS_WERT | int | HPS-index |
| STAT_HPS_TEXT | string | Umcodierungs-text |
| STAT_HVV_WERT | int | Umcodierungs-index |
| STAT_HVV_TEXT | string | Umcodierungs-text |
| STAT_TOL_WERT | int | Umcodierungs-index |
| STAT_TOL_TEXT | string | Umcodierungs-text |
| STAT_FLR_WERT | int | Umcodierungs-index |
| STAT_FLR_TEXT | string | Umcodierungs-text |
| STAT_RASSELLOGIK_WERT | int | Umcodierungs-index |
| STAT_RASSELLOGIK_TEXT | string | Umcodierungs-text |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
...
- [FORTTEXTE](#table-forttexte) (328 × 2)
