...
| Field | Value |
| --- | --- |
| ECU | Antiblockiersystem u. Autom. Stabilitaets Control 5.7 |
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, FEHLER |
| COD_BYTE_00_DEC | int | Codierbyte_00 in Dezimal |
| CS_BYTE_00_DEC | int | Checksum Byte_00 in Dezimal |
| COD_BYTE_01_DEC | int | Codierbyte_01 in Dezimal |
| CS_BYTE_01_DEC | int | Checksum Byte_01 in Dezimal |
| COD_BYTE_02_DEC | int | Codierbyte_02 in Dezimal |
| CS_BYTE_02_DEC | int | Checksum Byte_02 in Dezimal |
| COD_BYTE_14_DEC | int | Codierbyte_14 in Dezimal |
| CS_BYTE_14_DEC | int | Chechsum Byte_14 in Dezimal |
| _AUFTRAG1 | binary | Anforderungstelegramm |
| _ANTWORT1 | binary | Antworttelegramm |
| _AUFTRAG2 | binary | Anforderungstelegramm |
| _ANTWORT2 | binary | Antworttelegramm |
