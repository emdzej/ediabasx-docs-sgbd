...
| Name | Type | Comment |
| --- | --- | --- |
| STAT_ZK1_AKTIV | int | 0=ZK1_NICHT_AKTIV 1=ZK1_AKTIV Kopf-Airbag rechts |
| STAT_ZK2_AKTIV | int | 0=ZK2_NICHT_AKTIV 1=ZK2_AKTIV Kniepolster rechts |
| STAT_ZK3_AKTIV | int | 0=ZK3_NICHT_AKTIV 1=ZK3_AKTIV Front-Airbag Beifahrer Stufe 1 |
| STAT_ZK4_AKTIV | int | 0=ZK4_NICHT_AKTIV 1=ZK4_AKTIV Front-Airbag Beifahrer Stufe 2 |
...
| ORT | ORTTEXT |
| --- | --- |
| 0x95a8 | Watchdog-Reset uP |
| 0x95a9 | Clock-Monitor-Reset uP |
| 0x95aa | Illegal Opcode uP |
| 0x95ab | Falsche Fahrgestellnummer |
| 0x95ac | Systemzeitfehler |
| 0x95ad | Timeout ID 01H (STVL) |
| 0x95ae | Timeout ID 02H |
| 0x95af | Timeout ID 03H (STVR) |
| 0x95b0 | Timeout ID 04H |
| 0x95b1 | Timeout ID 05H (SBSL) |
| 0x95b2 | Timeout ID 06H (SASL) |
| 0x95b3 | Timeout ID 07H (SBSR) |
| 0x95b4 | Timeout ID 08H (SASR) |
| 0x95b5 | Timeout ID 09H (SFZ) |
| 0x95b6 | Timeout ID 0AH (SIM) |
| 0x95b7 | Timeout ID 0BH (SASL) |
| 0x95b8 | Timeout ID 0CH (SASR) |
| 0x95b9 | Timeout ID 0DH (SFZ) |
| 0x95ba | Timeout ID 0EH |
| 0x95bb | Timeout ID 0FH |
| 0x95bc | Timeout ID 20H (SSFA) |
| 0x95bd | Timeout ID 21H (SSBF) |
| 0x95be | Timeout ID 22H (SSH) |
| 0x95bf | Timeout ID 71H (SIM) |
| 0x95c0 | Codierdaten Checksummenfehler |
| 0x95c1 | Stack Overflow |
| 0x95c2 | PDC_3 : zu wenig Telegramme |
| 0x95c3 | PDC_3 : Datenfehler in Telegramm |
| 0x95c4 | PDC_3 : Uebertragungsfehler |
| 0x95c5 | unplausible Crash-Schwere |
| 0x95c6 | Kurzschluss oder Unterbrechung H/L-Side-Schalter ZK1 |
| 0x95c7 | Kurzschluss ZK1 nach Masse |
| 0x95c8 | Kurzschluss ZK1 nach Plus |
| 0x95c9 | Widerstand Zuendpille ZK1 zu klein |
| 0x95ca | Widerstand Zuendpille ZK1 zu gross |
| 0x95cb | Widerstand Zuendpille ZK1 nicht gemessen |
| 0x95cc | Unterbrechung ZK1 |
| 0x95cd | Spannung ZK1 n.i.O. |
| 0x95ce | Zuendkapazitaet ZK1 n.i.O. |
| 0x95cf | Codierung/Konfiguration ZK1 unstimmig |
| 0x95d0 | Unterbrechung Entladekreis ZK1 |
| 0x95d1 | Kurzschluss oder Unterbrechung H/L-Side-Schalter ZK2 |
| 0x95d2 | Kurzschluss ZK2 nach Masse |
| 0x95d3 | Kurzschluss ZK2 nach Plus |
| 0x95d4 | Widerstand Zuendpille ZK2 zu klein |
| 0x95d5 | Widerstand Zuendpille ZK2 zu gross |
| 0x95d6 | Widerstand Zuendpille ZK2 nicht gemessen |
| 0x95d7 | Unterbrechung ZK2 |
| 0x95d8 | Spannung ZK2 n.i.O. |
| 0x95d9 | Zuendkapazitaet ZK2 n.i.O. |
| 0x95da | Codierung/Konfiguration ZK2 unstimmig |
| 0x95db | Unterbrechung Entladekreis ZK2 |
| 0x95dc | Kurzschluss oder Unterbrechung H/L-Side-Schalter ZK3 |
| 0x95dd | Kurzschluss ZK3 nach Masse |
| 0x95de | Kurzschluss ZK3 nach Plus |
| 0x95df | Widerstand Zuendpille ZK3 zu klein |
| 0x95e0 | Widerstand Zuendpille ZK3 zu gross |
| 0x95e1 | Widerstand Zuendpille ZK3 nicht gemessen |
| 0x95e2 | Unterbrechung ZK3 |
| 0x95e3 | Spannung ZK3 n.i.O. |
| 0x95e4 | Zuendkapazitaet ZK3 n.i.O. |
| 0x95e5 | Codierung/Konfiguration ZK3 unstimmig |
| 0x95e6 | Unterbrechung Entladekreis ZK3 |
| 0x95e7 | Kurzschluss oder Unterbrechung H/L-Side-Schalter ZK4 |
| 0x95e8 | Kurzschluss ZK4 nach Masse |
| 0x95e9 | Kurzschluss ZK4 nach Plus |
| 0x95ea | Widerstand Zuendpille ZK4 zu klein |
| 0x95eb | Widerstand Zuendpille ZK4 zu gross |
| 0x95ec | Widerstand Zuendpille ZK4 nicht gemessen |
| 0x95ed | Unterbrechung ZK4 |
| 0x95ee | Spannung ZK4 n.i.O. |
| 0x95ef | Zuendkapazitaet ZK4 n.i.O. |
| 0x95f0 | Codierung/Konfiguration ZK4 unstimmig |
| 0x95f1 | Unterbrechung Entladekreis ZK4 |
| 0x95f2 | Fehler im Alarmpfad |
| 0x95f3 | Fehler Beschleunigungssensor:Offset zu gross (x-Richtung) |
| 0x95f4 | Fehler Beschleunigungssensor:Selbsttestwert zu gross (x-Richtung) |
| 0x95f5 | Fehler Beschleunigungssensor:Selbsttestwert zu klein (x-Richtung) |
| 0x95f6 | Fehler Beschleunigungssensor:Offset zu gross (y-Richtung) |
| 0x95f7 | Fehler Beschleunigungssensor:Selbsttestwert zu gross (y-Richtung) |
| 0x95f8 | Fehler Beschleunigungssensor:Selbsttestwert zu klein (y-Richtung) |
| 0x95f9 | Statusfehler Beschleunigungssensor (y-Richtung) |
| 0x95fa | Algorithmus-Parameter inkonsistent |
| 0x95fb | EAM-Parameter inkonsistent |
| 0x95fc | Zuendversuch erfolgt |
| 0x95fd | COP-Watchdog fehlerhaft |
| 0x9609 | Kurzschluss oder Unterbrechung Low-Side-Schalter ZK1 |
| 0x960a | Kurzschluss oder Unterbrechung High-Side-Schalter ZK1 |
| 0x960b | Kurzschluss oder Unterbrechung Low-Side-Schalter ZK2 |
| 0x960c | Kurzschluss oder Unterbrechung High-Side-Schalter ZK2 |
| 0x960d | Kurzschluss oder Unterbrechung Low-Side-Schalter ZK3 |
| 0x960e | Kurzschluss oder Unterbrechung High-Side-Schalter ZK3 |
| 0x960f | Kurzschluss oder Unterbrechung Low-Side-Schalter ZK4 |
| 0x9610 | Kurzschluss oder Unterbrechung High-Side-Schalter ZK4 |
| 0x9611 | Kommunikation mit Zuend-IC gestoert |
| 0x9612 | Spannungsueberwachung ASE unterer Grenzwert unterschritten |
| 0x9613 | Spannungsueberwachung ASE oberer Grenzwert ueberschritten |
| 0x9614 | Energiesparmode aktiv |
| 0x9615 | Codierung unvollstaendig |
...
| ORT | ORTTEXT |
| --- | --- |
| 0x9600 | Power-On-Reset uP |
| 0x9601 | Diagnose S/E-Modul (Lichtleistung) |
| 0x9602 | SI-Bus: Uebertragungsfehler, CRC-Fehler ERRIF |
| 0x9603 | SI-Bus: Uebertragungsfehler, Formatfehler ILLPIF |
| 0x9604 | SI-Bus: Synchronisierungspuls zu frueh SYNEIF |
| 0x9605 | SI-Bus: Synchronisierung verloren SYNLIF |
| 0x9606 | SI-Bus: Slotmismatch, Timingfehler SLMMIF |
| 0x9607 | SI-Bus: FIFO-Ueberlauf OVRNIF |
| 0x9608 | EMV-Fehler im Zuend-Ic |
| 0x???? | unbekannter Fehlerort |
