...
| --- | --- |
| ECU | Everest TCU |
| ORIGIN | BMW TI-431 Igor Rochal |
| REVISION | 2.05 |
| AUTHOR | Motorola Marc Manns BMW Thorsten Walter Winfried Siegl Doyen JP,BMW TI-431 Igor Rochal |
| COMMENT | Erstellt von Motorola auf Basis der Telefon-US E65 SGBD |
| PACKAGE | 1.17 |
| SPRACHE | deutsch |
...
- [TCU_TYPE_LESEN](#job-tcu-type-lesen) - Read out the TCU Type KWP2000: $22 ReadDataByCommonIdentifier $3000 recordCommonIdentifier e60_ece/00h/E60 TCU for ECE e60_us /01h/E60 TCU for US e60_japan /02h/E60 TCU for JAPAN e65_ece/03h/E65 TCU for ECE e65_us /04h/E65 TCU for US Modus  : Default
...
- [US_ESN_LESEN](#job-us-esn-lesen) - Read out ESN (8 Bytes) KWP2000: $22 ReadDataByCommonIdentifier $A006 recordCommonIdentifier Modus  : Default
- [GMIN_NULL_SCHREIBEN](#job-gmin-null-schreiben) - CM-42 GMIN NULL SCHREIBEN for South Amerika and Korea KWP2000: $2E WriteDataByCommonId $A110 GMIN Modus  : Default
- [US_MIN_SCHREIBEN](#job-us-min-schreiben) - CM-42 ESN MIN KWP2000: $2E WriteDataByCommonId $A110 GMIN Modus  : Default
- [US_MIN_LESEN](#job-us-min-lesen) - Read out ESN GMIN (11 Bytes) KWP2000: $22 ReadDataByCommonIdentifier $A110 recordCommonIdentifier Modus  : Default
- [US_CDMA_DIRECTORY_SCHREIBEN](#job-us-cdma-directory-schreiben) - CM-42 ESN CDMA Directory No KWP2000: $2E WriteDataByCommonId $A117 CDMA Directory Number Modus  : Default
- [US_CDMA_DIRECTORY_LESEN](#job-us-cdma-directory-lesen) - Read out ESN CDMA Directory(11 Bytes (including NULL)) KWP2000: $22 ReadDataByCommonIdentifier $A117 recordCommonIdentifier Modus  : Default
- [US_SID_NID_SCHREIBEN](#job-us-sid-nid-schreiben) - CM-42 ESN SIDNID KWP2000: $2E WriteDataByCommonId $A118 SID/NID Modus  : Default
- [US_SID_NID_LESEN](#job-us-sid-nid-lesen) - Read out ESN SID NID (16 Bytes (including NULL)) KWP2000: $22 ReadDataByCommonIdentifier $A118 recordCommonIdentifier Modus  : Default
...
- [US_CDMA_PRIMARY_CH_A_LESEN](#job-us-cdma-primary-ch-a-lesen) - Read out ESN CDMA Primary Channel A (up to 5 Bytes (including NULL)) KWP2000: $22 ReadDataByCommonIdentifier $A119 recordCommonIdentifier Modus  : Default
...
- [US_CDMA_SECONDARY_CH_A_LESEN](#job-us-cdma-secondary-ch-a-lesen) - Read out ESN CDMA Secondary Channel A (up to 5 Bytes (including NULL)) KWP2000: $22 ReadDataByCommonIdentifier $A11A recordCommonIdentifier Modus  : Default
...
- [US_CDMA_PRIMARY_CH_B_LESEN](#job-us-cdma-primary-ch-b-lesen) - Read out ESN CDMA Primary Channel B (up to 5 Bytes (including NULL)) KWP2000: $22 ReadDataByCommonIdentifier $A11B recordCommonIdentifier Modus  : Default
...
- [US_CDMA_SECONDARY_CH_B_LESEN](#job-us-cdma-secondary-ch-b-lesen) - Read out ESN CDMA Secondary Channel B (5 Bytes (including NULL)) KWP2000: $22 ReadDataByCommonIdentifier $A11C recordCommonIdentifier Modus  : Default
...
- [US_AMPS_SID_LESEN](#job-us-amps-sid-lesen) - Read out ESN AMPS SID (up to 6 Bytes (including NULL)) KWP2000: $22 ReadDataByCommonIdentifier $A11D recordCommonIdentifier Modus  : Default
...
- [US_AMPS_PAGING_CH_LESEN](#job-us-amps-paging-ch-lesen) - Read out ESN AMPS PAG (5 Bytes (including NULL)) KWP2000: $22 ReadDataByCommonIdentifier $A11E recordCommonIdentifier Modus  : Default
...
- [NON_TELEMATICS_ECALL_STATUS_LESEN](#job-non-telematics-ecall-status-lesen) - Read out Status of non telematics ECALL (1 Byte) KWP2000: $22 ReadDataByCommonIdentifier $A104 recordCommonIdentifier Modus  : Default
- [BACKUP_BATTERY_STATUS_LESEN](#job-backup-battery-status-lesen) - Read out Backup Battery Status KWP2000: $22 ReadDataByCommonIdentifier $A105 recordCommonIdentifier Modus  : Default
...
- [US_ESN_MIN_LESEN](#job-us-esn-min-lesen) - Read out ESN (8 Bytes) and MIN (10 Bytes) KWP2000: $22 ReadDataByCommonIdentifier $A006 recordCommonIdentifier and $A110 recordCommonIdentifier Modus  : Default
...
Read out the TCU Type KWP2000: $22 ReadDataByCommonIdentifier $3000 recordCommonIdentifier e60_ece/00h/E60 TCU for ECE e60_us /01h/E60 TCU for US e60_japan /02h/E60 TCU for JAPAN e65_ece/03h/E65 TCU for ECE e65_us /04h/E65 TCU for US Modus  : Default
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| FRIENDLY_NAME | string | OKAY, wenn fehlerfrei |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| Name | Type | Comment |
| --- | --- | --- |
| USER_FRIENDLY_NAME | string | User Friendly Name |
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| BT_FIX_PASSKEY | string | OKAY, wenn fehlerfrei |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| NUM_FOUND_DEVICES | int | OKAY, wenn fehlerfrei |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| PAIRING_RESULT | int | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| PAIRING_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| Name | Type | Comment |
| --- | --- | --- |
| BYTE1 | int | OKAY, wenn fehlerfrei id |
| BYTE2 | int | OKAY, wenn fehlerfrei high_byte |
| BYTE3 | int | OKAY, wenn fehlerfrei low_byte |
...
| Name | Type | Comment |
| --- | --- | --- |
| ARG | int | OKAY, wenn fehlerfrei id |
...
| Name | Type | Comment |
| --- | --- | --- |
| BYTE1 | int | OKAY, wenn fehlerfrei Port Pins |
| BYTE2 | int | OKAY, wenn fehlerfrei Port Pins |
...
<a id="job-us-esn-lesen"></a>
### US_ESN_LESEN

Read out ESN (8 Bytes) KWP2000: $22 ReadDataByCommonIdentifier $A006 recordCommonIdentifier Modus  : Default
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| ESN | string | OKAY, wenn fehlerfrei |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |

<a id="job-gmin-null-schreiben"></a>
### GMIN_NULL_SCHREIBEN

CM-42 GMIN NULL SCHREIBEN for South Amerika and Korea KWP2000: $2E WriteDataByCommonId $A110 GMIN Modus  : Default
...
CM-42 ESN MIN KWP2000: $2E WriteDataByCommonId $A110 GMIN Modus  : Default

#### Arguments

| Name | Type | Comment |
| --- | --- | --- |
| GMIN | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
...
Read out ESN GMIN (11 Bytes) KWP2000: $22 ReadDataByCommonIdentifier $A110 recordCommonIdentifier Modus  : Default
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| US_MIN | string | OKAY, wenn fehlerfrei |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |

<a id="job-us-cdma-directory-schreiben"></a>
### US_CDMA_DIRECTORY_SCHREIBEN

CM-42 ESN CDMA Directory No KWP2000: $2E WriteDataByCommonId $A117 CDMA Directory Number Modus  : Default

#### Arguments

| Name | Type | Comment |
| --- | --- | --- |
| CDMA_DIR | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
...
Read out ESN CDMA Directory(11 Bytes (including NULL)) KWP2000: $22 ReadDataByCommonIdentifier $A117 recordCommonIdentifier Modus  : Default
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| CDMA_DIR | string | CDMA Directory |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |

<a id="job-us-sid-nid-schreiben"></a>
### US_SID_NID_SCHREIBEN

CM-42 ESN SIDNID KWP2000: $2E WriteDataByCommonId $A118 SID/NID Modus  : Default
...
Read out ESN SID NID (16 Bytes (including NULL)) KWP2000: $22 ReadDataByCommonIdentifier $A118 recordCommonIdentifier Modus  : Default
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| INDEX | string | OKAY, wenn fehlerfrei |
| SID | string | OKAY, wenn fehlerfrei |
| NID | string | OKAY, wenn fehlerfrei |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| Name | Type | Comment |
| --- | --- | --- |
| CDMA_PA | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
...
Read out ESN CDMA Primary Channel A (up to 5 Bytes (including NULL)) KWP2000: $22 ReadDataByCommonIdentifier $A119 recordCommonIdentifier Modus  : Default
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| CDMA_PA | string | OKAY, wenn fehlerfrei |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| Name | Type | Comment |
| --- | --- | --- |
| CDMA_SA | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
...
Read out ESN CDMA Secondary Channel A (up to 5 Bytes (including NULL)) KWP2000: $22 ReadDataByCommonIdentifier $A11A recordCommonIdentifier Modus  : Default
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| CDMA_SA | string | OKAY, wenn fehlerfrei |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| Name | Type | Comment |
| --- | --- | --- |
| CDMA_PB | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
...
Read out ESN CDMA Primary Channel B (up to 5 Bytes (including NULL)) KWP2000: $22 ReadDataByCommonIdentifier $A11B recordCommonIdentifier Modus  : Default
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| CDMA_PB | string | ESN CDMA Primary Channel B |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| Name | Type | Comment |
| --- | --- | --- |
| CDMA_SB | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
...
Read out ESN CDMA Secondary Channel B (5 Bytes (including NULL)) KWP2000: $22 ReadDataByCommonIdentifier $A11C recordCommonIdentifier Modus  : Default
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| CDMA_SB | string | ESN CDMA Secondary Channel B |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| Name | Type | Comment |
| --- | --- | --- |
| AMPS_SID | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
...
Read out ESN AMPS SID (up to 6 Bytes (including NULL)) KWP2000: $22 ReadDataByCommonIdentifier $A11D recordCommonIdentifier Modus  : Default
...
| Name | Type | Comment |
| --- | --- | --- |
| AMPS_PAG | string | OKAY, wenn fehlerfrei  |
...
Read out ESN AMPS PAG (5 Bytes (including NULL)) KWP2000: $22 ReadDataByCommonIdentifier $A11E recordCommonIdentifier Modus  : Default
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| DEALER_NUM | string | OKAY, wenn fehlerfrei |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| BREAKDOWN_NO | string | OKAY, wenn fehlerfrei |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| HOTLINE_NUM | string | OKAY, wenn fehlerfrei |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| TELEMATICS_STATUS | int | Telematics status |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |

<a id="job-non-telematics-ecall-status-lesen"></a>
### NON_TELEMATICS_ECALL_STATUS_LESEN

Read out Status of non telematics ECALL (1 Byte) KWP2000: $22 ReadDataByCommonIdentifier $A104 recordCommonIdentifier Modus  : Default
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| NON_TELEMATIC_ECALL | int | Status of non telematics ECALL |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |

<a id="job-backup-battery-status-lesen"></a>
### BACKUP_BATTERY_STATUS_LESEN

Read out Backup Battery Status KWP2000: $22 ReadDataByCommonIdentifier $A105 recordCommonIdentifier Modus  : Default
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| BACKUP_BATTERY | int | Backup Battery Status |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| CUSTOMER_CALL_STATUS | int | Customer Calls over NAD with GMIN Status |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| EMERGENCY_NUM | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| GATS_SMSC_NUM | string | OKAY, wenn fehlerfrei |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| PROVIDER_NUM | string | OKAY, wenn fehlerfrei |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| ICC_ID | string | OKAY, wenn fehlerfrei |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| EMERG_DATA_NUM | string | OKAY, wenn fehlerfrei |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| EMERG_VOICE_NUM | string | OKAY, wenn fehlerfrei |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| MAIN_DATA_CALL_NUM | string | OKAY, wenn fehlerfrei |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| MAIN_VOICE_NUM | string | OKAY, wenn fehlerfrei |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
Read out ESN (8 Bytes) and MIN (10 Bytes) KWP2000: $22 ReadDataByCommonIdentifier $A006 recordCommonIdentifier and $A110 recordCommonIdentifier Modus  : Default
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| US_ESN | string | OKAY, wenn fehlerfrei |
| US_MIN | string | OKAY, wenn fehlerfrei |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
- [TCUTYPE_STATUS](#table-tcutype-status) (6 × 2)
...
| 0xFFFF | unbekannter Fehlerort / unknown error message |
