...
| Field | Value |
| --- | --- |
| ECU | Sitz-Pneumatik-Modul hinten rechts mit Gateway |
...
| --- | --- | --- |
| 0x025B00 | Energiesparmode aktiv | 0 |
| 0x025B08 | Codierung: Steuergerät ist nicht codiert | 0 |
| 0x025B09 | Codierung: Fehler bei Codierdatentransaktion aufgetreten | 0 |
| 0x025B0A | Codierung: Signatur der Codierdaten ungültig | 0 |
| 0x025B0B | Codierung: Codierdaten passen nicht zum Fahrzeug | 0 |
| 0x025B0C | Codierung: Unplausible Daten während Codierdatentransaktion | 0 |
| 0x025B0D | Codierung: Codierdaten nicht qualifiziert | 0 |
| 0x025B20 | CAN-Fehler (Sammelfehler) | 0 |
| 0x025B23 | Flash Memory Fehler (Sammelfehler) | 0 |
| 0x025B29 | Softwarefehler (Sammelfehler) | 0 |
| 0x02FF5B | Dummy-Fehlerspeichereintrag im Komponentenfehlerbereich nur für Testzwecke | 1 |
| 0x806C00 | Überspannung erkannt | 1 |
| 0x806C01 | Unterspannung erkannt | 1 |
| 0x806C02 | SPNM_HR: Verbauort unplausibel | 0 |
| 0x806C03 | SPNM Pumpe: Leitungsunterbrechung | 0 |
| 0x806C04 | SPNM Pumpe: Überlast oder Kurzschluss | 0 |
| 0x806C05 | Lordose, obere Blase (Ventil 1): Zieldruck wird nicht erreicht | 0 |
| 0x806C06 | Lordose, untere Blase (Ventil 2): Zieldruck wird nicht erreicht | 0 |
| 0x806C07 | Aktivsitz, linke Blase (Ventil 3): Zieldruck wird nicht erreicht | 0 |
| 0x806C08 | Aktivsitz, rechte Blase (Ventil 4): Zieldruck wird nicht erreicht | 0 |
| 0x806C09 | Massage, Blase 1 (Ventil 5): Zieldruck wird nicht erreicht | 0 |
| 0x806C0A | Massage, Blase 2 (Ventil 6): Zieldruck wird nicht erreicht | 0 |
| 0x806C0B | Massage, Blase 3 (Ventil 7): Zieldruck wird nicht erreicht | 0 |
| 0x806C0C | Massage, Blase 4 (Ventil 8): Zieldruck wird nicht erreicht | 0 |
| 0x806C0D | Massage, Blase 5 (Ventil 9): Zieldruck wird nicht erreicht | 0 |
| 0x806C0E | Massage, Blase 6 (Ventil 10): Zieldruck wird nicht erreicht | 0 |
| 0x806C0F | Rotationsblase mitte links (Ventil 11): Zieldruck wird nicht erreicht | 0 |
| 0x806C10 | Rotationsblase mitte rechts (Ventil 12): Zieldruck wird nicht erreicht | 0 |
| 0x806C11 | Rotationsblase oben rechts (Ventil 13): Zieldruck wird nicht erreicht | 0 |
| 0x806C12 | Rotationsblase oben links (Ventil 14): Zieldruck wird nicht erreicht | 0 |
| 0x806C13 | Taster Lordose: Taster hängt | 0 |
| 0x806C15 | Taster Lordose: Leitungsfehler | 0 |
| 0x806C16 | Taste Massage: Taste hängt | 0 |
| 0x806C17 | SPNM: interner Hardwarefehler (Sammelfehler für Ventile und Drucksensoren) | 0 |
| 0x806C19 | Lordose, obere Blase (Ventil 1): Zieldruck wird zu schnell erreicht | 0 |
| 0x806C1A | Lordose, untere Blase (Ventil 2): Zieldruck wird zu schnell erreicht | 0 |
| 0x806C1B | Aktivsitz, linke Blase (Ventil 3): Zieldruck wird zu schnell erreicht | 0 |
| 0x806C1C | Aktivsitz, rechte Blase (Ventil 4): Zieldruck wird zu schnell erreicht | 0 |
| 0x806C1D | Massage, Blase 1 (Ventil 5): Zieldruck wird zu schnell erreicht | 0 |
| 0x806C1E | Massage, Blase 2 (Ventil 6): Zieldruck wird zu schnell erreicht | 0 |
| 0x806C1F | Massage, Blase 3 (Ventil 7): Zieldruck wird zu schnell erreicht | 0 |
| 0x806C20 | Massage, Blase 4 (Ventil 8): Zieldruck wird zu schnell erreicht | 0 |
| 0x806C21 | Massage, Blase 5 (Ventil 9): Zieldruck wird zu schnell erreicht | 0 |
| 0x806C22 | Massage, Blase 6 (Ventil 10): Zieldruck wird zu schnell erreicht | 0 |
| 0x806C23 | Rotationsblase mitte links (Ventil 11): Zieldruck wird zu schnell erreicht | 0 |
| 0x806C24 | Rotationsblase mitte rechts (Ventil 12): Zieldruck wird zu schnell erreicht | 0 |
| 0x806C25 | Rotationsblase oben rechts (Ventil 13): Zieldruck wird zu schnell erreicht | 0 |
| 0x806C26 | Rotationsblase oben links (Ventil 14): Zieldruck wird zu schnell erreicht | 0 |
| 0x806C27 | SPNM_HR: Verbauort nicht angelernt | 0 |
| 0x806C28 | Temperatur im Steuergerät ausserhalb des Betriebsbereichs | 1 |
| 0x806C29 | Umgebungsdruck ausserhalb des Betriebsbereichs | 1 |
| 0x806C2A | SPNM: Vordruckkanal undicht | 0 |
| 0x806C2B | Drucksensor Vordruckkanal: Druck ausserhalb des zulässigen Bereichs | 1 |
| 0x806C2C | Drucksensor Rotationsblase oben rechts: Druck ausserhalb des zulässigen Bereichs | 1 |
| 0x806C2D | Drucksensor Rotationsblase oben links: Druck ausserhalb des zulässigen Bereichs | 1 |
| 0xDFC468 | BODY-CAN Control Module Bus OFF | 0 |
| 0xDFCBFF | Dummy-Fehlerspeichereintrag im Netzwerkfehlerbereich nur für Testzwecke | 1 |
| 0xDFD400 | Botschaft (0x1A1, Geschwindigkeit Fahrzeug): Ausfall | 1 |
| 0xDFD401 | Botschaft (0x19A, Querbeschleunigung Schwerpunkt): Ausfall | 1 |
| 0xDFD402 | Botschaft (0xAB, Status Crash): Ausfall | 1 |
| 0xDFD403 | Botschaft (0x3C, Zustand Fahrzeug): Ausfall | 1 |
...
| ORT | ORTTEXT | EREIGNIS_DTC |
| --- | --- | --- |
| 0x5B0015 | Ventil  M1 defekt | 0 |
| 0x5B0016 | Ventil  M2 defekt | 0 |
| 0x5B0017 | Ventil  M3 defekt | 0 |
| 0x5B0018 | Ventil  M4 defekt | 0 |
| 0x5B0019 | Ventil  M5 defekt | 0 |
| 0x5B0020 | Ventil  M6 defekt | 0 |
| 0x5B0021 | Ventil  R1 defekt | 0 |
| 0x5B0022 | Ventil  R2 defekt | 0 |
| 0x5B0023 | Ventil  R1 AS2 defekt | 0 |
| 0x5B0024 | Ventil  R2 AS1 defekt | 0 |
| 0x5B0025 | Ventil  LD1 defekt | 0 |
| 0x5B0026 | Ventil  LD2 defekt | 0 |
| 0x5B0027 | Ventil  AS1 defekt | 0 |
| 0x5B0028 | Ventil  AS2 defekt | 0 |
| 0x5B0029 | Drucksensor Umgebungsdruck defekt | 0 |
| 0x5B0030 | Drucksensor Vordruck defekt | 0 |
| 0x5B0031 | Drucksensor Rotationsblase oben rechts defekt | 0 |
| 0x5B0032 | Drucksensor Rotationsblase oben links defekt | 0 |
| 0x5B0033 | Temperatursensor defekt | 0 |
| 0x5B0125 | Codierwert über Grenzwert des Systems | 0 |
| 0xFFFFFF | unbekannter Fehlerort | 0 |
