...
| Field | Value |
| --- | --- |
| ECU | Integrierte Heiz- Klimaautomatik E39 Redesign |
...
- [STEUERN_DME_AC](#job-steuern-dme-ac) - Ansteuern des DME-AC-Signals Der Ausgang kann ein- bzw. ausgeschaltet werden. Vor dem Ansteuern den Job DIAGNOSE_AUFECHT aufrufen Nach dem Ansteuern den Job DIAGNOSE_ENDE aufrufen
- [STEUERN_DME_KO](#job-steuern-dme-ko) - Ansteuern des DME-KO-Signals Der Ausgang kann ein- bzw. ausgeschaltet werden. Vor dem Ansteuern den Job DIAGNOSE_AUFECHT aufrufen Nach dem Ansteuern den Job DIAGNOSE_ENDE aufrufen
...
| AUSSTATTUNG_5 | string | 'Fondraumklappenmotor' '' |
| AUSSTATTUNG_6 | string | 'Drucksensor' '' |
| ALLGEMEIN_1 | string | 'default' 'DME-Schnittstelle konventionell' 'DME-Schnittstelle PWM-Signal' |
| ALLGEMEIN_2 | string | 'Geblaeseautomatik' '' |
| TELEGRAMM | binary | Antworttelegramm |
...
Ansteuern des DME-AC-Signals Der Ausgang kann ein- bzw. ausgeschaltet werden. Vor dem Ansteuern den Job DIAGNOSE_AUFECHT aufrufen Nach dem Ansteuern den Job DIAGNOSE_ENDE aufrufen
...
Ansteuern des DME-KO-Signals Der Ausgang kann ein- bzw. ausgeschaltet werden. Vor dem Ansteuern den Job DIAGNOSE_AUFECHT aufrufen Nach dem Ansteuern den Job DIAGNOSE_ENDE aufrufen
