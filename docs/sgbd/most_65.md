...
| --- | --- |
| ECU | MOST_65 |
| ORIGIN | BMW VS-42 Benoit Blaser |
| REVISION | 0.93 |
| AUTHOR | BMW VS-42 Benoit Blaser, Armin David |
...
| DIAG_ADRESSE | int | Diagnose Adresse des SGs Defaultwert 0x3F ASK_E65 |
...
| F_ORT_NR | long | Wenn keine Kommunikation mit dem Gateway-SG (= Control Display) möglich ist =&gt; 0xFFF1 Wenn keine Kommunikation mit ASK (= Ringbruch) möglich ist =&gt; 0xFFF2 Wenn nach der MOST-Systemanalyse als Ergebnis ein MOST-SG verdächtigt werden kann dann wird der Fehlerort 0xFFF3 ausgegeben Wenn nach der MOST-Systemanalyse als Ergebnis zwei MOST-SG'e verdächtigt werden können dann wird der Fehlerort 0xFFF4 ausgegeben Wenn OPPS/OPS Error_Registry_New verursacht hat =&gt; 0xFFF5 |
...
| HFK_RESET_FD | unsigned char | Reset-Häufigkeit als Zahl für je 5 wirklich gespeicherte Resets im SG wird im Result 1 Reset angezeigt Wertebereich Resets im SG: 0 - 255 Somit Wertebereich für Result: 0 - 51 |
...
| HFK_RESET_CD | unsigned char | Reset-Häufigkeit als Zahl für je 5 wirklich gespeicherte Resets im SG wird im Result 1 Reset angezeigt Wertebereich Resets im SG: 0 - 255 Somit Wertebereich für Result: 0 - 51 |
| HFK_RESET_ANT | unsigned char | Reset-Häufigkeit als Zahl für je 5 wirklich gespeicherte Resets im SG wird im Result 1 Reset angezeigt Wertebereich Resets im SG: 0 - 255 Somit Wertebereich für Result: 0 - 51 |
| HFK_RESET_ASK | unsigned char | Reset-Häufigkeit als Zahl für je 5 wirklich gespeicherte Resets im SG wird im Result 1 Reset angezeigt Wertebereich Resets im SG: 0 - 255 Somit Wertebereich für Result: 0 - 51 |
| HFK_RESET_FBI | unsigned char | Reset-Häufigkeit als Zahl für je 5 wirklich gespeicherte Resets im SG wird im Result 1 Reset angezeigt Wertebereich Resets im SG: 0 - 255 Somit Wertebereich für Result: 0 - 51 |
| HFK_RESET_KOMBI | unsigned char | Reset-Häufigkeit als Zahl für je 5 wirklich gespeicherte Resets im SG wird im Result 1 Reset angezeigt Wertebereich Resets im SG: 0 - 255 Somit Wertebereich für Result: 0 - 51 |
...
| HFK_RESET_SVS | unsigned char | Reset-Häufigkeit als Zahl für je 5 wirklich gespeicherte Resets im SG wird im Result 1 Reset angezeigt Wertebereich Resets im SG: 0 - 255 Somit Wertebereich für Result: 0 - 51 |
| ERROR_NCE_SG_ADR_1 | unsigned char | Steuergeräte-Adresse in der Umweltbedingung 2 vom CCC bzw. Umweltbedingung 1 vom M-ASK Gültiger Wertebereich 0 - 255 Default: 0 (wenn keine Umweltbedingung gespeichert ist) |
| ERROR_NCE_SG_ADR_2 | unsigned char | Steuergeräte-Adresse in der Umweltbedingung 2 vom CCC bzw. Umweltbedingung 1 vom M-ASK Gültiger Wertebereich 0 - 255 Default: 0 (wenn keine Umweltbedingung gespeichert ist) |
| ERROR_NCE_SG_ADR_3 | unsigned char | Steuergeräte-Adresse in der Umweltbedingung 2 vom CCC bzw. Umweltbedingung 1 vom M-ASK Gültiger Wertebereich 0 - 255 Default: 0 (wenn keine Umweltbedingung gespeichert ist) |
| ERROR_REGISTRY_NEW_ADR_1 | unsigned char | Steuergeräte-Adresse in der Umweltbedingung 2 vom CCC bzw. Umweltbedingung 1 vom M-ASK Gültiger Wertebereich 0 - 255 Default: 0 (wenn keine Umweltbedingung gespeichert ist) |
| ERROR_REGISTRY_NEW_ADR_2 | unsigned char | Steuergeräte-Adresse in der Umweltbedingung 2 vom CCC bzw. Umweltbedingung 1 vom M-ASK Gültiger Wertebereich 0 - 255 Default: 0 (wenn keine Umweltbedingung gespeichert ist) |
| ERROR_REGISTRY_NEW_ADR_3 | unsigned char | Steuergeräte-Adresse in der Umweltbedingung 2 vom CCC bzw. Umweltbedingung 1 vom M-ASK Gültiger Wertebereich 0 - 255 Default: 0 (wenn keine Umweltbedingung gespeichert ist) |
| HFK_IPC_OPERATION_CD | unsigned char | Reset-Häufigkeit als Zahl Wertebereich 0 - 255 |
| HFK_IPC_STARTUP_CD | unsigned char | Reset-Häufigkeit als Zahl Wertebereich 0 - 255 |
...
| MOST_FD | char | Rückgabewert = Summe der Verdächtigungen |
...
| MOST_CD | char | Rückgabewert = Summe der Verdächtigungen |
| MOST_ANT | char | Rückgabewert = Summe der Verdächtigungen |
| MOST_ASK | char | Rückgabewert = Summe der Verdächtigungen |
| MOST_FBI | char | Rückgabewert = Summe der Verdächtigungen |
| MOST_KOMBI | char | Rückgabewert = Summe der Verdächtigungen |
| MOST_SVS | char | Rückgabewert = Summe der Verdächtigungen |
...
| ORT | ORTTEXT |
| --- | --- |
| 0xFFF1 | Keine Kommunikation mit Control Display |
