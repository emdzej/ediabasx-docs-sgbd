...
| Field | Value |
| --- | --- |
| ECU | Elektromechanische Aktive Rollstabilisierung hinten |
...
| PWM_W | % | high | unsigned int | - | - | 10.0 | 1.0 | 0.0 | 0.0 | 100.0 | PWM duty cycle für U Phase |
...
| --- | --- | --- |
| 0x020400 | Energiesparmode aktiv | 0 |
| 0x020408 | Codierung: Steuergerät ist nicht codiert | 0 |
| 0x020409 | Codierung: Fehler bei Codierdatentransaktion aufgetreten | 0 |
| 0x02040A | Codierung: Signatur der Codierdaten ungültig | 0 |
| 0x02040B | Codierung: Codierdaten passen nicht zum Fahrzeug | 0 |
| 0x02040C | Codierung: Unplausible Daten während Codierdatentransaktion | 0 |
| 0x02040D | Codierung: Codierdaten nicht qualifiziert | 0 |
| 0x020423 | Flash Memory Fehler (Sammelfehler) | 0 |
| 0x020426 | Hardwarefehler (Sammelfehler) | 0 |
| 0x02FF04 | Dummy-Fehlerspeichereintrag im Komponentenfehlerbereich nur für Testzwecke | 1 |
| 0x483601 | Steuergerät intern - Sammelfehler | 0 |
| 0x48360F | E-Motor Übertemperatur | 0 |
| 0x48361A | Steuergerät intern - Übertemperatur | 0 |
| 0x48361E | E-Motor Sammelfehler | 0 |
| 0x48361F | Spannungsversorgung - Lokale Unterspannung | 0 |
| 0x483621 | Spannungsversorgung - Globale Unterspannung extern | 1 |
| 0x483622 | Spannungsversorgung - Lokale Überspannung | 0 |
| 0x483623 | Spannungsversorgung - Globale Überspannung extern | 1 |
| 0x483625 | Momentensensor - Kommunikationsfehler | 0 |
| 0x483626 | Momentensensor - temporärer Fehler | 0 |
| 0x483627 | Momentensensor - permanenter Fehler | 0 |
| 0x483628 | Aktuator Bruch Stabilisatoren | 0 |
| 0x483629 | Aktuator Stabilisatoren blockiert | 0 |
| 0x48362A | Aktuator Falschverbau | 1 |
| 0x48362B | Momentensensor - Überlast | 1 |
| 0x48362C | Momentensensor - Offset-Fehler | 1 |
| 0x48362D | Steuergerät intern - Sammelfehler SW | 0 |
| 0x48362E | Steuergerät intern - Sammelfehler HW | 0 |
| 0x48362F | Spannungsversorgung – Degradation Unter oder Überspannung extern | 1 |
| 0xCA041F | Flexray:  Physikalischer Busfehler | 0 |
| 0xCA0420 | FLEXRAY Controller Error | 0 |
| 0xCA0487 | FLEXRAY StartUpFailed | 0 |
| 0xCA0BFF | Dummy-Fehlerspeichereintrag im Netzwerkfehlerbereich nur für Testzwecke | 1 |
| 0xCA146C | Botschaftsfehler (Steuerung ARS, ID: CTR_ARS) Checksumme | 1 |
| 0xCA14A9 | Botschaftsfehler (Fehlerspeicher Bordnetz Spannung, ID: ERRM_BN_U) - Timeout | 1 |
| 0xCA14B8 | Botschaftsfehler (Geschwindigkeit Fahrzeug, ID: V_VEH) - Timeout | 1 |
| 0xCA14B9 | Botschaftsfehler (Geschwindigkeit Fahrzeug, ID: V_VEH) - Checksumme | 1 |
| 0xCA14BA | Botschaftsfehler (Geschwindigkeit Fahrzeug, ID: V_VEH) - Alive | 1 |
| 0xCA14BE | Signalfehler (Geschwindigkeit Fahrzeug, ID: V_VEH) - Ungültig | 1 |
| 0xCA14F2 | Botschaftsfehler (Kilometerstand/Reichweite, ID: KILOMETERSTAND) - Timeout | 1 |
| 0xCA14FE | Botschaftsfehler (Steuerung Obergrenze ARS, ID: CTR_UPLIM_ARS) Checksumme | 1 |
| 0xCA14FF | Botschaftsfehler (Zustand Fahrzeug, ID: CON_VEH) Checksumme | 1 |
| 0xCA1562 | Botschaftsfehler (Steuerung ARS, ID: CTR_ARS) Alive | 1 |
| 0xCA1564 | Botschaftsfehler (Steuerung Obergrenze ARS, ID: CTR_UPLIM_ARS) Alive | 1 |
| 0xCA1565 | Botschaftsfehler (Zustand Fahrzeug, ID: CON_VEH) Alive | 1 |
| 0xCA1601 | Botschaftsfehler (Steuerung ARS, ID: CTR_ARS) Timeout | 1 |
| 0xCA160B | Botschaftsfehler (Steuerung Obergrenze ARS, ID: CTR_UPLIM_ARS) Timeout | 1 |
| 0xCA160C | Botschaftsfehler (Zustand Fahrzeug, ID: CON_VEH) Timeout | 1 |
| 0xCA165B | Signalfehler (Steuerung ARS, ID: CTR_ARS) Ungültig | 1 |
| 0xCA165D | Signalfehler (Steuerung Obergrenze ARS, ID: CTR_UPLIM_ARS) Ungültig | 1 |
| 0xCA165E | Signalfehler (Zustand Fahrzeug, ID: CON_VEH) Ungültig | 1 |
| 0xCA1966 | Signalfehler (Status Verbrennungsmotor, ID: ST_CENG) Ungültig | 1 |
| 0xCA19CC | Botschaftsfehler (Status Verbrennungsmotor, ID: ST_CENG) Timeout | 1 |
| 0xCA19DF | Botschaftsfehler (Relativzeit BN2020, ID: RELATIVZEIT) - Timeout | 1 |
| 0xCA1A4B | Botschaftsfehler (Status Verbrennungsmotor, ID: ST_CENG) Alive | 1 |
| 0xCA1A80 | Botschaftsfehler (Status Verbrennungsmotor, ID: ST_CENG) Checksumme | 1 |
| 0xCA1AE9 | Signalfehler (Relativzeit BN2020, ID: RELATIVZEIT) - Ungültig | 1 |
...
| 0x483600 | Steuergerät intern - Endstufentreiber | 0 |
| 0x483602 | Steuergerät intern - Mikrocontroller | 0 |
| 0x483603 | Steuergerät intern - Spannungsversorgung | 0 |
| 0x483604 | Steuergerät intern - Systembasischip | 0 |
| 0x483605 | Steuergerät intern - Temperaturfehler | 0 |
| 0x483606 | Steuergerät intern - Endstufentreiber - GDU Fehler Kurzschluss | 0 |
| 0x483607 | Steuergerät intern - Endstufentreiber - GDU Fehler Unterspannung | 0 |
| 0x483608 | Steuergerät intern - Endstufentreiber - GDU Fehler Temperatur | 0 |
| 0x483609 | Steuergerät intern - Temperaturfehler - Powerboard - Temperatursensor außerhalb des gültigen Bereichs | 0 |
| 0x48360A | Steuergerät intern - Temperaturfehler - Logiktemperatursensor außerhalb des gültigen Bereichs | 0 |
| 0x48360B | Steuergerät intern - Systembasischip - Watchdog | 0 |
| 0x48360C | Steuergerät intern - Systembasischip - F-Mon | 0 |
| 0x48360D | Steuergerät intern - Spannungsversorgung - Interne Spannungsversorgung | 0 |
| 0x48360E | Steuergerät intern - Mikrocontroller - RAM/ROM | 0 |
| 0x483610 | Momentensensor - temporärer Fehler | 0 |
| 0x483611 | Momentensensor - Kommunikationsfehler | 0 |
| 0x483612 | Rotorlagesensorfehler | 0 |
| 0x483613 | Rotorlagesensor - Kommunikation | 0 |
| 0x483614 | Rotorlagesensor - Wertebereich Signal | 0 |
| 0x483615 | Rotorlagesensor - Interner Sensorfehler | 0 |
| 0x483618 | Momentensensor - Interner Fehler - Versorgungsspannung ECU-seitig | 0 |
| 0x483619 | Momentensensor - Versorgungsspannung | 0 |
| 0x48361B | Momentensensor - Interner Fehler - Leitungsbruch | 0 |
| 0x48361C | Steuergerät intern - OS | 0 |
| 0x48361D | E-Motorfehler - Temperatursensor Außerhalb des gültigen Bereichs | 0 |
| 0x4836FF | E-Motorfehler - Detail | 0 |
| 0xFFFFFF | unbekannter Fehlerort | 0 |
...
| _BDM_PARAM | 0x4191 | - | Betriebs Daten Monitor Parameter | - | - | - | - | - | - | - | - | - | 22;2E | ARG_0x4191 | RES_0x4191 |
