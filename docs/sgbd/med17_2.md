...
| --- | --- | --- |
| JOB_STATUS | string | Status Jobausführung (="OKAY" wenn fehlerfrei) |
| STAT_SYSTEMCHECK_TEV_FUNC_WERT | int | Status-Wert der TEV-Diagnose (tesstat) |
| STAT_SYSTEMCHECK_TEV_FUNC_TEXT | string | Text zu tesstat |
| _TEL_AUFTRAG | binary | Hex-Auftrag an SG |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
| STAT_B_FA | int | Wert B_fa |
| STAT_B_FATES | int | Wert B_fates |
| STAT_B_DTEENF | int | Wert B_dteenf |
| STAT_B_DTEEND | int | Wert B_dteend |
...
Dimensions: 231 rows × 12 columns
