...
| STAT_SBE_BELEGT | unsigned int | Status Sitzbelegungserkennung Bit 0-2 unbelegt= 0 belegt  = 1 |
...
| STAT_OC3_KLASSE | unsigned int | Status Sitzbelegungserkennung Bit 2,1,0: Belegung 000: nicht belegt 001: KLASSE 1(Kindersitz) 010: KLASSE 2(5%-Frau) 011: KLASSE 3(50%-Mann) 100: OC3 nicht vorhanden 101: KLASSE 4 (vorgehalten) 111: OC3-Fehler |
| STAT_OC3_KLASSE_1 | unsigned int | Status Sitzbelegungserkennung Klasse 1 |
| STAT_OC3_KLASSE_2 | unsigned int | Status Sitzbelegungserkennung Klasse 2 |
| STAT_OC3_KLASSE_3 | unsigned int | Status Sitzbelegungserkennung Klasse 3 |
| STAT_OC3_KLASSE_4 | unsigned int | Status Sitzbelegungserkennung Klasse 4 |
| STAT_OC3_KLASSE_OC3_NICHT_VORHANDEN | unsigned int | Status Sitzbelegungserkennung OC3 nicht vorhanden |
| STAT_OC3_KLASSE_TEXT | string | 000: nicht belegt 001: KLASSE 1(Kindersitz) 010: KLASSE 2(5%-Frau) 011: KLASSE 3(50%-Mann) 100: OC3 nicht vorhanden 101: KLASSE 4 (vorgehalten) 111: OC3-Fehler |
| STAT_OC3_FEHLER_IM_ODS_SYSTEM | unsigned int | Status Sitzbelegungserkennung Bit 3: Fehler |
| STAT_OC3_FEHLER_IM_ODS_DATENSPEICHER | unsigned int | Status Sitzbelegungserkennung Bit 4: Fehler |
| STAT_OC3_FEHLER_ODS_NICHT_FREIGEGEBEN | unsigned int | Status Sitzbelegungserkennung Bit 5: ODS nicht freigegeben |
| STAT_OC3_FEHLER_KOMMUNIKATIONSFEHLER | unsigned int | Status Sitzbelegungserkennung Bit 6: Kommunikationsfehler |
| STAT_OC3_FEHLER_BELEGUNG_UNDEFINIERT | unsigned int | Status Sitzbelegungserkennung Bit 7: Belegung undefiniert |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_FREIGABE | int | 0: System freigegeben 1: System nicht freigegeben -1: n.v. |
| STAT_FEHLER | int | OC3 Fehler-Status 0: kein Fehler 1: OC3-Fehler -1: n.v. |
| STAT_DATENSPEICHER | int | OC3 Datenspeicher-Status 0: kein Fehler 1: Fehler OC3-Datenspeicher -1: n.v. |
...
| Name | Type | Comment |
| --- | --- | --- |
| STAT_ZK1_AKTIV | int | 0=ZK1_NICHT_AKTIV 1=ZK1_AKTIV Gurtstrammer Beifahrer |
| STAT_ZK2_AKTIV | int | 0=ZK2_NICHT_AKTIV 1=ZK2_AKTIV Aktive Kopfstuetze Beifahrer |
...
| ORT | ORTTEXT |
| --- | --- |
| 0x97a8 | Watchdog-Reset uP |
| 0x97a9 | Clock-Monitor-Reset uP |
| 0x97aa | Illegal Opcode uP |
| 0x97ab | Falsche Fahrgestellnummer |
| 0x97ac | Systemzeitfehler |
| 0x97ad | Timeout ID 01H (STVL) |
| 0x97ae | Timeout ID 02H |
| 0x97af | Timeout ID 03H (STVR) |
| 0x97b0 | Timeout ID 04H |
| 0x97b1 | Timeout ID 05H (SBSL) |
| 0x97b2 | Timeout ID 06H (SASL) |
| 0x97b3 | Timeout ID 07H (SBSR) |
| 0x97b4 | Timeout ID 08H (SASR) |
| 0x97b5 | Timeout ID 09H (SFZ) |
| 0x97b6 | Timeout ID 0AH (SIM) |
| 0x97b7 | Timeout ID 0BH (SASL) |
| 0x97b8 | Timeout ID 0CH (SASR) |
| 0x97b9 | Timeout ID 0DH (SFZ) |
| 0x97ba | Timeout ID 0EH |
| 0x97bb | Timeout ID 0FH |
| 0x97bc | Timeout ID 20H (SSFA) |
| 0x97bd | Timeout ID 21H (SSBF) |
| 0x97be | Timeout ID 22H (SSH) |
| 0x97bf | Timeout ID 71H (SIM) |
| 0x97c0 | Codierdaten Checksummenfehler |
| 0x97c1 | Stack Overflow |
| 0x97c2 | PDC_3 : zu wenig Telegramme |
| 0x97c3 | PDC_3 : Datenfehler in Telegramm |
| 0x97c4 | PDC_3 : Uebertragungsfehler |
| 0x97c5 | unplausible Crash-Schwere |
| 0x97c6 | Kurzschluss oder Unterbrechung H/L-Side-Schalter ZK1 |
| 0x97c7 | Kurzschluss ZK1 nach Masse |
| 0x97c8 | Kurzschluss ZK1 nach Plus |
| 0x97c9 | Widerstand Zuendpille ZK1 zu klein |
| 0x97ca | Widerstand Zuendpille ZK1 zu gross |
| 0x97cb | Widerstand Zuendpille ZK1 nicht gemessen |
| 0x97cc | Unterbrechung ZK1 |
| 0x97cd | Spannung ZK1 n.i.O. |
| 0x97ce | Zuendkapazitaet ZK1 n.i.O. |
| 0x97cf | Codierung/Konfiguration ZK1 unstimmig |
| 0x97d0 | Unterbrechung Entladekreis ZK1 |
| 0x97d1 | Kurzschluss oder Unterbrechung H/L-Side-Schalter ZK2 |
| 0x97d2 | Kurzschluss ZK2 nach Masse |
| 0x97d3 | Kurzschluss ZK2 nach Plus |
| 0x97d4 | Widerstand Zuendpille ZK2 zu klein |
| 0x97d5 | Widerstand Zuendpille ZK2 zu gross |
| 0x97d6 | Widerstand Zuendpille ZK2 nicht gemessen |
| 0x97d7 | Unterbrechung ZK2 |
| 0x97d8 | Spannung ZK2 n.i.O. |
| 0x97d9 | Zuendkapazitaet ZK2 n.i.O. |
| 0x97da | Codierung/Konfiguration ZK2 unstimmig |
| 0x97db | Unterbrechung Entladekreis ZK2 |
| 0x97dc | Gurtschlossschalter 1 Kurzschluss |
| 0x97dd | Gurtschlossschalter 1 Unterbrechung |
| 0x97de | Fehler im Alarmpfad |
| 0x97df | Kommunikationsstoerung OC3 |
| 0x97e0 | OC3 Fehler im ODS-System aktiv |
| 0x97e1 | OC3 Fehler im ODS Datenspeicher |
| 0x97e2 | OC3 ODS System nicht freigegeben |
| 0x97e3 | Entladen der Beifahrerairbags fehlerhaft |
| 0x97e4 | OC3 Vorlast |
| 0x97fc | Protokollfehler SBE1 |
| 0x97fd | Unterbrechung SBE1 |
| 0x97fe | Kurzschluss SBE1 |
| 0x97ff | Kommunikationsstoerung SBE1 |
| 0x9800 | Algorithmus-Parameter inkonsistent |
| 0x9801 | EAM-Parameter inkonsistent |
| 0x9802 | Zuendversuch erfolgt |
| 0x9803 | COP-Watchdog fehlerhaft |
| 0x9804 | Kurzschluss oder Unterbrechung Low-Side-Schalter ZK1 |
| 0x9805 | Kurzschluss oder Unterbrechung High-Side-Schalter ZK1 |
| 0x9806 | Kurzschluss oder Unterbrechung Low-Side-Schalter ZK2 |
| 0x9807 | Kurzschluss oder Unterbrechung High-Side-Schalter ZK2 |
| 0x9812 | Kommunikation mit Zuend-IC gestoert |
| 0x9813 | Energiesparmode aktiv |
| 0x9814 | Hallschalter:Kurzschluss |
| 0x9815 | Hallschalter:unplausibler Messwert |
| 0x9816 | Hallschalter:Unterbrechung |
| 0x9817 | Spannungsueberwachung ASE unterer Grenzwert unterschritten |
| 0x9818 | Spannungsueberwachung ASE oberer Grenzwert ueberschritten |
| 0x9819 | Codierung unvollstaendig |
...
| ORT | ORTTEXT |
| --- | --- |
| 0x9808 | Power-On-Reset uP |
| 0x9809 | Diagnose S/E-Modul (Lichtleistung) |
| 0x980a | SI-Bus: Uebertragungsfehler, CRC-Fehler ERRIF |
| 0x980b | SI-Bus: Uebertragungsfehler, Formatfehler ILLPIF |
| 0x980c | SI-Bus: Synchronisierungspuls zu frueh SYNEIF |
| 0x980d | SI-Bus: Synchronisierung verloren SYNLIF |
| 0x980e | SI-Bus: Slotmismatch, Timingfehler SLMMIF |
| 0x980f | SI-Bus: FIFO-Ueberlauf OVRNIF |
| 0x9810 | Unterspannung OCE |
| 0x9811 | EMV-Fehler im Zuend-Ic |
| 0x???? | unbekannter Fehlerort |
