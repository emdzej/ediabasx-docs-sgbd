...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_MCPB_TEMP_INVERTER_PHASE_A_WERT | 0x1C27 | STAT_MCPB_TEMP_INVERTER_PHASE_A_WERT | MCPB Temperatur IGBT Modul Phase A (-40-215°C) | °C | TEMP_INVERTER_PHASE_A | - | unsigned char | - | 1 | - | -40 | - | 22 | - | - |
| STAT_MCPB_TEMP_INVERTER_PHASE_B_WERT | 0x1C29 | STAT_MCPB_TEMP_INVERTER_PHASE_B_WERT | MCPB Temperatur IGBT Modul Phase B (-40-215°C) | °C | TEMP_INVERTER_PHASE_B | - | unsigned char | - | 1 | - | -40 | - | 22 | - | - |
| STAT_MCPB_TEMP_INVERTER_PHASE_C_WERT | 0x1C2B | STAT_MCPB_TEMP_INVERTER_PHASE_C_WERT | MCPB Temperatur IGBT Modul Phase C (-40-215°C) | °C | TEMP_INVERTER_PHASE_C | - | unsigned char | - | 1 | - | -40 | - | 22 | - | - |
| STAT_MCPB_VOLTAGE_MIDPACK_WERT | 0x1C46 | STAT_MCPB_VOLTAGE_MIDPACK_WERT | Motor B Isolationsmessung Spannung (0-765V) | V | MIDPACK_VOLTAGE | - | unsigned char | - | 3 | - | - | - | 22 | - | - |
| STAT_MCPB_TEMP_WERT | 0x2828 | STAT_MCPB_TEMP_WERT | Temperatur E-Motor (-40-215°C) | °C | MOT_TEMP | - | unsigned char | - | 1 | - | -40 | - | 22 | - | - |
| STAT_MCPB_CURRENT_COMMANDED_WERT | 0x282A | STAT_MCPB_CURRENT_COMMANDED_WERT | E-Motor Sollstrom (-512-508A) | A | CURRENT_COMMANDED | - | char | - | 4 | - | - | - | 22 | - | - |
| STAT_MCPB_CURRENT_PHASE_A_WERT | 0x2832 | STAT_MCPB_CURRENT_PHASE_A_WERT | Motor Phase A RMS Strom (-512-508A RMS) | A | CURRENT_PHASE_A | - | char | - | 4 | - | - | - | 22 | - | - |
| STAT_MCPB_CURRENT_PHASE_B_WERT | 0x2836 | STAT_MCPB_CURRENT_PHASE_B_WERT | Motor Phase B RMS Strom (-512-508A RMS) | A | CURRENT_PHASE_B | - | char | - | 4 | - | - | - | 22 | - | - |
| STAT_MCPB_CURRENT_PHASE_C_WERT | 0x283A | STAT_MCPB_CURRENT_PHASE_C_WERT | Motor Phase C RMS Strom (-512-508A RMS) | A | CURRENT_PHASE_C | - | char | - | 4 | - | - | - | 22 | - | - |
| STAT_MCPB_TORQUE_COMMANDED_WERT | 0x2842 | STAT_MCPB_TORQUE_COMMANDED_WERT | Motor B Sollmoment (-512-508 Nm) | Nm | TORQUE_COMMANDED | - | char | - | 4 | - | - | - | 22 | - | - |
| STAT_MCPB_TORQUE_WERT | 0x2844 | STAT_MCPB_TORQUE_WERT | Motor B Istmoment (-512-508 Nm) | Nm | TORQUE | - | char | - | 4 | - | - | - | 22 | - | - |
| STAT_MCPB_SPEED_WERT | 0x284C | STAT_MCPB_SPEED_WERT | Motor B Drehzahl (-32768-32767 rpm) | 1/min | SPEED | high | int | - | 1 | - | - | - | 22 | - | - |
| STAT_MCPB_RESOLVER_POSITION_WERT | 0x284E | STAT_MCPB_RESOLVER_POSITION_WERT | Motor B Positionssensor Istwert (0-510°) | ° | RESOLVER_POSITION | - | unsigned char | - | 2 | - | - | - | 22 | - | - |
| STAT_MCPB_RESOLVER_OFFSET_WERT | 0x2850 | STAT_MCPB_RESOLVER_OFFSET_WERT | Motor B Positionssensor Korrekturwert (-32-31,75°) | ° | RESOLVER_OFFSET | - | char | - | 0.25 | - | - | - | 22 | - | - |
