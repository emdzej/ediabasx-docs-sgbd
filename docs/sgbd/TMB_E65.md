...
| Field | Value |
| --- | --- |
| ECU | Tuermodul Beifahrertuer E65 |
...
- [STEUERN_ASP_AUS](#job-steuern-asp-aus) - bis i6.103: KWP2000: $3D WriteMemoryByAddress $004E Kodierungsinformation ASP alle ASP Kodierungen werden bis zum SG Reset ausschalten (Memory, Hzg., Beikl., Bordstein.) ab  i6.121: KWP2000: $31 StartRoutineByLocalIdentifier $FC Application diagnostics routines $15 AspHeizungAus Heizung bleibt bis zum SG Reset ausgeschalten! Modus  : Default
...
| STAT_ASP_POTI_VOLTAGE | int | Spannung für Spiegelpotentiometer (digits) |
| STAT_ASP_POTI_VOLTAGE_WERT | int | Spannung für Spiegelpotentiometer (gerundet) |
| STAT_ASP_POTI_VOLTAGE_REAL_WERT | real | Spannung für Spiegelpotentiometer in Volt Auflösung 0.02 V/Bit |
| STAT_ASP_POTI_VOLTAGE_EINH | string | Volt |
| STAT_ASP_POSVERT | int | Spiegelposition vertikal (digits) |
| STAT_ASP_POSVERT_WERT | int | Spiegelposition vertikal (gerundet) Auflösung 0.02 V/Bit |
| STAT_ASP_POSVERT_REAL_WERT | real | Spiegelposition vertikal in Volt Auflösung 0.02 V/Bit |
| STAT_ASP_POSHOR | int | Spiegelposition horizontal (digits) |
| STAT_ASP_POSHOR_WERT | int | Spiegelposition horizontal (gerundet) Auflösung 0.02 V/Bit |
| STAT_ASP_POSHOR_REAL_WERT | real | Spiegelposition horizontal in Volt Auflösung 0.02 V/Bit |
| STAT_ASP_POS_EINH | string | Volt |
| STAT_SR1_CURRENT | int | Aussenspiegel Beiklappen Laufstrom (digits) |
| STAT_SR1_CURRENT_WERT | int | Aussenspiegel Beiklappen Laufstrom (gerundet) |
| STAT_SR1_CURRENT_REAL_WERT | real | Aussenspiegel Beiklappen Laufstrom in Ampere Auflösung 0.0228 A/Bit |
| STAT_SR1_CURRMAX | int | Aussenspiegel Beiklappen Anlaufstrom (digits) |
| STAT_SR1_CURRMAX_WERT | int | Aussenspiegel Beiklappen Anlaufstrom (gerundet) |
| STAT_SR1_CURRMAX_REAL_WERT | real | Aussenspiegel Beiklappen Anlaufstrom in Ampere Auflösung 0.0228 A/Bit Wert bleibt bis nächsten Klappen stehen Kann durch STEUERGERAETE_RESET zurückgesetzt werden |
...
| STAT_MEM | int | (letzte) Speicherposition für Spiegelmemory (CAN-Empfang) iO-Bereich 1...12 |
...
<a id="job-steuern-asp-aus"></a>
### STEUERN_ASP_AUS

bis i6.103: KWP2000: $3D WriteMemoryByAddress $004E Kodierungsinformation ASP alle ASP Kodierungen werden bis zum SG Reset ausschalten (Memory, Hzg., Beikl., Bordstein.) ab  i6.121: KWP2000: $31 StartRoutineByLocalIdentifier $FC Application diagnostics routines $15 AspHeizungAus Heizung bleibt bis zum SG Reset ausgeschalten! Modus  : Default
