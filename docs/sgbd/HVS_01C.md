...
| Field | Value |
| --- | --- |
| ECU | Hochvoltspeicher, inkompatible Änderung |
| ORIGIN | BMW_AG EA-441 Michael_Binder |
| REVISION | 0.003 |
...
- [ARG_0XA228_R](#table-arg-0xa228-r) (2 × 14)
- [ARG_0XE49C_D](#table-arg-0xe49c-d) (1 × 12)
- [ARG_0XE4CB_D](#table-arg-0xe4cb-d) (3 × 12)
...
- [RES_0XA228_R](#table-res-0xa228-r) (7 × 13)
...
- [RES_0XE49A_D](#table-res-0xe49a-d) (12 × 10)
- [RES_0XE49B_D](#table-res-0xe49b-d) (12 × 10)
...
- [RES_0XE4CA_D](#table-res-0xe4ca-d) (18 × 10)
- [RES_0XE4CC_D](#table-res-0xe4cc-d) (81 × 10)
- [RES_0XE4CD_D](#table-res-0xe4cd-d) (20 × 10)
- [RES_0XE4CE_D](#table-res-0xe4ce-d) (20 × 10)
- [RES_0XE4CF_D](#table-res-0xe4cf-d) (80 × 10)
- [RES_0XE4D3_D](#table-res-0xe4d3-d) (2 × 10)
- [RES_0XE4D4_D](#table-res-0xe4d4-d) (32 × 10)
...
- [RES_0XE577_D](#table-res-0xe577-d) (189 × 10)
- [RES_0XE578_D](#table-res-0xe578-d) (189 × 10)
- [RES_0XE579_D](#table-res-0xe579-d) (324 × 10)
- [RES_0XE57A_D](#table-res-0xe57a-d) (110 × 10)
- [RES_0XE57B_D](#table-res-0xe57b-d) (110 × 10)
...
- [SG_FUNKTIONEN](#table-sg-funktionen) (134 × 16)
- [TAB_AUFSTART_VERHINDERER](#table-tab-aufstart-verhinderer) (4 × 2)
- [TAB_CRASH_ERKENNUNG](#table-tab-crash-erkennung) (5 × 2)
- [TAB_EAN_BTRV_BAUTEIL_TYP](#table-tab-ean-btrv-bauteil-typ) (19 × 2)
- [TAB_EAN_BTRV_VORGANG](#table-tab-ean-btrv-vorgang) (4 × 2)
...
- [TAB_HVS_SYMMETRIERMODUS](#table-tab-hvs-symmetriermodus) (6 × 2)
- [TAB_KRITERIUM_EOD](#table-tab-kriterium-eod) (3 × 2)
...
- [TAB_NBA_STATUS](#table-tab-nba-status) (10 × 2)
...
- [TAB_SOH_MAN](#table-tab-soh-man) (3 × 2)
...
| ARG | STR | STPR | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | MIN | MAX | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ARG_EAN_BTRV_DATENSATZ | + | - | - | high | unsigned char | - | - | 1.0 | 1.0 | 0.0 | 0.0 | 255.0 | Argument, welcher BTRV-Datensatz im Haupt-SG angesprochen wird. Position 0 ist immer für die Daten des Haupt-SGs zu verwenden [1 Byte Zähler]. |
| ARG_EAN_BTRV_VORGANG | + | - | 0-n | high | unsigned char | - | TAB_EAN_BTRV_VORGANG | - | - | - | - | - | Argument, welcher Vorgang auf dem gewählten BTRV-Datensatz ausgeführt werden soll (Lesen/Schreiben/Löschen) [1 Byte Diskret]. |

<a id="table-arg-0xe49c-d"></a>
### ARG_0XE49C_D
...
| ARG | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | MIN | MAX | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| MOD_MAN | 0-n | high | unsigned char | - | TAB_SOH_MAN | - | - | - | - | - | Art der Manipulation (1: Speicher 2: Modul 3: Zelle) |
| IDX_MAN | - | high | unsigned char | - | - | 1.0 | 1.0 | 0.0 | - | - | Index der Manipulation (1 bei Speicher, sonst Modul bzw. Zellindex) |
| PCT_MAN | % | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | - | - | Manipulationswert des SoH |
...
Dimensions: 562 rows × 4 columns

| ORT | ORTTEXT | EREIGNIS_DTC | FEHLERKLASSE |
| --- | --- | --- | --- |
| 0x020700 | Energiesparmode aktiv | 0 | - |
| 0x020708 | Codierung: Steuergerät ist nicht codiert | 0 | - |
| 0x020709 | Codierung: Codierdaten passen nicht zum Fahrzeug | 0 | - |
| 0x02070A | Codierung: Codierdaten nicht qualifiziert | 0 | - |
| 0x020724 | NVM_E_HARDWARE | 0 | - |
| 0x020736 | SecOC: Freshness Value Synchronisation fehlgeschlagen | 0 | - |
| 0x020740 | Spannungsversorgung - Lokale Unterspannung | 0 | - |
| 0x020741 | Spannungsversorgung - Lokale Überspannung | 0 | - |
| 0x020780 | ZERTIFIKATE_UND_BINDINGS_TYP1_WERK_NICHT_BEREIT | 0 | - |
| 0x020781 | ONLINE_ZERTIFIKATE_UND_BINDINGS_TYP2_NICHT_BEREIT | 0 | - |
| 0x020782 | Secure Feature Activation: Tokenprüfung fehlgeschlagen | 0 | - |
| 0x020783 | Secure Feature Activation: Tokenprüfung läuft aktuell oder ungeprüfte Tokens sind gespeichert | 0 | - |
| 0x020784 | Locking Configuration Switch: Einer oder mehrere Schalter nicht gesetzt. | 0 | - |
| 0x020785 | Secure ECU Modes: ECU not in field mode. | 0 | - |
| 0x020790 | SecOC: Keypackprüfung fehlgeschlagen | 0 | - |
| 0x020791 | SecOC: Bypass aktiv - Sichere Onboard Kommunikation deaktivert | 0 | - |
| 0x02FF07 | Dummy-Fehlerspeichereintrag im Komponentenfehlerbereich nur für Testzwecke | 1 | - |
| 0x21F00D | Speicher - Kühlventil - Kurzschluss nach Masse | 0 | - |
| 0x21F00E | Speicher - Kühlventil - Kurzschluss nach Plus | 0 | - |
| 0x21F00F | Speicher - Kühlventil - offene Leitung | 0 | - |
| 0x21F010 | Speicher - Kühlventil - Treiberfehler | 0 | - |
| 0x21F028 | U/I-Sensor - HV-Strom - Sicherheitsgrenze oben verletzt | 0 | - |
| 0x21F02C | U/I-Sensor - HV-Strom - Sicherheitsgrenze unten verletzt | 0 | - |
| 0x21F04B | Battery Management Unit (BMU) - FUSI - Selbst-Reset ausgelöst | 0 | - |
| 0x21F05D | U/I-Sensor - HV-Strom - Offene Leitung | 0 | - |
| 0x21F05E | U/I-Sensor - HV-Strom - Oberer Schwellenwert überschritten | 0 | - |
| 0x21F05F | U/I-Sensor - HV-Strom - Unterer Schwellenwert unterschritten | 0 | - |
| 0x21F061 | Speichermodul 01 - Bauteilschutz - Spannung - Sicherheitsgrenze oben verletzt | 0 | - |
| 0x21F062 | Speichermodul 01 - Bauteilschutz - Spannung - Sicherheitsgrenze unten verletzt | 0 | - |
| 0x21F063 | Speichermodul 02 - Bauteilschutz - Spannung - Sicherheitsgrenze oben verletzt | 0 | - |
| 0x21F064 | Speichermodul 02 - Bauteilschutz - Spannung - Sicherheitsgrenze unten verletzt | 0 | - |
| 0x21F065 | Speichermodul 03 - Bauteilschutz - Spannung - Sicherheitsgrenze oben verletzt | 0 | - |
| 0x21F066 | Speichermodul 03 - Bauteilschutz - Spannung - Sicherheitsgrenze unten verletzt | 0 | - |
| 0x21F067 | Speichermodul 04 - Bauteilschutz - Spannung - Sicherheitsgrenze oben verletzt | 0 | - |
| 0x21F068 | Speichermodul 04 - Bauteilschutz - Spannung - Sicherheitsgrenze unten verletzt | 0 | - |
| 0x21F069 | Speichermodul 05 - Bauteilschutz - Spannung - Sicherheitsgrenze oben verletzt | 0 | - |
| 0x21F06A | Speichermodul 05 - Bauteilschutz - Spannung - Sicherheitsgrenze unten verletzt | 0 | - |
| 0x21F06B | Speichermodul 06 - Bauteilschutz - Spannung - Sicherheitsgrenze oben verletzt | 0 | - |
| 0x21F06C | Speichermodul 06 - Bauteilschutz - Spannung - Sicherheitsgrenze unten verletzt | 0 | - |
| 0x21F06D | Speichermodul 07 - Bauteilschutz - Spannung - Sicherheitsgrenze oben verletzt | 0 | - |
| 0x21F06E | Speichermodul 07 - Bauteilschutz - Spannung - Sicherheitsgrenze unten verletzt | 0 | - |
| 0x21F06F | Speichermodul 08 - Bauteilschutz - Spannung - Sicherheitsgrenze oben verletzt | 0 | - |
| 0x21F070 | Speichermodul 08 - Bauteilschutz - Spannung - Sicherheitsgrenze unten verletzt | 0 | - |
| 0x21F071 | Speichermodul 09 - Bauteilschutz - Spannung - Sicherheitsgrenze oben verletzt | 0 | - |
| 0x21F072 | Speichermodul 09 - Bauteilschutz - Spannung - Sicherheitsgrenze unten verletzt | 0 | - |
| 0x21F073 | Speichermodul 10 - Bauteilschutz - Spannung - Sicherheitsgrenze oben verletzt | 0 | - |
| 0x21F074 | Speichermodul 10 - Bauteilschutz - Spannung - Sicherheitsgrenze unten verletzt | 0 | - |
| 0x21F075 | Speichermodul 11 - Bauteilschutz - Spannung - Sicherheitsgrenze oben verletzt | 0 | - |
| 0x21F076 | Speichermodul 11 - Bauteilschutz - Spannung - Sicherheitsgrenze unten verletzt | 0 | - |
| 0x21F077 | Speichermodul 12 - Bauteilschutz - Spannung - Sicherheitsgrenze oben verletzt | 0 | - |
| 0x21F078 | Speichermodul 12 - Bauteilschutz - Spannung - Sicherheitsgrenze unten verletzt | 0 | - |
| 0x21F081 | Speichermodul 01 - Temperatursensoren - Oberer Schwellenwert überschritten - (Sicherheitsgrenze) | 0 | - |
| 0x21F083 | Speichermodul 02 - Temperatursensoren - Oberer Schwellenwert überschritten - (Sicherheitsgrenze) | 0 | - |
| 0x21F085 | Speichermodul 03 - Temperatursensoren - Oberer Schwellenwert überschritten - (Sicherheitsgrenze) | 0 | - |
| 0x21F087 | Speichermodul 04 - Temperatursensoren - Oberer Schwellenwert überschritten - (Sicherheitsgrenze) | 0 | - |
| 0x21F089 | Speichermodul 05 - Temperatursensoren - Oberer Schwellenwert überschritten - (Sicherheitsgrenze) | 0 | - |
| 0x21F08B | Speichermodul 06 - Temperatursensoren - Oberer Schwellenwert überschritten - (Sicherheitsgrenze) | 0 | - |
| 0x21F08D | Speichermodul 07 - Temperatursensoren - Oberer Schwellenwert überschritten - (Sicherheitsgrenze) | 0 | - |
| 0x21F08F | Speichermodul 08 - Temperatursensoren - Oberer Schwellenwert überschritten - (Sicherheitsgrenze) | 0 | - |
| 0x21F091 | Speichermodul 09 - Temperatursensoren - Oberer Schwellenwert überschritten - (Sicherheitsgrenze) | 0 | - |
| 0x21F093 | Speichermodul 10 - Temperatursensoren - Oberer Schwellenwert überschritten - (Sicherheitsgrenze) | 0 | - |
| 0x21F095 | Speichermodul 11 - Temperatursensoren - Oberer Schwellenwert überschritten - (Sicherheitsgrenze) | 0 | - |
| 0x21F097 | Speichermodul 12 - Temperatursensoren - Oberer Schwellenwert überschritten - (Sicherheitsgrenze) | 0 | - |
| 0x21F0C1 | CSC - Symmetrierschaltung - Temperatursensor - ausgefallen | 0 | - |
| 0x21F0C2 | Speichermodul 01 - Spannungssensoren - Offene Leitung | 0 | - |
| 0x21F0C3 | Speichermodul 02 - Spannungssensoren - Offene Leitung | 0 | - |
| 0x21F0C4 | Speichermodul 03 - Spannungssensoren - Offene Leitung | 0 | - |
| 0x21F0C5 | Speichermodul 04 - Spannungssensoren - Offene Leitung | 0 | - |
| 0x21F0C6 | Speichermodul 05 - Spannungssensoren - Offene Leitung | 0 | - |
| 0x21F0C7 | Speichermodul 06 - Spannungssensoren - Offene Leitung | 0 | - |
| 0x21F0C8 | Speichermodul 07 - Spannungssensoren - Offene Leitung | 0 | - |
| 0x21F0C9 | Speichermodul 08 - Spannungssensoren - Offene Leitung | 0 | - |
| 0x21F0CA | Speichermodul 09 - Spannungssensoren - Offene Leitung | 0 | - |
| 0x21F0CB | Speichermodul 10 - Spannungssensoren - Offene Leitung | 0 | - |
| 0x21F0CC | Speichermodul 11 - Spannungssensoren - Offene Leitung | 0 | - |
| 0x21F0CD | Speichermodul 12 - Spannungssensoren - Offene Leitung | 0 | - |
| 0x21F0E3 | Speichermodul 01 - Temperatursensoren - Offene Leitung | 0 | - |
| 0x21F0E4 | Speichermodul 02 - Temperatursensoren - Offene Leitung | 0 | - |
| 0x21F0E5 | Speichermodul 03 - Temperatursensoren - Offene Leitung | 0 | - |
| 0x21F0E6 | Speichermodul 04 - Temperatursensoren - Offene Leitung | 0 | - |
| 0x21F0E7 | Speichermodul 05 - Temperatursensoren - Offene Leitung | 0 | - |
| 0x21F0E8 | Speichermodul 06 - Temperatursensoren - Offene Leitung | 0 | - |
| 0x21F0E9 | Speichermodul 07 - Temperatursensoren - Offene Leitung | 0 | - |
| 0x21F0EA | Speichermodul 08 - Temperatursensoren - Offene Leitung | 0 | - |
| 0x21F0EB | Speichermodul 09 - Temperatursensoren - Offene Leitung | 0 | - |
| 0x21F0EC | Speichermodul 10 - Temperatursensoren - Offene Leitung | 0 | - |
| 0x21F0ED | Speichermodul 11 - Temperatursensoren - Offene Leitung | 0 | - |
| 0x21F0EE | Speichermodul 12 - Temperatursensoren - Offene Leitung | 0 | - |
| 0x21F10F | Battery Management Unit (BMU) - FUSI - Aktive Zwischenkreisentladung - fehlerhaft | 0 | - |
| 0x21F115 | Schütze - Hauptschütz HV-Minus - Schütz dauerhaft offen | 0 | - |
| 0x21F116 | Schütze - Hauptschütz HV-Minus - Schütz dauerhaft geschlossen | 0 | - |
| 0x21F117 | Schütze - Hauptschütz HV-Plus - Schütz dauerhaft geschlossen | 0 | - |
| 0x21F118 | Schütze - Hauptschütz HV-Plus - Schütz dauerhaft offen | 0 | - |
| 0x21F11A | Schütze - Vorladeschütz HV-Plus - Schütz dauerhaft offen | 0 | - |
| 0x21F11C | U/I-Sensor - HV-Strom - Leitungsschutzgrenze verletzt | 0 | - |
| 0x21F11E | U/I-Sensor - HV-Strom - Betriebsgrenze unten verletzt | 0 | - |
| 0x21F11F | U/I-Sensor - HV-Strom - Betriebsgrenze oben verletzt | 0 | - |
| 0x21F120 | Battery Management Unit (BMU) - Interne Uhr ausgefallen | 0 | - |
| 0x21F121 | Battery Management Unit (BMU) - Interne Weckfunktion defekt | 0 | - |
| 0x21F122 | Speichermodul 01 - Bauteilschutz - Spannung - Betriebsgrenze oben verletzt | 0 | - |
| 0x21F123 | Speichermodul 02 - Bauteilschutz - Spannung - Betriebsgrenze oben verletzt | 0 | - |
| 0x21F124 | Speichermodul 03 - Bauteilschutz - Spannung - Betriebsgrenze oben verletzt | 0 | - |
| 0x21F125 | Speichermodul 04 - Bauteilschutz - Spannung - Betriebsgrenze oben verletzt | 0 | - |
| 0x21F126 | Speichermodul 05 - Bauteilschutz - Spannung - Betriebsgrenze oben verletzt | 0 | - |
| 0x21F127 | Speichermodul 06 - Bauteilschutz - Spannung - Betriebsgrenze oben verletzt | 0 | - |
| 0x21F128 | Speichermodul 07 - Bauteilschutz - Spannung - Betriebsgrenze oben verletzt | 0 | - |
| 0x21F129 | Speichermodul 08 - Bauteilschutz - Spannung - Betriebsgrenze oben verletzt | 0 | - |
| 0x21F12A | Speichermodul 09 - Bauteilschutz - Spannung - Betriebsgrenze oben verletzt | 0 | - |
| 0x21F12B | Speichermodul 10 - Bauteilschutz - Spannung - Betriebsgrenze oben verletzt | 0 | - |
| 0x21F12C | Speichermodul 11 - Bauteilschutz - Spannung - Betriebsgrenze oben verletzt | 0 | - |
| 0x21F12D | Speichermodul 12 - Bauteilschutz - Spannung - Betriebsgrenze oben verletzt | 0 | - |
| 0x21F12E | Speichermodul 13 - Bauteilschutz - Spannung - Betriebsgrenze oben verletzt | 0 | - |
| 0x21F12F | Speichermodul 14 - Bauteilschutz - Spannung - Betriebsgrenze oben verletzt | 0 | - |
| 0x21F130 | Speichermodul 15 - Bauteilschutz - Spannung - Betriebsgrenze oben verletzt | 0 | - |
| 0x21F131 | Speichermodul 16 - Bauteilschutz - Spannung - Betriebsgrenze oben verletzt | 0 | - |
| 0x21F133 | Speichermodul 01 - Bauteilschutz - Spannung - Betriebsgrenze unten verletzt | 0 | - |
| 0x21F134 | Speichermodul 02 - Bauteilschutz - Spannung - Betriebsgrenze unten verletzt | 0 | - |
| 0x21F135 | Speichermodul 03 - Bauteilschutz - Spannung - Betriebsgrenze unten verletzt | 0 | - |
| 0x21F136 | Speichermodul 04 - Bauteilschutz - Spannung - Betriebsgrenze unten verletzt | 0 | - |
| 0x21F137 | Speichermodul 05 - Bauteilschutz - Spannung - Betriebsgrenze unten verletzt | 0 | - |
| 0x21F138 | Speichermodul 06 - Bauteilschutz - Spannung - Betriebsgrenze unten verletzt | 0 | - |
| 0x21F139 | Speichermodul 07 - Bauteilschutz - Spannung - Betriebsgrenze unten verletzt | 0 | - |
| 0x21F13A | Speichermodul 08 - Bauteilschutz - Spannung - Betriebsgrenze unten verletzt | 0 | - |
| 0x21F13B | Speichermodul 09 - Bauteilschutz - Spannung - Betriebsgrenze unten verletzt | 0 | - |
| 0x21F13C | Speichermodul 10 - Bauteilschutz - Spannung - Betriebsgrenze unten verletzt | 0 | - |
| 0x21F13D | Speichermodul 11 - Bauteilschutz - Spannung - Betriebsgrenze unten verletzt | 0 | - |
| 0x21F13E | Speichermodul 12 - Bauteilschutz - Spannung - Betriebsgrenze unten verletzt | 0 | - |
| 0x21F13F | Speichermodul 13 - Bauteilschutz - Spannung - Betriebsgrenze unten verletzt | 0 | - |
| 0x21F140 | Speichermodul 14 - Bauteilschutz - Spannung - Betriebsgrenze unten verletzt | 0 | - |
| 0x21F141 | Speichermodul 15 - Bauteilschutz - Spannung - Betriebsgrenze unten verletzt | 0 | - |
| 0x21F142 | Speichermodul 16 - Bauteilschutz - Spannung - Betriebsgrenze unten verletzt | 0 | - |
| 0x21F151 | Battery Management Unit (BMU) - FUSI - Service Disconnect undefiniert | 0 | - |
| 0x21F152 | Battery Management Unit (BMU) - FUSI - Service Disconnect offen | 0 | - |
| 0x21F155 | Schütze - Vorladeschütz HV-Plus - Zeitüberschreitung | 0 | - |
| 0x21F157 | Schütze - Vorladeschütz HV-Plus - Kurzschluss im Zwischenkreis | 0 | - |
| 0x21F158 | Battery Management Unit (BMU) - Flashmode - Schütze - Trennelement offen | 0 | - |
| 0x21F159 | U/I-Sensor - HV-Strom - Strom unplausibel | 0 | - |
| 0x21F15A | Battery Management Unit (BMU) - Relais Treiberschaltung - Spulenstrom zu hoch - Messbereichsverletzung | 0 | - |
| 0x21F161 | Speichermodul 01 - Spannungssensoren - unplausibel | 0 | - |
| 0x21F162 | Speichermodul 02 - Spannungssensoren - unplausibel | 0 | - |
| 0x21F163 | Speichermodul 03 - Spannungssensoren - unplausibel | 0 | - |
| 0x21F164 | Speichermodul 04 - Spannungssensoren - unplausibel | 0 | - |
| 0x21F165 | Speichermodul 05 - Spannungssensoren - unplausibel | 0 | - |
| 0x21F166 | Speichermodul 06 - Spannungssensoren - unplausibel | 0 | - |
| 0x21F167 | Speichermodul 07 - Spannungssensoren - unplausibel | 0 | - |
| 0x21F168 | Speichermodul 08 - Spannungssensoren - unplausibel | 0 | - |
| 0x21F169 | Speichermodul 09 - Spannungssensoren - unplausibel | 0 | - |
| 0x21F16A | Speichermodul 10 - Spannungssensoren - unplausibel | 0 | - |
| 0x21F16B | Speichermodul 11 - Spannungssensoren - unplausibel | 0 | - |
| 0x21F16C | Speichermodul 12 - Spannungssensoren - unplausibel | 0 | - |
| 0x21F171 | Speichermodul 01 - Temperatursensoren - unplausibel | 0 | - |
| 0x21F172 | Speichermodul 02 - Temperatursensoren - unplausibel | 0 | - |
| 0x21F173 | Speichermodul 03 - Temperatursensoren - unplausibel | 0 | - |
| 0x21F174 | Speichermodul 04 - Temperatursensoren - unplausibel | 0 | - |
| 0x21F175 | Speichermodul 05 - Temperatursensoren - unplausibel | 0 | - |
| 0x21F176 | Speichermodul 06 - Temperatursensoren - unplausibel | 0 | - |
| 0x21F177 | Speichermodul 07 - Temperatursensoren - unplausibel | 0 | - |
| 0x21F178 | Speichermodul 08 - Temperatursensoren - unplausibel | 0 | - |
| 0x21F179 | Speichermodul 09 - Temperatursensoren - unplausibel | 0 | - |
| 0x21F17A | Speichermodul 10 - Temperatursensoren - unplausibel | 0 | - |
| 0x21F17B | Speichermodul 11 - Temperatursensoren - unplausibel | 0 | - |
| 0x21F17C | Speichermodul 12 - Temperatursensoren - unplausibel | 0 | - |
| 0x21F184 | Speichermodul 01 - Temperatursensoren - ausgefallen | 0 | - |
| 0x21F185 | Speichermodul 02 - Temperatursensoren - ausgefallen | 0 | - |
| 0x21F186 | Speichermodul 03 - Temperatursensoren - ausgefallen | 0 | - |
| 0x21F187 | Speichermodul 04 - Temperatursensoren - ausgefallen | 0 | - |
| 0x21F188 | Speichermodul 05 - Temperatursensoren - ausgefallen | 0 | - |
| 0x21F189 | Speichermodul 06 - Temperatursensoren - ausgefallen | 0 | - |
| 0x21F18A | Speichermodul 07 - Temperatursensoren - ausgefallen | 0 | - |
| 0x21F18B | Speichermodul 08 - Temperatursensoren - ausgefallen | 0 | - |
| 0x21F18C | Speichermodul 09 - Temperatursensoren - ausgefallen | 0 | - |
| 0x21F18D | Speichermodul 10 - Temperatursensoren - ausgefallen | 0 | - |
| 0x21F18E | Speichermodul 11 - Temperatursensoren - ausgefallen | 0 | - |
| 0x21F18F | Speichermodul 12 - Temperatursensoren - ausgefallen | 0 | - |
| 0x21F1A7 | Speichermodul 01 - Bauteilschutz - Temperatur - Betriebsgrenze verletzt | 0 | - |
| 0x21F1A8 | Speichermodul 02 - Bauteilschutz - Temperatur - Betriebsgrenze verletzt | 0 | - |
| 0x21F1A9 | Speichermodul 03 - Bauteilschutz - Temperatur - Betriebsgrenze verletzt | 0 | - |
| 0x21F1AA | Speichermodul 04 - Bauteilschutz - Temperatur - Betriebsgrenze verletzt | 0 | - |
| 0x21F1AB | Speichermodul 05 - Bauteilschutz - Temperatur - Betriebsgrenze verletzt | 0 | - |
| 0x21F1AC | Speichermodul 06 - Bauteilschutz - Temperatur - Betriebsgrenze verletzt | 0 | - |
| 0x21F1AD | Speichermodul 07 - Bauteilschutz - Temperatur - Betriebsgrenze verletzt | 0 | - |
| 0x21F1AE | Speichermodul 08 - Bauteilschutz - Temperatur - Betriebsgrenze verletzt | 0 | - |
| 0x21F1AF | Speichermodul 09 - Bauteilschutz - Temperatur - Betriebsgrenze verletzt | 0 | - |
| 0x21F1B0 | Speichermodul 10 - Bauteilschutz - Temperatur - Betriebsgrenze verletzt | 0 | - |
| 0x21F1B1 | Speichermodul 11 - Bauteilschutz - Temperatur - Betriebsgrenze verletzt | 0 | - |
| 0x21F1B2 | Speichermodul 12 - Bauteilschutz - Temperatur - Betriebsgrenze verletzt | 0 | - |
| 0x21F1B3 | Speichermodul 13 - Bauteilschutz - Temperatur - Betriebsgrenze verletzt | 0 | - |
| 0x21F1B4 | Speichermodul 14 - Bauteilschutz - Temperatur - Betriebsgrenze verletzt | 0 | - |
| 0x21F1B5 | Speichermodul 15 - Bauteilschutz - Temperatur - Betriebsgrenze verletzt | 0 | - |
| 0x21F1B6 | Speichermodul 16 - Bauteilschutz - Temperatur - Betriebsgrenze verletzt | 0 | - |
| 0x21F1B7 | Speichermodul 13 - Temperatursensoren - Oberer Schwellenwert überschritten - (Sicherheitsgrenze) | 0 | - |
| 0x21F1B8 | Speichermodul 14 - Temperatursensoren - Oberer Schwellenwert überschritten - (Sicherheitsgrenze) | 0 | - |
| 0x21F1B9 | Speichermodul 15 - Temperatursensoren - Oberer Schwellenwert überschritten - (Sicherheitsgrenze) | 0 | - |
| 0x21F1BB | Speichermodul 16 - Temperatursensoren - Oberer Schwellenwert überschritten - (Sicherheitsgrenze) | 0 | - |
| 0x21F1BC | Speichermodul 17 - Temperatursensoren - Oberer Schwellenwert überschritten - (Sicherheitsgrenze) | 0 | - |
| 0x21F1BE | Speichermodul 18 - Temperatursensoren - Oberer Schwellenwert überschritten - (Sicherheitsgrenze) | 0 | - |
| 0x21F1C0 | Speichermodul 19 - Temperatursensoren - Oberer Schwellenwert überschritten - (Sicherheitsgrenze) | 0 | - |
| 0x21F1C1 | Speichermodul 20 - Temperatursensoren - Oberer Schwellenwert überschritten - (Sicherheitsgrenze) | 0 | - |
| 0x21F1C2 | Speichermodul 21 - Temperatursensoren - Oberer Schwellenwert überschritten - (Sicherheitsgrenze) | 0 | - |
| 0x21F1C3 | Speichermodul 01 - Bauteilschutz - Zelldefekt festgestellt | 0 | - |
| 0x21F1C4 | Speichermodul 02 - Bauteilschutz - Zelldefekt festgestellt | 0 | - |
| 0x21F1C5 | Speichermodul 03 - Bauteilschutz - Zelldefekt festgestellt | 0 | - |
| 0x21F1C6 | Speichermodul 04 - Bauteilschutz - Zelldefekt festgestellt | 0 | - |
| 0x21F1C7 | Speichermodul 05 - Bauteilschutz - Zelldefekt festgestellt | 0 | - |
| 0x21F1C8 | Speichermodul 06 - Bauteilschutz - Zelldefekt festgestellt | 0 | - |
| 0x21F1C9 | Speichermodul 07 - Bauteilschutz - Zelldefekt festgestellt | 0 | - |
| 0x21F1CA | Speichermodul 08 - Bauteilschutz - Zelldefekt festgestellt | 0 | - |
| 0x21F1CB | Speichermodul 09 - Bauteilschutz - Zelldefekt festgestellt | 0 | - |
| 0x21F1CC | Speichermodul 10 - Bauteilschutz - Zelldefekt festgestellt | 0 | - |
| 0x21F1CD | Speichermodul 11 - Bauteilschutz - Zelldefekt festgestellt | 0 | - |
| 0x21F1CE | Speichermodul 12 - Bauteilschutz - Zelldefekt festgestellt | 0 | - |
| 0x21F1CF | Speichermodul 13 - Bauteilschutz - Zelldefekt festgestellt | 0 | - |
| 0x21F1D0 | Speichermodul 14 - Bauteilschutz - Zelldefekt festgestellt | 0 | - |
| 0x21F1D1 | Speichermodul 15 - Bauteilschutz - Zelldefekt festgestellt | 0 | - |
| 0x21F1D2 | Speichermodul 16 - Bauteilschutz - Zelldefekt festgestellt | 0 | - |
| 0x21F1D3 | Speichermodul 22 - Temperatursensoren - Oberer Schwellenwert überschritten - (Sicherheitsgrenze) | 0 | - |
| 0x21F1D4 | Speichermodul 23 - Temperatursensoren - Oberer Schwellenwert überschritten - (Sicherheitsgrenze) | 0 | - |
| 0x21F1D5 | Speichermodul 24 - Temperatursensoren - Oberer Schwellenwert überschritten - (Sicherheitsgrenze) | 0 | - |
| 0x21F1D6 | Speichermodul 25 - Temperatursensoren - Oberer Schwellenwert überschritten - (Sicherheitsgrenze) | 0 | - |
| 0x21F1D7 | Speichermodul 26 - Temperatursensoren - Oberer Schwellenwert überschritten - (Sicherheitsgrenze) | 0 | - |
| 0x21F1D8 | Speichermodul 27 - Temperatursensoren - Oberer Schwellenwert überschritten - (Sicherheitsgrenze) | 0 | - |
| 0x21F1D9 | Speichermodul 13 - Bauteilschutz - Spannung - Sicherheitsgrenze oben verletzt | 0 | - |
| 0x21F1DA | Speichermodul 14 - Bauteilschutz - Spannung - Sicherheitsgrenze oben verletzt | 0 | - |
| 0x21F1DB | Speichermodul 15 - Bauteilschutz - Spannung - Sicherheitsgrenze oben verletzt | 0 | - |
| 0x21F1DC | Speichermodul 16 - Bauteilschutz - Spannung - Sicherheitsgrenze oben verletzt | 0 | - |
| 0x21F1DD | Speichermodul 17 - Bauteilschutz - Spannung - Sicherheitsgrenze oben verletzt | 0 | - |
| 0x21F1DE | Speichermodul 18 - Bauteilschutz - Spannung - Sicherheitsgrenze oben verletzt | 0 | - |
| 0x21F1DF | Speichermodul 19 - Bauteilschutz - Spannung - Sicherheitsgrenze oben verletzt | 0 | - |
| 0x21F1E0 | Speichermodul 20 - Bauteilschutz - Spannung - Sicherheitsgrenze oben verletzt | 0 | - |
| 0x21F1E1 | Speichermodul 13 - Bauteilschutz - Spannung - Sicherheitsgrenze unten verletzt | 0 | - |
| 0x21F1E2 | Speichermodul 14 - Bauteilschutz - Spannung - Sicherheitsgrenze unten verletzt | 0 | - |
| 0x21F1E3 | Speichermodul 15 - Bauteilschutz - Spannung - Sicherheitsgrenze unten verletzt | 0 | - |
| 0x21F1E4 | Speichermodul 16 - Bauteilschutz - Spannung - Sicherheitsgrenze unten verletzt | 0 | - |
| 0x21F1E5 | Speichermodul 17 - Bauteilschutz - Spannung - Sicherheitsgrenze unten verletzt | 0 | - |
| 0x21F1E6 | Speichermodul 18 - Bauteilschutz - Spannung - Sicherheitsgrenze unten verletzt | 0 | - |
| 0x21F1E7 | Speichermodul 19 - Bauteilschutz - Spannung - Sicherheitsgrenze unten verletzt | 0 | - |
| 0x21F1E8 | Speichermodul 20 - Bauteilschutz - Spannung - Sicherheitsgrenze unten verletzt | 0 | - |
| 0x21F1E9 | Speichermodul 17 - Bauteilschutz - Zelldefekt festgestellt | 0 | - |
| 0x21F1EA | Speichermodul 18 - Bauteilschutz - Zelldefekt festgestellt | 0 | - |
| 0x21F1EB | Speichermodul 21 - Bauteilschutz - Spannung - Sicherheitsgrenze oben verletzt | 0 | - |
| 0x21F1EC | Speichermodul 22 - Bauteilschutz - Spannung - Sicherheitsgrenze oben verletzt | 0 | - |
| 0x21F1ED | Speichermodul 23 - Bauteilschutz - Spannung - Sicherheitsgrenze oben verletzt | 0 | - |
| 0x21F1EE | Speichermodul 24 - Bauteilschutz - Spannung - Sicherheitsgrenze oben verletzt | 0 | - |
| 0x21F1EF | Speichermodul 25 - Bauteilschutz - Spannung - Sicherheitsgrenze oben verletzt | 0 | - |
| 0x21F1F0 | Speichermodul 26 - Bauteilschutz - Spannung - Sicherheitsgrenze oben verletzt | 0 | - |
| 0x21F1F1 | Speichermodul 27 - Bauteilschutz - Spannung - Sicherheitsgrenze oben verletzt | 0 | - |
| 0x21F1F2 | Speichermodul 21 - Bauteilschutz - Spannung - Sicherheitsgrenze unten verletzt | 0 | - |
| 0x21F1F3 | Speichermodul 22 - Bauteilschutz - Spannung - Sicherheitsgrenze unten verletzt | 0 | - |
| 0x21F1F4 | Speichermodul 23 - Bauteilschutz - Spannung - Sicherheitsgrenze unten verletzt | 0 | - |
| 0x21F1F5 | Speichermodul 24 - Bauteilschutz - Spannung - Sicherheitsgrenze unten verletzt | 0 | - |
| 0x21F1FC | Speichermodul 25 - Bauteilschutz - Spannung - Sicherheitsgrenze unten verletzt | 0 | - |
| 0x21F1FF | Speichermodul 26 - Bauteilschutz - Spannung - Sicherheitsgrenze unten verletzt | 0 | - |
| 0x21F202 | Speichermodul 27 - Bauteilschutz - Spannung - Sicherheitsgrenze unten verletzt | 0 | - |
| 0x21F206 | Speichermodul 19 - Bauteilschutz - Zelldefekt festgestellt | 0 | - |
| 0x21F20E | Speichermodul 20 - Bauteilschutz - Zelldefekt festgestellt | 0 | - |
| 0x21F215 | Speichermodul 21 - Bauteilschutz - Zelldefekt festgestellt | 0 | - |
| 0x21F216 | Speichermodul 22 - Bauteilschutz - Zelldefekt festgestellt | 0 | - |
| 0x21F217 | Speichermodul 23 - Bauteilschutz - Zelldefekt festgestellt | 0 | - |
| 0x21F218 | Speichermodul 24 - Bauteilschutz - Zelldefekt festgestellt | 0 | - |
| 0x21F219 | Speichermodul 25 - Bauteilschutz - Zelldefekt festgestellt | 0 | - |
| 0x21F21A | Speichermodul 26 - Bauteilschutz - Zelldefekt festgestellt | 0 | - |
| 0x21F21B | Speichermodul 27 - Bauteilschutz - Zelldefekt festgestellt | 0 | - |
| 0x21F21C | Schütze - Hauptschütze - Bauteilschutz - Temperatur - Betriebsgrenze verletzt | 0 | - |
| 0x21F21D | Schütze - Ladeschütze - Bauteilschutz - Temperatur - Betriebsgrenze verletzt | 0 | - |
| 0x21F21E | Schütze - Hauptschütze - Max. Schaltzyklenanzahl Überschreitung | 0 | - |
| 0x21F21F | Schütze - Hauptschütze - Absehbare max. Schaltzyklenanzahl Überschreitung | 0 | - |
| 0x21F223 | Schütze - DC Ladeschütze - Max. Schaltzyklenanzahl überschritten | 0 | - |
| 0x21F224 | Schütze - DC Ladeschütze - Absehbare max. Schaltzyklenanzahl Überschreitung | 0 | - |
| 0x21F225 | Schütze - Vorladeschütz HV-Plus - Schütz offen - Schließversuch selbstständig | 0 | - |
| 0x21F226 | Schütze - Hauptschütz HV-Minus - Schütz offen - Schließversuch selbstständig | 0 | - |
| 0x21F227 | Schütze - Ladeschütze - Bauteilschutz - Temperatur - Oberer Schwellenwert überschritten | 0 | - |
| 0x21F228 | Schütze - Ladeschütze - Bauteilschutz - Temperatur - Unterer Schwellenwert unterschritten | 0 | - |
| 0x21F229 | U/I-Sensor - Kommunikation ausgefallen | 0 | - |
| 0x21F22A | Schütze - Hauptschütze - nicht freigegeben | 0 | - |
| 0x21F22B | U/I-Sensor - Kommunikation - Invalide Daten | 1 | - |
| 0x21F250 | Speichermodul 13 - Spannungssensoren - Offene Leitung | 0 | - |
| 0x21F251 | Speichermodul 13 - Spannungssensoren - unplausibel | 0 | - |
| 0x21F252 | Speichermodul 13 - Temperatursensoren - ausgefallen | 0 | - |
| 0x21F253 | Speichermodul 13 - Temperatursensoren - Offene Leitung | 0 | - |
| 0x21F254 | Speichermodul 14 - Spannungssensoren - Offene Leitung | 0 | - |
| 0x21F255 | Speichermodul 14 - Spannungssensoren - unplausibel | 0 | - |
| 0x21F256 | Speichermodul 14 - Temperatursensoren - ausgefallen | 0 | - |
| 0x21F257 | Speichermodul 14 - Temperatursensoren - Offene Leitung | 0 | - |
| 0x21F258 | Speichermodul 14 - Temperatursensoren - unplausibel | 0 | - |
| 0x21F259 | Speichermodul 15 - Spannungssensoren - Offene Leitung | 0 | - |
| 0x21F25A | Speichermodul 15 - Spannungssensoren - unplausibel | 0 | - |
| 0x21F25B | Speichermodul 15 - Temperatursensoren - ausgefallen | 0 | - |
| 0x21F25C | Speichermodul 15 - Temperatursensoren - Offene Leitung | 0 | - |
| 0x21F25D | Speichermodul 15 - Temperatursensoren - unplausibel | 0 | - |
| 0x21F25E | Speichermodul 16 - Spannungssensoren - Offene Leitung | 0 | - |
| 0x21F25F | Speichermodul 16 - Spannungssensoren - unplausibel | 0 | - |
| 0x21F260 | Speichermodul 16 - Temperatursensoren - ausgefallen | 0 | - |
| 0x21F261 | Speichermodul 16 - Temperatursensoren - Offene Leitung | 0 | - |
| 0x21F262 | Speichermodul 16 - Temperatursensoren - unplausibel | 0 | - |
| 0x21F263 | Speichermodul 17 - Spannungssensoren - Offene Leitung | 0 | - |
| 0x21F264 | Speichermodul 17 - Spannungssensoren - unplausibel | 0 | - |
| 0x21F265 | Speichermodul 17 - Temperatursensoren - ausgefallen | 0 | - |
| 0x21F266 | Speichermodul 17 - Temperatursensoren - Offene Leitung | 0 | - |
| 0x21F267 | Speichermodul 17 - Temperatursensoren - unplausibel | 0 | - |
| 0x21F268 | Speichermodul 18 - Spannungssensoren - Offene Leitung | 0 | - |
| 0x21F269 | Speichermodul 18 - Spannungssensoren - unplausibel | 0 | - |
| 0x21F26A | Speichermodul 18 - Temperatursensoren - ausgefallen | 0 | - |
| 0x21F26B | Speichermodul 18 - Temperatursensoren - Offene Leitung | 0 | - |
| 0x21F26C | Speichermodul 18 - Temperatursensoren - unplausibel | 0 | - |
| 0x21F26D | Speichermodul 19 - Spannungssensoren - Offene Leitung | 0 | - |
| 0x21F26E | Speichermodul 19 - Spannungssensoren - unplausibel | 0 | - |
| 0x21F26F | Speichermodul 17 - Bauteilschutz - Spannung - Betriebsgrenze oben verletzt | 0 | - |
| 0x21F274 | Speichermodul 19 - Temperatursensoren - ausgefallen | 0 | - |
| 0x21F277 | Speichermodul 19 - Temperatursensoren - Offene Leitung | 0 | - |
| 0x21F278 | Speichermodul 19 - Temperatursensoren - unplausibel | 0 | - |
| 0x21F279 | Speichermodul 20 - Spannungssensoren - Offene Leitung | 0 | - |
| 0x21F27A | Speichermodul 20 - Spannungssensoren - unplausibel | 0 | - |
| 0x21F27B | Speichermodul 20 - Temperatursensoren - ausgefallen | 0 | - |
| 0x21F27C | Speichermodul 20 - Temperatursensoren - Offene Leitung | 0 | - |
| 0x21F27D | Speichermodul 20 - Temperatursensoren - unplausibel | 0 | - |
| 0x21F27E | Speichermodul 21 - Spannungssensoren - Offene Leitung | 0 | - |
| 0x21F27F | Speichermodul 18 - Bauteilschutz - Spannung - Betriebsgrenze oben verletzt | 0 | - |
| 0x21F280 | Speichermodul 21 - Spannungssensoren - unplausibel | 0 | - |
| 0x21F281 | Speichermodul 21 - Temperatursensoren - ausgefallen | 0 | - |
| 0x21F282 | Speichermodul 21 - Temperatursensoren - Offene Leitung | 0 | - |
| 0x21F283 | Speichermodul 21 - Temperatursensoren - unplausibel | 0 | - |
| 0x21F284 | Speichermodul 22 - Spannungssensoren - Offene Leitung | 0 | - |
| 0x21F285 | Speichermodul 22 - Spannungssensoren - unplausibel | 0 | - |
| 0x21F286 | Speichermodul 22 - Temperatursensoren - ausgefallen | 0 | - |
| 0x21F287 | Speichermodul 22 - Temperatursensoren - Offene Leitung | 0 | - |
| 0x21F288 | Speichermodul 22 - Temperatursensoren - unplausibel | 0 | - |
| 0x21F289 | Speichermodul 23 - Spannungssensoren - Offene Leitung | 0 | - |
| 0x21F28A | Speichermodul 23 - Spannungssensoren - unplausibel | 0 | - |
| 0x21F28B | Speichermodul 23 - Temperatursensoren - ausgefallen | 0 | - |
| 0x21F28C | Speichermodul 23 - Temperatursensoren - Offene Leitung | 0 | - |
| 0x21F28D | Speichermodul 23 - Temperatursensoren - unplausibel | 0 | - |
| 0x21F28E | Speichermodul 24 - Spannungssensoren - Offene Leitung | 0 | - |
| 0x21F28F | Speichermodul 24 - Spannungssensoren - unplausibel | 0 | - |
| 0x21F290 | Speichermodul 24 - Temperatursensoren - ausgefallen | 0 | - |
| 0x21F291 | Speichermodul 24 - Temperatursensoren - Offene Leitung | 0 | - |
| 0x21F292 | Speichermodul 24 - Temperatursensoren - unplausibel | 0 | - |
| 0x21F293 | Speichermodul 25 - Spannungssensoren - Offene Leitung | 0 | - |
| 0x21F294 | Speichermodul 25 - Spannungssensoren - unplausibel | 0 | - |
| 0x21F295 | Speichermodul 25 - Temperatursensoren - ausgefallen | 0 | - |
| 0x21F296 | Speichermodul 25 - Temperatursensoren - Offene Leitung | 0 | - |
| 0x21F297 | Speichermodul 25 - Temperatursensoren - unplausibel | 0 | - |
| 0x21F298 | Speichermodul 26 - Spannungssensoren - Offene Leitung | 0 | - |
| 0x21F299 | Speichermodul 26 - Spannungssensoren - unplausibel | 0 | - |
| 0x21F29A | Speichermodul 26 - Temperatursensoren - ausgefallen | 0 | - |
| 0x21F29B | Speichermodul 26 - Temperatursensoren - Offene Leitung | 0 | - |
| 0x21F29C | Speichermodul 26 - Temperatursensoren - unplausibel | 0 | - |
| 0x21F29D | Speichermodul 27 - Spannungssensoren - Offene Leitung | 0 | - |
| 0x21F29E | Speichermodul 27 - Spannungssensoren - unplausibel | 0 | - |
| 0x21F29F | Speichermodul 27 - Temperatursensoren - ausgefallen | 0 | - |
| 0x21F2A0 | Speichermodul 27 - Temperatursensoren - Offene Leitung | 0 | - |
| 0x21F2A1 | Speichermodul 27 - Temperatursensoren - unplausibel | 0 | - |
| 0x21F2A2 | Speichermodul 13 - Temperatursensoren - unplausibel | 0 | - |
| 0x21F2A3 | Schütze - Ladeschütz HV-Minus - Schütz dauerhaft geschlossen | 0 | - |
| 0x21F2A4 | Schütze - Ladeschütz HV-Minus - Schütz dauerhaft offen | 0 | - |
| 0x21F2A5 | Schütze - Ladeschütz HV-Plus - Schütz dauerhaft geschlossen | 0 | - |
| 0x21F2A6 | Schütze - Ladeschütz HV-Plus - Schütz dauerhaft offen | 0 | - |
| 0x21F2A7 | Battery Management Unit (BMU) - Powerfuse - Zündung fehlgeschlagen | 0 | - |
| 0x21F2A8 | Battery Management Unit (BMU) - Powerfuse - Zündpille/Ansteuerungselektronik fehlerhaft | 0 | - |
| 0x21F2AA | Speichermodul 19 - Bauteilschutz - Spannung - Betriebsgrenze oben verletzt | 0 | - |
| 0x21F2AB | Speichermodul 20 - Bauteilschutz - Spannung - Betriebsgrenze oben verletzt | 0 | - |
| 0x21F2AC | Speichermodul 21 - Bauteilschutz - Spannung - Betriebsgrenze oben verletzt | 0 | - |
| 0x21F2AD | Speichermodul 22 - Bauteilschutz - Spannung - Betriebsgrenze oben verletzt | 0 | - |
| 0x21F2AE | Speichermodul 23 - Bauteilschutz - Spannung - Betriebsgrenze oben verletzt | 0 | - |
| 0x21F2AF | Speichermodul 24 - Bauteilschutz - Spannung - Betriebsgrenze oben verletzt | 0 | - |
| 0x21F2B0 | Schütze - Ladeschütze - Nicht freigegeben | 0 | - |
| 0x21F2BD | Speichermodul 25 - Bauteilschutz - Spannung - Betriebsgrenze oben verletzt | 0 | - |
| 0x21F2BE | Speichermodul 26 - Bauteilschutz - Spannung - Betriebsgrenze oben verletzt | 0 | - |
| 0x21F2BF | Speichermodul 27 - Bauteilschutz - Spannung - Betriebsgrenze oben verletzt | 0 | - |
| 0x21F2D0 | Speichermodul 17 - Bauteilschutz - Spannung - Betriebsgrenze unten verletzt | 0 | - |
| 0x21F2D1 | Battery Management Unit (BMU) - Vorladewiderstand - Bauteilschutz - Überhitzungsschutz aktiv | 0 | - |
| 0x21F2DD | Speichermodul 18 - Bauteilschutz - Spannung - Betriebsgrenze unten verletzt | 0 | - |
| 0x21F2DE | Speichermodul 19 - Bauteilschutz - Spannung - Betriebsgrenze unten verletzt | 0 | - |
| 0x21F2DF | Speichermodul 20 - Bauteilschutz - Spannung - Betriebsgrenze unten verletzt | 0 | - |
| 0x21F2E0 | Speichermodul 21 - Bauteilschutz - Spannung - Betriebsgrenze unten verletzt | 0 | - |
| 0x21F2E1 | Speichermodul 22 - Bauteilschutz - Spannung - Betriebsgrenze unten verletzt | 0 | - |
| 0x21F2E2 | Speichermodul 23 - Bauteilschutz - Spannung - Betriebsgrenze unten verletzt | 0 | - |
| 0x21F2E3 | Speichermodul 24 - Bauteilschutz - Spannung - Betriebsgrenze unten verletzt | 0 | - |
| 0x21F2E4 | Speichermodul 25 - Bauteilschutz - Spannung - Betriebsgrenze unten verletzt | 0 | - |
| 0x21F2E5 | Speichermodul 26 - Bauteilschutz - Spannung - Betriebsgrenze unten verletzt | 0 | - |
| 0x21F2E6 | Speichermodul 27 - Bauteilschutz - Spannung - Betriebsgrenze unten verletzt | 0 | - |
| 0x21F2E7 | Speichermodul 17 - Bauteilschutz - Temperatur - Betriebsgrenze verletzt | 0 | - |
| 0x21F2E8 | Speichermodul 18 - Bauteilschutz - Temperatur - Betriebsgrenze verletzt | 0 | - |
| 0x21F2E9 | Speichermodul 19 - Bauteilschutz - Temperatur - Betriebsgrenze verletzt | 0 | - |
| 0x21F2EA | Speichermodul 20 - Bauteilschutz - Temperatur - Betriebsgrenze verletzt | 0 | - |
| 0x21F2EB | Speichermodul 21 - Bauteilschutz - Temperatur - Betriebsgrenze verletzt | 0 | - |
| 0x21F2EC | Speichermodul 22 - Bauteilschutz - Temperatur - Betriebsgrenze verletzt | 0 | - |
| 0x21F2ED | Speichermodul 23 - Bauteilschutz - Temperatur - Betriebsgrenze verletzt | 0 | - |
| 0x21F2EE | Speichermodul 24 - Bauteilschutz - Temperatur - Betriebsgrenze verletzt | 0 | - |
| 0x21F2EF | Speichermodul 25 - Bauteilschutz - Temperatur - Betriebsgrenze verletzt | 0 | - |
| 0x21F2F0 | Speichermodul 26 - Bauteilschutz - Temperatur - Betriebsgrenze verletzt | 0 | - |
| 0x21F2F1 | Speichermodul 27 - Bauteilschutz - Temperatur - Betriebsgrenze verletzt | 0 | - |
| 0x21F2F2 | U/I-Sensor - HV-Batteriespannung - Oberer Schwellenwert überschritten | 1 | - |
| 0x21F2F3 | U/I-Sensor - Spannung Hauptschütz HV-Plus - Oberer Schwellenwert überschritten | 1 | - |
| 0x21F2F4 | U/I-Sensor - Spannung Hauptschütz HV-Minus - Oberer Schwellenwert überschritten | 1 | - |
| 0x21F2F5 | U/I-Sensor - Spannung Ladeschütz HV-Minus - Oberer Schwellenwert überschritten | 1 | - |
| 0x21F2F6 | U/I-Sensor - Spannung Ladeschütz HV-Plus - Oberer Schwellenwert überschritten | 1 | - |
| 0x21F2F7 | U/I-Sensor - HV-Batteriespannung - Unterer Schwellenwert unterschritten | 1 | - |
| 0x21F2F8 | U/I-Sensor - Spannung Hauptschütz HV-Plus - Unterer Schwellenwert unterschritten | 1 | - |
| 0x21F2F9 | U/I-Sensor - Spannung Hauptschütz HV-Minus - Unterer Schwellenwert unterschritten | 1 | - |
| 0x21F2FA | U/I-Sensor - Spannung Ladeschütz HV-Minus - Unterer Schwellenwert unterschritten | 1 | - |
| 0x21F2FB | U/I-Sensor - Spannung Ladeschütz HV-Plus - Unterer Schwellenwert unterschritten | 1 | - |
| 0x21F2FC | U/I-Sensor - HV-Batteriespannung - unplausibel | 1 | - |
| 0x21F2FD | U/I-Sensor - Spannung Hauptschütz HV-Plus - unplausibel | 1 | - |
| 0x21F2FE | U/I-Sensor - Spannung Hauptschütz HV-Minus - unplausibel | 1 | - |
| 0x21F2FF | U/I-Sensor - Spannung Ladeschütz HV-Minus - unplausibel | 1 | - |
| 0x21F300 | U/I-Sensor - Spannung Ladeschütz HV-Plus - unplausibel | 1 | - |
| 0x21F301 | Battery Management Unit (BMU) - Vorladung - Zwischenkreis - nicht angeschlossen | 0 | - |
| 0x21F309 | Speichermodul 01 - Kapazitätsalterung - Kapazität zu gering | 0 | - |
| 0x21F30B | CSC - Symmetrierschaltung - Temperatursensoren - unplausibel | 0 | - |
| 0x21F30C | CSC - Symmetrierschaltung - Temperatursensoren - Oberer Schwellenwert überschritten | 0 | - |
| 0x21F30D | CSC - Symmetrierschaltung - Temperatursensoren - Unterer Schwellenwert unterschritten | 0 | - |
| 0x21F30E | CSC - Symmetrierschaltung - Temperatursensoren - Symmetrierung nicht möglich | 0 | - |
| 0x21F30F | CSC - Versorgungspannungssensor - Kurzschluss nach Plus/Masse | 0 | - |
| 0x21F310 | CSC - Versorgungspannungssensor - offene Leitung | 0 | - |
| 0x21F311 | CSC - Versorgungspannungssensor - Oberer Schwellenwert überschritten | 0 | - |
| 0x21F312 | CSC - Versorgungspannungssensor - Unterer Schwellenwert unterschritten | 0 | - |
| 0x21F313 | Speicher - Kühlmittel - Temperatursensor 01 - offene Leitung | 0 | - |
| 0x21F314 | Speicher - Kühlmittel - Temperatursensor 01 - Oberer Schwellenwert überschritten | 0 | - |
| 0x21F315 | Speicher - Kühlmittel - Temperatursensor 01 - Unterer Schwellenwert unterschritten | 0 | - |
| 0x21F316 | Speicher - Kühlmittel - Temperatursensor 02 - offene Leitung | 0 | - |
| 0x21F317 | Speicher - Kühlmittel - Temperatursensor 02 - Oberer Schwellenwert überschritten | 0 | - |
| 0x21F318 | Speicher - Kühlmittel - Temperatursensor 02 - Unterer Schwellenwert unterschritten | 0 | - |
| 0x21F323 | Battery Management Unit (BMU) - Spannungssensor KL30 - unplausibel | 0 | - |
| 0x21F324 | Battery Management Unit (BMU) - Spannungssensor KL30C - Oberer Schwellenwert überschritten | 0 | - |
| 0x21F325 | Battery Management Unit (BMU) - Spannungssensor KL30C - Unterer Schwellenwert unterschritten | 0 | - |
| 0x21F328 | Battery Management Unit (BMU) - Vorladung - Zwischenkreis - Niederohmiger Verbraucher | 0 | - |
| 0x21F32A | Battery Management Unit (BMU) - Spannungsfestigkeit - Zähler überschritten | 0 | - |
| 0x21F32B | Battery Management Unit (BMU) - Schnellentladung - nicht verfügbar | 0 | - |
| 0x21F32C | Battery Management Unit (BMU) - Status - Vorladung gesperrt | 0 | - |
| 0x21F32D | Battery Management Unit (BMU) - Powerfuse - ausgelöst | 0 | - |
| 0x21F32E | Isolationsüberwachung - Messung defekt | 0 | - |
| 0x21F34B | CSC 01 - Versorgung - Überspannung | 0 | - |
| 0x21F34C | CSC 02 - Versorgung - Überspannung | 0 | - |
| 0x21F34D | CSC 03 - Versorgung - Überspannung | 0 | - |
| 0x21F34E | CSC 04 - Versorgung - Überspannung | 0 | - |
| 0x21F34F | CSC 05 - Versorgung - Überspannung | 0 | - |
| 0x21F350 | CSC 06 - Versorgung - Überspannung | 0 | - |
| 0x21F351 | CSC 07 - Versorgung - Überspannung | 0 | - |
| 0x21F352 | CSC 01 - Versorgung - Unterspannung | 0 | - |
| 0x21F353 | CSC 02 - Versorgung - Unterspannung | 0 | - |
| 0x21F354 | CSC 03 - Versorgung - Unterspannung | 0 | - |
| 0x21F355 | CSC 04 - Versorgung - Unterspannung | 0 | - |
| 0x21F356 | CSC 05 - Versorgung - Unterspannung | 0 | - |
| 0x21F357 | CSC 06 - Versorgung - Unterspannung | 0 | - |
| 0x21F358 | CSC 07 - Versorgung - Unterspannung | 0 | - |
| 0x21F359 | Battery Management Unit (BMU) - CSC Kommunikation ausgefallen | 0 | - |
| 0x21F35A | Schütze - Ladeschütze - Bauteilschutz - Temperatur - unplausibel | 0 | - |
| 0x21F35B | Schütze - Hauptschütze - Bauteilschutz - Temperatur - Oberer Schwellenwert überschritten | 0 | - |
| 0x21F35C | Schütze - Hauptschütze - Bauteilschutz - Temperatur - Unterer Schwellenwert unterschritten | 0 | - |
| 0x21F35D | Schütze - Hauptschütze - Bauteilschutz - Temperatur - unplausibel | 0 | - |
| 0x21F35E | U/I-Sensor - Strommesswiderstand - Bauteilschutz - Temperatur - Oberer Schwellenwert überschritten | 0 | - |
| 0x21F35F | U/I-Sensor - Strommesswiderstand - Bauteilschutz - Temperatur - Unterer Schwellenwert unterschritten | 0 | - |
| 0x21F360 | U/I-Sensor - Strommesswiderstand - Bauteilschutz - Temperatur - unplausibel | 0 | - |
| 0x21F361 | Speichermodul 01 - Temperatursensoren - Unterer Schwellenwert unterschritten | 0 | - |
| 0x21F362 | Speichermodul 02 - Temperatursensoren - Unterer Schwellenwert unterschritten | 0 | - |
| 0x21F363 | Speichermodul 03 - Temperatursensoren - Unterer Schwellenwert unterschritten | 0 | - |
| 0x21F364 | Speichermodul 04 - Temperatursensoren - Unterer Schwellenwert unterschritten | 0 | - |
| 0x21F365 | Speichermodul 05 - Temperatursensoren - Unterer Schwellenwert unterschritten | 0 | - |
| 0x21F366 | Speichermodul 06 - Temperatursensoren - Unterer Schwellenwert unterschritten | 0 | - |
| 0x21F367 | Speichermodul 07 - Temperatursensoren - Unterer Schwellenwert unterschritten | 0 | - |
| 0x21F368 | Speichermodul 08 - Temperatursensoren - Unterer Schwellenwert unterschritten | 0 | - |
| 0x21F369 | Speichermodul 09 - Temperatursensoren - Unterer Schwellenwert unterschritten | 0 | - |
| 0x21F36A | Speichermodul 10 - Temperatursensoren - Unterer Schwellenwert unterschritten | 0 | - |
| 0x21F36B | Speichermodul 11 - Temperatursensoren - Unterer Schwellenwert unterschritten | 0 | - |
| 0x21F36C | Speichermodul 12 - Temperatursensoren - Unterer Schwellenwert unterschritten | 0 | - |
| 0x21F36D | Speichermodul 13 - Temperatursensoren - Unterer Schwellenwert unterschritten | 0 | - |
| 0x21F36E | Speichermodul 14 - Temperatursensoren - Unterer Schwellenwert unterschritten | 0 | - |
| 0x21F36F | Speichermodul 15 - Temperatursensoren - Unterer Schwellenwert unterschritten | 0 | - |
| 0x21F370 | Speichermodul 16 - Temperatursensoren - Unterer Schwellenwert unterschritten | 0 | - |
| 0x21F371 | Speichermodul 17 - Temperatursensoren - Unterer Schwellenwert unterschritten | 0 | - |
| 0x21F372 | Speichermodul 18 - Temperatursensoren - Unterer Schwellenwert unterschritten | 0 | - |
| 0x21F373 | Speichermodul 19 - Temperatursensoren - Unterer Schwellenwert unterschritten | 0 | - |
| 0x21F374 | Speichermodul 20 - Temperatursensoren - Unterer Schwellenwert unterschritten | 0 | - |
| 0x21F375 | Speichermodul 21 - Temperatursensoren - Unterer Schwellenwert unterschritten | 0 | - |
| 0x21F376 | Speichermodul 22 - Temperatursensoren - Unterer Schwellenwert unterschritten | 0 | - |
| 0x21F377 | Speichermodul 23 - Temperatursensoren - Unterer Schwellenwert unterschritten | 0 | - |
| 0x21F378 | Speichermodul 24 - Temperatursensoren - Unterer Schwellenwert unterschritten | 0 | - |
| 0x21F379 | Speichermodul 25 - Temperatursensoren - Unterer Schwellenwert unterschritten | 0 | - |
| 0x21F37A | Speichermodul 26 - Temperatursensoren - Unterer Schwellenwert unterschritten | 0 | - |
| 0x21F37B | Speichermodul 27 - Temperatursensoren - Unterer Schwellenwert unterschritten | 0 | - |
| 0x21F37C | Crash-Erkennung - ACSM Signal unplausibel | 0 | - |
| 0x21F37E | Crash-Erkennung - Crash erkannt via ACSM Signal | 0 | - |
| 0x21F380 | Crash-Erkennung - KL30C unplausibel | 0 | - |
| 0x21F382 | Crash-Erkennung - Funktion ausgefallen | 0 | - |
| 0x21F385 | Battery Management Unit (BMU), Kurzschlussstrommessung, Offsetkalibrierung: Schwellwert über-/unterschritten | 0 | - |
| 0x21F386 | Battery Management Unit (BMU), EOL: Datenblock ungültig | 0 | - |
| 0x21F387 | Battery Management Unit (BMU), CSC: Showroom Modus nicht möglich | 0 | - |
| 0x21F388 | Battery Management Unit (BMU), Beschädigungs-/Flüssigkeitserkennungssensor: unplausibel | 0 | - |
| 0x21F389 | Battery Management Unit (BMU), Beschädigungs-/Flüssigkeitserkennungssensor: offene Leitung | 0 | - |
| 0x21F38A | Battery Management Unit (BMU), Beschädigungs-/Flüssigkeitserkennungssensor: oberer Schwellenwert überschritten | 0 | - |
| 0x21F38B | Battery Management Unit (BMU), Beschädigungs-/Flüssigkeitserkennungssensor: unterer Schwellenwert unterschritten | 0 | - |
| 0x21F38D | Battery Management Unit (BMU), Spannungssensor KL30C, Qualifier ungültig: Relais geöffnet | 0 | - |
| 0x21F38E | Battery Management Unit (BMU), Steuergerät intern: Sammelfehler Hardware | 0 | - |
| 0x21F38F | Battery Management Unit (BMU), Steuergerät intern: Sammelfehler Software | 0 | - |
| 0x21F390 | Battery Management Unit (BMU), Steuergerät intern: RAM Fehler | 0 | - |
| 0x21F391 | Battery Management Unit (BMU), Steuergerät intern: ROM Fehler | 0 | - |
| 0x21F392 | Speicher: Thermisches Ereignis erkannt | 0 | - |
| 0x21F393 | Speicher, Sammelfehler: Transportverhindernderter Fehlerspeicher aktiv | 0 | - |
| 0x21F394 | Battery Management Unit (BMU) - Relais Treiberschaltung - Spulenstrom zu niedrig - Messbereichsverletzung | 0 | - |
| 0x21F396 | Speicher: Kritischer Ladezustand | 0 | - |
| 0x21F398 | Speichermodul 03 - Kapazitätsalterung - Kapazität zu gering | 0 | - |
| 0x21F399 | Speichermodul 04 - Kapazitätsalterung - Kapazität zu gering | 0 | - |
| 0x21F39A | Speichermodul 05 - Kapazitätsalterung - Kapazität zu gering | 0 | - |
| 0x21F39B | Speichermodul 06 - Kapazitätsalterung - Kapazität zu gering | 0 | - |
| 0x21F39C | Speichermodul 07 - Kapazitätsalterung - Kapazität zu gering | 0 | - |
| 0x21F39D | Speichermodul 08 - Kapazitätsalterung - Kapazität zu gering | 0 | - |
| 0x21F39E | Speichermodul 09 - Kapazitätsalterung - Kapazität zu gering | 0 | - |
| 0x21F39F | Speichermodul 10 - Kapazitätsalterung - Kapazität zu gering | 0 | - |
| 0x21F3A0 | Speichermodul 02 - Kapazitätsalterung - Kapazität zu gering | 0 | - |
| 0x21F3A1 | Speichermodul 11 - Kapazitätsalterung - Kapazität zu gering | 0 | - |
| 0x21F3A2 | Speichermodul 12 - Kapazitätsalterung - Kapazität zu gering | 0 | - |
| 0x21F3A3 | Speichermodul 13 - Kapazitätsalterung - Kapazität zu gering | 0 | - |
| 0x21F3A4 | Speichermodul 14 - Kapazitätsalterung - Kapazität zu gering | 0 | - |
| 0x21F3A5 | Speichermodul 15 - Kapazitätsalterung - Kapazität zu gering | 0 | - |
| 0x21F3A6 | Speichermodul 16 - Kapazitätsalterung - Kapazität zu gering | 0 | - |
| 0x21F3A7 | Speichermodul 17 - Kapazitätsalterung - Kapazität zu gering | 0 | - |
| 0x21F3A8 | Speichermodul 18 - Kapazitätsalterung - Kapazität zu gering | 0 | - |
| 0x21F3A9 | Speichermodul 19 - Kapazitätsalterung - Kapazität zu gering | 0 | - |
| 0x21F3AA | Speichermodul 20 - Kapazitätsalterung - Kapazität zu gering | 0 | - |
| 0x21F3AB | Speichermodul 21 - Kapazitätsalterung - Kapazität zu gering | 0 | - |
| 0x21F3AC | Speichermodul 22 - Kapazitätsalterung - Kapazität zu gering | 0 | - |
| 0x21F3AD | Speichermodul 23 - Kapazitätsalterung - Kapazität zu gering | 0 | - |
| 0x21F3AE | Speichermodul 24 - Kapazitätsalterung - Kapazität zu gering | 0 | - |
| 0x21F3AF | Speichermodul 25 - Kapazitätsalterung - Kapazität zu gering | 0 | - |
| 0x21F3B0 | Speichermodul 26 - Kapazitätsalterung - Kapazität zu gering | 0 | - |
| 0x21F3B1 | Speichermodul 27 - Kapazitätsalterung - Kapazität zu gering | 0 | - |
| 0xCAC528 | AE-CAN-FD Control Module Bus OFF | 0 | - |
| 0xCACBFF | Dummy-Fehlerspeichereintrag im Netzwerkfehlerbereich nur für Testzwecke | 1 | - |
| 0xCAD434 | Botschaft (Außentemperatur, ID: A_TEMP) fehlt | 1 | - |
| 0xCAD444 | Botschaft (CombinedChargerUnit1000msNo1, ID: CombinedChargerUnit1000msNo1) fehlt | 1 | - |
| 0xCAD448 | Botschaft (CombinedChargerUnit100msNo1, ID: CombinedChargerUnit100msNo1) fehlt | 1 | - |
| 0xCAD449 | Botschaft (CombinedChargerUnit100msNo1, ID: CombinedChargerUnit100msNo1) nicht aktuell | 1 | - |
| 0xCAD44A | Botschaft (CombinedChargerUnit100msNo1, ID: CombinedChargerUnit100msNo1) Prüfsumme falsch | 1 | - |
| 0xCAD450 | Botschaft (CombinedChargerUnit10msNo2, ID: CombinedChargerUnit10msNo2) fehlt | 1 | - |
| 0xCAD454 | Botschaft (CombinedChargerUnit20msNo1, ID: CombinedChargerUnit20msNo1) fehlt | 1 | - |
| 0xCAD455 | Botschaft (CombinedChargerUnit20msNo1, ID: CombinedChargerUnit20msNo1) nicht aktuell | 1 | - |
| 0xCAD456 | Botschaft (CombinedChargerUnit20msNo1, ID: CombinedChargerUnit20msNo1) Prüfsumme falsch | 1 | - |
| 0xCAD490 | Botschaft (Fahrgestellnummer, ID: FAHRGESTELLNUMMER) fehlt | 1 | - |
| 0xCAD498 | Botschaft (Fahrzeugzustand, ID: FZZSTD) fehlt | 1 | - |
| 0xCAD4A0 | Botschaft (Freigabe Kühlung Hochvoltspeicher, ID: RLS_COOL_HVSTO) fehlt | 1 | - |
| 0xCAD4B0 | Botschaft (Geschwindigkeit Fahrzeug, ID: V_VEH) fehlt | 1 | - |
| 0xCAD4B1 | Botschaft (Geschwindigkeit Fahrzeug, ID: V_VEH) nicht aktuell | 1 | - |
| 0xCAD4B2 | Botschaft (Geschwindigkeit Fahrzeug, ID: V_VEH) Prüfsumme falsch | 1 | - |
| 0xCAD4B8 | Botschaft (HighVoltagePowerManagement200msNo1, ID: HighVoltagePowerManagement200msNo1) fehlt | 1 | - |
| 0xCAD558 | Botschaft (Kilometerstand/Reichweite, ID: KILOMETERSTAND) fehlt | 1 | - |
| 0xCAD5C0 | Botschaft (Netzwerkmanagement-3 AE_CAN_FD, ID: NM3_AE_CAN_FD) fehlt | 1 | - |
| 0xCAD5F8 | Botschaft (Relativzeit BN2020, ID: RELATIVZEIT) fehlt | 1 | - |
| 0xCAD5FC | Botschaft (Sicher Fahrgestellnummer, ID: SECU_FAHRGESTELLNUMMER) fehlt | 1 | - |
| 0xCAD600 | Botschaft (Sicher Response, ID: SECU_RESP) fehlt | 1 | - |
| 0xCAD618 | Botschaft (Status Crash, ID: ST_CR) fehlt | 1 | - |
| 0xCAD714 | Botschaft (Zustand Fahrzeug, ID: CON_VEH) fehlt | 1 | - |
| 0xCAD715 | Botschaft (Zustand Fahrzeug, ID: CON_VEH) nicht aktuell | 1 | - |
| 0xCAD716 | Botschaft (Zustand Fahrzeug, ID: CON_VEH) Prüfsumme falsch | 1 | - |
| 0xCAD720 | Botschaft (Wärmemanagement Motorsteuerung, ID: HT_MGT_ENG_CTR) fehlt | 1 | - |
| 0xCAD775 | Botschaft (SecOcP2TestSecOcEA_CCU, ID: SecOcP2TestSecOcEA_CCU) fehlt | 1 | - |
| 0xCAD77B | Botschaft (SecOcP2TestSecOcEA_TEE1, ID: SecOcP2TestSecOcEA_TEE1) fehlt | 1 | - |
| 0xCAD77E | Botschaft (SecOcP2TestSecOcEA_TEE2, ID: SecOcP2TestSecOcEA_TEE2) fehlt | 1 | - |
| 0xCAD799 | Botschaft (TestSecOcEA_CCU, ID: TestSecOcEA_CCU) fehlt | 1 | - |
| 0xCAD79F | Botschaft (TestSecOcEA_TEE1, ID: TestSecOcEA_TEE1) fehlt | 1 | - |
| 0xCAD7A2 | Botschaft (TestSecOcEA_TEE2, ID: TestSecOcEA_TEE2) fehlt | 1 | - |
| 0xCAD7A5 | Botschaft (Kilometerstand_2, ID: Kilometerstand_2) fehlt | 1 | - |
...
Dimensions: 92 rows × 4 columns

| ORT | ORTTEXT | EREIGNIS_DTC | FEHLERKLASSE |
| --- | --- | --- | --- |
| 0x21F002 | Speichermodul 01 - Bauteilschutz - Temperatur - Leistungsgrenze aktiv | 1 | - |
| 0x21F003 | Speichermodul 02 - Bauteilschutz - Temperatur - Leistungsgrenze aktiv | 0 | - |
| 0x21F006 | Speichermodul 03 - Bauteilschutz - Temperatur - Leistungsgrenze aktiv | 0 | - |
| 0x21F007 | Speichermodul 04 - Bauteilschutz - Temperatur - Leistungsgrenze aktiv | 0 | - |
| 0x21F008 | Speichermodul 05 - Bauteilschutz - Temperatur - Leistungsgrenze aktiv | 0 | - |
| 0x21F017 | Speichermodul 06 - Bauteilschutz - Temperatur - Leistungsgrenze aktiv | 0 | - |
| 0x21F01B | Speichermodul 07 - Bauteilschutz - Temperatur - Leistungsgrenze aktiv | 0 | - |
| 0x21F01C | Speichermodul 08 - Bauteilschutz - Temperatur - Leistungsgrenze aktiv | 0 | - |
| 0x21F026 | Speichermodul 09 - Bauteilschutz - Temperatur - Leistungsgrenze aktiv | 0 | - |
| 0x21F027 | Speichermodul 10 - Bauteilschutz - Temperatur - Leistungsgrenze aktiv | 0 | - |
| 0x21F030 | Speichermodul 11 - Bauteilschutz - Temperatur - Leistungsgrenze aktiv | 0 | - |
| 0x21F031 | Speichermodul 12 - Bauteilschutz - Temperatur - Leistungsgrenze aktiv | 0 | - |
| 0x21F032 | Speichermodul 13 - Bauteilschutz - Temperatur - Leistungsgrenze aktiv | 0 | - |
| 0x21F033 | Speichermodul 14 - Bauteilschutz - Temperatur - Leistungsgrenze aktiv | 0 | - |
| 0x21F034 | Speichermodul 15 - Bauteilschutz - Temperatur - Leistungsgrenze aktiv | 0 | - |
| 0x21F035 | Speichermodul 16 - Bauteilschutz - Temperatur - Leistungsgrenze aktiv | 0 | - |
| 0x21F036 | Speichermodul 17 - Bauteilschutz - Temperatur - Leistungsgrenze aktiv | 0 | - |
| 0x21F037 | Speichermodul 18 - Bauteilschutz - Temperatur - Leistungsgrenze aktiv | 0 | - |
| 0x21F038 | Speichermodul 19 - Bauteilschutz - Temperatur - Leistungsgrenze aktiv | 0 | - |
| 0x21F039 | Speichermodul 20 - Bauteilschutz - Temperatur - Leistungsgrenze aktiv | 0 | - |
| 0x21F03A | Speichermodul 21 - Bauteilschutz - Temperatur - Leistungsgrenze aktiv | 0 | - |
| 0x21F03B | Speichermodul 22 - Bauteilschutz - Temperatur - Leistungsgrenze aktiv | 0 | - |
| 0x21F03C | Speichermodul 23 - Bauteilschutz - Temperatur - Leistungsgrenze aktiv | 0 | - |
| 0x21F03D | Speichermodul 24 - Bauteilschutz - Temperatur - Leistungsgrenze aktiv | 0 | - |
| 0x21F03E | Speichermodul 25 - Bauteilschutz - Temperatur - Leistungsgrenze aktiv | 0 | - |
| 0x21F03F | Speichermodul 26 - Bauteilschutz - Temperatur - Leistungsgrenze aktiv | 0 | - |
| 0x21F040 | Speichermodul 27 - Bauteilschutz - Temperatur - Leistungsgrenze aktiv | 0 | - |
| 0x21F0F5 | Speicher - Symmetrierschaltung - Hohe Asymmetrie | 0 | - |
| 0x21F2A9 | Battery Management Unit (BMU) - Crasherkennung - kurzzeitiges Crash Event | 0 | - |
| 0x21F2B1 | Speicher - Kühlmittel - Temperatursensor 01 - Kurzschluss nach Plus/Masse | 0 | - |
| 0x21F2B2 | Schütze - Hauptschütz HV-Minus - Zustandsermittlung fehlgeschlagen | 0 | - |
| 0x21F2B3 | Schütze - Hauptschütz HV-Plus - Zustandsermittlung fehlgeschlagen | 0 | - |
| 0x21F2B4 | Schütze - Vorladeschütz HV-Minus - Zustandsermittlung fehlgeschlagen | 0 | - |
| 0x21F2B5 | Schütze - Ladeschütz HV-Minus - Zustandsermittlung fehlgeschlagen | 0 | - |
| 0x21F2B6 | Schütze - Ladeschütz HV-Plus - Zustandsermittlung fehlgeschlagen | 0 | - |
| 0x21F2C0 | Battery Management Unit (BMU) - Status - Vorladung temporär gesperrt | 0 | - |
| 0x21F302 | CSC - Entladeschutz aktiv | 0 | - |
| 0x21F303 | Speicher, Bauteilschutz, Stromgrenzen: Reduzierung aktiv | 0 | - |
| 0x21F319 | Speicher - Kühlmittel - Temperatursensor 02 - Kurzschluss nach Plus/Masse | 0 | - |
| 0x21F31A | CSC 01 - Symmetrierschaltung - Temperatursensoren - Oberer/Unterer Schwellenwert über-/unterschritten | 0 | - |
| 0x21F31B | CSC 02 - Symmetrierschaltung - Temperatursensoren - Oberer/Unterer Schwellenwert über-/unterschritten | 0 | - |
| 0x21F31C | CSC 03 - Symmetrierschaltung - Temperatursensoren - Oberer/Unterer Schwellenwert über-/unterschritten | 0 | - |
| 0x21F31D | CSC 04 - Symmetrierschaltung - Temperatursensoren - Oberer/Unterer Schwellenwert über-/unterschritten | 0 | - |
| 0x21F31E | CSC 05 - Symmetrierschaltung - Temperatursensoren - Oberer/Unterer Schwellenwert über-/unterschritten | 0 | - |
| 0x21F31F | CSC 06 - Symmetrierschaltung - Temperatursensoren - Oberer/Unterer Schwellenwert über-/unterschritten | 0 | - |
| 0x21F320 | CSC 07 - Symmetrierschaltung - Temperatursensoren - Oberer/Unterer Schwellenwert über-/unterschritten | 0 | - |
| 0x21F327 | Battery Management Unit (BMU) - Spannungssensor KL30C - Kurzschluss nach Plus/Masse | 0 | - |
| 0x21F32F | Speichermodul 01 - Bauteilschutz - Spannungssensoren - Messbereichsverletzung | 0 | - |
| 0x21F330 | Speichermodul 02 - Bauteilschutz - Spannungssensoren - Messbereichsverletzung | 0 | - |
| 0x21F331 | Speichermodul 03 - Bauteilschutz - Spannungssensoren - Messbereichsverletzung | 0 | - |
| 0x21F332 | Speichermodul 04 - Bauteilschutz - Spannungssensoren - Messbereichsverletzung | 0 | - |
| 0x21F333 | Speichermodul 05 - Bauteilschutz - Spannungssensoren - Messbereichsverletzung | 0 | - |
| 0x21F334 | Speichermodul 06 - Bauteilschutz - Spannungssensoren - Messbereichsverletzung | 0 | - |
| 0x21F335 | Speichermodul 07 - Bauteilschutz - Spannungssensoren - Messbereichsverletzung | 0 | - |
| 0x21F336 | Speichermodul 08 - Bauteilschutz - Spannungssensoren - Messbereichsverletzung | 0 | - |
| 0x21F337 | Speichermodul 09 - Bauteilschutz - Spannungssensoren - Messbereichsverletzung | 0 | - |
| 0x21F338 | Speichermodul 10 - Bauteilschutz - Spannungssensoren - Messbereichsverletzung | 0 | - |
| 0x21F339 | Speichermodul 11 - Bauteilschutz - Spannungssensoren - Messbereichsverletzung | 0 | - |
| 0x21F33A | Speichermodul 12 - Bauteilschutz - Spannungssensoren - Messbereichsverletzung | 0 | - |
| 0x21F33B | Speichermodul 13 - Bauteilschutz - Spannungssensoren - Messbereichsverletzung | 0 | - |
| 0x21F33C | Speichermodul 14 - Bauteilschutz - Spannungssensoren - Messbereichsverletzung | 0 | - |
| 0x21F33D | Speichermodul 15 - Bauteilschutz - Spannungssensoren - Messbereichsverletzung | 0 | - |
| 0x21F33E | Speichermodul 16 - Bauteilschutz - Spannungssensoren - Messbereichsverletzung | 0 | - |
| 0x21F33F | Speichermodul 17 - Bauteilschutz - Spannungssensoren - Messbereichsverletzung | 0 | - |
| 0x21F340 | Speichermodul 18 - Bauteilschutz - Spannungssensoren - Messbereichsverletzung | 0 | - |
| 0x21F341 | Speichermodul 19 - Bauteilschutz - Spannungssensoren - Messbereichsverletzung | 0 | - |
| 0x21F342 | Speichermodul 20 - Bauteilschutz - Spannungssensoren - Messbereichsverletzung | 0 | - |
| 0x21F343 | Speichermodul 21 - Bauteilschutz - Spannungssensoren - Messbereichsverletzung | 0 | - |
| 0x21F344 | Speichermodul 22 - Bauteilschutz - Spannungssensoren - Messbereichsverletzung | 0 | - |
| 0x21F345 | Speichermodul 23 - Bauteilschutz - Spannungssensoren - Messbereichsverletzung | 0 | - |
| 0x21F346 | Speichermodul 24 - Bauteilschutz - Spannungssensoren - Messbereichsverletzung | 0 | - |
| 0x21F347 | Speichermodul 25 - Bauteilschutz - Spannungssensoren - Messbereichsverletzung | 0 | - |
| 0x21F348 | Speichermodul 26 - Bauteilschutz - Spannungssensoren - Messbereichsverletzung | 0 | - |
| 0x21F349 | Speichermodul 27 - Bauteilschutz - Spannungssensoren - Messbereichsverletzung | 0 | - |
| 0x21F34A | Speichermodul 28 - Bauteilschutz - Spannungssensoren - Messbereichsverletzung | 0 | - |
| 0x21F38C | Battery Management Unit (BMU), Codierung DC Charging: nicht korrekt | 0 | - |
| 0x21F395 | Battery Management Unit (BMU) - Relais Treiberschaltung - Qualifier des Spulenstromsignals ist ungültig | 0 | - |
| 0x21F3B2 | Isolationsüberwachung - Spannungsmessung fehlgeschlagen | 0 | - |
| 0x21F3B3 | Isolationsüberwachung - Referenzspannungsmessung fehlgeschlagen | 0 | - |
| 0x21F3B4 | Battery Management Unit (BMU) - Service Disconnect - elektrischen Fehler | 0 | - |
| 0x21F3B5 | Battery Management Unit (BMU) - Service Disconnect - Messsignal unplausibel | 0 | - |
| 0x21F3B6 | Battery Management Unit (BMU) - Schnellentladung - Treiber Selbsttest fehlgeschlagen | 0 | - |
| 0x21F3B7 | Battery Management Unit (BMU) - Schnellentladung - Highside Treiber Fehler | 0 | - |
| 0x21F3B8 | Battery Management Unit (BMU) - Schnellentladung - Lowside Treiber Fehler | 0 | - |
| 0x21F3B9 | Battery Management Unit (BMU) - Schnellentladung - Widerstandsmessung Zündpille fehlgeschlagen | 0 | - |
| 0x21F3BA | Battery Management Unit (BMU) - Powerfuse - Treiber Selbsttest fehlgeschlagen | 0 | - |
| 0x21F3BB | Battery Management Unit (BMU) - Powerfuse - Treiber Reset fehlgeschlagen | 0 | - |
| 0x21F3BC | Battery Management Unit (BMU) - Powerfuse - Highside Treiber Fehler | 0 | - |
| 0x21F3BD | Battery Management Unit (BMU) - Powerfuse - Lowside Treiber Fehler | 0 | - |
| 0x21F3BE | Battery Management Unit (BMU) - Powerfuse - Widerstandsmessung Zündpille fehlgeschlagen | 0 | - |
| 0x800730 | Fehler der Fahrzeug-Security | 0 | - |
| 0xFFFFFF | unbekannter Fehlerort | 0 | - |
...
| RESULTNAME | STR | STPR | RRR | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_EAN_BTRV_HAUPT_SG_ADRESSE_WERT | - | - | + | HEX | high | unsigned char | - | - | - | - | - | SG-Adresse des Haupt-Steuergerätes [1 Byte Hex]. |
| STAT_EAN_BTRV_MAX_ANZAHL_DATENSAETZE_WERT | - | - | + | - | high | unsigned char | - | - | 1.0 | 1.0 | 0.0 | Anzahl der Datensätze im SG, für die eine Kombination aus Typ, Position und DMC pro Bauteil abgespeichert ist [1 Byte Zähler]. |
| STAT_EAN_BTRV_DATENSATZ_WERT | - | - | + | - | high | unsigned char | - | - | 1.0 | 1.0 | 0.0 | Position des Datensatz zur BTRV im SG. Position 0 ist immer für die Daten des Haupt-SGs zu verwenden [1 Byte Zähler]. |
| STAT_EAN_BTRV_VORGANG | - | - | + | 0-n | high | unsigned char | - | TAB_EAN_BTRV_VORGANG | - | - | - | Welcher Vorgang (Lesen, Ändern, Löschen) wurde am gewählten Datensatz ausgeführt [1 Byte Diskret]. |
| STAT_EAN_BTRV_BAUTEIL_TYP | - | - | + | 0-n | high | unsigned char | - | TAB_EAN_BTRV_BAUTEIL_TYP | - | - | - | Typ des BTRV-Bauteils [1 Byte Diskret]. |
| STAT_EAN_BTRV_BAUTEIL_POSITION_WERT | - | - | + | - | high | unsigned char | - | - | 1.0 | 1.0 | 0.0 | Bauteil-Zähler, wenn im Haupt-SG mehrere Subkomponenten vom gleichen Bauteil-Typ verbaut sind [1 Byte Zähler]. |
| STAT_EAN_BTRV_BAUTEIL_DMC_TEXT | - | - | + | TEXT | high | string[31] | - | - | 1.0 | 1.0 | 0.0 | Data-Matrix-Code des Bauteils unter Typ/Position nach GS91010-2 Variante 4a [31 Zeichen String]. |
...
| RESULTNAME | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_CURR_ERR_INT_LIM_T1_WERT | As | - | unsigned int | - | - | 1.0 | 100.0 | 0.0 | Bei T &lt;= -25: Schwellwert des Fehlerintegrals (IerrIntLim) |
| STAT_CURR_ERR_INT_LIM_T2_WERT | As | - | unsigned int | - | - | 1.0 | 100.0 | 0.0 | Bei T &gt; -10: Schwellwert des Fehlerintegrals (IerrIntLim) |
| STAT_HIS_CHA_ERR_LIM_STROM_1_T1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Bei T &lt;= -10: Dauer in Minuten in der Klasse 0 &lt; IerrInt &lt; IerrIntLim  |
| STAT_HIS_CHA_ERR_LIM_STROM_2_T1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Bei T &lt;= -10: Dauer in Minuten in der Klasse IerrInt &gt; IerrIntLim  |
| STAT_HIS_CHA_ERR_LIM_STROM_1_T2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Bei -10 &lt; T &lt;= 5: Dauer in Minuten in der Klasse 0 &lt; IerrInt &lt; IerrIntLim  |
| STAT_HIS_CHA_ERR_LIM_STROM_2_T2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Bei -10 &lt; T &lt;= 5: Dauer in Minuten in der Klasse IerrInt &gt; IerrIntLim  |
| STAT_HIS_CHA_ERR_LIM_STROM_1_T3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Bei 5 &lt; T &lt;= 25: Dauer in Minuten in der Klasse 0 &lt; IerrInt &lt; IerrIntLim  |
| STAT_HIS_CHA_ERR_LIM_STROM_2_T3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Bei 5 &lt; T &lt;= 25: Dauer in Minuten in der Klasse IerrInt &gt; IerrIntLim  |
| STAT_HIS_CHA_ERR_LIM_STROM_1_T4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Bei 25 &lt; T &lt;= 40: Dauer in Minuten in der Klasse 0 &lt; IerrInt &lt; IerrIntLim  |
| STAT_HIS_CHA_ERR_LIM_STROM_2_T4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Bei 25 &lt; T &lt;= 40: Dauer in Minuten in der Klasse IerrInt &gt; IerrIntLim  |
| STAT_HIS_CHA_ERR_LIM_STROM_1_T5_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Bei 40 &lt; T: Dauer in Minuten in der Klasse 0 &lt; IerrInt &lt; IerrIntLim  |
| STAT_HIS_CHA_ERR_LIM_STROM_2_T5_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Bei 40 &lt; T: Dauer in Minuten in der Klasse IerrInt &gt; IerrIntLim  |

<a id="table-res-0xe49b-d"></a>
### RES_0XE49B_D
...
| STAT_CURR_ERR_INT_LIM_T1_WERT | As | - | unsigned int | - | - | 1.0 | 100.0 | 0.0 | Bei T &lt;= -25: Schwellwert des Fehlerintegrals (IerrIntLim) |
| STAT_CURR_ERR_INT_LIM_T2_WERT | As | - | unsigned int | - | - | 1.0 | 100.0 | 0.0 | Bei T &gt; -10: Schwellwert des Fehlerintegrals (IerrIntLim) |
| STAT_HIS_DCHA_ERR_LIM_STROM_1_T1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Bei T &lt;= -10: Dauer in Minuten in der Klasse 0 &lt; IerrInt &lt; IerrIntLim  |
| STAT_HIS_DCHA_ERR_LIM_STROM_2_T1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Bei T &lt;= -10: Dauer in Minuten in der Klasse IerrInt &gt; IerrIntLim  |
| STAT_HIS_DCHA_ERR_LIM_STROM_1_T2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Bei -10 &lt; T &lt;= 5: Dauer in Minuten in der Klasse 0 &lt; IerrInt &lt; IerrIntLim  |
| STAT_HIS_DCHA_ERR_LIM_STROM_2_T2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Bei -10 &lt; T &lt;= 5: Dauer in Minuten in der Klasse IerrInt &gt; IerrIntLim  |
| STAT_HIS_DCHA_ERR_LIM_STROM_1_T3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Bei 5 &lt; T &lt;= 25: Dauer in Minuten in der Klasse 0 &lt; IerrInt &lt; IerrIntLim  |
| STAT_HIS_DCHA_ERR_LIM_STROM_2_T3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Bei 5 &lt; T &lt;= 25: Dauer in Minuten in der Klasse IerrInt &gt; IerrIntLim  |
| STAT_HIS_DCHA_ERR_LIM_STROM_1_T4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Bei 25 &lt; T &lt;= 40: Dauer in Minuten in der Klasse 0 &lt; IerrInt &lt; IerrIntLim  |
| STAT_HIS_DCHA_ERR_LIM_STROM_2_T4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Bei 25 &lt; T &lt;= 40: Dauer in Minuten in der Klasse IerrInt &gt; IerrIntLim  |
| STAT_HIS_DCHA_ERR_LIM_STROM_1_T5_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Bei 40 &lt; T: Dauer in Minuten in der Klasse 0 &lt; IerrInt &lt; IerrIntLim  |
| STAT_HIS_DCHA_ERR_LIM_STROM_2_T5_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Bei 40 &lt; T: Dauer in Minuten in der Klasse IerrInt &gt; IerrIntLim  |
...
| STAT_PRAEDIZIERTE_STROM_ENTLADEN_AKT_HVS_WERT | A | high | signed int | - | - | 1.0 | 10.0 | 0.0 | Prädizierter mittlerer Strom beim Entladen, auf Basis der prädizierten mittleren Speicherleistung |
| STAT_PRAEDIZIERTE_STROM_ENTLADEN_MAX_HVS_WERT | A | high | signed int | - | - | 1.0 | 10.0 | 0.0 | Prädizierter mittlerer Strom beim vollständigen Entladen, auf Basis der prädizierten mittleren Speicherleistung |
| STAT_PRAEDIZIERTE_STROM_LADEN_HVS_WERT | A | high | signed int | - | - | 1.0 | 10.0 | 0.0 | Prädizierter mittlerer Strom beim Laden, auf Basis der prädizierten mittleren Speicherleistung |
...
| RESULTNAME | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_SYM_MODUS | 0-n | high | unsigned char | - | TAB_HVS_SYMMETRIERMODUS | - | - | - | Aktueller Symmetriermodus |
| STAT_MAX_ASYMMETRIE_AKT_WERT | As | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Aktueller maximaler Symmetrierbedarf |
| STAT_SYM_ZEIT_BEDARF_WERT | s | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Zeitstempel bei Symmetrierbedarfsberechnung |
| STAT_UCELL_MIN_BEDARF_WERT | V | high | unsigned int | - | - | 1.0 | 1000.0 | 0.0 | Minimale Zellspannung bei letzter Symmetrierbedarfsberechnung |
| STAT_UCELL_MEAN_BEDARF_WERT | V | high | unsigned int | - | - | 1.0 | 1000.0 | 0.0 | Durchschnittliche Zellspannung bei letzter Symmetrierbedarfsberechnung |
| STAT_UCELL_MAX_BEDARF_WERT | V | high | unsigned int | - | - | 1.0 | 1000.0 | 0.0 | Maximale Zellspannung bei letzter Symmetrierbedarfsberechnung |
| STAT_SOC_MIN_BEDARF_WERT | % | high | signed int | - | - | 1.0 | 100.0 | 0.0 | Minimaler SoC bei letzter Symmetrierbedarfsberechnung |
| STAT_SOC_MEAN_BEDARF_WERT | % | high | signed int | - | - | 1.0 | 100.0 | 0.0 | Durchschnittlicher SoC bei letzter Symmetrierbedarfsberechnung |
| STAT_SOC_MAX_BEDARF_WERT | % | high | signed int | - | - | 1.0 | 100.0 | 0.0 | Maximaler SoC bei letzter Symmetrierbedarfsberechnung |
| STAT_MAX_ASYMMETRIE_BEDARF_WERT | As | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Maximaler Symmetrierbedarf bei letzter Symmetrierbedarfsberechnung |
| STAT_SYM_ZEIT_ENDE_WERT | s | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Zeitstempel bei letzter vollständig abgeschlossener Symmetrierung |
| STAT_UCELL_MIN_ENDE_WERT | V | high | unsigned int | - | - | 1.0 | 1000.0 | 0.0 | Minimale Zellspannung bei letzter vollständig abgeschlossener Symmetrierung |
| STAT_UCELL_MEAN_ENDE_WERT | V | high | unsigned int | - | - | 1.0 | 1000.0 | 0.0 | Durchschnittliche Zellspannung bei letzter vollständig abgeschlossener Symmetrierung |
| STAT_UCELL_MAX_ENDE_WERT | V | high | unsigned int | - | - | 1.0 | 1000.0 | 0.0 | Maximale Zellspannung bei letzter vollständig abgeschlossener Symmetrierung |
| STAT_SOC_MIN_ENDE_WERT | % | high | signed int | - | - | 1.0 | 100.0 | 0.0 | Minimaler SoC bei letzter vollständig abgeschlossener Symmetrierung |
| STAT_SOC_MEAN_ENDE_WERT | % | high | signed int | - | - | 1.0 | 100.0 | 0.0 | Durchschnittlicher SoC bei letzter vollständig abgeschlossener Symmetrierung |
| STAT_SOC_MAX_ENDE_WERT | % | high | signed int | - | - | 1.0 | 100.0 | 0.0 | Maximaler SoC bei letzter vollständig abgeschlossener Symmetrierung |
| STAT_ZEIT_AKT_WERT | s | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Aktueller Zeitstempel |

<a id="table-res-0xe4cc-d"></a>
### RES_0XE4CC_D
...
| RESULTNAME | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_RB1_SOC_MIN_WERT | % | high | signed int | - | - | 1.0 | 100.0 | 0.0 | SOC RB1: Minimaler Ladezustand aller Zellen |
| STAT_RB1_SOC_DIFF_WERT | % | - | unsigned int | - | - | 1.0 | 100.0 | 0.0 | SOC RB1: Differenz zwischen dem mittleren und minimalem Ladezustand aller Zellen |
| STAT_RB1_SOC_ZEIT_WERT | s | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | SOC RB1: Aktueller Zeitstempel |
| STAT_RB2_SOC_MIN_WERT | % | - | signed int | - | - | 1.0 | 100.0 | 0.0 | SOC RB2: Minimaler Ladezustand aller Zellen |
| STAT_RB2_SOC_DIFF_WERT | % | - | unsigned int | - | - | 1.0 | 100.0 | 0.0 | SOC RB2: Differenz zwischen dem mittleren und minimalem Ladezustand aller Zellen |
| STAT_RB2_SOC_ZEIT_WERT | s | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | SOC RB2: Aktueller Zeitstempel |
| STAT_RB3_SOC_MIN_WERT | % | - | signed int | - | - | 1.0 | 100.0 | 0.0 | SOC RB3: Minimaler Ladezustand aller Zellen |
| STAT_RB3_SOC_DIFF_WERT | % | - | unsigned int | - | - | 1.0 | 100.0 | 0.0 | SOC RB3: Differenz zwischen dem mittleren und minimalem Ladezustand aller Zellen |
| STAT_RB3_SOC_ZEIT_WERT | s | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | SOC RB3: Aktueller Zeitstempel |
| STAT_RB4_SOC_MIN_WERT | % | - | signed int | - | - | 1.0 | 100.0 | 0.0 | SOC RB4: Minimaler Ladezustand aller Zellen |
| STAT_RB4_SOC_DIFF_WERT | % | - | unsigned int | - | - | 1.0 | 100.0 | 0.0 | SOC RB4: Differenz zwischen dem mittleren und minimalem Ladezustand aller Zellen |
| STAT_RB4_SOC_ZEIT_WERT | s | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | SOC RB4: Aktueller Zeitstempel |
| STAT_RB5_SOC_MIN_WERT | % | - | signed int | - | - | 1.0 | 100.0 | 0.0 | SOC RB5: Minimaler Ladezustand aller Zellen |
| STAT_RB5_SOC_DIFF_WERT | % | - | unsigned int | - | - | 1.0 | 100.0 | 0.0 | SOC RB5: Differenz zwischen dem mittleren und minimalem Ladezustand aller Zellen |
| STAT_RB5_SOC_ZEIT_WERT | s | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | SOC RB5: Aktueller Zeitstempel |
| STAT_SOC_MIN_ID_ZELLE_WERT | - | - | unsigned char | - | - | 1.0 | 1.0 | 0.0 | SOC: Index der Zelle mit minimalem Ladezustand |
| STAT_SOC_COUNTER_WERT | - | - | unsigned char | - | - | 1.0 | 1.0 | 0.0 | SOC: Zähler wie oft der Ringspeicher seit dem letzten Reset beschrieben wurde |
| STAT_RB1_SOH_C_MIN_WERT | % | - | unsigned int | - | - | 1.0 | 100.0 | 0.0 | SOH_C RB1: Minimaler Alterungszustand der Kapazität aller Zellen des HV-Speichers |
| STAT_RB1_SOH_C_DIFF_WERT | % | - | unsigned int | - | - | 1.0 | 100.0 | 0.0 | SOH_C RB1: Differenz zwischen dem mittleren und minimalem Alterungszustand aller Zellen |
| STAT_RB1_SOH_C_ZEIT_WERT | s | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | SOH_C RB1: Aktueller Zeitstempel |
| STAT_RB2_SOH_C_MIN_WERT | % | - | unsigned int | - | - | 1.0 | 100.0 | 0.0 | SOH_C RB2: Minimaler Alterungszustand der Kapazität aller Zellen des HV-Speichers |
| STAT_RB2_SOH_C_DIFF_WERT | % | - | unsigned int | - | - | 1.0 | 100.0 | 0.0 | SOH_C RB2: Differenz zwischen dem mittleren und minimalem Alterungszustand aller Zellen |
| STAT_RB2_SOH_C_ZEIT_WERT | s | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | SOH_C RB2: Aktueller Zeitstempel |
| STAT_RB3_SOH_C_MIN_WERT | % | - | unsigned int | - | - | 1.0 | 100.0 | 0.0 | SOH_C RB3: Minimaler Alterungszustand der Kapazität aller Zellen des HV-Speichers |
| STAT_RB3_SOH_C_DIFF_WERT | % | - | unsigned int | - | - | 1.0 | 100.0 | 0.0 | SOH_C RB3: Differenz zwischen dem mittleren und minimalem Alterungszustand aller Zellen |
| STAT_RB3_SOH_C_ZEIT_WERT | s | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | SOH_C RB3: Aktueller Zeitstempel |
| STAT_RB4_SOH_C_MIN_WERT | % | - | unsigned int | - | - | 1.0 | 100.0 | 0.0 | SOH_C RB4: Minimaler Alterungszustand der Kapazität aller Zellen des HV-Speichers |
| STAT_RB4_SOH_C_DIFF_WERT | % | - | unsigned int | - | - | 1.0 | 100.0 | 0.0 | SOH_C RB4: Differenz zwischen dem mittleren und minimalem Alterungszustand aller Zellen |
| STAT_RB4_SOH_C_ZEIT_WERT | s | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | SOH_C RB4: Aktueller Zeitstempel |
| STAT_RB5_SOH_C_MIN_WERT | % | - | unsigned int | - | - | 1.0 | 100.0 | 0.0 | SOH_C RB5: Minimaler Alterungszustand der Kapazität aller Zellen des HV-Speichers |
| STAT_RB5_SOH_C_DIFF_WERT | % | - | unsigned int | - | - | 1.0 | 100.0 | 0.0 | SOH_C RB5: Differenz zwischen dem mittleren und minimalem Alterungszustand aller Zellen |
| STAT_RB5_SOH_C_ZEIT_WERT | s | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | SOH_C RB5: Aktueller Zeitstempel |
| STAT_SOH_C_MIN_ID_ZELLE_WERT | - | - | unsigned char | - | - | 1.0 | 1.0 | 0.0 | SOH_C: Index der Zelle mit minimalem Alterungszustand |
| STAT_SOH_C_COUNTER_WERT | - | - | unsigned char | - | - | 1.0 | 1.0 | 0.0 | SOH_C: Zähler wie oft der Ringspeicher seit dem letzten Reset beschrieben wurde |
| STAT_RB1_SOH_R_ALPHA_LONG_MAX_WERT | - | - | unsigned int | - | - | 1.0 | 100.0 | 0.0 | SOH_R RB1: Maximaler Innenwiderstandskorrekturfaktor AlphaLong aller Zellen |
| STAT_RB1_SOH_R_ALPHA_LONG_DIFF_WERT | - | - | unsigned int | - | - | 1.0 | 100.0 | 0.0 | SOH_R RB1: Differenz zwischen dem maximalem und mittleren Innenwiderstandskorrekturfaktor AlphaLong aller Zellen |
| STAT_RB1_SOH_R_ZEIT_WERT | s | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | SOH_R RB1: Aktueller Zeitstempel |
| STAT_RB2_SOH_R_ALPHA_LONG_MAX_WERT | - | - | unsigned int | - | - | 1.0 | 100.0 | 0.0 | SOH_R RB2: Maximaler Innenwiderstandskorrekturfaktor AlphaLong aller Zellen |
| STAT_RB2_SOH_R_ALPHA_LONG_DIFF_WERT | - | - | unsigned int | - | - | 1.0 | 100.0 | 0.0 | SOH_R RB2: Differenz zwischen dem maximalem und mittleren Innenwiderstandskorrekturfaktor AlphaLong aller Zellen |
| STAT_RB2_SOH_R_ZEIT_WERT | s | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | SOH_R RB2: Aktueller Zeitstempel |
| STAT_RB3_SOH_R_ALPHA_LONG_MAX_WERT | - | - | unsigned int | - | - | 1.0 | 100.0 | 0.0 | SOH_R RB3: Maximaler Innenwiderstandskorrekturfaktor AlphaLong aller Zellen |
| STAT_RB3_SOH_R_ALPHA_LONG_DIFF_WERT | - | - | unsigned int | - | - | 1.0 | 100.0 | 0.0 | SOH_R RB3: Differenz zwischen dem maximalem und mittleren Innenwiderstandskorrekturfaktor AlphaLong aller Zellen |
| STAT_RB3_SOH_R_ZEIT_WERT | s | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | SOH_R RB3: Aktueller Zeitstempel |
| STAT_RB4_SOH_R_ALPHA_LONG_MAX_WERT | - | - | unsigned int | - | - | 1.0 | 100.0 | 0.0 | SOH_R RB4: Maximaler Innenwiderstandskorrekturfaktor AlphaLong aller Zellen |
| STAT_RB4_SOH_R_ALPHA_LONG_DIFF_WERT | - | - | unsigned int | - | - | 1.0 | 100.0 | 0.0 | SOH_R RB4: Differenz zwischen dem maximalem und mittleren Innenwiderstandskorrekturfaktor AlphaLong aller Zellen |
| STAT_RB4_SOH_R_ZEIT_WERT | s | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | SOH_R RB4: Aktueller Zeitstempel |
| STAT_RB5_SOH_R_ALPHA_LONG_MAX_WERT | - | - | unsigned int | - | - | 1.0 | 100.0 | 0.0 | SOH_R RB5: Maximaler Innenwiderstandskorrekturfaktor AlphaLong aller Zellen |
| STAT_RB5_SOH_R_ALPHA_LONG_DIFF_WERT | - | - | unsigned int | - | - | 1.0 | 100.0 | 0.0 | SOH_R RB5: Differenz zwischen dem maximalem und mittleren Innenwiderstandskorrekturfaktor AlphaLong aller Zellen |
| STAT_RB5_SOH_R_ZEIT_WERT | s | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | SOH_R RB5: Aktueller Zeitstempel |
| STAT_SOH_R_ALPHA_LONG_MAX_ID_ZELLE_WERT | - | - | unsigned char | - | - | 1.0 | 1.0 | 0.0 | RB3: Index der Zelle mit maximalem Innenwiderstandskorrekturfaktor AlphaLong |
| STAT_SOH_R_COUNTER_WERT | - | - | unsigned char | - | - | 1.0 | 1.0 | 0.0 | RB3: Zähler wie oft der Ringspeicher seit dem letzten Reset beschrieben wurde |
| STAT_ERROR_SOC_ZELL_ID_01_WERT | - | - | unsigned char | - | - | 1.0 | 1.0 | 0.0 | SOC: Index der Zelle für Fehler erhöhter Ladungsverlust 01 |
| STAT_ERROR_SOC_SCORE_01_WERT | - | - | unsigned char | - | - | 1.0 | 1.0 | 0.0 | SOC: Auf Zellindex bezogener Zähler für Wahrscheinlichkeit von Fehler erhöhter Ladungsverlust 01 |
| STAT_ERROR_SOC_ZELL_ID_02_WERT | - | - | unsigned char | - | - | 1.0 | 1.0 | 0.0 | SOC: Index der Zelle für Fehler erhöhter Ladungsverlust 02 |
| STAT_ERROR_SOC_SCORE_02_WERT | - | - | unsigned char | - | - | 1.0 | 1.0 | 0.0 | SOC: Auf Zellindex bezogener Zähler für Wahrscheinlichkeit von Fehler erhöhter Ladungsverlust 02 |
| STAT_ERROR_SOC_ZELL_ID_03_WERT | - | - | unsigned char | - | - | 1.0 | 1.0 | 0.0 | SOC: Index der Zelle für Fehler erhöhter Ladungsverlust 03 |
| STAT_ERROR_SOC_SCORE_03_WERT | - | - | unsigned char | - | - | 1.0 | 1.0 | 0.0 | SOC: Auf Zellindex bezogener Zähler für Wahrscheinlichkeit von Fehler erhöhter Ladungsverlust 03 |
| STAT_ERROR_SOC_ZELL_ID_04_WERT | - | - | unsigned char | - | - | 1.0 | 1.0 | 0.0 | SOC: Index der Zelle für Fehler erhöhter Ladungsverlust 04 |
| STAT_ERROR_SOC_SCORE_04_WERT | - | - | unsigned char | - | - | 1.0 | 1.0 | 0.0 | SOC: Auf Zellindex bezogener Zähler für Wahrscheinlichkeit von Fehler erhöhter Ladungsverlust 04 |
| STAT_ERROR_SOC_ZELL_ID_05_WERT | - | - | unsigned char | - | - | 1.0 | 1.0 | 0.0 | SOC: Index der Zelle für Fehler erhöhter Ladungsverlust 05 |
| STAT_ERROR_SOC_SCORE_05_WERT | - | - | unsigned char | - | - | 1.0 | 1.0 | 0.0 | SOC: Auf Zellindex bezogener Zähler für Wahrscheinlichkeit von Fehler erhöhter Ladungsverlust 05 |
| STAT_ERROR_SOH_ZELL_ID_01_WERT | - | - | unsigned char | - | - | 1.0 | 1.0 | 0.0 | SOH_C: Index der Zelle für Fehler erhöhter Kapazitätsverlust 01 |
| STAT_ERROR_SOH_SCORE_01_WERT | - | - | unsigned char | - | - | 1.0 | 1.0 | 0.0 | SOH_C: Auf Zellindex bezogener Zähler für Wahrscheinlichkeit von Fehler erhöhter Kapazitätsverlust 01 |
| STAT_ERROR_SOH_ZELL_ID_02_WERT | - | - | unsigned char | - | - | 1.0 | 1.0 | 0.0 | SOH_C: Index der Zelle für Fehler erhöhter Kapazitätsverlust 02 |
| STAT_ERROR_SOH_SCORE_02_WERT | - | - | unsigned char | - | - | 1.0 | 1.0 | 0.0 | SOH_C: Auf Zellindex bezogener Zähler für Wahrscheinlichkeit von Fehler erhöhter Kapazitätsverlust 02 |
| STAT_ERROR_SOH_ZELL_ID_03_WERT | - | - | unsigned char | - | - | 1.0 | 1.0 | 0.0 | SOH_C: Index der Zelle für Fehler erhöhter Kapazitätsverlust 03 |
| STAT_ERROR_SOH_SCORE_03_WERT | - | - | unsigned char | - | - | 1.0 | 1.0 | 0.0 | SOH_C: Auf Zellindex bezogener Zähler für Wahrscheinlichkeit von Fehler erhöhter Kapazitätsverlust 03 |
| STAT_ERROR_SOH_ZELL_ID_04_WERT | - | - | unsigned char | - | - | 1.0 | 1.0 | 0.0 | SOH_C: Index der Zelle für Fehler erhöhter Kapazitätsverlust 04 |
| STAT_ERROR_SOH_SCORE_04_WERT | - | - | unsigned char | - | - | 1.0 | 1.0 | 0.0 | SOH_C: Auf Zellindex bezogener Zähler für Wahrscheinlichkeit von Fehler erhöhter Kapazitätsverlust 04 |
| STAT_ERROR_SOH_ZELL_ID_05_WERT | - | - | unsigned char | - | - | 1.0 | 1.0 | 0.0 | SOH_C: Index der Zelle für Fehler erhöhter Kapazitätsverlust 05 |
| STAT_ERROR_SOH_SCORE_05_WERT | - | - | unsigned char | - | - | 1.0 | 1.0 | 0.0 | SOH_C: Auf Zellindex bezogener Zähler für Wahrscheinlichkeit von Fehler erhöhter Kapazitätsverlust 05 |
| STAT_ERROR_ALPHA_LONG_ZELL_ID_01_WERT | - | - | unsigned char | - | - | 1.0 | 1.0 | 0.0 | SOH_R: Index der Zelle für Fehler schnelle Innenwiderstandsalterung 01 |
| STAT_ERROR_ALPHA_LONG_SCORE_01_WERT | - | - | unsigned char | - | - | 1.0 | 1.0 | 0.0 | SOH_R: Auf Zellindex bezogener Zähler für Wahrscheinlichkeit von Fehler schnelle Innenwiderstandsaltertung 01 |
| STAT_ERROR_ALPHA_LONG_ZELL_ID_02_WERT | - | - | unsigned char | - | - | 1.0 | 1.0 | 0.0 | SOH_R: Index der Zelle für Fehler schnelle Innenwiderstandsalterung 02 |
| STAT_ERROR_ALPHA_LONG_SCORE_02_WERT | - | - | unsigned char | - | - | 1.0 | 1.0 | 0.0 | SOH_R: Auf Zellindex bezogener Zähler für Wahrscheinlichkeit von Fehler schnelle Innenwiderstandsaltertung 02 |
| STAT_ERROR_ALPHA_LONG_ZELL_ID_03_WERT | - | - | unsigned char | - | - | 1.0 | 1.0 | 0.0 | SOH_R: Index der Zelle für Fehler schnelle Innenwiderstandsalterung 03 |
| STAT_ERROR_ALPHA_LONG_SCORE_03_WERT | - | - | unsigned char | - | - | 1.0 | 1.0 | 0.0 | SOH_R: Auf Zellindex bezogener Zähler für Wahrscheinlichkeit von Fehler schnelle Innenwiderstandsaltertung 03 |
| STAT_ERROR_ALPHA_LONG_ZELL_ID_04_WERT | - | - | unsigned char | - | - | 1.0 | 1.0 | 0.0 | SOH_R: Index der Zelle für Fehler schnelle Innenwiderstandsalterung 04 |
| STAT_ERROR_ALPHA_LONG_SCORE_04_WERT | - | - | unsigned char | - | - | 1.0 | 1.0 | 0.0 | SOH_R: Auf Zellindex bezogener Zähler für Wahrscheinlichkeit von Fehler schnelle Innenwiderstandsaltertung 04 |
| STAT_ERROR_ALPHA_LONG_ZELL_ID_05_WERT | - | - | unsigned char | - | - | 1.0 | 1.0 | 0.0 | SOH_R: Index der Zelle für Fehler schnelle Innenwiderstandsalterung 05 |
| STAT_ERROR_ALPHA_LONG_SCORE_05_WERT | - | - | unsigned char | - | - | 1.0 | 1.0 | 0.0 | SOH_R: Auf Zellindex bezogener Zähler für Wahrscheinlichkeit von Fehler schnelle Innenwiderstandsaltertung 05 |

<a id="table-res-0xe4cd-d"></a>
### RES_0XE4CD_D
...
| RESULTNAME | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_HIS_EFF_CURR_CHA_1_T1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Bei -10&lt;= T: Dauer in Minuten des Relativwerts von RMS/Dauerstrom beim Laden in der Klasse: 0 &lt; Irel_cha &lt;=0.7 |
| STAT_HIS_EFF_CURR_CHA_2_T1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Bei -10&lt;= T: Dauer in Minuten des Relativwerts von RMS/Dauerstrom beim Laden in der Klasse: 0.7 &lt; Irel_cha &lt;=1 |
| STAT_HIS_EFF_CURR_CHA_3_T1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Bei -10&lt;= T: Dauer in Minuten des Relativwerts von RMS/Dauerstrom beim Laden in der Klasse: 1 &lt; Irel_cha &lt;= 1.25 |
| STAT_HIS_EFF_CURR_CHA_4_T1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Bei -10&lt;= T: Dauer in Minuten des Relativwerts von RMS/Dauerstrom beim Laden in der Klasse: 1.25 &lt; Irel_cha |
| STAT_HIS_EFF_CURR_CHA_1_T2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Bei -10&lt; T &lt;= -5: Dauer in Minuten des Relativwerts von RMS/Dauerstrom beim Laden in der Klasse: 0 &lt; Irel_abs &lt;=0.7 |
| STAT_HIS_EFF_CURR_CHA_2_T2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Bei -10&lt; T &lt;= -5: Dauer in Minuten des Relativwerts von RMS/Dauerstrom beim Laden in der Klasse: 0.7 &lt; Irel_cha &lt;=1 |
| STAT_HIS_EFF_CURR_CHA_3_T2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Bei -10&lt; T &lt;= -5: Dauer in Minuten des Relativwerts von RMS/Dauerstrom beim Laden in der Klasse: 1 &lt; Irel_cha &lt;= 1.25 |
| STAT_HIS_EFF_CURR_CHA_4_T2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Bei -10&lt; T &lt;= -5: Dauer in Minuten des Relativwerts von RMS/Dauerstrom beim Laden in der Klasse: 1.25 &lt; Irel_cha |
| STAT_HIS_EFF_CURR_CHA_1_T3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Bei -5&lt; T &lt;= 25: Dauer in Minuten des Relativwerts von RMS/Dauerstrom beim Laden in der Klasse: 0 &lt; Irel_cha &lt;=0.7 |
| STAT_HIS_EFF_CURR_CHA_2_T3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Bei -5&lt; T &lt;= 25: Dauer in Minuten des Relativwerts von RMS/Dauerstrom beim Laden in der Klasse: 0.7 &lt; Irel_cha &lt;=1 |
| STAT_HIS_EFF_CURR_CHA_3_T3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Bei -5&lt; T &lt;= 25: Dauer in Minuten des Relativwerts von RMS/Dauerstrom beim Laden in der Klasse: 1 &lt; Irel_cha &lt;= 1.25 |
| STAT_HIS_EFF_CURR_CHA_4_T3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Bei -5&lt; T &lt;= 25: Dauer in Minuten des Relativwerts von RMS/Dauerstrom beim Laden in der Klasse: 1.25 &lt; Irel_cha |
| STAT_HIS_EFF_CURR_CHA_1_T4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Bei 25&lt; T &lt;= 40: Dauer in Minuten des Relativwerts von RMS/Dauerstrom beim Laden in der Klasse: 0 &lt; Irel_cha &lt;=0.7 |
| STAT_HIS_EFF_CURR_CHA_2_T4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Bei 25&lt; T &lt;= 40: Dauer in Minuten des Relativwerts von RMS/Dauerstrom beim Laden in der Klasse: 0.7 &lt; Irel_cha &lt;=1 |
| STAT_HIS_EFF_CURR_CHA_3_T4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Bei 25&lt; T &lt;= 40: Dauer in Minuten des Relativwerts von RMS/Dauerstrom beim Laden in der Klasse: 1 &lt; Irel_cha &lt;= 1.25 |
| STAT_HIS_EFF_CURR_CHA_4_T4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Bei 25&lt; T &lt;= 40: Dauer in Minuten des Relativwerts von RMS/Dauerstrom beim Laden in der Klasse: 1.25 &lt; Irel_cha |
| STAT_HIS_EFF_CURR_CHA_1_T5_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Bei 40 &lt; T : Dauer in Minuten des Relativwerts von RMS/Dauerstrom beim Laden in der Klasse: 0 &lt; Irel_cha &lt;=0.7 |
| STAT_HIS_EFF_CURR_CHA_2_T5_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Bei 40 &lt; T : Dauer in Minuten des Relativwerts von RMS/Dauerstrom beim Laden in der Klasse: 0.7 &lt; Irel_cha &lt;=1 |
| STAT_HIS_EFF_CURR_CHA_3_T5_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Bei 40 &lt; T : Dauer in Minuten des Relativwerts von RMS/Dauerstrom beim Laden in der Klasse: 1 &lt; Irel_cha &lt;= 1.25 |
| STAT_HIS_EFF_CURR_ABS_4_T5_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Bei 40 &lt; T : Dauer in Minuten des Relativwerts von RMS/Dauerstrom beim Laden in der Klasse: 1.25 &lt; Irel_cha |

<a id="table-res-0xe4ce-d"></a>
### RES_0XE4CE_D
...
| RESULTNAME | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_HIS_EFF_CURR_ABS_1_T1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Bei -10&lt;= T: Dauer in Minuten des Relativwerts von RMS/Dauerstrom beim Entladen in der Klasse: 0 &lt; Irel_abs &lt;=0.7 |
| STAT_HIS_EFF_CURR_ABS_2_T1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Bei -10&lt;= T: Dauer in Minuten des Relativwerts von RMS/Dauerstrom beim Entladen in der Klasse: 0.7 &lt; Irel_abs &lt;=1 |
| STAT_HIS_EFF_CURR_ABS_3_T1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Bei -10&lt;= T: Dauer in Minuten des Relativwerts von RMS/Dauerstrom beim Entladen in der Klasse: 1 &lt; Irel_abs &lt;= 1.25 |
| STAT_HIS_EFF_CURR_ABS_4_T1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Bei -10&lt;= T: Dauer in Minuten des Relativwerts von RMS/Dauerstrom beim Entladen in der Klasse: 1.25 &lt; Irel_abs |
| STAT_HIS_EFF_CURR_ABS_1_T2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Bei -10&lt; T &lt;= -5: Dauer in Minuten des Relativwerts von RMS/Dauerstrom beim Entladen in der Klasse: 0 &lt; Irel_abs &lt;=0.7 |
| STAT_HIS_EFF_CURR_ABS_2_T2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Bei -10&lt; T &lt;= -5: Dauer in Minuten des Relativwerts von RMS/Dauerstrom beim Entladen in der Klasse: 0.7 &lt; Irel_abs &lt;=1 |
| STAT_HIS_EFF_CURR_ABS_3_T2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Bei -10&lt; T &lt;= -5: Dauer in Minuten des Relativwerts von RMS/Dauerstrom beim Entladen in der Klasse: 1 &lt; Irel_abs &lt;= 1.25 |
| STAT_HIS_EFF_CURR_ABS_4_T2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Bei -10&lt; T &lt;= -5: Dauer in Minuten des Relativwerts von RMS/Dauerstrom beim Entladen in der Klasse: 1.25 &lt; Irel_abs |
| STAT_HIS_EFF_CURR_ABS_1_T3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Bei -5&lt; T &lt;= 25: Dauer in Minuten des Relativwerts von RMS/Dauerstrom beim Entladen in der Klasse: 0 &lt; Irel_abs &lt;=0.7 |
| STAT_HIS_EFF_CURR_ABS_2_T3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Bei -5&lt; T &lt;= 25: Dauer in Minuten des Relativwerts von RMS/Dauerstrom beim Entladen in der Klasse: 0.7 &lt; Irel_abs &lt;=1 |
| STAT_HIS_EFF_CURR_ABS_3_T3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Bei -5&lt; T &lt;= 25: Dauer in Minuten des Relativwerts von RMS/Dauerstrom beim Entladen in der Klasse: 1 &lt; Irel_abs &lt;= 1.25 |
| STAT_HIS_EFF_CURR_ABS_4_T3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Bei -5&lt; T &lt;= 25: Dauer in Minuten des Relativwerts von RMS/Dauerstrom beim Entladen in der Klasse: 1.25 &lt; Irel_abs |
| STAT_HIS_EFF_CURR_ABS_1_T4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Bei 25&lt; T &lt;= 40: Dauer in Minuten des Relativwerts von RMS/Dauerstrom beim Entladen in der Klasse: 0 &lt; Irel_abs &lt;=0.7 |
| STAT_HIS_EFF_CURR_ABS_2_T4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Bei 25&lt; T &lt;= 40: Dauer in Minuten des Relativwerts von RMS/Dauerstrom beim Entladen in der Klasse: 0.7 &lt; Irel_abs &lt;=1 |
| STAT_HIS_EFF_CURR_ABS_3_T4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Bei 25&lt; T &lt;= 40: Dauer in Minuten des Relativwerts von RMS/Dauerstrom beim Entladen in der Klasse: 1 &lt; Irel_abs &lt;= 1.25 |
| STAT_HIS_EFF_CURR_ABS_4_T4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Bei 25&lt; T &lt;= 40: Dauer in Minuten des Relativwerts von RMS/Dauerstrom beim Entladen in der Klasse: 1.25 &lt; Irel_abs |
| STAT_HIS_EFF_CURR_ABS_1_T5_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Bei 40 &lt; T : Dauer in Minuten des Relativwerts von RMS/Dauerstrom beim Entladen in der Klasse: 0 &lt; Irel_abs &lt;=0.7 |
| STAT_HIS_EFF_CURR_ABS_2_T5_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Bei 40 &lt; T : Dauer in Minuten des Relativwerts von RMS/Dauerstrom beim Entladen in der Klasse: 0.7 &lt; Irel_abs &lt;=1 |
| STAT_HIS_EFF_CURR_ABS_3_T5_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Bei 40 &lt; T : Dauer in Minuten des Relativwerts von RMS/Dauerstrom beim Entladen in der Klasse: 1 &lt; Irel_abs &lt;= 1.25 |
| STAT_HIS_EFF_CURR_ABS_4_T5_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Bei 40 &lt; T : Dauer in Minuten des Relativwerts von RMS/Dauerstrom beim Entladen in der Klasse: 1.25 &lt; Irel_abs |

<a id="table-res-0xe4cf-d"></a>
### RES_0XE4CF_D
...
| RESULTNAME | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_HIS_LEITUNG_ABS_1_N1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom  in der Klasse: 0 &lt; Irel_abs &lt;=0.7 |
| STAT_HIS_LEITUNG_ABS_2_N1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom  in der Klasse: 0.7 &lt; Irel_abs &lt;=0.8 |
| STAT_HIS_LEITUNG_ABS_3_N1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom in der Klasse: 0.8 &lt; Irel_abs &lt;= 1.0 |
| STAT_HIS_LEITUNG_ABS_4_N1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom in der Klasse: 1.0 &lt; Irel_abs |
| STAT_HIS_LEITUNG_ABS_1_N2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom  in der Klasse: 0 &lt; Irel_abs &lt;=0.7 |
| STAT_HIS_LEITUNG_ABS_2_N2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom  in der Klasse: 0.7 &lt; Irel_abs &lt;=0.8 |
| STAT_HIS_LEITUNG_ABS_3_N2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom in der Klasse: 0.8 &lt; Irel_abs &lt;= 1.0 |
| STAT_HIS_LEITUNG_ABS_4_N2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom in der Klasse: 1.0 &lt; Irel_abs |
| STAT_HIS_LEITUNG_ABS_1_N3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom  in der Klasse: 0 &lt; Irel_abs &lt;=0.7 |
| STAT_HIS_LEITUNG_ABS_2_N3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom  in der Klasse: 0.7 &lt; Irel_abs &lt;=0.8 |
| STAT_HIS_LEITUNG_ABS_3_N3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom in der Klasse: 0.8 &lt; Irel_abs &lt;= 1.0 |
| STAT_HIS_LEITUNG_ABS_4_N3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom in der Klasse: 1.0 &lt; Irel_abs |
| STAT_HIS_LEITUNG_ABS_1_N4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom  in der Klasse: 0 &lt; Irel_abs &lt;=0.7 |
| STAT_HIS_LEITUNG_ABS_2_N4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom  in der Klasse: 0.7 &lt; Irel_abs &lt;=0.8 |
| STAT_HIS_LEITUNG_ABS_3_N4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom in der Klasse: 0.8 &lt; Irel_abs &lt;= 1.0 |
| STAT_HIS_LEITUNG_ABS_4_N4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom in der Klasse: 1.0 &lt; Irel_abs |
| STAT_HIS_LEITUNG_ABS_1_N5_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom  in der Klasse: 0 &lt; Irel_abs &lt;=0.7 |
| STAT_HIS_LEITUNG_ABS_2_N5_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom  in der Klasse: 0.7 &lt; Irel_abs &lt;=0.8 |
| STAT_HIS_LEITUNG_ABS_3_N5_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom in der Klasse: 0.8 &lt; Irel_abs &lt;= 1.0 |
| STAT_HIS_LEITUNG_ABS_4_N5_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom in der Klasse: 1.0 &lt; Irel_abs |
| STAT_HIS_LEITUNG_ABS_1_N6_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom  in der Klasse: 0 &lt; Irel_abs &lt;=0.7 |
| STAT_HIS_LEITUNG_ABS_2_N6_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom  in der Klasse: 0.7 &lt; Irel_abs &lt;=0.8 |
| STAT_HIS_LEITUNG_ABS_3_N6_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom in der Klasse: 0.8 &lt; Irel_abs &lt;= 1.0 |
| STAT_HIS_LEITUNG_ABS_4_N6_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom in der Klasse: 1.0 &lt; Irel_abs |
| STAT_HIS_LEITUNG_ABS_1_N7_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom  in der Klasse: 0 &lt; Irel_abs &lt;=0.7 |
| STAT_HIS_LEITUNG_ABS_2_N7_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom  in der Klasse: 0.7 &lt; Irel_abs &lt;=0.8 |
| STAT_HIS_LEITUNG_ABS_3_N7_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom in der Klasse: 0.8 &lt; Irel_abs &lt;= 1.0 |
| STAT_HIS_LEITUNG_ABS_4_N7_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom in der Klasse: 1.0 &lt; Irel_abs |
| STAT_HIS_LEITUNG_ABS_1_N8_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom  in der Klasse: 0 &lt; Irel_abs &lt;=0.7 |
| STAT_HIS_LEITUNG_ABS_2_N8_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom  in der Klasse: 0.7 &lt; Irel_abs &lt;=0.8 |
| STAT_HIS_LEITUNG_ABS_3_N8_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom in der Klasse: 0.8 &lt; Irel_abs &lt;= 1.0 |
| STAT_HIS_LEITUNG_ABS_4_N8_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom in der Klasse: 1.0 &lt; Irel_abs |
| STAT_HIS_LEITUNG_ABS_1_N9_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom  in der Klasse: 0 &lt; Irel_abs &lt;=0.7 |
| STAT_HIS_LEITUNG_ABS_2_N9_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom  in der Klasse: 0.7 &lt; Irel_abs &lt;=0.8 |
| STAT_HIS_LEITUNG_ABS_3_N9_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom in der Klasse: 0.8 &lt; Irel_abs &lt;= 1.0 |
| STAT_HIS_LEITUNG_ABS_4_N9_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom in der Klasse: 1.0 &lt; Irel_abs |
| STAT_HIS_LEITUNG_ABS_1_N10_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom  in der Klasse: 0 &lt; Irel_abs &lt;=0.7 |
| STAT_HIS_LEITUNG_ABS_2_N10_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom  in der Klasse: 0.7 &lt; Irel_abs &lt;=0.8 |
| STAT_HIS_LEITUNG_ABS_3_N10_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom in der Klasse: 0.8 &lt; Irel_abs &lt;= 1.0 |
| STAT_HIS_LEITUNG_ABS_4_N10_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom in der Klasse: 1.0 &lt; Irel_abs |
| STAT_HIS_LEITUNG_ABS_1_N11_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom  in der Klasse: 0 &lt; Irel_abs &lt;=0.7 |
| STAT_HIS_LEITUNG_ABS_2_N11_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom  in der Klasse: 0.7 &lt; Irel_abs &lt;=0.8 |
| STAT_HIS_LEITUNG_ABS_3_N11_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom in der Klasse: 0.8 &lt; Irel_abs &lt;= 1.0 |
| STAT_HIS_LEITUNG_ABS_4_N11_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom in der Klasse: 1.0 &lt; Irel_abs |
| STAT_HIS_LEITUNG_ABS_1_N12_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom  in der Klasse: 0 &lt; Irel_abs &lt;=0.7 |
| STAT_HIS_LEITUNG_ABS_2_N12_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom  in der Klasse: 0.7 &lt; Irel_abs &lt;=0.8 |
| STAT_HIS_LEITUNG_ABS_3_N12_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom in der Klasse: 0.8 &lt; Irel_abs &lt;= 1.0 |
| STAT_HIS_LEITUNG_ABS_4_N12_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom in der Klasse: 1.0 &lt; Irel_abs |
| STAT_HIS_LEITUNG_ABS_1_N13_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom  in der Klasse: 0 &lt; Irel_abs &lt;=0.7 |
| STAT_HIS_LEITUNG_ABS_2_N13_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom  in der Klasse: 0.7 &lt; Irel_abs &lt;=0.8 |
| STAT_HIS_LEITUNG_ABS_3_N13_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom in der Klasse: 0.8 &lt; Irel_abs &lt;= 1.0 |
| STAT_HIS_LEITUNG_ABS_4_N13_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom in der Klasse: 1.0 &lt; Irel_abs |
| STAT_HIS_LEITUNG_ABS_1_N14_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom  in der Klasse: 0 &lt; Irel_abs &lt;=0.7 |
| STAT_HIS_LEITUNG_ABS_2_N14_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom  in der Klasse: 0.7 &lt; Irel_abs &lt;=0.8 |
| STAT_HIS_LEITUNG_ABS_3_N14_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom in der Klasse: 0.8 &lt; Irel_abs &lt;= 1.0 |
| STAT_HIS_LEITUNG_ABS_4_N14_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom in der Klasse: 1.0 &lt; Irel_abs |
| STAT_HIS_LEITUNG_ABS_1_N15_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom  in der Klasse: 0 &lt; Irel_abs &lt;=0.7 |
| STAT_HIS_LEITUNG_ABS_2_N15_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom  in der Klasse: 0.7 &lt; Irel_abs &lt;=0.8 |
| STAT_HIS_LEITUNG_ABS_3_N15_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom in der Klasse: 0.8 &lt; Irel_abs &lt;= 1.0 |
| STAT_HIS_LEITUNG_ABS_4_N15_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom in der Klasse: 1.0 &lt; Irel_abs |
| STAT_HIS_LEITUNG_ABS_1_N16_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom  in der Klasse: 0 &lt; Irel_abs &lt;=0.7 |
| STAT_HIS_LEITUNG_ABS_2_N16_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom  in der Klasse: 0.7 &lt; Irel_abs &lt;=0.8 |
| STAT_HIS_LEITUNG_ABS_3_N16_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom in der Klasse: 0.8 &lt; Irel_abs &lt;= 1.0 |
| STAT_HIS_LEITUNG_ABS_4_N16_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom in der Klasse: 1.0 &lt; Irel_abs |
| STAT_HIS_LEITUNG_ABS_1_N17_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom  in der Klasse: 0 &lt; Irel_abs &lt;=0.7 |
| STAT_HIS_LEITUNG_ABS_2_N17_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom  in der Klasse: 0.7 &lt; Irel_abs &lt;=0.8 |
| STAT_HIS_LEITUNG_ABS_3_N17_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom in der Klasse: 0.8 &lt; Irel_abs &lt;= 1.0 |
| STAT_HIS_LEITUNG_ABS_4_N17_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom in der Klasse: 1.0 &lt; Irel_abs |
| STAT_HIS_LEITUNG_ABS_1_N18_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom  in der Klasse: 0 &lt; Irel_abs &lt;=0.7 |
| STAT_HIS_LEITUNG_ABS_2_N18_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom  in der Klasse: 0.7 &lt; Irel_abs &lt;=0.8 |
| STAT_HIS_LEITUNG_ABS_3_N18_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom in der Klasse: 0.8 &lt; Irel_abs &lt;= 1.0 |
| STAT_HIS_LEITUNG_ABS_4_N18_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom in der Klasse: 1.0 &lt; Irel_abs |
| STAT_HIS_LEITUNG_ABS_1_N19_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom  in der Klasse: 0 &lt; Irel_abs &lt;=0.7 |
| STAT_HIS_LEITUNG_ABS_2_N19_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom  in der Klasse: 0.7 &lt; Irel_abs &lt;=0.8 |
| STAT_HIS_LEITUNG_ABS_3_N19_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom in der Klasse: 0.8 &lt; Irel_abs &lt;= 1.0 |
| STAT_HIS_LEITUNG_ABS_4_N19_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom in der Klasse: 1.0 &lt; Irel_abs |
| STAT_HIS_LEITUNG_ABS_1_N20_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom  in der Klasse: 0 &lt; Irel_abs &lt;=0.7 |
| STAT_HIS_LEITUNG_ABS_2_N20_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom  in der Klasse: 0.7 &lt; Irel_abs &lt;=0.8 |
| STAT_HIS_LEITUNG_ABS_3_N20_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom in der Klasse: 0.8 &lt; Irel_abs &lt;= 1.0 |
| STAT_HIS_LEITUNG_ABS_4_N20_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Dauer in Minuten des Relativwerts von RMS/Dauerstrom in der Klasse: 1.0 &lt; Irel_abs |

<a id="table-res-0xe4d3-d"></a>
### RES_0XE4D3_D
...
| RESULTNAME | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_STROM_MEAS_MAX_CHA_WERT | A | high | signed int | - | - | 1.0 | 10.0 | 0.0 | Maximal gemessener Strom Laden |
| STAT_STROM_MEAS_MIN_DCHA_WERT | A | high | signed int | - | - | 1.0 | 10.0 | 0.0 | Minimal gemessener Strom Entladen |

<a id="table-res-0xe4d4-d"></a>
### RES_0XE4D4_D
...
| RESULTNAME | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_ZEITPUNKT_EOD_START_WERT | s | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Zeitpunkt, zu dem das Fahrzeug in den EoD gewechselt ist (Liegenbleiber) |
| STAT_ZEITPUNKT_EOD_ENDE_WERT | s | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Zeitpunkt, zu dem das Fahrzeug den EoD beendet hat (bspw. durch Laden) |
| STAT_TEMPERATUR_MIN_ZELLE_EOD_START_WERT | °C | - | signed char | - | - | 1.0 | 1.0 | 0.0 | minimale Zelltemperatur zu Beginn EoD |
| STAT_TEMPERATUR_MIN_ZELLE_EOD_ENDE_WERT | °C | - | signed char | - | - | 1.0 | 1.0 | 0.0 | minimale Zelltemperatur bei Ende EoD |
| STAT_ZELLSPANNUNG_MIN_ZELLE_EOD_START_WERT | V | - | unsigned int | - | - | 1.0 | 1.0 | 0.0 | minimale Zellspannung bei Start EoD |
| STAT_ZELLSPANNUNG_MEAN_ZELLE_EOD_START_WERT | V | - | unsigned int | - | - | 1.0 | 1.0 | 0.0 | mittlere Zellspannung bei Start EoD |
| STAT_ZELLSPANNUNG_MAX_ZELLE_EOD_START_WERT | V | - | unsigned int | - | - | 1.0 | 1.0 | 0.0 | maximale Zellspannung bei Start EoD |
| STAT_ID_ZELLSPANNUNG_MIN_ZELLE_EOD_START_WERT | - | - | unsigned char | - | - | - | - | - | Index der Zelle mit minimale Zellspannung bei Start EoD |
| STAT_ZELLSPANNUNG_MIN_ZELLE_EOD_ENDE_WERT | V | - | unsigned int | - | - | 1.0 | 1.0 | 0.0 | minimale Zellspannung bei Ende EoD |
| STAT_ZELLSPANNUNG_MEAN_ZELLE_EOD_ENDE_WERT | V | - | unsigned int | - | - | 1.0 | 1.0 | 0.0 | mittlere Zellspannung bei Ende EoD |
| STAT_ZELLSPANNUNG_MAX_ZELLE_EOD_ENDE_WERT | V | - | unsigned int | - | - | 1.0 | 1.0 | 0.0 | maximale Zellspannung bei Ende EoD |
| STAT_ID_ZELLSPANNUNG_MIN_ZELLE_EOD_ENDE_WERT | - | - | unsigned char | - | - | - | - | - | Index der Zelle mit minimale Zellspannung bei Ende EoD |
| STAT_SOC_MIN_EOD_START_WERT | % | - | signed int | - | - | 1.0 | 1.0 | 0.0 | minimaler Zell-SoC bei Start EoD |
| STAT_SOC_MEAN_EOD_START_WERT | % | - | signed int | - | - | 1.0 | 1.0 | 0.0 | mittlerer Zell-SoC bei Start EoD |
| STAT_SOC_MAX_EOD_START_WERT | % | - | signed int | - | - | 1.0 | 1.0 | 0.0 | maximaler Zell-SoC bei Start EoD |
| STAT_SOC_MIN_EOD_ENDE_WERT | % | - | signed int | - | - | 1.0 | 1.0 | 0.0 | minimaler Zell-SoC bei Ende EoD |
| STAT_SOC_MEAN_EOD_ENDE_WERT | % | - | signed int | - | - | 1.0 | 1.0 | 0.0 | mittlerer Zell-SoC bei Ende EoD |
| STAT_SOC_MAX_EOD_ENDE_WERT | % | - | signed int | - | - | 1.0 | 1.0 | 0.0 | maximaler Zell-SoC bei Ende EoD |
| STAT_LEISTUNG_START_EOD_WERT | kW | - | signed int | - | - | 1.0 | 1.0 | 0.0 | Leistung zu Start EoD |
| STAT_LEISTUNG_ENDE_EOD_WERT | kW | - | signed char | - | - | 1.0 | 1.0 | 0.0 | Leistung zu Ende EoD |
| STAT_STROM_START_EOD_WERT | A | high | signed char | - | - | 1.0 | 1.0 | 0.0 | Strom zu Start EoD |
| STAT_STROM_MAX_VOR_START_EOD_WERT | A | - | signed char | - | - | 1.0 | 1.0 | 0.0 | Maximaler Strom in Entladerichtung kurz vor Erkennung eines EoD |
| STAT_KRITERIUM_EOD | 0-n | high | signed char | - | TAB_KRITERIUM_EOD | - | - | - | Grund, warum ein EoD erkannt wurde |
| STAT_LADUNGSMENGE_WAEHREND_NBA4_WERT | As | - | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Ladungsmenge, die während NbA = 4 verbraucht wurde |
| STAT_LADUNGSMENGE_WAEHREND_NBA3_WERT | As | - | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Ladungsmenge, die während NbA = 3 verbraucht wurde |
| STAT_LADUNGSMENGE_WAEHREND_NBA2_WERT | As | - | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Ladungsmenge, die während NbA = 2 verbraucht wurde |
| STAT_STATUS_NBA_START_EOD | 0-n | high | unsigned char | - | TAB_NBA_STATUS | - | - | - | NbA-Status zu Start EoD (Plausi-Check, sollte immer 4 sein) |
| STAT_STATUS_NBA_ENDE_EOD | 0-n | high | unsigned char | - | TAB_NBA_STATUS | - | - | - | NbA-Status zu Ende EoD |
| STAT_LEISTUNG_MAXIMAL_WAEHREND_EOD_WERT | kW | - | unsigned char | - | - | 1.0 | 1.0 | 0.0 | Maximaler Leistungsabruf (Entladerichtung) während EoD |
| STAT_LEISTUNG_DURCHSCHNITT_WAEHREND_EOD_WERT | kW | - | signed char | - | - | 1.0 | 1.0 | 0.0 | Durchschnittlicher Leistungsabruf waehrend EoD |
| STAT_SCHLAFZEIT_BMU_WAEHREND_EOD_WERT | min | - | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Zeit, die die BMU während eines aktiven EoD schläft |
| STAT_DAUER_EOD_WERT | min | - | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Dauer des EoD |
...
Dimensions: 189 rows × 10 columns
...
| STAT_HIS_TEMP_HVON_MIN_MOD12_T1_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 12 Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: TmodMin &lt;= -20°C |
| STAT_HIS_TEMP_HVON_MIN_MOD12_T2_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 12 Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: -20°C &lt; TmodMin &lt;= -5°C |
| STAT_HIS_TEMP_HVON_MIN_MOD12_T3_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 12 Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: -5°C &lt; TmodMin &lt;= 10°C |
| STAT_HIS_TEMP_HVON_MIN_MOD12_T4_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 12 Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 10°C &lt; TmodMin &lt;= 20°C |
| STAT_HIS_TEMP_HVON_MIN_MOD12_T5_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 12 Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 20°C &lt; TmodMin &lt;= 30°C |
| STAT_HIS_TEMP_HVON_MIN_MOD12_T6_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 12 Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 30°C &lt; TmodMin &lt;= 35°C |
| STAT_HIS_TEMP_HVON_MIN_MOD12_T7_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 12 Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: TmodMin &gt; 35°C |
| STAT_HIS_TEMP_HVON_MIN_MOD13_T1_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 13 Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: TmodMin &lt;= -20°C |
| STAT_HIS_TEMP_HVON_MIN_MOD13_T2_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 13 Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: -20°C &lt; TmodMin &lt;= -5°C |
| STAT_HIS_TEMP_HVON_MIN_MOD13_T3_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 13 Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: -5°C &lt; TmodMin &lt;= 10°C |
| STAT_HIS_TEMP_HVON_MIN_MOD13_T4_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 13 Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 10°C &lt; TmodMin &lt;= 20°C |
| STAT_HIS_TEMP_HVON_MIN_MOD13_T5_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 13 Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 20°C &lt; TmodMin &lt;= 30°C |
| STAT_HIS_TEMP_HVON_MIN_MOD13_T6_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 13 Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 30°C &lt; TmodMin &lt;= 35°C |
| STAT_HIS_TEMP_HVON_MIN_MOD13_T7_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 13 Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: TmodMin &gt; 35°C |
| STAT_HIS_TEMP_HVON_MIN_MOD14_T1_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 14 Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: TmodMin &lt;= -20°C |
| STAT_HIS_TEMP_HVON_MIN_MOD14_T2_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 14 Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: -20°C &lt; TmodMin &lt;= -5°C |
| STAT_HIS_TEMP_HVON_MIN_MOD14_T3_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 14 Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: -5°C &lt; TmodMin &lt;= 10°C |
| STAT_HIS_TEMP_HVON_MIN_MOD14_T4_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 14 Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 10°C &lt; TmodMin &lt;= 20°C |
| STAT_HIS_TEMP_HVON_MIN_MOD14_T5_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 14 Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 20°C &lt; TmodMin &lt;= 30°C |
| STAT_HIS_TEMP_HVON_MIN_MOD14_T6_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 14 Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 30°C &lt; TmodMin &lt;= 35°C |
| STAT_HIS_TEMP_HVON_MIN_MOD14_T7_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 14 Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: TmodMin &gt; 35°C |
| STAT_HIS_TEMP_HVON_MIN_MOD15_T1_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 15 Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: TmodMin &lt;= -20°C |
| STAT_HIS_TEMP_HVON_MIN_MOD15_T2_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 15 Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: -20°C &lt; TmodMin &lt;= -5°C |
| STAT_HIS_TEMP_HVON_MIN_MOD15_T3_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 15 Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: -5°C &lt; TmodMin &lt;= 10°C |
| STAT_HIS_TEMP_HVON_MIN_MOD15_T4_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 15 Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 10°C &lt; TmodMin &lt;= 20°C |
| STAT_HIS_TEMP_HVON_MIN_MOD15_T5_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 15 Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 20°C &lt; TmodMin &lt;= 30°C |
| STAT_HIS_TEMP_HVON_MIN_MOD15_T6_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 15 Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 30°C &lt; TmodMin &lt;= 35°C |
| STAT_HIS_TEMP_HVON_MIN_MOD15_T7_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 15 Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: TmodMin &gt; 35°C |
| STAT_HIS_TEMP_HVON_MIN_MOD16_T1_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 16 Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: TmodMin &lt;= -20°C |
| STAT_HIS_TEMP_HVON_MIN_MOD16_T2_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 16 Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: -20°C &lt; TmodMin &lt;= -5°C |
| STAT_HIS_TEMP_HVON_MIN_MOD16_T3_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 16 Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: -5°C &lt; TmodMin &lt;= 10°C |
| STAT_HIS_TEMP_HVON_MIN_MOD16_T4_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 16 Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 10°C &lt; TmodMin &lt;= 20°C |
| STAT_HIS_TEMP_HVON_MIN_MOD16_T5_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 16 Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 20°C &lt; TmodMin &lt;= 30°C |
| STAT_HIS_TEMP_HVON_MIN_MOD16_T6_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 16 Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 30°C &lt; TmodMin &lt;= 35°C |
| STAT_HIS_TEMP_HVON_MIN_MOD16_T7_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 16 Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: TmodMin &gt; 35°C |
| STAT_HIS_TEMP_HVON_MIN_MOD17_T1_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 17 Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: TmodMin &lt;= -20°C |
| STAT_HIS_TEMP_HVON_MIN_MOD17_T2_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 17 Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: -20°C &lt; TmodMin &lt;= -5°C |
| STAT_HIS_TEMP_HVON_MIN_MOD17_T3_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 17  Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: -5°C &lt; TmodMin &lt;= 10°C |
| STAT_HIS_TEMP_HVON_MIN_MOD17_T4_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 17  Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 10°C &lt; TmodMin &lt;= 20°C |
| STAT_HIS_TEMP_HVON_MIN_MOD17_T5_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 17 Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 20°C &lt; TmodMin &lt;= 30°C |
| STAT_HIS_TEMP_HVON_MIN_MOD17_T6_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 17  Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 30°C &lt; TmodMin &lt;= 35°C |
| STAT_HIS_TEMP_HVON_MIN_MOD17_T7_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 17  Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: TmodMin &gt; 35°C |
| STAT_HIS_TEMP_HVON_MIN_MOD18_T1_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 18 Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: TmodMin &lt;= -20°C |
| STAT_HIS_TEMP_HVON_MIN_MOD18_T2_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 18 Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: -20°C &lt; TmodMin &lt;= -5°C |
| STAT_HIS_TEMP_HVON_MIN_MOD18_T3_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 18  Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: -5°C &lt; TmodMin &lt;= 10°C |
| STAT_HIS_TEMP_HVON_MIN_MOD18_T4_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 18  Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 10°C &lt; TmodMin &lt;= 20°C |
| STAT_HIS_TEMP_HVON_MIN_MOD18_T5_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 18 Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 20°C &lt; TmodMin &lt;= 30°C |
| STAT_HIS_TEMP_HVON_MIN_MOD18_T6_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 18  Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 30°C &lt; TmodMin &lt;= 35°C |
| STAT_HIS_TEMP_HVON_MIN_MOD18_T7_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 18 Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: TmodMin &gt; 35°C |
| STAT_HIS_TEMP_HVON_MIN_MOD19_T1_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 19 Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: TmodMin &lt;= -20°C |
| STAT_HIS_TEMP_HVON_MIN_MOD19_T2_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 19  Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: -20°C &lt; TmodMin &lt;= -5°C |
| STAT_HIS_TEMP_HVON_MIN_MOD19_T3_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 19   Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: -5°C &lt; TmodMin &lt;= 10°C |
| STAT_HIS_TEMP_HVON_MIN_MOD19_T4_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 19   Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 10°C &lt; TmodMin &lt;= 20°C |
| STAT_HIS_TEMP_HVON_MIN_MOD19_T5_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 19  Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 20°C &lt; TmodMin &lt;= 30°C |
| STAT_HIS_TEMP_HVON_MIN_MOD19_T6_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 19   Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 30°C &lt; TmodMin &lt;= 35°C |
| STAT_HIS_TEMP_HVON_MIN_MOD19_T7_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 19  Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: TmodMin &gt; 35°C |
| STAT_HIS_TEMP_HVON_MIN_MOD20_T1_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 20 Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: TmodMin &lt;= -20°C |
| STAT_HIS_TEMP_HVON_MIN_MOD20_T2_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 20  Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: -20°C &lt; TmodMin &lt;= -5°C |
| STAT_HIS_TEMP_HVON_MIN_MOD20_T3_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 20  Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: -5°C &lt; TmodMin &lt;= 10°C |
| STAT_HIS_TEMP_HVON_MIN_MOD20_T4_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 20   Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 10°C &lt; TmodMin &lt;= 20°C |
| STAT_HIS_TEMP_HVON_MIN_MOD20_T5_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 20  Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 20°C &lt; TmodMin &lt;= 30°C |
| STAT_HIS_TEMP_HVON_MIN_MOD20_T6_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 20   Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 30°C &lt; TmodMin &lt;= 35°C |
| STAT_HIS_TEMP_HVON_MIN_MOD20_T7_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 20  Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: TmodMin &gt; 35°C |
| STAT_HIS_TEMP_HVON_MIN_MOD21_T1_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 21 Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: TmodMin &lt;= -20°C |
| STAT_HIS_TEMP_HVON_MIN_MOD21_T2_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 21 Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: -20°C &lt; TmodMin &lt;= -5°C |
| STAT_HIS_TEMP_HVON_MIN_MOD21_T3_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 21  Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: -5°C &lt; TmodMin &lt;= 10°C |
| STAT_HIS_TEMP_HVON_MIN_MOD21_T4_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 21   Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 10°C &lt; TmodMin &lt;= 20°C |
| STAT_HIS_TEMP_HVON_MIN_MOD21_T5_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 21  Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 20°C &lt; TmodMin &lt;= 30°C |
| STAT_HIS_TEMP_HVON_MIN_MOD21_T6_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 21  Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 30°C &lt; TmodMin &lt;= 35°C |
| STAT_HIS_TEMP_HVON_MIN_MOD21_T7_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 21  Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: TmodMin &gt; 35°C |
| STAT_HIS_TEMP_HVON_MIN_MOD22_T1_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 22 Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: TmodMin &lt;= -20°C |
| STAT_HIS_TEMP_HVON_MIN_MOD22_T2_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 22 Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: -20°C &lt; TmodMin &lt;= -5°C |
| STAT_HIS_TEMP_HVON_MIN_MOD22_T3_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 22  Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: -5°C &lt; TmodMin &lt;= 10°C |
| STAT_HIS_TEMP_HVON_MIN_MOD22_T4_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 22   Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 10°C &lt; TmodMin &lt;= 20°C |
| STAT_HIS_TEMP_HVON_MIN_MOD22_T5_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 22  Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 20°C &lt; TmodMin &lt;= 30°C |
| STAT_HIS_TEMP_HVON_MIN_MOD22_T6_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 22  Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 30°C &lt; TmodMin &lt;= 35°C |
| STAT_HIS_TEMP_HVON_MIN_MOD22_T7_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 22  Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: TmodMin &gt; 35°C |
| STAT_HIS_TEMP_HVON_MIN_MOD23_T1_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 23 Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: TmodMin &lt;= -20°C |
| STAT_HIS_TEMP_HVON_MIN_MOD23_T2_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 23 Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: -20°C &lt; TmodMin &lt;= -5°C |
| STAT_HIS_TEMP_HVON_MIN_MOD23_T3_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 23  Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: -5°C &lt; TmodMin &lt;= 10°C |
| STAT_HIS_TEMP_HVON_MIN_MOD23_T4_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 23   Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 10°C &lt; TmodMin &lt;= 20°C |
| STAT_HIS_TEMP_HVON_MIN_MOD23_T5_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 23  Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 20°C &lt; TmodMin &lt;= 30°C |
| STAT_HIS_TEMP_HVON_MIN_MOD23_T6_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 23  Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 30°C &lt; TmodMin &lt;= 35°C |
| STAT_HIS_TEMP_HVON_MIN_MOD23_T7_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 23  Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: TmodMin &gt; 35°C |
| STAT_HIS_TEMP_HVON_MIN_MOD24_T1_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 24 Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: TmodMin &lt;= -20°C |
| STAT_HIS_TEMP_HVON_MIN_MOD24_T2_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 24 Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: -20°C &lt; TmodMin &lt;= -5°C |
| STAT_HIS_TEMP_HVON_MIN_MOD24_T3_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 24  Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: -5°C &lt; TmodMin &lt;= 10°C |
| STAT_HIS_TEMP_HVON_MIN_MOD24_T4_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 24   Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 10°C &lt; TmodMin &lt;= 20°C |
| STAT_HIS_TEMP_HVON_MIN_MOD24_T5_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 24  Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 20°C &lt; TmodMin &lt;= 30°C |
| STAT_HIS_TEMP_HVON_MIN_MOD24_T6_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 24  Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 30°C &lt; TmodMin &lt;= 35°C |
| STAT_HIS_TEMP_HVON_MIN_MOD24_T7_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 24  Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: TmodMin &gt; 35°C |
| STAT_HIS_TEMP_HVON_MIN_MOD25_T1_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 25 Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: TmodMin &lt;= -20°C |
| STAT_HIS_TEMP_HVON_MIN_MOD25_T2_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 25 Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: -20°C &lt; TmodMin &lt;= -5°C |
| STAT_HIS_TEMP_HVON_MIN_MOD25_T3_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 25  Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: -5°C &lt; TmodMin &lt;= 10°C |
| STAT_HIS_TEMP_HVON_MIN_MOD25_T4_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 25   Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 10°C &lt; TmodMin &lt;= 20°C |
| STAT_HIS_TEMP_HVON_MIN_MOD25_T5_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 25  Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 20°C &lt; TmodMin &lt;= 30°C |
| STAT_HIS_TEMP_HVON_MIN_MOD25_T6_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 25  Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 30°C &lt; TmodMin &lt;= 35°C |
| STAT_HIS_TEMP_HVON_MIN_MOD25_T7_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 25  Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: TmodMin &gt; 35°C |
| STAT_HIS_TEMP_HVON_MIN_MOD26_T1_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 26 Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: TmodMin &lt;= -20°C |
| STAT_HIS_TEMP_HVON_MIN_MOD26_T2_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 26 Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: -20°C &lt; TmodMin &lt;= -5°C |
| STAT_HIS_TEMP_HVON_MIN_MOD26_T3_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 26  Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: -5°C &lt; TmodMin &lt;= 10°C |
| STAT_HIS_TEMP_HVON_MIN_MOD26_T4_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 26   Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 10°C &lt; TmodMin &lt;= 20°C |
| STAT_HIS_TEMP_HVON_MIN_MOD26_T5_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 26  Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 20°C &lt; TmodMin &lt;= 30°C |
| STAT_HIS_TEMP_HVON_MIN_MOD26_T6_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 26  Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 30°C &lt; TmodMin &lt;= 35°C |
| STAT_HIS_TEMP_HVON_MIN_MOD26_T7_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 26  Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: TmodMin &gt; 35°C |
| STAT_HIS_TEMP_HVON_MIN_MOD27_T1_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 27 Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: TmodMin &lt;= -20°C |
| STAT_HIS_TEMP_HVON_MIN_MOD27_T2_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 27 Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: -20°C &lt; TmodMin &lt;= -5°C |
| STAT_HIS_TEMP_HVON_MIN_MOD27_T3_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 27  Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: -5°C &lt; TmodMin &lt;= 10°C |
| STAT_HIS_TEMP_HVON_MIN_MOD27_T4_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 27   Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 10°C &lt; TmodMin &lt;= 20°C |
| STAT_HIS_TEMP_HVON_MIN_MOD27_T5_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 27  Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 20°C &lt; TmodMin &lt;= 30°C |
| STAT_HIS_TEMP_HVON_MIN_MOD27_T6_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 27  Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 30°C &lt; TmodMin &lt;= 35°C |
| STAT_HIS_TEMP_HVON_MIN_MOD27_T7_WERT | min | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 27  Dauer der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: TmodMin &gt; 35°C |
...
| STAT_HIS_TEMP_HVON_MAX_MOD10_T1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 10 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: TmodMax &lt;= 35°C |
| STAT_HIS_TEMP_HVON_MAX_MOD10_T2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 10 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 35°C &lt; TmodMax &lt;= 40°C |
| STAT_HIS_TEMP_HVON_MAX_MOD10_T3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 10 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 40°C &lt; TmodMax &lt;= 50°C |
| STAT_HIS_TEMP_HVON_MAX_MOD10_T4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 10 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 50°C &lt; TmodMax &lt;= 60°C |
| STAT_HIS_TEMP_HVON_MAX_MOD10_T5_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 10 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 60°C &lt; TmodMax &lt;= 70°C |
| STAT_HIS_TEMP_HVON_MAX_MOD10_T6_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 10 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 70°C &lt; TmodMax &lt;= 80°C |
| STAT_HIS_TEMP_HVON_MAX_MOD10_T7_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 10 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: TmodMax &gt; 80°C |
| STAT_HIS_TEMP_HVON_MAX_MOD11_T1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 11 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: TmodMax &lt;= 35°C |
| STAT_HIS_TEMP_HVON_MAX_MOD11_T2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 11 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 35°C &lt; TmodMax &lt;= 40°C |
| STAT_HIS_TEMP_HVON_MAX_MOD11_T3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 11 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 40°C &lt; TmodMax &lt;= 50°C |
| STAT_HIS_TEMP_HVON_MAX_MOD11_T4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 11 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 50°C &lt; TmodMax &lt;= 60°C |
| STAT_HIS_TEMP_HVON_MAX_MOD11_T5_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 11 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 60°C &lt; TmodMax &lt;= 70°C |
| STAT_HIS_TEMP_HVON_MAX_MOD11_T6_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 11 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 70°C &lt; TmodMax &lt;= 80°C |
| STAT_HIS_TEMP_HVON_MAX_MOD11_T7_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 11 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: TmodMax &gt; 80°C |
| STAT_HIS_TEMP_HVON_MAX_MOD12_T1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 12 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: TmodMax &lt;= 35°C |
| STAT_HIS_TEMP_HVON_MAX_MOD12_T2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 12 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 35°C &lt; TmodMax &lt;= 40°C |
| STAT_HIS_TEMP_HVON_MAX_MOD12_T3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 12 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 40°C &lt; TmodMax &lt;= 50°C |
| STAT_HIS_TEMP_HVON_MAX_MOD12_T4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 12 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 50°C &lt; TmodMax &lt;= 60°C |
| STAT_HIS_TEMP_HVON_MAX_MOD12_T5_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 12 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 60°C &lt; TmodMax &lt;= 70°C |
| STAT_HIS_TEMP_HVON_MAX_MOD12_T6_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 12 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 70°C &lt; TmodMax &lt;= 80°C |
| STAT_HIS_TEMP_HVON_MAX_MOD12_T7_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 12 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: TmodMax &gt; 80°C |
| STAT_HIS_TEMP_HVON_MAX_MOD13_T1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 13 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: TmodMax &lt;= 35°C |
| STAT_HIS_TEMP_HVON_MAX_MOD13_T2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 13 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 35°C &lt; TmodMax &lt;= 40°C |
| STAT_HIS_TEMP_HVON_MAX_MOD13_T3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 13 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 40°C &lt; TmodMax &lt;= 50°C |
| STAT_HIS_TEMP_HVON_MAX_MOD13_T4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 13 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 50°C &lt; TmodMax &lt;= 60°C |
| STAT_HIS_TEMP_HVON_MAX_MOD13_T5_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 13 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 60°C &lt; TmodMax &lt;= 70°C |
| STAT_HIS_TEMP_HVON_MAX_MOD13_T6_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 13 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 70°C &lt; TmodMax &lt;= 80°C |
| STAT_HIS_TEMP_HVON_MAX_MOD13_T7_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 13 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: TmodMax &gt; 80°C |
| STAT_HIS_TEMP_HVON_MAX_MOD14_T1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 14 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: TmodMax &lt;= 35°C |
| STAT_HIS_TEMP_HVON_MAX_MOD14_T2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 14 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 35°C &lt; TmodMax &lt;= 40°C |
| STAT_HIS_TEMP_HVON_MAX_MOD14_T3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 14 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 40°C &lt; TmodMax &lt;= 50°C |
| STAT_HIS_TEMP_HVON_MAX_MOD14_T4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 14 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 50°C &lt; TmodMax &lt;= 60°C |
| STAT_HIS_TEMP_HVON_MAX_MOD14_T5_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 14 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 60°C &lt; TmodMax &lt;= 70°C |
| STAT_HIS_TEMP_HVON_MAX_MOD14_T6_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 14 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 70°C &lt; TmodMax &lt;= 80°C |
| STAT_HIS_TEMP_HVON_MAX_MOD14_T7_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 14 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: TmodMax &gt; 80°C |
| STAT_HIS_TEMP_HVON_MAX_MOD15_T1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 15 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: TmodMax &lt;= 35°C |
| STAT_HIS_TEMP_HVON_MAX_MOD15_T2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 15 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 35°C &lt; TmodMax &lt;= 40°C |
| STAT_HIS_TEMP_HVON_MAX_MOD15_T3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 15 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 40°C &lt; TmodMax &lt;= 50°C |
| STAT_HIS_TEMP_HVON_MAX_MOD15_T4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 15 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 50°C &lt; TmodMax &lt;= 60°C |
| STAT_HIS_TEMP_HVON_MAX_MOD15_T5_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 15 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 60°C &lt; TmodMax &lt;= 70°C |
| STAT_HIS_TEMP_HVON_MAX_MOD15_T6_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 15 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 70°C &lt; TmodMax &lt;= 80°C |
| STAT_HIS_TEMP_HVON_MAX_MOD15_T7_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 15 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: TmodMax &gt; 80°C |
| STAT_HIS_TEMP_HVON_MAX_MOD16_T1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 16 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: TmodMax &lt;= 35°C |
| STAT_HIS_TEMP_HVON_MAX_MOD16_T2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 16 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 35°C &lt; TmodMax &lt;= 40°C |
| STAT_HIS_TEMP_HVON_MAX_MOD16_T3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 16 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 40°C &lt; TmodMax &lt;= 50°C |
| STAT_HIS_TEMP_HVON_MAX_MOD16_T4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 16 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 50°C &lt; TmodMax &lt;= 60°C |
| STAT_HIS_TEMP_HVON_MAX_MOD16_T5_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 16 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 60°C &lt; TmodMax &lt;= 70°C |
| STAT_HIS_TEMP_HVON_MAX_MOD16_T6_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 16 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 70°C &lt; TmodMax &lt;= 80°C |
| STAT_HIS_TEMP_HVON_MAX_MOD16_T7_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 16 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: TmodMax &gt; 80°C |
| STAT_HIS_TEMP_HVON_MAX_MOD17_T1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 17 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: TmodMax &lt;= 35°C |
| STAT_HIS_TEMP_HVON_MAX_MOD17_T2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 17 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 35°C &lt; TmodMax &lt;= 40°C |
| STAT_HIS_TEMP_HVON_MAX_MOD17_T3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 17 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 40°C &lt; TmodMax &lt;= 50°C |
| STAT_HIS_TEMP_HVON_MAX_MOD17_T4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 17 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 50°C &lt; TmodMax &lt;= 60°C |
| STAT_HIS_TEMP_HVON_MAX_MOD17_T5_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 17 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 60°C &lt; TmodMax &lt;= 70°C |
| STAT_HIS_TEMP_HVON_MAX_MOD17_T6_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 17 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 70°C &lt; TmodMax &lt;= 80°C |
| STAT_HIS_TEMP_HVON_MAX_MOD17_T7_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 17 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: TmodMax &gt; 80°C |
| STAT_HIS_TEMP_HVON_MAX_MOD18_T1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 18 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: TmodMax &lt;= 35°C |
| STAT_HIS_TEMP_HVON_MAX_MOD18_T2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 18 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 35°C &lt; TmodMax &lt;= 40°C |
| STAT_HIS_TEMP_HVON_MAX_MOD18_T3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 18 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 40°C &lt; TmodMax &lt;= 50°C |
| STAT_HIS_TEMP_HVON_MAX_MOD18_T4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 18 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 50°C &lt; TmodMax &lt;= 60°C |
| STAT_HIS_TEMP_HVON_MAX_MOD18_T5_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 18 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 60°C &lt; TmodMax &lt;= 70°C |
| STAT_HIS_TEMP_HVON_MAX_MOD18_T6_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 18 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 70°C &lt; TmodMax &lt;= 80°C |
| STAT_HIS_TEMP_HVON_MAX_MOD18_T7_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 18 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: TmodMax &gt; 80°C |
| STAT_HIS_TEMP_HVON_MAX_MOD19_T1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 19 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: TmodMax &lt;= 35°C |
| STAT_HIS_TEMP_HVON_MAX_MOD19_T2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 19 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 35°C &lt; TmodMax &lt;= 40°C |
| STAT_HIS_TEMP_HVON_MAX_MOD19_T3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 19 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 40°C &lt; TmodMax &lt;= 50°C |
| STAT_HIS_TEMP_HVON_MAX_MOD19_T4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 19 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 50°C &lt; TmodMax &lt;= 60°C |
| STAT_HIS_TEMP_HVON_MAX_MOD19_T5_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 19 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 60°C &lt; TmodMax &lt;= 70°C |
| STAT_HIS_TEMP_HVON_MAX_MOD19_T6_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 19 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 70°C &lt; TmodMax &lt;= 80°C |
| STAT_HIS_TEMP_HVON_MAX_MOD19_T7_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 19 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: TmodMax &gt; 80°C |
| STAT_HIS_TEMP_HVON_MAX_MOD20_T1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 20 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: TmodMax &lt;= 35°C |
| STAT_HIS_TEMP_HVON_MAX_MOD20_T2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 20 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 35°C &lt; TmodMax &lt;= 40°C |
| STAT_HIS_TEMP_HVON_MAX_MOD20_T3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 20 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 40°C &lt; TmodMax &lt;= 50°C |
| STAT_HIS_TEMP_HVON_MAX_MOD20_T4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 20 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 50°C &lt; TmodMax &lt;= 60°C |
| STAT_HIS_TEMP_HVON_MAX_MOD20_T5_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 20 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 60°C &lt; TmodMax &lt;= 70°C |
| STAT_HIS_TEMP_HVON_MAX_MOD20_T6_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 20 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 70°C &lt; TmodMax &lt;= 80°C |
| STAT_HIS_TEMP_HVON_MAX_MOD20_T7_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 20 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: TmodMax &gt; 80°C |
| STAT_HIS_TEMP_HVON_MAX_MOD21_T1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 21 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: TmodMax &lt;= 35°C |
| STAT_HIS_TEMP_HVON_MAX_MOD21_T2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 21 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 35°C &lt; TmodMax &lt;= 40°C |
| STAT_HIS_TEMP_HVON_MAX_MOD21_T3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 21 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 40°C &lt; TmodMax &lt;= 50°C |
| STAT_HIS_TEMP_HVON_MAX_MOD21_T4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 21 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 50°C &lt; TmodMax &lt;= 60°C |
| STAT_HIS_TEMP_HVON_MAX_MOD21_T5_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 21 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 60°C &lt; TmodMax &lt;= 70°C |
| STAT_HIS_TEMP_HVON_MAX_MOD21_T6_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 21 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 70°C &lt; TmodMax &lt;= 80°C |
| STAT_HIS_TEMP_HVON_MAX_MOD21_T7_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 21 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: TmodMax &gt; 80°C |
| STAT_HIS_TEMP_HVON_MAX_MOD22_T1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 22 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: TmodMax &lt;= 35°C |
| STAT_HIS_TEMP_HVON_MAX_MOD22_T2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 22 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 35°C &lt; TmodMax &lt;= 40°C |
| STAT_HIS_TEMP_HVON_MAX_MOD22_T3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 22 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 40°C &lt; TmodMax &lt;= 50°C |
| STAT_HIS_TEMP_HVON_MAX_MOD22_T4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 22 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 50°C &lt; TmodMax &lt;= 60°C |
| STAT_HIS_TEMP_HVON_MAX_MOD22_T5_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 22 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 60°C &lt; TmodMax &lt;= 70°C |
| STAT_HIS_TEMP_HVON_MAX_MOD22_T6_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 22 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 70°C &lt; TmodMax &lt;= 80°C |
| STAT_HIS_TEMP_HVON_MAX_MOD22_T7_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 22 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: TmodMax &gt; 80°C |
| STAT_HIS_TEMP_HVON_MAX_MOD23_T1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 23 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: TmodMax &lt;= 35°C |
| STAT_HIS_TEMP_HVON_MAX_MOD23_T2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 23 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 35°C &lt; TmodMax &lt;= 40°C |
| STAT_HIS_TEMP_HVON_MAX_MOD23_T3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 23 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 40°C &lt; TmodMax &lt;= 50°C |
| STAT_HIS_TEMP_HVON_MAX_MOD23_T4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 23 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 50°C &lt; TmodMax &lt;= 60°C |
| STAT_HIS_TEMP_HVON_MAX_MOD23_T5_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 23 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 60°C &lt; TmodMax &lt;= 70°C |
| STAT_HIS_TEMP_HVON_MAX_MOD23_T6_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 23 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 70°C &lt; TmodMax &lt;= 80°C |
| STAT_HIS_TEMP_HVON_MAX_MOD23_T7_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 23 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: TmodMax &gt; 80°C |
| STAT_HIS_TEMP_HVON_MAX_MOD24_T1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 24 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: TmodMax &lt;= 35°C |
| STAT_HIS_TEMP_HVON_MAX_MOD24_T2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 24 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 35°C &lt; TmodMax &lt;= 40°C |
| STAT_HIS_TEMP_HVON_MAX_MOD24_T3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 24 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 40°C &lt; TmodMax &lt;= 50°C |
| STAT_HIS_TEMP_HVON_MAX_MOD24_T4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 24 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 50°C &lt; TmodMax &lt;= 60°C |
| STAT_HIS_TEMP_HVON_MAX_MOD24_T5_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 24 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 60°C &lt; TmodMax &lt;= 70°C |
| STAT_HIS_TEMP_HVON_MAX_MOD24_T6_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 24 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 70°C &lt; TmodMax &lt;= 80°C |
| STAT_HIS_TEMP_HVON_MAX_MOD24_T7_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 24 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: TmodMax &gt; 80°C |
| STAT_HIS_TEMP_HVON_MAX_MOD25_T1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 25 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: TmodMax &lt;= 35°C |
| STAT_HIS_TEMP_HVON_MAX_MOD25_T2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 25 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 35°C &lt; TmodMax &lt;= 40°C |
| STAT_HIS_TEMP_HVON_MAX_MOD25_T3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 25 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 40°C &lt; TmodMax &lt;= 50°C |
| STAT_HIS_TEMP_HVON_MAX_MOD25_T4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 25 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 50°C &lt; TmodMax &lt;= 60°C |
| STAT_HIS_TEMP_HVON_MAX_MOD25_T5_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 25 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 60°C &lt; TmodMax &lt;= 70°C |
| STAT_HIS_TEMP_HVON_MAX_MOD25_T6_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 25 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 70°C &lt; TmodMax &lt;= 80°C |
| STAT_HIS_TEMP_HVON_MAX_MOD25_T7_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 25 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: TmodMax &gt; 80°C |
| STAT_HIS_TEMP_HVON_MAX_MOD26_T1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 26 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: TmodMax &lt;= 35°C |
| STAT_HIS_TEMP_HVON_MAX_MOD26_T2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 26 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 35°C &lt; TmodMax &lt;= 40°C |
| STAT_HIS_TEMP_HVON_MAX_MOD26_T3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 26 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 40°C &lt; TmodMax &lt;= 50°C |
| STAT_HIS_TEMP_HVON_MAX_MOD26_T4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 26 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 50°C &lt; TmodMax &lt;= 60°C |
| STAT_HIS_TEMP_HVON_MAX_MOD26_T5_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 26 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 60°C &lt; TmodMax &lt;= 70°C |
| STAT_HIS_TEMP_HVON_MAX_MOD26_T6_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 26 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 70°C &lt; TmodMax &lt;= 80°C |
| STAT_HIS_TEMP_HVON_MAX_MOD26_T7_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 26 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: TmodMax &gt; 80°C |
| STAT_HIS_TEMP_HVON_MAX_MOD27_T1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 27 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: TmodMax &lt;= 35°C |
| STAT_HIS_TEMP_HVON_MAX_MOD27_T2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 27 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 35°C &lt; TmodMax &lt;= 40°C |
| STAT_HIS_TEMP_HVON_MAX_MOD27_T3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 27 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 40°C &lt; TmodMax &lt;= 50°C |
| STAT_HIS_TEMP_HVON_MAX_MOD27_T4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 27 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 50°C &lt; TmodMax &lt;= 60°C |
| STAT_HIS_TEMP_HVON_MAX_MOD27_T5_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 27 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 60°C &lt; TmodMax &lt;= 70°C |
| STAT_HIS_TEMP_HVON_MAX_MOD27_T6_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 27 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: 70°C &lt; TmodMax &lt;= 80°C |
| STAT_HIS_TEMP_HVON_MAX_MOD27_T7_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 27 Dauer der grössten gemessenen Zelltemperatur bei geschlossen Schützen in der Klasse: TmodMax &gt; 80°C |

<a id="table-res-0xe579-d"></a>
### RES_0XE579_D

Dimensions: 324 rows × 10 columns
...
| STAT_HIS_TEMP_HVOFF_AVG_MOD6_T1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 06 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: TmodMean &lt;= -20°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD6_T2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 06 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: -20°C &lt; TmodMean &lt;= -5°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD6_T3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 06 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: -5°C &lt; TmodMean &lt;= 10°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD6_T4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 06 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 10°C &lt; TmodMean &lt;= 20°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD6_T5_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 06 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 20°C &lt; TmodMean &lt;= 30°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD6_T6_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 06 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 30°C &lt; TmodMean &lt;= 35°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD6_T7_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 06 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 35°C &lt; TmodMean &lt;= 40°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD6_T8_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 06 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 40°C &lt; TmodMean &lt;= 50°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD6_T9_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 06 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 50°C &lt; TmodMean &lt;= 60°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD6_T10_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 06 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 60°C &lt; TmodMean &lt;= 70°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD6_T11_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 06 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 70°C &lt; TmodMean &lt;= 80°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD6_T12_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 06 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: TmodMean &gt; 80°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD7_T1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 07 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: TmodMean &lt;= -20°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD7_T2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 07 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: -20°C &lt; TmodMean &lt;= -5°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD7_T3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 07 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: -5°C &lt; TmodMean &lt;= 10°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD7_T4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 07 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 10°C &lt; TmodMean &lt;= 20°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD7_T5_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 07 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 20°C &lt; TmodMean &lt;= 30°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD7_T6_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 07 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 30°C &lt; TmodMean &lt;= 35°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD7_T7_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 07 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 35°C &lt; TmodMean &lt;= 40°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD7_T8_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 07 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 40°C &lt; TmodMean &lt;= 50°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD7_T9_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 07 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 50°C &lt; TmodMean &lt;= 60°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD7_T10_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 07 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 60°C &lt; TmodMean &lt;= 70°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD7_T11_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 07 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 70°C &lt; TmodMean &lt;= 80°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD7_T12_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 07 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: TmodMean &gt; 80°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD8_T1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 08 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: TmodMean &lt;= -20°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD8_T2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 08 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: -20°C &lt; TmodMean &lt;= -5°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD8_T3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 08 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: -5°C &lt; TmodMean &lt;= 10°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD8_T4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 08 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 10°C &lt; TmodMean &lt;= 20°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD8_T5_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 08 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 20°C &lt; TmodMean &lt;= 30°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD8_T6_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 08 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 30°C &lt; TmodMean &lt;= 35°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD8_T7_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 08 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 35°C &lt; TmodMean &lt;= 40°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD8_T8_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 08 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 40°C &lt; TmodMean &lt;= 50°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD8_T9_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 08 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 50°C &lt; TmodMean &lt;= 60°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD8_T10_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 08 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 60°C &lt; TmodMean &lt;= 70°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD8_T11_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 08 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 70°C &lt; TmodMean &lt;= 80°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD8_T12_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 08 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: TmodMean &gt; 80°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD9_T1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 09 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: TmodMean &lt;= -20°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD9_T2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 09 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: -20°C &lt; TmodMean &lt;= -5°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD9_T3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 09 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: -5°C &lt; TmodMean &lt;= 10°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD9_T4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 09 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 10°C &lt; TmodMean &lt;= 20°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD9_T5_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 09 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 20°C &lt; TmodMean &lt;= 30°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD9_T6_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 09 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 30°C &lt; TmodMean &lt;= 35°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD9_T7_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 09 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 35°C &lt; TmodMean &lt;= 40°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD9_T8_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 09 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 40°C &lt; TmodMean &lt;= 50°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD9_T9_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 09 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 50°C &lt; TmodMean &lt;= 60°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD9_T10_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 09 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 60°C &lt; TmodMean &lt;= 70°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD9_T11_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 09 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 70°C &lt; TmodMean &lt;= 80°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD9_T12_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 09 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: TmodMean &gt; 80°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD10_T1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 10 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: TmodMean &lt;= -20°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD10_T2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 10 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: -20°C &lt; TmodMean &lt;= -5°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD10_T3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 10 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: -5°C &lt; TmodMean &lt;= 10°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD10_T4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 10 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 10°C &lt; TmodMean &lt;= 20°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD10_T5_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 10 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 20°C &lt; TmodMean &lt;= 30°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD10_T6_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 10 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 30°C &lt; TmodMean &lt;= 35°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD10_T7_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 10 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 35°C &lt; TmodMean &lt;= 40°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD10_T8_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 10 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 40°C &lt; TmodMean &lt;= 50°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD10_T9_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 10 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 50°C &lt; TmodMean &lt;= 60°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD10_T10_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 10 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 60°C &lt; TmodMean &lt;= 70°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD10_T11_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 10 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 70°C &lt; TmodMean &lt;= 80°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD10_T12_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 10 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: TmodMean &gt; 80°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD11_T1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 11 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: TmodMean &lt;= -20°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD11_T2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 11 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: -20°C &lt; TmodMean &lt;= -5°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD11_T3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 11 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: -5°C &lt; TmodMean &lt;= 10°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD11_T4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 11 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 10°C &lt; TmodMean &lt;= 20°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD11_T5_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 11 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 20°C &lt; TmodMean &lt;= 30°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD11_T6_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 11 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 30°C &lt; TmodMean &lt;= 35°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD11_T7_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 11 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 35°C &lt; TmodMean &lt;= 40°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD11_T8_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 11 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 40°C &lt; TmodMean &lt;= 50°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD11_T9_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 11 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 50°C &lt; TmodMean &lt;= 60°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD11_T10_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 11 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 60°C &lt; TmodMean &lt;= 70°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD11_T11_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 11 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 70°C &lt; TmodMean &lt;= 80°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD11_T12_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 11 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: TmodMean &gt; 80°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD12_T1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 12 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: TmodMean &lt;= -20°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD12_T2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 12 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: -20°C &lt; TmodMean &lt;= -5°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD12_T3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 12 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: -5°C &lt; TmodMean &lt;= 10°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD12_T4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 12 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 10°C &lt; TmodMean &lt;= 20°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD12_T5_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 12 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 20°C &lt; TmodMean &lt;= 30°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD12_T6_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 12 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 30°C &lt; TmodMean &lt;= 35°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD12_T7_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 12 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 35°C &lt; TmodMean &lt;= 40°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD12_T8_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 12 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 40°C &lt; TmodMean &lt;= 50°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD12_T9_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 12 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 50°C &lt; TmodMean &lt;= 60°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD12_T10_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 12 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 60°C &lt; TmodMean &lt;= 70°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD12_T11_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 12 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 70°C &lt; TmodMean &lt;= 80°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD12_T12_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 12 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: TmodMean &gt; 80°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD13_T1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 13 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: TmodMean &lt;= -20°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD13_T2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 13 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: -20°C &lt; TmodMean &lt;= -5°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD13_T3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 13 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: -5°C &lt; TmodMean &lt;= 10°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD13_T4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 13 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 10°C &lt; TmodMean &lt;= 20°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD13_T5_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 13 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 20°C &lt; TmodMean &lt;= 30°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD13_T6_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 13 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 30°C &lt; TmodMean &lt;= 35°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD13_T7_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 13 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 35°C &lt; TmodMean &lt;= 40°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD13_T8_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 13 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 40°C &lt; TmodMean &lt;= 50°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD13_T9_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 13 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 50°C &lt; TmodMean &lt;= 60°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD13_T10_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 13 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 60°C &lt; TmodMean &lt;= 70°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD13_T11_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 13 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 70°C &lt; TmodMean &lt;= 80°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD13_T12_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 13 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: TmodMean &gt; 80°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD14_T1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 14 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: TmodMean &lt;= -20°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD14_T2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 14 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: -20°C &lt; TmodMean &lt;= -5°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD14_T3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 14 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: -5°C &lt; TmodMean &lt;= 10°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD14_T4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 14 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 10°C &lt; TmodMean &lt;= 20°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD14_T5_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 14 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 20°C &lt; TmodMean &lt;= 30°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD14_T6_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 14 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 30°C &lt; TmodMean &lt;= 35°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD14_T7_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 14 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 35°C &lt; TmodMean &lt;= 40°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD14_T8_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 14 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 40°C &lt; TmodMean &lt;= 50°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD14_T9_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 14 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 50°C &lt; TmodMean &lt;= 60°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD14_T10_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 14 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 60°C &lt; TmodMean &lt;= 70°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD14_T11_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 14 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 70°C &lt; TmodMean &lt;= 80°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD14_T12_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 14 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: TmodMean &gt; 80°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD15_T1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 15 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: TmodMean &lt;= -20°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD15_T2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 15 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: -20°C &lt; TmodMean &lt;= -5°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD15_T3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 15 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: -5°C &lt; TmodMean &lt;= 10°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD15_T4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 15 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 10°C &lt; TmodMean &lt;= 20°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD15_T5_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 15 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 20°C &lt; TmodMean &lt;= 30°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD15_T6_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 15 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 30°C &lt; TmodMean &lt;= 35°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD15_T7_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 15 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 35°C &lt; TmodMean &lt;= 40°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD15_T8_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 15 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 40°C &lt; TmodMean &lt;= 50°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD15_T9_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 15 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 50°C &lt; TmodMean &lt;= 60°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD15_T10_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 15 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 60°C &lt; TmodMean &lt;= 70°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD15_T11_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 15 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 70°C &lt; TmodMean &lt;= 80°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD15_T12_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 15 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: TmodMean &gt; 80°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD16_T1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 16 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: TmodMean &lt;= -20°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD16_T2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 16 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: -20°C &lt; TmodMean &lt;= -5°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD16_T3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 16 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: -5°C &lt; TmodMean &lt;= 10°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD16_T4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 16 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 10°C &lt; TmodMean &lt;= 20°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD16_T5_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 16 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 20°C &lt; TmodMean &lt;= 30°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD16_T6_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 16 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 30°C &lt; TmodMean &lt;= 35°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD16_T7_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 16 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 35°C &lt; TmodMean &lt;= 40°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD16_T8_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 16 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 40°C &lt; TmodMean &lt;= 50°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD16_T9_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 16 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 50°C &lt; TmodMean &lt;= 60°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD16_T10_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 16 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 60°C &lt; TmodMean &lt;= 70°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD16_T11_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 16 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 70°C &lt; TmodMean &lt;= 80°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD16_T12_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 16 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: TmodMean &gt; 80°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD17_T1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 17 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: TmodMean &lt;= -20°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD17_T2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 17 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: -20°C &lt; TmodMean &lt;= -5°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD17_T3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 17 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: -5°C &lt; TmodMean &lt;= 10°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD17_T4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 17 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 10°C &lt; TmodMean &lt;= 20°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD17_T5_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 17 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 20°C &lt; TmodMean &lt;= 30°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD17_T6_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 17 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 30°C &lt; TmodMean &lt;= 35°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD17_T7_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 17 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 35°C &lt; TmodMean &lt;= 40°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD17_T8_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 17 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 40°C &lt; TmodMean &lt;= 50°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD17_T9_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 17 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 50°C &lt; TmodMean &lt;= 60°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD17_T10_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 17 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 60°C &lt; TmodMean &lt;= 70°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD17_T11_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 17 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 70°C &lt; TmodMean &lt;= 80°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD17_T12_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 17 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: TmodMean &gt; 80°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD18_T1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 18 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: TmodMean &lt;= -20°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD18_T2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 18 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: -20°C &lt; TmodMean &lt;= -5°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD18_T3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 18 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: -5°C &lt; TmodMean &lt;= 10°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD18_T4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 18 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 10°C &lt; TmodMean &lt;= 20°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD18_T5_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 18 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 20°C &lt; TmodMean &lt;= 30°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD18_T6_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 18 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 30°C &lt; TmodMean &lt;= 35°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD18_T7_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 18 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 35°C &lt; TmodMean &lt;= 40°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD18_T8_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 18 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 40°C &lt; TmodMean &lt;= 50°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD18_T9_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 18 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 50°C &lt; TmodMean &lt;= 60°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD18_T10_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 18 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 60°C &lt; TmodMean &lt;= 70°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD18_T11_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 18 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 70°C &lt; TmodMean &lt;= 80°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD18_T12_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 18 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: TmodMean &gt; 80°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD19_T1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 19 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: TmodMean &lt;= -20°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD19_T2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 19 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: -20°C &lt; TmodMean &lt;= -5°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD19_T3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 19 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: -5°C &lt; TmodMean &lt;= 10°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD19_T4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 19 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 10°C &lt; TmodMean &lt;= 20°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD19_T5_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 19 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 20°C &lt; TmodMean &lt;= 30°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD19_T6_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 19 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 30°C &lt; TmodMean &lt;= 35°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD19_T7_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 19 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 35°C &lt; TmodMean &lt;= 40°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD19_T8_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 19 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 40°C &lt; TmodMean &lt;= 50°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD19_T9_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 19 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 50°C &lt; TmodMean &lt;= 60°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD19_T10_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 19 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 60°C &lt; TmodMean &lt;= 70°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD19_T11_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 19 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 70°C &lt; TmodMean &lt;= 80°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD19_T12_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 19 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: TmodMean &gt; 80°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD20_T1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 20 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: TmodMean &lt;= -20°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD20_T2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 20 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: -20°C &lt; TmodMean &lt;= -5°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD20_T3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 20 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: -5°C &lt; TmodMean &lt;= 10°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD20_T4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 20 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 10°C &lt; TmodMean &lt;= 20°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD20_T5_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 20 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 20°C &lt; TmodMean &lt;= 30°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD20_T6_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 20 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 30°C &lt; TmodMean &lt;= 35°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD20_T7_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 20 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 35°C &lt; TmodMean &lt;= 40°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD20_T8_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 20 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 40°C &lt; TmodMean &lt;= 50°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD20_T9_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 20 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 50°C &lt; TmodMean &lt;= 60°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD20_T10_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 20 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 60°C &lt; TmodMean &lt;= 70°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD20_T11_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 20 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 70°C &lt; TmodMean &lt;= 80°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD20_T12_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 20 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: TmodMean &gt; 80°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD21_T1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 21 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: TmodMean &lt;= -20°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD21_T2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 21 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: -20°C &lt; TmodMean &lt;= -5°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD21_T3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 21 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: -5°C &lt; TmodMean &lt;= 10°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD21_T4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 21 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 10°C &lt; TmodMean &lt;= 20°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD21_T5_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 21 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 20°C &lt; TmodMean &lt;= 30°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD21_T6_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 21 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 30°C &lt; TmodMean &lt;= 35°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD21_T7_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 21 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 35°C &lt; TmodMean &lt;= 40°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD21_T8_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 21 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 40°C &lt; TmodMean &lt;= 50°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD21_T9_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 21 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 50°C &lt; TmodMean &lt;= 60°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD21_T10_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 21 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 60°C &lt; TmodMean &lt;= 70°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD21_T11_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 21 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 70°C &lt; TmodMean &lt;= 80°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD21_T12_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 21 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: TmodMean &gt; 80°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD22_T1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 22 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: TmodMean &lt;= -20°C2 |
| STAT_HIS_TEMP_HVOFF_AVG_MOD22_T2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 22 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: -20°C &lt; TmodMean &lt;= -5°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD22_T3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 22 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: -5°C &lt; TmodMean &lt;= 10°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD22_T4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 22 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 10°C &lt; TmodMean &lt;= 20°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD22_T5_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 22 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 20°C &lt; TmodMean &lt;= 30°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD22_T6_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 22 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 30°C &lt; TmodMean &lt;= 35°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD22_T7_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 22 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 35°C &lt; TmodMean &lt;= 40°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD22_T8_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 22 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 40°C &lt; TmodMean &lt;= 50°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD22_T9_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 22 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 50°C &lt; TmodMean &lt;= 60°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD22_T10_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 22 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 60°C &lt; TmodMean &lt;= 70°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD22_T11_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 22 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 70°C &lt; TmodMean &lt;= 80°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD22_T12_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 22 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: TmodMean &gt; 80°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD23_T1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 23 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: TmodMean &lt;= -20°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD23_T2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 23 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: -20°C &lt; TmodMean &lt;= -5°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD23_T3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 23 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: -5°C &lt; TmodMean &lt;= 10°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD23_T4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 23 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 10°C &lt; TmodMean &lt;= 20°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD23_T5_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 23 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 20°C &lt; TmodMean &lt;= 30°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD23_T6_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 23 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 30°C &lt; TmodMean &lt;= 35°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD23_T7_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 23 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 35°C &lt; TmodMean &lt;= 40°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD23_T8_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 23 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 40°C &lt; TmodMean &lt;= 50°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD23_T9_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 23 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 50°C &lt; TmodMean &lt;= 60°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD23_T10_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 23 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 60°C &lt; TmodMean &lt;= 70°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD23_T11_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 23 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 70°C &lt; TmodMean &lt;= 80°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD23_T12_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 23 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: TmodMean &gt; 80°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD24_T1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 24 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: TmodMean &lt;= -20°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD24_T2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 24 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: -20°C &lt; TmodMean &lt;= -5°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD24_T3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 24 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: -5°C &lt; TmodMean &lt;= 10°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD24_T4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 24 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 10°C &lt; TmodMean &lt;= 20°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD24_T5_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 24 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 20°C &lt; TmodMean &lt;= 30°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD24_T6_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 24 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 30°C &lt; TmodMean &lt;= 35°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD24_T7_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 24 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 35°C &lt; TmodMean &lt;= 40°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD24_T8_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 24 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 40°C &lt; TmodMean &lt;= 50°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD24_T9_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 24 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 50°C &lt; TmodMean &lt;= 60°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD24_T10_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 24 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 60°C &lt; TmodMean &lt;= 70°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD24_T11_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 24 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 70°C &lt; TmodMean &lt;= 80°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD24_T12_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 24 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: TmodMean &gt; 80°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD25_T1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 25 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: TmodMean &lt;= -20°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD25_T2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 25 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: -20°C &lt; TmodMean &lt;= -5°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD25_T3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 25 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: -5°C &lt; TmodMean &lt;= 10°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD25_T4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 25 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 10°C &lt; TmodMean &lt;= 20°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD25_T5_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 25 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 20°C &lt; TmodMean &lt;= 30°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD25_T6_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 25 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 30°C &lt; TmodMean &lt;= 35°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD25_T7_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 25 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 35°C &lt; TmodMean &lt;= 40°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD25_T8_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 25 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 40°C &lt; TmodMean &lt;= 50°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD25_T9_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 25 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 50°C &lt; TmodMean &lt;= 60°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD25_T10_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 25 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 60°C &lt; TmodMean &lt;= 70°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD25_T11_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 25 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 70°C &lt; TmodMean &lt;= 80°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD25_T12_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 25 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: TmodMean &gt; 80°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD26_T1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 26 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: TmodMean &lt;= -20°C2 |
| STAT_HIS_TEMP_HVOFF_AVG_MOD26_T2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 26 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: -20°C &lt; TmodMean &lt;= -5°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD26_T3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 26 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: -5°C &lt; TmodMean &lt;= 10°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD26_T4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 26 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 10°C &lt; TmodMean &lt;= 20°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD26_T5_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 26 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 20°C &lt; TmodMean &lt;= 30°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD26_T6_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 26 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 30°C &lt; TmodMean &lt;= 35°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD26_T7_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 26 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 35°C &lt; TmodMean &lt;= 40°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD26_T8_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 26 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 40°C &lt; TmodMean &lt;= 50°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD26_T9_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 26 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 50°C &lt; TmodMean &lt;= 60°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD26_T10_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 26 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 60°C &lt; TmodMean &lt;= 70°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD26_T11_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 26 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 70°C &lt; TmodMean &lt;= 80°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD26_T12_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 26 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: TmodMean &gt; 80°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD27_T1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 27 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: TmodMean &lt;= -20°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD27_T2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 27 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: -20°C &lt; TmodMean &lt;= -5°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD27_T3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 27 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: -5°C &lt; TmodMean &lt;= 10°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD27_T4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 27 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 10°C &lt; TmodMean &lt;= 20°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD27_T5_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 27 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 20°C &lt; TmodMean &lt;= 30°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD27_T6_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 27 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 30°C &lt; TmodMean &lt;= 35°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD27_T7_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 27 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 35°C &lt; TmodMean &lt;= 40°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD27_T8_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 27 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 40°C &lt; TmodMean &lt;= 50°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD27_T9_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 27 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 50°C &lt; TmodMean &lt;= 60°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD27_T10_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 27 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 60°C &lt; TmodMean &lt;= 70°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD27_T11_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 27 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: 70°C &lt; TmodMean &lt;= 80°C |
| STAT_HIS_TEMP_HVOFF_AVG_MOD27_T12_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 27 Dauer der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen in der Klasse: TmodMean &gt; 80°C |

<a id="table-res-0xe57a-d"></a>
### RES_0XE57A_D

Dimensions: 110 rows × 10 columns
...
| STAT_HIS_SPANNUNG_MOD12_U1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 12 Dauer in Minuten in der Klasse UminLim &lt;= U &lt;= 3.62 |
| STAT_HIS_SPANNUNG_MOD12_U2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 12 Dauer in Minuten in der Klasse  3.57 &lt; U &lt;= 3.82 |
| STAT_HIS_SPANNUNG_MOD12_U3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 12 Dauer in Minuten in der Klasse  3.77 &lt; U &lt;= 3.98 |
| STAT_HIS_SPANNUNG_MOD12_U4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 12 Dauer in Minuten in der Klasse  3.93 &lt; U &lt;= UmaxLim |
| STAT_HIS_SPANNUNG_MOD13_U1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 13 Dauer in Minuten in der Klasse UminLim &lt;= U &lt;= 3.62 |
| STAT_HIS_SPANNUNG_MOD13_U2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 13 Dauer in Minuten in der Klasse  3.57 &lt; U &lt;= 3.82 |
| STAT_HIS_SPANNUNG_MOD13_U3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 13 Dauer in Minuten in der Klasse  3.77 &lt; U &lt;= 3.98 |
| STAT_HIS_SPANNUNG_MOD13_U4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 13 Dauer in Minuten in der Klasse  3.93 &lt; U &lt;= UmaxLim |
| STAT_HIS_SPANNUNG_MOD14_U1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 14 Dauer in Minuten in der Klasse UminLim &lt;= U &lt;= 3.63 |
| STAT_HIS_SPANNUNG_MOD14_U2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 14 Dauer in Minuten in der Klasse  3.57 &lt; U &lt;= 3.83 |
| STAT_HIS_SPANNUNG_MOD14_U3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 14 Dauer in Minuten in der Klasse  3.77 &lt; U &lt;= 3.99 |
| STAT_HIS_SPANNUNG_MOD14_U4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 14 Dauer in Minuten in der Klasse  3.93 &lt; U &lt;= UmaxLim |
| STAT_HIS_SPANNUNG_MOD15_U1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 15 Dauer in Minuten in der Klasse UminLim &lt;= U &lt;= 3.63 |
| STAT_HIS_SPANNUNG_MOD15_U2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 15 Dauer in Minuten in der Klasse  3.57 &lt; U &lt;= 3.83 |
| STAT_HIS_SPANNUNG_MOD15_U3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 15 Dauer in Minuten in der Klasse  3.77 &lt; U &lt;= 3.99 |
| STAT_HIS_SPANNUNG_MOD15_U4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 15 Dauer in Minuten in der Klasse  3.93 &lt; U &lt;= UmaxLim |
| STAT_HIS_SPANNUNG_MOD16_U1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 16 Dauer in Minuten in der Klasse UminLim &lt;= U &lt;= 3.64 |
| STAT_HIS_SPANNUNG_MOD16_U2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 16 Dauer in Minuten in der Klasse  3.57 &lt; U &lt;= 3.84 |
| STAT_HIS_SPANNUNG_MOD16_U3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 16 Dauer in Minuten in der Klasse  3.77 &lt; U &lt;= 3.100 |
| STAT_HIS_SPANNUNG_MOD16_U4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 16 Dauer in Minuten in der Klasse  3.93 &lt; U &lt;= UmaxLim |
| STAT_HIS_SPANNUNG_MOD17_U1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 17 Dauer in Minuten in der Klasse UminLim &lt;= U &lt;= 3.64 |
| STAT_HIS_SPANNUNG_MOD17_U2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 17 Dauer in Minuten in der Klasse  3.57 &lt; U &lt;= 3.84 |
| STAT_HIS_SPANNUNG_MOD17_U3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 17 Dauer in Minuten in der Klasse  3.77 &lt; U &lt;= 3.100 |
| STAT_HIS_SPANNUNG_MOD17_U4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 17 Dauer in Minuten in der Klasse  3.93 &lt; U &lt;= UmaxLim |
| STAT_HIS_SPANNUNG_MOD18_U1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 18 Dauer in Minuten in der Klasse UminLim &lt;= U &lt;= 3.65 |
| STAT_HIS_SPANNUNG_MOD18_U2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 18 Dauer in Minuten in der Klasse  3.57 &lt; U &lt;= 3.85 |
| STAT_HIS_SPANNUNG_MOD18_U3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 18 Dauer in Minuten in der Klasse  3.77 &lt; U &lt;= 3.101 |
| STAT_HIS_SPANNUNG_MOD18_U4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 18 Dauer in Minuten in der Klasse  3.93 &lt; U &lt;= UmaxLim |
| STAT_HIS_SPANNUNG_MOD19_U1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 19 Dauer in Minuten in der Klasse UminLim &lt;= U &lt;= 3.65 |
| STAT_HIS_SPANNUNG_MOD19_U2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 19 Dauer in Minuten in der Klasse  3.57 &lt; U &lt;= 3.85 |
| STAT_HIS_SPANNUNG_MOD19_U3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 19 Dauer in Minuten in der Klasse  3.77 &lt; U &lt;= 3.101 |
| STAT_HIS_SPANNUNG_MOD19_U4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 19 Dauer in Minuten in der Klasse  3.93 &lt; U &lt;= UmaxLim |
| STAT_HIS_SPANNUNG_MOD20_U1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 20 Dauer in Minuten in der Klasse UminLim &lt;= U &lt;= 3.66 |
| STAT_HIS_SPANNUNG_MOD20_U2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 20 Dauer in Minuten in der Klasse  3.57 &lt; U &lt;= 3.86 |
| STAT_HIS_SPANNUNG_MOD20_U3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 20 Dauer in Minuten in der Klasse  3.77 &lt; U &lt;= 3.102 |
| STAT_HIS_SPANNUNG_MOD20_U4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 20 Dauer in Minuten in der Klasse  3.93 &lt; U &lt;= UmaxLim |
| STAT_HIS_SPANNUNG_MOD21_U1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 21 Dauer in Minuten in der Klasse UminLim &lt;= U &lt;= 3.66 |
| STAT_HIS_SPANNUNG_MOD21_U2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 21 Dauer in Minuten in der Klasse  3.57 &lt; U &lt;= 3.86 |
| STAT_HIS_SPANNUNG_MOD21_U3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 21 Dauer in Minuten in der Klasse  3.77 &lt; U &lt;= 3.102 |
| STAT_HIS_SPANNUNG_MOD21_U4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 21 Dauer in Minuten in der Klasse  3.93 &lt; U &lt;= UmaxLim |
| STAT_HIS_SPANNUNG_MOD22_U1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 22 Dauer in Minuten in der Klasse UminLim &lt;= U &lt;= 3.67 |
| STAT_HIS_SPANNUNG_MOD22_U2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 22 Dauer in Minuten in der Klasse  3.57 &lt; U &lt;= 3.87 |
| STAT_HIS_SPANNUNG_MOD22_U3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 22 Dauer in Minuten in der Klasse  3.77 &lt; U &lt;= 3.103 |
| STAT_HIS_SPANNUNG_MOD22_U4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 22 Dauer in Minuten in der Klasse  3.93 &lt; U &lt;= UmaxLim |
| STAT_HIS_SPANNUNG_MOD23_U1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 23 Dauer in Minuten in der Klasse UminLim &lt;= U &lt;= 3.67 |
| STAT_HIS_SPANNUNG_MOD23_U2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 23 Dauer in Minuten in der Klasse  3.57 &lt; U &lt;= 3.87 |
| STAT_HIS_SPANNUNG_MOD23_U3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 23 Dauer in Minuten in der Klasse  3.77 &lt; U &lt;= 3.103 |
| STAT_HIS_SPANNUNG_MOD23_U4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 23 Dauer in Minuten in der Klasse  3.93 &lt; U &lt;= UmaxLim |
| STAT_HIS_SPANNUNG_MOD24_U1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 24 Dauer in Minuten in der Klasse UminLim &lt;= U &lt;= 3.68 |
| STAT_HIS_SPANNUNG_MOD24_U2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 24 Dauer in Minuten in der Klasse  3.57 &lt; U &lt;= 3.88 |
| STAT_HIS_SPANNUNG_MOD24_U3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 24 Dauer in Minuten in der Klasse  3.77 &lt; U &lt;= 3.104 |
| STAT_HIS_SPANNUNG_MOD24_U4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 24 Dauer in Minuten in der Klasse  3.93 &lt; U &lt;= UmaxLim |
| STAT_HIS_SPANNUNG_MOD25_U1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 25 Dauer in Minuten in der Klasse UminLim &lt;= U &lt;= 3.68 |
| STAT_HIS_SPANNUNG_MOD25_U2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 25 Dauer in Minuten in der Klasse  3.57 &lt; U &lt;= 3.88 |
| STAT_HIS_SPANNUNG_MOD25_U3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 25 Dauer in Minuten in der Klasse  3.77 &lt; U &lt;= 3.104 |
| STAT_HIS_SPANNUNG_MOD25_U4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 25 Dauer in Minuten in der Klasse  3.93 &lt; U &lt;= UmaxLim |
| STAT_HIS_SPANNUNG_MOD26_U1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 26 Dauer in Minuten in der Klasse UminLim &lt;= U &lt;= 3.69 |
| STAT_HIS_SPANNUNG_MOD26_U2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 26 Dauer in Minuten in der Klasse  3.57 &lt; U &lt;= 3.89 |
| STAT_HIS_SPANNUNG_MOD26_U3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 26 Dauer in Minuten in der Klasse  3.77 &lt; U &lt;= 3.105 |
| STAT_HIS_SPANNUNG_MOD26_U4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 26 Dauer in Minuten in der Klasse  3.93 &lt; U &lt;= UmaxLim |
| STAT_HIS_SPANNUNG_MOD27_U1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 27 Dauer in Minuten in der Klasse UminLim &lt;= U &lt;= 3.69 |
| STAT_HIS_SPANNUNG_MOD27_U2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 27 Dauer in Minuten in der Klasse  3.57 &lt; U &lt;= 3.89 |
| STAT_HIS_SPANNUNG_MOD27_U3_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 27 Dauer in Minuten in der Klasse  3.77 &lt; U &lt;= 3.105 |
| STAT_HIS_SPANNUNG_MOD27_U4_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 27 Dauer in Minuten in der Klasse  3.93 &lt; U &lt;= UmaxLim |
...
| STAT_HIS_ERR_LIM_SPANNUNG_MOD12_OVER_1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 12 Dauer in Minuten beim Laden in der Klasse: 0 &lt;UerrInt_over &lt;= UerrIntLim_over |
| STAT_HIS_ERR_LIM_SPANNUNG_MOD12_OVER_2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 12 Dauer in Minuten beim Laden in der Klasse: UerrInt_over &gt; UerrIntLim_over &gt;&gt;GW-FALL&lt;&lt; |
| STAT_HIS_ERR_LIM_SPANNUNG_MOD12_UNDER_1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 12 Dauer in Minuten beim Entladen in der Klasse: 0 &lt;UerrInt_under &lt;= UerrIntLim_under |
| STAT_HIS_ERR_LIM_SPANNUNG_MOD12_UNDER_2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 12 Dauer in Minuten beim Entladen in der Klasse: UerrInt_under &gt; UerrIntLim_under &gt;&gt;GW-FALL&lt;&lt; |
| STAT_HIS_ERR_LIM_SPANNUNG_MOD13_OVER_1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 13 Dauer in Minuten beim Laden in der Klasse: 0 &lt;UerrInt_over &lt;= UerrIntLim_over |
| STAT_HIS_ERR_LIM_SPANNUNG_MOD13_OVER_2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 13 Dauer in Minuten beim Laden in der Klasse: UerrInt_over &gt; UerrIntLim_over &gt;&gt;GW-FALL&lt;&lt; |
| STAT_HIS_ERR_LIM_SPANNUNG_MOD13_UNDER_1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 13 Dauer in Minuten beim Entladen in der Klasse: 0 &lt;UerrInt_under &lt;= UerrIntLim_under |
| STAT_HIS_ERR_LIM_SPANNUNG_MOD13_UNDER_2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 13 Dauer in Minuten beim Entladen in der Klasse: UerrInt_under &gt; UerrIntLim_under &gt;&gt;GW-FALL&lt;&lt; |
| STAT_HIS_ERR_LIM_SPANNUNG_MOD14_OVER_1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 14 Dauer in Minuten beim Laden in der Klasse: 0 &lt;UerrInt_over &lt;= UerrIntLim_over |
| STAT_HIS_ERR_LIM_SPANNUNG_MOD14_OVER_2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 14 Dauer in Minuten beim Laden in der Klasse: UerrInt_over &gt; UerrIntLim_over &gt;&gt;GW-FALL&lt;&lt; |
| STAT_HIS_ERR_LIM_SPANNUNG_MOD14_UNDER_1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 14 Dauer in Minuten beim Entladen in der Klasse: 0 &lt;UerrInt_under &lt;= UerrIntLim_under |
| STAT_HIS_ERR_LIM_SPANNUNG_MOD14_UNDER_2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 14 Dauer in Minuten beim Entladen in der Klasse: UerrInt_under &gt; UerrIntLim_under &gt;&gt;GW-FALL&lt;&lt; |
| STAT_HIS_ERR_LIM_SPANNUNG_MOD15_OVER_1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 15 Dauer in Minuten beim Laden in der Klasse: 0 &lt;UerrInt_over &lt;= UerrIntLim_over |
| STAT_HIS_ERR_LIM_SPANNUNG_MOD15_OVER_2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 15 Dauer in Minuten beim Laden in der Klasse: UerrInt_over &gt; UerrIntLim_over &gt;&gt;GW-FALL&lt;&lt; |
| STAT_HIS_ERR_LIM_SPANNUNG_MOD15_UNDER_1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 15 Dauer in Minuten beim Entladen in der Klasse: 0 &lt;UerrInt_under &lt;= UerrIntLim_under |
| STAT_HIS_ERR_LIM_SPANNUNG_MOD15_UNDER_2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 15 Dauer in Minuten beim Entladen in der Klasse: UerrInt_under &gt; UerrIntLim_under &gt;&gt;GW-FALL&lt;&lt; |
| STAT_HIS_ERR_LIM_SPANNUNG_MOD16_OVER_1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 16 Dauer in Minuten beim Laden in der Klasse: 0 &lt;UerrInt_over &lt;= UerrIntLim_over |
| STAT_HIS_ERR_LIM_SPANNUNG_MOD16_OVER_2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 16 Dauer in Minuten beim Laden in der Klasse: UerrInt_over &gt; UerrIntLim_over &gt;&gt;GW-FALL&lt;&lt; |
| STAT_HIS_ERR_LIM_SPANNUNG_MOD16_UNDER_1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 16 Dauer in Minuten beim Entladen in der Klasse: 0 &lt;UerrInt_under &lt;= UerrIntLim_under |
| STAT_HIS_ERR_LIM_SPANNUNG_MOD16_UNDER_2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 16 Dauer in Minuten beim Entladen in der Klasse: UerrInt_under &gt; UerrIntLim_under &gt;&gt;GW-FALL&lt;&lt; |
| STAT_HIS_ERR_LIM_SPANNUNG_MOD17_OVER_1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 17 Dauer in Minuten beim Laden in der Klasse: 0 &lt;UerrInt_over &lt;= UerrIntLim_over |
| STAT_HIS_ERR_LIM_SPANNUNG_MOD17_OVER_2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 17 Dauer in Minuten beim Laden in der Klasse: UerrInt_over &gt; UerrIntLim_over &gt;&gt;GW-FALL&lt;&lt; |
| STAT_HIS_ERR_LIM_SPANNUNG_MOD17_UNDER_1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 17 Dauer in Minuten beim Entladen in der Klasse: 0 &lt;UerrInt_under &lt;= UerrIntLim_under |
| STAT_HIS_ERR_LIM_SPANNUNG_MOD17_UNDER_2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 17 Dauer in Minuten beim Entladen in der Klasse: UerrInt_under &gt; UerrIntLim_under &gt;&gt;GW-FALL&lt;&lt; |
| STAT_HIS_ERR_LIM_SPANNUNG_MOD18_OVER_1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 18 Dauer in Minuten beim Laden in der Klasse: 0 &lt;UerrInt_over &lt;= UerrIntLim_over |
| STAT_HIS_ERR_LIM_SPANNUNG_MOD18_OVER_2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 18 Dauer in Minuten beim Laden in der Klasse: UerrInt_over &gt; UerrIntLim_over &gt;&gt;GW-FALL&lt;&lt; |
| STAT_HIS_ERR_LIM_SPANNUNG_MOD18_UNDER_1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 18 Dauer in Minuten beim Entladen in der Klasse: 0 &lt;UerrInt_under &lt;= UerrIntLim_under |
| STAT_HIS_ERR_LIM_SPANNUNG_MOD18_UNDER_2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 18 Dauer in Minuten beim Entladen in der Klasse: UerrInt_under &gt; UerrIntLim_under &gt;&gt;GW-FALL&lt;&lt; |
| STAT_HIS_ERR_LIM_SPANNUNG_MOD19_OVER_1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 19 Dauer in Minuten beim Laden in der Klasse: 0 &lt;UerrInt_over &lt;= UerrIntLim_over |
| STAT_HIS_ERR_LIM_SPANNUNG_MOD19_OVER_2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 19 Dauer in Minuten beim Laden in der Klasse: UerrInt_over &gt; UerrIntLim_over &gt;&gt;GW-FALL&lt;&lt; |
| STAT_HIS_ERR_LIM_SPANNUNG_MOD19_UNDER_1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 19 Dauer in Minuten beim Entladen in der Klasse: 0 &lt;UerrInt_under &lt;= UerrIntLim_under |
| STAT_HIS_ERR_LIM_SPANNUNG_MOD19_UNDER_2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 19 Dauer in Minuten beim Entladen in der Klasse: UerrInt_under &gt; UerrIntLim_under &gt;&gt;GW-FALL&lt;&lt; |
| STAT_HIS_ERR_LIM_SPANNUNG_MOD20_OVER_1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 20 Dauer in Minuten beim Laden in der Klasse: 0 &lt;UerrInt_over &lt;= UerrIntLim_over |
| STAT_HIS_ERR_LIM_SPANNUNG_MOD20_OVER_2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 20 Dauer in Minuten beim Laden in der Klasse: UerrInt_over &gt; UerrIntLim_over &gt;&gt;GW-FALL&lt;&lt; |
| STAT_HIS_ERR_LIM_SPANNUNG_MOD20_UNDER_1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 20 Dauer in Minuten beim Entladen in der Klasse: 0 &lt;UerrInt_under &lt;= UerrIntLim_under |
| STAT_HIS_ERR_LIM_SPANNUNG_MOD20_UNDER_2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 20 Dauer in Minuten beim Entladen in der Klasse: UerrInt_under &gt; UerrIntLim_under &gt;&gt;GW-FALL&lt;&lt; |
| STAT_HIS_ERR_LIM_SPANNUNG_MOD21_OVER_1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 21 Dauer in Minuten beim Laden in der Klasse: 0 &lt;UerrInt_over &lt;= UerrIntLim_over |
| STAT_HIS_ERR_LIM_SPANNUNG_MOD21_OVER_2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 21 Dauer in Minuten beim Laden in der Klasse: UerrInt_over &gt; UerrIntLim_over &gt;&gt;GW-FALL&lt;&lt; |
| STAT_HIS_ERR_LIM_SPANNUNG_MOD21_UNDER_1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 21 Dauer in Minuten beim Entladen in der Klasse: 0 &lt;UerrInt_under &lt;= UerrIntLim_under |
| STAT_HIS_ERR_LIM_SPANNUNG_MOD21_UNDER_2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 21 Dauer in Minuten beim Entladen in der Klasse: UerrInt_under &gt; UerrIntLim_under &gt;&gt;GW-FALL&lt;&lt; |
| STAT_HIS_ERR_LIM_SPANNUNG_MOD22_OVER_1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 22 Dauer in Minuten beim Laden in der Klasse: 0 &lt;UerrInt_over &lt;= UerrIntLim_over |
| STAT_HIS_ERR_LIM_SPANNUNG_MOD22_OVER_2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 22 Dauer in Minuten beim Laden in der Klasse: UerrInt_over &gt; UerrIntLim_over &gt;&gt;GW-FALL&lt;&lt; |
| STAT_HIS_ERR_LIM_SPANNUNG_MOD22_UNDER_1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 22 Dauer in Minuten beim Entladen in der Klasse: 0 &lt;UerrInt_under &lt;= UerrIntLim_under |
| STAT_HIS_ERR_LIM_SPANNUNG_MOD22_UNDER_2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 22 Dauer in Minuten beim Entladen in der Klasse: UerrInt_under &gt; UerrIntLim_under &gt;&gt;GW-FALL&lt;&lt; |
| STAT_HIS_ERR_LIM_SPANNUNG_MOD23_OVER_1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 23 Dauer in Minuten beim Laden in der Klasse: 0 &lt;UerrInt_over &lt;= UerrIntLim_over |
| STAT_HIS_ERR_LIM_SPANNUNG_MOD23_OVER_2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 23 Dauer in Minuten beim Laden in der Klasse: UerrInt_over &gt; UerrIntLim_over &gt;&gt;GW-FALL&lt;&lt; |
| STAT_HIS_ERR_LIM_SPANNUNG_MOD23_UNDER_1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 23 Dauer in Minuten beim Entladen in der Klasse: 0 &lt;UerrInt_under &lt;= UerrIntLim_under |
| STAT_HIS_ERR_LIM_SPANNUNG_MOD23_UNDER_2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 23 Dauer in Minuten beim Entladen in der Klasse: UerrInt_under &gt; UerrIntLim_under &gt;&gt;GW-FALL&lt;&lt; |
| STAT_HIS_ERR_LIM_SPANNUNG_MOD24_OVER_1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 24 Dauer in Minuten beim Laden in der Klasse: 0 &lt;UerrInt_over &lt;= UerrIntLim_over |
| STAT_HIS_ERR_LIM_SPANNUNG_MOD24_OVER_2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 24 Dauer in Minuten beim Laden in der Klasse: UerrInt_over &gt; UerrIntLim_over &gt;&gt;GW-FALL&lt;&lt; |
| STAT_HIS_ERR_LIM_SPANNUNG_MOD24_UNDER_1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 24 Dauer in Minuten beim Entladen in der Klasse: 0 &lt;UerrInt_under &lt;= UerrIntLim_under |
| STAT_HIS_ERR_LIM_SPANNUNG_MOD24_UNDER_2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 24 Dauer in Minuten beim Entladen in der Klasse: UerrInt_under &gt; UerrIntLim_under &gt;&gt;GW-FALL&lt;&lt; |
| STAT_HIS_ERR_LIM_SPANNUNG_MOD25_OVER_1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 25 Dauer in Minuten beim Laden in der Klasse: 0 &lt;UerrInt_over &lt;= UerrIntLim_over |
| STAT_HIS_ERR_LIM_SPANNUNG_MOD25_OVER_2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 25 Dauer in Minuten beim Laden in der Klasse: UerrInt_over &gt; UerrIntLim_over &gt;&gt;GW-FALL&lt;&lt; |
| STAT_HIS_ERR_LIM_SPANNUNG_MOD25_UNDER_1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 25 Dauer in Minuten beim Entladen in der Klasse: 0 &lt;UerrInt_under &lt;= UerrIntLim_under |
| STAT_HIS_ERR_LIM_SPANNUNG_MOD25_UNDER_2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 25 Dauer in Minuten beim Entladen in der Klasse: UerrInt_under &gt; UerrIntLim_under &gt;&gt;GW-FALL&lt;&lt; |
| STAT_HIS_ERR_LIM_SPANNUNG_MOD26_OVER_1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 26 Dauer in Minuten beim Laden in der Klasse: 0 &lt;UerrInt_over &lt;= UerrIntLim_over |
| STAT_HIS_ERR_LIM_SPANNUNG_MOD26_OVER_2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 26 Dauer in Minuten beim Laden in der Klasse: UerrInt_over &gt; UerrIntLim_over &gt;&gt;GW-FALL&lt;&lt; |
| STAT_HIS_ERR_LIM_SPANNUNG_MOD26_UNDER_1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 26 Dauer in Minuten beim Entladen in der Klasse: 0 &lt;UerrInt_under &lt;= UerrIntLim_under |
| STAT_HIS_ERR_LIM_SPANNUNG_MOD26_UNDER_2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 26 Dauer in Minuten beim Entladen in der Klasse: UerrInt_under &gt; UerrIntLim_under &gt;&gt;GW-FALL&lt;&lt; |
| STAT_HIS_ERR_LIM_SPANNUNG_MOD27_OVER_1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 27 Dauer in Minuten beim Laden in der Klasse: 0 &lt;UerrInt_over &lt;= UerrIntLim_over |
| STAT_HIS_ERR_LIM_SPANNUNG_MOD27_OVER_2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 27 Dauer in Minuten beim Laden in der Klasse: UerrInt_over &gt; UerrIntLim_over &gt;&gt;GW-FALL&lt;&lt; |
| STAT_HIS_ERR_LIM_SPANNUNG_MOD27_UNDER_1_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 27 Dauer in Minuten beim Entladen in der Klasse: 0 &lt;UerrInt_under &lt;= UerrIntLim_under |
| STAT_HIS_ERR_LIM_SPANNUNG_MOD27_UNDER_2_WERT | min | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | MODUL 27 Dauer in Minuten beim Entladen in der Klasse: UerrInt_under &gt; UerrIntLim_under &gt;&gt;GW-FALL&lt;&lt; |
...
| RESULTNAME | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_SYM_ZEIT_ZELLE_001_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 001  |
| STAT_SYM_ZEIT_ZELLE_002_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 002 |
| STAT_SYM_ZEIT_ZELLE_003_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 003 |
| STAT_SYM_ZEIT_ZELLE_004_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 004  |
| STAT_SYM_ZEIT_ZELLE_005_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 005  |
| STAT_SYM_ZEIT_ZELLE_006_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 006 |
| STAT_SYM_ZEIT_ZELLE_007_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 007 |
| STAT_SYM_ZEIT_ZELLE_008_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 008 |
| STAT_SYM_ZEIT_ZELLE_009_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 009  |
| STAT_SYM_ZEIT_ZELLE_010_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 010  |
| STAT_SYM_ZEIT_ZELLE_011_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 011  |
| STAT_SYM_ZEIT_ZELLE_012_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 012  |
| STAT_SYM_ZEIT_ZELLE_013_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 013  |
| STAT_SYM_ZEIT_ZELLE_014_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 014  |
| STAT_SYM_ZEIT_ZELLE_015_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 015 |
| STAT_SYM_ZEIT_ZELLE_016_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 016  |
| STAT_SYM_ZEIT_ZELLE_017_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 017 |
| STAT_SYM_ZEIT_ZELLE_018_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 018  |
| STAT_SYM_ZEIT_ZELLE_019_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 019  |
| STAT_SYM_ZEIT_ZELLE_020_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 020  |
| STAT_SYM_ZEIT_ZELLE_021_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 021 |
| STAT_SYM_ZEIT_ZELLE_022_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 022  |
| STAT_SYM_ZEIT_ZELLE_023_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 023  |
| STAT_SYM_ZEIT_ZELLE_024_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 024 |
| STAT_SYM_ZEIT_ZELLE_025_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 025  |
| STAT_SYM_ZEIT_ZELLE_026_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 026  |
| STAT_SYM_ZEIT_ZELLE_027_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 027  |
| STAT_SYM_ZEIT_ZELLE_028_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 028  |
| STAT_SYM_ZEIT_ZELLE_029_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 029  |
| STAT_SYM_ZEIT_ZELLE_030_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 030  |
| STAT_SYM_ZEIT_ZELLE_031_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 031  |
| STAT_SYM_ZEIT_ZELLE_032_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 032  |
| STAT_SYM_ZEIT_ZELLE_033_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 033  |
| STAT_SYM_ZEIT_ZELLE_034_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 034  |
| STAT_SYM_ZEIT_ZELLE_035_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 035  |
| STAT_SYM_ZEIT_ZELLE_036_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 036  |
| STAT_SYM_ZEIT_ZELLE_037_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 037  |
| STAT_SYM_ZEIT_ZELLE_038_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 038  |
| STAT_SYM_ZEIT_ZELLE_039_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 039  |
| STAT_SYM_ZEIT_ZELLE_040_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 040 |
| STAT_SYM_ZEIT_ZELLE_041_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 041  |
| STAT_SYM_ZEIT_ZELLE_042_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 042 |
| STAT_SYM_ZEIT_ZELLE_043_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 043 |
| STAT_SYM_ZEIT_ZELLE_044_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 044  |
| STAT_SYM_ZEIT_ZELLE_045_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 045 |
| STAT_SYM_ZEIT_ZELLE_046_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 046  |
| STAT_SYM_ZEIT_ZELLE_047_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 047 |
| STAT_SYM_ZEIT_ZELLE_048_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 048  |
| STAT_SYM_ZEIT_ZELLE_049_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 049 |
| STAT_SYM_ZEIT_ZELLE_050_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 050  |
| STAT_SYM_ZEIT_ZELLE_051_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 051 |
| STAT_SYM_ZEIT_ZELLE_052_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 052  |
| STAT_SYM_ZEIT_ZELLE_053_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 053 |
| STAT_SYM_ZEIT_ZELLE_054_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 054 |
| STAT_SYM_ZEIT_ZELLE_055_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 055 |
| STAT_SYM_ZEIT_ZELLE_056_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 056 |
| STAT_SYM_ZEIT_ZELLE_057_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 057 |
| STAT_SYM_ZEIT_ZELLE_058_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 058  |
| STAT_SYM_ZEIT_ZELLE_059_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 059  |
| STAT_SYM_ZEIT_ZELLE_060_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 060  |
| STAT_SYM_ZEIT_ZELLE_061_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 061 |
| STAT_SYM_ZEIT_ZELLE_062_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 062  |
| STAT_SYM_ZEIT_ZELLE_063_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 063 |
| STAT_SYM_ZEIT_ZELLE_064_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 064 |
| STAT_SYM_ZEIT_ZELLE_065_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 065 |
| STAT_SYM_ZEIT_ZELLE_066_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 066 |
| STAT_SYM_ZEIT_ZELLE_067_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 067 |
| STAT_SYM_ZEIT_ZELLE_068_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 068  |
| STAT_SYM_ZEIT_ZELLE_069_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 069  |
| STAT_SYM_ZEIT_ZELLE_070_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 070  |
| STAT_SYM_ZEIT_ZELLE_071_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 071 |
| STAT_SYM_ZEIT_ZELLE_072_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 072  |
| STAT_SYM_ZEIT_ZELLE_073_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 073 |
| STAT_SYM_ZEIT_ZELLE_074_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 074 |
| STAT_SYM_ZEIT_ZELLE_075_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 075 |
| STAT_SYM_ZEIT_ZELLE_076_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 076 |
| STAT_SYM_ZEIT_ZELLE_077_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 077 |
| STAT_SYM_ZEIT_ZELLE_078_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 078  |
| STAT_SYM_ZEIT_ZELLE_079_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 079  |
| STAT_SYM_ZEIT_ZELLE_080_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 080  |
| STAT_SYM_ZEIT_ZELLE_081_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 081 |
| STAT_SYM_ZEIT_ZELLE_082_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 082  |
| STAT_SYM_ZEIT_ZELLE_083_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 083 |
| STAT_SYM_ZEIT_ZELLE_084_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 084 |
| STAT_SYM_ZEIT_ZELLE_085_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 085 |
| STAT_SYM_ZEIT_ZELLE_086_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 086 |
| STAT_SYM_ZEIT_ZELLE_087_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 087 |
| STAT_SYM_ZEIT_ZELLE_088_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 088  |
| STAT_SYM_ZEIT_ZELLE_089_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 089  |
| STAT_SYM_ZEIT_ZELLE_090_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 090  |
| STAT_SYM_ZEIT_ZELLE_091_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 091 |
| STAT_SYM_ZEIT_ZELLE_092_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 092  |
| STAT_SYM_ZEIT_ZELLE_093_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 093 |
| STAT_SYM_ZEIT_ZELLE_094_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 094 |
| STAT_SYM_ZEIT_ZELLE_095_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 095 |
| STAT_SYM_ZEIT_ZELLE_096_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 096 |
| STAT_SYM_ZEIT_ZELLE_097_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 097 |
| STAT_SYM_ZEIT_ZELLE_098_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 098  |
| STAT_SYM_ZEIT_ZELLE_099_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 099  |
| STAT_SYM_ZEIT_ZELLE_100_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 100  |
| STAT_SYM_ZEIT_ZELLE_101_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 101 |
| STAT_SYM_ZEIT_ZELLE_102_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 102  |
| STAT_SYM_ZEIT_ZELLE_103_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 103 |
| STAT_SYM_ZEIT_ZELLE_104_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 104 |
| STAT_SYM_ZEIT_ZELLE_105_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 105 |
| STAT_SYM_ZEIT_ZELLE_106_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 106 |
| STAT_SYM_ZEIT_ZELLE_107_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 107 |
| STAT_SYM_ZEIT_ZELLE_108_WERT | h | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Symmetrierzeit über Lebenszeit Zelle 108  |
...
Dimensions: 134 rows × 16 columns
...
| EAN_BTRV_DATAMATRIXCODE | 0xA228 | - | Bauteilrückverfolgbarkeit (BTRV) Daten der E-Antriebs-SGe in Form des Data-Matrix-Codes nach GS91010-2 Variante 4a. | - | - | - | - | - | - | - | - | - | 31 | ARG_0xA228_R | RES_0xA228_R |
...
| HISTO_STROM_ERR_LIM_CHA | 0xE49A | - | Zeit in Minuten in verschiedenen Stromfehlergrenzklassen über alle Temperaturbereiche (HV-ON) | - | - | - | - | - | - | - | - | - | 22 | - | RES_0xE49A_D |
| HISTO_STROM_ERR_LIM_DCHA | 0xE49B | - | Zeit in Minuten in verschiedenen Stromfehlergrenzklassen über alle Temperaturbereiche (HV-ON) | - | - | - | - | - | - | - | - | - | 22 | - | RES_0xE49B_D |
| RESET_HISTO_STROM | 0xE49C | - | Zurücksetzen aller Strom Histogramme und der maximal gemessenen Ströme für Laden und Entladen | - | - | - | - | - | - | - | - | - | 2E | ARG_0xE49C_D | - |
...
| SYMMETRIERUNG_AKT | 0xE4CA | - | Informationen über die letzte Symmetrierbedarfsberechnung und über die letzte vollständig abgeschlossene Symmetrierung  | - | - | - | - | - | - | - | - | - | 22 | - | RES_0xE4CA_D |
| ZELLKAPAZITAET | 0xE4CB | - | Mit diesem Steuernjob kann die Kapazität des Speichers verändert werden. Dabei ist es möglich, den gesamten Speicher, einzelne Module oder einzelne Zellen pro Aufruf zu manipulieren | - | - | - | - | - | - | - | - | - | 2E | ARG_0xE4CB_D | - |
| ENERGIEVERLUST | 0xE4CC | - | Ringspeicher zur Detektion von Fehlerbildern, welche zu einem potentiellen unerwarteten Reichweitenverlust führen (erhöhter Ladungsverlust und Kapazitätsverlust sowie schnelle Innenwiderstandsalterung). | - | - | - | - | - | - | - | - | - | 22 | - | RES_0xE4CC_D |
| HISTO_STROM_EFF_CHA | 0xE4CD | - | Zeit in Minuten in verschiedenen Prozentklassen für das Verhältnis effektiver Strom zu Dauerstromgrenze für Laden (HV-ON) über alle Temperaturbereiche | - | - | - | - | - | - | - | - | - | 22 | - | RES_0xE4CD_D |
| HISTO_STROM_EFF_DCHA | 0xE4CE | - | Zeit in Minuten in verschiedenen Prozentklassen für das Verhältnis effektiver Strom zu Dauerstromgrenze für Entladen (HV-ON) über alle Temperaturbereiche | - | - | - | - | - | - | - | - | - | 22 | - | RES_0xE4CE_D |
| HISTO_STROM_EFF_LEITUNG | 0xE4CF | - | Zeit in Minuten in verschiedenen Prozentklassenfür das Verhältnis effektiver Strom zu Stromgrenze Leitung/Komponenten | - | - | - | - | - | - | - | - | - | 22 | - | RES_0xE4CF_D |
| STROM_MEAS_MAX_MIN | 0xE4D3 | - | Maximaler gemessener Strom für Laden und minimaler gemessener Strom für Entladen | - | - | - | - | - | - | - | - | - | 22 | - | RES_0xE4D3_D |
| NBA_EOD | 0xE4D4 | - | Auslesen des Batteriezustandes während des zuletzt erfolgten End-of-Drives (stark entladene Batterie). | - | - | - | - | - | - | - | - | - | 22 | - | RES_0xE4D4_D |
...
| HISTO_TEMP_HVON_MIN_MOD | 0xE577 | - | Zeit in Minuten in mehreren Temperaturklassen der niedrigsten gemessenen Zelltemperatur bei geschlossen Schützen | - | - | - | - | - | - | - | - | - | 22 | - | RES_0xE577_D |
| HISTO_TEMP_HVON_MAX_MOD | 0xE578 | - | Zeit in Minuten in mehreren Temperaturklassen der höchsten gemessenen Zelltemperatur bei geschlossen Schützen | - | - | - | - | - | - | - | - | - | 22 | - | RES_0xE578_D |
| HISTO_TEMP_HVOFF_AVG_MOD | 0xE579 | - | Zeit in Minuten in mehreren Temperaturklassen der berechneten durchschnittlichen Zelltemperatur bei offenen Schützen | - | - | - | - | - | - | - | - | - | 22 | - | RES_0xE579_D |
...
<a id="table-tab-ean-btrv-bauteil-typ"></a>
### TAB_EAN_BTRV_BAUTEIL_TYP
...
| --- | --- |
| 0x00 | Reserviert |
| 0x01 | Haupt-Komponente TEE |
| 0x02 | Haupt-Komponente CCU |
| 0x03 | Haupt-Komponente HVS |
| 0x10 | Sub-Komponente Inverter |
| 0x11 | Sub-Komponente E-Maschine |
| 0x12 | Sub-Komponente Getriebe |
| 0x13 | Sub-Komponente Elektrische Getriebeoelpumpe |
| 0x20 | Sub-Komponente Ladedose AC oder CCS |
| 0x21 | Sub-Komponente Ladedose DC (CHAdeMO oder GB/T) |
| 0x22 | Sub-Komponente Ladedose Unterboden |
| 0x23 | Sub-Komponente Elektrischer Lüfter |
| 0x24 | Sub-Komponente Elektrische Wasserpumpe |
| 0x25 | Sub-Komponente Elektrischer Durchlaufheizer |
| 0x26 | Sub-Komponente Aktiver Kühlluftklappensteller |
| 0x30 | Sub-Komponente Battery Management Unit |
| 0x31 | Sub-Komponente Zellmodul |
| 0x32 | Sub-Komponente Cell Supervising Circuit |
| 0xFF | Wert ungültig |

<a id="table-tab-ean-btrv-vorgang"></a>
### TAB_EAN_BTRV_VORGANG

Dimensions: 4 rows × 2 columns

| WERT | TEXT |
| --- | --- |
| 0x01 | Datensatz Lesen |
| 0x02 | Datensatz ÄNDERN |
| 0x03 | Datensatz LÖSCHEN |
| 0xFF | Wert ungültig |
...
<a id="table-tab-hvs-symmetriermodus"></a>
### TAB_HVS_SYMMETRIERMODUS

Dimensions: 6 rows × 2 columns

| WERT | TEXT |
| --- | --- |
| 0x00 | Kein Symmetriermodus aktiv |
| 0x01 | Spannungsgesteuerter Symmetriermodus |
| 0x02 | Zeitgesteuerter Symmetriermodus mit Bedarfsberechnung bei Ladeende |
| 0x03 | Zeitgesteuerter Symmetriermodus mit Bedarfsberechnung bei Ruhespannung |
| 0x04 | Kein Symmetriermodus aktiv, Qualifier ungültig |
| 0xFF | Wert ungültig |

<a id="table-tab-kriterium-eod"></a>
### TAB_KRITERIUM_EOD
...
| WERT | TEXT |
| --- | --- |
| 0x01 | Nebenverbraucher |
| 0x02 | Fahrt-Kriterium |
| 0xFF | Wert ungültig |
...
| WERT | TEXT |
| --- | --- |
| 0x01 | 1 = Tiefentladung HVS |
| 0x02 | 2 = HVS Eigenschutz |
| 0x03 | 3 = Anfoderung Entladestopp |
| 0x04 | 4 = End of Drive |
| 0x05 | 5 = Vorwarnung End of Drive |
| 0x06 | 6 = Kein kritischer Ladezustand |
| 0x0D | 13 = Funktionsschnittstelle nicht verfügbar |
| 0x0E | 14 = Funktion meldet Fehler |
| 0x0F | 15 = Signal unbefüllt |
| 0xFF | Wert ungültig |
