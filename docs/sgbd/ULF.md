...
| COMMENT | Universelle Lade- und Freisprecheinrichtung |
| PACKAGE | 0.11 |
| SPRACHE | deutsch |
...
- [STEUERN_SELBSTTEST_AUDIO](#job-steuern-selbsttest-audio) - Durchfuehrung des Selbsttests (Audio Loop back)
- [STATUS_IO_LESEN](#job-status-io-lesen) - Auslesen von Ein- und Ausgangsstati
- [MUTE_EIN](#job-mute-ein) - Activate audio mute
- [MUTE_AUS](#job-mute-aus) - Deactivate audio mute
- [NOTRUF_NR_LESEN](#job-notruf-nr-lesen) - Notuf-Nummer lesen
- [NOTRUF_NR_SCHREIBEN](#job-notruf-nr-schreiben) - Notruf-Nummer schreiben
- [BT_EIN](#job-bt-ein) - Activate Bluetooth
- [BT_AUS](#job-bt-aus) - Deactivate Bluetooth
- [BT_PASSKEY_LESEN](#job-bt-passkey-lesen) - Lesen des Bluetooth Passkey
- [BT_PASSKEY_SCHREIBEN](#job-bt-passkey-schreiben) - Beschreiben des Bluetooth Passkey
- [BT_GERAETEADRESSE_LESEN](#job-bt-geraeteadresse-lesen) - Lesen der lokalen Bluetooth Geraeteadresse der ULF
- [BT_GERAETENAME_LESEN](#job-bt-geraetename-lesen) - Lesen der lokalen Bluetooth user-friendly name der ULF
- [RESET_TO_BASIC_STATE](#job-reset-to-basic-state) - Reset Bluetooth Passkey und Löschen gekoppelter Geräte
- [BT_ERKENNUNGSMODUS](#job-bt-erkennungsmodus) - Starten des Bluetooth Erkennungsmodus
