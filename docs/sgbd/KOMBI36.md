...
| EEPROM_CODIERT | int | EEPROM codiert j/n |
...
| WEGGRENZE_EGS_OEL_WERT | int | Wert der Weginspektionsintervalle fuer EGS |
| WEGGRENZE_EGS_OEL_EINH | string | Einheit fuer den Wert der Weginspektionsintervalle [km] |
| ZEITGRENZE_EGS_OEL_WERT | int | Wert der Zeitinspektionsintervalle fuer EGS |
| ZEITGRENZE_EGS_OEL_EINH | string | Einheit fuer den Wert der Zeitinspektionsintervalle [Tage] |
...
| SIA_AUS_VERZOEGERUNGSZEIT_EINH | string | "s" |
| BC_LAENDERCODE | string | Laendercodierung des BC |
| LAENDERCODE_KOMBI | string | Laendercode des Kombis |
| FG_NR | string | Fahrgestellnummer |
| BC_ZEIT_EINHEIT | string |  |
| BC_TEMPERATUR_EINHEIT | string |  |
| BC_OHNE_CHECKCONTROL | int |  |
| BC_HUPENALARM_DAUERTON | int |  |
| BC_GESCHWINDIGKEITS_EINHEIT | string |  |
| BC_WEGSTRECKEN_EINHEIT | string |  |
| BC_VERBRAUCHS_EINHEIT | string |  |
| LICHT_EINSCHALTDAUER_WERT | int |  |
| LICHT_EINSCHALTDAUER_EINH | string | "s" |
| LICHT_EINSCHALTVERZOEGERUNG_WERT | int |  |
| LICHT_EINSCHALTVERZOEGERUNG_EINH | string | "s" |
...
| Name | Type | Comment |
| --- | --- | --- |
| GESCHWINDIGKEIT | int | gewuenschte Vorgabegeschwindigkeit 6-300 km/h |
