...
- [TANTENNA_NUMBER](#table-tantenna-number) (5 × 2)
- [TFAULT_CODE](#table-tfault-code) (10 × 2)
- [TAUDIOKANAL](#table-taudiokanal) (6 × 3)
- [TRDS_SET](#table-trds-set) (5 × 3)
- [TSCHALTMODI](#table-tschaltmodi) (5 × 3)
- [TAUDIOVOLUME](#table-taudiovolume) (58 × 2)
...
| ORT | ORTTEXT |
| --- | --- |
| 0xABC9 | 0xABC9: Drive communication error |
...
| 0xA16D | 0xA16D: Energiesparmode aktiv |
| 0xE1C4 | 0xE1C4: CAN physical bus error |
...
| 0xE1D2 | 0xE1D2: DME sender failure |
