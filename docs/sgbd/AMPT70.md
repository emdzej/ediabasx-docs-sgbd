...
| Field | Value |
| --- | --- |
| ECU | Lear Top HiFi E70 |
| ORIGIN | BMW EE-41 Grubauer |
| REVISION | 3.003 |
| AUTHOR | LEAR DCS Reißig, SOHARD Embedded Kropf |
| COMMENT | N/A |
| PACKAGE | 1.31 |
| SPRACHE | deutsch |
...
| KANAL | int | Einstellen der Kanalmaske Moegliche Werte: 0x0000 - 0x01FF Kanalbelegung: 0x0000: alle Kanaele aktiv 0x0001: Left front 0x0002: Right front 0x0004: Center front 0x0008: Left mid 0x0010: Right mid 0x0020: Left rear 0x0040: Right rear 0x0080: Zentral Bass Left 0x0100: Zentral Bass Right zum Ansteuern mehrerer Kanäle werden die Bits fuer die jeweiligen Kanaele verodert |
...
| 0xA1AB | Fehler bei der DTCP Authentisierung |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Node Position Register | Hex | high | unsigned int | - | 1 | 1 | 0 |
| 2 | Umgebungstemperatur | Hex | high | unsigned int | - | 1 | 1 | 0 |
| 3 | Energy Saving State | Hex | high | unsigned int | - | 1 | 1 | 0 |
