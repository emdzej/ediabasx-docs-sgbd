...
| REVISION | 1.02 |
| AUTHOR | ASKON Consulting fuer BMW AG EE-430, BMW EE-430 Winfried Siegl, BMW TI-431 Rochal |
| COMMENT | Erstellt von Thorsten Walter nach Vorlage MOST-Muster-SGBD fuer E65 |
| PACKAGE | 1.32 |
| SPRACHE | deutsch |
...
| ORT | ORTTEXT |
| --- | --- |
| 0xD68D | Weckendes Device hat erfolglos 3mal versucht das Netzwerk zu wecken (Error_WakeUp_Failed). |
...
| 0xD685 | Fehler NOT_TASTE_NOK |
| 0xD687 | Fehler CAN_BUS_NOK |
| 0xD688 | Fehler TELCOMANDER_INVALID_KEY |
| 0xD689 | unbekannter Portable Fehler |
...
| 0x9310 | Trotz Low Level Widerholungen hat ein Empfaenger eine Nachricht nicht angenommen (Error_NAK). |
| 0xFFFF | unbekannter Fehlerort |
