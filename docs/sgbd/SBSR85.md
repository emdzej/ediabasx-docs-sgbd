...
| Field | Value |
| --- | --- |
| ECU | Satellit B-Saeule rechts |
| ORIGIN | BMW EE-52 Christian Marschner |
| REVISION | 4.10 |
| AUTHOR | BMW TI-430 Ruediger_Gall, ESG Hans-Ulrich Meyer |
...
- [OC3_DATEN_LESEN](#job-oc3-daten-lesen) - OC3-Ident-Daten lesen ab SG-Softwareversion 4.4.2 KWP2000: $22 SG spezifische Daten lesen $98 $01 OC3-Ident lesen (über SBSR als Gateway) Modus  : Default  siehe auch JOB: OC3_DATEN_LESEN
- [OC3_STATUS](#job-oc3-status) - OC3-Status-Information lesen ab SG-Softwareversion 4.4.2 KWP2000: $22 SG spezifische Daten lesen $98 $03 OC3-Status lesen (über SBSR als Gateway) Modus  : Default
- [OC3_DATEN_SCHREIBEN](#job-oc3-daten-schreiben) - OC3-Codierdaten schreiben ab SG-Softwareversion 4.4.2 KWP2000: $2E SG spezifische Daten schreiben $98 $01 OC3-Codierdaten schreiben (über SBSR als Gateway) Modus  : Default  SG muß vor Jobaufruf in den Diagnose-Modus versetzt werden (für 25 sec) durch Aufruf von OC3-Daten_Lesen! Sitz muß während der Codierung unbelegt sein, ansonsten erfolgt FS-Eintrag 0x95BC ("OC3 Vorlast")
...
| STAT_SBE | unsigned int | Status Sitzbelegungserkennung Bit 0-2: Gewichtsklasse (0xx7 = Fehler) Bei SBE1 nur: unbelegt: 000 belegt: 011 Bit 3: frei Bit 4: Kurzschluss Bit 5: Unterbrechung Bit 6: Kommunikationsfehler Bit 7: Belegung undefiniert |
...
| STAT_BATTERIESCHIRM_AKTUELLER_WERT | unsigned int | Batterieschirm: aktueller Messwert: 0-255 Inkremente ***BEACHTE: Batterieleitungsdiagnose findet auch im SBSL statt!*** |
| STAT_BATTERIESCHIRM_AKTUELLER_EINH | string | Batterieschirm: Einheit: (Ink)kremente ***BEACHTE: Batterieleitungsdiagnose findet auch im SBSL statt!*** |
| STAT_BATTERIESCHIRM | unsigned int | Batterieschirm aktuelle Klassifizierung: 0x00: Okay 0x01: Unterbrechung 0x02: Kurzschluss + 0x03: Kurzschluss - 0x04: unplausible Messwerte ***BEACHTE: Batterieleitungsdiagnose findet auch im SBSL statt!*** |
| STAT_BATTERIESCHIRM_OKAY | unsigned int | Batterieschirm: = 0 : Batterieschirm ist IO &lt;&gt;0 : Batterieschirm ist NIO ***BEACHTE: Batterieleitungsdiagnose findet auch im SBSL statt!*** |
| STAT_BATTERIESCHIRM_GROESSER_SENDESCHWELLE_PLUS | unsigned int | Batterieschirm: 1= Messwert groesser als Sendeschwelle + ***BEACHTE: Batterieleitungsdiagnose findet auch im SBSL statt!*** Dieser Fehler tritt nur im SBSL auf |
| STAT_BATTERIESCHIRM_NIEDRIGER_SENDESCHWELLE_MINUS | unsigned int | Batterieschirm: 1= Messwert niedriger als Sendeschwelle - ***BEACHTE: Batterieleitungsdiagnose findet auch im SBSL statt!*** Dieser Fehler tritt nur im SBSL auf |
| STAT_BATTERIESCHIRM_UNTERBRECHUNG | unsigned int | Batterieschirm: 1= Unterbrechung ***BEACHTE: Batterieleitungsdiagnose findet auch im SBSL statt!*** |
| STAT_BATTERIESCHIRM_KURZSCHLUSS_PLUS | unsigned int | Batterieschirm: 1= Kurzschluss gegen Plus ***BEACHTE: Batterieleitungsdiagnose findet auch im SBSL statt!*** |
| STAT_BATTERIESCHIRM_KURZSCHLUSS_MINUS | unsigned int | Batterieschirm: 1= Kurzschluss gegen Minus ***BEACHTE: Batterieleitungsdiagnose findet auch im SBSL statt!*** |
| STAT_BATTERIESCHIRM_UNPLAUS_MESSWERT | unsigned int | Batterieschirm: 1= Unplausibler Messwert ***BEACHTE: Batterieleitungsdiagnose findet auch im SBSL statt!*** |
...
<a id="job-oc3-daten-lesen"></a>
### OC3_DATEN_LESEN

OC3-Ident-Daten lesen ab SG-Softwareversion 4.4.2 KWP2000: $22 SG spezifische Daten lesen $98 $01 OC3-Ident lesen (über SBSR als Gateway) Modus  : Default  siehe auch JOB: OC3_DATEN_LESEN
...
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| BMW_TEILE_NR | string | BMW-Teile-Nr. (4 Byte) |
| HW_NR | string | Hardware-Nr. (1 Byte) |
| CODIERINDEX | string | Codierindex (1 Byte) |
| DIAGNOSEINDEX | string | Diagnoseindex (1 Byte) |
| BUSINDEX | string | Busindex (1 Byte) |
| HERSTELLUNGSDATUM | string | Herstellungsdatum Woche/Jahr (2 Byte) |
| LIEFERANTEN_NR | string | Lieferantennr. (1 Byte) |
| SOFTWARE_NR | string | Softwarenr. (1 Byte) |
| SERIEN_NR | string | Seriennr. (7 Byte) |

<a id="job-oc3-status"></a>
### OC3_STATUS

OC3-Status-Information lesen ab SG-Softwareversion 4.4.2 KWP2000: $22 SG spezifische Daten lesen $98 $03 OC3-Status lesen (über SBSR als Gateway) Modus  : Default
...
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_FREIGABE | int | 1: System freigegeben 0: System nicht freigegeben |
| STAT_FEHLER | int | OC3 Fehler-Status 0: kein Fehler 1: OC3-Fehler |
| STAT_DATENSPEICHER | int | OC3 Datenspeicher-Status 0: kein Fehler 1: Fehler OC3-Datenspeicher |
| STAT_GEWICHTSKLASSE | int | OC3 Gewichtsklasse 1: Gewichtsklasse "1" (Kindersitz oder leerer Sitz) 2: Gewichtsklasse "2" (&gt;=5% Frau / 45kg) -1: n.v.  Hinweis: Wechsel von Klasse 2 auf Klasse 1 (leerer Sitz) betraegt 6s. Wechsel von Klasse 1 auf Klasse 2 erfolgt sofort. |
| STAT_GEWICHTSKLASSE_KINDERSITZ | int | OC3 Gewichtsklasse 1: (Kindersitz oder leerer Sitz) siehe Hinweis bei Result "STAT_GEWICHTSKLASSE"! |
...
| STAT_SITZBELEGUNG | int | OC3 Sitzbelegung 0: Sitz unbelegt 1: Sitz belegt Signal wird unverzoegert ausgegeben Signal entspricht "Seatbelt reminder" (Gong) -1: n.v. |
...
| Name | Type | Comment |
| --- | --- | --- |
| HAENDLER_NR | string | Haendlernummer (3 Byte) 6 Ziffern eingeben z. B.: 081534 |
| PRUEFDATUM | string | Pruefdatum (3 Byte) 6 Ziffern eingeben z. B.: 050203 |
...
| Name | Type | Comment |
| --- | --- | --- |
| STAT_ZK1_AKTIV | int | 0=ZK1_NICHT_AKTIV 1=ZK1_AKTIV E60,E61,E63,E64 : Beifahrer-Airbag Stufe 1 / E85 : Front-Airbag Stufe 1 |
| STAT_ZK2_AKTIV | int | 0=ZK2_NICHT_AKTIV 1=ZK2_AKTIV E60,E61,E63,E64 : Beifahrer-Airbag Stufe 2 / E85 : Front-Airbag Stufe 2 |
| STAT_ZK3_AKTIV | int | 0=ZK3_NICHT_AKTIV 1=ZK3_AKTIV E60,E61,E63,E64,E85 : Gurtstrammer rechts |
| STAT_ZK4_AKTIV | int | 0=ZK4_NICHT_AKTIV 1=ZK4_AKTIV E60,E61 : Thorax-Airbag hinten rechts / E63,E64 : Knie-Airbag vorne rechts / E85 : Thorax-Airbag rechts |
| STAT_ZK5_AKTIV | int | 0=ZK5_NICHT_AKTIV 1=ZK5_AKTIV E60,E61 : Gurtstrammer hinten rechts / E63,E64,E85 : nicht verwendet |
| STAT_ZK6_AKTIV | int | 0=ZK6_NICHT_AKTIV 1=ZK6_AKTIV E60,E61,E63 : Kopf-Airbag rechts / E64 : nicht verwendet / E85 : Knie-Airbag rechts (nur US) |
...
- [FORTTEXTE](#table-forttexte) (142 × 2)
...
| ORT | ORTTEXT |
| --- | --- |
| 0x95a8 | Kurzschluss oder Unterbrechung Low-Side-Schalter  ZK1 |
| 0x95a9 | Kurzschluss oder Unterbrechung High-Side-Schalter ZK1 |
| 0x95aa | Kurzschluss oder Unterbrechung Low-Side-Schalter  ZK2 |
| 0x95ab | Kurzschluss oder Unterbrechung High-Side-Schalter ZK2 |
| 0x95ac | Kurzschluss oder Unterbrechung Low-Side-Schalter  ZK3 |
| 0x95ad | Kurzschluss oder Unterbrechung High-Side-Schalter ZK3 |
| 0x95ae | Kurzschluss oder Unterbrechung Low-Side-Schalter  ZK4 |
| 0x95af | Kurzschluss oder Unterbrechung High-Side-Schalter ZK4 |
| 0x95b0 | Kurzschluss oder Unterbrechung Low-Side-Schalter  ZK5 |
| 0x95b1 | Kurzschluss oder Unterbrechung High-Side-Schalter ZK5 |
| 0x95b2 | Kurzschluss oder Unterbrechung Low-Side-Schalter  ZK6 |
| 0x95b3 | Kurzschluss oder Unterbrechung High-Side-Schalter ZK6 |
| 0x95b4 | Spannungsueberwachung ASE unterer Grenzwert unterschritten |
| 0x95b5 | Spannungsueberwachung ASE oberer Grenzwert ueberschritten |
| 0x95b6 | Stack Overflow |
| 0x95b7 | OC3 Kommunikationsstoerung |
| 0x95b8 | OC3 Fehler |
| 0x95b9 | OC3 Datenspeicher |
| 0x95ba | OC3 nicht freigegeben |
| 0x95bb | Entladen der Beifahrerairbags fehlerhaft |
| 0x95bc | OC3 Vorlast |
| 0x95bd | Codierung unvollstaendig |
...
| 0x98ad | Timeout ID 01H (STVL) |
| 0x98ae | Timeout ID 02H (Reserve) |
| 0x98af | Timeout ID 03H (STVR) |
| 0x98b0 | Timeout ID 04H (Reserve) |
| 0x98b1 | Timeout ID 05H (SBSL_Y) |
| 0x98b2 | Timeout ID 06H (Reserve) |
| 0x98b3 | Timeout ID 07H (Reserve/SBSR_Y) |
| 0x98b4 | Timeout ID 08H (Reserve) |
| 0x98b5 | Timeout ID 09H (Zentral_Y; E85: SIM/E6x: SFZ) |
| 0x98b6 | Timeout ID 0AH (E85: SIM/E6x: SGM) |
| 0x98b7 | Timeout ID 0BH (SBSL_X) |
| 0x98b8 | Timeout ID 0CH (Reserve/SBSR_X) |
| 0x98b9 | Timeout ID 0DH (Zentral_X; E85: SIM/E6x: SFZ) |
| 0x98ba | Timeout ID 11H (Reserve/SBSR Batterieleitung) |
| 0x98bb | Timeout ID 12H (SBSL Batterieleitung) |
| 0x98bc | Timeout ID 20H (SBSL Sitzbelegungserkennung) |
| 0x98bd | Timeout ID 21H (Reserve/SBSR Sitzbelegungserkennung) |
| 0x98be | Unterbrechung ZK-Line |
| 0x98bf | Timeout ID 71H (E85: SIM/E6x: SGM Status) |
| 0x98c0 | Codierdaten Checksummenfehler |
...
| 0x98c6 | Kurzschluss oder Unterbrechung H/L-Side-Schalter ZK1 (E85: Front-Airbag rechts/E6x: Beifahrer-Airbag Stufe 1) |
| 0x98c7 | Kurzschluss ZK1 (E85: Front-Airbag rechts/E6x: Beifahrer-Airbag Stufe 1) nach Masse |
| 0x98c8 | Kurzschluss ZK1 (E85: Front-Airbag rechts/E6x: Beifahrer-Airbag Stufe 1) nach Plus |
| 0x98c9 | Widerstand Zuendpille ZK1 (E85: Front-Airbag rechts/E6x: Beifahrer-Airbag Stufe 1) zu klein |
| 0x98ca | Widerstand Zuendpille ZK1 (E85: Front-Airbag rechts/E6x: Beifahrer-Airbag Stufe 1) zu gross |
| 0x98cb | Widerstand Zuendpille ZK1 (E85: Front-Airbag rechts/E6x: Beifahrer-Airbag Stufe 1) nicht gemessen |
| 0x98cc | Unterbrechung ZK1 (E85: Front-Airbag rechts/E6x: Beifahrer-Airbag Stufe 1) |
| 0x98cd | Spannung ZK1 (E85: Front-Airbag rechts/E6x: Beifahrer-Airbag Stufe 1) n.i.O. |
| 0x98ce | Zuendkapazitaet ZK1 (E85: Front-Airbag rechts/E6x: Beifahrer-Airbag Stufe 1) n.i.O. |
| 0x98cf | Codierung/Konfiguration ZK1 (E85: Front-Airbag rechts; E6x: Beifahrer-Airbag Stufe 1) unstimmig |
| 0x98d0 | Unterbrechung Entladekreis ZK1 (E85: Front-Airbag rechts; E6x: Beifahrer-Airbag Stufe 1) |
| 0x98d1 | Kurzschluss oder Unterbrechung H/L-Side-Schalter ZK2 (E85: Front-Airbag rechts; E6x: Beifahrer-Airbag Stufe 2) |
| 0x98d2 | Kurzschluss ZK2 (E85: Front-Airbag rechts; E6x: Beifahrer-Airbag Stufe 2) nach Masse |
| 0x98d3 | Kurzschluss ZK2 (E85: Front-Airbag rechts; E6x: Beifahrer-Airbag Stufe 2) nach Plus |
| 0x98d4 | Widerstand Zuendpille ZK2 (E85: Front-Airbag rechts/E6x: Beifahrer-Airbag Stufe 2) zu klein |
| 0x98d5 | Widerstand Zuendpille ZK2 (E85: Front-Airbag rechts/E6x: Beifahrer-Airbag Stufe 2) zu gross |
| 0x98d6 | Widerstand Zuendpille ZK2 (E85: Front-Airbag rechts/E6x: Beifahrer-Airbag Stufe 2) nicht gemessen |
| 0x98d7 | Unterbrechung ZK2 (E85: Front-Airbag rechts/E6x: Beifahrer-Airbag Stufe 2) |
| 0x98d8 | Spannung ZK2 (E85: Front-Airbag rechts/E6x: Beifahrer-Airbag Stufe 2) n.i.O. |
| 0x98d9 | Zuendkapazitaet ZK2 (E85: Front-Airbag rechts/E6x: Beifahrer-Airbag Stufe 2) n.i.O. |
| 0x98da | Codierung/Konfiguration ZK2 (E85: Front-Airbag rechts/E6x: Beifahrer-Airbag Stufe 2) unstimmig |
| 0x98db | Unterbrechung Entladekreis ZK2 (E85: Front-Airbag rechts/E6x: Beifahrer-Airbag Stufe 2) |
| 0x98dc | Kurzschluss oder Unterbrechung H/L-Side-Schalter ZK3 (Gurtstrammer rechts) |
| 0x98dd | Kurzschluss ZK3 (Gurtstrammer rechts) nach Masse |
| 0x98de | Kurzschluss ZK3 (Gurtstrammer rechts) nach Plus |
| 0x98df | Widerstand Zuendpille ZK3 (Gurtstrammer rechts) zu klein |
| 0x98e0 | Widerstand Zuendpille ZK3 (Gurtstrammer rechts) zu gross |
| 0x98e1 | Widerstand Zuendpille ZK3 (Gurtstrammer rechts) nicht gemessen |
| 0x98e2 | Unterbrechung ZK3 (Gurtstrammer rechts) |
| 0x98e3 | Spannung ZK3 (Gurtstrammer rechts) n.i.O. |
| 0x98e4 | Zuendkapazitaet ZK3 (Gurtstrammer rechts) n.i.O. |
| 0x98e5 | Codierung/Konfiguration ZK3 (Gurtstrammer rechts) unstimmig |
| 0x98e6 | Unterbrechung Entladekreis ZK3 (Gurtstrammer rechts) |
| 0x98e7 | Kurzschluss oder Unterbrechung H/L-Side-Schalter ZK4 (E85: Seitenairbag rechts/E60,E61: Thorax-Airbag hinten rechts/E63,E64: Knie-Airbag vorne rechts) |
| 0x98e8 | Kurzschluss ZK4 (E85: Seitenairbag rechts/E60,E61: Thorax-Airbag hinten rechts/E63,E64: Knie-Airbag vorne rechts) nach Masse |
...
| 0x98ea | Widerstand Zuendpille ZK4 (E85: Seitenairbag rechts/E60,E61: Thorax-Airbag hinten rechts/E63,E64: Knie-Airbag vorne rechts) zu klein |
...
| 0x98ec | Widerstand Zuendpille ZK4 (E85: Seitenairbag rechts/E60,E61: Thorax-Airbag hinten rechts/E63,E64: Knie-Airbag vorne rechts) nicht gemessen |
| 0x98ed | Unterbrechung ZK4 (E85: Seitenairbag rechts/E60,E61: Thorax-Airbag hinten rechts/E63,E64: Knie-Airbag vorne rechts) |
| 0x98ee | Spannung ZK4 (E85: Seitenairbag rechts/E60,E61: Thorax-Airbag hinten rechts/E63,E64: Knie-Airbag vorne rechts) n.i.O. |
| 0x98ef | Zuendkapazitaet ZK4 (E85: Seitenairbag rechts/E60,E61: Thorax-Airbag hinten rechts/E63,E64: Knie-Airbag vorne rechts) n.i.O. |
| 0x98f0 | Codierung/Konfiguration ZK4 (E85: Seitenairbag rechts/E60,E61: Thorax-Airbag hinten rechts/E63,E64: Knie-Airbag vorne rechts) unstimmig |
| 0x98f1 | Unterbrechung Entladekreis ZK4 (E85: Seitenairbag rechts/E60,E61: Thorax-Airbag hinten rechts/E63,E64: Knie-Airbag vorne rechts) |
| 0x98f2 | Kurzschluss oder Unterbrechung H/L-Side-Schalter ZK5 (E85: Sicherheitsbatterieklemme/E6x: Gurtstrammer hinten rechts) |
| 0x98f3 | Kurzschluss ZK5 (E85: Sicherheitsbatterieklemme/E6x: Gurtstrammer hinten rechts) nach Masse |
| 0x98f4 | Kurzschluss ZK5 (E85: Sicherheitsbatterieklemme/E6x: Gurtstrammer hinten rechts) nach Plus |
| 0x98f5 | Widerstand Zuendpille ZK5 (E85: Sicherheitsbatterieklemme/E6x: Gurtstrammer hinten rechts) zu klein |
| 0x98f6 | Widerstand Zuendpille ZK5 (E85: Sicherheitsbatterieklemme/E6x: Gurtstrammer hinten rechts) zu gross |
| 0x98f7 | Widerstand Zuendpille ZK5 (E85: Sicherheitsbatterieklemme/E6x: Gurtstrammer hinten rechts) nicht gemessen |
| 0x98f8 | Unterbrechung ZK5 (E85: Sicherheitsbatterieklemme/E6x: Gurtstrammer hinten rechts) |
| 0x98f9 | Spannung ZK5 (E85: Sicherheitsbatterieklemme/E6x: Gurtstrammer hinten rechts) n.i.O. |
| 0x98fa | Zuendkapazitaet ZK5 (E85: Sicherheitsbatterieklemme/E6x: Gurtstrammer hinten rechts) n.i.O. |
| 0x98fb | Codierung/Konfiguration ZK5 (E85: Sicherheitsbatterieklemme/E6x: Gurtstrammer hinten rechts) unstimmig |
| 0x98fc | Unterbrechung Entladekreis ZK5 (E85: Sicherheitsbatterieklemme/E6x: Gurtstrammer hinten rechts) |
| 0x98fd | Kurzschluss oder Unterbrechung H/L-Side-Schalter ZK6 (E85: Knie-Airbag/E6x: Kopf-Airbag rechts) nach Masse) |
| 0x98fe | Kurzschluss ZK6 (E85: Knie-Airbag/E6x: Kopf-Airbag rechts) nach Masse) |
| 0x98ff | Kurzschluss ZK6 (E85: Knie-Airbag/E6x: Kopf-Airbag rechts) nach Plus) |
| 0x9900 | Widerstand Zuendpille ZK6 (E85: Knie-Airbag/E6x: Kopf-Airbag rechts) zu klein |
| 0x9901 | Widerstand Zuendpille ZK6 (E85: Knie-Airbag/E6x: Kopf-Airbag rechts) zu gross |
| 0x9902 | Widerstand Zuendpille ZK6 (E85: Knie-Airbag/E6x: Kopf-Airbag rechts) nicht gemessen |
| 0x9903 | Unterbrechung ZK6 (E85: Knie-Airbag/E6x: Kopf-Airbag rechts) |
| 0x9904 | Spannung ZK6 (E85: Knie-Airbag/E6x: Kopf-Airbag rechts) n.i.O. |
| 0x9905 | Zuendkapazitaet ZK6 (E85: Knie-Airbag/E6x: Kopf-Airbag rechts) n.i.O. |
| 0x9906 | Codierung/Konfiguration ZK6 (E85: Knie-Airbag/E6x: Kopf-Airbag rechts) unstimmig |
| 0x9907 | Unterbrechung Entladekreis ZK6 (E85: Knie-Airbag/E6x: Kopf-Airbag rechts) |
| 0x9908 | Fehler Beschleunigungssensor x: Offset zu gross |
| 0x9909 | Fehler Beschleunigungssensor x: Selbsttestwert zu gross |
| 0x990a | Fehler Beschleunigungssensor x: Selbsttestwert zu klein |
| 0x990b | Fehler Beschleunigungssensor y: Offset zu gross |
| 0x990c | Fehler Beschleunigungssensor y: Selbsttestwert zu gross |
| 0x990d | Fehler Beschleunigungssensor y: Selbsttestwert zu klein |
| 0x990e | Statusfehler Beschleunigungssensor |
| 0x990f | Hallschalter Kurzschluss |
| 0x9910 | Hallschalter unplausibler Messwert |
| 0x9911 | Hallschalter Unterbrechung |
| 0x9912 | Fehler im Alarmpfad |
| 0x9913 | Unterbrechung SBE1 |
| 0x9914 | Kurzschluss SBE1 |
| 0x9915 | Kommunikationsstoerung SBE1 |
| 0x9916 | Algorithmus-Parameter inkonsistent |
| 0x9917 | EAM-Parameter inkonsistent |
| 0x9918 | Zuendversuch erfolgt |
| 0x9919 | COP-Watchdog fehlerhaft |
| 0x991a | Unterbrechung Batterieleitung |
| 0x991b | Kurzschluss gegen Masse Batterieleitung (Schirmung) |
| 0x991c | Kurzschluss gegen Plus Batterieleitung (Schirmung) |
| 0x991d | Batterieleitung unplausibler Messwert |
| 0x991e | Interne Versorgungsspannung unplausibel (E85: SIM/E6x: SGM) |
...
| 0x9928 | Energiesparmode aktiv |
| 0x9617 | BLD: Offset nach oben ueberschritten |
| 0x9618 | BLD: Offset nach unten unterschritten |
| 0x9619 | BLD: Offset nach oben waehrend Initialisierung ueberschritten |
| 0x961a | BLD: Offset nach unten waehrend Initialisierung unterschritten |
| 0x961b | CS nur vom Bus erhalten |
| 0x961c | CS nur aus RAM erhalten |
| 0x961d | CS gueltig |
| 0x961e | EAM wird ausgewertet |
| 0x961f | EAM hat Treffer |
| 0x9620 | ZK Timer laeuft |
| 0x9621 | ZK wird gezündet |
| 0x9622 | Alarm war kurz vor Zündung da |
| 0x9623 | Eintrag Zuendversuch bzw unpl. CS ist Absicht |
| 0x9624 | BLD: Fehlerwert links über Bus empfangen |
| 0xFFFF | unbekannter Fehlerort |
