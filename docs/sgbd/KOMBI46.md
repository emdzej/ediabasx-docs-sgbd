...
- [KALIBRIERFAKTOR_VERBRAUCH_LESEN](#job-kalibrierfaktor-verbrauch-lesen) - Kalibrierfaktor Verbrauch aus EEPROM W-Adr. 1B lesen
- [KALIBRIERFAKTOR_VERBRAUCH_SCHREIBEN](#job-kalibrierfaktor-verbrauch-schreiben) - Kalibrierfaktor Verbrauch in EEPROM W-Adr. 1B schreiben
...
- [STEUERN_LEUCHTE](#job-steuern-leuchte) - Leuchten in der Anzeigeeinheit ansteuern Es muessen 4 Argumente uebergeben werden. Die Belegung der Datenbytes ist separat beschrieben.
...
- [STATUS_AUSSENTEMP_LESEN](#job-status-aussentemp-lesen) - Aussentemperatur lesen
...
- [STATUS_CAN_GETRIEBEINFO_LESEN](#job-status-can-getriebeinfo-lesen) - Getriebeinformationen ueber CAN auslesen
...
- [C_FA_LESEN](#job-c-fa-lesen) - Fahrzeugauftrag lesen Gueltiger Adressbereich: 0x10 - 0xDF (416 Bytes)
- [C_FA_AUFTRAG](#job-c-fa-auftrag) - Fahrzeugauftrag schreiben Fahrzeugauftrag lesen Gueltiger Adressbereich: 0x10 - 0xDF (416 Bytes)
...
<a id="job-kalibrierfaktor-verbrauch-lesen"></a>
...
| Name | Type | Comment |
| --- | --- | --- |
| KALIBRIERFAKTOR_WERT | int | Kalibrierfaktor Verbrauch |
| JOB_STATUS | string | Job-Status: OKAY, ERROR_.. |
| ANTWORT | binary | Antworttelegramm von SG |

<a id="job-kalibrierfaktor-verbrauch-schreiben"></a>
...
| STAT_WEGEINGANG_WERT | long | ADC-Wert der Geschwindigkeit |
| STAT_WEGEINGANG_EINH | string | Einheit [ADC-Wert] |
...
| --- | --- | --- |
| JOB_STATUS | string | Job-Status: OKAY, ERROR_.. |
| STAT_AUSSENTEMP_SENSOR_WERT | real | Aussentemperaturwert in Grad Celsius |
| STAT_AUSSENTEMP_SENSOR_EINH | string | Einheit Aussentemperatur: "Grad Celsius" |
| ANTWORT | binary | Antworttelegramm von SG |
...
| STAT_NK_TOG_N_MITTEL_1_WERT | real | Kurzzeitmittelwert des Oelniveaus auf 1/10 genau |
...
| STAT_NK_TOG_N_MITTEL_KORR_WERT | real | drehzahlkorregierter Kurzzeitmittelwert des Oelniveaus auf 1/10 genau |
| STAT_TOG_NIVEAU_MITTEL_KORR_EINH | string | mm |
| STAT_TOG_NIVEAU_MITTEL_WERT | real | Langzeitmittelwert des Oelniveaus |
| STAT_NK_TOG_N_MITTEL_WERT | real | Langzeitmittelwert des Oelniveaus auf 1/10 genau |
...
| STAT_BITSTATUS_0x0F | int | Bitstatus oberstes Bit Adresse 0x0F |
