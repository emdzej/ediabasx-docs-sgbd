...
| --- | --- |
| ECU | PGS R56  |
| ORIGIN | Magna-Steyr . Georg Schwarhofer |
| REVISION | 1.100 |
| AUTHOR | SiemensVDO SV C BC S52 SW MüllerFrank, SiemensVDO SV C BC S52 SW AignerBenjamin |
...
- [STATUS_DIGITAL_WUP_K_BUS](#job-status-digital-wup-k-bus) - Auslesen des Status des digitalen Signales K_BUS_WUP KWP2000: $30 InputOutputControlByLocalIdentifier Parameter: $01 ReportCurrentState Modus  : Default
- [STATUS_DIGITAL_NERR_CAN](#job-status-digital-nerr-can) - Auslesen des Status des digitalen Signales NERR_CAN KWP2000: $30 InputOutputControlByLocalIdentifier Parameter: $01 ReportCurrentState Modus  : Default
...
- [STATUS_DIGITAL_STB_CAN](#job-status-digital-stb-can) - Auslesen des Status des digitalen Signales STB_CAN KWP2000: $30 InputOutputControlByLocalIdentifier Parameter: $01 ReportCurrentState Modus  : Default
...
- [STATUS_DIGITAL_ON_FBD](#job-status-digital-on-fbd) - Auslesen des Status des digitalen Signales WUP KWP2000: $30 InputOutputControlByLocalIdentifier Parameter: $01 ReportCurrentState Modus  : Default
...
- [STATUS_KBUS_TELEGRAMM](#job-status-kbus-telegramm) - letztes PA-Telegramm KWP 2000: $21 ReadDataByLocalIdentifier LocalIdentifier $0D Modus   : Default
...
- [STATUS_TOGGLE_TASTER](#job-status-toggle-taster) - FT und BFT Toggle-Taster-Status lesen FT und BFT Toggle-Taster testen KWP2000: $31 StartRoutineByLocalIdentifier LID: $33 Beide Toggle-Taster testen  PGS-Applikation fuehrt den Test durch
- [STATUS_DIGITAL_RL0](#job-status-digital-rl0) - Auslesen des Status des digitalen Signales RL0 KWP2000: $30 InputOutputControlByLocalIdentifier Parameter: $01 ReportCurrentState Modus  : Default
- [STATUS_DIGITAL_RL1](#job-status-digital-rl1) - Auslesen des Status des digitalen Signales RL1 KWP2000: $30 InputOutputControlByLocalIdentifier Parameter: $01 ReportCurrentState Modus  : Default
- [STATUS_DIGITAL_RL2](#job-status-digital-rl2) - Auslesen des Status des digitalen Signales RL2 KWP2000: $30 InputOutputControlByLocalIdentifier Parameter: $01 ReportCurrentState Modus  : Default
- [STATUS_DIGITAL_RL3](#job-status-digital-rl3) - Auslesen des Status des digitalen Signales RL3 KWP2000: $30 InputOutputControlByLocalIdentifier Parameter: $01 ReportCurrentState Modus  : Default
- [STATUS_DIGITAL_RL4](#job-status-digital-rl4) - Auslesen des Status des digitalen Signales RL4 KWP2000: $30 InputOutputControlByLocalIdentifier Parameter: $01 ReportCurrentState Modus  : Default
- [STATUS_DIGITAL_NTC](#job-status-digital-ntc) - Auslesen des Status des digitalen Signales NTC KWP2000: $30 InputOutputControlByLocalIdentifier Parameter: $01 ReportCurrentState Modus  : Default
- [STATUS_DIGITAL_I_SEC](#job-status-digital-i-sec) - Auslesen des Status von digitalen Signal I_SEC KWP2000: $30 InputOutputControlByLocalIdentifier Parameter: $01 ReportCurrentState Modus  : Default
- [STATUS_DIGITAL_S_RL0](#job-status-digital-s-rl0) - Auslesen des Status des digitalen Signales S_RL0 KWP2000: $30 InputOutputControlByLocalIdentifier Parameter: $01 ReportCurrentState Modus  : Default
- [STATUS_DIGITAL_S_RL1](#job-status-digital-s-rl1) - Auslesen des Status des digitalen Signales S_RL1 KWP2000: $30 InputOutputControlByLocalIdentifier Parameter: $01 ReportCurrentState Modus  : Default
- [STATUS_DIGITAL_S_RL2](#job-status-digital-s-rl2) - Auslesen des Status des digitalen Signales S_RL2 KWP2000: $30 InputOutputControlByLocalIdentifier Parameter: $01 ReportCurrentState Modus  : Default
- [STATUS_DIGITAL_S_RL3](#job-status-digital-s-rl3) - Auslesen des Status des digitalen Signales S_RL3 KWP2000: $30 InputOutputControlByLocalIdentifier Parameter: $01 ReportCurrentState Modus  : Default
- [STATUS_DIGITAL_S_RL4](#job-status-digital-s-rl4) - Auslesen des Status des digitalen Signales S_RL4 KWP2000: $30 InputOutputControlByLocalIdentifier Parameter: $01 ReportCurrentState Modus  : Default
- [STATUS_DIGITAL_S_RL5](#job-status-digital-s-rl5) - Auslesen des Status des digitalen Signales S_RL5 KWP2000: $30 InputOutputControlByLocalIdentifier Parameter: $01 ReportCurrentState Modus  : Default
- [STATUS_DIGITAL_S_RL6](#job-status-digital-s-rl6) - Auslesen des Status des digitalen Signales S_RL6 KWP2000: $30 InputOutputControlByLocalIdentifier Parameter: $01 ReportCurrentState Modus  : Default
...
<a id="job-status-digital-wup-k-bus"></a>
### STATUS_DIGITAL_WUP_K_BUS
...
<a id="job-status-digital-nerr-can"></a>
### STATUS_DIGITAL_NERR_CAN

Auslesen des Status des digitalen Signales NERR_CAN KWP2000: $30 InputOutputControlByLocalIdentifier Parameter: $01 ReportCurrentState Modus  : Default
...
<a id="job-status-digital-stb-can"></a>
### STATUS_DIGITAL_STB_CAN

Auslesen des Status des digitalen Signales STB_CAN KWP2000: $30 InputOutputControlByLocalIdentifier Parameter: $01 ReportCurrentState Modus  : Default
...
<a id="job-status-digital-on-fbd"></a>
### STATUS_DIGITAL_ON_FBD
...
<a id="job-status-kbus-telegramm"></a>
### STATUS_KBUS_TELEGRAMM
...
| Name | Type | Comment |
| --- | --- | --- |
| STAT_PA_TELEGRAMM | binary | 20 Byte Byte0-19 |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
<a id="job-status-toggle-taster"></a>
### STATUS_TOGGLE_TASTER

FT und BFT Toggle-Taster-Status lesen FT und BFT Toggle-Taster testen KWP2000: $31 StartRoutineByLocalIdentifier LID: $33 Beide Toggle-Taster testen  PGS-Applikation fuehrt den Test durch

#### Arguments

| Name | Type | Comment |
| --- | --- | --- |
| TOGGLE_TASTER_NUMMER | int | Werte: 1...2 |
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_VALUE | int | Bereich: 0, wenn OFF (high) / 1, wenn ON (low) |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |

<a id="job-status-digital-rl0"></a>
### STATUS_DIGITAL_RL0

Auslesen des Status des digitalen Signales RL0 KWP2000: $30 InputOutputControlByLocalIdentifier Parameter: $01 ReportCurrentState Modus  : Default
...
<a id="job-status-digital-rl1"></a>
### STATUS_DIGITAL_RL1

Auslesen des Status des digitalen Signales RL1 KWP2000: $30 InputOutputControlByLocalIdentifier Parameter: $01 ReportCurrentState Modus  : Default
...
<a id="job-status-digital-rl2"></a>
### STATUS_DIGITAL_RL2

Auslesen des Status des digitalen Signales RL2 KWP2000: $30 InputOutputControlByLocalIdentifier Parameter: $01 ReportCurrentState Modus  : Default
...
<a id="job-status-digital-rl3"></a>
### STATUS_DIGITAL_RL3

Auslesen des Status des digitalen Signales RL3 KWP2000: $30 InputOutputControlByLocalIdentifier Parameter: $01 ReportCurrentState Modus  : Default
...
<a id="job-status-digital-rl4"></a>
### STATUS_DIGITAL_RL4

Auslesen des Status des digitalen Signales RL4 KWP2000: $30 InputOutputControlByLocalIdentifier Parameter: $01 ReportCurrentState Modus  : Default
...
<a id="job-status-digital-ntc"></a>
### STATUS_DIGITAL_NTC

Auslesen des Status des digitalen Signales NTC KWP2000: $30 InputOutputControlByLocalIdentifier Parameter: $01 ReportCurrentState Modus  : Default
...
<a id="job-status-digital-i-sec"></a>
### STATUS_DIGITAL_I_SEC

Auslesen des Status von digitalen Signal I_SEC KWP2000: $30 InputOutputControlByLocalIdentifier Parameter: $01 ReportCurrentState Modus  : Default
...
<a id="job-status-digital-s-rl0"></a>
### STATUS_DIGITAL_S_RL0

Auslesen des Status des digitalen Signales S_RL0 KWP2000: $30 InputOutputControlByLocalIdentifier Parameter: $01 ReportCurrentState Modus  : Default
...
<a id="job-status-digital-s-rl1"></a>
### STATUS_DIGITAL_S_RL1

Auslesen des Status des digitalen Signales S_RL1 KWP2000: $30 InputOutputControlByLocalIdentifier Parameter: $01 ReportCurrentState Modus  : Default
...
<a id="job-status-digital-s-rl2"></a>
### STATUS_DIGITAL_S_RL2

Auslesen des Status des digitalen Signales S_RL2 KWP2000: $30 InputOutputControlByLocalIdentifier Parameter: $01 ReportCurrentState Modus  : Default
...
<a id="job-status-digital-s-rl3"></a>
### STATUS_DIGITAL_S_RL3

Auslesen des Status des digitalen Signales S_RL3 KWP2000: $30 InputOutputControlByLocalIdentifier Parameter: $01 ReportCurrentState Modus  : Default
...
<a id="job-status-digital-s-rl4"></a>
### STATUS_DIGITAL_S_RL4

Auslesen des Status des digitalen Signales S_RL4 KWP2000: $30 InputOutputControlByLocalIdentifier Parameter: $01 ReportCurrentState Modus  : Default
...
<a id="job-status-digital-s-rl5"></a>
### STATUS_DIGITAL_S_RL5

Auslesen des Status des digitalen Signales S_RL5 KWP2000: $30 InputOutputControlByLocalIdentifier Parameter: $01 ReportCurrentState Modus  : Default
...
<a id="job-status-digital-s-rl6"></a>
### STATUS_DIGITAL_S_RL6

Auslesen des Status des digitalen Signales S_RL6 KWP2000: $30 InputOutputControlByLocalIdentifier Parameter: $01 ReportCurrentState Modus  : Default
...
- [ANALOGSIGNALEFUERLESEN](#table-analogsignalefuerlesen) (1 × 7)
...
| 0xA068 | PGS_Innenraumantenne_vorne_defekt |
| 0xA069 | PGS_Innenraumantenne_hinten_defekt |
| 0xA06A | PGS_Tuerantenne_links_defekt |
| 0xA06B | PGS_Tuerantenne_rechts_defekt |
| 0xA06C | PGS_Stossfaengerantenne_defekt |
...
| 0xA0C8 | Energiesparmode aktiv |
| 0xA0C9 | PGS_FT_Toggle_Taster_defekt |
| 0xA0CA | PGS_BFT_Toggle_Taster_defekt |
...
| ORT | ORTTEXT |
| --- | --- |
| 0x9323 | PGS_FT_ToggleTaster_defekt |
| 0x9324 | PGS_BFT_ToggleTaster_defekt |
| 0xFFFF | unbekannter Fehlerort |
...
| IOLI | NAME | TEXT |
| --- | --- | --- |
| 0x50 | RL5 | Relaisansteuerung Tuerantenne links |
| 0x51 | EN0 | CAN - Signale |
| 0x52 | STB_CAN | CAN - Signale |
...
| 0x5A | RL2 | Relaisansteuerung Innenraumantenne vorne |
| 0x5B | RL3 | Relaisansteuerung Innenraumantenne hinten |
| 0x5C | RL4 | Relaisansteuerung Stossfaengerantenne |
| 0x5E | ON_FBD | Wake-Up-Signal fuer FBD-Empfaenger |
| 0x60 | RL6 | Relaisansteuerung Tuerantenne rechts |
...
| --- | --- | --- | --- | --- | --- | --- |
| 0xA0 | VBAT | Volt | 236.25 | 8439.75 | 0 | Diagnoseleitung der KL30 (+12V) |
