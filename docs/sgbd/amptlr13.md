...
| Field | Value |
| --- | --- |
| ECU | High Audio Verstärker 16 Kanal |
| ORIGIN | BMW EI-41 H.Kelch |
| REVISION | 5.000 |
| AUTHOR | LEAR_Corporation_GmbH DCS_Sound M.Hümmer |
| COMMENT | N/A |
| PACKAGE | 1.25 |
| SPRACHE | deutsch |
...
- [STATUS_FOT_TEMPERATUR](#job-status-fot-temperatur) - Gibt die Temperatur an der FOT eines Steuergerätes zurück UDS   : $22 ReadDataByIdentifier UDS   : $17 DID StatusFOTTemperatur UDS   : $0A DID StatusFOTTemperatur
...
- [STEUERGERAETE_SW_RESET](#job-steuergeraete-sw-reset) - Harter Reset des Steuergeraets UDS  : $11 EcuReset UDS  : $03 HardReset Modus: Default
...
Gibt die Temperatur an der FOT eines Steuergerätes zurück UDS   : $22 ReadDataByIdentifier UDS   : $17 DID StatusFOTTemperatur UDS   : $0A DID StatusFOTTemperatur
...
| Name | Type | Comment |
| --- | --- | --- |
| STAT_FOT_TEMP_CELSIUS | int | Temperatur am FOT des SG in Celsius -128 C bis +127 C hierbei -128 C bedeutet ungültig (0xFF) |
| STAT_FOT_TEMP_FAHRENHEIT | real | Temperatur am FOT des SG in Fahrenheit -196.6 F bis +260.6 F hierbei bedeutet -198.4 F ungültig ( -128 C) Das Ergebnis wir innerhalb des SGBD-Jobs berechnet Fahrenheit = (( Celsius × 9 ) / 5 ) + 32 |
...
<a id="job-steuergeraete-sw-reset"></a>
### STEUERGERAETE_SW_RESET

Harter Reset des Steuergeraets UDS  : $11 EcuReset UDS  : $03 HardReset Modus: Default
...
- [IORTTEXTE](#table-iorttexte) (32 × 3)
...
- [RES_0XD05B](#table-res-0xd05b) (2 × 10)
- [ARG_0XD05B](#table-arg-0xd05b) (2 × 12)
- [ARG_0XA001](#table-arg-0xa001) (3 × 14)
- [RES_0XA06F](#table-res-0xa06f) (1 × 13)
- [ARG_0XA06F](#table-arg-0xa06f) (1 × 14)
...
- [TAB_VERBAU_ROUTINE](#table-tab-verbau-routine) (7 × 2)
...
- [ARG_0XA0A6](#table-arg-0xa0a6) (1 × 14)
- [RES_0XA0A6](#table-res-0xa0a6) (1 × 13)
- [TAB_MOVING](#table-tab-moving) (3 × 2)
- [ARG_0XD09C](#table-arg-0xd09c) (2 × 12)
- [TDEMUTESTATUS](#table-tdemutestatus) (3 × 2)
- [TAB_ASD_AUDIOQUELLEN](#table-tab-asd-audioquellen) (4 × 2)
- [RES_0X4000](#table-res-0x4000) (4 × 10)
- [RES_0XD09C](#table-res-0xd09c) (2 × 10)
- [ARG_0XF000](#table-arg-0xf000) (1 × 14)
- [RES_0XA0AB](#table-res-0xa0ab) (3 × 13)
- [ARG_0XA0AB](#table-arg-0xa0ab) (2 × 14)
...
| 0x02FF37 | Fehlerspeichereintrag im Komponentenfehlerbereich nur für Testzwecke | 1 |
| 0xB7F481 | Codierung: Steuergerät nicht codiert | 0 |
...
| 0xB7F4A0 | Geräte-Hardware: Temperatur übersteigt kritische Schwelle | 1 |
| 0xB7F4A1 | Fehler Lautsprecherkanal links vorne (Mitteltöner, wenn getrennt angesteuert) (Leitungsunterbrechung oder Kurzschluss nach Masse oder Plus) | 0 |
| 0xB7F4A2 | Fehler Lautsprecherkanal rechts vorne (Mitteltöner, wenn getrennt angesteuert) (Leitungsunterbrechung oder Kurzschluss nach Masse oder Plus) | 0 |
| 0xB7F4A3 | Fehler Lautsprecherkanal Center vorne (Mitteltöner, wenn getrennt angesteuert) (Leitungsunterbrechung oder Kurzschluss nach Masse oder Plus) | 0 |
| 0xB7F4A4 | Fehler Lautsprecherkanal Türe hinten links (Mitteltöner, wenn getrennt angesteuert) (Leitungsunterbrechung oder Kurzschluss nach Masse oder Plus) | 0 |
| 0xB7F4A5 | Fehler Lautsprecherkanal Türe hinten rechts (Mitteltöner, wenn getrennt angesteuert) (Leitungsunterbrechung oder Kurzschluss nach Masse oder Plus) | 0 |
| 0xB7F4A6 | Fehler Lautsprecherkanal links hinten (Mitteltöner, wenn getrennt angesteuert) (Leitungsunterbrechung oder Kurzschluss nach Masse oder Plus) | 0 |
| 0xB7F4A7 | Fehler Lautsprecherkanal rechts hinten (Mitteltöner, wenn getrennt angesteuert) (Leitungsunterbrechung oder Kurzschluss nach Masse oder Plus) | 0 |
| 0xB7F4A8 | Fehler Lautsprecherkanal Bass vorne links (Leitungsunterbrechung oder Kurzschluss nach Masse oder Plus) | 0 |
| 0xB7F4A9 | Fehler Lautsprecherkanal Bass vorne rechts (Leitungsunterbrechung oder Kurzschluss nach Masse oder Plus) | 0 |
| 0xB7F4AC | Fehler Lautsprecherkanal Center hinten (Mitteltöner, wenn getrennt angesteuert) (Leitungsunterbrechung oder Kurzschluss nach Masse oder Plus) | 0 |
| 0xB7F4AD | Fehler Lautsprecherkanal Hochtöner links vorne (Leitungsunterbrechung oder Kurzschluss nach Masse oder Plus) | 0 |
| 0xB7F4AE | Fehler Lautsprecherkanal Hochtöner rechts vorne (Leitungsunterbrechung oder Kurzschluss nach Masse oder Plus) | 0 |
| 0xB7F4AF | Fehler Lautsprecherkanal Hochtöner Center vorne (Leitungsunterbrechung oder Kurzschluss nach Masse oder Plus) | 0 |
| 0xB7F4B0 | Fehler Lautsprecherkanal Hochtöner Türe hinten links (Leitungsunterbrechung oder Kurzschluss nach Masse oder Plus) | 0 |
| 0xB7F4B1 | Fehler Lautsprecherkanal Hochtöner Türe hinten rechts (Leitungsunterbrechung oder Kurzschluss nach Masse oder Plus) | 0 |
| 0xB7F4B2 | Fehler Lautsprecherkanal Hochtöner hinten links (Leitungsunterbrechung oder Kurzschluss nach Masse oder Plus) | 0 |
| 0xB7F4B3 | Fehler Lautsprecherkanal Hochtöner hinten rechts (Leitungsunterbrechung oder Kurzschluss nach Masse oder Plus) | 0 |
| 0xB7F4B4 | Fehler Lautsprecherkanal Hochtöner Center hinten (Leitungsunterbrechung oder Kurzschluss nach Masse oder Plus) | 0 |
| 0xB7F4B5 | Verbindung Verstärker zum Mikrophon 1: Leitungsunterbrechung | 0 |
| 0xB7F4B6 | Verbindung Verstärker zum Mikrophon 1: Kurzschluss nach Plus | 0 |
| 0xB7F4B7 | Verbindung Verstärker zum Mikrophon 1: Kurzschluss nach Masse | 0 |
| 0xB7F4BC | Kein RADON-Signal obwohl Motor läuft | 1 |
| 0xB7F4BD | Pegel auf ASD-Eingang obwohl Motor nicht läuft | 1 |
| 0xB7F4BF | Inszenierung Licht 1: Kurzschluss nach Masse | 0 |
| 0xB7F4C1 | Inszenierung Licht 2: Kurzschluss nach Masse | 0 |
| 0xB7F4E0 | Logikteil: Unterspannung erkannt | 1 |
| 0xB7F4E1 | Lastteil: Unterspannung erkannt | 1 |
| 0xB7F4E2 | Logikteil: Überspannung erkannt | 1 |
| 0xB7F4E3 | Lastteil: Überspannung erkannt | 1 |
| 0xD6C43F | Empfängerknoten: hat Nachricht nicht abgenommen; Puffer voll | 1 |
| 0xD6C440 | Überwachungsschaltung hat Reset ausgelöst | 0 |
| 0xD6C442 | Sender- Empfängerbaustein (FOT): Temperatur übersteigt kritische Schwelle | 1 |
| 0xD6C445 | Reset INIC | 0 |
| 0xD6CBFF | Fehlerspeichereintrag im Netzwerkfehlerbereich nur für Testzwecke | 1 |
| 0xb7f492 | Ungültige Codierdaten | 0 |
...
| UWNR | UWTEXT | UW_EINH | L/H | UWTYP | NAME | MUL | DIV | ADD |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 0x1709 | MOSTMesHeader | Text | - | 6 | - | 1 | 1 | 0 |
| 0x170a | FOT Temperatur | Celsius | high | signed char | - | - | 1 | 0 |
| 0x170b | Node Position Register | Text | - | 1 | - | - | - | 0 |
| 0x170c | Versorgungsspannung | Volt | high | unsigned int | - | - | 1000 | 0 |
| 0x4001 | Bauteil | - | - | unsigned char | - | - | 1 | 0 |
...
| ORT | ORTTEXT | EREIGNIS_DTC |
| --- | --- | --- |
| 0x370000 | DSP Bootfehler | 0 |
| 0x370001 | DSP Kommunikationsfehler | 0 |
| 0x370002 | DSP RAM Fehler | 0 |
| 0x370003 | DSP Request Fehler | 0 |
| 0x370004 | Endstufen Kommunikationsfehler | 0 |
...
| 0xB7F496 | Fehler Onboard-Spannungen | 0 |
| 0xb7f495 | Entwickler-EQ: ungültige Checksumme | 0 |
| 0xb7f4c0 | NVM WRITE FAILED | 0 |
...
| 0xb7f4d0 | Nachrichtenausfall  Relativzeit  | 1 |
| 0xb7f4d1 | Nachrichtenausfall  Fahrzeugzustand  | 1 |
| 0xb7f4d2 | Puffer für aktive Fehlermeldung voll | 0 |
| 0xb7f4d3 | aktive Fehlermeldung konnte nicht gesendet werden | 1 |
| 0xFFFFFF | unbekannter Fehlerort | 0 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| LAUTSPRECHER_AUSGANG | 0xD05B | - | Verstellt und liest gleichzeitig Kanal und Lautstärke | - | - | - | - | - | - | - | - | - | 2E;22 | ARG_0xD05B | RES_0xD05B |
| SINUSGENERATOR | 0xA001 | - | Gibt einen Sinuston auf einen oder mehrere Kanäle aus. | - | - | - | - | - | - | - | - | - | 31 | ARG_0xA001 | - |
| LEISTUNGSZUSTAENDE | 0xA06F | - | Steuert die Leistungszustände des Verstärkers | - | - | - | - | - | - | - | - | - | 31 | ARG_0xA06F | RES_0xA06F |
...
| MOVING_CENTER | 0xA0A6 | - | Steuerung und Status des Moving Centers. | - | - | - | - | - | - | - | - | - | 31 | ARG_0xA0A6 | RES_0xA0A6 |
| ASD_AUDIOQUELLE | 0xD09C | - | Audioquelle für MUTE | - | - | - | - | - | - | - | - | - | 22;2E | ARG_0xD09C | RES_0xD09C |
| ASD_EINGANGSSIGNALE | 0x4000 | - | Liest den aktuellen Eingangspegel auf allen ASD Kanälen. | - | - | - | - | - | - | - | - | - | 22 | - | RES_0x4000 |
| ASD_GAIN | 0xF000 | - | Steuerung des Gains der ASD Signale. | - | - | - | - | - | - | - | - | - | 31 | ARG_0xF000 | - |
| RADON | 0xD028 | STAT_RADON | Abfragen des Radon-Signals. | 0-n | - | - | unsigned char | TRadOnLead | - | - | - | - | 22 | - | - |
| LICHTINSZENIERUNG | 0xA0AB | - | Ansteuerung der Lichtinszenierung, LEDs blinken mit fester Frequenz um eine Sichtprüfung zu vereinfachen. | - | - | - | - | - | - | - | - | - | 31 | ARG_0xA0AB | RES_0xA0AB |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ARG_LEVEL | - | - | char | - | - | - | - | - | - | - | -96..0 dB |
| ARG_KANAL | - | - | unsigned long | - | - | - | - | - | - | - | Kanalnummer Tabelle TAudioKanal |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_LEISTUNGSZUSTAND | - | - | + | 0-n | - | unsigned char | - | TAB_AMP_LEISTUNGSZUSTAND | - | - | - | - |

<a id="table-arg-0xa06f"></a>
### ARG_0XA06F
...
| ARG | STR | STPR | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | MIN | MAX | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ARG_LEISTUNGSZUSTAND | + | - | 0-n | - | unsigned char | - | TAB_AMP_LEISTUNGSZUSTAND | - | - | - | - | - | - |
...
| RESULTNAME | STR | STPR | RRR | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_TEST_VERBAU_VERSTAERKER | - | - | + | 0-n | high | unsigned char | - | TTestStatus | - | - | - | Gibt den Status des Verbautests wieder. Nach dem Herunterfahren oder Neustart des Steuergerätes wird der Status automatisch auf 0 zurückgesetzt. |
...
| ARG | STR | STPR | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | MIN | MAX | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ARG_MOVING | + | - | - | - | unsigned char | - | TAB_MOVING | - | - | - | 0 | 1 | Lässt das Moving Center auf- und zuklappen. |

<a id="table-res-0xa0a6"></a>
### RES_0XA0A6
...
| RESULTNAME | STR | STPR | RRR | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_MOVING_CENTER | - | - | + | 0-n | - | unsigned char | - | TAB_MOVING | - | - | - | Gibt an ob das MOVING_CENTER auf oder zu ist. |
...
| WERT | TEXT |
| --- | --- |
| 0x00 | MOVING CENTER zu |
| 0x01 | MOVING CENTER auf |
| 0xFF | Nicht definiert |
...
| ARG | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | MIN | MAX | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ARG_AUDIOQUELLE | 0-n | high | unsigned char | - | TAB_ASD_AUDIOQUELLEN | - | - | - | - | - | Signalwahl für MUTE: 0 = alle Signale 1 = ASD-Signal 2 = Entertainment-Signale |
...
| RESULTNAME | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_ASD_CHANNEL_0_WERT | Prozent | - | unsigned char | - | - | - | - | - | Input Level ASD Channel 0 |
| STAT_ASD_CHANNEL_1_WERT | Prozent | - | unsigned char | - | - | - | - | - | Input Level ASD Channel 1 |
| STAT_ASD_CHANNEL_2_WERT | Prozent | - | unsigned char | - | - | - | - | - | Input Level ASD Channel 2 |
| STAT_ASD_CHANNEL_3_WERT | Prozent | - | unsigned char | - | - | - | - | - | Input Level ASD Channel 3 |
...
| ARG | STR | STPR | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | MIN | MAX | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ASD_GAIN | + | - | dB | - | char | - | - | - | - | - | -96 | 0 | Gain der ASD Signale |

<a id="table-res-0xa0ab"></a>
### RES_0XA0AB
...
| RESULTNAME | STR | STPR | RRR | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_FREQ_WERT | - | - | + | Hz | high | unsigned char | - | - | 1.0 | 1.0 | 0.0 | gibt die aktuelle Blinkfrequenz an MIN=0 Hz MAX=5 Hz |
| STAT_LICHT_WERT | - | - | + | % | high | unsigned char | - | - | 1.0 | 1.0 | 0.0 | gibt die aktuelle Helligkeit der Lichtinszenierung an MIN=0 MAX=100 in Prozent |
| STAT_DIAG_MODE | - | - | + | 0-n | high | unsigned char | - | TAB_ONOFF | 1.0 | 1.0 | 0.0 | gibt an ob die Lichtinszenierung von der Diagnose oder Applikation gesteuert wird 0=AUS (=Applikation) 1=EIN (=Diagnose) |

<a id="table-arg-0xa0ab"></a>
### ARG_0XA0AB
...
| ARG | STR | STPR | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | MIN | MAX | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ARG_FREQ | + | - | Hz | high | unsigned char | - | - | 1.0 | 1.0 | 0.0 | 0.0 | 5.0 | legt die Blinkfrequenz fest MIN=0 Hz MAX=5 Hz |
| ARG_LICHT | + | - | % | high | unsigned char | - | - | 1.0 | 1.0 | 0.0 | 0.0 | 100.0 | legt die Helligkeit der Lichtinszenierung fest MIN=0 MAX=100 in Prozent |
