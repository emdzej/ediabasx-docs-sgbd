...
- [FORTTEXTE](#table-forttexte) (553 × 4)
- [FSCSM_ERRORCODE_TAB](#table-fscsm-errorcode-tab) (18 × 2)
- [FUMWELTTEXTE](#table-fumwelttexte) (294 × 9)
- [HWMODEL](#table-hwmodel) (5 × 2)
- [IDETAILSTRUKTUR](#table-idetailstruktur) (5 × 2)
- [IORTTEXTE](#table-iorttexte) (198 × 4)
- [IUMWELTTEXTE](#table-iumwelttexte) (214 × 9)
...
- [RES_0X1075_R](#table-res-0x1075-r) (2 × 13)
- [RES_0X10AB_R](#table-res-0x10ab-r) (1 × 13)
- [RES_0X1105_D](#table-res-0x1105-d) (3 × 10)
- [RES_0X1106_R](#table-res-0x1106-r) (1 × 13)
- [RES_0X1108_R](#table-res-0x1108-r) (3 × 13)
...
- [RES_0XE4C5_D](#table-res-0xe4c5-d) (6 × 10)
...
- [SG_FUNKTIONEN](#table-sg-funktionen) (114 × 16)
...
- [TAB_RSU_ACTIVATION_HV_SUPPORT_RETURNCODE](#table-tab-rsu-activation-hv-support-returncode) (3 × 2)
- [TAB_RSU_DEACTIVATION_HV_SUPPORT_RETURNCODE](#table-tab-rsu-deactivation-hv-support-returncode) (3 × 2)
...
- [TAB_UWB_SG_RESET_ART](#table-tab-uwb-sg-reset-art) (4 × 2)
- [TAB_UWB_STATUS_ENTLADESCHUTZ](#table-tab-uwb-status-entladeschutz) (4 × 2)
- [TAB_UWB_SWMATRIX_ZUSTAND](#table-tab-uwb-swmatrix-zustand) (3 × 2)
...
- [TAB_0X708C](#table-tab-0x708c) (1 × 17)
- [TAB_0X708D](#table-tab-0x708d) (1 × 17)
- [TAB_0X70F6](#table-tab-0x70f6) (1 × 17)
- [TAB_0X70F7](#table-tab-0x70f7) (1 × 17)
- [TAB_0X70F8](#table-tab-0x70f8) (1 × 17)
- [TAB_0X70F9](#table-tab-0x70f9) (1 × 17)
- [TAB_0X70FA](#table-tab-0x70fa) (1 × 17)
- [TAB_0X70FB](#table-tab-0x70fb) (1 × 17)
...
Dimensions: 553 rows × 4 columns

| ORT | ORTTEXT | EREIGNIS_DTC | FEHLERKLASSE |
| --- | --- | --- | --- |
| 0x023A00 | Energiesparmode aktiv | 0 | 0x00000010 |
| 0x023A08 | Codierung: Steuergerät ist nicht codiert | 0 | 0x00000020 |
| 0x023A09 | Codierung: Codierdaten passen nicht zum Fahrzeug | 0 | 0x00000020 |
| 0x023A0A | Codierung: Codierdaten nicht qualifiziert | 0 | 0x00000020 |
| 0x023A24 | NVM_E_HARDWARE | 0 | 0x00000020 |
| 0x023A36 | SecOC: Freshness Value Synchronisation fehlgeschlagen | 0 | 0x00000020 |
| 0x023A40 | Spannungsversorgung - Lokale Unterspannung | 0 | 0x00000080 |
| 0x023A41 | Spannungsversorgung - Lokale Überspannung | 0 | 0x00000080 |
| 0x023A46 | Spannungsversorgung - Lokal - Unplausibel | 0 | 0x00000080 |
| 0x023A70 | IPSEC_NICHT_INITIALISIERT | 0 | 0x00000020 |
| 0x023A71 | IPSEC_NICHT_VERRIEGELT | 0 | 0x00000020 |
| 0x023A72 | IPSEC_FEHLER_AUFGETRETEN | 0 | 0x00000020 |
| 0x023A80 | ZERTIFIKATE_UND_BINDINGS_TYP1_WERK_NICHT_BEREIT | 0 | 0x00000020 |
| 0x023A81 | ONLINE_ZERTIFIKATE_UND_BINDINGS_TYP2_NICHT_BEREIT | 0 | 0x00000020 |
| 0x023A82 | Secure Feature Activation: Tokenprüfung fehlgeschlagen | 0 | 0x00000020 |
| 0x023A83 | Secure Feature Activation: Tokenprüfung läuft aktuell oder ungeprüfte Tokens sind gespeichert | 0 | 0x00000020 |
| 0x023A84 | Locking Configuration Switch: Einer oder mehrere Schalter nicht gesetzt. | 0 | 0x00000020 |
| 0x023A85 | Secure ECU Modes: ECU not in field mode. | 0 | 0x00000020 |
| 0x023A90 | SecOC: Keypackprüfung fehlgeschlagen | 0 | 0x00000020 |
| 0x023A91 | SecOC: Bypass aktiv - Sichere Onboard Kommunikation deaktivert | 0 | 0x00000010 |
| 0x023A93 | SecOC: Security error von empfangenen Nachrichten | 0 | 0x00000020 |
| 0x02FF3A | Dummy-Fehlerspeichereintrag im Komponentenfehlerbereich nur für Testzwecke | 1 | 0x00000010 |
| 0x030F87 | DC/DC-Wandler, Hochvolt-Stromsensor: Oberer Schwellwert überschritten | 0 | 0x00000080 |
| 0x030F89 | DC/DC-Wandler, Hochvolt-Stromsensor: Signal unplausibel | 0 | 0x00000100 |
| 0x030F8C | DC/DC-Wandler, Niedervolt-Spannungssensor: Oberer Schwellwert überschritten | 0 | 0x00000080 |
| 0x030F8D | DC/DC-Wandler, Niedervolt-Spannungssensor: Unterer Schwellwert unterschritten | 0 | 0x00000080 |
| 0x030F8E | DC/DC-Wandler, Niedervolt-Spannungssensor: Signal unplausibel | 0 | 0x00000100 |
| 0x030F91 | DC/DC-Wandler, Niedervolt-Stromsensor: Schwellenwert überschritten | 0 | 0x00000080 |
| 0x030F93 | DC/DC-Wandler, Niedervolt-Stromsensor: Signal unplausibel | 0 | 0x00000100 |
| 0x030F96 | DC/DC-Wandler, Temperatursensor: Oberer Schwellenwert überschritten | 0 | 0x00000080 |
| 0x030F97 | DC/DC-Wandler, Temperatursensor: Unterer Schwellenwert unterschritten | 0 | 0x00000080 |
| 0x030F98 | DC/DC-Wandler, Temperatursensor: Signal unplausibel | 0 | 0x00000100 |
| 0x030FA6 | DC/DC-Wandler, Niedervolt-Spannungssensor: Sollspannung nicht erreicht | 0 | 0x00000100 |
| 0x030FA8 | DC/DC-Wandler, Bauteilschutz:  Abschaltung aufgrund Übertemperatur | 0 | 0x00000100 |
| 0x030FAA | DC/DC-Wandler, Hochvolt-Stromsensor, Bauteilschutz: Abschaltung aufgrund Überstrom | 0 | 0x00000100 |
| 0x030FAC | DC/DC-Wandler, Niedervolt-Stromsensor, Bauteilschutz: Abschaltung aufgrund Überstrom | 0 | 0x00000100 |
| 0x030FB3 | DC/DC-Wandler, Wirkungsgrad unplausibel | 0 | 0x00000100 |
| 0x030FB6 | DC/DC-Wandler, Bauteilschutz: Kühlmitteltemperatur | 0 | 0x00000100 |
| 0x030FB7 | DC/DC-Wandler, Bauteilschutz: Ausgangsanschlüsse vertauscht | 0 | 0x00000100 |
| 0x030FB8 | DC/DC-Wandler, Bauteilschutz: Niedervolt-Spannung-Eigendiagnose | 0 | 0x00000100 |
| 0x0317F0 | eAntrieb, Hochvoltsystem: Spannungsfreiheit nicht hergestellt | 0 | 0x00000100 |
| 0x0317F1 | eAntrieb, Hochvoltsystem: Isolationsfehler erkannt | 0 | 0x00000100 |
| 0x0317F2 | eAntrieb, Hochvoltsystem: Isolationswarnung erkannt | 0 | 0x00000100 |
| 0x031807 | AC-Laden, Modul 2, Digitaler Signalprozessor: Interner Fehler | 0 | 0x00000100 |
| 0x03180E | AC-Laden, Modul 1, Digitaler Signalprozessor: Interner Fehler | 0 | 0x00000100 |
| 0x03181E | AC-Laden, Modul 1:  Wirkungsgrad Signal unplausibel | 0 | 0x00000100 |
| 0x0318B5 | AC-Laden, Modul 2: Wirkungsgrad Signal unplausibel | 0 | 0x00000100 |
| 0x0318DA | AC-Laden, Modul 3: Wirkungsgrad unplausibel | 0 | 0x00000100 |
| 0x0318DE | AC-Laden, Modul 3, Digitaler Signalprozessor: Interner Fehler | 0 | 0x00000100 |
| 0x031942 | AC-Laden, Modul 1, Bauteilschutz: Sammelfehler | 0 | 0x00000100 |
| 0x031944 | AC-Laden, Modul 1, Plausibilität: Solleistung nicht erreicht | 0 | 0x00000100 |
| 0x031945 | AC-Laden, Modul 1, Vorladen: Funktion fehlerhaft | 0 | 0x00000100 |
| 0x031946 | AC-Laden, Modul 1: Sensor Sammelfehler | 0 | 0x00000100 |
| 0x031947 | AC-Laden, Modul 2, Bauteilschutz: Sammelfehler | 0 | 0x00000100 |
| 0x031948 | AC-Laden, Modul 2, Plausibilität: Solleistung nicht erreicht | 0 | 0x00000100 |
| 0x031949 | AC-Laden, Modul 2, Vorladen: Funktion fehlerhaft | 0 | 0x00000100 |
| 0x03194A | Power Line Communication: Kommunikation zum Modem gestört | 0 | 0x00000100 |
| 0x03194B | Power Line Communication: Verbindungsstörung, Ladesäule | 0 | 0x00000100 |
| 0x03194C | Power Line Communication: Protokollfehler | 0 | 0x00000100 |
| 0x03194D | AC-Laden, Modul 2: Sensor Sammelfehler | 0 | 0x00000100 |
| 0x03194E | AC-Laden, Modul 3, Bauteilschutz: Sammelfehler | 0 | 0x00000100 |
| 0x03194F | AC-Laden, Modul 3, Plausibilität: Solleistung nicht erreicht | 0 | 0x00000100 |
| 0x031951 | AC-Laden, Modul 3, Vorladen: Funktion fehlerhaft | 0 | 0x00000100 |
| 0x031952 | AC-Laden, Modul 3: Sensor Sammelfehler | 0 | 0x00000100 |
| 0x031953 | AC-Laden, Bauteilschutz: AC-Überspannung | 0 | 0x00000080 |
| 0x031954 | AC-Laden, Bauteilschutz: AC-Unterspannung | 0 | 0x00000080 |
| 0x031955 | AC-Laden, Bauteilschutz: DC-Überspannung | 0 | 0x00000100 |
| 0x031956 | AC-Laden, Bauteilschutz: DC-Unterspannung | 0 | 0x00000080 |
| 0x031957 | AC-Laden, Bauteilschutz: Sammelfehler | 0 | 0x00000100 |
| 0x031958 | AC-Laden, Bauteilschutz: Temperatur | 0 | 0x00000100 |
| 0x031959 | AC-Laden, Bauteilschutz: HV-Sicherheit | 0 | 0x00000100 |
| 0x032140 | Ladedose AC oder Combo, Beleuchtung: Oberer Schwellenwert überschritten | 0 | 0x00000080 |
| 0x032141 | Ladedose AC oder Combo, Beleuchtung: Unterer Schwellenwert unterschritten | 0 | 0x00000080 |
| 0x032142 | Ladedose AC oder Combo, Kommunikationsausfall | 0 | 0x00000080 |
| 0x032143 | Ladedose AC oder Combo, Spannungsversorgung: Überspannung | 0 | 0x00000080 |
| 0x032144 | Ladedose AC oder Combo, Spannungsversorgung: Unterspannung | 0 | 0x00000080 |
| 0x032145 | Ladedose AC oder Combo, Temperatursensor N: Oberer Schwellenwert überschritten | 0 | 0x00000080 |
| 0x032146 | Ladedose AC oder Combo, Temperatursensor N: Signal unplausibel | 0 | 0x00000080 |
| 0x032147 | Ladedose AC oder Combo, Temperatursensor N: Unterer Schwellenwert unterschritten | 0 | 0x00000080 |
| 0x032148 | Ladedose AC oder Combo, Temperatursensor L2: Oberer Schwellenwert überschritten | 0 | 0x00000080 |
| 0x032149 | Ladedose AC oder Combo, Temperatursensor L2: Signal unplausibel | 0 | 0x00000080 |
| 0x03214A | Ladedose AC oder Combo, Temperatursensor L2: Unterer Schwellenwert unterschritten | 0 | 0x00000080 |
| 0x03214B | Ladedose AC oder Combo, Verriegelungsaktor: Oberer Schwellenwert überschritten | 0 | 0x00000080 |
| 0x03214C | Ladedose AC oder Combo, Verriegelungsaktor: Unterer Schwellenwert unterschritten | 0 | 0x00000080 |
| 0x03214D | Ladedose AC oder Combo, Verriegelungssensor: Oberer Schwellenwert überschritten | 0 | 0x00000080 |
| 0x03214E | Ladedose AC oder Combo, Verriegelungssensor: Unterer Schwellenwert unterschritten | 0 | 0x00000080 |
| 0x03215E | Ladedose DC, Beleuchtung: Oberer Schwellenwert überschritten | 0 | 0x00000080 |
| 0x03215F | Ladedose DC, Beleuchtung: Unterer Schwellenwert unterschritten | 0 | 0x00000080 |
| 0x032160 | Ladedose DC, Kommunikationsausfall | 0 | 0x00000080 |
| 0x032161 | Ladedose DC, Spannungsversorgung: Überspannung | 0 | 0x00000080 |
| 0x032162 | Ladedose DC, Spannungsversorgung: Unterspannung | 0 | 0x00000080 |
| 0x032163 | Ladedose DC oder Combo, Temperatursensor DC plus: Oberer Schwellenwert überschritten | 0 | 0x00000080 |
| 0x032164 | Ladedose DC oder Combo, Temperatursensor DC plus: Unterer Schwellenwert unterschritten | 0 | 0x00000080 |
| 0x032165 | Ladedose DC oder Combo, Temperatursensor DC minus: Oberer Schwellenwert überschritten | 0 | 0x00000080 |
| 0x032166 | Ladedose DC oder Combo, Temperatursensor DC minus: Unterer Schwellenwert unterschritten | 0 | 0x00000080 |
| 0x03216B | Ladeklappe AC oder Combo, Positionssensor: Oberer Schwellenwert überschritten | 0 | 0x00000080 |
| 0x03216C | Ladeklappe AC oder Combo, Positionssensor: Unterer Schwellenwert unterschritten | 0 | 0x00000080 |
| 0x03216D | Ladeklappe AC oder Combo, Verriegelungsaktor: Funktionsprüfung fehlgeschlagen | 0 | 0x00000080 |
| 0x03216E | Ladeklappe AC oder Combo, Verriegelungsaktor: Oberer Schwellenwert überschritten | 0 | 0x00000080 |
| 0x03216F | Ladeklappe AC oder Combo, Verriegelungsaktor: Unterer Schwellenwert unterschritten | 0 | 0x00000080 |
| 0x032170 | Ladeklappe DC, Positionssensor: Oberer Schwellenwert überschritten | 0 | 0x00000080 |
| 0x032171 | Ladeklappe DC, Positionssensor: Unterer Schwellenwert unterschritten | 0 | 0x00000080 |
| 0x032172 | Ladeklappe DC, Verriegelungsaktor: Funktionsprüfung fehlgeschlagen | 0 | 0x00000080 |
| 0x032173 | Ladeklappe DC, Verriegelungsaktor: Oberer Schwellenwert überschritten | 0 | 0x00000080 |
| 0x032174 | Ladeklappe DC, Verriegelungsaktor: Unterer Schwellenwert unterschritten | 0 | 0x00000080 |
| 0x032175 | AC-Laden, Schaltmatrix: Fehlfunktion | 0 | 0x00000100 |
| 0x032189 | Ladedose AC oder Combo, Temperatursensor L1: Oberer Schwellenwert überschritten | 0 | 0x00000080 |
| 0x03218A | Ladedose AC oder Combo, Temperatursensor L1: Unterer Schwellenwert unterschritten | 0 | 0x00000080 |
| 0x03218B | Ladedose AC oder Combo, Temperatursensor L1: Signal unplausibel | 0 | 0x00000080 |
| 0x03218C | Ladedose AC oder Combo, Temperatursensor L3: Oberer Schwellenwert überschritten | 0 | 0x00000080 |
| 0x03218D | Ladedose AC oder Combo, Temperatursensor L3: Unterer Schwellenwert unterschritten | 0 | 0x00000080 |
| 0x03218E | Ladedose AC oder Combo, Temperatursensor L3: Signal unplausibel | 0 | 0x00000080 |
| 0x03218F | Ladedose AC oder Combo, Verriegelungsaktor: Funktionsprüfung fehlgeschlagen | 0 | 0x00000080 |
| 0x032190 | Ladedose AC oder Combo, Verriegelungssensor: Signal unplausibel | 0 | 0x00000080 |
| 0x032191 | Ladedose DC oder Combo, Temperatursensor DC plus: Signal unplausibel | 0 | 0x00000080 |
| 0x032192 | Ladedose DC oder Combo, Temperatursensor DC minus: Signal unplausibel | 0 | 0x00000080 |
| 0x032193 | Ladedose AC oder Combo, Entriegelungstasters Typ 1 oder China: Dauerbetätigung | 0 | 0x00020000 |
| 0x032194 | Ladeklappe AC oder Combo, Positionssensor: Zustand unplausibel | 0 | 0x00020000 |
| 0x032196 | Ladeklappe DC, Positionssensor: Zustand unplausibel | 0 | 0x00020000 |
| 0x032198 | Ladeschnittstelle AC oder Combo, Ladesteckererkennung: ungültig | 0 | 0x00000100 |
| 0x032199 | Ladeschnittstelle AC, Ladebereitschaft mit Ladesäule: nicht herstellbar | 0 | 0x00000100 |
| 0x03219A | Ladeschnittstelle AC oder Combo, Ladesteuerungssignale der Ladesäule: ungültig | 0 | 0x00000100 |
| 0x03219B | Ladeschnittstelle DC, Ladesteuerungssignale der Ladesäule: ungültig | 0 | 0x00000100 |
| 0x03219C | Ladeschnittstelle DC, Ladefehler durch Ladesäule erkannt | 0 | 0x00000100 |
| 0x03219D | Ladeschnittstelle DC, Ladefehler durch Fahrzeug erkannt | 0 | 0x00000100 |
| 0x03219E | Ladeschnittstelle DC, Ladesteckererkennung: ungültig | 0 | 0x00000100 |
| 0x032C40 | Betriebsstrategie Antrieb, Turtle Mode: kritische Degradation vorhanden | 0 | 0x00000100 |
| 0x032C41 | Betriebsstrategie Antrieb, Turtle Mode: Hochvolt-Batterie-Ladezustand zu niedrig | 0 | 0x00000100 |
| 0x032C46 | Antrieb, Fahrbereitschaft: Fahrbereitschaft nicht möglich aufgrund steckendem Ladekabel | 0 | 0x00000100 |
| 0x032C47 | Antrieb, Fahrbereitschaft: Fahrbereitschaft nicht möglich: nach Anforderung durch den Kunden | 1 | 0x00020000 |
| 0x032C4C | Antrieb, Segel-Rekuperations-Assistent: Assistent nicht verfügbar aufgrund defektem Radar | 0 | 0x00000100 |
| 0x032C4F | Antrieb,  Segel-Rekuperations-Assistent: Assistent nicht verfügbar aufgrund blindem Radar | 0 | 0x00000100 |
| 0x032C50 | Antrieb, Segel-Rekuperations-Assistent: Assistent nicht verfügbar aufgrund blinder Kamera | 0 | 0x00000100 |
| 0x033DC0 | Shift-by-Wire, FuSi: Falsche Fahrtrichtung | 0 | 0x00000100 |
| 0x033DC1 | Shift-by-Wire, FuSi: Falsche Positionsanzeige erkannt | 0 | 0x00000100 |
| 0x033DC2 | Shift-by-Wire, FuSi: Kommando ungewolltes Auslegen der Parksperre | 0 | 0x00000100 |
| 0x033DC3 | Shift-by-Wire, FuSi: Kommando ungewolltes Einlegen der Parksperre | 0 | 0x00000100 |
| 0x033DC4 | Shift-by-Wire, FuSi: Ungewolltes Auslegen der Parksperre erkannt | 0 | 0x00000100 |
| 0x033DC5 | Shift-by-Wire: Auto-N Rollen falsche Fahrtrichtung | 0 | 0x00000100 |
| 0x033DC6 | Shift-by-Wire: Auto-P deaktiviert | 0 | 0x00000100 |
| 0x033DC7 | Shift-by-Wire: FAS-Signalfehler bei aktivem FAS | 0 | 0x00000100 |
| 0x033DC8 | Shift-by-Wire: Parksperrenfehler Diebstahlschutz | 0 | 0x00000100 |
| 0x033DC9 | Shift-by-Wire: Parksperrenfehler über Qualifier gemeldet | 0 | 0x00000100 |
| 0x033DCA | Shift-by-Wire: Parksperre nicht ausgelegt | 0 | 0x00000100 |
| 0x033DCB | Shift-by-Wire: P bei hoher Fahrzeuggeschwindigkeit | 0 | 0x00000100 |
| 0x033DCC | Shift-by-Wire: P bei niedriger Fahrzeuggeschwindigkeit | 0 | 0x00000100 |
| 0x033DCD | Shift-by-Wire: P nicht eingelegt | 0 | 0x00000100 |
| 0x033DCE | Shift-by-Wire: Raddrehzahlen nicht plausibel zur EM-Drehzahl | 0 | 0x00000100 |
| 0x033DCF | Shift-by-Wire: Ungewolltes Einlegen der Parksperre erkannt | 0 | 0x00000100 |
| 0x224040 | Aktive Kühlluftklappensteuerung 01 - Lageregelung - Dauerhafte Blockierung | 0 | 0x00000100 |
| 0x224041 | Aktive Kühlluftklappensteuerung 01 - Lageregelung - Dauerhafte Blockierung Umgebungstemperatur warm | 0 | 0x00000100 |
| 0x224042 | Aktive Kühlluftklappensteuerung 01 - Lageregelung - Anschlag offen nicht erkannt | 0 | 0x00000100 |
| 0x224043 | Aktive Kühlluftklappensteuerung 01 - Lageregelung - Anschlag geschlossen nicht erkannt | 0 | 0x00000100 |
| 0x224044 | Aktive Kühlluftklappensteuerung 01 - Lageregelung - Regelabweichung Umgebungstemperatur warm | 0 | 0x00000100 |
| 0x224045 | Aktive Kühlluftklappensteuerung 01 - Lageregelung - Regelabweichung | 0 | 0x00000100 |
| 0x224046 | Aktive Kühlluftklappensteuerung 02 - Lageregelung - Dauerhafte Blockierung | 0 | 0x00000100 |
| 0x224047 | Aktive Kühlluftklappensteuerung 02 - Lageregelung - Dauerhafte Blockierung Umgebungstemperatur warm | 0 | 0x00000100 |
| 0x224048 | Aktive Kühlluftklappensteuerung 02 - Lageregelung - Anschlag offen nicht erkannt | 0 | 0x00000100 |
| 0x224049 | Aktive Kühlluftklappensteuerung 02 - Lageregelung - Anschlag geschlossen nicht erkannt | 0 | 0x00000100 |
| 0x22404A | Aktive Kühlluftklappensteuerung 02 - Lageregelung - Regelabweichung Umgebungstemperatur warm | 0 | 0x00000100 |
| 0x22404B | Aktive Kühlluftklappensteuerung 02 - Lageregelung - Regelabweichung | 0 | 0x00000100 |
| 0x22404E | Aktive Kühlluftklappensteuerung 01 - Aktor - Spannungsversorgung gestört | 0 | 0x00000080 |
| 0x22404F | Aktive Kühlluftklappensteuerung 01 - Aktor - Übertemperatur | 0 | 0x00000100 |
| 0x224050 | Aktive Kühlluftklappensteuerung 01 - Aktor - elektrischer Fehler | 0 | 0x00000080 |
| 0x224051 | Aktive Kühlluftklappensteuerung 01 - Aktor - Istposition unplausibel | 0 | 0x00000100 |
| 0x224052 | Aktive Kühlluftklappensteuerung 02 - Aktor - Spannungsversorgung gestört | 0 | 0x00000080 |
| 0x224053 | Aktive Kühlluftklappensteuerung 02 - Aktor - Übertemperatur | 0 | 0x00000100 |
| 0x224054 | Aktive Kühlluftklappensteuerung 02 - Aktor - elektrischer Fehler | 0 | 0x00000080 |
| 0x224055 | Aktive Kühlluftklappensteuerung 02 - Aktor - Istposition unplausibel | 0 | 0x00000100 |
| 0x224058 | Aktive Kühlluftklappensteuerung 01 - Kommunikation - Botschaft LIN - Timeout | 0 | 0x00000100 |
| 0x224059 | Aktive Kühlluftklappensteuerung 01 - Kommunikation - Botschaft DOBD-MUX - Alive | 0 | 0x00000100 |
| 0x22405A | Aktive Kühlluftklappensteuerung 01 - Kommunikation - Botschaft DOBD MUX - Timeout | 0 | 0x00000100 |
| 0x22405B | Aktive Kühlluftklappensteuerung 01 - Kommunikation - LIN Knoten | 0 | 0x00000100 |
| 0x22405C | Aktive Kühlluftklappensteuerung 02 - Kommunikation - Botschaft LIN - Timeout | 0 | 0x00000100 |
| 0x22405D | Aktive Kühlluftklappensteuerung 02 - Kommunikation - Botschaft DOBD-MUX - Alive | 0 | 0x00000100 |
| 0x22405E | Aktive Kühlluftklappensteuerung 02 - Kommunikation - Botschaft DOBD MUX - Timeout | 0 | 0x00000100 |
| 0x22405F | Aktive Kühlluftklappensteuerung 02 - Kommunikation - LIN Knoten | 0 | 0x00000100 |
| 0x224060 | Aktive Kühlluftklappensteuerung 01 - DOBD - Interner Brückenfehler | 0 | 0x00000100 |
| 0x224061 | Aktive Kühlluftklappensteuerung 01 - DOBD - Überspannung | 0 | 0x00000080 |
| 0x224062 | Aktive Kühlluftklappensteuerung 01 - DOBD - Unterspannung | 0 | 0x00000080 |
| 0x224063 | Aktive Kühlluftklappensteuerung 01 - DOBD - Hallsensor | 0 | 0x00000100 |
| 0x224064 | Aktive Kühlluftklappensteuerung 01 - DOBD - Notlauf aktiv | 0 | 0x00000100 |
| 0x224065 | Aktive Kühlluftklappensteuerung 02 - DOBD - Interner Brückenfehler | 0 | 0x00000100 |
| 0x224066 | Aktive Kühlluftklappensteuerung 02 - DOBD - Überspannung | 0 | 0x00000080 |
| 0x224067 | Aktive Kühlluftklappensteuerung 02 - DOBD - Unterspannung | 0 | 0x00000080 |
| 0x224068 | Aktive Kühlluftklappensteuerung 02 - DOBD - Hallsensor | 0 | 0x00000100 |
| 0x224069 | Aktive Kühlluftklappensteuerung 02 - DOBD - Notlauf aktiv | 0 | 0x00000100 |
| 0x22408A | Dreiwegeventil-HVS - Bauteilschutz - Abschaltung wegen Übertemperatur | 0 | 0x00000080 |
| 0x22408B | Dreiwegeventil-HVS - Kurzschluss nach Masse | 0 | 0x00000080 |
| 0x22408C | Dreiwegeventil-HVS - Kurzschluss nach Plus | 0 | 0x00000080 |
| 0x22408D | Dreiwegeventil-HVS - offene Leitung | 0 | 0x00000080 |
| 0x2240C0 | Elektrolüfter - Stromerfassung - Oberer Schwellenwert überschritten | 0 | 0x00000080 |
| 0x2240C1 | Elektrolüfter - Stromerfassung - Unterer Schwellenwert unterschritten | 0 | 0x00000080 |
| 0x2240C2 | Elektrolüfter - Temperaturerfassung - Oberer Schwellenwert überschritten | 0 | 0x00000080 |
| 0x2240C3 | Elektrolüfter - Temperaturerfassung - Unterer Schwellenwert unterschritten | 0 | 0x00000080 |
| 0x2240C4 | Elektrolüfter - Spannungserfassung - Oberer Schwellenwert überschritten | 0 | 0x00000080 |
| 0x2240C5 | Elektrolüfter - Spannungserfassung - Unterer Schwellenwert unterschritten | 0 | 0x00000080 |
| 0x2240C6 | Elektrolüfter - Blockierung erkannt | 0 | 0x00000100 |
| 0x2240C7 | Elektrolüfter - Brückentreiber gestört | 0 | 0x00000080 |
| 0x2240C8 | Elektrolüfter - Phasenkurzschluss | 0 | 0x00000080 |
| 0x2240C9 | Elektrolüfter - Kommunikation - Kommunikation zu Master gestört | 0 | 0x00000084 |
| 0x2240CA | Elektrolüfter - Bauteilschutz - Degradation wegen Überstrom | 0 | 0x00000084 |
| 0x2240CB | Elektrolüfter-  Stromerfassung - Strom unplausibel | 0 | 0x00000100 |
| 0x2240CC | Elektrolüfter - Bauteilschutz - Abschaltung wegen Überstrom | 0 | 0x00000080 |
| 0x2240CD | Elektrolüfter - Betriebsmodus unplausibel | 0 | 0x00000100 |
| 0x2240CE | Elektrolüfter - Daten unplausibel | 0 | 0x00000100 |
| 0x2240CF | Elektrolüfter - Schwergängigkeit erkannt | 0 | 0x00000100 |
| 0x2240D0 | Elektrolüfter - Bauteilschutz - Degradation wegen Übertemperatur | 0 | 0x00000100 |
| 0x2240D1 | Elektrolüfter - Bauteilschutz - Abschaltung wegen Übertemperatur | 0 | 0x00000100 |
| 0x2240D2 | Elektrolüfter - Spannungserfassung - Spannung unplausibel | 0 | 0x00000080 |
| 0x2240D3 | Elektrolüfter - Sicherungsrelais - Ansteuerleitung - Leistungsunterbrechung | 0 | 0x00000080 |
| 0x2240D4 | Elektrolüfter - Sicherungsrelais - Ansteuerleitung - Kurzschluss nach Plus | 0 | 0x00000080 |
| 0x2240D5 | Elektrolüfter - Sicherungsrelais - Ansteuerleitung - Kurzschluss nach Masse | 0 | 0x00000080 |
| 0x2240D6 | Elektrolüfter - Ausfall trotz Ansteuerung | 0 | 0x00000100 |
| 0x2240D7 | Elektrolüfter - Spannungsversorgung - Last unplausibel | 0 | 0x00000080 |
| 0x2240D8 | Elektrolüfter - Drehzahlregelung - Regelungsabweichung | 0 | 0x00000100 |
| 0x224100 | Kühlmittelpumpe-Hochvoltspeicher - Bauteilschutz - Degradierung wegen Übertemperatur | 0 | 0x00000080 |
| 0x224101 | Kühlmittelpumpe-Hochvoltspeicher - Bauteilschutz - Abschaltung wegen Übertemperatur | 0 | 0x00000080 |
| 0x224102 | Kühlmittelpumpe-Hochvoltspeicher - Bauteilschutz - Degradierung wegen Überstrom | 0 | 0x00000080 |
| 0x224103 | Kühlmittelpumpe-Hochvoltspeicher - Bauteilschutz - Abschaltung wegen Überstrom | 0 | 0x00000080 |
| 0x224104 | Kühlmittelpumpe-Hochvoltspeicher - Bauteilschutz - Abschaltung wegen Blockierung | 0 | 0x00000080 |
| 0x224105 | Kühlmittelpumpe-Hochvoltspeicher - Spannungsversorgung - Über-/oder Unterspannung | 0 | 0x00000080 |
| 0x224106 | Kühlmittelpumpe-Hochvoltspeicher - Interner elektrischer Fehler | 0 | 0x00000080 |
| 0x224107 | Kühlsystem-Hochvoltspeicher - Bauteilschutz - Erkennung Kühlmittelverlust | 0 | 0x00000080 |
| 0x22410A | Kühlmittelpumpe-Leistungselektronik - Bauteilschutz - Degradierung wegen Übertemperatur | 0 | 0x00000080 |
| 0x22410B | Kühlmittelpumpe-Leistungselektronik - Bauteilschutz - Abschaltung wegen Übertemperatur | 0 | 0x00000080 |
| 0x22410C | Kühlmittelpumpe-Leistungselektronik - Bauteilschutz - Degradierung wegen Überstrom | 0 | 0x00000080 |
| 0x22410D | Kühlmittelpumpe-Leistungselektronik - Bauteilschutz - Abschaltung wegen Überstrom | 0 | 0x00000080 |
| 0x22410E | Kühlmittelpumpe-Leistungselektronik - Bauteilschutz - Abschaltung wegen Blockierung | 0 | 0x00000080 |
| 0x22410F | Kühlmittelpumpe-Leistungselektronik - Spannungsversorgung - Über-/oder Unterspannung | 0 | 0x00000080 |
| 0x224110 | Kühlmittelpumpe-Leistungselektronik - Interner elektrischer Fehler | 0 | 0x00000080 |
| 0x224111 | Kühlsystem-Leistungselektronik - Bauteilschutz - Erkennung Kühlmittelverlust | 0 | 0x00000080 |
| 0x224142 | eDH_HVS - HV-Spannungssensor - Spannung über Betriebsbereich | 0 | 0x00000080 |
| 0x224143 | eDH_HVS - HV-Spannungssensor unter Betriebsbereich | 0 | 0x00000080 |
| 0x224149 | eDH_HVS - Temperaturfühler Platine Kurzschluss zu Masse / Leitung unterbrochen | 0 | 0x00000080 |
| 0x22414A | eDH_HVS - Temperaturfühler Platine Kurzschluss zu Plus | 0 | 0x00000080 |
| 0x22414B | eDH_HVS - Temperaturfühler Platine über Betriebsbereich | 0 | 0x00000100 |
| 0x22414D | eDH_HVS - Temperaturfühler Kühlmittel Kurzschluss zu Masse | 0 | 0x00000080 |
| 0x22414E | eDH_HVS - Temperaturfühler Kühlmittel Kurzschluss zu Plus / Leitung unterbrochen | 0 | 0x00000080 |
| 0x22414F | eDH_HVS - Temperaturfühler Kühlmittel über Betriebsbereich | 0 | 0x00000100 |
| 0x224162 | eDH_HVS - interner Fehler | 0 | 0x00000080 |
| 0x224163 | eDH_HVS - Niederspannungsfehler/unplausible Prozessorkommunikation | 0 | 0x00000080 |
| 0x224164 | eDH_HVS - Degradation | 0 | 0x00000080 |
| 0x224165 | eDH_HVS - Systemfehler Fahrzeugseitig | 0 | 0x00000080 |
| 0x224166 | eDH_HVS - LIN-Timeout | 0 | 0x00000080 |
| 0x224180 | Antrieb - Sicherheitsfunktion - Fahrpedalmodul - Pedalwerterfassung 1 - Kurzschluss nach Plus | 0 | 0x00000080 |
| 0x224181 | Antrieb - Sicherheitsfunktion - Fahrpedalmodul - Pedalwerterfassung 1 - Kurzschluss nach Masse | 0 | 0x00000080 |
| 0x224182 | Antrieb - Sicherheitsfunktion - Fahrpedalmodul - Pedalwerterfassung 2 - Kurzschluss nach Plus | 0 | 0x00000080 |
| 0x224183 | Antrieb - Sicherheitsfunktion - Fahrpedalmodul - Pedalwerterfassung 2 - Kurzschluss nach Masse | 0 | 0x00000080 |
| 0x224184 | Antrieb - Sicherheitsfunktion - Fahrpedalmodul - Versorgungsspannung - Pedalwerterfassung 1 - Überspannung | 0 | 0x00000080 |
| 0x224185 | Antrieb - Sicherheitsfunktion - Fahrpedalmodul - Versorgungsspannung - Pedalwerterfassung 1 - Unterspannung | 0 | 0x00000080 |
| 0x224186 | Antrieb - Sicherheitsfunktion - Fahrpedalmodul - Versorgungsspannung - Pedalwerterfassung 2 - Überspannung | 0 | 0x00000080 |
| 0x224187 | Antrieb - Sicherheitsfunktion - Fahrpedalmodul - Versorgungsspannung - Pedalwerterfassung 2 - Unterspannung | 0 | 0x00000080 |
| 0x224188 | Antrieb - Sicherheitsfunktion - Fahrpedalmodul - Pedalwerterfassung Sensor 1, Sensor 2 - Signale unplausibel | 0 | 0x00000100 |
| 0x224189 | Antrieb - Sicherheitsfunktion - Fahrpedalmodul - Pedalbetätigungserkennung - Fahrpedal und Bremse gleichzeitig aktiv | 0 | 0x00000100 |
| 0x2241C0 | Temperatursensor Kühleraustritt - Oberer Schwellenwert überschritten | 0 | 0x00000080 |
| 0x2241C1 | Temperatursensor Kühleraustritt - Unterer Schwellenwert unterschritten | 0 | 0x00000080 |
| 0x2241C4 | Temperatursensor Kühleraustritt - Gradient unplausibel | 0 | 0x00000080 |
| 0x2241C5 | Temperatursensor Kühleraustritt - Signal unplausibel | 0 | 0x00000080 |
| 0x224F40 | Absperrventil-HVS: Funktionsprüfung fehlgeschlagen | 0 | 0x00000100 |
| 0x224F41 | Kühlsystem: Kühlleistung, E-Maschine unplausibel | 0 | 0x00000100 |
| 0x224F42 | Kühlsystem: Kühlleistung Hochvoltspeicher unplausibel | 0 | 0x00000100 |
| 0x224F80 | Funktion AC-Laden eingeschränkt verfügbar | 0 | 0x00000800 |
| 0x224F81 | Funktion AC-Laden nicht verfügbar | 0 | 0x00000800 |
| 0x224F82 | Funktion DC-Laden eingeschränkt verfügbar | 0 | 0x00000800 |
| 0x224F83 | Funktion DC-Laden nicht verfügbar | 0 | 0x00000800 |
| 0x224F86 | Funktion Intelligent-Laden nicht verfügbar | 0 | 0x00000800 |
| 0x224F87 | Funktion Laden und Vorkonditionierung nicht verfügbar | 0 | 0x00000800 |
| 0x224F88 | Funktion: Fahrstufenwahl nicht verfügbar | 0 | 0x00000800 |
| 0x224F89 | Funktion: Beschleunigungsverhalten eingeschränkt verfügbar | 0 | 0x00000800 |
| 0x224F8A | Funktion: Beschleunigungsverhalten nicht verfügbar | 0 | 0x00000800 |
| 0x224F8B | Funktion: Powermode nicht verfügbar | 0 | 0x00000800 |
| 0x224F8C | Funktion: Verzögern nicht verfügbar | 0 | 0x00000800 |
| 0x224F8D | Funktion: Verzögern eingeschränkt verfügbar | 0 | 0x00000800 |
| 0x224F8E | Funktion: Fahrbereitschaft herstellen nicht verfügbar | 0 | 0x00000800 |
| 0x224F8F | Service Bedarf demnächst | 0 | 0x00000800 |
| 0x224F90 | Service Bedarf sofort | 0 | 0x00000800 |
| 0x224F91 | Funktion: Fahrbereitschaft herstellen eingeschränkt verfügbar | 0 | 0x00000800 |
| 0xBA0000 | DC/DC-Wandler, Bauteilschutz: Hochvolt Überspannung | 0 | 0x00000080 |
| 0xBA0001 | DC/DC-Wandler, Bauteilschutz: Hochvolt Unterspannung | 0 | 0x00000080 |
| 0xBA0003 | DC/DC-Wandler, Bauteilschutz: Niedervolt Überspannung | 0 | 0x00000080 |
| 0xBA0004 | DC/DC-Wandler, Bauteilschutz: Niedervolt Unterspannung | 0 | 0x00000080 |
| 0xBA0006 | Komponentenkühlung - Temperatursensor - Oberer Schwellenwert überschritten | 0 | 0x00000080 |
| 0xBA0007 | Komponentenkühlung - Temperatursensor - Unterer Schwellenwert unterschritten | 0 | 0x00000080 |
| 0xBA0008 | Komponentenkühlung - Temperatursensor - Plausibilitätsfehler | 0 | 0x00000080 |
| 0xBA0009 | Komponentenkühlung - Temperatursensor - Plausibilitätsfehler 02 | 0 | 0x00000080 |
| 0xBA000A | Montagemode aktiv - Laden | 0 | 0x00000080 |
| 0xBA000B | DC-Stromsensor Summenstrom 01 - Oberer Schwellenwert überschritten | 0 | 0x00000080 |
| 0xBA000C | DC-Stromsensor Summenstrom 01 - Unterer Schwellenwert unterschritten | 0 | 0x00000080 |
| 0xBA000D | DC-Stromsensor Summenstrom 01 - Plausibilitätsfehler | 0 | 0x00000080 |
| 0xBA0014 | Crash-Erkennung - KL30C unplausibel | 0 | 0x00000100 |
| 0xBA0017 | DC-Stromsensor Summenstrom 02 - Oberer Schwellenwert überschritten | 0 | 0x00000080 |
| 0xBA0018 | DC-Stromsensor Summenstrom 02 - Unterer Schwellenwert unterschritten | 0 | 0x00000080 |
| 0xBA0019 | Hochvolt-Leitung, E-Maschine, Leitungsschutz: zu hohe Temperatur | 0 | 0x00000100 |
| 0xBA001A | Hochvolt-Leitung, E-Maschine 2, Leitungsschutz: zu hohe Temperatur | 0 | 0x00000100 |
| 0xBA001B | Hochvolt-Leitung, DC-Ladedose, Leitungsschutz: zu hohe Temperatur | 0 | 0x00000100 |
| 0xBA001C | Hochvolt-Leitung, Ladesteuergerät, Leitungsschutz: zu hohe Temperatur | 0 | 0x00000100 |
| 0xBA0021 | Spannungsversorgung - Interne Bauteilversorgung fehlerhaft | 0 | 0x00000080 |
| 0xBA0022 | Steuergerät: interner Fehler (Sammelfehler Hardware) | 0 | 0x00000200 |
| 0xBA0023 | Steuergerät: interner Fehler (Sammelfehler Software) | 0 | 0x00000400 |
| 0xD78528 | AE-CAN-FD Control Module Bus OFF | 0 | 0x00001000 |
| 0xD78600 | Ethernet: physikalischer Fehler (link off) | 1 | 0x00001000 |
| 0xD78602 | Ethernet: Link-Qualität niedrig | 1 | 0x00001000 |
| 0xD78603 | Ethernet: Kommunikationsfehler (Link-Abbruch) durch Steuergeräte-Reset | 0 | 0x00001000 |
| 0xD78604 | Ethernet: Unerwarteter Link aufgebaut | 1 | 0x00001000 |
| 0xD78610 | Ethernet: unerwartete Link-Abbruch auf Port 0 | 1 | 0x00001000 |
| 0xD78618 | ETHERNET_COMMUNICATION_FAILURE | 1 | 0x00001000 |
| 0xD78700 | Zeitbasis unsynchronisiert | 1 | 0x00001000 |
| 0xD78BFF | Dummy-Fehlerspeichereintrag im Netzwerkfehlerbereich nur für Testzwecke | 1 | 0x00000010 |
| 0xD79408 | Botschaft (Anforderung Drehzahl Vorderachse, ID: RQ_RPM_FTAX) fehlt | 1 | 0x00004000 |
| 0xD79410 | Botschaft (Anforderung Klima Hybrid, ID: RQ_AIC_HYB) fehlt | 1 | 0x00004000 |
| 0xD79414 | Botschaft (Anforderung Klimaanlage, ID: RQ_AIC) fehlt | 1 | 0x00004000 |
| 0xD79418 | Botschaft (Anforderung Kraftschluss Funktion Segeln, ID: RQ_PENG_FN_SAIL) fehlt | 1 | 0x00004000 |
| 0xD79420 | Botschaft (Anforderung Radmoment Antriebsstrang Summe Rekuperation, ID: RQ_WMOM_PT_SUM_RECUP) fehlt | 1 | 0x00004000 |
| 0xD79421 | Botschaft (Anforderung Radmoment Antriebsstrang Summe Rekuperation, ID: RQ_WMOM_PT_SUM_RECUP) nicht aktuell | 1 | 0x00010000 |
| 0xD79422 | Botschaft (Anforderung Radmoment Antriebsstrang Summe Rekuperation, ID: RQ_WMOM_PT_SUM_RECUP) Prüfsumme falsch | 1 | 0x00010000 |
| 0xD79424 | Botschaft (Anforderung Radmoment Antriebsstrang Summe Soll Begrenzung FAS, ID: RQ_WMOM_PT_SUM_TAR_LIM_DRS) fehlt | 1 | 0x00004000 |
| 0xD79425 | Botschaft (Anforderung Radmoment Antriebsstrang Summe Soll Begrenzung FAS, ID: RQ_WMOM_PT_SUM_TAR_LIM_DRS) nicht aktuell | 1 | 0x00010000 |
| 0xD79426 | Botschaft (Anforderung Radmoment Antriebsstrang Summe Soll Begrenzung FAS, ID: RQ_WMOM_PT_SUM_TAR_LIM_DRS) Prüfsumme falsch | 1 | 0x00010000 |
| 0xD7942C | Botschaft (Anfrage Leistung Funktionen Klima 1, ID: INQY_PWR_FNS_AIC_1) fehlt | 1 | 0x00004000 |
| 0xD79430 | Botschaft (Anfrage Leistung Funktionen Klima 2, ID: INQY_PWR_FNS_AIC_2) fehlt | 1 | 0x00004000 |
| 0xD79434 | Botschaft (Außentemperatur, ID: A_TEMP) fehlt | 1 | 0x00004000 |
| 0xD7943C | Botschaft (Bedienung Konfiguration SOC Hold, ID: OP_SU_SOC_HLD) fehlt | 1 | 0x00004000 |
| 0xD79460 | Botschaft (Daten Hydraulikmodell Bremskraftmodell Unterdrucksensor, ID: DT_HYDM_BRKM_LPS) fehlt | 1 | 0x00004000 |
| 0xD79468 | Botschaft (Daten Vorderfahrzeug, ID: DT_FRVEH) fehlt | 1 | 0x00004000 |
| 0xD7946C | Botschaft (Daten elektrischer Durchlauferhitzer, ID: DT_EL_GEY) fehlt | 1 | 0x00004000 |
| 0xD79478 | Botschaft (Einheiten BN2020, ID: EINHEITEN_BN2020) fehlt | 1 | 0x00004000 |
| 0xD7948C | Botschaft (Fahrerlebnis Modus, ID: DXP_MOD) fehlt | 1 | 0x00004000 |
| 0xD79490 | Botschaft (Fahrgestellnummer, ID: FAHRGESTELLNUMMER) fehlt | 1 | 0x00004000 |
| 0xD79498 | Botschaft (Fahrzeugzustand, ID: FZZSTD) fehlt | 1 | 0x00004000 |
| 0xD7949C | Botschaft (Fehler_Status_eDH_HVS_LIN, ID: ERR_ST_eDH_HVS_LIN) fehlt | 1 | 0x00004000 |
| 0xD794A0 | Botschaft (Freigabe Kühlung Hochvoltspeicher, ID: RLS_COOL_HVSTO) fehlt | 1 | 0x00004000 |
| 0xD794A4 | Botschaft (Frontraumüberwachung FCM, ID: HDWOBS_FCM) fehlt | 1 | 0x00004000 |
| 0xD794A8 | Botschaft (GPS Rohdaten, ID: GPS_RWDT) fehlt | 1 | 0x00004000 |
| 0xD794AC | Botschaft (Geschwindigkeit Fahrzeug 2, ID: V_VEH_2) fehlt | 1 | 0x00004000 |
| 0xD794AD | Botschaft (Geschwindigkeit Fahrzeug 2, ID: V_VEH_2) nicht aktuell | 1 | 0x00010000 |
| 0xD794AE | Botschaft (Geschwindigkeit Fahrzeug 2, ID: V_VEH_2) Prüfsumme falsch | 1 | 0x00010000 |
| 0xD794B0 | Botschaft (Geschwindigkeit Fahrzeug, ID: V_VEH) fehlt | 1 | 0x00004000 |
| 0xD794B1 | Botschaft (Geschwindigkeit Fahrzeug, ID: V_VEH) nicht aktuell | 1 | 0x00010000 |
| 0xD794B2 | Botschaft (Geschwindigkeit Fahrzeug, ID: V_VEH) Prüfsumme falsch | 1 | 0x00010000 |
| 0xD794C0 | Botschaft (HighVoltageStorage100msNo1, ID: HighVoltageStorage100msNo1) fehlt | 1 | 0x00004000 |
| 0xD794C4 | Botschaft (HighVoltageStorage10msNo1, ID: HighVoltageStorage10msNo1) fehlt | 1 | 0x00004000 |
| 0xD794C8 | Botschaft (HighVoltageStorage10msNo2, ID: HighVoltageStorage10msNo2) fehlt | 1 | 0x00004000 |
| 0xD794C9 | Botschaft (HighVoltageStorage10msNo2, ID: HighVoltageStorage10msNo2) nicht aktuell | 1 | 0x00010000 |
| 0xD794CA | Botschaft (HighVoltageStorage10msNo2, ID: HighVoltageStorage10msNo2) Prüfsumme falsch | 1 | 0x00010000 |
| 0xD794CC | Botschaft (HighVoltageStorage200msNo1, ID: HighVoltageStorage200msNo1) fehlt | 1 | 0x00004000 |
| 0xD794CD | Botschaft (HighVoltageStorage200msNo1, ID: HighVoltageStorage200msNo1) nicht aktuell | 1 | 0x00010000 |
| 0xD794CE | Botschaft (HighVoltageStorage200msNo1, ID: HighVoltageStorage200msNo1) Prüfsumme falsch | 1 | 0x00010000 |
| 0xD794D0 | Botschaft (HighVoltageStorage200msNo2, ID: HighVoltageStorage200msNo2) fehlt | 1 | 0x00004000 |
| 0xD794E0 | Botschaft (Information Fahrzeug Antrieb, ID: INFO_VEH_DRV) fehlt | 1 | 0x00004000 |
| 0xD794E1 | Botschaft (Information Fahrzeug Antrieb, ID: INFO_VEH_DRV) nicht aktuell | 1 | 0x00010000 |
| 0xD794E2 | Botschaft (Information Fahrzeug Antrieb, ID: INFO_VEH_DRV) Prüfsumme falsch | 1 | 0x00010000 |
| 0xD794E4 | Botschaft (Information Spannung Zelle Hochvoltspeicher 10, ID: INFO_U_CELL_HVSTO_10) fehlt | 1 | 0x00004000 |
| 0xD794E8 | Botschaft (Information Spannung Zelle Hochvoltspeicher 11, ID: INFO_U_CELL_HVSTO_11) fehlt | 1 | 0x00004000 |
| 0xD794EC | Botschaft (Information Spannung Zelle Hochvoltspeicher 12, ID: INFO_U_CELL_HVSTO_12) fehlt | 1 | 0x00004000 |
| 0xD794F0 | Botschaft (Information Spannung Zelle Hochvoltspeicher 13, ID: INFO_U_CELL_HVSTO_13) fehlt | 1 | 0x00004000 |
| 0xD794F4 | Botschaft (Information Spannung Zelle Hochvoltspeicher 14, ID: INFO_U_CELL_HVSTO_14) fehlt | 1 | 0x00004000 |
| 0xD794F8 | Botschaft (Information Spannung Zelle Hochvoltspeicher 15, ID: INFO_U_CELL_HVSTO_15) fehlt | 1 | 0x00004000 |
| 0xD794FC | Botschaft (Information Spannung Zelle Hochvoltspeicher 16, ID: INFO_U_CELL_HVSTO_16) fehlt | 1 | 0x00004000 |
| 0xD79500 | Botschaft (Information Spannung Zelle Hochvoltspeicher 17, ID: INFO_U_CELL_HVSTO_17) fehlt | 1 | 0x00004000 |
| 0xD79504 | Botschaft (Information Spannung Zelle Hochvoltspeicher 18, ID: INFO_U_CELL_HVSTO_18) fehlt | 1 | 0x00004000 |
| 0xD79508 | Botschaft (Information Spannung Zelle Hochvoltspeicher 19, ID: INFO_U_CELL_HVSTO_19) fehlt | 1 | 0x00004000 |
| 0xD7950C | Botschaft (Information Spannung Zelle Hochvoltspeicher 1, ID: INFO_U_CELL_HVSTO_1) fehlt | 1 | 0x00004000 |
| 0xD79510 | Botschaft (Information Spannung Zelle Hochvoltspeicher 20, ID: INFO_U_CELL_HVSTO_20) fehlt | 1 | 0x00004000 |
| 0xD79514 | Botschaft (Information Spannung Zelle Hochvoltspeicher 21, ID: INFO_U_CELL_HVSTO_21) fehlt | 1 | 0x00004000 |
| 0xD79518 | Botschaft (Information Spannung Zelle Hochvoltspeicher 22, ID: INFO_U_CELL_HVSTO_22) fehlt | 1 | 0x00004000 |
| 0xD7951C | Botschaft (Information Spannung Zelle Hochvoltspeicher 23, ID: INFO_U_CELL_HVSTO_23) fehlt | 1 | 0x00004000 |
| 0xD79520 | Botschaft (Information Spannung Zelle Hochvoltspeicher 24, ID: INFO_U_CELL_HVSTO_24) fehlt | 1 | 0x00004000 |
| 0xD79524 | Botschaft (Information Spannung Zelle Hochvoltspeicher 25, ID: INFO_U_CELL_HVSTO_25) fehlt | 1 | 0x00004000 |
| 0xD79528 | Botschaft (Information Spannung Zelle Hochvoltspeicher 26, ID: INFO_U_CELL_HVSTO_26) fehlt | 1 | 0x00004000 |
| 0xD7952C | Botschaft (Information Spannung Zelle Hochvoltspeicher 27, ID: INFO_U_CELL_HVSTO_27) fehlt | 1 | 0x00004000 |
| 0xD79530 | Botschaft (Information Spannung Zelle Hochvoltspeicher 2, ID: INFO_U_CELL_HVSTO_2) fehlt | 1 | 0x00004000 |
| 0xD79534 | Botschaft (Information Spannung Zelle Hochvoltspeicher 3, ID: INFO_U_CELL_HVSTO_3) fehlt | 1 | 0x00004000 |
| 0xD79538 | Botschaft (Information Spannung Zelle Hochvoltspeicher 4, ID: INFO_U_CELL_HVSTO_4) fehlt | 1 | 0x00004000 |
| 0xD7953C | Botschaft (Information Spannung Zelle Hochvoltspeicher 5, ID: INFO_U_CELL_HVSTO_5) fehlt | 1 | 0x00004000 |
| 0xD79540 | Botschaft (Information Spannung Zelle Hochvoltspeicher 6, ID: INFO_U_CELL_HVSTO_6) fehlt | 1 | 0x00004000 |
| 0xD79544 | Botschaft (Information Spannung Zelle Hochvoltspeicher 7, ID: INFO_U_CELL_HVSTO_7) fehlt | 1 | 0x00004000 |
| 0xD79548 | Botschaft (Information Spannung Zelle Hochvoltspeicher 8, ID: INFO_U_CELL_HVSTO_8) fehlt | 1 | 0x00004000 |
| 0xD7954C | Botschaft (Information Spannung Zelle Hochvoltspeicher 9, ID: INFO_U_CELL_HVSTO_9) fehlt | 1 | 0x00004000 |
| 0xD79550 | Botschaft (Ist Bremsmoment Summe, ID: AVL_BRTORQ_SUM) fehlt | 1 | 0x00004000 |
| 0xD79551 | Botschaft (Ist Bremsmoment Summe, ID: AVL_BRTORQ_SUM) nicht aktuell | 1 | 0x00010000 |
| 0xD79552 | Botschaft (Ist Bremsmoment Summe, ID: AVL_BRTORQ_SUM) Prüfsumme falsch | 1 | 0x00010000 |
| 0xD79554 | Botschaft (Ist Lenkwinkel Vorderachse, ID: AVL_STEA_FTAX) fehlt | 1 | 0x00004000 |
| 0xD79555 | Botschaft (Ist Lenkwinkel Vorderachse, ID: AVL_STEA_FTAX) nicht aktuell | 1 | 0x00010000 |
| 0xD79556 | Botschaft (Ist Lenkwinkel Vorderachse, ID: AVL_STEA_FTAX) Prüfsumme falsch | 1 | 0x00010000 |
| 0xD79560 | Botschaft (Konfiguration SCharge KEY, ID: SU_SCHRG_KEY) fehlt | 1 | 0x00004000 |
| 0xD79568 | Botschaft (Konfiguration Stellhebel Fahrdynamik Fahrerlebnis, ID: SU_CLE_DRDY_DXP) fehlt | 1 | 0x00004000 |
| 0xD79570 | Botschaft (Laden Parameter, ID: CHGNG_PRMTR) fehlt | 1 | 0x00004000 |
| 0xD79578 | Botschaft (Längsbeschleunigung Schwerpunkt, ID: ACLNX_MASSCNTR) fehlt | 1 | 0x00004000 |
| 0xD79579 | Botschaft (Längsbeschleunigung Schwerpunkt, ID: ACLNX_MASSCNTR) nicht aktuell | 1 | 0x00010000 |
| 0xD7957A | Botschaft (Längsbeschleunigung Schwerpunkt, ID: ACLNX_MASSCNTR) Prüfsumme falsch | 1 | 0x00010000 |
| 0xD79580 | Botschaft (Nachlaufzeit Stromversorgung BN2020, ID: FLLUPT_GPWSUP ) fehlt | 1 | 0x00004000 |
| 0xD79584 | Botschaft (Nav-Graph 2 Aktuelle Segment, ID: NAVGRPH_2_PRES_SEG) fehlt | 1 | 0x00004000 |
| 0xD79598 | Botschaft (Nav-Graph 2 Route Beschreibung, ID: NAVGRPH_2_RT_DESCR) fehlt | 1 | 0x00004000 |
| 0xD795A8 | Botschaft (Navigation System Information, ID: NAV_SYS_INF) fehlt | 1 | 0x00004000 |
| 0xD795BC | Botschaft (Neigung Fahrbahn, ID: TLT_RW) fehlt | 1 | 0x00004000 |
| 0xD795BD | Botschaft (Neigung Fahrbahn, ID: TLT_RW) nicht aktuell | 1 | 0x00010000 |
| 0xD795BE | Botschaft (Neigung Fahrbahn, ID: TLT_RW) Prüfsumme falsch | 1 | 0x00010000 |
| 0xD795C4 | Botschaft (PIA Daten Anfrage, ID: PIA_DT_INQY) fehlt | 1 | 0x00004000 |
| 0xD795C8 | Botschaft (PIA Daten Setzen, ID: PIA_DT_SET) fehlt | 1 | 0x00004000 |
| 0xD795CC | Botschaft (PIA Konfiguration, ID: PIA_SU) fehlt | 1 | 0x00004000 |
| 0xD795D0 | Botschaft (PIA Transaktion, ID: PIA_TRANA) fehlt | 1 | 0x00004000 |
| 0xD795D4 | Botschaft (PIA_Dienst, ID: PIA_SVC) fehlt | 1 | 0x00004000 |
| 0xD795DC | Botschaft (Powermanagement Niederspannung, ID: PWMG_LV) fehlt | 1 | 0x00004000 |
| 0xD795E0 | Botschaft (Prognose Fahrt Information, ID: FRC_RD_INFO) fehlt | 1 | 0x00004000 |
| 0xD795E4 | Botschaft (Querbeschleunigung Schwerpunkt, ID: ACLNY_MASSCNTR) fehlt | 1 | 0x00004000 |
| 0xD795E5 | Botschaft (Querbeschleunigung Schwerpunkt, ID: ACLNY_MASSCNTR) nicht aktuell | 1 | 0x00010000 |
| 0xD795E6 | Botschaft (Querbeschleunigung Schwerpunkt, ID: ACLNY_MASSCNTR) Prüfsumme falsch | 1 | 0x00010000 |
| 0xD795F4 | Botschaft (Regensensor-Wischergeschwindigkeit, ID: WISCHGESCHWINDIGKEIT) fehlt | 1 | 0x00004000 |
| 0xD795F8 | Botschaft (Relativzeit BN2020, ID: RELATIVZEIT) fehlt | 1 | 0x00004000 |
| 0xD795FC | Botschaft (Sicher Fahrgestellnummer, ID: SECU_FAHRGESTELLNUMMER) fehlt | 1 | 0x00004000 |
| 0xD79600 | Botschaft (Sicher Response, ID: SECU_RESP) fehlt | 1 | 0x00004000 |
| 0xD79604 | Botschaft (SlaveResp, ID: SlaveResp) fehlt | 1 | 0x00004000 |
| 0xD79608 | Botschaft (Soll Anzeige Vibration Warnung Fahrspurwechsel, ID: TAR_DISP_VIB_WARN_LNCH) fehlt | 1 | 0x00004000 |
| 0xD7960C | Botschaft (Soll Radmoment Antriebsstrang Stabilisierung, ID: TAR_WMOM_PT_STAB) fehlt | 1 | 0x00004000 |
| 0xD7960D | Botschaft (Soll Radmoment Antriebsstrang Stabilisierung, ID: TAR_WMOM_PT_STAB) nicht aktuell | 1 | 0x00010000 |
| 0xD7960E | Botschaft (Soll Radmoment Antriebsstrang Stabilisierung, ID: TAR_WMOM_PT_STAB) Prüfsumme falsch | 1 | 0x00010000 |
| 0xD79614 | Botschaft (Status Anhänger, ID: STAT_ANHAENGER) fehlt | 1 | 0x00004000 |
| 0xD79618 | Botschaft (Status Crash, ID: ST_CR) fehlt | 1 | 0x00004000 |
| 0xD79619 | Botschaft (Status Crash, ID: ST_CR) nicht aktuell | 1 | 0x00010000 |
| 0xD7961A | Botschaft (Status Crash, ID: ST_CR) Prüfsumme falsch | 1 | 0x00010000 |
| 0xD79620 | Botschaft (Status Funkschlüssel, ID: STAT_FUNKSCHLUESSEL) fehlt | 1 | 0x00004000 |
| 0xD79624 | Botschaft (Status Gang Rückwärts, ID: STAT_GANG_RUECKWAERTS) fehlt | 1 | 0x00004000 |
| 0xD79628 | Botschaft (Status Gangwahlschalter, ID: ST_GWS) fehlt | 1 | 0x00004000 |
| 0xD79629 | Botschaft (Status Gangwahlschalter, ID: ST_GWS) nicht aktuell | 1 | 0x00010000 |
| 0xD7962A | Botschaft (Status Gangwahlschalter, ID: ST_GWS) Prüfsumme falsch | 1 | 0x00010000 |
| 0xD7962C | Botschaft (Status Gurt Kontakt Sitzbelegung, ID: ST_BLT_CT_SOCCU) fehlt | 1 | 0x00004000 |
| 0xD7962D | Botschaft (Status Gurt Kontakt Sitzbelegung, ID: ST_BLT_CT_SOCCU) nicht aktuell | 1 | 0x00010000 |
| 0xD7962E | Botschaft (Status Gurt Kontakt Sitzbelegung, ID: ST_BLT_CT_SOCCU) Prüfsumme falsch | 1 | 0x00010000 |
| 0xD79630 | Botschaft (Status Hochvoltspeicher 1, ID: ST_HVSTO_1) fehlt | 1 | 0x00004000 |
| 0xD79638 | Botschaft (Status Klima Luftverteilung FA, ID: STAT_KLIMA_LUFT_FA) fehlt | 1 | 0x00004000 |
| 0xD7963C | Botschaft (Status RCP, ID: ST_RCP) fehlt | 1 | 0x00004000 |
| 0xD7963D | Botschaft (Status RCP, ID: ST_RCP) nicht aktuell | 1 | 0x00010000 |
| 0xD7963E | Botschaft (Status RCP, ID: ST_RCP) Prüfsumme falsch | 1 | 0x00010000 |
| 0xD79640 | Botschaft (Status Reibwert Fahrdynamik, ID: ST_MUE_DRDY) fehlt | 1 | 0x00004000 |
| 0xD79641 | Botschaft (Status Reibwert Fahrdynamik, ID: ST_MUE_DRDY) nicht aktuell | 1 | 0x00010000 |
| 0xD79642 | Botschaft (Status Reibwert Fahrdynamik, ID: ST_MUE_DRDY) Prüfsumme falsch | 1 | 0x00010000 |
| 0xD79644 | Botschaft (Status Stabilisierung DSC 2, ID: ST_STAB_DSC_2) fehlt | 1 | 0x00004000 |
| 0xD79648 | Botschaft (Status Stabilisierung DSC, ID: ST_STAB_DSC) fehlt | 1 | 0x00004000 |
| 0xD79649 | Botschaft (Status Stabilisierung DSC: ID: ST_STAB_DSC) nicht aktuell | 1 | 0x00010000 |
| 0xD7964A | Botschaft (Status Stabilisierung DSC, ID: ST_STAB_DSC) Prüfsumme falsch | 1 | 0x00010000 |
| 0xD7964C | Botschaft (Status Stillstandsfunktionen DSC, ID: ST_SSFN_DSC) fehlt | 1 | 0x00004000 |
| 0xD7964D | Botschaft (Status Stillstandsfunktionen DSC, ID: ST_SSFN_DSC) nicht aktuell | 1 | 0x00010000 |
| 0xD7964E | Botschaft (Status Stillstandsfunktionen DSC, ID: ST_SSFN_DSC) Prüfsumme falsch | 1 | 0x00010000 |
| 0xD79654 | Botschaft (Status Türsensoren Abgesichert, ID: STAT_DS_VRFD) fehlt | 1 | 0x00004000 |
| 0xD79655 | Botschaft (Status Türsensoren Abgesichert, ID: STAT_DS_VRFD) nicht aktuell | 1 | 0x00010000 |
| 0xD79656 | Botschaft (Status Türsensoren Abgesichert, ID: STAT_DS_VRFD) Prüfsumme falsch | 1 | 0x00010000 |
| 0xD79658 | Botschaft (Status Ventil Hochvoltbatterie-Kühlung, ID: ST_VA_HVBTC) fehlt | 1 | 0x00004000 |
| 0xD7965C | Botschaft (StatusHighVoltageStorageIsolationMeasure, ID: StatusHighVoltageStorageIsolationMeasure) fehlt | 1 | 0x00004000 |
| 0xD7965D | Botschaft (StatusHighVoltageStorageIsolationMeasure, ID: StatusHighVoltageStorageIsolationMeasure) nicht aktuell | 1 | 0x00010000 |
| 0xD7965E | Botschaft (StatusHighVoltageStorageIsolationMeasure, ID: StatusHighVoltageStorageIsolationMeasure) Prüfsumme falsch | 1 | 0x00010000 |
| 0xD79660 | Botschaft (Status_AKKS_2_LIN, ID: ST_AKKS_2_LIN) fehlt | 1 | 0x00004000 |
| 0xD79664 | Botschaft (Status_AKKS_LIN, ID: ST_AKKS_LIN) fehlt | 1 | 0x00004000 |
| 0xD79668 | Botschaft (Status_Diagnose_OBD_16_Antriebsstrang_LIN_AKKS, ID: ST_DIAG_OBD_16_PT_LIN_AKKS) fehlt | 1 | 0x00004000 |
| 0xD7966C | Botschaft (Status_Diagnose_OBD_1_Antriebsstrang_eDH_HVS_LIN, ID: ST_DIAG_OBD_1_PT_eDH_HVS_LIN) fehlt | 1 | 0x00004000 |
| 0xD79670 | Botschaft (Status_Diagnose_OBD_20_Antriebsstrang_LIN_AKKS_2, ID: ST_DIAG_OBD_20_PT_LIN_AKKS_2) fehlt | 1 | 0x00004000 |
| 0xD79674 | Botschaft (Status_Diagnose_System_eDH_HVS_LIN, ID: ST_DIAG_SYS_eDH_HVS_LIN) fehlt | 1 | 0x00004000 |
| 0xD79678 | Botschaft (Status_EWP22_LIN, ID: ST_EWP22_LIN) fehlt | 1 | 0x00004000 |
| 0xD7967C | Botschaft (Status_EWP23_LIN, ID: ST_EWP23_LIN) fehlt | 1 | 0x00004000 |
| 0xD79680 | Botschaft (Status_Lüfter_1_LIN, ID: ST_FAN_1_LIN) fehlt | 1 | 0x00004000 |
| 0xD79684 | Botschaft (Status_eDH_HVS_LIN, ID: ST_eDH_HVS_LIN) fehlt | 1 | 0x00004000 |
| 0xD7968C | Botschaft (Steuerung Funktion Hospitality, ID: CTR_FN_HOSP) fehlt | 1 | 0x00004000 |
| 0xD79690 | Botschaft (Steuerung Ladeschnittstelle CSM, ID: CTR_CHGINTF_CSM) fehlt | 1 | 0x00004000 |
| 0xD79694 | Botschaft (Steuerung Zentralverriegelung, ID: CTR_ZV) fehlt | 1 | 0x00004000 |
| 0xD7969C | Botschaft (Tankinhalt/Reichweite, ID: TAC_RNG) fehlt | 1 | 0x00004000 |
| 0xD796A0 | Botschaft (Teleservice Call Status, ID: TS_CALL_ST) fehlt | 1 | 0x00004000 |
| 0xD796A4 | Botschaft (Temperatursensor Hochvoltspeicher 10, ID: TEMPSEN_HVSTO_10) fehlt | 1 | 0x00004000 |
| 0xD796A8 | Botschaft (Temperatursensor Hochvoltspeicher 11, ID: TEMPSEN_HVSTO_11) fehlt | 1 | 0x00004000 |
| 0xD796AC | Botschaft (Temperatursensor Hochvoltspeicher 12, ID: TEMPSEN_HVSTO_12) fehlt | 1 | 0x00004000 |
| 0xD796B0 | Botschaft (Temperatursensor Hochvoltspeicher 1, ID: TEMPSEN_HVSTO_1) fehlt | 1 | 0x00004000 |
| 0xD796B4 | Botschaft (Temperatursensor Hochvoltspeicher 2, ID: TEMPSEN_HVSTO_2) fehlt | 1 | 0x00004000 |
| 0xD796B8 | Botschaft (Temperatursensor Hochvoltspeicher 3, ID: TEMPSEN_HVSTO_3) fehlt | 1 | 0x00004000 |
| 0xD796BC | Botschaft (Temperatursensor Hochvoltspeicher 4, ID: TEMPSEN_HVSTO_4) fehlt | 1 | 0x00004000 |
| 0xD796C0 | Botschaft (Temperatursensor Hochvoltspeicher 5, ID: TEMPSEN_HVSTO_5) fehlt | 1 | 0x00004000 |
| 0xD796C4 | Botschaft (Temperatursensor Hochvoltspeicher 6, ID: TEMPSEN_HVSTO_6) fehlt | 1 | 0x00004000 |
| 0xD796C8 | Botschaft (Temperatursensor Hochvoltspeicher 7, ID: TEMPSEN_HVSTO_7) fehlt | 1 | 0x00004000 |
| 0xD796CC | Botschaft (Temperatursensor Hochvoltspeicher 8, ID: TEMPSEN_HVSTO_8) fehlt | 1 | 0x00004000 |
| 0xD796D0 | Botschaft (Temperatursensor Hochvoltspeicher 9, ID: TEMPSEN_HVSTO_9) fehlt | 1 | 0x00004000 |
| 0xD796D4 | Botschaft (TractionEMachineElectronic1Time100msNo1, ID: TractionEMachineElectronic1Time100msNo1) fehlt | 1 | 0x00004000 |
| 0xD796D8 | Botschaft (TractionEMachineElectronic1Time10msNo1, ID: TractionEMachineElectronic1Time10msNo1) fehlt | 1 | 0x00004000 |
| 0xD796D9 | Botschaft (TractionEMachineElectronic1Time10msNo1, ID: TractionEMachineElectronic1Time10msNo1) nicht aktuell | 1 | 0x00010000 |
| 0xD796DA | Botschaft (TractionEMachineElectronic1Time10msNo1,, ID: TractionEMachineElectronic1Time10msNo1) Prüfsumme falsch | 1 | 0x00010000 |
| 0xD796DC | Botschaft (TractionEMachineElectronic1Time10msNo2, ID: TractionEMachineElectronic1Time10msNo2) fehlt | 1 | 0x00004000 |
| 0xD796E0 | Botschaft (TractionEMachineElectronic2Time100msNo1, ID: TractionEMachineElectronic2Time100msNo1) fehlt | 1 | 0x00004000 |
| 0xD796E4 | Botschaft (TractionEMachineElectronic2Time10msNo, ID: TractionEMachineElectronic2Time10msNo1) fehlt | 1 | 0x00004000 |
| 0xD796E5 | Botschaft (TractionEMachineElectronic2Time10msNo1, ID: TractionEMachineElectronic2Time10msNo1) nicht aktuell | 1 | 0x00010000 |
| 0xD796E6 | Botschaft (TractionEMachineElectronic2Time10msNo1, ID: TractionEMachineElectronic2Time10msNo1) Prüfsumme falsch | 1 | 0x00010000 |
| 0xD796E8 | Botschaft (TractionEMachineElectronic2Time10msNo2, ID: TractionEMachineElectronic2Time10msNo2) fehlt | 1 | 0x00004000 |
| 0xD796EC | Botschaft (Uhrzeit/Datum, ID: UHRZEIT_DATUM) fehlt | 1 | 0x00004000 |
| 0xD796F0 | Botschaft (Verbraucherstatus, ID: ST_COS) fehlt | 1 | 0x00004000 |
| 0xD796F8 | Botschaft (Vorgabe Adaption Modus Fahrerlebnis, ID: SPEC_ADPT_MOD_DXP) fehlt | 1 | 0x00004000 |
| 0xD796FC | Botschaft (WirelessChargingUnit100msNo1, ID: WirelessChargingUnit100msNo1) fehlt | 1 | 0x00004000 |
| 0xD79700 | Botschaft (WirelessChargingUnit500msNo1, ID: WirelessChargingUnit500msNo1) fehlt | 1 | 0x00004000 |
| 0xD79704 | Botschaft (WirelessChargingUnit50msNo1, ID: WirelessChargingUnit50msNo1) fehlt | 1 | 0x00004000 |
| 0xD7970C | Botschaft (ZV und Klappenzustand, ID: STAT_ZV_KLAPPEN) fehlt | 1 | 0x00004000 |
| 0xD79710 | Botschaft (Zieladresse Nav-Graph_2, ID: DEST_ADRESS_NAVGRPH_2) fehlt | 1 | 0x00004000 |
| 0xD79714 | Botschaft (Zustand Fahrzeug, ID: CON_VEH) fehlt | 1 | 0x00004000 |
| 0xD79715 | Botschaft (Zustand Fahrzeug, ID: CON_VEH) nicht aktuell | 1 | 0x00010000 |
| 0xD79716 | Botschaft (Zustand Fahrzeug, ID: CON_VEH) Prüfsumme falsch | 1 | 0x00010000 |
| 0xD79724 | Botschaft (Ist Drehzahl Rad, ID: AVL_RPM_WHL) fehlt | 1 | 0x00004000 |
| 0xD79725 | Botschaft (Ist Drehzahl Rad, ID: AVL_RPM_WHL) nicht aktuell | 1 | 0x00010000 |
| 0xD79726 | Botschaft (Ist Drehzahl Rad, ID: AVL_RPM_WHL) Prüfsumme falsch | 1 | 0x00010000 |
| 0xD7973C | Botschaft (Bedienung Laden Strom Begrenzung 2, ID: OP_ST_CHGNG_I_LIM_2) fehlt | 1 | 0x00004000 |
| 0xD7973F | Botschaft (Bedienung Timer, ID: OP_TIMER) fehlt | 1 | 0x00004000 |
| 0xD79745 | Botschaft (EAPC Diagnose Response LD_AC_CCS, ID: EAPC_DIAG_RESP_LD_AC_CCS) fehlt | 1 | 0x00004000 |
| 0xD79748 | Botschaft (EAPC Diagnose Response LD_DC, ID: EAPC_DIAG_RESP_LD_DC) fehlt | 1 | 0x00004000 |
| 0xD7974B | Botschaft (EAPC Weckbotschaft LD_AC_CCS, ID: EAPC_WUPM_LD_AC_CCS) fehlt | 1 | 0x00004000 |
| 0xD7974E | Botschaft (EAPC Weckbotschaft LD_DC, ID: EAPC_WUPM_LD_DC) fehlt | 1 | 0x00004000 |
| 0xD79751 | Botschaft (EAPC_ Temperatur DC, ID: EAPC_Temperatur_DC) fehlt | 1 | 0x00004000 |
| 0xD79752 | Botschaft (EAPC_ Temperatur DC, ID: EAPC_Temperatur_DC) nicht aktuell | 1 | 0x00010000 |
| 0xD79753 | Botschaft (EAPC_ Temperatur DC, ID: EAPC_Temperatur_DC) Prüfsumme falsch | 1 | 0x00010000 |
| 0xD79754 | Botschaft (EAPC_CHDM_H108, ID: EAPC_CHDM_H108) fehlt | 1 | 0x00004000 |
| 0xD79757 | Botschaft (EAPC_CHDM_H109, ID: EAPC_CHDM_H109) fehlt | 1 | 0x00004000 |
| 0xD7975A | Botschaft (EAPC_CHDM_H118, ID: EAPC_CHDM_H118) fehlt | 1 | 0x00004000 |
| 0xD7975D | Botschaft (EAPC_Status_Ladeklappe_AC_CCS, ID: EAPC_Status_Ladeklappe_AC_CCS) fehlt | 1 | 0x00004000 |
| 0xD7975E | Botschaft (EAPC_Status_Ladeklappe_AC_CCS, ID: EAPC_Status_Ladeklappe_AC_CCS) nicht aktuell | 1 | 0x00010000 |
| 0xD7975F | Botschaft (EAPC_Status_Ladeklappe_AC_CCS, ID: EAPC_Status_Ladeklappe_AC_CCS) Prüfsumme falsch | 1 | 0x00010000 |
| 0xD79760 | Botschaft (EAPC_Status_Ladeklappe_DC, ID: EAPC_Status_Ladeklappe_DC) fehlt | 1 | 0x00004000 |
| 0xD79761 | Botschaft (EAPC_Status_Ladeklappe_DC, ID: EAPC_Status_Ladeklappe_DC) nicht aktuell | 1 | 0x00010000 |
| 0xD79762 | Botschaft (EAPC_Status_Ladeklappe_DC, ID: EAPC_Status_Ladeklappe_DC) Prüfsumme falsch | 1 | 0x00010000 |
| 0xD79763 | Botschaft (EAPC_Status_Ladestatusanzeige_AC_CCS, ID: EAPC_Status_Ladestatusanzeige_AC_CCS) fehlt | 1 | 0x00004000 |
| 0xD79766 | Botschaft (EAPC_Status_Ladestatusanzeige_DC, ID: EAPC_Status_Ladestatusanzeige_DC) fehlt | 1 | 0x00004000 |
| 0xD79769 | Botschaft (EAPC_Status_Ladesteckerverriegelung_AC_CCS, ID: EAPC_Status_Ladesteckerverriegelung_AC_CCS) fehlt | 1 | 0x00004000 |
| 0xD7976A | Botschaft (EAPC_Status_Ladesteckerverriegelung_AC_CCS, ID: EAPC_Status_Ladesteckerverriegelung_AC_CCS) nicht aktuell | 1 | 0x00010000 |
| 0xD7976B | Botschaft (EAPC_Status_Ladesteckerverriegelung_AC_CCS, ID: EAPC_Status_Ladesteckerverriegelung_AC_CCS) Prüfsumme falsch | 1 | 0x00010000 |
| 0xD7976C | Botschaft (EAPC_Temperatur AC, ID: EAPC_Temperatur_AC) fehlt | 1 | 0x00004000 |
| 0xD7976D | Botschaft (EAPC_Temperatur AC, ID: EAPC_Temperatur_AC) nicht aktuell | 1 | 0x00010000 |
| 0xD7976E | Botschaft (EAPC_Temperatur AC, ID: EAPC_Temperatur_AC) Prüfsumme falsch | 1 | 0x00010000 |
| 0xD7976F | Botschaft (EAPC_Temperatur DC_CCS, ID: EAPC_Temperatur_DC_CCS) fehlt | 1 | 0x00004000 |
| 0xD79770 | Botschaft (EAPC_Temperatur DC_CCS, ID: EAPC_Temperatur_DC_CCS) nicht aktuell | 1 | 0x00010000 |
| 0xD79771 | Botschaft (EAPC_Temperatur DC_CCS, ID: EAPC_Temperatur_DC_CCS) Prüfsumme falsch | 1 | 0x00010000 |
| 0xD79772 | Botschaft (PowerTrainGuidanceTargetLimit, ID: PowerTrainGuidanceTargetLimit) fehlt | 1 | 0x00004000 |
| 0xD79773 | Botschaft (PowerTrainGuidanceTargetLimit, ID: PowerTrainGuidanceTargetLimit) nicht aktuell | 1 | 0x00010000 |
| 0xD79774 | Botschaft (PowerTrainGuidanceTargetLimit, ID: PowerTrainGuidanceTargetLimit) Prüfsumme falsch | 1 | 0x00010000 |
| 0xD79778 | Botschaft (SecOcP2TestSecOcEA_HVS, ID: SecOcP2TestSecOcEA_HVS) fehlt | 1 | 0x00004000 |
| 0xD7977B | Botschaft (SecOcP2TestSecOcEA_TEE1, ID: SecOcP2TestSecOcEA_TEE1) fehlt | 1 | 0x00004000 |
| 0xD7977E | Botschaft (SecOcP2TestSecOcEA_TEE2, ID: SecOcP2TestSecOcEA_TEE2) fehlt | 1 | 0x00004000 |
| 0xD79784 | Botschaft (Status1DV3Lin, ID: Status1DV3Lin) fehlt | 1 | 0x00004000 |
| 0xD79787 | Botschaft (Status2DV3Lin, ID: Status2DV3Lin) fehlt | 1 | 0x00004000 |
| 0xD7978A | Botschaft (StatusCrashIdentETractSys1, ID: StatusCrashIdentETractSys1) fehlt | 1 | 0x00004000 |
| 0xD7978B | Botschaft (StatusCrashIdentETractSys1, ID: StatusCrashIdentETractSys1) nicht aktuell | 1 | 0x00010000 |
| 0xD7978C | Botschaft (StatusCrashIdentETractSys1, ID: StatusCrashIdentETractSys1) Prüfsumme falsch | 1 | 0x00010000 |
| 0xD7978D | Botschaft (StatusCrashIdentETractSys2, ID: StatusCrashIdentETractSys2) fehlt | 1 | 0x00004000 |
| 0xD7978E | Botschaft (StatusCrashIdentETractSys2, ID: StatusCrashIdentETractSys2) nicht aktuell | 1 | 0x00010000 |
| 0xD7978F | Botschaft (StatusCrashIdentETractSys2, ID: StatusCrashIdentETractSys2) Prüfsumme falsch | 1 | 0x00010000 |
| 0xD79790 | Botschaft (StatusTempSS7Lin, ID: StatusTempSS7Lin) fehlt | 1 | 0x00004000 |
| 0xD79793 | Botschaft (StatusTempSS8Lin, ID: StatusTempSS8Lin) fehlt | 1 | 0x00004000 |
| 0xD79796 | Botschaft (Status XPAD, ID: ST_XPAD) fehlt | 1 | 0x00004000 |
| 0xD7979C | Botschaft (TestSecOcEA_HVS, ID: TestSecOcEA_HVS) fehlt | 1 | 0x00004000 |
| 0xD7979F | Botschaft (TestSecOcEA_TEE1, ID: TestSecOcEA_TEE1) fehlt | 1 | 0x00004000 |
| 0xD797A2 | Botschaft (TestSecOcEA_TEE2, ID: TestSecOcEA_TEE2) fehlt | 1 | 0x00004000 |
| 0xD797A5 | Botschaft (Kilometerstand_2, ID: Kilometerstand_2) fehlt | 1 | 0x00004000 |
...
Dimensions: 294 rows × 9 columns

| UWNR | UWTEXT | UW_EINH | L/H | UWTYP | NAME | MUL | DIV | ADD |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 0x0001 | UWB_HVSTART_ERROR_ISOLATION_WARNUNG | 0/1 | High | 0x00000001 | - | - | - | - |
| 0x0002 | UWB_HVSTART_ERROR_ISOLATIONS_FEHLER | 0/1 | High | 0x00000002 | - | - | - | - |
| 0x0003 | UWB_HVSTART_ERROR_EINFACHER_SCHUETZKLEBER | 0/1 | High | 0x00000004 | - | - | - | - |
| 0x0004 | UWB_HVSTART_ERROR_DOPPELTER_SCHUETZKLEBER | 0/1 | High | 0x00000008 | - | - | - | - |
| 0x0005 | UWB_HVSTART_ERROR_SYSTEMINTERLOCK_FEHLERVERDACHT | 0/1 | High | 0x00000010 | - | - | - | - |
| 0x0006 | UWB_HVSTART_ERROR_SYSTEMINTERLOCK | 0/1 | High | 0x00000020 | - | - | - | - |
| 0x0007 | UWB_HVSTART_ERROR_SERVICE_DISCONNECT_OFFEN | 0/1 | High | 0x00000040 | - | - | - | - |
| 0x0008 | UWB_HVSTART_ERROR_KAT6_SME_VERDACHT | 0/1 | High | 0x00000080 | - | - | - | - |
| 0x0009 | UWB_HVSTART_ERROR_KAT6_SME | 0/1 | High | 0x00000100 | - | - | - | - |
| 0x000A | UWB_HVSTART_ERROR_KAT7_SME_VERDACHT | 0/1 | High | 0x00000200 | - | - | - | - |
| 0x000B | UWB_HVSTART_ERROR_KAT7_SME | 0/1 | High | 0x00000400 | - | - | - | - |
| 0x000C | UWB_HVSTART_ERROR_SIGNALAUSFALL_SME_VERDACHT | 0/1 | High | 0x00000800 | - | - | - | - |
| 0x000D | UWB_HVSTART_ERROR_SIGNALAUSFALL_SME | 0/1 | High | 0x00001000 | - | - | - | - |
| 0x000E | UWB_HVSTART_ERROR_SIGNALAUSFALL_EME_VERDACHT | 0/1 | High | 0x00002000 | - | - | - | - |
| 0x000F | UWB_HVSTART_ERROR_SIGNALAUSFALL_EME | 0/1 | High | 0x00004000 | - | - | - | - |
| 0x0010 | UWB_HVSTART_ERROR_SIGNALAUSFALL_IHKA | 0/1 | High | 0x00008000 | - | - | - | - |
| 0x0011 | UWB_HVSTART_ERROR_ENTLADESCHUTZ_AKTIV | 0/1 | High | 0x00010000 | - | - | - | - |
| 0x0012 | UWB_HVSTART_ERROR_CRASH_SCHWERE_1 | 0/1 | High | 0x00020000 | - | - | - | - |
| 0x0013 | UWB_HVSTART_ERROR_CRASH_SCHWERE_2 | 0/1 | High | 0x00040000 | - | - | - | - |
| 0x0014 | UWB_HVSTART_ERROR_FLASH_MODE_EME | 0/1 | High | 0x00080000 | - | - | - | - |
| 0x0015 | UWB_HVSTART_ERROR_HV_SYSTEM_SICHER_ABGESCHALTET_CCM636 | 0/1 | High | 0x00100000 | - | - | - | - |
| 0x0016 | UWB_HVSTART_ERROR_RESTLAUFZEIT_30B_KRITISCH | 0/1 | High | 0x00200000 | - | - | - | - |
| 0x0017 | UWB_HVSTART_ERROR_DIAGNOSEJOB_HVPM_ZUM_HV_POWERDOWN | 0/1 | High | 0x00400000 | - | - | - | - |
| 0x0018 | UWB_HVSTART_ERROR_DIAGNOSEJOB_FUNCTIONAL_SLEEP_GESAMTFAHRZEUG | 0/1 | High | 0x00800000 | - | - | - | - |
| 0x0019 | UWB_HVSTART_ERROR_KAT1_SME_VERDACHT | 0/1 | High | 0x01000000 | - | - | - | - |
| 0x001A | UWB_HVSTART_ERROR_KAT1_SME | 0/1 | High | 0x02000000 | - | - | - | - |
| 0x001B | UWB_HVSTART_ERROR_KAT5_SME_VERDACHT | 0/1 | High | 0x04000000 | - | - | - | - |
| 0x001C | UWB_HVSTART_ERROR_KAT5_SME | 0/1 | High | 0x08000000 | - | - | - | - |
| 0x001D | UWB_HVSTART_ERROR_BB_ANGEFORDERT_VON_NLM | 0/1 | High | 0x10000000 | - | - | - | - |
| 0x001E | UWB_HVSTART_ISO_ERROR_DCDC_AKTIV | 0/1 | High | 0x01 | - | - | - | - |
| 0x001F | UWB_HVSTART_ISO_ERROR_UMRICHTER_IN_AKS | 0/1 | High | 0x02 | - | - | - | - |
| 0x0020 | UWB_HVSTART_ISO_ERROR_UMRICHTER_IN_FREILAUF | 0/1 | High | 0x04 | - | - | - | - |
| 0x0021 | UWB_HVSTART_ISO_ERROR_LADEGERAET_AKTIV | 0/1 | High | 0x08 | - | - | - | - |
| 0x0022 | UWB_HVSTART_ISO_ERROR_EDH_AKTIV | 0/1 | High | 0x10 | - | - | - | - |
| 0x0023 | UWB_HVSTART_ISO_ERROR_EKMV_AKTIV | 0/1 | High | 0x20 | - | - | - | - |
| 0x0024 | UWB_HVSTART_ISO_ERROR_ISO_WARN_AKTIV | 0/1 | High | 0x40 | - | - | - | - |
| 0x0025 | UWB_HVSTART_ISO_ERROR_ISO_ERR_AKTIV | 0/1 | High | 0x80 | - | - | - | - |
| 0x0026 | UWB_BF_FEHLERURSACHE_LADEMODUL_3_HARDWARE | 0/1 | High | 0x0000 | - | - | - | - |
| 0x0027 | UWB_BF_FEHLERURSACHE_LADEMODUL_3_UNTERSPANNUNG_AC | 0/1 | High | 0x0001 | - | - | - | - |
| 0x0028 | UWB_BF_FEHLERURSACHE_LADEMODUL_3_UEBERSPANNUNG_AC | 0/1 | High | 0x0002 | - | - | - | - |
| 0x0029 | UWB_BF_FEHLERURSACHE_LADEMODUL_3_UEBERSTROM_AC | 0/1 | High | 0x0004 | - | - | - | - |
| 0x002A | UWB_BF_FEHLERURSACHE_LADEMODUL_3_UNTERSPANNUNG_DC | 0/1 | High | 0x0008 | - | - | - | - |
| 0x002B | UWB_BF_FEHLERURSACHE_LADEMODUL_3_UEBERSPANNUNG_DC | 0/1 | High | 0x0010 | - | - | - | - |
| 0x002C | UWB_BF_FEHLERURSACHE_LADEMODUL_3_UEBERSTROM_DC | 0/1 | High | 0x0020 | - | - | - | - |
| 0x002D | UWB_BF_FEHLERURSACHE_LADEMODUL_3_TEMPERATUR | 0/1 | High | 0x0040 | - | - | - | - |
| 0x002E | UWB_BF_FEHLERURSACHE_LADEMODUL_3_KOMMUNIKATIONSFEHLER | 0/1 | High | 0x0080 | - | - | - | - |
| 0x002F | UWB_BF_FEHLERURSACHE_LADEMODUL_3_BETRIEBSART | 0/1 | High | 0x0100 | - | - | - | - |
| 0x0030 | UWB_BF_FEHLERURSACHE_LADEMODUL_3_EFFIZIENZ | 0/1 | High | 0x0200 | - | - | - | - |
| 0x0031 | UWB_BF_FEHLERURSACHE_LADEMODUL_3_ANDERE | 0/1 | High | 0x0400 | - | - | - | - |
| 0x0032 | UWB_BF_FEHLERURSACHE_LADEMODUL_3_N_LINE | 0/1 | High | 0x0800 | - | - | - | - |
| 0x0033 | UWB_BF_FEHLERURSACHE_LADEMODUL_3_UNTERSCHIED_AC | 0/1 | High | 0x1000 | - | - | - | - |
| 0x0034 | UWB_BF_FEHLERURSACHE_LADEMODUL_3_RESERVIERT14 | 0/1 | High | 0x2000 | - | - | - | - |
| 0x0035 | UWB_BF_FEHLERURSACHE_LADEMODUL_3_RESERVIERT15 | 0/1 | High | 0x4000 | - | - | - | - |
| 0x0036 | UWB_BF_LIMITIERUNGSURSACHE_EXC_TEMP | 0/1 | High | 0x0000 | - | - | - | - |
| 0x0037 | UWB_BF_LIMITIERUNGSURSACHE_LADEFEHLER | 0/1 | High | 0x0001 | - | - | - | - |
| 0x0038 | UWB_BF_LIMITIERUNGSURSACHE_EFFIZIENZ | 0/1 | High | 0x0002 | - | - | - | - |
| 0x0039 | UWB_BF_LIMITIERUNGSURSACHE_POWER | 0/1 | High | 0x0004 | - | - | - | - |
| 0x003A | UWB_BF_LIMITIERUNGSURSACHE_RESERVEBIT4 | 0/1 | High | 0x0008 | - | - | - | - |
| 0x003B | UWB_BF_LIMITIERUNGSURSACHE_RESERVEBIT5 | 0/1 | High | 0x0010 | - | - | - | - |
| 0x003C | UWB_BF_LIMITIERUNGSURSACHE_RESERVEBIT6 | 0/1 | High | 0x0020 | - | - | - | - |
| 0x003D | UWB_BF_LIMITIERUNGSURSACHE_RESERVEBIT7 | 0/1 | High | 0x0040 | - | - | - | - |
| 0x003E | UWB_BF_LIMITIERUNGSURSACHE_AC_FEHLT | 0/1 | High | 0x0080 | - | - | - | - |
| 0x003F | UWB_BF_LIMITIERUNGSURSACHE_COMMANDED_POWER | 0/1 | High | 0x0100 | - | - | - | - |
| 0x0040 | UWB_BF_LIMITIERUNGSURSACHE_RESERVEBIT10 | 0/1 | High | 0x0200 | - | - | - | - |
| 0x0041 | UWB_BF_LIMITIERUNGSURSACHE_RESERVEBIT11 | 0/1 | High | 0x0400 | - | - | - | - |
| 0x0042 | UWB_BF_LIMITIERUNGSURSACHE_RESERVEBIT12 | 0/1 | High | 0x0800 | - | - | - | - |
| 0x0043 | UWB_BF_LIMITIERUNGSURSACHE_RESERVEBIT13 | 0/1 | High | 0x1000 | - | - | - | - |
| 0x0044 | UWB_BF_LIMITIERUNGSURSACHE_RESERVEBIT14 | 0/1 | High | 0x2000 | - | - | - | - |
| 0x0045 | UWB_BF_LIMITIERUNGSURSACHE_RESERVEBIT15 | 0/1 | High | 0x4000 | - | - | - | - |
| 0x0046 | UWB_BF_FEHLERURSACHE_LADEMODUL_2_HARDWARE | 0/1 | High | 0x0000 | - | - | - | - |
| 0x0047 | UWB_BF_FEHLERURSACHE_LADEMODUL_2_UNTERSPANNUNG_AC | 0/1 | High | 0x0001 | - | - | - | - |
| 0x0048 | UWB_BF_FEHLERURSACHE_LADEMODUL_2_UEBERSPANNUNG_AC | 0/1 | High | 0x0002 | - | - | - | - |
| 0x0049 | UWB_BF_FEHLERURSACHE_LADEMODUL_2_UEBERSTROM_AC | 0/1 | High | 0x0004 | - | - | - | - |
| 0x004A | UWB_BF_FEHLERURSACHE_LADEMODUL_2_UNTERSPANNUNG_DC | 0/1 | High | 0x0008 | - | - | - | - |
| 0x004B | UWB_BF_FEHLERURSACHE_LADEMODUL_2_UEBERSPANNUNG_DC | 0/1 | High | 0x0010 | - | - | - | - |
| 0x004C | UWB_BF_FEHLERURSACHE_LADEMODUL_2_UEBERSTROM_DC | 0/1 | High | 0x0020 | - | - | - | - |
| 0x004D | UWB_BF_FEHLERURSACHE_LADEMODUL_2_TEMPERATUR | 0/1 | High | 0x0040 | - | - | - | - |
| 0x004E | UWB_BF_FEHLERURSACHE_LADEMODUL_2_KOMMUNIKATIONSFEHLER | 0/1 | High | 0x0080 | - | - | - | - |
| 0x004F | UWB_BF_FEHLERURSACHE_LADEMODUL_2_BETRIEBSART | 0/1 | High | 0x0100 | - | - | - | - |
| 0x0050 | UWB_BF_FEHLERURSACHE_LADEMODUL_2_EFFIZIENZ | 0/1 | High | 0x0200 | - | - | - | - |
| 0x0051 | UWB_BF_FEHLERURSACHE_LADEMODUL_2_ANDERE | 0/1 | High | 0x0400 | - | - | - | - |
| 0x0052 | UWB_BF_FEHLERURSACHE_LADEMODUL_2_N_LINE | 0/1 | High | 0x0800 | - | - | - | - |
| 0x0053 | UWB_BF_FEHLERURSACHE_LADEMODUL_2_UNTERSCHIED_AC | 0/1 | High | 0x1000 | - | - | - | - |
| 0x0054 | UWB_BF_FEHLERURSACHE_LADEMODUL_2_RESERVIERT14 | 0/1 | High | 0x2000 | - | - | - | - |
| 0x0055 | UWB_BF_FEHLERURSACHE_LADEMODUL_2_RESERVIERT15 | 0/1 | High | 0x4000 | - | - | - | - |
| 0x0056 | UWB_BF_LIMITIERUNGSURSACHE_EXC_TEMP | 0/1 | High | 0x0000 | - | - | - | - |
| 0x0057 | UWB_BF_LIMITIERUNGSURSACHE_LADEFEHLER | 0/1 | High | 0x0001 | - | - | - | - |
| 0x0058 | UWB_BF_LIMITIERUNGSURSACHE_EFFIZIENZ | 0/1 | High | 0x0002 | - | - | - | - |
| 0x0059 | UWB_BF_LIMITIERUNGSURSACHE_POWER | 0/1 | High | 0x0004 | - | - | - | - |
| 0x005A | UWB_BF_LIMITIERUNGSURSACHE_RESERVEBIT4 | 0/1 | High | 0x0008 | - | - | - | - |
| 0x005B | UWB_BF_LIMITIERUNGSURSACHE_RESERVEBIT5 | 0/1 | High | 0x0010 | - | - | - | - |
| 0x005C | UWB_BF_LIMITIERUNGSURSACHE_RESERVEBIT6 | 0/1 | High | 0x0020 | - | - | - | - |
| 0x005D | UWB_BF_LIMITIERUNGSURSACHE_RESERVEBIT7 | 0/1 | High | 0x0040 | - | - | - | - |
| 0x005E | UWB_BF_LIMITIERUNGSURSACHE_AC_FEHLT | 0/1 | High | 0x0080 | - | - | - | - |
| 0x005F | UWB_BF_LIMITIERUNGSURSACHE_COMMANDED_POWER | 0/1 | High | 0x0100 | - | - | - | - |
| 0x0060 | UWB_BF_LIMITIERUNGSURSACHE_RESERVEBIT10 | 0/1 | High | 0x0200 | - | - | - | - |
| 0x0061 | UWB_BF_LIMITIERUNGSURSACHE_RESERVEBIT11 | 0/1 | High | 0x0400 | - | - | - | - |
| 0x0062 | UWB_BF_LIMITIERUNGSURSACHE_RESERVEBIT12 | 0/1 | High | 0x0800 | - | - | - | - |
| 0x0063 | UWB_BF_LIMITIERUNGSURSACHE_RESERVEBIT13 | 0/1 | High | 0x1000 | - | - | - | - |
| 0x0064 | UWB_BF_LIMITIERUNGSURSACHE_RESERVEBIT14 | 0/1 | High | 0x2000 | - | - | - | - |
| 0x0065 | UWB_BF_LIMITIERUNGSURSACHE_RESERVEBIT15 | 0/1 | High | 0x4000 | - | - | - | - |
| 0x0066 | UWB_BF_FEHLERURSACHE_LADEMODUL_1_HARDWARE | 0/1 | High | 0x0000 | - | - | - | - |
| 0x0067 | UWB_BF_FEHLERURSACHE_LADEMODUL_1_UNTERSPANNUNG_AC | 0/1 | High | 0x0001 | - | - | - | - |
| 0x0068 | UWB_BF_FEHLERURSACHE_LADEMODUL_1_UEBERSPANNUNG_AC | 0/1 | High | 0x0002 | - | - | - | - |
| 0x0069 | UWB_BF_FEHLERURSACHE_LADEMODUL_1_UEBERSTROM_AC | 0/1 | High | 0x0004 | - | - | - | - |
| 0x006A | UWB_BF_FEHLERURSACHE_LADEMODUL_1_UNTERSPANNUNG_DC | 0/1 | High | 0x0008 | - | - | - | - |
| 0x006B | UWB_BF_FEHLERURSACHE_LADEMODUL_1_UEBERSPANNUNG_DC | 0/1 | High | 0x0010 | - | - | - | - |
| 0x006C | UWB_BF_FEHLERURSACHE_LADEMODUL_1_UEBERSTROM_DC | 0/1 | High | 0x0020 | - | - | - | - |
| 0x006D | UWB_BF_FEHLERURSACHE_LADEMODUL_1_TEMPERATUR | 0/1 | High | 0x0040 | - | - | - | - |
| 0x006E | UWB_BF_FEHLERURSACHE_LADEMODUL_1_KOMMUNIKATIONSFEHLER | 0/1 | High | 0x0080 | - | - | - | - |
| 0x006F | UWB_BF_FEHLERURSACHE_LADEMODUL_1_BETRIEBSART | 0/1 | High | 0x0100 | - | - | - | - |
| 0x0070 | UWB_BF_FEHLERURSACHE_LADEMODUL_1_EFFIZIENZ | 0/1 | High | 0x0200 | - | - | - | - |
| 0x0071 | UWB_BF_FEHLERURSACHE_LADEMODUL_1_ANDERE | 0/1 | High | 0x0400 | - | - | - | - |
| 0x0072 | UWB_BF_FEHLERURSACHE_LADEMODUL_1_N_LINE | 0/1 | High | 0x0800 | - | - | - | - |
| 0x0073 | UWB_BF_FEHLERURSACHE_LADEMODUL_1_UNTERSCHIED_AC | 0/1 | High | 0x1000 | - | - | - | - |
| 0x0074 | UWB_BF_FEHLERURSACHE_LADEMODUL_1_RESERVIERT14 | 0/1 | High | 0x2000 | - | - | - | - |
| 0x0075 | UWB_BF_FEHLERURSACHE_LADEMODUL_1_RESERVIERT15 | 0/1 | High | 0x4000 | - | - | - | - |
| 0x0076 | UWB_BF_LIMITIERUNGSURSACHE_EXC_TEMP | 0/1 | High | 0x0000 | - | - | - | - |
| 0x0077 | UWB_BF_LIMITIERUNGSURSACHE_LADEFEHLER | 0/1 | High | 0x0001 | - | - | - | - |
| 0x0078 | UWB_BF_LIMITIERUNGSURSACHE_EFFIZIENZ | 0/1 | High | 0x0002 | - | - | - | - |
| 0x0079 | UWB_BF_LIMITIERUNGSURSACHE_POWER | 0/1 | High | 0x0004 | - | - | - | - |
| 0x007A | UWB_BF_LIMITIERUNGSURSACHE_RESERVEBIT4 | 0/1 | High | 0x0008 | - | - | - | - |
| 0x007B | UWB_BF_LIMITIERUNGSURSACHE_RESERVEBIT5 | 0/1 | High | 0x0010 | - | - | - | - |
| 0x007C | UWB_BF_LIMITIERUNGSURSACHE_RESERVEBIT6 | 0/1 | High | 0x0020 | - | - | - | - |
| 0x007D | UWB_BF_LIMITIERUNGSURSACHE_RESERVEBIT7 | 0/1 | High | 0x0040 | - | - | - | - |
| 0x007E | UWB_BF_LIMITIERUNGSURSACHE_AC_FEHLT | 0/1 | High | 0x0080 | - | - | - | - |
| 0x007F | UWB_BF_LIMITIERUNGSURSACHE_COMMANDED_POWER | 0/1 | High | 0x0100 | - | - | - | - |
| 0x0080 | UWB_BF_LIMITIERUNGSURSACHE_RESERVEBIT10 | 0/1 | High | 0x0200 | - | - | - | - |
| 0x0081 | UWB_BF_LIMITIERUNGSURSACHE_RESERVEBIT11 | 0/1 | High | 0x0400 | - | - | - | - |
| 0x0082 | UWB_BF_LIMITIERUNGSURSACHE_RESERVEBIT12 | 0/1 | High | 0x0800 | - | - | - | - |
| 0x0083 | UWB_BF_LIMITIERUNGSURSACHE_RESERVEBIT13 | 0/1 | High | 0x1000 | - | - | - | - |
| 0x0084 | UWB_BF_LIMITIERUNGSURSACHE_RESERVEBIT14 | 0/1 | High | 0x2000 | - | - | - | - |
| 0x0085 | UWB_BF_LIMITIERUNGSURSACHE_RESERVEBIT15 | 0/1 | High | 0x4000 | - | - | - | - |
| 0x0086 | DETECTED_UNEXPECTED_LINK_STATUS_PORT_00 | 0-n | High | 0x0001 | UNEXPECTED_LINK_UP_STATUS_TAB | - | - | - |
| 0x0087 | DETECTED_UNEXPECTED_LINK_STATUS_PORT_01 | 0-n | High | 0x0002 | UNEXPECTED_LINK_UP_STATUS_TAB | - | - | - |
| 0x0088 | DETECTED_UNEXPECTED_LINK_STATUS_PORT_02 | 0-n | High | 0x0004 | UNEXPECTED_LINK_UP_STATUS_TAB | - | - | - |
| 0x0089 | DETECTED_UNEXPECTED_LINK_STATUS_PORT_03 | 0-n | High | 0x0008 | UNEXPECTED_LINK_UP_STATUS_TAB | - | - | - |
| 0x008A | DETECTED_UNEXPECTED_LINK_STATUS_PORT_04 | 0-n | High | 0x0010 | UNEXPECTED_LINK_UP_STATUS_TAB | - | - | - |
| 0x008B | DETECTED_UNEXPECTED_LINK_STATUS_PORT_05 | 0-n | High | 0x0020 | UNEXPECTED_LINK_UP_STATUS_TAB | - | - | - |
| 0x008C | DETECTED_UNEXPECTED_LINK_STATUS_PORT_06 | 0-n | High | 0x0040 | UNEXPECTED_LINK_UP_STATUS_TAB | - | - | - |
| 0x008D | DETECTED_UNEXPECTED_LINK_STATUS_PORT_07 | 0-n | High | 0x0080 | UNEXPECTED_LINK_UP_STATUS_TAB | - | - | - |
| 0x008E | DETECTED_UNEXPECTED_LINK_STATUS_PORT_08 | 0-n | High | 0x0100 | UNEXPECTED_LINK_UP_STATUS_TAB | - | - | - |
| 0x008F | DETECTED_UNEXPECTED_LINK_STATUS_PORT_09 | 0-n | High | 0x0200 | UNEXPECTED_LINK_UP_STATUS_TAB | - | - | - |
| 0x0090 | DETECTED_UNEXPECTED_LINK_STATUS_PORT_10 | 0-n | High | 0x0400 | UNEXPECTED_LINK_UP_STATUS_TAB | - | - | - |
| 0x0091 | DETECTED_UNEXPECTED_LINK_STATUS_PORT_11 | 0-n | High | 0x0800 | UNEXPECTED_LINK_UP_STATUS_TAB | - | - | - |
| 0x0092 | DETECTED_UNEXPECTED_LINK_STATUS_PORT_12 | 0-n | High | 0x1000 | UNEXPECTED_LINK_UP_STATUS_TAB | - | - | - |
| 0x0093 | DETECTED_UNEXPECTED_LINK_STATUS_PORT_13 | 0-n | High | 0x2000 | UNEXPECTED_LINK_UP_STATUS_TAB | - | - | - |
| 0x0094 | DETECTED_UNEXPECTED_LINK_STATUS_PORT_14 | 0-n | High | 0x4000 | UNEXPECTED_LINK_UP_STATUS_TAB | - | - | - |
| 0x0095 | DETECTED_UNEXPECTED_LINK_STATUS_PORT_15 | 0-n | High | 0x8000 | UNEXPECTED_LINK_UP_STATUS_TAB | - | - | - |
| 0x0096 | LINK_RESET_STATUS_00 | 0/1 | High | 0x0001 | - | - | - | - |
| 0x0097 | LINK_RESET_STATUS_01 | 0/1 | High | 0x0002 | - | - | - | - |
| 0x0098 | LINK_RESET_STATUS_02 | 0/1 | High | 0x0004 | - | - | - | - |
| 0x0099 | LINK_RESET_STATUS_03 | 0/1 | High | 0x0008 | - | - | - | - |
| 0x009A | LINK_RESET_STATUS_04 | 0/1 | High | 0x0010 | - | - | - | - |
| 0x009B | LINK_RESET_STATUS_05 | 0/1 | High | 0x0020 | - | - | - | - |
| 0x009C | LINK_RESET_STATUS_06 | 0/1 | High | 0x0040 | - | - | - | - |
| 0x009D | LINK_RESET_STATUS_07 | 0/1 | High | 0x0080 | - | - | - | - |
| 0x009E | LINK_RESET_STATUS_08 | 0/1 | High | 0x0100 | - | - | - | - |
| 0x009F | LINK_RESET_STATUS_09 | 0/1 | High | 0x0200 | - | - | - | - |
| 0x00A0 | LINK_RESET_STATUS_10 | 0/1 | High | 0x0400 | - | - | - | - |
| 0x00A1 | LINK_RESET_STATUS_11 | 0/1 | High | 0x0800 | - | - | - | - |
| 0x00A2 | LINK_RESET_STATUS_12 | 0/1 | High | 0x1000 | - | - | - | - |
| 0x00A3 | LINK_RESET_STATUS_13 | 0/1 | High | 0x2000 | - | - | - | - |
| 0x00A4 | LINK_RESET_STATUS_14 | 0/1 | High | 0x4000 | - | - | - | - |
| 0x00A5 | LINK_RESET_STATUS_15 | 0/1 | High | 0x8000 | - | - | - | - |
| 0x00A6 | IPSEC_ATM02_STATUS | 0-n | High | 0x03 | TAB_DEFINITION_STATUS_ATM02 | - | - | - |
| 0x00A7 | IPSEC_KOMBI_STATUS | 0-n | High | 0x0C | TAB_DEFINITION_STATUS_KOMBI | - | - | - |
| 0x00A8 | IPSEC_MGU_STATUS | 0-n | High | 0x30 | TAB_DEFINITION_STATUS_MGU | - | - | - |
| 0x00A9 | IPSEC_RSE_STATUS | 0-n | High | 0xC0 | TAB_DEFINITION_STATUS_RSE | - | - | - |
| 0x00AA | UWB_BF_DERATING_STATUS_DCDC_MAX_COMMANDED_HVPOWER | 0/1 | High | 0x0000 | - | - | - | - |
| 0x00AB | UWB_BF_DERATING_STATUS_DCDC_MIN_COMMANDED_HVVOLTAGE | 0/1 | High | 0x0001 | - | - | - | - |
| 0x00AC | UWB_BF_DERATING_STATUS_DCDC_RESERVEBIT2 | 0/1 | High | 0x0002 | - | - | - | - |
| 0x00AD | UWB_BF_DERATING_STATUS_DCDC_RESERVEBIT3 | 0/1 | High | 0x0004 | - | - | - | - |
| 0x00AE | UWB_BF_DERATING_STATUS_DCDC_TEMPERATUR | 0/1 | High | 0x0009 | - | - | - | - |
| 0x00AF | UWB_BF_DERATING_STATUS_DCDC_RESERVEBIT5 | 0/1 | High | 0x0010 | - | - | - | - |
| 0x00B0 | UWB_BF_DERATING_STATUS_DCDC_LOW_EFFICIENCY | 0/1 | High | 0x0020 | - | - | - | - |
| 0x00B1 | UWB_BF_DERATING_STATUS_DCDC_RESERVEBIT7 | 0/1 | High | 0x0040 | - | - | - | - |
| 0x00B2 | UWB_BF_DERATING_STATUS_DCDC_RESERVEBIT8 | 0/1 | High | 0x0080 | - | - | - | - |
| 0x00B3 | UWB_BF_DERATING_STATUS_DCDC_RESERVEBIT9 | 0/1 | High | 0x0100 | - | - | - | - |
| 0x00B4 | UWB_BF_DERATING_STATUS_DCDC_RESERVEBIT10 | 0/1 | High | 0x0200 | - | - | - | - |
| 0x00B5 | UWB_BF_DERATING_STATUS_DCDC_RESERVEBIT11 | 0/1 | High | 0x0400 | - | - | - | - |
| 0x00B6 | UWB_BF_DERATING_STATUS_DCDC_RESERVEBIT12 | 0/1 | High | 0x0800 | - | - | - | - |
| 0x00B7 | UWB_BF_DERATING_STATUS_DCDC_RESERVEBIT13 | 0/1 | High | 0x1000 | - | - | - | - |
| 0x00B8 | UWB_BF_DERATING_STATUS_DCDC_RESERVEBIT14 | 0/1 | High | 0x2000 | - | - | - | - |
| 0x00B9 | UWB_BF_DERATING_STATUS_DCDC_RESERVEBIT15 | 0/1 | High | 0x4000 | - | - | - | - |
| 0x00BA | UWB_BF_ERROR_STATUS_DCDC_HARDWAREERROR | 0/1 | High | 0x0000 | - | - | - | - |
| 0x00BB | UWB_BF_ERROR_STATUS_DCDC_UNTERSPANNUNG_HV | 0/1 | High | 0x0001 | - | - | - | - |
| 0x00BC | UWB_BF_ERROR_STATUS_DCDC_UEBERSPANNUNG_HV | 0/1 | High | 0x0002 | - | - | - | - |
| 0x00BD | UWB_BF_ERROR_STATUS_DCDC_UEBERSTROM_HV | 0/1 | High | 0x0004 | - | - | - | - |
| 0x00BE | UWB_BF_ERROR_STATUS_DCDC_UNTERSPANNUNG_LV | 0/1 | High | 0x0008 | - | - | - | - |
| 0x00BF | UWB_BF_ERROR_STATUS_DCDC_UEBERSPANNUNG_LV | 0/1 | High | 0x0010 | - | - | - | - |
| 0x00C0 | UWB_BF_ERROR_STATUS_DCDC_UEBERSTROM_LV | 0/1 | High | 0x0020 | - | - | - | - |
| 0x00C1 | UWB_BF_ERROR_STATUS_DCDC_UEBERTEMPERATUR | 0/1 | High | 0x0040 | - | - | - | - |
| 0x00C2 | UWB_BF_ERROR_STATUS_DCDC_KOMMUNIKATIONSFEHLER | 0/1 | High | 0x0080 | - | - | - | - |
| 0x00C3 | UWB_BF_ERROR_STATUS_DCDC_ZIEL_BETRIEBSART | 0/1 | High | 0x0100 | - | - | - | - |
| 0x00C4 | UWB_BF_ERROR_STATUS_DCDC_ZIEL_SPANNUNG | 0/1 | High | 0x0200 | - | - | - | - |
| 0x00C5 | UWB_BF_ERROR_STATUS_DCDC_ANDERE_GRUENDE | 0/1 | High | 0x0400 | - | - | - | - |
| 0x00C6 | UWB_BF_ERROR_STATUS_DCDC_RESERVEBIT12 | 0/1 | High | 0x0800 | - | - | - | - |
| 0x00C7 | UWB_BF_ERROR_STATUS_DCDC_RESERVEBIT13 | 0/1 | High | 0x1000 | - | - | - | - |
| 0x00C8 | UWB_BF_ERROR_STATUS_DCDC_RESERVEBIT14 | 0/1 | High | 0x2000 | - | - | - | - |
| 0x00C9 | UWB_BF_ERROR_STATUS_DCDC_RESERVEBIT15 | 0/1 | High | 0x4000 | - | - | - | - |
...
| 0x2200 | VERIFICATION_FAILED_DATA_ID_1 | - | High | unsigned int | - | 1.0 | 1.0 | 0.0 |
| 0x2201 | VERIFICATION_FAILED_DATA_ID_2 | - | High | unsigned int | - | 1.0 | 1.0 | 0.0 |
| 0x2202 | VERIFICATION_FAILED_DATA_ID_3 | - | High | unsigned int | - | 1.0 | 1.0 | 0.0 |
| 0x2203 | VERIFICATION_FAILED_DATA_ID_4 | - | High | unsigned int | - | 1.0 | 1.0 | 0.0 |
| 0x2204 | VERIFICATION_FAILED_DATA_ID_5 | - | High | unsigned int | - | 1.0 | 1.0 | 0.0 |
| 0x2205 | VERIFICATION_TIMER_VALUE | ms | High | unsigned int | - | 1.0 | 1.0 | 0.0 |
...
| 0x7002 | UWB_DCDC_Maximum_Input_Power | W | High | unsigned char | - | 5100.0 | 255.0 | 0.0 |
...
| 0x7007 | UWB_DCDC_Temperature | °C | High | unsigned char | - | 1.0 | 1.0 | -50.0 |
| 0x7008 | UWB_DCDC_Actual_BA | 0-n | High | 0xFF | TAB_UWB_DCDC_ACTUAL_BA | - | - | - |
| 0x7009 | UWB_DCDC_Actual_Filtered_Current_LV | A | High | unsigned int | - | 1.0 | 1.0 | 0.0 |
...
| 0x704D | UWB_DCDC_Actual_Power_HV | W | High | unsigned int | - | 1.0 | 1.0 | 0.0 |
| 0x704E | UWB_DCDC_Actual_Load | % | High | unsigned char | - | 100.0 | 255.0 | 0.0 |
| 0x705B | Sub-Tabelle | 0-n | - | 0xFF | - | - | - | - |
| 0x707B | UWB_SUMMENSTROM_ZWISCHNEKREIS | A | High | unsigned char | - | 1.0 | 1.0 | 0.0 |
| 0x708B | UWB_UEBERSTROM_HW_ERKANNT | 0/1 | High | 0x01 | - | - | - | - |
| 0x708C | Sub-Tabelle | 0-n | - | 0xFFFF | - | - | - | - |
| 0x708D | Sub-Tabelle | 0-n | - | 0xFFFF | - | - | - | - |
| 0x708E | UWB_TEMPERATUR_KUEHLMITTEL_CCU_WERT | °C | High | unsigned char | - | 1.0 | 1.0 | -50.0 |
| 0x70F0 | UWB_SOLL_BETRIEBSART_LADEMODUL_1 | 0-n | High | 0xFF | TAB_UWB_BETRIEBSZUSTAND_LADEMODUL | - | - | - |
| 0x70F1 | UWB_SOLL_BETRIEBSART_LADEMODUL_2 | 0-n | High | 0xFF | TAB_UWB_BETRIEBSZUSTAND_LADEMODUL | - | - | - |
| 0x70F2 | UWB_SOLL_BETRIEBSART_LADEMODUL_3 | 0-n | High | 0xFF | TAB_UWB_BETRIEBSZUSTAND_LADEMODUL | - | - | - |
| 0x70F3 | UWB_IST_BETRIEBSART_LADEMODUL_1 | 0-n | High | 0xFF | TAB_UWB_BETRIEBSZUSTAND_LADEMODUL | - | - | - |
| 0x70F4 | UWB_IST_BETRIEBSART_LADEMODUL_2 | 0-n | High | 0xFF | TAB_UWB_BETRIEBSZUSTAND_LADEMODUL | - | - | - |
| 0x70F5 | UWB_IST_BETRIEBSART_LADEMODUL_3 | 0-n | High | 0xFF | TAB_UWB_BETRIEBSZUSTAND_LADEMODUL | - | - | - |
| 0x70F6 | Sub-Tabelle | 0-n | - | 0xFFFF | - | - | - | - |
| 0x70F7 | Sub-Tabelle | 0-n | - | 0xFFFF | - | - | - | - |
| 0x70F8 | Sub-Tabelle | 0-n | - | 0xFFFF | - | - | - | - |
| 0x70F9 | Sub-Tabelle | 0-n | - | 0xFFFF | - | - | - | - |
| 0x70FA | Sub-Tabelle | 0-n | - | 0xFFFF | - | - | - | - |
| 0x70FB | Sub-Tabelle | 0-n | - | 0xFFFF | - | - | - | - |
| 0x70FC | AC_SPANNUNG_PHASE_1 | V | High | unsigned char | - | 2.0 | 1.0 | 0.0 |
| 0x70FD | AC_SPANNUNG_PHASE_2 | V | High | unsigned char | - | 2.0 | 1.0 | 0.0 |
| 0x70FE | AC_SPANNUNG_PHASE_3 | V | High | unsigned char | - | 2.0 | 1.0 | 0.0 |
| 0x70FF | IST_DC_STROM_LADEMODUL_1 | A | High | unsigned char | - | 1.0 | 10.0 | 0.0 |
| 0x7100 | IST_DC_STROM_LADEMODUL_2 | A | High | unsigned char | - | 1.0 | 10.0 | 0.0 |
| 0x7101 | IST_DC_STROM_LADEMODUL_3 | A | High | unsigned char | - | 1.0 | 10.0 | 0.0 |
| 0x7102 | SOLL_LADELEISTUNG_LADEMODUL_1 | W | High | unsigned char | - | 20.0 | 1.0 | 0.0 |
| 0x7103 | SOLL_LADELEISTUNG_LADEMODUL_2 | W | High | unsigned char | - | 20.0 | 1.0 | 0.0 |
| 0x7104 | SOLL_LADELEISTUNG_LADEMODUL_3 | W | High | unsigned char | - | 20.0 | 1.0 | 0.0 |
| 0x7105 | IST_TEMPERATUR_LADEMODUL_1 | °C | High | unsigned char | - | 1.0 | 1.0 | -50.0 |
| 0x7106 | IST_TEMPERATUR_LADEMODUL_2 | °C | High | unsigned char | - | 1.0 | 1.0 | -50.0 |
| 0x7107 | IST_TEMPERATUR_LADEMODUL_3 | °C | High | unsigned char | - | 1.0 | 1.0 | -50.0 |
| 0x7108 | AC_STROMGRENZE | A | High | unsigned char | - | 1.0 | 1.0 | 0.0 |
| 0x7109 | DC_STROMGRENZE | A | High | unsigned char | - | 1.0 | 1.0 | 0.0 |
| 0x710A | GESAMTLADEDAUER_SEIT_LADESTART | s | High | unsigned int | - | 2.0 | 1.0 | 0.0 |
| 0x710B | IST_AC_NETZSTROM_LADEMODUL_1 | A | High | unsigned char | - | 2.0 | 10.0 | 0.0 |
| 0x710C | IST_AC_NETZSTROM_LADEMODUL_2 | A | High | unsigned char | - | 2.0 | 10.0 | 0.0 |
| 0x710D | IST_AC_NETZSTROM_LADEMODUL_3 | A | High | unsigned char | - | 2.0 | 10.0 | 0.0 |
| 0x710E | AC_FREQUENZ_PHASE_1 | Hz | High | unsigned char | - | 4.0 | 10.0 | 0.0 |
| 0x710F | AC_FREQUENZ_PHASE_2 | Hz | High | unsigned char | - | 4.0 | 10.0 | 0.0 |
| 0x7110 | AC_FREQUENZ_PHASE_3 | Hz | High | unsigned char | - | 4.0 | 10.0 | 0.0 |
| 0x7111 | UWB_AC_SW_MATRIX1_TAR | 0-n | High | 0xFF | TAB_UWB_SWMATRIX_ZUSTAND | - | - | - |
| 0x7112 | UWB_AC_SW_MATRIX1_ACT | 0-n | High | 0xFF | TAB_UWB_SWMATRIX_ZUSTAND | - | - | - |
| 0x7113 | UWB_SW_MATRIX1_SCHALTVORGAENGE_ZAEHLER | Counts | High | unsigned int | - | 1.0 | 1.0 | 0.0 |
| 0x77CF | UWB_SG_RESET_ART | 0-n | High | 0xFF | TAB_UWB_SG_RESET_ART | - | - | - |
| 0x77D0 | UWB_SG_RESET_URSACHE | HEX | High | unsigned char | - | - | - | - |
| 0x77D1 | UWB_SG_RESET_PROZESSOR_KERN | HEX | High | unsigned char | - | - | - | - |
| 0x77D2 | UWB_SG_RESET_SCHEMA_VERSION | HEX | High | unsigned char | - | - | - | - |
| 0x77D3 | UWB_SG_RESET_REGISTER_01 | HEX | High | unsigned long | - | - | - | - |
| 0x77D4 | UWB_SG_RESET_REGISTER_02 | HEX | High | unsigned long | - | - | - | - |
| 0x77D5 | UWB_SG_RESET_REGISTER_03 | HEX | High | unsigned long | - | - | - | - |
| 0x77D6 | UWB_SG_RESET_REGISTER_04 | HEX | High | unsigned long | - | - | - | - |
| 0x77D7 | UWB_SG_RESET_REGISTER_05 | HEX | High | unsigned long | - | - | - | - |
| 0x77D8 | UWB_SG_RESET_REGISTER_06 | HEX | High | unsigned long | - | - | - | - |
| 0x77D9 | UWB_SG_RESET_REGISTER_07 | HEX | High | unsigned long | - | - | - | - |
| 0x77DA | UWB_SG_RESET_REGISTER_08 | HEX | High | unsigned long | - | - | - | - |
| 0x77DB | UWB_SG_RESET_REGISTER_09 | HEX | High | unsigned long | - | - | - | - |
| 0x77DC | UWB_SG_RESET_REGISTER_10 | HEX | High | unsigned long | - | - | - | - |
| 0x77FE | UWB_SG_RESET_FEHLER_ADRESSE | HEX | High | unsigned long | - | - | - | - |
| 0x77FF | UWB_SG_RESET_PROGRAMMZAEHLER | HEX | High | unsigned long | - | - | - | - |
...
Dimensions: 198 rows × 4 columns

| ORT | ORTTEXT | EREIGNIS_DTC | FEHLERKLASSE |
| --- | --- | --- | --- |
| 0x030EC0 | HVPM - Laden - Ladekabel - Entriegelungsknopf | 1 | 0x00000000 |
| 0x030EC1 | HVPM - Laden - Ausfall Lademodul | 1 | 0x00000000 |
| 0x030EC2 | HVPM - Laden - Ladegerät - Degradation-Abbruch | 1 | 0x00000000 |
| 0x030EC3 | HVPM - Laden - Degradation Lademodul | 1 | 0x00000000 |
| 0x030EC4 | HVPM - Laden - Ladekabel - Keine Steckererkennung | 1 | 0x00000000 |
| 0x030EC5 | HVPM - Laden - Ladekabel - Pilot nicht vorhanden | 1 | 0x00000000 |
| 0x030EC6 | HVPM - Laden - Ausfall DC/DC-Wandler | 1 | 0x00000000 |
| 0x030EC7 | HVPM - Laden - Vollladen nicht möglich | 1 | 0x00000000 |
| 0x030EC8 | HVPM - Laden - Ladestörung da Wegfall AC-Spannung | 1 | 0x00000000 |
| 0x030EC9 | HVPM - Laden - AC-Spannung ohne Ladebereitschaft | 1 | 0x00000000 |
| 0x030ECA | HVPM - Laden - Kommunikationsausfall zur primären Energiequelle | 1 | 0x00000000 |
| 0x030ECB | HVPM - Laden - Kommunikationsausfall zum Lademodul | 1 | 0x00000000 |
| 0x030ECC | HVPM - Laden - VOKO-Fehler | 1 | 0x00000000 |
| 0x030ECD | HVPM - Laden - Ladefehler aufgrund Zustandsautomaten | 1 | 0x00000000 |
| 0x030ECE | HVPM - Laden - Störung | 1 | 0x00000000 |
| 0x030ECF | HVPM - Laden - Ladekabel - Verriegelung | 1 | 0x00000000 |
| 0x030ED0 | HVPM - Laden - Werksladen gesetzt | 1 | 0x00000000 |
| 0x030ED1 | HVPM - Laden - Klappe der Lade-Buchse offen | 1 | 0x00000000 |
| 0x030EDA | HVPM - Leistungskoordinator - zu geringe Leistungsaufnahme IHKA | 1 | 0x00000000 |
| 0x030EDB | HVPM - Leistungskoordinator - Leistungsfreigaben IHKA überschritten | 1 | 0x00000000 |
| 0x030EDC | HVPM - Leistungskoordinator - Leistungsfreigaben DC/DC überschritten | 1 | 0x00000000 |
| 0x030EDE | HVPM - Leistungskoordinator - Reduzierte Leistungsfreigabe DC/DC Wandler | 0 | 0x00000000 |
| 0x030EE1 | HVPM - Start - Abschaltgrund - Crash Schwere | 1 | 0x00000000 |
| 0x030EE2 | HVPM - Start - Abschaltgrund - Entladeschutzfunktion | 1 | 0x00000000 |
| 0x030EE6 | HVPM - Start - HV-Speicher - Einfacher Schützkleber | 1 | 0x00000000 |
| 0x030EE7 | HVPM - Start - HV-Speicher - Doppelter Schützkleber | 1 | 0x00000000 |
| 0x030EE8 | HVPM - Start - Signalausfall - Klimafunktionen | 1 | 0x00000000 |
| 0x030EE9 | HVPM - Start - Signalausfall - Antriebselektronik | 1 | 0x00000000 |
| 0x030EEA | HVPM - Start - Signalausfall  - Primären Energiequelle | 1 | 0x00000000 |
| 0x030EEB | HVPM - Start - HV-Bereitschaft nicht möglich trotz Anforderung | 1 | 0x00000000 |
| 0x030EEC | HVPM - Start - HV-System sicher abgeschaltet | 1 | 0x00000000 |
| 0x030EED | HVPM - Start - Powerdown-Fehler - Entladezeit-Überschreitung | 1 | 0x00000000 |
| 0x030EEE | HVPM - Start - Abschaltkategorien - Sofortiger befehlerbedinger Shutdown Hochvolt | 0 | 0x00000000 |
| 0x030EEF | HVPM - Start - Abschaltkategorien - Kontrollierter fehlerbedingter Shutdown Hochvolt | 0 | 0x00000000 |
| 0x030EF0 | HVPM - Start - Abschaltkategorien - Regulärer Shutdown | 0 | 0x00000000 |
| 0x030EF1 | HVPM - Start - Batterieloser Betrieb nicht verfügbar | 0 | 0x00000000 |
| 0x030EF2 | HVPM - Start - IHKA - VoKo | 0 | 0x00000000 |
| 0x030FB4 | DC/DC-Wandler, Derating | 0 | 0x00000000 |
| 0x030FB9 | DC/DC-Wandler, Bauteilschutz: DC/DC Abschaltfehler KL30 | 0 | 0x00000000 |
| 0x030FBA | DC/DC-Wandler, Bauteilschutz: DC/DC Abschaltfehler Crash | 0 | 0x00000000 |
| 0x031800 | AC-Laden - Modul 1 - AC-Spannungssensor - Unterer Schwellenwert unterschritten | 0 | 0x00000000 |
| 0x031802 | AC-Laden - Modul 1 - AC-Spannungssensor - Plausibilitätsfehler | 0 | 0x00000000 |
| 0x031803 | AC-Laden - Modul 1 - AC-Spannungssensor - Oberer Schwellenwert überschritten | 0 | 0x00000000 |
| 0x03181F | AC-Laden - Modul 1 - DC-Spannungssensor - Oberer Schwellenwert überschritten | 0 | 0x00000000 |
| 0x031830 | AC-Laden - Modul 1 - PFC-Spannungssensor - Unterer Schwellenwert unterschritten | 0 | 0x00000000 |
| 0x031832 | AC-Laden - Modul 1 - PFC-Spannungssensor - Plausibilitätsfehler | 0 | 0x00000000 |
| 0x031833 | AC-Laden - Modul 1 - PFC-Spannungssensor - Oberer Schwellenwert überschritten | 0 | 0x00000000 |
| 0x031836 | AC-Laden - Modul 1 - DC-Spannungssensor - Unterer Schwellenwert unterschritten | 0 | 0x00000000 |
| 0x031837 | AC-Laden - Modul 1 - DC-Spannungssensor - Plausibilitätsfehler | 0 | 0x00000000 |
| 0x03183E | AC-Laden - Modul 2 - AC-Spannungssensor - Oberer Schwellenwert überschritten | 0 | 0x00000000 |
| 0x03183F | AC-Laden - Modul 2 - AC-Spannungssensor - Plausibilitätsfehler | 0 | 0x00000000 |
| 0x031841 | AC-Laden - Modul 2 - AC-Spannungssensor - Unterer Schwellenwert unterschritten | 0 | 0x00000000 |
| 0x031845 | AC-Laden - Modul 1 - AC-Stromsensor - Unterer Schwellenwert unterschritten | 0 | 0x00000000 |
| 0x031847 | AC-Laden - Modul 1 - AC-Stromsensor - Plausibilitätsfehler | 0 | 0x00000000 |
| 0x031848 | AC-Laden - Modul 1 - AC-Stromsensor - Oberer Schwellenwert überschritten | 0 | 0x00000000 |
| 0x03184C | AC-Laden - Modul 2 - AC-Stromsensor - Oberer Schwellenwert überschritten | 0 | 0x00000000 |
| 0x031853 | AC-Laden - Modul 2 - AC-Stromsensor - Plausibilitätsfehler | 0 | 0x00000000 |
| 0x03185C | AC-Laden - Modul 2 - AC-Stromsensor - Unterer Schwellenwert unterschritten | 0 | 0x00000000 |
| 0x031864 | AC-Laden - Modul 2 - DC-Spannungssensor - Oberer Schwellenwert überschritten | 0 | 0x00000000 |
| 0x031865 | AC-Laden - Modul 1 - PFC-Temperatursensor - Unterer Schwellenwert unterschritten | 0 | 0x00000000 |
| 0x031866 | AC-Laden - Modul 1 - PFC-Temperatursensor - Plausiblitätsfehler | 0 | 0x00000000 |
| 0x031867 | AC-Laden - Modul 1 - PFC-Temperatursensor - Oberer Schwellenwert überschritten | 0 | 0x00000000 |
| 0x03186C | AC-Laden - Modul 2 - DC-Spannungssensor - Plausibilitätsfehler | 0 | 0x00000000 |
| 0x03186D | AC-Laden - Modul 2 - DC-Spannungssensor - Unterer Schwellenwert unterschritten | 0 | 0x00000000 |
| 0x031875 | AC-Laden - Modul 2 - PFC-Spannungssensor - Oberer Schwellenwert überschritten | 0 | 0x00000000 |
| 0x031876 | AC-Laden - Modul 2 - PFC-Spannungssensor - Plausibilitätsfehler | 0 | 0x00000000 |
| 0x031887 | AC-Laden - Modul 2 - PFC-Spannungssensor - Unterer Schwellenwert unterschritten | 0 | 0x00000000 |
| 0x031888 | AC-Laden - Modul 2 - PFC-Temperatursensor - Oberer Schwellenwert überschritten | 0 | 0x00000000 |
| 0x031890 | AC-Laden - Modul 2 - PFC-Temperatursensor - Plausiblitätsfehler | 0 | 0x00000000 |
| 0x031899 | AC-Laden - Modul 2 - PFC-Temperatursensor - Unterer Schwellenwert unterschritten | 0 | 0x00000000 |
| 0x03189A | AC-Laden - Modul 3 - AC-Spannungssensor - Oberer Schwellenwert überschritten | 0 | 0x00000000 |
| 0x0318A2 | AC-Laden - Modul 3 - AC-Spannungssensor - Plausibilitätsfehler | 0 | 0x00000000 |
| 0x0318AB | AC-Laden - Modul 3 - AC-Spannungssensor - Unterer Schwellenwert unterschritten | 0 | 0x00000000 |
| 0x0318CE | AC-Laden - Modul 3 - AC-Stromsensor - Oberer Schwellenwert überschritten | 0 | 0x00000000 |
| 0x0318CF | AC-Laden - Modul 3 - AC-Stromsensor - Plausibilitätsfehler | 0 | 0x00000000 |
| 0x0318D4 | AC-Laden - Modul 3 - AC-Stromsensor - Unterer Schwellenwert unterschritten | 0 | 0x00000000 |
| 0x0318DB | AC-Laden - Modul 3 - DC-Spannungssensor - Oberer Schwellenwert überschritten | 0 | 0x00000000 |
| 0x0318DC | AC-Laden - Modul 3 - DC-Spannungssensor - Plausibilitätsfehler | 0 | 0x00000000 |
| 0x0318DD | AC-Laden - Modul 3 - DC-Spannungssensor - Unterer Schwellenwert unterschritten | 0 | 0x00000000 |
| 0x0318E0 | AC-Laden - Modul 1 - Bauteilschutz - AC-Überspannung | 0 | 0x00000000 |
| 0x0318E1 | AC-Laden - Modul 1 - Bauteilschutz - PFC-Überspannung | 0 | 0x00000000 |
| 0x0318E2 | AC-Laden - Modul 1 - Bauteilschutz - AC-Überstrom | 0 | 0x00000000 |
| 0x0318E3 | AC-Laden - Modul 1 - Bauteilschutz - AC-Unterspannung | 0 | 0x00000000 |
| 0x0318E4 | AC-Laden - Modul 1 - Bauteilschutz - PFC-Unterspannung | 0 | 0x00000000 |
| 0x0318E5 | AC-Laden - Modul 1 - Bauteilschutz - DC-Überspannung | 0 | 0x00000000 |
| 0x0318E6 | AC-Laden - Modul 1 - Bauteilschutz - DC-Überstrom | 0 | 0x00000000 |
| 0x0318E7 | AC-Laden - Modul 1 - Bauteilschutz - DC-Unterspannung | 0 | 0x00000000 |
| 0x0318E8 | AC-Laden - Modul 2 - Bauteilschutz - AC-Überspannung | 0 | 0x00000000 |
| 0x0318E9 | AC-Laden - Modul 2 - Bauteilschutz - AC-Überstrom | 0 | 0x00000000 |
| 0x0318EA | AC-Laden - Modul 2 - Bauteilschutz - AC-Unterspannung | 0 | 0x00000000 |
| 0x0318EB | AC-Laden, 5V Versorgung ausgefallen | 0 | 0x00000000 |
| 0x0318EC | AC-Laden - Modul 2 - Bauteilschutz - DC-Überstrom | 0 | 0x00000000 |
| 0x0318ED | AC-Laden - Modul 2 - Bauteilschutz - DC-Unterspannung | 0 | 0x00000000 |
| 0x0318EE | AC-Laden - Modul 2 - Bauteilschutz - PFC-Überspannung | 0 | 0x00000000 |
| 0x0318EF | AC-Laden - Modul 2 - Bauteilschutz - PFC-Unterspannung | 0 | 0x00000000 |
| 0x0318F0 | AC-Laden - Modul 3 - Bauteilschutz - AC-Überspannung | 0 | 0x00000000 |
| 0x0318F1 | AC-Laden - Modul 3 - Bauteilschutz - AC-Überstrom | 0 | 0x00000000 |
| 0x0318F2 | AC-Laden - Modul 3 - Bauteilschutz - AC-Unterspannung | 0 | 0x00000000 |
| 0x0318F3 | AC-Laden, Bauteilschutz: Summenstrom | 0 | 0x00000000 |
| 0x0318F4 | AC-Laden - Modul 3 - Bauteilschutz - DC-Überstrom | 0 | 0x00000000 |
| 0x0318F5 | AC-Laden - Modul 3 - Bauteilschutz - DC-Unterspannung | 0 | 0x00000000 |
| 0x0318F6 | AC-Laden - Modul 3 - Bauteilschutz - PFC-Überspannung | 0 | 0x00000000 |
| 0x0318F7 | AC-Laden - Modul 3 - Bauteilschutz - PFC-Unterspannung | 0 | 0x00000000 |
| 0x0318FA | AC-Laden - Modul 3 - PFC-Spannungssensor - Oberer Schwellenwert überschritten | 0 | 0x00000000 |
| 0x0318FB | AC-Laden - Modul 3 - PFC-Spannungssensor - Plausibilitätsfehler | 0 | 0x00000000 |
| 0x0318FD | AC-Laden - Modul 3 - PFC-Spannungssensor - Unterer Schwellenwert unterschritten | 0 | 0x00000000 |
| 0x0318FE | AC-Laden - Modul 3 - PFC-Temperatursensor - Oberer Schwellenwert überschritten | 0 | 0x00000000 |
| 0x0318FF | AC-Laden - Modul 3 - PFC-Temperatursensor - Plausiblitätsfehler | 0 | 0x00000000 |
| 0x031901 | AC-Laden - Modul 3 - PFC-Temperatursensor - Unterer Schwellenwert unterschritten | 0 | 0x00000000 |
| 0x031902 | AC-Laden - Modul 1 - Bauteilschutz - PFC-Temperatur | 0 | 0x00000000 |
| 0x031903 | AC-Laden - Modul 2 - Bauteilschutz - PFC-Temperatur | 0 | 0x00000000 |
| 0x031904 | AC-Laden - Modul 3 - Bauteilschutz - PFC-Temperatur | 0 | 0x00000000 |
| 0x031905 | AC-Laden - Modul 1 - DC-Stromsensor - Oberer Schwellenwert überschritten | 0 | 0x00000000 |
| 0x031906 | AC-Laden - Modul 1 - DC-Stromsensor - Plausibilitätsfehler | 0 | 0x00000000 |
| 0x031907 | AC-Laden - Modul 1 - DC-Stromsensor - Unterer Schwellenwert unterschritten | 0 | 0x00000000 |
| 0x031908 | AC-Laden - Modul 2 - DC-Stromsensor - Oberer Schwellenwert überschritten | 0 | 0x00000000 |
| 0x031909 | AC-Laden - Modul 2 - DC-Stromsensor - Plausibilitätsfehler | 0 | 0x00000000 |
| 0x03190A | AC-Laden - Modul 2 - DC-Stromsensor - Unterer Schwellenwert unterschritten | 0 | 0x00000000 |
| 0x03190B | AC-Laden - Modul 3 - DC-Stromsensor - Oberer Schwellenwert überschritten | 0 | 0x00000000 |
| 0x03190C | AC-Laden - Modul 3 - DC-Stromsensor - Plausibilitätsfehler | 0 | 0x00000000 |
| 0x03190D | AC-Laden - Modul 3 - DC-Stromsensor - Unterer Schwellenwert unterschritten | 0 | 0x00000000 |
| 0x031910 | AC-Laden - Komponentenschutz - N-Leitung-Stromsensor - Oberer Schwellenwert überschritten | 1 | 0x00000000 |
| 0x031911 | AC-Laden - Ungültige Leistungseinstellung LDK Modul - Einstellung führt zu Fehlern | 1 | 0x00000000 |
| 0x031912 | AC-Laden - Modul 1 - Komponentenschutz - Stromwert zw. 2 Leitungen - Oberer Schwellenwert überschritten | 0 | 0x00000000 |
| 0x031913 | AC-Laden - Modul 2 - Komponentenschutz - Stromwert zw. 2 Leitungen - Oberer Schwellenwert überschritten | 0 | 0x00000000 |
| 0x031914 | AC-Laden - Modul 3 - Komponentenschutz - Stromwert zw. 2 Leitungen - Oberer Schwellenwert überschritten | 0 | 0x00000000 |
| 0x03191B | AC-Laden - Modul 2 - LLC-Temperatursensor - Oberer Schwellenwert überschritten | 0 | 0x00000000 |
| 0x03191C | AC-Laden - Modul 2 - LLC-Temperatursensor - Unterer Schwellenwert unterschritten | 0 | 0x00000000 |
| 0x03191D | AC-Laden - Modul 2 - LLC-Temperatursensor - Plausiblitätsfehler | 0 | 0x00000000 |
| 0x031921 | AC-Laden - Modul 3 - LLC-Temperatursensor - Oberer Schwellenwert überschritten | 0 | 0x00000000 |
| 0x031922 | AC-Laden - Modul 3 - LLC-Temperatursensor - Plausiblitätsfehler | 0 | 0x00000000 |
| 0x031923 | AC-Laden - Modul 3 - LLC-Temperatursensor - Unterer Schwellenwert unterschritten | 0 | 0x00000000 |
| 0x031927 | AC-Laden - Modul 1 - Bauteilschutz - PFC-Überstrom | 0 | 0x00000000 |
| 0x031928 | AC-Laden - Modul 2 - Bauteilschutz - PFC-Überstrom | 0 | 0x00000000 |
| 0x031929 | AC-Laden - Modul 3 - Bauteilschutz - PFC-Überstrom | 0 | 0x00000000 |
| 0x03192B | AC-Laden - Modul 1 - Bauteilschutz - AC Frequenz fehlerhaft | 0 | 0x00000000 |
| 0x03192C | AC-Laden - Modul 2 - Bauteilschutz - AC Frequenz fehlerhaft | 0 | 0x00000000 |
| 0x03192D | AC-Laden - Modul 1 - Passive Entladung - Fehlerhaft | 0 | 0x00000000 |
| 0x03192E | AC-Laden - Modul 2 - Passive Entladung - Fehlerhaft | 0 | 0x00000000 |
| 0x03192F | AC-Laden - Modul 3 - Passive Entladung - Fehlerhaft | 0 | 0x00000000 |
| 0x031938 | AC-Laden - Modul 3 - Bauteilschutz - AC Frequenz fehlerhaft | 0 | 0x00000000 |
| 0x03193C | AC-Laden - Modul 1 - LLC-Temperatursensor - Oberer Schwellenwert überschritten | 0 | 0x00000000 |
| 0x03193D | AC-Laden - Modul 1 - LLC-Temperatursensor - Unterer Schwellenwert unterschritten | 0 | 0x00000000 |
| 0x03193E | AC-Laden - Modul 1 - LLC-Temperatursensor - Plausiblitätsfehler | 0 | 0x00000000 |
| 0x031943 | AC-Laden, Bauteilschutz: KL30 Versorgung | 0 | 0x00000000 |
| 0x031950 | DC-Ladestation: Sammelfehler | 0 | 0x00000000 |
| 0x03195A | AC-Laden, Bauteilschutz: Kühlmitteltemperatur | 0 | 0x00000000 |
| 0x03195B | AC-Laden - Modul 1 - Bauteilschutz - LLC-Temperatur | 0 | 0x00000000 |
| 0x03195C | AC-Laden - Modul 2 - Bauteilschutz - LLC-Temperatur | 0 | 0x00000000 |
| 0x03195D | AC-Laden - Modul 3 - Bauteilschutz - LLC-Temperatur | 0 | 0x00000000 |
| 0x03195E | AC-Laden - Modul 1 - HW-Bauteilschutz | 0 | 0x00000000 |
| 0x03195F | AC-Laden - Modul 2 - HW-Bauteilschutz | 0 | 0x00000000 |
| 0x031960 | AC-Laden - Modul 3 - HW-Bauteilschutz | 0 | 0x00000000 |
| 0x031961 | AC-Laden - Modul 1 - Bauteilschutz - LLC Eingangsstrom | 0 | 0x00000000 |
| 0x031962 | AC-Laden - Modul 2 - Bauteilschutz - LLC Eingangsstrom | 0 | 0x00000000 |
| 0x031963 | AC-Laden - Modul 3 - Bauteilschutz - LLC Eingangsstrom | 0 | 0x00000000 |
| 0x031974 | AC-Laden, Modul 3: Nullpunktdurchgangsfehler | 0 | 0x00000000 |
| 0x031975 | AC-Laden, Modul 2: Nullpunktdurchgangsfehler | 0 | 0x00000000 |
| 0x031976 | AC-Laden, Modul 1: Nullpunktdurchgangsfehler | 0 | 0x00000000 |
| 0x031977 | AC-Laden, Modul 3, PFC, Buffer Caps Entladefehler | 0 | 0x00000000 |
| 0x031978 | AC-Laden, Modul 3, Bauteilschutz: Phasendifferenzfehler | 0 | 0x00000000 |
| 0x031979 | AC-Laden, Modul 3, Bauteilschutz: Modulabschaltung | 0 | 0x00000000 |
| 0x03197A | AC-Laden, Modul 2, PFC, Buffer Caps Entladefehler | 0 | 0x00000000 |
| 0x03197B | AC-Laden, Modul 2, Bauteilschutz: Phasendifferenzfehler | 0 | 0x00000000 |
| 0x03197C | AC-Laden, Modul 2, Bauteilschutz: Modulabschaltung | 0 | 0x00000000 |
| 0x03197D | AC-Laden, Modul 1, PFC, Buffer Caps Entladefehler | 0 | 0x00000000 |
| 0x03197E | AC-Laden, Modul 1, Bauteilschutz: Phasendifferenzfehler | 0 | 0x00000000 |
| 0x03197F | AC-Laden, Modul 1, Bauteilschutz: Modulabschaltung | 0 | 0x00000000 |
| 0x032195 | Ladeklappe AC oder Combo, Verriegelungsaktor: Zustand unplausibel | 0 | 0x00000000 |
| 0x032197 | Ladeklappe DC, Verriegelungsaktor: Zustand unplausibel | 0 | 0x00000000 |
| 0x033DD0 | Shift-by-Wire: Anforderung Fahrbereitschaft Beenden bei v&gt;30km/h | 0 | 0x00000000 |
| 0x033DD1 | Shift-by-Wire: Auto-P bei Fahrbereitschaftsverlust und Gurtdummy | 0 | 0x00000000 |
| 0x033DD2 | Shift-by-Wire: Auto-P wegen Fahrerabwesenheit | 0 | 0x00000000 |
| 0x033DD3 | Shift-by-Wire: Fahreranwesenheit unbekannt in D/R | 0 | 0x00000000 |
| 0x033DD4 | Shift-by-Wire: Fahrer nicht anwesend in N | 0 | 0x00000000 |
| 0x033DD5 | Shift-by-Wire: P-Anforderung durch Bremssystem in D/R | 0 | 0x00000000 |
| 0x033DD6 | Shift-by-Wire: P-Anforderung durch Bremssystem in N | 0 | 0x00000000 |
| 0x033DD7 | Shift-by-Wire: Parksperre ohne Fahrbereitschaft ausgelegt | 0 | 0x00000000 |
| 0x033DD8 | Shift-by-Wire: PWF-Wechsel von Fahren nach FBB ohne Fahrerwunsch | 0 | 0x00000000 |
| 0x033DD9 | Shift-by-Wire: Steuergerät in Fahrstufe ungleich P aufgestartet | 0 | 0x00000000 |
| 0x22404C | Aktive Kühlluftklappensteuerung 01 - Lageregelung - System vereist - Blockierung | 0 | 0x00000000 |
| 0x22404D | Aktive Kühlluftklappensteuerung 01 - Lageregelung - Positionsabweichungsfehler in allen Systemzuständen | 0 | 0x00000000 |
| 0x224056 | Aktive Kühlluftklappensteuerung 02 - Lageregelung - System vereist - Blockierung | 0 | 0x00000000 |
| 0x224057 | Aktive Kühlluftklappensteuerung 02 - Lageregelung - Positionsabweichungsfehler in allen Systemzuständen | 0 | 0x00000000 |
| 0x224F4B | Kühlsystem - Kühlungsnotlauf aktiv - Kühlleistung nicht eingeschränkt | 0 | 0x00000000 |
| 0x224F4C | Kühlsystem - Kühlungsnotlauf aktiv - Kühlleistung stark eingeschränkt | 0 | 0x00000000 |
| 0xBA0002 | DC/DC-Wandler - Bauteilschutz - HV Überstrom | 1 | 0x00000000 |
| 0xBA0005 | DC/DC-Wandler - Bauteilschutz - LV Überstrom | 1 | 0x00000000 |
| 0xBA001D | Hochvolt-Leitung, E-Maschine, Leitungsschutz, Degradation | 0 | 0x00000000 |
| 0xBA001E | Hochvolt-Leitung, E-Maschine 2, Leitungsschutz: Degradation | 0 | 0x00000000 |
| 0xBA001F | Hochvolt-Leitung, DC-Ladedose, Leitungsschutz: Degradation | 0 | 0x00000000 |
| 0xBA0020 | Hochvolt-Leitung, Ladesteuergerät, Leitungsschutz: Degradation | 0 | 0x00000000 |
| 0xBA02BE | UDPNM_E_TCPIP_TRANSMIT_ERROR | 0 | 0x00000000 |
| 0xD78601 | Ethernet: CRC Fehler | 1 | 0x00000000 |
| 0xD78605 | Ethernet-Frameverlust | 1 | 0x00000000 |
| 0xD78606 | Ethernet ARP-Tabelleneintrag verworfen | 1 | 0x00000000 |
| 0xD78607 | IPv4-Adresskonflikt (duplizierte DHCP-Adresse erkannt) | 1 | 0x00000000 |
| 0xFFFFFF | unbekannter Fehlerort | 0 | - |

<a id="table-iumwelttexte"></a>
### IUMWELTTEXTE

Dimensions: 214 rows × 9 columns
...
| 0x00C8 | UWB_BF_ERROR_STATUS_DCDC_RESERVEBIT14 | 0/1 | High | 0x2000 | - | - | - | - |
| 0x00C9 | UWB_BF_ERROR_STATUS_DCDC_RESERVEBIT15 | 0/1 | High | 0x4000 | - | - | - | - |
| 0x00CA | UWB_HVLADEN_ERROR_LADEGERAET_HW_FEHLER | 0/1 | High | 0x0001 | - | - | - | - |
| 0x00CB | UWB_HVLADEN_ERROR_LADEGERAET_AC_SPANNUNG | 0/1 | High | 0x0002 | - | - | - | - |
| 0x00CC | UWB_HVLADEN_ERROR_DCDC_NICHT_VERFUEGBAR | 0/1 | High | 0x0004 | - | - | - | - |
| 0x00CD | UWB_HVLADEN_ERROR_HV_NICHT VERFUEGBAR | 0/1 | High | 0x0008 | - | - | - | - |
| 0x00CE | UWB_HVLADEN_ERROR_AC_SPANNUNG_NICHT_VORHANDEN | 0/1 | High | 0x0010 | - | - | - | - |
| 0x00CF | UWB_HVLADEN_ERROR_STECKER_UNERWARTET_GEZOGEN | 0/1 | High | 0x0020 | - | - | - | - |
| 0x00D0 | UWB_HVLADEN_ERROR_STECKER_UNERWARTET_ENTRIEGELT | 0/1 | High | 0x0040 | - | - | - | - |
| 0x00D1 | UWB_HVLADEN_ERROR_LADEGERAET_UNGUELTIGE_BETRIEBSART | 0/1 | High | 0x0080 | - | - | - | - |
| 0x00D2 | UWB_HVLADEN_ERROR_LADERGERAET_CRASH | 0/1 | High | 0x0100 | - | - | - | - |
| 0x00D3 | UWB_HVLADEN_ERROR_LADEGERAET_FEHLER | 0/1 | High | 0x0200 | - | - | - | - |
| 0x00D4 | UWB_HVLADEN_ERROR_LADEGERAET_UNTERBRECHUNG | 0/1 | High | 0x0400 | - | - | - | - |
| 0x00D5 | UWB_HVLADEN_ERROR_AC_STROMGRENZE_GLEICH_NULL | 0/1 | High | 0x0800 | - | - | - | - |
| 0x00D6 | UWB_HVLADEN_ERROR_KOMMFEHLER_HVS_ODER_LADEINTERFACE | 0/1 | High | 0x1000 | - | - | - | - |
| 0x00D7 | UWB_HVLADEN_ERROR_KOMMFEHLER_LADEGERAET | 0/1 | High | 0x2000 | - | - | - | - |
| 0x00D8 | PORT_CRC_ERROR_COUNT | 0-n | High | 0xFF | PORT_CRC_ERROR_COUNT_1B_TAB | - | - | - |
| 0x1750 | F_UW_BN | - | High | unsigned char | - | 1.0 | 1.0 | 0.0 |
| 0x1751 | F_UW_TN | TEXT | High | 3 | - | 1.0 | 1.0 | 0.0 |
...
| 0x703E | UWB_I_BAT_SME | A | High | signed int | - | 1.0 | 32.0 | 0.0 |
...
| 0x7042 | UWB_VOKO_FREIGABE | 0/1 | High | 0x01 | - | - | - | - |
...
| RESULTNAME | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_LCS_NO1_WERT | - | high | unsigned char | - | - | 1.0 | 1.0 | 0.0 | Aktuelle Einstellung des LCS#1 (SecOC By-pass) |
| STAT_SENT_PAYLOAD_BYTE1_DIAG_ADDR_SENDER_WERT | HEX | high | unsigned char | - | - | - | - | - | Versendete Payload der Test-PDU. 1. Byte entspricht der Diagnoseadresse des Senders. |
| STAT_SENT_PAYLOAD_DATA | DATA | high | data[7] | - | - | 1.0 | 1.0 | 0.0 | Versendete Payload der Test-PDU (Byte 2 - Byte 8). |
...
| STAT_IST_BA_ELUELIN_WERT | - | - | + | - | high | unsigned char | - | - | 1.0 | 1.0 | 0.0 | Ist Betriebsart Luefter 1 LIN |
...
| STAT_STACK_INDEX_CORE1_WERT | HEX | high | signed char | - | - | - | - | - | Stack Index für den Verbrauchwert Core 1 |
| STAT_STACK_INDEX_CORE2_WERT | HEX | high | signed char | - | - | - | - | - | Stack Index für den Verbrauchwert Core 2 |
| STAT_STACK_INDEX_CORE3_WERT | HEX | high | signed char | - | - | - | - | - | Stack Index für den Verbrauchwert Core 3 |
...
| RESULTNAME | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_ZULIEF_NUM_WERT | HEX | high | unsigned int | - | - | - | - | - | Zulieferer Nummer |
| STAT_FUNK_NUM_WERT | HEX | high | unsigned int | - | - | - | - | - | Funktions Nummer |
| STAT_VAR_LIN_WERT | HEX | high | unsigned char | - | - | - | - | - | Variante LIN-Luefter |
| STAT_PROD_TAG_WERT | HEX | high | unsigned char | - | - | - | - | - | Produktionsdatum Tag |
| STAT_PROD_MON_WERT | HEX | high | unsigned char | - | - | - | - | - | Produktionsdatum Monat |
| STAT_PROD_JHR_WERT | HEX | high | unsigned char | - | - | - | - | - | Produktionsdatum Jahr |
| STAT_SERIEN_NR_WERT | HEX | high | unsigned long | - | - | - | - | - | Seriennummer |
| STAT_SW_REF_WERT | HEX | high | unsigned int | - | - | - | - | - | Software Referenznummer |
| STAT_HW_REF_WERT | HEX | high | unsigned int | - | - | - | - | - | Hardware Referenznummer |
| STAT_STATUS_ELUE_LIN | 0-n | high | unsigned char | - | T_BMWFANLIN1_ST_READBYIDTSTR_UB_TEXTTABLE_DOP | - | - | - | Statusrueckmeldung Tester Auslesen Metadaten E-Luefter |
| STAT_SPNG_VERS_WERT | HEX | high | unsigned char | - | - | - | - | - | vorgesehene Versorgungsspannung fuer den Luefter 12V oder 48V |
| STAT_LEIST_KLASSE | 0-n | high | unsigned char | - | T_BMWFANLIN1_PWR_CLAS_UB_TEXTTABLE_DOP | - | - | - | Leistungsklasse Luefter |
| STAT_HERST_LUEFTER_WERT | HEX | high | unsigned char | - | - | - | - | - | Hersteller Luefterantrieb |
| STAT_WERK_LUEFTER_WERT | HEX | high | unsigned char | - | - | - | - | - | Produktionswerk Luefterantrieb |
| STAT_FAM_LUEFTER_WERT | HEX | high | unsigned char | - | - | - | - | - | Produktfamilie Luefterantrieb |
...
Dimensions: 114 rows × 16 columns
...
| RSU_TEILNETZ_HV_STUETZUNG_ACTIVATION | 0x1075 | - | RID zur Aktivierung / Deaktivierung des Teilnetz: HV-Stützung während RSU-Aktivierung | - | - | - | - | - | - | - | - | - | 31 | - | RES_0x1075_R |
...
| GET_RECEIVED_SECOC_TEST_PDU | 0x1105 | - | Auslesen des Inhalts der empfangenen SecOC Test-PDU. Wenn noch keine Test-PDU empfangen wurde, haben alle Bytes den Wert 0xff. Die SecOC Test-PDU dient zur Absicherung von SecOC und hat keine applikativen Einfluss. | - | - | - | - | - | - | - | - | - | 22 | - | RES_0x1105_D |
| GET_SECOC_COUNTER | 0x1106 | - | Liest den Counterwert für eine spezifische SecOC dataID aus. | - | - | - | - | - | - | - | - | - | 31 | - | RES_0x1106_R |
| SEND_SECOC_TEST_PDU | 0x1108 | - | Die Erstellung und der Versand der SecOC Test PDU wird initiiert. Die SecOC Test-PDU dient zur Absicherung von SecOC und hat keine applikativen Einfluss. | - | - | - | - | - | - | - | - | - | 31 | - | RES_0x1108_R |
...
| ELUEFTER_LIN_STROM | 0xE50C | STAT_ELUEFTER_LIN_STROM_WERT | Strom E-Luefter LIN | A | - | High | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22 | - | - |
...
| WERT | TEXT |
| --- | --- |
| 0x00 | Activation of Partial Network for HV support during RSU successfully triggered |
...
| WERT | TEXT |
| --- | --- |
| 0x00 | Deactivation of Partial Network for HV support during RSU successfully triggered |
...
| WERT | TEXT |
| --- | --- |
| 0x00 | Kein Reset oder unbekannt |
| 0x01 | Einmaliger Reset |
...
<a id="table-tab-uwb-swmatrix-zustand"></a>
### TAB_UWB_SWMATRIX_ZUSTAND
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 16 | 0x0086 | 0x0087 | 0x0088 | 0x0089 | 0x008A | 0x008B | 0x008C | 0x008D | 0x008E | 0x008F | 0x0090 | 0x0091 | 0x0092 | 0x0093 | 0x0094 | 0x0095 |
...
| UW_ANZ | UW1_NR | UW2_NR | UW3_NR | UW4_NR | UW5_NR | UW6_NR | UW7_NR | UW8_NR | UW9_NR | UW10_NR | UW11_NR | UW12_NR | UW13_NR | UW14_NR | UW15_NR | UW16_NR |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 16 | 0x0096 | 0x0097 | 0x0098 | 0x0099 | 0x009A | 0x009B | 0x009C | 0x009D | 0x009E | 0x009F | 0x00A0 | 0x00A1 | 0x00A2 | 0x00A3 | 0x00A4 | 0x00A5 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 29 | 0x0001 | 0x0002 | 0x0003 | 0x0004 | 0x0005 | 0x0006 | 0x0007 | 0x0008 | 0x0009 | 0x000A | 0x000B | 0x000C | 0x000D | 0x000E | 0x000F | 0x0010 | 0x0011 | 0x0012 | 0x0013 | 0x0014 | 0x0015 | 0x0016 | 0x0017 | 0x0018 | 0x0019 | 0x001A | 0x001B | 0x001C | 0x001D |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 14 | 0x00CA | 0x00CB | 0x00CC | 0x00CD | 0x00CE | 0x00CF | 0x00D0 | 0x00D1 | 0x00D2 | 0x00D3 | 0x00D4 | 0x00D5 | 0x00D6 | 0x00D7 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 8 | 0x001E | 0x001F | 0x0020 | 0x0021 | 0x0022 | 0x0023 | 0x0024 | 0x0025 |

<a id="table-tab-0x708c"></a>
### TAB_0X708C
...
| UW_ANZ | UW1_NR | UW2_NR | UW3_NR | UW4_NR | UW5_NR | UW6_NR | UW7_NR | UW8_NR | UW9_NR | UW10_NR | UW11_NR | UW12_NR | UW13_NR | UW14_NR | UW15_NR | UW16_NR |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 16 | 0x00BA | 0x00BB | 0x00BC | 0x00BD | 0x00BE | 0x00BF | 0x00C0 | 0x00C1 | 0x00C2 | 0x00C3 | 0x00C4 | 0x00C5 | 0x00C6 | 0x00C7 | 0x00C8 | 0x00C9 |

<a id="table-tab-0x708d"></a>
### TAB_0X708D
...
| UW_ANZ | UW1_NR | UW2_NR | UW3_NR | UW4_NR | UW5_NR | UW6_NR | UW7_NR | UW8_NR | UW9_NR | UW10_NR | UW11_NR | UW12_NR | UW13_NR | UW14_NR | UW15_NR | UW16_NR |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 16 | 0x00AA | 0x00AB | 0x00AC | 0x00AD | 0x00AE | 0x00AF | 0x00B0 | 0x00B1 | 0x00B2 | 0x00B3 | 0x00B4 | 0x00B5 | 0x00B6 | 0x00B7 | 0x00B8 | 0x00B9 |

<a id="table-tab-0x70f6"></a>
### TAB_0X70F6
...
| UW_ANZ | UW1_NR | UW2_NR | UW3_NR | UW4_NR | UW5_NR | UW6_NR | UW7_NR | UW8_NR | UW9_NR | UW10_NR | UW11_NR | UW12_NR | UW13_NR | UW14_NR | UW15_NR | UW16_NR |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 16 | 0x0066 | 0x0067 | 0x0068 | 0x0069 | 0x006A | 0x006B | 0x006C | 0x006D | 0x006E | 0x006F | 0x0070 | 0x0071 | 0x0072 | 0x0073 | 0x0074 | 0x0075 |

<a id="table-tab-0x70f7"></a>
### TAB_0X70F7
...
| UW_ANZ | UW1_NR | UW2_NR | UW3_NR | UW4_NR | UW5_NR | UW6_NR | UW7_NR | UW8_NR | UW9_NR | UW10_NR | UW11_NR | UW12_NR | UW13_NR | UW14_NR | UW15_NR | UW16_NR |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 16 | 0x0046 | 0x0047 | 0x0048 | 0x0049 | 0x004A | 0x004B | 0x004C | 0x004D | 0x004E | 0x004F | 0x0050 | 0x0051 | 0x0052 | 0x0053 | 0x0054 | 0x0055 |

<a id="table-tab-0x70f8"></a>
### TAB_0X70F8
...
| UW_ANZ | UW1_NR | UW2_NR | UW3_NR | UW4_NR | UW5_NR | UW6_NR | UW7_NR | UW8_NR | UW9_NR | UW10_NR | UW11_NR | UW12_NR | UW13_NR | UW14_NR | UW15_NR | UW16_NR |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 16 | 0x0026 | 0x0027 | 0x0028 | 0x0029 | 0x002A | 0x002B | 0x002C | 0x002D | 0x002E | 0x002F | 0x0030 | 0x0031 | 0x0032 | 0x0033 | 0x0034 | 0x0035 |

<a id="table-tab-0x70f9"></a>
### TAB_0X70F9
...
| UW_ANZ | UW1_NR | UW2_NR | UW3_NR | UW4_NR | UW5_NR | UW6_NR | UW7_NR | UW8_NR | UW9_NR | UW10_NR | UW11_NR | UW12_NR | UW13_NR | UW14_NR | UW15_NR | UW16_NR |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 16 | 0x0076 | 0x0077 | 0x0078 | 0x0079 | 0x007A | 0x007B | 0x007C | 0x007D | 0x007E | 0x007F | 0x0080 | 0x0081 | 0x0082 | 0x0083 | 0x0084 | 0x0085 |

<a id="table-tab-0x70fa"></a>
### TAB_0X70FA
...
| UW_ANZ | UW1_NR | UW2_NR | UW3_NR | UW4_NR | UW5_NR | UW6_NR | UW7_NR | UW8_NR | UW9_NR | UW10_NR | UW11_NR | UW12_NR | UW13_NR | UW14_NR | UW15_NR | UW16_NR |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 16 | 0x0056 | 0x0057 | 0x0058 | 0x0059 | 0x005A | 0x005B | 0x005C | 0x005D | 0x005E | 0x005F | 0x0060 | 0x0061 | 0x0062 | 0x0063 | 0x0064 | 0x0065 |

<a id="table-tab-0x70fb"></a>
### TAB_0X70FB
...
| UW_ANZ | UW1_NR | UW2_NR | UW3_NR | UW4_NR | UW5_NR | UW6_NR | UW7_NR | UW8_NR | UW9_NR | UW10_NR | UW11_NR | UW12_NR | UW13_NR | UW14_NR | UW15_NR | UW16_NR |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 16 | 0x0036 | 0x0037 | 0x0038 | 0x0039 | 0x003A | 0x003B | 0x003C | 0x003D | 0x003E | 0x003F | 0x0040 | 0x0041 | 0x0042 | 0x0043 | 0x0044 | 0x0045 |
