...
| Field | Value |
| --- | --- |
| ECU | AMP-HIFILR02 HiFi-Verstaerker L6-F07 |
| ORIGIN | BMW EI-41 Michael_Baumgartner |
| REVISION | 2.000 |
| AUTHOR | Lear_Corporation DCS Klaus_Bach |
| COMMENT | N/A |
| PACKAGE | 1.14 |
| SPRACHE | deutsch |
...
| --- | --- | --- |
| 0x02FF37 | DM-Test-Applikation | 1 |
...
| 0xD6CBFF | DM-Test-Kommunikation | 1 |
| 0xD6C414 | K-CAN Control Module Bus OFF | 0 |
| 0xD6C40B | K-CAN Bus Phys.Fehler | 0 |
...
| UWNR | UWTEXT | UW_EINH | L/H | UWTYP | NAME | MUL | DIV | ADD |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 0x4900 | HW-Fehlerursache (Codec: 1 / DSP: 2) | - | - | unsigned char | - | 1 | 1 | 0 |
...
| ORT | ORTTEXT | EREIGNIS_DTC |
| --- | --- | --- |
| 0xb7f4d0 | DM-Zeitbotschaft-Timeout | 1 |
| 0xb7f4d1 | DM-Fahrzeugzustand-Timeout | 1 |
| 0xb7f4d2 | DM-Queue Full | 0 |
| 0xb7f4d3 | DM-Queue Deleted | 1 |
| 0xb7f4c0 | NVM Write Failed | 0 |
| 0xb7f4c1 | NVM Read Failed | 0 |
| 0xb7f4c2 | NVM Control Failed | 0 |
| 0xb7f4c3 | NVM Erase Failed | 0 |
| 0xb7f4c4 | NVM Write All Failed | 0 |
| 0xb7f4c5 | NVM Wrong Config ID | 0 |
| 0xb7f4c6 | NVM Read All Failed | 0 |
| 0xb7f495 | Fehler im Entwickler-EQ | 0 |
| 0xFFFFFF | unbekannter Fehlerort | 0 |
