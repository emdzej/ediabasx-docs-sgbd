...
| Field | Value |
| --- | --- |
| ECU | Integrierte Heiz- Klimaautomatik E38 Redesign |
...
- [IDENT](#job-ident) - Identifikation fuer IHKA E38 Redesign
...
- [CODIERUNG_SCHREIBEN](#job-codierung-schreiben) - Codierdaten Schreiben fuer IHKA E38 Redesign
...
| SENSORIK | string | 'default' 'Kennfeldkuehlung' |
...
| ALLGEMEIN_1 | string | 'DME-Schnittstelle konventionell' 'DME-Schnittstelle PWM-Signal' |
| ALLGEMEIN_2 | string | 'geregelter Kompressor' '' |
| TELEGRAMM | binary | Antworttelegramm |
