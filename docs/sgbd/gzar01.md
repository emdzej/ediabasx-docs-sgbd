...
| --- | --- | --- |
| 0x805801 | LED Versorgung: Kurzschluss | 0 |
| 0x024709 | Codierung: Fehler bei Codierdatentransaktion aufgetreten | 0 |
| 0x024700 | Energiesparmode aktiv | 0 |
| 0x02470C | Codierung: Unplausible Daten während Codierdatentransaktion | 0 |
| 0x80580B | Abschaltung wegen Übertemperatur | 1 |
| 0xDAC514 | B2-CAN Control Module Bus OFF | 0 |
| 0x805810 | Überspannung | 1 |
| 0x805806 | Schrittmotor defekt | 0 |
| 0x805815 | Botschaft 0x22C (CTR_GZA) - Timeout | 1 |
| 0x805800 | Spotlight: Kurzschluss Kathode | 0 |
| 0x02FF47 | Dummy-Fehlerspeichereintrag im Komponentenfehlerbereich nur für Testzwecke | 1 |
| 0x805817 | Steuersignal Gezieltes Anleuchten ungültig | 0 |
| 0x805802 | Spotlight: Leitungsunterbrechung | 0 |
| 0x805805 | Designleuchte: Leitungsunterbrechung | 0 |
| 0x805807 | Schrittmotortreiber defekt | 0 |
| 0x80580F | Unterspannung | 1 |
| 0xDACBFF | Dummy-Fehlerspeichereintrag im Netzwerkfehlerbereich nur für Testzwecke | 1 |
| 0x02470A | Codierung: Signatur der Codierdaten ungültig | 0 |
| 0x02470B | Codierung: Codierdaten passen nicht zum Fahrzeug | 0 |
| 0x805816 | Signal CTR_GZADL ungültig | 1 |
| 0x805803 | Designleuchte: Kurzschluss Kathode | 0 |
| 0x024708 | Codierung: Steuergerät ist nicht codiert | 0 |
...
| SystembusDTC | DAC487 | DAC48F | Zulässiger Bereich wird mittels Formel berechnet. Enthält physikalische Fehler bzw. Protokollfehler des Systembusses. |
| SystembusDTC | DAC401 | DAC40A | Zulässiger Bereich wird mittels Formel berechnet. Enthält physikalische Fehler bzw. Protokollfehler des Systembusses. |
| SystembusDTC | DAC469 | DAC472 | Zulässiger Bereich wird mittels Formel berechnet. Enthält physikalische Fehler bzw. Protokollfehler des Systembusses. |
| SystembusDTC | DAC47D | DAC486 | Zulässiger Bereich wird mittels Formel berechnet. Enthält physikalische Fehler bzw. Protokollfehler des Systembusses. |
| SystembusDTC | DAC415 | DAC41E | Zulässiger Bereich wird mittels Formel berechnet. Enthält physikalische Fehler bzw. Protokollfehler des Systembusses. |
| SystembusDTC | DAC473 | DAC47C | Zulässiger Bereich wird mittels Formel berechnet. Enthält physikalische Fehler bzw. Protokollfehler des Systembusses. |
| SystembusDTC | DAC41F | DAC43E | Zulässiger Bereich wird mittels Formel berechnet. Enthält physikalische Fehler bzw. Protokollfehler des Systembusses. |
| SystembusDTC | DAC501 | DAC50A | Zulässiger Bereich wird mittels Formel berechnet. Enthält physikalische Fehler bzw. Protokollfehler des Systembusses. |
| SystembusDTC | DAC50B | DAC514 | Zulässiger Bereich wird mittels Formel berechnet. Enthält physikalische Fehler bzw. Protokollfehler des Systembusses. |
| SystembusDTC | DAC43F | DAC449 | Zulässiger Bereich wird mittels Formel berechnet. Enthält physikalische Fehler bzw. Protokollfehler des Systembusses. |
...
| SystembusDTC | DAC45F | DAC468 | Zulässiger Bereich wird mittels Formel berechnet. Enthält physikalische Fehler bzw. Protokollfehler des Systembusses. |
| SystembusDTC | DAC40B | DAC414 | Zulässiger Bereich wird mittels Formel berechnet. Enthält physikalische Fehler bzw. Protokollfehler des Systembusses. |
| SubbusDTC | DACC00 | DAD3FF | Zulässiger Bereich wird mittels Formel berechnet. Enthält physikalische Fehler bzw. Protokollfehler des Systembusses. |
| SignalDTC | DAD400 | DB03FF | Ist aus einem vorgegebenen Offset-Bereich frei wählbar. Enthält Signalfehler, die SG-spezifisch sind. |
| SignalDTC | DAD400 | DB03FF | Ist aus einem vorgegebenen Offset-Bereich frei wählbar. Enthält Signalfehler, die SG-spezifisch sind. |
| SignalDTC | DACBFF | DACBFF | Ist aus einem vorgegebenen Offset-Bereich frei wählbar. Enthält Signalfehler, die SG-spezifisch sind. |
| KomponentenDTC | 805800 | 80587F | Die zulässigen Bereiche sind für jedes Steuergerät festgelegt. Es können mehrere gültige Bereiche (Kacheln) definiert werden. |
...
| ORT | ORTTEXT | EREIGNIS_DTC |
| --- | --- | --- |
| 0x470004 | NVM_E_CONTROL_FAILED | 0 |
| 0x47000E | Botschaft (Fahrzeugzustand, 0x3A0) fehlt | 1 |
| 0x470007 | NVM_E_READ_FAILED | 0 |
| 0x47000D | Puffer für ausgehende Fehlermeldungen ist voll | 1 |
| 0x47000A | NVM_E_WRONG_CONFIG_ID | 0 |
| 0x470011 | Thermistor Leitungsunterbrechung | 0 |
| 0x470009 | NVM_E_WRITE_FAILED | 0 |
| 0x470008 | NVM_E_WRITE_ALL_FAILED | 0 |
| 0x470005 | NVM_E_ERASE_FAILED | 0 |
| 0x47000B | Fehler konnte nach maximaler Anzahl von Versuchen nicht gesendet werden | 1 |
| 0x470006 | NVM_E_READ_ALL_FAILED | 0 |
| 0x47000F | Signal (Zeit_Sekunde_Zaehler_Relativ, 0x328): ungültig | 1 |
| 0x470010 | Thermistor Kurzschluss | 0 |
| 0xFFFFFF | unbekannter Fehlerort | 0 |
...
| LEUCHTEN_GZA_REFERENZLAUF | 0xD5E3 | - | STATUS/STEUERN Referenzlauf | - | - | - | - | - | - | - | - | - | 22;2E | ARG_0xD5E3 | RES_0xD5E3 |
...
| GZA_DESIGNLIGHT_BINCLASS | 0x4002 | - | Helligkeitsklasse der Designleuchte | - | - | - | - | - | - | - | - | - | 22;2E | ARG_0x4002 | RES_0x4002 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| HOR_POSITION | ° | high | unsigned char | - | - | 1.0 | 0.1 | 125.0 | -12.5 | 3.0 | Horizontale Position  in Grad in Fahrtrichtung links positiv, rechts  negativ |
| HOR_GESCHW | °/s | high | unsigned char | - | - | 1.0 | 1.0 | 0.0 | 1.0 | 18.0 | Horizontale Geschwindigkeit |

<a id="table-arg-0xd5e3"></a>
### ARG_0XD5E3
...
| ARG | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | MIN | MAX | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| SEITE_R | 0/1 | high | unsigned char | - | - | - | - | - | - | - | Bei Senden mit gelöschtem Bit SEITE_R wird das Steuergerät auf die Diagnoseadresse 0x46 (Leuchte auf linker Seite) umgestellt. Das SG ist nach Ausführen des Jobs, sowie einem anschliessenden RESET (Job)  nicht mehr auf Adresse 0x47 ansprechbar. |

<a id="table-arg-0x4001"></a>
### ARG_0X4001
...
<a id="table-dl-binclass-helligkeit"></a>
...
<a id="table-sl-binclass-helligkeit"></a>
...
<a id="table-tab-gza-referenzlauf"></a>
