...
| Field | Value |
| --- | --- |
| ECU | Satellit Tuer vorne rechts |
...
| 0x96Ad | Timeout ID 01H (STVL) |
| 0x96Ae | Timeout ID 02H |
| 0x96Af | Timeout ID 03H (STVR) |
| 0x96b0 | Timeout ID 04H |
| 0x96b1 | Timeout ID 05H (SBSL) |
| 0x96b2 | Timeout ID 06H () |
| 0x96b3 | Timeout ID 07H (SBSR) |
| 0x96b4 | Timeout ID 08H () |
| 0x96b5 | Timeout ID 09H (SIM) |
| 0x96b6 | Timeout ID 0AH (SIM) |
| 0x96b7 | Timeout ID 0BH (SBSL) |
| 0x96b8 | Timeout ID 0CH (SBSR) |
| 0x96b9 | Timeout ID 0DH (SIM) |
| 0x96ba | Timeout ID 0EH |
| 0x96bb | Timeout ID 0FH |
| 0x96bc | Timeout ID 20H (SBSL) |
| 0x96bd | Timeout ID 21H (SBSR) |
| 0x96be | Timeout ID 22H () |
| 0x96bf | Timeout ID 71H (SIM) |
| 0x96c0 | Codierdaten Checksummenfehler |
| 0x96c1 | Stack Overflow |
...
| 0x96c6 | Kurzschluss oder Unterbrechung H/L-Side-Schalter ZK1 (E85: unbelegt) |
| 0x96c7 | Kurzschluss ZK1 (E85: unbelegt) nach Masse |
| 0x96c8 | Kurzschluss ZK1 (E85: unbelegt) nach Plus |
| 0x96c9 | Widerstand Zuendpille ZK1 (E85: unbelegt) zu klein |
| 0x96ca | Widerstand Zuendpille ZK1 (E85: unbelegt) zu gross |
| 0x96cb | Widerstand Zuendpille ZK1 (E85: unbelegt) nicht gemessen |
| 0x96cc | Unterbrechung ZK1 (E85: unbelegt) |
| 0x96cd | Spannung ZK1 (E85: unbelegt) n.i.O. |
| 0x96ce | Zuendkapazitaet ZK1 (E85: unbelegt) n.i.O. |
| 0x96cf | Codierung/Konfiguration ZK1 (E85: unbelegt) unstimmig |
| 0x96d0 | Unterbrechung Entladekreis ZK1 (E85: unbelegt) |
| 0x96d1 | Kurzschluss oder Unterbrechung H/L-Side-Schalter ZK2 (E85: unbelegt) |
| 0x96d2 | Kurzschluss ZK2 (E85: unbelegt) nach Masse |
| 0x96d3 | Kurzschluss ZK2 (E85: unbelegt) nach Plus |
| 0x96d4 | Widerstand Zuendpille ZK2 (E85: unbelegt) zu klein |
| 0x96d5 | Widerstand Zuendpille ZK2 (E85: unbelegt) zu gross |
| 0x96d6 | Widerstand Zuendpille ZK2 (E85: unbelegt) nicht gemessen |
| 0x96d7 | Unterbrechung ZK2 (E85: unbelegt) |
| 0x96d8 | Spannung ZK2 (E85: unbelegt) n.i.O. |
| 0x96d9 | Zuendkapazitaet ZK2 (E85: unbelegt) n.i.O. |
| 0x96da | Codierung/Konfiguration ZK2 (E85: unbelegt) unstimmig |
| 0x96db | Unterbrechung Entladekreis ZK2 (E85: unbelegt) |
| 0x96dd | Fehler im Alarmpfad |
| 0x96de | Algorithmus-Parameter inkonsistent |
...
| 0x96f8 | Kommunkation mit ZündIC gestört |
...
| 0x96ff | Codierung unvollstaendig |
