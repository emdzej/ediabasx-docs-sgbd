...
| Field | Value |
| --- | --- |
| ECU | Top Hifi Verstärker mit ASD-Funktion |
...
- [STATUS_ASD_EINGANGSKANAELE](#job-status-asd-eingangskanaele) - Liest die relativen Eingangspegel der ASD-Kanaele $22 0x4FFB ASD_EINGANGSKANAELE
- [STEUERN_ASD_SIGNALE](#job-steuern-asd-signale) - Setzen der Daempfung der ASD Signale
- [STATUS_CODIERDATEN](#job-status-codierdaten) - xx Status der Codierdaten
- [STEUERN_HARMAN_SW_VERSION](#job-steuern-harman-sw-version) - Read SW Versions UDS: $31    RoutineControl $01    startRoutine $F0 00 RoutineIdentifier PM Mode $FF    Developer Functions $20    Version $xx    Sort $00    Get Status $0D    PM Mode Endmarker HARMAN Version: xx.yy.zz xx = Major yy = Minor zz = Bugfix
...
<a id="job-status-asd-eingangskanaele"></a>
### STATUS_ASD_EINGANGSKANAELE

Liest die relativen Eingangspegel der ASD-Kanaele $22 0x4FFB ASD_EINGANGSKANAELE
...
| Name | Type | Comment |
| --- | --- | --- |
| STAT_KANAL1 | int | relativer Eingangspegel von ASD-Kanal 1 in dB Bereich 0dB ... -100dB |
| STAT_KANAL2 | int | relativer Eingangspegel von ASD-Kanal 2 in dB Bereich 0dB ... -100dB |
| STAT_KANAL3 | int | relativer Eingangspegel von ASD-Kanal 3 in dB Bereich 0dB ... -100dB |
| STAT_KANAL4 | int | relativer Eingangspegel von ASD-Kanal 4 in dB Bereich 0dB ... -100dB |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| _REQUEST | binary | Hex-Auftrag an SG |
| _RESPONSE | binary | Hex-Antwort von SG |

<a id="job-steuern-asd-signale"></a>
### STEUERN_ASD_SIGNALE

Setzen der Daempfung der ASD Signale

#### Arguments

| Name | Type | Comment |
| --- | --- | --- |
| ARG_DAEMPFUNG | int | Daempfung der ASD Signale 0dB ... -100dB |
...
| Name | Type | Comment |
| --- | --- | --- |
| STAT_CODING_STATUS | string | Codierzustand |
| STAT_CODING_MODELRANGE | string | Werte aus table TCodingModelRange TEXT |
| STAT_CODING_ASDINPUT | string | Werte aus table TCodingASDInput TEXT |
| STAT_CODING_HYBRIDTYPE | string | Werte aus table TCodingHybridType TEXT |
| STAT_CODING_STEERINGWHEEL | string | Werte aus table TCodingSteeringWheel TEXT |
| JOB_STATUS | string | "OKAY", wenn fehlerfrei |
| _REQUEST | binary | Hex-Auftrag an SG |
| _RESPONSE | binary | Hex-Antwort von SG |
...
Read SW Versions UDS: $31    RoutineControl $01    startRoutine $F0 00 RoutineIdentifier PM Mode $FF    Developer Functions $20    Version $xx    Sort $00    Get Status $0D    PM Mode Endmarker HARMAN Version: xx.yy.zz xx = Major yy = Minor zz = Bugfix
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| SW_VERSION_CU | string | Controller Urloader Version |
| SW_VERSION_CF | string | Controller Flasher Version |
| SW_VERSION_CA | string | Controller Audio Application |
| SW_VERSION_CB | string | Controller H/B BIOS Version |
| SW_VERSION_DU0 | string | DSP0 Urloader Version |
| SW_VERSION_DA0 | string | DSP0 Audio Application Version |
| SW_VERSION_DB0 | string | DSP0 H/B BIOS Version |
| SW_VERSION_DS0 | string | DSP0 DataSet Version |
| SW_VERSION_DU1 | string | DSP1 Urloader Version |
| SW_VERSION_DA1 | string | DSP1 Audio Application Version |
| SW_VERSION_DB1 | string | DSP1 H/B BIOS Version |
| SW_VERSION_DS1 | string | DSP1 DataSet Version |
| SW_VERSION_NS | string | MOST NetServices Version |
| HARDWARE_INIC | string | INIC Hardware Version xx xx = Major |
| FIRMWARE_INIC | string | INIC firmware Version |
| CONFIGSTRING_INIC | string | INIC ConfigString Version |
| FIRMWARE_P | string | Lattice Power Manager Version |
| FIRMWARE_Q | string | FPGA Version |
...
- [ARG_0X4FFA_D](#table-arg-0x4ffa-d) (1 × 12)
...
- [ARG_0XA0CC_R](#table-arg-0xa0cc-r) (1 × 14)
- [ARG_0XA0CD_R](#table-arg-0xa0cd-r) (2 × 14)
- [ARG_0XD028_D](#table-arg-0xd028-d) (1 × 12)
- [ARG_0XD09C_D](#table-arg-0xd09c-d) (2 × 12)
...
- [TCODINGMODELRANGE](#table-tcodingmodelrange) (5 × 2)
- [TCODINGASDINPUT](#table-tcodingasdinput) (2 × 2)
- [TCODINGHYBRIDTYPE](#table-tcodinghybridtype) (3 × 2)
- [TCODINGSTEERINGWHEEL](#table-tcodingsteeringwheel) (2 × 2)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ARG_EQINDEX | HEX | high | unsigned char | - | - | - | - | - | - | - | Index des hinterlegten EQ Datensatzes |
...
| ARG | STR | STPR | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | MIN | MAX | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ARG_KANAL_1 | + | - | 0-n | - | unsigned long | - | TAudioKanal | - | - | - | - | - | Kanalnummer |

<a id="table-arg-0xa0cd-r"></a>
### ARG_0XA0CD_R
...
| ARG | STR | STPR | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | MIN | MAX | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ARG_LEVEL | + | - | - | - | char | - | - | 1.0 | 1.0 | 0.0 | - | - | -96..0 dB |
| ARG_KANAL_1 | + | - | 0-n | - | unsigned long | - | TAudioKanal | - | - | - | - | - | Kanalnummer |
...
| ARG | STR | STPR | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | MIN | MAX | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ARG_DREHZAHL | + | - | - | high | unsigned char | - | - | 1.0 | 1.0 | 0.0 | 0.0 | 100.0 | Drehzahl des Lüfters in Prozent |
...
| ARG | STR | STPR | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | MIN | MAX | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ARG_MEHRKANALEINGANG | + | - | 0-n | high | unsigned char | - | TAB_MEHRKANAL | - | - | - | - | - | Mehrkanal Eingang der Signalverarbeitung im DSP |
...
| 0xB7F4BB | Kalibrierung: Steuergerät nicht kalibriert | 0 |
...
| 0xD6C43F | MOST: Empfänger hat Nachricht nicht abgenommen | 1 |
| 0xD6C440 | Reset | 0 |
| 0xD6C442 | Abschaltung Übertemperatur | 1 |
| 0xD6C445 | MOST: Reset | 0 |
...
| ORT | ORTTEXT | EREIGNIS_DTC |
| --- | --- | --- |
| 0x0B7495 | Entwickler-EQ: ungueltige Checksumme | 0 |
...
| RESULTNAME | STR | STPR | RRR | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_ROUTINE_MIKROFONTEST | - | - | + | 0-n | high | unsigned char | - | TAB_TESTSTATUS | - | - | - | Ergebnis der Routine aus dem Mikrofontest siehe Beschreibung Tabelle TTestStatus |
| STAT_REFERENZ_WERT | - | - | + | - | high | unsigned char | - | - | 1.0 | 1.0 | 0.0 | Im Steuergerät hinterlegter Referenzwert. |
| STAT_LEVEL_WERT | - | - | + | - | high | unsigned char | - | - | 1.0 | 1.0 | 0.0 | Über die Routine gemessener Wert. |
...
| RESULTNAME | STR | STPR | RRR | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_TEST_VERBAU_VERSTAERKER | - | - | + | 0-n | high | unsigned char | - | TAB_TESTSTATUS | - | - | - | Gibt den Status des Verbautests wieder. Nach dem Herunterfahren oder Neustart des Steuergerätes wird der Status automatisch auf 0 zurückgesetzt. |
...
| MIKROFON_KALIBRIERUNG | 0xA091 | - | Kalibrierung des Mikrofons des Top-Hifi Verstärkers | - | - | - | - | - | - | - | - | - | 31 | - | RES_0xA091_R |
...
| MIKROFON_KALIBRIERUNG_LOESCHEN | 0xA0C9 | - | Mit dem Job wird die Kalibrierung des Mikrofons gelöscht. | - | - | - | - | - | - | - | - | - | 31 | - | - |
| AUDIOKANAELE | 0xA0CC | - | Verstellt und liest den aktuell eingestellten Lautsprecherkanal. | - | - | - | - | - | - | - | - | - | 31 | ARG_0xA0CC_R | - |
| LAUTSPRECHER_AUSGANG | 0xA0CD | - | Verstellt und liest gleichzeitig Kanal und Lautstärke. | - | - | - | - | - | - | - | - | - | 31 | ARG_0xA0CD_R | - |
...
| ASD_AUDIOQUELLE | 0xD09C | - | Audioquelle für MUTE | - | - | - | - | - | - | - | - | - | 2E;22 | ARG_0xD09C_D | RES_0xD09C_D |
| AKTIVIEREN_EQSET | 0x4FFA | - | Aktivieren des hintelegten EQ Datensatzes | - | - | - | - | - | - | - | - | - | 2E | ARG_0x4FFA_D | - |
| LEISTUNGSZUSTAENDE_MOST | 0x4FFD | STAT_LEISTUNGSZUSTAND | Leistungszustände MOST | 0-n | - | high | unsigned char | LEISTUNGSZUSTAND | - | - | - | - | 22 | - | - |
| LUEFTER | 0xF001 | - | Steuerung Lüfter EIN/AUS | - | - | - | - | - | - | - | - | - | 31 | ARG_0xF001_R | - |
| MEHRKANAL_ZUTEILUNG | 0xF002 | - | MOST Mono Eingang kann verschiedenen Mehrkanaleingängen des Signalflusses zugeteilt werden. | - | - | - | - | - | - | - | - | - | 31 | ARG_0xF002_R | - |
...
<a id="table-tcodingmodelrange"></a>
### TCODINGMODELRANGE
...
<a id="table-tcodinghybridtype"></a>
### TCODINGHYBRIDTYPE
...
<a id="table-tcodingsteeringwheel"></a>
### TCODINGSTEERINGWHEEL
