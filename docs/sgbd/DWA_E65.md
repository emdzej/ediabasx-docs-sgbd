...
| Field | Value |
| --- | --- |
| ECU | DWA - Innenraumschutz E65-68, E60-61, PL2 ausser E88 und E93   |
| ORIGIN | BMW EI-61 Thomas Reiter |
| REVISION | 3.000 |
| AUTHOR | Megamos PE/SW van_der_Linde |
| COMMENT | SGBD fuer DWA E65-68, E60-61, PL2 ausser E88 und E93   |
| PACKAGE | 1.29 |
| SPRACHE | deutsch |
...
- [STATUS_KLEMME_30](#job-status-klemme-30) - Auslesen der Klemme 30 Spannung an der DWA KWP2000: $30 InputOutputControlByLocalIdentifier $01 ReportCurrentState Modus  : Default
- [STATUS_DWA_LED_EIN](#job-status-dwa-led-ein) - Auslesen der Stati von der DWA_LED KWP2000: $30 InputOutputControlByLocalIdentifier $01 ReportCurrentState
- [STATUS_DWA_ALARMTRIGGER](#job-status-dwa-alarmtrigger) - Abfrage des DWA Status KWP2000: $21 ReadDataByLocalIdentifier $fa DWA - spezifischer Test: Alarmtrigger Lesen
- [STATUS_DWA_INTERN](#job-status-dwa-intern) - Abfrage der internen DWA Status KWP2000: $21 ReadDataByLocalIdentifier $fb DWA specific test
- [STATUS_SENSOR_EMPFINDLICHKEIT](#job-status-sensor-empfindlichkeit) - Auslesen der Sensorempfindlichkeit KWP2000: $30 InputOutputControlByLocalIdentifier $01 ReportCurrentState
- [STEUERN_ALARMTEST_START](#job-steuern-alarmtest-start) - DWA Test-Alarmausgabe starten KWP2000: Byte 0: $31 StartRoutineByLocalIdentifier Byte 1: $04 DWA specific test Byte 2: $07 ShortTermAdjustment Byte 3: $02 Alarmtest start Funktion: -Alarmausgabe starten -optischer Alarm gemäß Codierung -SiNe Alarm Vorbedingung: -DWA entschärft -US_SCHNELLTEST und ALARMTEST inaktiv Abbruch-/Endebedingung: -Deaktivierung mit STEUERN_ALARMTEST_STOP oder -30 Sek. Timeout
- [STEUERN_ALARMTEST_STOP](#job-steuern-alarmtest-stop) - DWA Test-Alarmausgabe beenden KWP2000: Byte 0: $31 StartRoutineByLocalIdentifier Byte 1: $04 DWA specific test Byte 2: $03 stop & returnControlToECU Funktion: -Test-Alarmausgabe beenden Vorbedingung: -ALARMTEST aktiv
- [STEUERN_DWA_LED](#job-steuern-dwa-led) - Ansteuern der DWA-LED KWP2000: Byte 0: $30 InputOutputControlByLocalIdentifier Byte 1: $02 DWA-LED Byte 2: $07 ShortTermAdjustment Byte 3: $00/$01 AUS/EIN Funktion: -Uebernahme der Steuerung der DWA-LED per Diagnose -EIN/AUS durch argument "DIGITALWERT" Vorbedingung: -keine Abbruch-/Endebedingung: -Rueckgabe der Kontrolle an die Applikation mit STEUERN_DWA_LED_STOP oder -120 Sek. Timeout
- [STEUERN_DWA_LED_STOP](#job-steuern-dwa-led-stop) - Ansteuerung der DWA_LED aufheben KWP2000: Byte 0: $30 InputOutputControlByLocalIdentifier Byte 1: $02 DWA-LED Byte 2: $00 returnControlToECU Funktion: -Diagnose-Ansteuerung der DWA-LED aufheben / Rueckgabe der Kontrolle an die Applikation Vorbedingung: -keine
- [STEUERN_SCHNELLTEST_US](#job-steuern-schnelltest-us) - Aktivierung des Schnelltest Ultraschallsensor KWP2000: Byte 0: $31 StartRoutineByLocalIdentifier Byte 1: $04 DWA specific test Byte 2: $01 US Schnelltest Funktion: -Ultraschallsensor-Schnelltest mit verkürzter Referenzierungszeit (10 Sek.) -2 Sek. Alarmausgabe bei erkannter Bewegung Vorbedingung: -DWA-Zustand gleich "entschärft" und -SCHNELLTEST_US und ALARMTEST inaktiv Abbruch-/Endebedingung: -Bewegung erkannt und 2 Sek. Alarmausgabe beendet -5 Min. Timeout -"DWA entschärfen" - Signal
- [STEUERN_SIGNAL_HK_REVERSIEREN](#job-steuern-signal-hk-reversieren) - Startet 3malige Ausgabe des Doppeltons (Signal Heckklappe reversieren) KWP2000: $31 StartRoutineByLocalIdentifier $fd LocalIdentifier high $00 LocalIdentifier low
- [STEUERN_SENSOR_EMPF_MIN](#job-steuern-sensor-empf-min) - Setzen der Sensorempfindlichkeit auf Minimum KWP2000: $30 InputOutputControlByLocalIdentifier $07 SetCurrentState $01 Mode 1
- [STEUERN_SENSOR_EMPF_MAX](#job-steuern-sensor-empf-max) - Setzen der Sensorempfindlichkeit auf Maximum KWP2000: $30 InputOutputControlByLocalIdentifier $07 SetCurrentState $00 Mode 0
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_KLEMME_30_WERT | int | Spannung Klemme 30 an der DWA |
| STAT_KLEMME_30_EINH | string | Einheit Volt |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |

<a id="job-status-dwa-led-ein"></a>
### STATUS_DWA_LED_EIN
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei |
| STAT_DWA_LED_EIN | int | Status der DWA-LED 0: LED aus 1: LED ein |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_FT_AUSGEL | int | 0: RUHEZUSTANDAND 1: AUSGELOEST |
| STAT_FTH_AUSGEL | int | 0: RUHEZUSTANDAND 1: AUSGELOEST |
| STAT_BFT_AUSGEL | int | 0: RUHEZUSTANDAND 1: AUSGELOEST |
| STAT_BFTH_AUSGEL | int | 0: RUHEZUSTANDAND 1: AUSGELOEST |
| STAT_MOT_AUSGEL | int | 0: RUHEZUSTANDAND 1: AUSGELOEST |
| STAT_HKL_AUSGEL | int | 0: RUHEZUSTANDAND 1: AUSGELOEST |
| STAT_US_AUSGEL | int | 0: RUHEZUSTANDAND 1: AUSGELOEST |
| STAT_NG_AUSGEL | int | 0: RUHEZUSTANDAND 1: AUSGELOEST |
| STAT_KBUS_AUSGEL | int | 0: RUHEZUSTANDAND 1: AUSGELOEST |
| STAT_AUTH_AUSGEL | int | 0: RUHEZUSTANDAND 1: AUSGELOEST |
| STAT_BUS_MANIP_AUSGEL | int | 0: RUHEZUSTANDAND 1: AUSGELOEST |
| STAT_RDC_AUSGEL | int | 0: RUHEZUSTANDAND 1: AUSGELOEST |
| STAT_DISTRIBUTION_AUSGEL | int | 0: RUHEZUSTANDAND 1: AUSGELOEST |
| STAT_RSCR_AUSGEL | int | 0: RUHEZUSTANDAND 1: AUSGELOEST |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei |
| STAT_DWA_ZUSTAND_GESAMT | int | Flags der Zustaende des DWA-Systems Bedeutung im Einzelnen siehe unten |
| STAT_DWA_ZUSTAND_SCHARF | int | 0: DWA - System entschaerft 1: DWA - System geschaerft |
| STAT_DWA_US_NG_AUS_AKTIV | int | 0: IRS und NG - Normalbetrieb 1: IRS und NG - Abgeschaltet durch 2. Schluesseltastendruck |
| STAT_DWA_HOT_AKTIV | int | 0: Hotelstellung inaktiv 1: Hotelstellung aktiv |
| STAT_DWA_DISTR_AKTIV | int | 0: DWA Normalbetrieb 1: DWA im Distributionsmodus |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei |
| STAT_EMPFINDLICHKEIT | int | Status der DWA-Empfindlichkeit: 0: maximale Empfindlichkeit 1: minimale Empfindlichkeit 2..6: Zwischenwerte |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |

<a id="job-steuern-alarmtest-start"></a>
...
<a id="job-steuern-alarmtest-stop"></a>
...
<a id="job-steuern-dwa-led-stop"></a>
...
<a id="job-steuern-schnelltest-us"></a>
### STEUERN_SCHNELLTEST_US
...
| Name | Type | Comment |
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn Vorbedingungen erfüllt |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |

<a id="job-steuern-signal-hk-reversieren"></a>
...
<a id="job-steuern-sensor-empf-min"></a>
...
<a id="job-steuern-sensor-empf-max"></a>
...
- [HORTTEXTE](#table-horttexte) (21 × 2)
