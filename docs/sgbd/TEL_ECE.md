...
| REVISION | 1.02 |
| AUTHOR | ERD PSE PRO CDA4, BMW TI-431 Rochal |
| COMMENT | Erstellt von Pichler Maik |
| PACKAGE | 1.32 |
| SPRACHE | deutsch |
...
- [SBDH_Logoff](#job-sbdh-logoff) - Hörerabmelden KWP2000: $31 StartroutineByLocalID Modus  : Default
- [SBDH_Logon](#job-sbdh-logon) - Höreranmelden KWP2000: $31 StartroutineByLocalID Modus  : Default
- [SBDH_UndoDeviceCode](#job-sbdh-undodevicecode) - Gerätecode zurücksetzen KWP2000: $31 StartroutineByLocalID Modus  : Default
- [RFPI_LESEN](#job-rfpi-lesen) - RFPI-Kennung lesen KWP2000: $21 ReadDataByLocalID $B1 RFPI_Nummer Modus  : Default
- [IMEI_LESEN](#job-imei-lesen) - IMEI-Kennung lesen KWP2000: $21 ReadDataByLocalID $B2 IMEI_Nummer Modus  : Default
- [A20VER_LESEN](#job-a20ver-lesen) - GSM-Versions-Nummer lesen KWP2000: $21 ReadDataByLocalID $B4 A20VER_Nummer Modus  : Default
- [BASISVER_LESEN](#job-basisver-lesen) - Basis-Versions-Nummer lesen KWP2000: $21 ReadDataByLocalID $B3 Basis_Nummer Modus  : Default
- [BASIS_Init](#job-basis-init) - Basis initialisieren KWP2000: $31 StartroutineByLocalID Modus  : Default
- [Notruf_aktiv](#job-notruf-aktiv) - Betätigung Notruftaster löst Notruf aus KWP2000: $ 2E WriteDataByCommonIdentifier Modus  : Default
- [Notruf_deaktiv](#job-notruf-deaktiv) - Betätigung Notruftaster löst KEINEN Notruf aus KWP2000: $ 2E WriteDataByCommonIdentifier Modus  : Default
- [Notruf_Status](#job-notruf-status) - Auslesen des Status Notruffähigkeit KWP2000: $22 ReadByCommonIdentifier $3004 Notrufauslösung
...
<a id="job-sbdh-logoff"></a>
### SBDH_Logoff

Hörerabmelden KWP2000: $31 StartroutineByLocalID Modus  : Default
...
<a id="job-sbdh-logon"></a>
### SBDH_Logon

Höreranmelden KWP2000: $31 StartroutineByLocalID Modus  : Default
...
<a id="job-sbdh-undodevicecode"></a>
### SBDH_UndoDeviceCode

Gerätecode zurücksetzen KWP2000: $31 StartroutineByLocalID Modus  : Default
...
RFPI-Kennung lesen KWP2000: $21 ReadDataByLocalID $B1 RFPI_Nummer Modus  : Default
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| RFPI | string | Seriennummer des Steuergeraets |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |

<a id="job-imei-lesen"></a>
### IMEI_LESEN

IMEI-Kennung lesen KWP2000: $21 ReadDataByLocalID $B2 IMEI_Nummer Modus  : Default
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| IMEI | string | Seriennummer des Steuergeraets |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |

<a id="job-a20ver-lesen"></a>
### A20VER_LESEN

GSM-Versions-Nummer lesen KWP2000: $21 ReadDataByLocalID $B4 A20VER_Nummer Modus  : Default
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| A20VER | string | Seriennummer des Steuergeraets |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |

<a id="job-basisver-lesen"></a>
### BASISVER_LESEN

Basis-Versions-Nummer lesen KWP2000: $21 ReadDataByLocalID $B3 Basis_Nummer Modus  : Default
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| BASISVER | string | Seriennummer des Steuergeraets |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |

<a id="job-basis-init"></a>
### BASIS_Init

Basis initialisieren KWP2000: $31 StartroutineByLocalID Modus  : Default
...
<a id="job-notruf-aktiv"></a>
### Notruf_aktiv

Betätigung Notruftaster löst Notruf aus KWP2000: $ 2E WriteDataByCommonIdentifier Modus  : Default
...
<a id="job-notruf-deaktiv"></a>
### Notruf_deaktiv

Betätigung Notruftaster löst KEINEN Notruf aus KWP2000: $ 2E WriteDataByCommonIdentifier Modus  : Default
...
<a id="job-notruf-status"></a>
### Notruf_Status

Auslesen des Status Notruffähigkeit KWP2000: $22 ReadByCommonIdentifier $3004 Notrufauslösung
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_NOTRUF | int | Status ob Telefon Notruf auslösen kann 0 = darf nicht auslösen 1 = darf Notruf absetzen |
| STAT_NOTRUF_TEXT | string | Status ob Telefon Notruf absetzen darf als Text |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
- [NOTRUF_STATUS](#table-notruf-status) (3 × 2)
...
<a id="table-notruf-status"></a>
### NOTRUF_STATUS

Dimensions: 3 rows × 2 columns

| NOTRUF_STATUS_NR | NOTRUF_STATUS_MODE |
| --- | --- |
| 0x00 | NOTRUFAUSLÖSUNG ist nicht möglich |
| 0x01 | NOTRUFAUSLÖSUNG ist möglich |
| 0xXY | unbekannter Mode |
...
| 0x06 | NPR | Hex | high | unsigned char | -- | 1 | 1 | 0 |
