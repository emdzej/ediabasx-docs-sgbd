...
| Field | Value |
| --- | --- |
| ECU | Elektronische Wegfahrsperre 2 - alle Typen |
...
- [COD_LESEN](#job-cod-lesen) - Auslesen der Codierdaten der EWS
- [HERSTELLDATEN_LESEN](#job-herstelldaten-lesen) - Auslesen der Herstelldaten der EWS
...
- [STEUERN_DIGITAL](#job-steuern-digital) - Ansteuern / Vorgeben digitaler Stati der EWS
...
- [SCHL_SPERREN_FREIGEBEN](#job-schl-sperren-freigeben) - Schreiben der ISN-Nummer in die EWS
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, ERROR_.. |
| COD_DATEN | string | die 4 bzw. 5 Codierbytes |
| COD_GETRIEBE | string | Schaltgetriebe oder Automatik |
| COD_DME_FREIGABE | string | codiertes oder statisches Signal |
| COD_TRANSPONDER_CODE | string | Festcode oder Wechselcode |
| COD_ABSCHALTDREHZAHL | real | (5 bis 254)/0.3 1/s |
| COD_ABSCHALTZEIT | real | (1 bis 254)*0.3 s |
| COD_ZEIT_WS_SCHAERFEN | int | 0 bis 255 s |
| COD_DME_SS | int | 2 oder 3 (EWS mit Cod-Index &lt;2 immer 2) |
