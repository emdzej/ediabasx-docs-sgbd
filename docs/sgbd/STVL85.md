...
| Field | Value |
| --- | --- |
| ECU | Satellit Tuer vorne links |
| ORIGIN | BMW TI-430 Christian Marschner |
| REVISION | 1.03 |
| AUTHOR | BMW EE-53 Robert Schmidt, BMW EE-53 Thomas Theenhaus |
| COMMENT | 1.Version E85 |
| PACKAGE | 1.14 |
| SPRACHE | deutsch |
...
- [FORTTEXTE](#table-forttexte) (78 × 2)
...
| 0x962d | Timeout ID 01H (STVL) |
| 0x962e | Timeout ID 02H |
| 0x962f | Timeout ID 03H (STVR) |
| 0x9630 | Timeout ID 04H |
| 0x9631 | Timeout ID 05H (SBSL) |
| 0x9632 | Timeout ID 06H () |
| 0x9633 | Timeout ID 07H (SBSR) |
| 0x9634 | Timeout ID 08H (SASR) |
| 0x9635 | Timeout ID 09H (SIM |
| 0x9636 | Timeout ID 0AH (SIM) |
| 0x9637 | Timeout ID 0BH (SBSL) |
| 0x9638 | Timeout ID 0CH (SBSR) |
| 0x9639 | Timeout ID 0DH (SIM) |
| 0x963a | Timeout ID 0EH |
| 0x963b | Timeout ID 0FH |
| 0x963c | Timeout ID 20H (SBSL) |
| 0x963d | Timeout ID 21H (SBSR) |
| 0x963e | Timeout ID 22H () |
| 0x963f | Timeout ID 71H (SIM) |
| 0x9640 | Codierdaten Checksummenfehler |
| 0x9641 | Stack Overflow |
...
| 0x9646 | Kurzschluss oder Unterbrechung H/L-Side-Schalter ZK1 (E85: unbelegt) |
| 0x9647 | Kurzschluss ZK1 (E85: unbelegt) nach Masse |
| 0x9648 | Kurzschluss ZK1 (E85: unbelegt) nach Plus |
| 0x9649 | Widerstand Zuendpille ZK1 (E85: unbelegt) zu klein |
| 0x964a | Widerstand Zuendpille ZK1 (E85: unbelegt) zu gross |
| 0x964b | Widerstand Zuendpille ZK1 (E85: unbelegt) nicht gemessen |
| 0x964c | Unterbrechung ZK1 (E85: unbelegt) |
| 0x964d | Spannung ZK1 (E85: unbelegt) n.i.O. |
| 0x964e | Zuendkapazitaet ZK1 (E85: unbelegt) n.i.O. |
| 0x964f | Codierung/Konfiguration ZK1 (E85: unbelegt) unstimmig |
| 0x9650 | Unterbrechung Entladekreis ZK1 (E85: unbelegt) |
| 0x9651 | Kurzschluss oder Unterbrechung H/L-Side-Schalter ZK2 (E85: unbelegt) |
| 0x9652 | Kurzschluss ZK2 (E85: unbelegt) nach Masse |
| 0x9653 | Kurzschluss ZK2 (E85: unbelegt) nach Plus |
| 0x9654 | Widerstand Zuendpille ZK2 (E85: unbelegt) zu klein |
| 0x9655 | Widerstand Zuendpille ZK2 (E85: unbelegt) zu gross |
| 0x9656 | Widerstand Zuendpille ZK2 (E85: unbelegt) nicht gemessen |
| 0x9657 | Unterbrechung ZK2 (E85: unbelegt) |
| 0x9658 | Spannung ZK2 (E85: unbelegt) n.i.O. |
| 0x9659 | Zuendkapazitaet ZK2 (E85: unbelegt) n.i.O. |
| 0x965a | Codierung/Konfiguration ZK2 (E85: unbelegt) unstimmig |
| 0x965b | Unterbrechung Entladekreis ZK2 (E85: unbelegt) |
| 0x965d | Fehler im Alarmpfad |
| 0x965e | Algorithmus-Parameter inkonsistent |
...
| 0x9678 | Kommunkation mit ZündIC gestört |
...
| 0x967f | Codierung unvollstaendig |
