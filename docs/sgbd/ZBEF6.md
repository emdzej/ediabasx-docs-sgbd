...
| Field | Value |
| --- | --- |
| ECU | Zentrales Bedienelement Fond |
| ORIGIN | BMW EI-823 Andreas_Oellinger |
| REVISION | 1.001 |
| AUTHOR | PREH-GMBH EI-510 Braun |
| COMMENT | Neuanlage SGBD in SWL |
| PACKAGE | 1.70 |
| SPRACHE | deutsch |
...
- [ARG_0XD147_D](#table-arg-0xd147-d) (2 × 12)
- [ARG_0XD14D_D](#table-arg-0xd14d-d) (2 × 12)
- [ARG_0XD597_D](#table-arg-0xd597-d) (1 × 12)
...
- [IORTTEXTE](#table-iorttexte) (26 × 3)
...
- [TAB_ARG_STELLGLIED_POSITIONEN](#table-tab-arg-stellglied-positionen) (6 × 2)
...
| 0x026808 | Codierung: Steuergerät ist nicht codiert | 0 |
| 0x026809 | Codierung: Fehler bei Codierdatentransaktion aufgetreten | 0 |
| 0x02680A | Codierung: Signatur der Codierdaten ungültig | 0 |
| 0x02680B | Codierung: Codierdaten passen nicht zum Fahrzeug | 0 |
| 0x02680C | Codierung: Unplausible Daten während Codierdatentransaktion | 0 |
| 0x026820 | CAN-Fehler (Sammelfehler) | 0 |
| 0x026823 | Flash Memory Fehler (Sammelfehler) | 0 |
| 0x026826 | Hardwarefehler (Sammelfehler) | 0 |
| 0x026829 | Softwarefehler (Sammelfehler) | 0 |
...
| 0x670203 | TOUCHPAD_COMMUNICATION_TIMEOUT_OR_CRC_ERROR | 0 |
| 0x670204 | CONTROLLER_BFRID_ERROR | 0 |
...
| STEUERN_FUNKTIONS_LED_RSE | 0xD147 | - | Steuert die Funktions-LED in den RSE- Modulen. | - | - | - | - | - | - | - | - | - | 2E | ARG_0xD147_D | - |
...
| STEUERN_TASTEN_RSE | 0xD597 | - | Aufruf steuert die Tasten. | - | - | - | - | - | - | - | - | - | 2E | ARG_0xD597_D | - |
