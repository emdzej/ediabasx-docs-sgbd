...
| Field | Value |
| --- | --- |
| ECU | MSD85 fuer N63 und S63 mit EWS4 oder CAS  |
| ORIGIN | BMW EA-740 Lorch |
| REVISION | 7.000 |
| AUTHOR | P&Z EA-740 Berger |
| COMMENT | SGBD für MSD85 C-Muster mit SW 762EG00S und 9ZCE800S |
| PACKAGE | 1.66 |
| SPRACHE | deutsch |
...
- [STATUS_CONFIGMDRV](#job-status-configmdrv) - 0x225F82 STATUS_CONFIGMDRV M-Drive Konfiguration
...
- [STATUS_ZWDIAG](#job-status-zwdiag) - 0x333A STATUS_ZWDIAG CSERS Diagnose zur Fehlerdemo (Zuendwinkeldiagnose Status)
...
- [STEUERN_CONFIGMDRV](#job-steuern-configmdrv) - 0x2E5F82 STEUERN_CONFIGMDRV M-Drive Konfiguration vorgeben , NO_CON
...
- [STEUERN_ENDE_ZWDIAG](#job-steuern-ende-zwdiag) - 0x323A STEUERN_ENDE_ZWDIAG CSERS Diagnose zur Fehlerdemo (Zuendwinkeldiagnose Steuern-Ende)
...
- [STEUERN_ZWDIAG](#job-steuern-zwdiag) - 0x313A STEUERN_ZWDIAG CSERS Diagnose zur Fehlerdemo (Zuendwinkeldiagnose Steuern) 
...
- [STATUS_FREISCHALTUNG](#job-status-freischaltung) - Freischaltstatus der SA 7ME KWP2000: $31 StartRoutineByLocalIdentifier $1F SweepingTechnologies $F6 SWTGetStatus
...
- [STATUS_DAROL](#job-status-darol) - 0x224061 STATUS_DAROL Darol Lastkollektivdaten lesen (FASTA)
- [STATUS_DAROL1](#job-status-darol1) - 0x224062 STATUS_DAROL1 Darol Lastkollektivdaten Teil 2/5 lesen (FASTA)
- [STATUS_DAROL2](#job-status-darol2) - 0x224063 STATUS_DAROL2 Darol Lastkollektivdaten Teil 3/5 lesen (FASTA)
- [STATUS_DAROL3](#job-status-darol3) - 0x224064 STATUS_DAROL3 Darol Lastkollektivdaten Teil 4/5 lesen (FASTA)
- [STATUS_DAROL4](#job-status-darol4) - 0x224065 STATUS_DAROL4 Darol Lastkollektivdaten Teil 5/5 lesen (FASTA)
- [STATUS_DAROL_LESEN](#job-status-darol-lesen) - 0x22406x STATUS_DAROL_LESEN Job zum Auslesen der DAROL Lastkollektivdaten
...
| STAT_QVC_STATUS_1_WERT | real | Ausgang fuer SchluesselgroeÃŸe 1 (A2L-Name: Qvc_status_1) Qvc_status_1   Einheit: %   Min: 0 Max: 99.6093 |
| STAT_QVC_STATUS_1_EINH | string | percent |
| STAT_QVC_STATUS_2_WERT | real | Ausgang fuer SchluesselgroeÃŸe 2 (A2L-Name: Qvc_status_2) Qvc_status_2   Einheit: %   Min: 0 Max: 99.6093 |
| STAT_QVC_STATUS_2_EINH | string | percent |
| STAT_QVC_STATUS_3 | unsigned long | Ausgang fuer SchluesselgroeÃŸe 3 (A2L-Name: Qvc_status_3) Qvc_status_3   Min: 0 Max: 255 |
| STAT_QVC_STATUS_4 | long | Ausgang fuer SchluesselgroeÃŸe 4 (A2L-Name: Qvc_status_4) Qvc_status_4   Min: -128 Max: 127 |
...
| Name | Type | Comment |
| --- | --- | --- |
| STAT_STAT_AGK | unsigned long | Status Abgasklappe LV_EF[1] (t.b.d.)   Min: 0 Max: 1 |
| JOB_STATUS | string | "OKAY", wenn fehlerfrei |
| _TEL_AUFTRAG | binary | Hex-Auftrag an SG |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| STAT_AN_LUFTTEMPERATUR1_WERT | real | Rohwert Ansauglufttemperatur 1 TIA_MES[1]   Einheit: C   Min: -48 Max: 142.5 |
...
| STAT_B_SPA_CIST_TEXT | string | Zurueckgemeltdete Codierung SPA, 0 = Schaltpunktanzeige inaktiv, 1 = Schaltpunktanzeige aktiv B_SPA_CIST   Min: 0 Max: 1 |
| STAT_B_SPA_CIST_WERT | int | Zurueckgemeltdete Codierung SPA, 0 = Schaltpunktanzeige inaktiv, 1 = Schaltpunktanzeige aktiv B_SPA_CIST   Min: 0 Max: 1 |
| JOB_STATUS | string | "OKAY", wenn fehlerfrei |
| _TEL_AUFTRAG | binary | Hex-Auftrag an SG |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
<a id="job-status-configmdrv"></a>
### STATUS_CONFIGMDRV

0x225F82 STATUS_CONFIGMDRV M-Drive Konfiguration
...
| Name | Type | Comment |
| --- | --- | --- |
| STAT_STATE_SPT_ESP_CAN_TEXT | string | CAN: MDrive ESP sport mode (A2L-Name: state_spt_esp_can) STATE_SPT_ESP_CAN   Min: 0 Max: 5 |
| STAT_STATE_SPT_ESP_CAN_WERT | int | CAN: MDrive ESP sport mode (A2L-Name: state_spt_esp_can) STATE_SPT_ESP_CAN   Min: 0 Max: 5 |
| STAT_STATE_SPT_ECU_CAN_TEXT | string | CAN: Mdrive ECU sport mode (A2L-Name: state_spt_ecu_can) STATE_SPT_ECU_CAN   Min: 0 Max: 3 |
| STAT_STATE_SPT_ECU_CAN_WERT | int | CAN: Mdrive ECU sport mode (A2L-Name: state_spt_ecu_can) STATE_SPT_ECU_CAN   Min: 0 Max: 3 |
| STAT_STATE_SPT_SUS_CAN_TEXT | string | CAN: MDrive suspension sport mode (A2L-Name: state_spt_sus_can) STATE_SPT_SUS_CAN   Min: 0 Max: 10 |
| STAT_STATE_SPT_SUS_CAN_WERT | int | CAN: MDrive suspension sport mode (A2L-Name: state_spt_sus_can) STATE_SPT_SUS_CAN   Min: 0 Max: 10 |
| STAT_STATE_SPT_HUD_CAN_TEXT | string | CAN: MDrive head up display mode (A2L-Name: state_spt_hud_can) STATE_SPT_HUD_CAN   Min: 0 Max: 1 |
| STAT_STATE_SPT_HUD_CAN_WERT | int | CAN: MDrive head up display mode (A2L-Name: state_spt_hud_can) STATE_SPT_HUD_CAN   Min: 0 Max: 1 |
| STAT_STATE_SPT_PSTE_CAN_TEXT | string | CAN: Mdrive powersteering STATE_SPT_PSTE_CAN |
| STAT_STATE_SPT_PSTE_CAN_WERT | int | CAN: Mdrive powersteering STATE_SPT_PSTE_CAN |
| JOB_STATUS | string | "OKAY", wenn fehlerfrei |
| _TEL_AUFTRAG | binary | Hex-Auftrag an SG |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| STAT_STAT_DK_WERT | real | Drosselklappenwinkel Bank 1 TPS_AV[1]   Einheit: TPS   Min: 0 Max: 119.5 |
...
| STAT_STAT_DKP2_WERT | real | Drosselklappenwinkel Bank 2 TPS_AV[2]   Einheit: TPS   Min: 0 Max: 119.5 |
...
| STAT_F_LRADAP1_C_0_WERT | real | Faktoren aus KLANN-Befragung an applizierten Zentren Bank1   00 F_lradap1_c_[0]   Min: -50 Max: 49.9984 |
...
| STAT_F_LRADAP2_C_0_WERT | real | Faktoren aus KLANN-Befragung an applizierten Zentren Bank2   00 F_LRADAP2_C_[0]   Min: -50 Max: 49.9984 |
| STAT_F_LRADAP2_C_1_WERT | real | Faktoren aus KLANN-Befragung an applizierten Zentren Bank2   01 F_LRADAP2_C_[1]   Min: -50 Max: 49.9984 |
| STAT_F_LRADAP2_C_2_WERT | real | Faktoren aus KLANN-Befragung an applizierten Zentren Bank2   02 F_LRADAP2_C_[2]   Min: -50 Max: 49.9984 |
| STAT_F_LRADAP2_C_3_WERT | real | Faktoren aus KLANN-Befragung an applizierten Zentren Bank2   03 F_LRADAP2_C_[3]   Min: -50 Max: 49.9984 |
| STAT_F_LRADAP2_C_4_WERT | real | Faktoren aus KLANN-Befragung an applizierten Zentren Bank2   04 F_LRADAP2_C_[4]   Min: -50 Max: 49.9984 |
| STAT_F_LRADAP2_C_5_WERT | real | Faktoren aus KLANN-Befragung an applizierten Zentren Bank2   05 F_LRADAP2_C_[5]   Min: -50 Max: 49.9984 |
| STAT_F_LRADAP2_C_6_WERT | real | Faktoren aus KLANN-Befragung an applizierten Zentren Bank2   06 F_LRADAP2_C_[6]   Min: -50 Max: 49.9984 |
| STAT_F_LRADAP2_C_7_WERT | real | Faktoren aus KLANN-Befragung an applizierten Zentren Bank2   07 F_LRADAP2_C_[7]   Min: -50 Max: 49.9984 |
| STAT_F_LRADAP2_C_8_WERT | real | Faktoren aus KLANN-Befragung an applizierten Zentren Bank2   08 F_LRADAP2_C_[8]   Min: -50 Max: 49.9984 |
| STAT_F_LRADAP2_C_9_WERT | real | Faktoren aus KLANN-Befragung an applizierten Zentren Bank2   09 F_LRADAP2_C_[9]   Min: -50 Max: 49.9984 |
| STAT_F_LRADAP2_C_10_WERT | real | Faktoren aus KLANN-Befragung an applizierten Zentren Bank2   10 F_LRADAP2_C_[10]   Min: -50 Max: 49.9984 |
| STAT_F_LRADAP2_C_11_WERT | real | Faktoren aus KLANN-Befragung an applizierten Zentren Bank2   11 F_LRADAP2_C_[11]   Min: -50 Max: 49.9984 |
| STAT_F_LRADAP2_C_12_WERT | real | Faktoren aus KLANN-Befragung an applizierten Zentren Bank2   12 F_LRADAP2_C_[12]   Min: -50 Max: 49.9984 |
| STAT_F_LRADAP2_C_13_WERT | real | Faktoren aus KLANN-Befragung an applizierten Zentren Bank2   13 F_LRADAP2_C_[13]   Min: -50 Max: 49.9984 |
| STAT_F_LRADAP2_C_14_WERT | real | Faktoren aus KLANN-Befragung an applizierten Zentren Bank2   14 F_LRADAP2_C_[14]   Min: -50 Max: 49.9984 |
| JOB_STATUS | string | "OKAY", wenn fehlerfrei |
| _TEL_AUFTRAG | binary | Hex-Auftrag an SG |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| STAT_TI_OFS_CMB_AD_032_WERT | real | Offset der Einspritzzeit Zyl. 4 (relative to injection time map) (A2L-Name: ti_ofs_cmb_ad[32]) TI_OFS_CMB_AD[32]   Einheit: [ms]   Min: -13.1072 Max: 13.1064 |
| STAT_TI_OFS_CMB_AD_032_EINH | string | lbracketmsrbracket |
| STAT_TI_OFS_CMB_AD_048_WERT | real | Offset der Einspritzzeit Zyl. 8 (relative to injection time map) (A2L-Name: ti_ofs_cmb_ad[48]) TI_OFS_CMB_AD[48]   Einheit: [ms]   Min: -13.1072 Max: 13.1064 |
| STAT_TI_OFS_CMB_AD_048_EINH | string | lbracketmsrbracket |
| STAT_TI_OFS_CMB_AD_064_WERT | real | Offset der Einspritzzeit Zyl. 6 (relative to injection time map) (A2L-Name: ti_ofs_cmb_ad[64]) TI_OFS_CMB_AD[64]   Einheit: [ms]   Min: -13.1072 Max: 13.1064 |
| STAT_TI_OFS_CMB_AD_064_EINH | string | lbracketmsrbracket |
| STAT_TI_OFS_CMB_AD_080_WERT | real | Offset der Einspritzzeit Zyl. 3 (relative to injection time map) (A2L-Name: ti_ofs_cmb_ad[80]) TI_OFS_CMB_AD[80]   Einheit: [ms]   Min: -13.1072 Max: 13.1064 |
| STAT_TI_OFS_CMB_AD_080_EINH | string | lbracketmsrbracket |
| STAT_TI_OFS_CMB_AD_096_WERT | real | Offset der Einspritzzeit Zyl. 7 (relative to injection time map) (A2L-Name: ti_ofs_cmb_ad[96]) TI_OFS_CMB_AD[96]   Einheit: [ms]   Min: -13.1072 Max: 13.1064 |
| STAT_TI_OFS_CMB_AD_096_EINH | string | lbracketmsrbracket |
| STAT_TI_OFS_CMB_AD_112_WERT | real | Offset der Einspritzzeit Zyl. 2 (relative to injection time map) (A2L-Name: ti_ofs_cmb_ad[112]) TI_OFS_CMB_AD[112]   Einheit: [ms]   Min: -13.1072 Max: 13.1064 |
...
| Name | Type | Comment |
| --- | --- | --- |
| STAT_PHY_MSV_WERT | unsigned long | Status Mengensteuerventil Bank 1 FUP_H_MPL[0]   Einheit: hPa   Min: 0 Max: 347776 |
...
| Name | Type | Comment |
| --- | --- | --- |
| STAT_OBDCOND | unsigned long | OBD Monitoring Conditions Encountered Counts (general denominator) 2BYTE in 0 bis 65534   Min: 0 Max: 65534 |
| STAT_IGNCNTR | unsigned long | Ignition Counter 2BYTE in 0 bis 65534   Min: 0 Max: 65534 |
| STAT_CATCOMP1 | unsigned long | Catalyst Monitor Completion Counts Bank 1 (numerator) 2BYTE in 0 bis 65534   Min: 0 Max: 65534 |
| STAT_CATCOND1 | unsigned long | Catalyst Monitor Conditions Encountered Counts Bank 1 (denominator) 2BYTE in 0 bis 65534   Min: 0 Max: 65534 |
| STAT_CATCOMP2 | unsigned long | Catalyst Monitor Completion Counts Bank 2 (numerator) 2BYTE in 0 bis 65534   Min: 0 Max: 65534 |
| STAT_CATCOND2 | unsigned long | Catalyst Monitor Conditions Encountered Counts Bank 2 (denominator) 2BYTE in 0 bis 65534   Min: 0 Max: 65534 |
...
| STAT_O2DCOMP1 | unsigned long | O2 Down  Monitor Completion Condition Counts Bank 1 (numerator) 2BYTE in 0 bis 65534   Min: 0 Max: 65534 |
| STAT_O2DCOND1 | unsigned long | O2 DOWN Monitor Conditions Encountered Counts Bank 1 (denominator) 2BYTE in 0 bis 65534   Min: 0 Max: 65534 |
| STAT_O2DCOMP2 | unsigned long | O2 DOWN Monitor Completion Condition Counts Bank 2 (numerator) 2BYTE in 0 bis 65534   Min: 0 Max: 65534 |
| STAT_O2DCOND2 | unsigned long | O2 DOWN Monitor Conditions Encountered Counts Bank 2 (denominator) 2BYTE in 0 bis 65534   Min: 0 Max: 65534 |
| JOB_STATUS | string | "OKAY", wenn fehlerfrei |
| _TEL_AUFTRAG | binary | Hex-Auftrag an SG |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| STAT_CTR_COMP_RBM_CSERS_IVVT_IN_1 | unsigned long | Nummerator CERS VANOS Diagnose Einlass  Bank 1(A2L-Name: rbm_stat_CSERS_IVVT_IN_1.ctr_comp_rbm) CTR_COMP_RBM_CSERS_IVVT_IN_1   Min: 0 Max: 65535 |
| STAT_CTR_CDN_RBM_CSERS_IVVT_IN_1 | unsigned long | Denominator CERS Vanos Diagnose Einlass Bank1 (A2L-Name: rbm_stat_CSERS_IVVT_IN_1.ctr_cdn_rbm) CTR_CDN_RBM_CSERS_IVVT_IN_1   Min: 0 Max: 65535 |
| STAT_CTR_COMP_RBM_CSERS_IVVT_EX_1 | unsigned long | Nummerator CERS VANOS Diagnose Auslass  Bank 1 (A2L-Name: rbm_stat_CSERS_IVVT_EX_1.ctr_comp_rbm) CTR_COMP_RBM_CSERS_IVVT_EX_1   Min: 0 Max: 65535 |
| STAT_CTR_CDN_RBM_CSERS_IVVT_EX_1 | unsigned long | Denominator CERS Vanos Diagnose Auslass Bank1 (A2L-Name: rbm_stat_CSERS_IVVT_EX_1.ctr_cdn_rbm) CTR_CDN_RBM_CSERS_IVVT_EX_1   Min: 0 Max: 65535 |
| STAT_CTR_COMP_RBM_CSERS_IVVT_IN_2 | unsigned long | Nummerator CERS VANOS Diagnose Einlass  Bank 2 (A2L-Name: rbm_stat_CSERS_IVVT_IN_2.ctr_comp_rbm) CTR_COMP_RBM_CSERS_IVVT_IN_2   Min: 0 Max: 65535 |
| STAT_CTR_CDN_RBM_CSERS_IVVT_IN_2 | unsigned long | Denominator CERS Vanos Diagnose Einlass Bank2 (A2L-Name: rbm_stat_CSERS_IVVT_IN_2.ctr_cdn_rbm) CTR_CDN_RBM_CSERS_IVVT_IN_2   Min: 0 Max: 65535 |
| STAT_CTR_COMP_RBM_CSERS_IVVT_EX_2 | unsigned long | Nummerator CERS VANOS Diagnose Auslass  Bank 2(A2L-Name: rbm_stat_CSERS_IVVT_EX_2.ctr_comp_rbm) CTR_COMP_RBM_CSERS_IVVT_EX_2   Min: 0 Max: 65535 |
| STAT_CTR_CDN_RBM_CSERS_IVVT_EX_2 | unsigned long | Denominator CERS Vanos Diagnose Auslass Bank2 (A2L-Name: rbm_stat_CSERS_IVVT_EX_2.ctr_cdn_rbm) CTR_CDN_RBM_CSERS_IVVT_EX_2   Min: 0 Max: 65535 |
| JOB_STATUS | string | "OKAY", wenn fehlerfrei |
| _TEL_AUFTRAG | binary | Hex-Auftrag an SG |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| STAT_TANS_1_WERT | real | Temperatur vor Drosselklappe Bank 1 TANS_I_[0]   Einheit: C   Min: -3276.8 Max: 3276.7 |
...
| STAT_TANS_2_WERT | real | Temperatur vor Drosselklappe Bank 2 TANS_I_[1]   Einheit: C   Min: -3276.8 Max: 3276.7 |
...
| STAT_AN_LUFTTEMPERATUR2_WERT | real | Rohwert Ansauglufttemperatur 2 TIA_MES[2]   Einheit: C   Min: -48 Max: 142.5 |
...
| STAT_COND | unsigned long | Externe Aktivierungsbedingung fuer  Zylinderbalancing-Berechnung (A2L-Name: lv_er_bal_hom_ena_ext) LV_ER_BAL_HOM_ENA_EXT   Min: 0 Max: 1 |
| JOB_STATUS | string | "OKAY", wenn fehlerfrei |
| _TEL_AUFTRAG | binary | Hex-Auftrag an SG |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
<a id="job-steuern-configmdrv"></a>
### STEUERN_CONFIGMDRV

0x2E5F82 STEUERN_CONFIGMDRV M-Drive Konfiguration vorgeben , NO_CON

#### Arguments

| Name | Type | Comment |
| --- | --- | --- |
| SW_STATE_SPT_HUD_EXT_ADJ_WERT | string | CAN: MDrive head up display mode STATE_SPT_HUD_EXT_ADJ   Min: 0 Max: 1 |
| SW_STATE_SPT_SUS_EXT_ADJ_WERT | string | CAN: MDrive suspension sport mode STATE_SPT_SUS_EXT_ADJ   Min: 0 Max: 10 |
| SW_STATE_SPT_ESP_EXT_ADJ_WERT | string | CAN: MDrive ESP sport mode STATE_SPT_ESP_EXT_ADJ   Min: 0 Max: 5 |
| SW_STATE_SPT_ECU_EXT_ADJ_WERT | string | CAN: Mdrive ECU sport mode STATE_SPT_ECU_EXT_ADJ   Min: 0 Max: 3 |
| SW_STATE_SPT_PSTE_EXT_ADJ_WERT | string | CAN: Mdrive powersteering STATE_SPT_PSTE_EXT_ADJ |
...
| VANOSSPL_N_AZLVERSTL_WERT | unsigned long | Anzahl der Verstellungen  Default-Wert = 10 Dez. CYCNR_CAM_OFS_EXT_ADJ   Min: 0 Max: 255 |
...
| STAT_CTR_COMP_RBM_MEC_IVVT_IN_2 | unsigned long | (A2L-Name: rbm_stat_MEC_IVVT_IN_2.ctr_comp_rbm) CTR_COMP_RBM_MEC_IVVT_IN_2   Min: 0 Max: 65535 |
| STAT_CTR_CDN_RBM_MEC_IVVT_IN_2 | unsigned long | (A2L-Name: rbm_stat_MEC_IVVT_IN_2.ctr_cdn_rbm) CTR_CDN_RBM_MEC_IVVT_IN_2   Min: 0 Max: 65535 |
| STAT_CTR_COMP_RBM_MEC_IVVT_EX_2 | unsigned long | (A2L-Name: rbm_stat_MEC_IVVT_EX_2.ctr_comp_rbm) CTR_COMP_RBM_MEC_IVVT_EX_2   Min: 0 Max: 65535 |
| STAT_CTR_CDN_RBM_MEC_IVVT_EX_2 | unsigned long | (A2L-Name: rbm_stat_MEC_IVVT_EX_2.ctr_cdn_rbm) CTR_CDN_RBM_MEC_IVVT_EX_2   Min: 0 Max: 65535 |
...
| STAT_CTR_COMP_RBM_TOOTH_OFF_IN_2 | unsigned long | (A2L-Name: rbm_stat_TOOTH_OFF_IN_2.ctr_comp_rbm) CTR_COMP_RBM_TOOTH_OFF_IN_2   Min: 0 Max: 65535 |
| STAT_CTR_CDN_RBM_TOOTH_OFF_IN_2 | unsigned long | (A2L-Name: rbm_stat_TOOTH_OFF_IN_2.ctr_cdn_rbm) CTR_CDN_RBM_TOOTH_OFF_IN_2   Min: 0 Max: 65535 |
| STAT_CTR_COMP_RBM_TOOTH_OFF_EX_2 | unsigned long | (A2L-Name: rbm_stat_TOOTH_OFF_EX_2.ctr_comp_rbm) CTR_COMP_RBM_TOOTH_OFF_EX_2   Min: 0 Max: 65535 |
| STAT_CTR_CDN_RBM_TOOTH_OFF_EX_2 | unsigned long | (A2L-Name: rbm_stat_TOOTH_OFF_EX_2.ctr_cdn_rbm) CTR_CDN_RBM_TOOTH_OFF_EX_2   Min: 0 Max: 65535 |
...
Freischaltstatus der SA 7ME KWP2000: $31 StartRoutineByLocalIdentifier $1F SweepingTechnologies $F6 SWTGetStatus
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_FSC_WERT | int | FSC-Freischaltung 0 = deactivated / 1 = activated |
| STAT_FSC_TEXT | string | FSC-Freischaltung deactivated / activated |
| _TEL_AUFTRAG | binary | Hex-Auftrag an SG |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
| _DATEN | binary | Hex-Antwort von SG |
...
| Name | Type | Comment |
| --- | --- | --- |
| STAT_PHY_KDF_1_WERT | real | Kraftstoffdruck im Einspritzsystem (Raildruck) Bank 1 FUP_H_MPL[0]   Einheit: hPa   Min: 0 Max: 347776 |
...
| Name | Type | Comment |
| --- | --- | --- |
| STAT_DRL_ANZ_PWF | unsigned long | Anzahl der Powerfails fuer DAROL NvRam Daten (seit letzter FASTA-Prozedur) (A2L-Name: Drl_anz_pwf) Drl_anz_pwf   Min: 0 Max: 255 |
| STAT_DRL_ANZ_SAVE | unsigned long | Anzahl der Datenaenderungen DAROL im EEPROM abgelegt (A2L-Name: Drl_anz_save) Drl_anz_save   Min: 0 Max: 65535 |
| STAT_DRL_KM_BZG_WERT | unsigned long | Akkumulierte Bezugskilometerzahl fuer Ueberrollungen im DAROL-NvRam (A2L-Name: Drl_km_bzg) Drl_km_bzg   Einheit: km   Min: 0 Max: 4294967295 |
| STAT_DRL_KM_BZG_EINH | string | km |
| STAT_DRL_UEB_RDAT_0_WERT | real | DREC_Drl_ueb_rdat_[0] Drl_ueb_rdat_[0]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_RDAT_1_WERT | real | DREC_Drl_ueb_rdat_[1] Drl_ueb_rdat_[1]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_RDAT_2_WERT | real | DREC_Drl_ueb_rdat_[2] Drl_ueb_rdat_[2]   Min: -1e+018 Max: 1e+018 |
| JOB_STATUS | string | "OKAY", wenn fehlerfrei |
| _TEL_AUFTRAG | binary | Hex-Auftrag an SG |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |

<a id="job-status-darol1"></a>
### STATUS_DAROL1
...
| Name | Type | Comment |
| --- | --- | --- |
| STAT_DRL_UEB_FDAT_0_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[0]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_1_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[1]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_2_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[2]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_3_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[3]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_4_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[4]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_5_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[5]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_6_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[6]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_7_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[7]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_8_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[8]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_9_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[9]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_10_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[10]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_11_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[11]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_12_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[12]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_13_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[13]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_14_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[14]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_15_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[15]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_16_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[16]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_17_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[17]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_18_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[18]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_19_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[19]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_20_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[20]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_21_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[21]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_22_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[22]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_23_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[23]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_24_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[24]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_25_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[25]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_26_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[26]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_27_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[27]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_28_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[28]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_29_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[29]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_30_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[30]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_31_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[31]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_32_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[32]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_33_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[33]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_34_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[34]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_35_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[35]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_36_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[36]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_37_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[37]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_38_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[38]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_39_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[39]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_40_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[40]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_41_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[41]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_42_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[42]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_43_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[43]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_44_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[44]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_45_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[45]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_46_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[46]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_47_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[47]   Min: -1e+018 Max: 1e+018 |
| JOB_STATUS | string | "OKAY", wenn fehlerfrei |
| _TEL_AUFTRAG | binary | Hex-Auftrag an SG |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |

<a id="job-status-darol2"></a>
### STATUS_DAROL2
...
| Name | Type | Comment |
| --- | --- | --- |
| STAT_DRL_UEB_FDAT_48_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[48]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_49_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[49]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_50_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[50]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_51_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[51]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_52_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[52]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_53_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[53]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_54_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[54]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_55_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[55]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_56_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[56]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_57_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[57]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_58_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[58]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_59_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[59]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_60_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[60]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_61_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[61]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_62_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[62]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_63_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[63]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_64_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[64]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_65_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[65]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_66_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[66]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_67_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[67]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_68_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[68]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_69_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[69]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_70_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[70]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_71_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[71]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_72_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[72]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_73_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[73]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_74_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[74]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_75_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[75]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_76_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[76]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_77_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[77]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_78_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[78]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_79_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[79]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_80_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[80]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_81_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[81]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_82_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[82]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_83_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[83]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_84_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[84]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_85_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[85]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_86_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[86]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_87_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[87]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_88_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[88]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_89_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[89]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_90_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[90]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_91_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[91]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_92_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[92]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_93_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[93]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_94_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[94]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_95_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[95]   Min: -1e+018 Max: 1e+018 |
| JOB_STATUS | string | "OKAY", wenn fehlerfrei |
| _TEL_AUFTRAG | binary | Hex-Auftrag an SG |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |

<a id="job-status-darol3"></a>
### STATUS_DAROL3
...
| Name | Type | Comment |
| --- | --- | --- |
| STAT_DRL_UEB_FDAT_96_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[96]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_97_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[97]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_98_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[98]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_99_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[99]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_100_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[100]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_101_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[101]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_102_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[102]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_103_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[103]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_104_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[104]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_105_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[105]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_106_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[106]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_107_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[107]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_108_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[108]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_109_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[109]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_110_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[110]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_111_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[111]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_112_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[112]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_113_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[113]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_114_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[114]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_115_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[115]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_116_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[116]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_117_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[117]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_118_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[118]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_119_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[119]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_120_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[120]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_121_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[121]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_122_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[122]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_123_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[123]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_124_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[124]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_125_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[125]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_126_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[126]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_127_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[127]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_128_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[128]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_129_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[129]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_130_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[130]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_131_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[131]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_132_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[132]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_133_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[133]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_134_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[134]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_135_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[135]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_136_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[136]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_137_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[137]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_138_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[138]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_139_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[139]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_140_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[140]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_141_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[141]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_142_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[142]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_143_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[143]   Min: -1e+018 Max: 1e+018 |
| JOB_STATUS | string | "OKAY", wenn fehlerfrei |
| _TEL_AUFTRAG | binary | Hex-Auftrag an SG |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |

<a id="job-status-darol4"></a>
### STATUS_DAROL4
...
| Name | Type | Comment |
| --- | --- | --- |
| STAT_DRL_UEB_FDAT_144_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[144]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_145_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[145]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_146_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[146]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_147_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[147]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_148_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[148]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_149_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[149]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_150_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[150]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_151_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[151]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_152_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[152]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_153_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[153]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_154_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[154]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_155_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[155]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_156_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[156]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_157_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[157]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_158_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[158]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_159_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[159]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_160_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[160]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_161_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[161]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_162_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[162]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_163_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[163]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_164_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[164]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_165_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[165]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_166_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[166]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_167_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[167]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_168_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[168]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_169_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[169]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_170_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[170]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_171_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[171]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_172_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[172]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_173_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[173]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_174_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[174]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_175_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[175]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_176_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[176]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_177_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[177]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_178_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[178]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_179_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[179]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_180_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[180]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_181_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[181]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_182_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[182]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_183_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[183]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_184_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[184]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_185_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[185]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_186_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[186]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_187_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[187]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_188_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[188]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_189_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[189]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_190_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[190]   Min: -1e+018 Max: 1e+018 |
| STAT_DRL_UEB_FDAT_191_WERT | real | Matrix der Getriebeklassierung Vorwaertsgaenge (A2L-Name: Drl_ueb_fdat) Drl_ueb_fdat_[191]   Min: -1e+018 Max: 1e+018 |
| JOB_STATUS | string | "OKAY", wenn fehlerfrei |
| _TEL_AUFTRAG | binary | Hex-Auftrag an SG |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| --- | --- | --- |
| JOB_STATUS | string | "OKAY", wenn fehlerfrei |
| STAT_DRL_ANZ_PWF | int | Anzahl NvRam Fehler seit letztem FASTA-Auslesen |
| STAT_DRL_ANZ_SAVE | int | Anzahl Datenänderungen seit erstem Flashen |
| STAT_DRL_KM_BZG_WERT | long | Bezugskilometerstand der Erfassung |
| STAT_DRL_KM_BZG_EINH | string | Einheit des Bezugskilometerstandes |
| STAT_DRL_UEB_RDAT | binary | Array der Rückwärtsgänge (Werte 0 - 2) Die Werte werden in aufsteigender Reihenfolge als Bytearray ausgegeben |
| STAT_DRL_UEB_FDAT | binary | Array der Vorwärtsgänge (Werte 0 - 191) Die Werte werden in aufsteigender Reihenfolge als Bytearray ausgegeben {fdat[0](High Word, High Byte),fdat[0](High Word, Low Byte),fdat[0](Low Word, High Byte),fdat[0](Low Word, Low Byte),... ...,fdat[191](Low Word, High Byte),fdat[191](Low Word, Low Byte)} |
| _TEL_AUFTRAG | binary | Hex-Auftrag an SG |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
- [FARTTEXTEINDIVIDUELL](#table-farttexteindividuell) (452 × 2)
- [FARTTYP](#table-farttyp) (572 × 5)
- [FDETAILSTRUKTUR](#table-fdetailstruktur) (7 × 2)
- [FORTTEXTE](#table-forttexte) (574 × 2)
- [FUMWELTMATRIX](#table-fumweltmatrix) (574 × 5)
- [FUMWELTTEXTE](#table-fumwelttexte) (645 × 9)
...
- [MESSWERTETAB](#table-messwertetab) (645 × 12)
- [SG_DIAGNOSEKONZEPT](#table-sg-diagnosekonzept) (3 × 2)
- [STATUS_GENMANUFAK](#table-status-genmanufak) (6 × 2)
- [STATUS_GENTYPKENN](#table-status-gentypkenn) (21 × 2)
- [_CNV_S_11_EGCP_RANGE_290](#table-cnv-s-11-egcp-range-290) (12 × 2)
- [_CNV_S_11_RANGE_STAT_862](#table-cnv-s-11-range-stat-862) (11 × 2)
- [_CNV_S_12__CNV_S_12__698](#table-cnv-s-12-cnv-s-12-698) (14 × 2)
- [_CNV_S_19_ECOP_RANGE_806](#table-cnv-s-19-ecop-range-806) (20 × 2)
- [_CNV_S_4_EGCP_RANGE_294](#table-cnv-s-4-egcp-range-294) (5 × 2)
- [_CNV_S_4_EGCP_RANGE_301](#table-cnv-s-4-egcp-range-301) (5 × 2)
- [_CNV_S_5_LACO_RANGE_342](#table-cnv-s-5-laco-range-342) (6 × 2)
- [_CNV_S_5_THRO_RANGE_897](#table-cnv-s-5-thro-range-897) (6 × 2)
- [_CNV_S_5__CNV_S_5_D_631](#table-cnv-s-5-cnv-s-5-d-631) (6 × 2)
- [_CNV_S_6_LACO_RANGE_350](#table-cnv-s-6-laco-range-350) (7 × 2)
- [_CNV_S_6_RANGE_STAT_110](#table-cnv-s-6-range-stat-110) (7 × 2)
- [_CNV_S_7_EGCP_RANGE_275](#table-cnv-s-7-egcp-range-275) (8 × 2)
- [_CNV_S_7_RANGE_ECU__108](#table-cnv-s-7-range-ecu-108) (8 × 2)
...
- [_MSD85KWP_CNV_S_5_RANGE_STAT_1007_CM_9ZCE401S](#table-msd85kwp-cnv-s-5-range-stat-1007-cm-9zce401s) (5 × 2)
- [_MSD85KWP_CNV_S_4_RANGE_STAT_1006_CM_9ZCE401S](#table-msd85kwp-cnv-s-4-range-stat-1006-cm-9zce401s) (4 × 2)
- [_MSD85KWP_CNV_S_4_RANGE_STAT_1009_CM_9ZCE401S](#table-msd85kwp-cnv-s-4-range-stat-1009-cm-9zce401s) (4 × 2)
- [_MSD85KWP_CNV_S_2_RANGE_STAT_1008_CM_9ZCE401S](#table-msd85kwp-cnv-s-2-range-stat-1008-cm-9zce401s) (2 × 2)
- [_MSD85KWP_TABLE_STATUS_CONFIGMDRV_STATE_SPT_PSTE_CAN](#table-msd85kwp-table-status-configmdrv-state-spt-pste-can) (4 × 2)
...
- [_MSD85KWP_CNV_S_10_STATE_EOL__449_CM_4DC3200S_](#table-msd85kwp-cnv-s-10-state-eol-449-cm-4dc3200s) (10 × 2)
- [_MSD85KWP_CNV_S_13_STATE_DMTL_140_CM](#table-msd85kwp-cnv-s-13-state-dmtl-140-cm) (21 × 2)
...
- [_MSD85KWP_TABLE_FS](#table-msd85kwp-table-fs) (11 × 2)
- [_MSD85KWP_CNV_S_4_CYBL_RANGE_180_CM_792A900S](#table-msd85kwp-cnv-s-4-cybl-range-180-cm-792a900s) (4 × 2)
- [_MSD85KWP_CNV_S_4_CYBL_RANGE_179_CM_792A900S](#table-msd85kwp-cnv-s-4-cybl-range-179-cm-792a900s) (4 × 2)
- [_MSD85KWP_CNV_S_4_STATE_CH_776_CM_762E940S](#table-msd85kwp-cnv-s-4-state-ch-776-cm-762e940s) (4 × 2)
...
| 0x1576 | Fehler untere Rückstellfeder  |
...
| 0x157B | Drosselklappen Lageregelung (Bank 1) - klemmt kurzzeitig |
| 0x157C | Drosselklappen Lageregelung (Bank 1) - klemmt anhaltend |
| 0x157D | Drosselklappen Lageregelung (Bank 2) - klemmt kurzzeitig |
| 0x157E | Drosselklappen Lageregelung (Bank 2) - klemmt anhaltend |
| 0x157F | Drosselklappen Lageregelung (Bank 1) - klemmt  |
| 0x1580 | Drosselklappen Lageregelung (Bank 2) - klemmt |
| 0x1581 | Mengenregelung außerhalb gültigem Bereich |
| 0x1582 | Anforderung ICM unplausibel |
| 0x1583 | Kurzschluß nach Masse |
| 0x1584 | Minimaltemperatur unplausibel |
| 0x1585 | Maximaltemperatur unplausibel |
| 0x1586 | Signal hängt |
...
| 0x158C | Adaption außerhalb gültigem Bereich |
...
| 0x15D1 | Übertragbares Moment zu niedrig, Kupplung leicht geschädigt |
| 0x15D2 | Übertragbares Moment zu niedrig, Kupplung geschädigt |
| 0x15D3 | Getriebeöltemperatur zu hoch |
| 0x15D4 | Zündwinkel zu früh |
| 0x15D9 | Prüfsumme falsch |
| 0x15DA | fehlt |
| 0x15DD | Ungültige Botschaft |
| 0x15DF | Minimaler geschätzter Adaptionsbereich unterschritten |
| 0x15E0 | Maximaler geschätzter Adaptionsbereich überschritten |
| 0x15E1 | Maximaler Adaptionsbereich überschritten |
| 0x15E2 | Minimaler Adaptionsbereich unterschritten |
| 0x15E3 | Minimalwert zylinderselektive Gesamtadaption unterschritten  |
| 0x15E4 | Maximalwert zylinderselektive Gesamtadaption überschritten  |
| 0x15E5 | Minimalwert zylinderbankselektive Gesamtadaption unterschritten  |
| 0x15E6 | Maximalwert zylinderbankselektive Gesamtadaption überschritten  |
| 0x15E9 | Übertragbares Moment zu niedrig, Kupplung stark geschädigt |
| 0x15EA | Batteriedefekt |
...
| 0x16CC | Periodendauer zu groß, Luftmasse zu niedrig |
| 0x16CD | erwarteter Adaptionswert unter gültigem Bereich |
| 0x16CE | erwarteter Adaptionswert über gültigem Bereich |
...
| 0x16DD | Abschaltung Kühlmittelpumpe 2 wegen Überspannung |
| 0x16DE | Abschaltung Kühlmittelpumpe 2 wegen Übertemperatur |
| 0x16DF | Abschaltung Kühlmittelpumpe 2 wegen Blockierung |
...
| 0x16E5 | Übertemperatur erkannt |
| 0x16E6 | Übertemperatur mit Vorschädigung Getriebeölkühlerleitung erkannt |
...
| 0x16FC | Geschwindigkeitsdifferenz rechts zu links zu hoch |
...
| 0x1732 | elektrischer Notlauf aktiv |
| 0x1733 | Übertemperatur mit Schädigung Getriebeöl erkannt |
| 0xFFFF | unbekannte Fehlerart |

<a id="table-farttyp"></a>
### FARTTYP

Dimensions: 572 rows × 5 columns
...
| 0x2A0A | 0x0000 | 0x0000 | 0x1571 | 0x1570 |
| 0x2A0B | 0x0000 | 0x0000 | 0x1571 | 0x1570 |
...
| 0x2AC0 | 0x0000 | 0x15A5 | 0x15A6 | 0x15A4 |
| 0x2AC2 | 0x0000 | 0x0000 | 0x0000 | 0x104F |
| 0x2AC3 | 0x0000 | 0x0000 | 0x0000 | 0x104F |
| 0x2AC4 | 0x0000 | 0x16C7 | 0x15A6 | 0x16C8 |
| 0x2AC9 | 0x0000 | 0x0000 | 0x0000 | 0x1732 |
| 0x2ACA | 0x0000 | 0x0000 | 0x15A2 | 0x1014 |
| 0x2ACB | 0x0000 | 0x0000 | 0x1559 | 0x1062 |
| 0x2ACC | 0x0000 | 0x0000 | 0x1063 | 0x1063 |
| 0x2ACD | 0x0000 | 0x0000 | 0x0000 | 0x16E5 |
| 0x2ACE | 0x0000 | 0x0000 | 0x0000 | 0x1733 |
| 0x2ACF | 0x0000 | 0x0000 | 0x0000 | 0x1621 |
| 0x2AD1 | 0x15D1 | 0x0000 | 0x0000 | 0x15D1 |
| 0x2AD2 | 0x15D2 | 0x0000 | 0x0000 | 0x15D2 |
| 0x2AD3 | 0x15D2 | 0x0000 | 0x0000 | 0x15E9 |
...
| 0x2B0F | 0x0000 | 0x0000 | 0x153B | 0x0000 |
...
| 0x2B25 | 0x0000 | 0x0000 | 0x0000 | 0x15BF |
...
| 0x2B2A | 0x0000 | 0x0000 | 0x129B | 0x129A |
| 0x2B2B | 0x0000 | 0x0000 | 0x129B | 0x129A |
...
| 0x2B30 | 0x0000 | 0x1016 | 0x11F8 | 0x1014 |
| 0x2B31 | 0x0000 | 0x1016 | 0x11F8 | 0x1014 |
| 0x2B34 | 0x1021 | 0x1022 | 0x0000 | 0x0000 |
...
| 0x2B3E | 0x0000 | 0x0000 | 0x15E3 | 0x15E4 |
| 0x2B3F | 0x0000 | 0x0000 | 0x15E3 | 0x15E4 |
| 0x2B40 | 0x0000 | 0x0000 | 0x15E3 | 0x15E4 |
| 0x2B41 | 0x0000 | 0x0000 | 0x15E3 | 0x15E4 |
| 0x2B42 | 0x0000 | 0x0000 | 0x15E3 | 0x15E4 |
| 0x2B43 | 0x0000 | 0x0000 | 0x15E3 | 0x15E4 |
| 0x2B44 | 0x0000 | 0x0000 | 0x15E3 | 0x15E4 |
| 0x2B45 | 0x0000 | 0x0000 | 0x15E3 | 0x15E4 |
| 0x2B46 | 0x0000 | 0x0000 | 0x15E5 | 0x15E6 |
| 0x2B47 | 0x0000 | 0x0000 | 0x15E5 | 0x15E6 |
...
| 0x2C3D | 0x106E | 0x1609 | 0x1609 | 0x106F |
| 0x2C3E | 0x106E | 0x1609 | 0x1609 | 0x106F |
...
| 0x2C57 | 0x0000 | 0x0000 | 0x11F8 | 0x1014 |
...
| 0x2CA6 | 0x0000 | 0x1647 | 0x1079 | 0x14D1 |
| 0x2CA7 | 0x0000 | 0x1647 | 0x1079 | 0x14D1 |
| 0x2CA8 | 0x0000 | 0x0000 | 0x0000 | 0x132A |
| 0x2CA9 | 0x0000 | 0x0000 | 0x0000 | 0x132A |
| 0x2CAA | 0x0000 | 0x1647 | 0x1079 | 0x14D1 |
| 0x2CAB | 0x0000 | 0x1647 | 0x1079 | 0x14D1 |
...
| 0x2D0A | 0x1731 | 0x0000 | 0x0000 | 0x0000 |
...
| 0x2D21 | 0x0000 | 0x0000 | 0x15A9 | 0x16CC |
| 0x2D22 | 0x0000 | 0x0000 | 0x15A9 | 0x16CC |
...
| 0x2D7C | 0x0000 | 0x0000 | 0x15C0 | 0x0000 |
...
| 0x2DA2 | 0x16CD | 0x16CE | 0x15AC | 0x15AB |
| 0x2DA3 | 0x16CD | 0x16CE | 0x15AC | 0x15AB |
| 0x2DA4 | 0x16CD | 0x16CE | 0x15AC | 0x15AB |
| 0x2DA5 | 0x16CD | 0x16CE | 0x15AC | 0x15AB |
| 0x2DA6 | 0x16CD | 0x16CE | 0x15AC | 0x15AB |
| 0x2DA7 | 0x16CD | 0x16CE | 0x15AC | 0x15AB |
| 0x2DA8 | 0x16CD | 0x16CE | 0x15AC | 0x15AB |
| 0x2DA9 | 0x16CD | 0x16CE | 0x15AC | 0x15AB |
...
| 0x2DEE | 0x10BD | 0x0000 | 0x0000 | 0x0000 |
| 0x2DEF | 0x15EA | 0x0000 | 0x0000 | 0x0000 |
...
| 0x2EA5 | 0x0000 | 0x16D5 | 0x16D4 | 0x16D6 |
| 0x2EA6 | 0x16DA | 0x16D9 | 0x16D8 | 0x16D7 |
| 0x2EA8 | 0x16DB | 0x0000 | 0x0000 | 0x0000 |
| 0x2EA9 | 0x0000 | 0x1016 | 0x11F8 | 0x1014 |
| 0x2EAA | 0x155C | 0x1016 | 0x1583 | 0x1404 |
| 0x2EAB | 0x0000 | 0x0000 | 0x0000 | 0x10CA |
| 0x2EAC | 0x10CD | 0x10CF | 0x1031 | 0x10CE |
| 0x2EB2 | 0x0000 | 0x0000 | 0x1730 | 0x15DA |
...
| 0x2ED4 | 0x0000 | 0x0000 | 0x0000 | 0x1019 |
| 0x2ED5 | 0x0000 | 0x0000 | 0x0000 | 0x1019 |
| 0x2ED6 | 0x0000 | 0x0000 | 0x0000 | 0x1019 |
| 0x2ED7 | 0x0000 | 0x0000 | 0x0000 | 0x1019 |
| 0x2ED8 | 0x0000 | 0x0000 | 0x0000 | 0x1019 |
| 0x2ED9 | 0x0000 | 0x0000 | 0x0000 | 0x1019 |
| 0x2EDA | 0x0000 | 0x0000 | 0x0000 | 0x1019 |
| 0x2EDB | 0x0000 | 0x0000 | 0x0000 | 0x1019 |
...
| 0x2F03 | 0x1586 | 0x0000 | 0x1584 | 0x1585 |
...
| 0x2F1D | 0x0000 | 0x0000 | 0x1730 | 0x15DA |
| 0x2F1E | 0x0000 | 0x0000 | 0x1730 | 0x15DA |
| 0x2F22 | 0x0000 | 0x0000 | 0x0000 | 0x16D3 |
| 0x2F23 | 0x0000 | 0x16D5 | 0x16D4 | 0x16D6 |
| 0x2F24 | 0x16DA | 0x16D9 | 0x16D8 | 0x16D7 |
| 0x2F25 | 0x16DB | 0x0000 | 0x0000 | 0x0000 |
| 0x2F27 | 0x0000 | 0x0000 | 0x0000 | 0x16DC |
| 0x2F28 | 0x0000 | 0x16DF | 0x16DD | 0x16DE |
| 0x2F29 | 0x16E2 | 0x16E1 | 0x16E3 | 0x16E0 |
| 0x2F2A | 0x16E4 | 0x0000 | 0x0000 | 0x0000 |
...
| 0x2F60 | 0x0000 | 0x0000 | 0x0000 | 0x16FC |
...
| 0x2FC4 | 0x0000 | 0x1571 | 0x1570 | 0x1570 |
| 0x2FC5 | 0x0000 | 0x1571 | 0x1570 | 0x1570 |
...
| 0x2FCB | 0x0000 | 0x0000 | 0x0000 | 0x129B |
| 0x2FD5 | 0x0000 | 0x0000 | 0x0000 | 0x129B |
| 0x2FD6 | 0x0000 | 0x0000 | 0x0000 | 0x129B |
...
| 0x3108 | 0x129B | 0x0000 | 0x0000 | 0x0000 |
| 0x310A | 0x129A | 0x0000 | 0x0000 | 0x0000 |
| 0x310B | 0x129B | 0x0000 | 0x0000 | 0x0000 |
| 0x3124 | 0x0000 | 0x0000 | 0x0000 | 0x158C |
| 0x3125 | 0x0000 | 0x0000 | 0x0000 | 0x158C |
| 0x3126 | 0x0000 | 0x0000 | 0x0000 | 0x158C |
| 0x3127 | 0x0000 | 0x0000 | 0x0000 | 0x158C |
| 0x3128 | 0x0000 | 0x0000 | 0x0000 | 0x158C |
| 0x3129 | 0x0000 | 0x0000 | 0x0000 | 0x158C |
| 0x312A | 0x0000 | 0x0000 | 0x0000 | 0x158C |
| 0x312B | 0x0000 | 0x0000 | 0x0000 | 0x158C |
...
| 0xCDBB | 0x15D9 | 0x15DA | 0x124B | 0x0000 |
| 0xCDBC | 0x0000 | 0x15DA | 0x0000 | 0x0000 |
...
| 0x2A74 | 0x2A74 VANOS, Auslass 2, Kaltstart |
| 0x2A75 | 0x2A75 VANOS, Einlass 2, Kaltstart |
...
| 0x2A7E | 0x2A7E VANOS, Auslass 2 |
| 0x2A7F | 0x2A7F VANOS, Einlass 2 |
...
| 0x2AC0 | 0x2AC0 Kraftstoffniederdrucksystem, Regelung |
...
| 0x2ACD | 0x2ACD Getriebeöltemperatur Wandleraustritt |
| 0x2ACE | 0x2ACE Getriebeöltemperatur Wandleraustritt |
| 0x2ACF | 0x2ACF Schaltzeitpunkt |
| 0x2AD1 | 0x2AD1 Kupplung, Plausibilität |
| 0x2AD2 | 0x2AD2 Kupplung, Plausibilität |
| 0x2AD3 | 0x2AD3 Kupplung, Plausibilität |
...
| 0x2B25 | 0x2B25 Tankentlüftungs- und Spülluftsystem, Feinleck |
...
| 0x2B2D | 0x2B2D Kraftstoffhochdruck 2, Plausibilität, Kaltstart |
| 0x2B2E | 0x2B2E Raildrucksensor, Plausibilität |
| 0x2B2F | 0x2B2F Raildrucksensor 2, Plausibilität |
| 0x2B30 | 0x2B30 Tankentlüftungsventil, Ansteuerung |
| 0x2B31 | 0x2B31 Tankentlüftungsventil 2, Ansteuerung |
| 0x2B34 | 0x2B34 Tankentlüftungssystem 2, Funktion |
...
| 0x2B3E | 0x2B3E Gemischregelung, Lambdaadapiton, Zylinder 1 |
| 0x2B3F | 0x2B3F Gemischregelung, Lambdaadapiton, Zylinder 2 |
| 0x2B40 | 0x2B40 Gemischregelung, Lambdaadapiton, Zylinder 3 |
| 0x2B41 | 0x2B41 Gemischregelung, Lambdaadapiton, Zylinder 4 |
| 0x2B42 | 0x2B42 Gemischregelung, Lambdaadapiton, Zylinder 5 |
| 0x2B43 | 0x2B43 Gemischregelung, Lambdaadapiton, Zylinder 6 |
| 0x2B44 | 0x2B44 Gemischregelung, Lambdaadapiton, Zylinder 7 |
| 0x2B45 | 0x2B45 Gemischregelung, Lambdaadapiton, Zylinder 8 |
| 0x2B46 | 0x2B46 Gemischregelung, Lambdaadaption, Bank 1 |
| 0x2B47 | 0x2B47 Gemischregelung, Lambdaadaption, Bank 2 |
...
| 0x2C57 | 0x2C57 Lambdasonde vor Katalysator, Signalleitungen |
...
| 0x2D21 | 0x2D21 Luftmassenmesser, Arbeitsbereich |
...
| 0x2DA2 | 0x2DA2 Zylinderindividuelle Gemischüberwachung, Adaption, Zylinder 1 |
| 0x2DA3 | 0x2DA3 Zylinderindividuelle Gemischüberwachung, Adaption, Zylinder 2 |
| 0x2DA4 | 0x2DA4 Zylinderindividuelle Gemischüberwachung, Adaption, Zylinder 3 |
| 0x2DA5 | 0x2DA5 Zylinderindividuelle Gemischüberwachung, Adaption, Zylinder 4 |
| 0x2DA6 | 0x2DA6 Zylinderindividuelle Gemischüberwachung, Adaption, Zylinder 5 |
| 0x2DA7 | 0x2DA7 Zylinderindividuelle Gemischüberwachung, Adaption, Zylinder 6 |
| 0x2DA8 | 0x2DA8 Zylinderindividuelle Gemischüberwachung, Adaption, Zylinder 7 |
| 0x2DA9 | 0x2DA9 Zylinderindividuelle Gemischüberwachung, Adaption, Zylinder 8 |
...
| 0x2DEE | 0x2DEE Powermanagement, Batteriezustandserkennung |
| 0x2DEF | 0x2DEF Powermanagement, Batteriezustandserkennung  |
...
| 0x2EA2 | 0x2EA2 Kühlmittelpumpe für Ladeluftkühler 2, Plausibilität Kommunikation |
| 0x2EA3 | 0x2EA3 Kühlmittelpumpe für Ladeluftkühler 2, Abschaltung |
...
| 0x2EA9 | 0x2EA9 Turbolader-Kühlmittelpumpe, Ansteuerung |
| 0x2EAA | 0x2EAA Turbolader-Kühlmittelpumpe, Ansteuerung |
| 0x2EAB | 0x2EAB Kühlmittelpumpe für Ladeluftkühler 2, Drehzahlabweichung |
| 0x2EAC | 0x2EAC Kühlmittelpumpe für Ladeluftkühler 2, leistungsreduzierter Betrieb |
| 0x2EB2 | 0x2EB2 LIN, Kommunikation (Ladeluft-Kühlmittelpumpe) |
...
| 0x2ED4 | 0x2ED4 Injektor Zylinder 1, mechanisch |
| 0x2ED5 | 0x2ED5 Injektor Zylinder 2, mechanisch |
| 0x2ED6 | 0x2ED6 Injektor Zylinder 3, mechanisch |
| 0x2ED7 | 0x2ED7 Injektor Zylinder 4, mechanisch |
| 0x2ED8 | 0x2ED8 Injektor Zylinder 5, mechanisch |
| 0x2ED9 | 0x2ED9 Injektor Zylinder 6, mechanisch |
| 0x2EDA | 0x2EDA Injektor Zylinder 7, mechanisch |
| 0x2EDB | 0x2EDB Injektor Zylinder 8, mechanisch |
...
| 0x2F1D | 0x2F1D LIN, Kommunikation (Ladeluft-Kühlmittelpumpe) |
| 0x2F1E | 0x2F1E LIN, Kommunikation (Ladeluft-Kühlmittelpumpe 2) |
| 0x2F22 | 0x2F22 Ladeluft-Kühlsystem |
| 0x2F23 | 0x2F23 Ladeluft-Kühlsystem |
| 0x2F24 | 0x2F24 Ladeluft-Kühlsystem, leistungsreduzierter Betrieb |
| 0x2F25 | 0x2F25 Ladeluft-Kühlsystem |
| 0x2F27 | 0x2F27 Ladeluft-Kühlsystem |
| 0x2F28 | 0x2F28 Ladeluft-Kühlsystem |
| 0x2F29 | 0x2F29 Ladeluft-Kühlsystem, leistungsreduzierter Betrieb |
| 0x2F2A | 0x2F2A Ladeluft-Kühlsystem |
...
| 0x2FC4 | 0x2FC4 Kraftstoffdruckbereich, Messbereich |
| 0x2FC5 | 0x2FC5 Kraftstoffdruckbereich, Messbereich 2 |
...
| 0x2FCB | 0x2FCB Kraftstoffhochdruck 2 bei Freigabe der Einspritzung |
| 0x2FD5 | 0x2FD5 Kraftstoffhochdruck bei Freigabe der Einspritzung |
| 0x2FD6 | 0x2FD6 Kraftstoffhochdruck 2 bei Freigabe der Einspritzung |
...
| 0x3108 | 0x3108 Ladedruckregelung 2, Leckage |
| 0x310A | 0x310A Ladedruckregelung 2, Plausibilität |
| 0x310B | 0x310B Ladedruckregelung 2, Plausibilität |
| 0x3124 | 0x3124 Injektor Zylinder 1, Kleinstmengenadaption |
| 0x3125 | 0x3125 Injektor Zylinder 2, Kleinstmengenadaption |
| 0x3126 | 0x3126 Injektor Zylinder 3, Kleinstmengenadaption |
| 0x3127 | 0x3127 Injektor Zylinder 4, Kleinstmengenadaption |
| 0x3128 | 0x3128 Injektor Zylinder 5, Kleinstmengenadaption |
| 0x3129 | 0x3129 Injektor Zylinder 6, Kleinstmengenadaption |
| 0x312A | 0x312A Injektor Zylinder 7, Kleinstmengenadaption |
| 0x312B | 0x312B Injektor Zylinder 8, Kleinstmengenadaption |
...
| 0xCDBB | 0xCDBB Botschaft (Getriebedaten 4, 0x10A) |
| 0xCDBC | 0xCDBC PT-CAN, Botschaft (Status Sollmomentumsetzung, 0xBC) |
...
Dimensions: 574 rows × 5 columns

| ORT | UW1_NR | UW2_NR | UW3_NR | UW4_NR |
| --- | --- | --- | --- | --- |
| 0x0000 | 0x58FF | 0x58FF | 0x58FF | 0x58FF |
| 0x29CC | 0x58F0 | 0x583C | 0x5824 | 0x586D |
...
| 0x29D3 | 0x581F | 0x58E5 | 0x58E6 | 0x58E7 |
| 0x29D4 | 0x581F | 0x58E5 | 0x58E6 | 0x58E7 |
| 0x29D9 | 0x5811 | 0x586D | 0x581F | 0x583B |
| 0x29DA | 0x5811 | 0x583C | 0x58F8 | 0x58F9 |
| 0x29DB | 0x5811 | 0x581F | 0x5810 | 0x583C |
| 0x29DC | 0x580E | 0x5816 | 0x5839 | 0x5861 |
...
| 0x29FB | 0x5811 | 0x581F | 0x583C | 0x587C |
| 0x29FC | 0x5811 | 0x581F | 0x583C | 0x587C |
| 0x2A0A | 0x5811 | 0x581F | 0x587C | 0x583C |
| 0x2A0B | 0x5811 | 0x581F | 0x587C | 0x583C |
...
| 0x2A74 | 0x5811 | 0x581F | 0x587C | 0x5822 |
| 0x2A75 | 0x5811 | 0x581F | 0x587C | 0x5822 |
| 0x2A78 | 0x5811 | 0x581F | 0x587C | 0x5822 |
| 0x2A79 | 0x5811 | 0x581F | 0x587C | 0x5822 |
...
| 0x2AC0 | 0x58BB | 0x58BE | 0x58C5 | 0x58F3 |
| 0x2AC2 | 0x5811 | 0x5832 | 0x5822 | 0x583C |
| 0x2AC3 | 0x5811 | 0x5832 | 0x5822 | 0x583C |
| 0x2AC4 | 0x58BB | 0x58AF | 0x5811 | 0x58F3 |
| 0x2AC9 | 0x580C | 0x5891 | 0x5881 | 0x588B |
| 0x2ACA | 0x5811 | 0x5832 | 0x583C | 0x587C |
| 0x2ACB | 0x5823 | 0x584A | 0x587C | 0x583C |
| 0x2ACC | 0x5823 | 0x584A | 0x587C | 0x583C |
| 0x2ACD | 0x5862 | 0x5800 | 0x581F | 0x5824 |
| 0x2ACE | 0x5862 | 0x5800 | 0x581F | 0x5824 |
| 0x2ACF | 0x5815 | 0x5844 | 0x5857 | 0x5887 |
| 0x2AD1 | 0x5867 | 0x5811 | 0x580D | 0x5815 |
| 0x2AD2 | 0x5867 | 0x5811 | 0x580D | 0x5815 |
| 0x2AD3 | 0x5867 | 0x5811 | 0x580D | 0x5815 |
...
| 0x2B25 | 0x583B | 0x5811 | 0x585A | 0x588D |
...
| 0x2B30 | 0x5811 | 0x5832 | 0x587C | 0x583C |
| 0x2B31 | 0x5811 | 0x5832 | 0x587C | 0x583C |
| 0x2B34 | 0x581F | 0x5810 | 0x5811 | 0x584D |
...
| 0x2B3E | 0x5811 | 0x5807 | 0x5813 | 0x58EF |
| 0x2B3F | 0x5811 | 0x5807 | 0x5813 | 0x58EF |
| 0x2B40 | 0x5811 | 0x5807 | 0x5813 | 0x58EF |
| 0x2B41 | 0x5811 | 0x5807 | 0x5813 | 0x58EF |
| 0x2B42 | 0x5811 | 0x5807 | 0x5813 | 0x58F0 |
| 0x2B43 | 0x5811 | 0x5807 | 0x5813 | 0x58F0 |
| 0x2B44 | 0x5811 | 0x5807 | 0x5813 | 0x58F0 |
| 0x2B45 | 0x5811 | 0x5807 | 0x5813 | 0x58F0 |
| 0x2B46 | 0x5811 | 0x5807 | 0x5813 | 0x58EF |
| 0x2B47 | 0x5811 | 0x5807 | 0x5813 | 0x58F0 |
...
| 0x2C57 | 0x5837 | 0x5815 | 0x5845 | 0x5827 |
...
| 0x2D17 | 0x581F | 0x5810 | 0x580C | 0x580F |
...
| 0x2D21 | 0x581F | 0x5810 | 0x580C | 0x580F |
...
| 0x2D67 | 0x580D | 0x587A | 0x5832 | 0x587C |
| 0x2D7C | 0x5811 | 0x5822 | 0x5865 | 0x588B |
...
| 0x2DA2 | 0x5811 | 0x5807 | 0x5813 | 0x58EF |
| 0x2DA3 | 0x5811 | 0x5807 | 0x5813 | 0x58EF |
| 0x2DA4 | 0x5811 | 0x5807 | 0x5813 | 0x58EF |
| 0x2DA5 | 0x5811 | 0x5807 | 0x5813 | 0x58EF |
| 0x2DA6 | 0x5811 | 0x5807 | 0x5813 | 0x58F0 |
| 0x2DA7 | 0x5811 | 0x5807 | 0x5813 | 0x58F0 |
| 0x2DA8 | 0x5811 | 0x5807 | 0x5813 | 0x58F0 |
| 0x2DA9 | 0x5811 | 0x5807 | 0x5813 | 0x58F0 |
...
| 0x2DEE | 0x5867 | 0x586A | 0x587C | 0x5811 |
| 0x2DEF | 0x5867 | 0x586A | 0x58AC | 0x5811 |
...
| 0x2E7F | 0x5811 | 0x581F | 0x587C | 0x583C |
...
| 0x2EA3 | 0x581F | 0x58E9 | 0x58EC | 0x58EE |
| 0x2EA4 | 0x581F | 0x58E9 | 0x58EA | 0x58EB |
| 0x2EA5 | 0x581F | 0x58E9 | 0x58EC | 0x58ED |
| 0x2EA6 | 0x581F | 0x58E9 | 0x58EC | 0x58EE |
| 0x2EA8 | 0x5811 | 0x581F | 0x587C | 0x583C |
| 0x2EA9 | 0x5811 | 0x581F | 0x587C | 0x583C |
| 0x2EAA | 0x5811 | 0x581F | 0x587C | 0x583C |
| 0x2EAB | 0x581F | 0x58E9 | 0x58EA | 0x58EB |
| 0x2EAC | 0x581F | 0x58E9 | 0x58EC | 0x58EE |
| 0x2EB2 | 0x581F | 0x58E9 | 0x58EC | 0x583C |
| 0x2EB3 | 0x581F | 0x583C | 0x58E9 | 0x58EC |
| 0x2EB4 | 0x581F | 0x583C | 0x58E9 | 0x58EC |
...
| 0x2ED4 | 0x580C | 0x5813 | 0x5889 | 0x58EF |
| 0x2ED5 | 0x580C | 0x5813 | 0x5889 | 0x58EF |
| 0x2ED6 | 0x580C | 0x5813 | 0x5889 | 0x58EF |
| 0x2ED7 | 0x580C | 0x5813 | 0x5889 | 0x58EF |
| 0x2ED8 | 0x580C | 0x5813 | 0x588A | 0x58F0 |
| 0x2ED9 | 0x580C | 0x5813 | 0x588A | 0x58F0 |
| 0x2EDA | 0x580C | 0x5813 | 0x588A | 0x58F0 |
| 0x2EDB | 0x580C | 0x5813 | 0x588A | 0x58F0 |
...
| 0x2F02 | 0x5801 | 0x581F | 0x5824 | 0x583C |
| 0x2F03 | 0x5801 | 0x581F | 0x5824 | 0x583C |
...
| 0x2F1D | 0x580F | 0x58EC | 0x58EA | 0x583C |
| 0x2F1E | 0x580F | 0x5890 | 0x5899 | 0x583C |
| 0x2F22 | 0x580F | 0x58E9 | 0x58EA | 0x58EB |
| 0x2F23 | 0x580F | 0x58E9 | 0x58EC | 0x581D |
| 0x2F24 | 0x580F | 0x58E9 | 0x58EC | 0x58DF |
| 0x2F25 | 0x5811 | 0x580F | 0x587C | 0x583C |
| 0x2F27 | 0x580F | 0x580A | 0x5899 | 0x58F2 |
| 0x2F28 | 0x580F | 0x580A | 0x5890 | 0x5892 |
| 0x2F29 | 0x580F | 0x580A | 0x5890 | 0x587B |
| 0x2F2A | 0x5811 | 0x580F | 0x587C | 0x583C |
...
| 0x2F60 | 0x5811 | 0x5832 | 0x58D1 | 0x5881 |
...
| 0x2FC4 | 0x5811 | 0x581F | 0x587C | 0x583C |
| 0x2FC5 | 0x5811 | 0x581F | 0x587C | 0x583C |
| 0x2FC6 | 0x580D | 0x583C | 0x5811 | 0x5832 |
| 0x2FC7 | 0x580D | 0x583C | 0x5811 | 0x5832 |
| 0x2FC8 | 0x58F0 | 0x58EF | 0x58F3 | 0x58BA |
| 0x2FC9 | 0x58F0 | 0x58EF | 0x58F3 | 0x58BA |
| 0x2FCA | 0x5876 | 0x5877 | 0x58F3 | 0x5882 |
| 0x2FCB | 0x5876 | 0x5877 | 0x58F3 | 0x5882 |
| 0x2FD5 | 0x58EF | 0x58F3 | 0x581F | 0x5811 |
| 0x2FD6 | 0x58F0 | 0x58F3 | 0x581F | 0x5811 |
...
| 0x3124 | 0x580B | 0x5821 | 0x583C | 0x587C |
| 0x3125 | 0x580B | 0x5821 | 0x583C | 0x587C |
| 0x3126 | 0x580B | 0x5821 | 0x583C | 0x587C |
| 0x3127 | 0x580B | 0x5821 | 0x583C | 0x587C |
| 0x3128 | 0x580B | 0x5821 | 0x583C | 0x587C |
| 0x3129 | 0x580B | 0x5821 | 0x583C | 0x587C |
| 0x312A | 0x580B | 0x5821 | 0x583C | 0x587C |
| 0x312B | 0x580B | 0x5821 | 0x583C | 0x587C |
| 0x3179 | 0x5811 | 0x5821 | 0x583C | 0x587C |
...
| 0xCDB3 | 0x5831 | 0x5841 | 0x583C | 0x587C |
...
| 0xCDBB | 0x5811 | 0x5821 | 0x583C | 0x587C |
| 0xCDBC | 0x5811 | 0x5821 | 0x583C | 0x587C |
| 0xCDBD | 0x5811 | 0x5821 | 0x583C | 0x587C |
| 0xCDBE | 0x5811 | 0x581F | 0x587C | 0x583C |
...
| 0x4307 | Betriebsart Wasserpumpe | 0-n | - | 0xFF | _CNV_S_12__CNV_S_12__698 | 1 | 1 | 0 |
...
| 0x4426 | CBS Verfügbarkeitsanzeige | - | - | unsigned char | - | 0,009999999776482582 | 1 | 0,0 |
...
| 0x470B | Faktor Adaptierte Kraftstoffquallität | - | - | unsigned char | - | 0,00390625 | 1 | 0,0 |
...
| 0x4850 | Zähler für MISFIRE Ergekennung über Lebenszeit Zyl. 1 | - | - | unsigned integer | - | 1,0 | 1 | 0,0 |
| 0x4851 | Zähler für MISFIRE Ergekennung über Lebenszeit Zyl. 5 | - | - | unsigned integer | - | 1,0 | 1 | 0,0 |
| 0x4852 | Zähler für MISFIRE Ergekennung über Lebenszeit Zyl. 4 | - | - | unsigned integer | - | 1,0 | 1 | 0,0 |
| 0x4853 | Zähler für MISFIRE Ergekennung über Lebenszeit Zyl. 8 | - | - | unsigned integer | - | 1,0 | 1 | 0,0 |
| 0x4854 | Zähler für MISFIRE Ergekennung über Lebenszeit Zyl. 6 | - | - | unsigned integer | - | 1,0 | 1 | 0,0 |
| 0x4855 | Zähler für MISFIRE Ergekennung über Lebenszeit Zyl. 3 | - | - | unsigned integer | - | 1,0 | 1 | 0,0 |
| 0x4856 | Zähler für MISFIRE Ergekennung über Lebenszeit Zyl. 7 | - | - | unsigned integer | - | 1,0 | 1 | 0,0 |
| 0x4857 | Zähler für MISFIRE Ergekennung über Lebenszeit Zyl. 2 | - | - | unsigned integer | - | 1,0 | 1 | 0,0 |
...
| 0x5802 | Zustand Lambdaregelung Bank 1 | 0-n | - | 0xFF | _CNV_S_6_LACO_RANGE_350 | 1 | 1 | 0 |
| 0x5803 | Zustand Lambdaregelung Bank 2 | 0-n | - | 0xFF | _CNV_S_6_LACO_RANGE_350 | 1 | 1 | 0 |
...
| 0x581D | Wasserpumpe Strom CWP_2_1 | A | - | unsigned char | - | 0,20000000298023224 | 1 | 0,0 |
| 0x581E | DK Adaptionsschritt Bank 2 | V | - | signed char | - | 0,03905882313847542 | 1 | -4,7058822283200315E-4 |
...
| 0x5832 | Motor Status | 0-n | - | 0xFF | _CNV_S_6_RANGE_STAT_110 | 1 | 1 | 0 |
...
| 0x5837 | Status OBD-I Fehler vor Katalysator Bank 1 | 0-n | - | 0xFF | _CNV_S_11_EGCP_RANGE_290 | 1 | 1 | 0 |
| 0x5838 | Status OBD-I Fehler vor Katalysator Bank 2 | 0-n | - | 0xFF | _CNV_S_11_EGCP_RANGE_290 | 1 | 1 | 0 |
...
| 0x583D | Resettyp | 0-n | - | 0xFF | _CNV_S_19_ECOP_RANGE_806 | 1 | 1 | 0 |
...
| 0x584F | Spannung Ansauglufttemperatur Sensor 2 | V | - | unsigned char | - | 0,019600000232458115 | 1 | 0,0 |
| 0x5850 | Spannung Motortemperatur | V | - | unsigned char | - | 0,01953125 | 1 | 0,0 |
| 0x5851 | Spannung Ansauglufttemperatur Sensor 1 | V | - | unsigned char | - | 0,019600000232458115 | 1 | 0,0 |
...
| 0x5858 | Drosselklappe aktueller Wert Bank1 | °TPS | - | unsigned char | - | 1,8673014640808105 | 1 | 0,0 |
...
| 0x5862 | Temperatur Getriebeöltemperaturmodell | ° C | - | signed char | - | 2,559999942779541 | 1 | 0,0 |
...
| 0x587B | relative Wasserpumpe Leistung | % | - | unsigned char | - | 0,390625 | 1 | 0,0 |
| 0x587C | Status Motorsteuerung | 0-n | - | 0xFF | _CNV_S_7_RANGE_ECU__108 | 1 | 1 | 0 |
| 0x587D | Symptom bei Schubabschaltung Sonde vor Katalysator Bank 1 | 0-n | - | 0xFF | _CNV_S_4_EGCP_RANGE_301 | 1 | 1 | 0 |
| 0x587E | Symptom bei Schubabschaltung Sonde vor Katalysator Bank 2 | 0-n | - | 0xFF | _CNV_S_4_EGCP_RANGE_301 | 1 | 1 | 0 |
...
| 0x5890 | Wasserpumpe Elektronik Temperatur | °C | - | unsigned char | - | 1,0 | 1 | -50,0 |
| 0x5891 | Momentanforderung an der Kupplung | Nm | - | signed char | - | 8,0 | 1 | 0,0 |
| 0x5892 | Wasserpumpe Stromaufnahme, CWP_2_2 | A | - | unsigned char | - | 0,20000000298023224 | 1 | 0,0 |
| 0x5893 | Drehmomentabfall schnell bei Gangwechsel | Nm | - | signed char | - | 8,0 | 1 | 0,0 |
| 0x5894 | Symptom Lambdasondenheizung vor Katalysator Bank 1 | 0-n | - | 0xFF | _CNV_S_4_EGCP_RANGE_294 | 1 | 1 | 0 |
| 0x5895 | Symptom Lambdasondenheizung vor Katalysator Bank 2 | 0-n | - | 0xFF | _CNV_S_4_EGCP_RANGE_294 | 1 | 1 | 0 |
...
| 0x5899 | Wasserpumpe Ist-Drehzahl, CWP_2_2 | - | - | unsigned char | - | 1,0 | 1 | 0,0 |
| 0x589A | Wasserpumpe Soll-Drehzahl, CWP_2_1/2 | - | - | unsigned char | - | 1,0 | 1 | 0,0 |
...
| 0x589E | Status_Drosselklapendiagnose Bank1 | 0-n | - | 0xFF | _CNV_S_5_THRO_RANGE_897 | 1 | 1 | 0 |
| 0x589F | Status Drosselklappendiagnose Bank2 | 0-n | - | 0xFF | _CNV_S_5_THRO_RANGE_897 | 1 | 1 | 0 |
...
| 0x58DF | relative Wasserpumpenleistung, CWP_2_1 | % | - | unsigned char | - | 0,390625 | 1 | 0,0 |
...
| 0x58E4 | Betriebsart Istwert | 0-n | - | 0xFF | _CNV_S_5__CNV_S_5_D_631 | 1 | 1 | 0 |
...
| 0x58EB | Wasserpumpe Soll -Ist_Differenz | - | - | unsigned char | - | 1,0 | 1 | 0,0 |
| 0x58EC | Wasserpumpe Temperatur Elektronik | °C | - | unsigned char | - | 1,0 | 1 | -50,0 |
| 0x58EF | gemittelter Raildruck Bank 2 | hPa | - | unsigned char | - | 1358,5177001953125 | 1 | 0,0 |
| 0x58F0 | gemittelter Raildruck Bank 1 | hPa | - | unsigned char | - | 1358,5177001953125 | 1 | 0,0 |
| 0x58F1 | DME - Losnummer | 0-n | - | 0xFF | _CNV_S_11_RANGE_STAT_862 | 1 | 1 | 0 |
| 0x58F2 | Wasserpumpe Drehzahl Soll-Ist-Vergleich, CWP_2_2 | - | - | unsigned char | - | 1,0 | 1 | 0,0 |
| 0x58F3 | Fuel pressure EFP | hPa | - | unsigned char | - | 42,453758239746094 | 1 | 0,0 |
...
| 0x5A06 | Ladediagnose Bank 2 | 0/1 | - | 0xFFFF | - | 1 | 1 | 0 |
| 0x5A07 | Ende Ladediagnose Bank2 | 0/1 | - | 0xFFFF | - | 1 | 1 | 0 |
...
| 0x5A1A | Ausgabebedingung für Ladedruck, nierdrige Aufladung, Bank 1 | 0/1 | - | 0xFFFF | - | 1 | 1 | 0 |
| 0x5A1B | Ausgabebedingung für Ladedruck, nierdrige Aufladung, Bank 2 | 0/1 | - | 0xFFFF | - | 1 | 1 | 0 |
| 0x5A1C | Ausgabebedingung für Ladedruck, hohe Aufladung, Bank 1 | 0/1 | - | 0xFFFF | - | 1 | 1 | 0 |
| 0x5A1D | Ausgabebedingung für Ladedruck, hohe Aufladung, Bank 2 | 0/1 | - | 0xFFFF | - | 1 | 1 | 0 |
...
| 0x5A2F | gemessener Tankdruck | MPa | - | unsigned integer | - | 0,00390625 | 1 | 0,0 |
...
| 0x5A54 | Status LS Heizung hinter Katalysator Bank 1 | 0-n | - | 0xFF | _CNV_S_7_EGCP_RANGE_275 | 1 | 1 | 0 |
| 0x5A55 | Status LS Heizung hinter Katalysator Bank 2 | 0-n | - | 0xFF | _CNV_S_7_EGCP_RANGE_275 | 1 | 1 | 0 |
| 0x5A56 | Status LS Heizung vor Katalysator Bank 1 | 0-n | - | 0xFF | _CNV_S_7_EGCP_RANGE_275 | 1 | 1 | 0 |
| 0x5A57 | Status LS Heizung vor Katalysator Bank 2 | 0-n | - | 0xFF | _CNV_S_7_EGCP_RANGE_275 | 1 | 1 | 0 |
...
| 0x5A5F | Status HPDI-Relais | 0/1 | - | 0xFF | - | 1 | 1 | 0 |
...
| 0x5AE2 | Resetart des letzten Resets | 0-n | - | 0xFF | _CNV_S_19_ECOP_RANGE_806 | 1 | 1 | 0 |
...
| 0xFFFF | Umweltbedingung unbekann | - | - | signed char | - | 1 | 1 | 0 |
| 0xXYXY | UWB_UNKNOWN | - | - | - | - | - | - | - |
...
Dimensions: 645 rows × 12 columns
...
| STAT_0x4307_WERT | 0x4307 | STAT_0x4307_WERT | Betriebsart Wasserpumpe | 0-n | BA_WM_IST | - | unsigned char | _CNV_S_12__CNV_S_12__698 | 1 | 1 | 0 |
...
| STAT_0x4617_WERT | 0x4617 | STAT_0x4617_WERT | gefiltertes Generatormoment absolut Ausgang | Nm | MD_GENNM_NA | - | signed integer | - | 0,10000000149011612 | 1 | 0,0 |
...
| STAT_0x461A_WERT | 0x461A | STAT_0x461A_WERT | Nominale Generatorspannung | V | UREGNOM | - | unsigned integer | - | 0,10000000149011612 | 1 | 0,0 |
...
| STAT_0x470B_WERT | 0x470B | STAT_0x470B_WERT | Faktor Adaptierte Kraftstoffquallität | - | FAC_RON | - | unsigned char | - | 0,00390625 | 1 | 0,0 |
...
| STAT_0x4850_WERT | 0x4850 | STAT_0x4850_WERT | Zähler für MISFIRE Ergekennung über Lebenszeit Zyl. 1 | - | CTR_MIS_DET_CYL[0] | - | unsigned integer | - | 1,0 | 1 | 0,0 |
| STAT_0x4851_WERT | 0x4851 | STAT_0x4851_WERT | Zähler für MISFIRE Ergekennung über Lebenszeit Zyl. 5 | - | CTR_MIS_DET_CYL[1] | - | unsigned integer | - | 1,0 | 1 | 0,0 |
| STAT_0x4852_WERT | 0x4852 | STAT_0x4852_WERT | Zähler für MISFIRE Ergekennung über Lebenszeit Zyl. 4 | - | CTR_MIS_DET_CYL[2] | - | unsigned integer | - | 1,0 | 1 | 0,0 |
| STAT_0x4853_WERT | 0x4853 | STAT_0x4853_WERT | Zähler für MISFIRE Ergekennung über Lebenszeit Zyl. 8 | - | CTR_MIS_DET_CYL[3] | - | unsigned integer | - | 1,0 | 1 | 0,0 |
| STAT_0x4854_WERT | 0x4854 | STAT_0x4854_WERT | Zähler für MISFIRE Ergekennung über Lebenszeit Zyl. 6 | - | CTR_MIS_DET_CYL[4] | - | unsigned integer | - | 1,0 | 1 | 0,0 |
| STAT_0x4855_WERT | 0x4855 | STAT_0x4855_WERT | Zähler für MISFIRE Ergekennung über Lebenszeit Zyl. 3 | - | CTR_MIS_DET_CYL[5] | - | unsigned integer | - | 1,0 | 1 | 0,0 |
| STAT_0x4856_WERT | 0x4856 | STAT_0x4856_WERT | Zähler für MISFIRE Ergekennung über Lebenszeit Zyl. 7 | - | CTR_MIS_DET_CYL[6] | - | unsigned integer | - | 1,0 | 1 | 0,0 |
| STAT_0x4857_WERT | 0x4857 | STAT_0x4857_WERT | Zähler für MISFIRE Ergekennung über Lebenszeit Zyl. 2 | - | CTR_MIS_DET_CYL[7] | - | unsigned integer | - | 1,0 | 1 | 0,0 |
...
| ICLR1 | 0x5802 | STAT_LAMBDAREGELUNG_ZUSTAND_BANK1_WERT | Zustand Lambdaregelung Bank 1 | 0-n | STATE_LS[1] | - | unsigned char | _CNV_S_6_LACO_RANGE_350 | 1 | 1 | 0 |
| ICLR2 | 0x5803 | STAT_LAMBDAREGELUNG_ZUSTAND_BANK2_WERT | Zustand Lambdaregelung Bank 2 | 0-n | STATE_LS[2] | - | unsigned char | _CNV_S_6_LACO_RANGE_350 | 1 | 1 | 0 |
...
| STAT_0x5812_WERT | 0x5812 | STAT_0x5812_WERT | Luftmasse gemessen Bank 1 | kg/h | MAF_KGH_MES_BAS_KWP | - | unsigned char | - | 8,0 | 1 | 0,0 |
...
| STAT_0x581D_WERT | 0x581D | STAT_0x581D_WERT | Wasserpumpe Strom CWP_2_1 | A | CUR_CNS_CWP_2_1 | - | unsigned char | - | 0,20000000298023224 | 1 | 0,0 |
| STAT_0x581E_WERT | 0x581E | STAT_0x581E_WERT | DK Adaptionsschritt Bank 2 | V | VP_TPS_2_KWP[1] | - | signed char | - | 0,03905882313847542 | 1 | -4,7058822283200315E-4 |
...
| IMOST | 0x5832 | STAT_MOTOR_STATUS_WERT | Motor Status | 0-n | STATE_ENG | - | unsigned char | _CNV_S_6_RANGE_STAT_110 | 1 | 1 | 0 |
...
| STAT_0x5837_WERT | 0x5837 | STAT_0x5837_WERT | Status OBD-I Fehler vor Katalysator Bank 1 | 0-n | STATE_ERR_EL_LSL_UP[1] | - | unsigned char | _CNV_S_11_EGCP_RANGE_290 | 1 | 1 | 0 |
| STAT_0x5838_WERT | 0x5838 | STAT_0x5838_WERT | Status OBD-I Fehler vor Katalysator Bank 2 | 0-n | STATE_ERR_EL_LSL_UP[2] | - | unsigned char | _CNV_S_11_EGCP_RANGE_290 | 1 | 1 | 0 |
...
| STAT_0x583D_WERT | 0x583D | STAT_0x583D_WERT | Resettyp | 0-n | STATE_RST_TYP[0] | - | unsigned char | _CNV_S_19_ECOP_RANGE_806 | 1 | 1 | 0 |
...
| STAT_0x584C_WERT | 0x584C | STAT_0x584C_WERT | Drosselklappe Adaptionsschritte Drosselklappe 2 | - | TPS_AD_STEP_KWP[2] | - | unsigned char | - | 1,0 | 1 | 0,0 |
...
| STAT_0x584F_WERT | 0x584F | STAT_0x584F_WERT | Spannung Ansauglufttemperatur Sensor 2 | V | VP_TIA_KWP[2] | - | unsigned char | - | 0,019600000232458115 | 1 | 0,0 |
| STAT_0x5850_WERT | 0x5850 | STAT_0x5850_WERT | Spannung Motortemperatur | V | V_TCO_KWP | - | unsigned char | - | 0,01953125 | 1 | 0,0 |
| STAT_0x5851_WERT | 0x5851 | STAT_0x5851_WERT | Spannung Ansauglufttemperatur Sensor 1 | V | VP_TIA_KWP[1] | - | unsigned char | - | 0,019600000232458115 | 1 | 0,0 |
...
| STAT_0x5858_WERT | 0x5858 | STAT_0x5858_WERT | Drosselklappe aktueller Wert Bank1 | °TPS | TPS_AV[1] | - | unsigned char | - | 1,8673014640808105 | 1 | 0,0 |
...
| STAT_0x5862_WERT | 0x5862 | STAT_0x5862_WERT | Temperatur Getriebeöltemperaturmodell | ° C | TWANDLER_SIM_KWP | - | signed char | - | 2,559999942779541 | 1 | 0,0 |
...
| STAT_0x587B_WERT | 0x587B | STAT_0x587B_WERT | relative Wasserpumpe Leistung | % | REL_CWP_2_2_PWR | - | unsigned char | - | 0,390625 | 1 | 0,0 |
| ISMST | 0x587C | STAT_MOTORSTEUERUNG_WERT | Status Motorsteuerung | 0-n | ECU_STATE | - | unsigned char | _CNV_S_7_RANGE_ECU__108 | 1 | 1 | 0 |
| STAT_0x587D_WERT | 0x587D | STAT_0x587D_WERT | Symptom bei Schubabschaltung Sonde vor Katalysator Bank 1 | 0-n | STATE_SYM_DIAG_PUC_LSL_UP[1] | - | unsigned char | _CNV_S_4_EGCP_RANGE_301 | 1 | 1 | 0 |
| STAT_0x587E_WERT | 0x587E | STAT_0x587E_WERT | Symptom bei Schubabschaltung Sonde vor Katalysator Bank 2 | 0-n | STATE_SYM_DIAG_PUC_LSL_UP[2] | - | unsigned char | _CNV_S_4_EGCP_RANGE_301 | 1 | 1 | 0 |
...
| STAT_0x5890_WERT | 0x5890 | STAT_0x5890_WERT | Wasserpumpe Elektronik Temperatur | °C | TEMP_EL_CWP_2_2 | - | unsigned char | - | 1,0 | 1 | -50,0 |
| IMOKU | 0x5891 | STAT_MOMENTANFORDERUNG_KUPPLUNG_WERT | Momentanforderung an der Kupplung | Nm | TQ_REQ_CLU | - | signed char | - | 8,0 | 1 | 0,0 |
| STAT_0x5892_WERT | 0x5892 | STAT_0x5892_WERT | Wasserpumpe Stromaufnahme, CWP_2_2 | A | CUR_CNS_CWP_2_2 | - | unsigned char | - | 0,20000000298023224 | 1 | 0,0 |
...
| STAT_0x5894_WERT | 0x5894 | STAT_0x5894_WERT | Symptom Lambdasondenheizung vor Katalysator Bank 1 | 0-n | STATE_SYM_OBD_LSL_LSH_UP[1] | - | unsigned char | _CNV_S_4_EGCP_RANGE_294 | 1 | 1 | 0 |
| STAT_0x5895_WERT | 0x5895 | STAT_0x5895_WERT | Symptom Lambdasondenheizung vor Katalysator Bank 2 | 0-n | STATE_SYM_OBD_LSL_LSH_UP[2] | - | unsigned char | _CNV_S_4_EGCP_RANGE_294 | 1 | 1 | 0 |
...
| STAT_0x5899_WERT | 0x5899 | STAT_0x5899_WERT | Wasserpumpe Ist-Drehzahl, CWP_2_2 | - | N_REL_CWP_2_2 | - | unsigned char | - | 1,0 | 1 | 0,0 |
| STAT_0x589A_WERT | 0x589A | STAT_0x589A_WERT | Wasserpumpe Soll-Drehzahl, CWP_2_1/2 | - | N_REL_CWP_SP_2 | - | unsigned char | - | 1,0 | 1 | 0,0 |
...
| STAT_0x589E_WERT | 0x589E | STAT_0x589E_WERT | Status_Drosselklapendiagnose Bank1 | 0-n | STATE_TPS_DIAG[1] | - | unsigned char | _CNV_S_5_THRO_RANGE_897 | 1 | 1 | 0 |
| STAT_0x589F_WERT | 0x589F | STAT_0x589F_WERT | Status Drosselklappendiagnose Bank2 | 0-n | STATE_TPS_DIAG[2] | - | unsigned char | _CNV_S_5_THRO_RANGE_897 | 1 | 1 | 0 |
...
| STAT_0x58A2_WERT | 0x58A2 | STAT_0x58A2_WERT | Wasserpumpe Stromaufnahme | A | CUR_CNS_CWP | - | unsigned char | - | 0,20000000298023224 | 1 | 0,0 |
...
| STAT_0x58D7_WERT | 0x58D7 | STAT_0x58D7_WERT | Druck vor Drosselklappe Bank 2 | kPa | PUT_KWP[2] | - | unsigned char | - | 1,0 | 1 | 0,0 |
| STAT_0x58D8_WERT | 0x58D8 | STAT_0x58D8_WERT | Sensorspannung Sensor Druck vor Drosselklappe Bank 2 | V | V_PUT_KWP[2] | - | unsigned char | - | 0,019531216472387314 | 1 | 0,0 |
...
| STAT_0x58DD_WERT | 0x58DD | STAT_0x58DD_WERT | Druck vor Drosselklappe Bank 1(Turbo) | kPa | PUT_KWP[1] | - | unsigned char | - | 1,0 | 1 | 0,0 |
| STAT_0x58DE_WERT | 0x58DE | STAT_0x58DE_WERT | Sensorspannung Sensor Druck vor Drosselkappe Bank 1 | V | V_PUT_KWP[1] | - | unsigned char | - | 0,019531216472387314 | 1 | 0,0 |
| STAT_0x58DF_WERT | 0x58DF | STAT_0x58DF_WERT | relative Wasserpumpenleistung, CWP_2_1 | % | REL_CWP_2_1_PWR | - | unsigned char | - | 0,390625 | 1 | 0,0 |
...
| STAT_0x58E4_WERT | 0x58E4 | STAT_0x58E4_WERT | Betriebsart Istwert | 0-n | BA_IST | - | unsigned char | _CNV_S_5__CNV_S_5_D_631 | 1 | 1 | 0 |
...
| STAT_0x58E9_WERT | 0x58E9 | STAT_WASSERPUMPE_SPANNUNG_WERT | Wasserpumpe Spannung  | V | V_CWP | - | unsigned char | - | 0,10000000149011612 | 1 | 0,0 |
| STAT_0x58EA_WERT | 0x58EA | STAT_0x58EA_WERT | Wasserpumpe Drehzahl | - | N_REL_CWP_2 | - | unsigned char | - | 1,0 | 1 | 0,0 |
| STAT_0x58EB_WERT | 0x58EB | STAT_WASSERPUMPE_DREHZAHL_SOLL_IST_DIFFERENZ_WERT | Wasserpumpe Soll -Ist_Differenz | - | N_REL_CWP_DIF | - | unsigned char | - | 1,0 | 1 | 0,0 |
| STAT_0x58EC_WERT | 0x58EC | STAT_0x58EC_WERT | Wasserpumpe Temperatur Elektronik | °C | TEMP_EL_CWP | - | unsigned char | - | 1,0 | 1 | -50,0 |
| STAT_0x58EF_WERT | 0x58EF | STAT_0x58EF_WERT | gemittelter Raildruck Bank 2 | hPa | FUP_KWP[2] | - | unsigned char | - | 1358,5177001953125 | 1 | 0,0 |
| STAT_0x58F0_WERT | 0x58F0 | STAT_0x58F0_WERT | gemittelter Raildruck Bank 1 | hPa | FUP_KWP[1] | - | unsigned char | - | 1358,5177001953125 | 1 | 0,0 |
| IDMEL | 0x58F1 | STAT_DME_LOSNUMMER_WERT | DME - Losnummer | 0-n | STATE_LRN_ECU_KWP | - | unsigned char | _CNV_S_11_RANGE_STAT_862 | 1 | 1 | 0 |
| STAT_0x58F2_WERT | 0x58F2 | STAT_0x58F2_WERT | Wasserpumpe Drehzahl Soll-Ist-Vergleich, CWP_2_2 | - | N_REL_CWP_2_2_DIF | - | unsigned char | - | 1,0 | 1 | 0,0 |
| STAT_0x58F3_WERT | 0x58F3 | STAT_0x58F3_WERT | Fuel pressure EFP | hPa | FUP_EFP_KWP | - | unsigned char | - | 42,453758239746094 | 1 | 0,0 |
...
| STAT_0x5A02_WERT | 0x5A02 | STAT_0x5A02_WERT |  Bedingungen für Ablaufen der Turboladerdiagnose erfüllt Lader 1 | 0/1 | LV_CDN_DIAG_TCHA_LEAK_1 | - | unsigned integer | - | 1 | 1 | 0 |
| STAT_0x5A03_WERT | 0x5A03 | STAT_0x5A03_WERT | Turboladerdiagnose gesamthaft abgelaufen Lader 1 | 0/1 | LV_END_DIAG_TCHA_LEAK_1 | - | unsigned integer | - | 1 | 1 | 0 |
...
| STAT_0x5A06_WERT | 0x5A06 | STAT_0x5A06_WERT | Ladediagnose Bank 2 | 0/1 | LV_CDN_DIAG_TCHA_LEAK_2 | - | unsigned integer | - | 1 | 1 | 0 |
| STAT_0x5A07_WERT | 0x5A07 | STAT_0x5A07_WERT | Ende Ladediagnose Bank2 | 0/1 | LV_END_DIAG_TCHA_LEAK_2 | - | unsigned integer | - | 1 | 1 | 0 |
...
| STAT_0x5A1A_WERT | 0x5A1A | STAT_0x5A1A_WERT | Ausgabebedingung für Ladedruck, nierdrige Aufladung, Bank 1 | 0/1 | LV_CDN_DIAG_TCHA_PRS_LOW_1 | - | unsigned integer | - | 1 | 1 | 0 |
| STAT_0x5A1B_WERT | 0x5A1B | STAT_0x5A1B_WERT | Ausgabebedingung für Ladedruck, nierdrige Aufladung, Bank 2 | 0/1 | LV_CDN_DIAG_TCHA_PRS_LOW_2 | - | unsigned integer | - | 1 | 1 | 0 |
| STAT_0x5A1C_WERT | 0x5A1C | STAT_0x5A1C_WERT | Ausgabebedingung für Ladedruck, hohe Aufladung, Bank 1 | 0/1 | LV_CDN_DIAG_TCHA_PRS_HIGH_1 | - | unsigned integer | - | 1 | 1 | 0 |
| STAT_0x5A1D_WERT | 0x5A1D | STAT_0x5A1D_WERT | Ausgabebedingung für Ladedruck, hohe Aufladung, Bank 2 | 0/1 | LV_CDN_DIAG_TCHA_PRS_HIGH_2 | - | unsigned integer | - | 1 | 1 | 0 |
...
| STAT_0x5A2F_WERT | 0x5A2F | STAT_0x5A2F_WERT | gemessener Tankdruck | MPa | FUP_RNG_H_MES | - | unsigned integer | - | 0,00390625 | 1 | 0,0 |
...
| ISHN1 | 0x5A54 | STAT_SONDENHEIZUNG_NACHKAT_BANK1_WERT | Status LS Heizung hinter Katalysator Bank 1 | 0-n | STATE_LSH_DOWN[1] | - | unsigned char | _CNV_S_7_EGCP_RANGE_275 | 1 | 1 | 0 |
| ISHN2 | 0x5A55 | STAT_SONDENHEIZUNG_NACHKAT_BANK2_WERT | Status LS Heizung hinter Katalysator Bank 2 | 0-n | STATE_LSH_DOWN[2] | - | unsigned char | _CNV_S_7_EGCP_RANGE_275 | 1 | 1 | 0 |
| ISHV1 | 0x5A56 | STAT_SONDENHEIZUNG_VORKAT_BANK1_WERT | Status LS Heizung vor Katalysator Bank 1 | 0-n | STATE_LSH_UP[1] | - | unsigned char | _CNV_S_7_EGCP_RANGE_275 | 1 | 1 | 0 |
| ISHV2 | 0x5A57 | STAT_SONDENHEIZUNG_VORKAT_BANK2_WERT | Status LS Heizung vor Katalysator Bank 2 | 0-n | STATE_LSH_UP[2] | - | unsigned char | _CNV_S_7_EGCP_RANGE_275 | 1 | 1 | 0 |
...
| STAT_0x5A7C_WERT | 0x5A7C | STAT_0x5A7C_WERT | Lüfterfehler mit Funktionseinschränkungen | 0/1 | lv_err_ecfpwm_fb_3 | - | unsigned char | - | 1 | 1 | 0 |
| STAT_0x5A7D_WERT | 0x5A7D | STAT_0x5A7D_WERT | Schwerwiegender Lüfterfehler | 0/1 | lv_err_ecfpwm_fb_4 | - | unsigned char | - | 1 | 1 | 0 |
...
| STAT_0x5AE2_WERT | 0x5AE2 | STAT_0x5AE2_WERT | Resetart des letzten Resets | 0-n | STATE_RST_TYP_ACT | - | unsigned char | _CNV_S_19_ECOP_RANGE_806 | 1 | 1 | 0 |
...
<a id="table-cnv-s-11-range-stat-862"></a>
### _CNV_S_11_RANGE_STAT_862
...
<a id="table-cnv-s-12-cnv-s-12-698"></a>
### _CNV_S_12__CNV_S_12__698
...
<a id="table-cnv-s-19-ecop-range-806"></a>
### _CNV_S_19_ECOP_RANGE_806
...
<a id="table-cnv-s-4-egcp-range-294"></a>
### _CNV_S_4_EGCP_RANGE_294
...
<a id="table-cnv-s-4-egcp-range-301"></a>
### _CNV_S_4_EGCP_RANGE_301
...
<a id="table-cnv-s-5-laco-range-342"></a>
### _CNV_S_5_LACO_RANGE_342
...
<a id="table-cnv-s-5-thro-range-897"></a>
### _CNV_S_5_THRO_RANGE_897
...
<a id="table-cnv-s-5-cnv-s-5-d-631"></a>
### _CNV_S_5__CNV_S_5_D_631
...
<a id="table-cnv-s-6-laco-range-350"></a>
### _CNV_S_6_LACO_RANGE_350
...
<a id="table-cnv-s-6-range-stat-110"></a>
### _CNV_S_6_RANGE_STAT_110
...
<a id="table-cnv-s-7-egcp-range-275"></a>
### _CNV_S_7_EGCP_RANGE_275
...
<a id="table-cnv-s-7-range-ecu-108"></a>
### _CNV_S_7_RANGE_ECU__108
...
<a id="table-msd85kwp-cnv-s-2-def-bit-ub-755-cm-4dc3300s"></a>
...
<a id="table-msd85kwp-cnv-s-2-def-bit-ub-755-cm0x2-4dc3300s"></a>
...
<a id="table-msd85kwp-cnv-s-5-range-stat-1007-cm-9zce401s"></a>
### _MSD85KWP_CNV_S_5_RANGE_STAT_1007_CM_9ZCE401S
...
<a id="table-msd85kwp-cnv-s-4-range-stat-1006-cm-9zce401s"></a>
### _MSD85KWP_CNV_S_4_RANGE_STAT_1006_CM_9ZCE401S
...
<a id="table-msd85kwp-cnv-s-4-range-stat-1009-cm-9zce401s"></a>
### _MSD85KWP_CNV_S_4_RANGE_STAT_1009_CM_9ZCE401S
...
<a id="table-msd85kwp-cnv-s-2-range-stat-1008-cm-9zce401s"></a>
### _MSD85KWP_CNV_S_2_RANGE_STAT_1008_CM_9ZCE401S
...
<a id="table-msd85kwp-table-status-configmdrv-state-spt-pste-can"></a>
### _MSD85KWP_TABLE_STATUS_CONFIGMDRV_STATE_SPT_PSTE_CAN
...
<a id="table-msd85kwp-table-switch-position-high-byte-bit7"></a>
...
<a id="table-msd85kwp-table-switch-position-high-byte-bit6"></a>
...
<a id="table-msd85kwp-table-switch-position-high-byte-bit5"></a>
...
<a id="table-msd85kwp-table-switch-position-high-byte-bit4"></a>
...
<a id="table-msd85kwp-table-switch-position-high-byte-bit3"></a>
...
<a id="table-msd85kwp-table-switch-position-high-byte-bit2"></a>
...
<a id="table-msd85kwp-table-switch-position-high-byte-bit1"></a>
...
<a id="table-msd85kwp-table-switch-position-high-byte-bit0"></a>
...
<a id="table-msd85kwp-table-switch-position-low-byte-bit7"></a>
...
<a id="table-msd85kwp-table-switch-position-low-byte-bit6"></a>
...
<a id="table-msd85kwp-table-switch-position-low-byte-bit3"></a>
...
<a id="table-msd85kwp-table-switch-position-low-byte-bit2"></a>
...
<a id="table-msd85kwp-table-switch-position-bit7"></a>
...
<a id="table-msd85kwp-table-switch-position-bit4"></a>
...
<a id="table-msd85kwp-table-switch-position-bit3"></a>
...
<a id="table-msd85kwp-table-switch-position-bit2"></a>
...
<a id="table-msd85kwp-table-switch-position-bit1"></a>
...
<a id="table-msd85kwp-table-switch-position-bit0"></a>
...
<a id="table-msd85kwp-cnv-s-2-def-bit-ub-716-cm0x4"></a>
...
<a id="table-msd85kwp-cnv-s-4-range-stat-455-cm-4dc3200s"></a>
...
<a id="table-msd85kwp-tabel-status-obd-readiness"></a>
...
<a id="table-msd85kwp-tabel-status-obd-monitor"></a>
...
<a id="table-msd85kwp-table-ecos"></a>
...
<a id="table-msd85kwpdef-st-atlsvc-bmsnf"></a>
...
<a id="table-msd85kwpdef-st-atlsvc-pvdk-bmsnf"></a>
...
<a id="table-msd85kwp-cnv-s-2-def-bit-uw-683-cm-4dc3500s"></a>
...
<a id="table-msd85kwp-cnv-s-10-state-eol-449-cm-4dc3200s"></a>
### _MSD85KWP_CNV_S_10_STATE_EOL__449_CM_4DC3200S_
...
<a id="table-msd85kwp-cnv-s-13-state-dmtl-140-cm"></a>
...
<a id="table-msd85kwp-table-st-gentest"></a>
...
<a id="table-msd85kwp-table-geniutest-err-bit0"></a>
...
<a id="table-msd85kwp-table-geniutest-err-bit1"></a>
...
<a id="table-msd85kwp-table-geniutest-err-bit2"></a>
...
<a id="table-msd85kwp-table-geniutest-err-bit3"></a>
...
<a id="table-msd85kwp-table-geniutest-err-bit4"></a>
...
<a id="table-msd85kwp-table-geniutest-err-bit5"></a>
...
<a id="table-msd85kwp-table-geniutest-err-bit6"></a>
...
<a id="table-msd85kwp-table-geniutest-err-bit7"></a>
...
<a id="table-msd85kwp-table-geniutest-ab-bit0"></a>
...
<a id="table-msd85kwp-cnv-s-10-state-eol-422-cm-761i200s"></a>
...
<a id="table-msd85kwp-table-glf-high-byte-bit7"></a>
...
<a id="table-msd85kwp-table-glf-high-byte-bit6"></a>
...
<a id="table-msd85kwp-table-glf-high-byte-bit5"></a>
...
<a id="table-msd85kwp-table-glf-high-byte-bit4"></a>
...
<a id="table-msd85kwp-table-glf-high-byte-bit3"></a>
...
<a id="table-msd85kwp-table-glf-high-byte-bit2"></a>
...
<a id="table-msd85kwp-table-glf-high-byte-bit1"></a>
...
<a id="table-msd85kwp-table-glf-high-byte-bit0"></a>
...
<a id="table-msd85kwp-table-glf-low-byte-bit7"></a>
...
<a id="table-msd85kwp-table-glf-low-byte-bit6"></a>
...
<a id="table-msd85kwp-table-glf-low-byte-bit5"></a>
...
<a id="table-msd85kwp-table-glf-low-byte-bit4"></a>
...
<a id="table-msd85kwp-table-glf-low-byte-bit3"></a>
...
<a id="table-msd85kwp-table-glf-low-byte-bit2"></a>
...
<a id="table-msd85kwp-table-glf-low-byte-bit1"></a>
...
<a id="table-msd85kwp-table-glf-low-byte-bit0"></a>
...
<a id="table-msd85kwp-cnv-s-2-def-bit-ub-741-cm"></a>
...
<a id="table-msd85kwp-cnv-s-14-state-vls-226-cm-4dc3200s"></a>
...
<a id="table-msd85kwp-cnv-s-6-state-diag-157-cm"></a>
...
<a id="table-msd85kwp-table-fs"></a>
### _MSD85KWP_TABLE_FS
...
<a id="table-msd85kwp-cnv-s-4-cybl-range-180-cm-792a900s"></a>
### _MSD85KWP_CNV_S_4_CYBL_RANGE_180_CM_792A900S
...
<a id="table-msd85kwp-cnv-s-4-cybl-range-179-cm-792a900s"></a>
### _MSD85KWP_CNV_S_4_CYBL_RANGE_179_CM_792A900S
...
<a id="table-msd85kwp-cnv-s-4-state-ch-776-cm-762e940s"></a>
### _MSD85KWP_CNV_S_4_STATE_CH_776_CM_762E940S
...
<a id="table-msd85kwp-cnv-s-5-def-ba-gdi-588-cm"></a>
