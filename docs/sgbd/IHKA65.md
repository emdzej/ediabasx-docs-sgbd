...
- [STATUS_ANALOGEINGAENGE](#job-status-analogeingaenge) - Auslesen der 30 A/D-Werte + 2 CAN-Signale KWP2000: $30 InputOutputControlByLocalIdentifier $01 ReportCurrentState Modus  : Default
...
- [STATUS_IO](#job-status-io) - Auslesen der 8 Ports KWP2000: $30 InputOutputControlByLocalIdentifier $01 ReportCurrentState Modus  : Default
- [STATUS_MOTOR_KLAPPENPOSITION](#job-status-motor-klappenposition) - Auslesen der 14 Klappenpositionen KWP2000: $30 InputOutputControlByLocalIdentifier $01 ReportCurrentState Modus  : Default
...
- [STATUS_MOTOR_FEHLER](#job-status-motor-fehler) - Auslesen der MUX4-Motoren-Fehler KWP2000: $30 InputOutputControlByLocalIdentifier $01 ReportCurrentState Modus  : Default
...
- [STEUERN_HECKROLLO](#job-steuern-heckrollo) - Ansteuern des Heckrollos im Diagnosemode KWP2000: $30 InputOutputControlByLocalIdentifier $07 ShortTermAdjustment Modus  : Default
...
- [STATUS_KLIMAGERAETETYP](#job-status-klimageraetetyp) - Gibt den Typ des Klimageraetes zurueck KWP2000: $30 InputOutputControlByLocalIdentifier $07 ShortTermAdjustment Modus  : Default
...
- [STEUERN_BEDIENTEIL_POTENTIOMETER](#job-steuern-bedienteil-potentiometer) - Simulieren von Verstellungen der Drehsteller am Bedienteil KWP2000: $30 InputOutputControlByLocalIdentifier $07 ShortTermAdjustment Modus  : Default
- [ZWP_AKTIVIEREN](#job-zwp-aktivieren) - Aktivieren der Zusatzwasserpumpe (Setzen des Codierbits) KWP 2000: $1A Ident KWP 2000: $23 ReadMemoryByAddress KWP 2000: $31 StartRoutineByLocalIdentifier KWP 2000: $23 ReadMemoryByAddress Modus   : Default
- [ZWP_DEAKTIVIEREN](#job-zwp-deaktivieren) - Deaktivieren der Zusatzwasserpumpe (Löschen des Codierbits) KWP 2000: $1A Ident KWP 2000: $23 ReadMemoryByAddress KWP 2000: $31 StartRoutineByLocalIdentifier KWP 2000: $23 ReadMemoryByAddress Modus   : Default
...
- [REICHWEITENSCHWELLE_SETZEN](#job-reichweitenschwelle-setzen) - Setzen der Reichweitenschwelle für die Aktivierung der Standheizung. Falls kein Parameter angegeben wird, erfolgt eine Codierung auf 0 km. KWP 2000: $1A Ident KWP 2000: $23 ReadMemoryByAddress KWP 2000: $31 StartRoutineByLocalIdentifier KWP 2000: $23 ReadMemoryByAddress Modus   : Default
- [_Schwelle_Heckrollo_erhoehen](#job-schwelle-heckrollo-erhoehen) - Achtung: nur für E67 zulässig!! EEPROM-Wert in der IHKA ändern relativen Grenzwert für Abschaltung des Heckrollostromes auf 1,5 A erhöhen
...
| STAT_RESERVE_2_WERT | real | Freier AD-Kanal |
| STAT_RESERVE_2_EINH | string | Volt |
| STAT_RESERVE_3_WERT | real | Freier AD-Kanal |
| STAT_RESERVE_3_EINH | string | Volt |
...
| STAT_MONI_HECKROLLO_WERT | int | Monitor Heckrollo |
| STAT_MONI_HECKROLLO_EINH | string | Inkremente |
...
| STAT_RESERVE_4_WERT | real | Freier AD-Kanal |
| STAT_RESERVE_4_EINH | string | Volt |
| STAT_FONDRAUM_VERSORGUNG_WERT | real | Spannungsversorgung Fondraumpoti |
| STAT_FONDRAUM_VERSORGUNG_EINH | string | Volt |
| STAT_FONDRAUM_LI_WERT | int | Fondraumpoti links |
| STAT_FONDRAUM_LI_EINH | string | Volt |
| STAT_FONDRAUM_RE_WERT | int | Fondraumpoti rechts |
| STAT_FONDRAUM_RE_EINH | string | Volt |
...
| STAT_GEBLAESE_FOND_LI_WERT | int | Geblaesepoti Fondraum links |
| STAT_GEBLAESE_FOND_RE_WERT | int | Geblaesepoti Fondraum rechts |
| STAT_GEBLAESE_FOND_LI_EINH | string | Volt |
| STAT_GEBLAESE_FOND_RE_EINH | string | Volt |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| STAT_HECKROLLO_UNTEN_EIN | int |  |
| STAT_HECKROLLO_OBEN_EIN | int |  |
| STAT_SH_LED_BLINKEN_EIN | int |  |
| STAT_ENDSCHALTER_ABLAGEFACH_EIN | int |  |
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_AUC_SENSOR_WERT | int | 0 = Noch kein Sensor erkannt (Bei automatischer Erkennung) 1 = Kostal AUC I-Sensor erkannt 2 = Paragon AUC II-Sensor erkannt 3 = Paragon AUC II/MK4-Sensor erkannt |
| STAT_AUC_SENSOR_TEXT | string | Sensor in Klartext |
| STAT_AUC_AUSGANG_EINH | string | % oder Volt |
| STAT_AUC_AUSGANG_WERT | int | -1 = Wird von SW-Version nicht unterstuetzt Duty-Cycle des PWM-Signals in Prozent |
| STAT_AUC_LUFTGUETE_STUFE | int | -1 = Wird von SW-Version nicht unterstuetzt AUC I-Sensor (0 = Schadstoffwerte OK, 1 = Schadstoffe NOK) AUC II, AUC II/MK4-Sensor Luftguetestufe 0 bis 6, Sensorfehler = 255 |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
<a id="job-status-klimageraetetyp"></a>
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| GERAETETYP | int | 0   : IHKA High ohne HKA-Betrieb oder altes Gerät 1   : IHKA Basis 2   : IHKA für HKA-Betrieb 3   : nicht definiert |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
<a id="job-steuern-bedienteil-potentiometer"></a>
...
| Name | Type | Comment |
| --- | --- | --- |
| MELDUNG | string | ausgelesene Daten |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
<a id="job-reichweitenschwelle-setzen"></a>
...
| Name | Type | Comment |
| --- | --- | --- |
| ALTE_REICHWEITEN_SCHWELLE | unsigned int | Reichweitenschwelle bevor umcodiert wurde. |
| MELDUNG | string | ausgelesene Daten |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |

<a id="job-schwelle-heckrollo-erhoehen"></a>
