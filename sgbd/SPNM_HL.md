...
| Field | Value |
| --- | --- |
| ECU | Sitz-Pneumatik-Modul hinten links |
...
| --- | --- | --- |
| 0x025A00 | Energiesparmode aktiv | 0 |
| 0x025A08 | Codierung: Steuergerät ist nicht codiert | 0 |
| 0x025A09 | Codierung: Fehler bei Codierdatentransaktion aufgetreten | 0 |
| 0x025A0A | Codierung: Signatur der Codierdaten ungültig | 0 |
| 0x025A0B | Codierung: Codierdaten passen nicht zum Fahrzeug | 0 |
| 0x025A0C | Codierung: Unplausible Daten während Codierdatentransaktion | 0 |
| 0x025A0D | Codierung: Codierdaten nicht qualifiziert | 0 |
| 0x025A20 | CAN-Fehler (Sammelfehler) | 0 |
| 0x025A23 | Flash Memory Fehler (Sammelfehler) | 0 |
| 0x025A29 | Softwarefehler (Sammelfehler) | 0 |
| 0x02FF5A | Dummy-Fehlerspeichereintrag im Komponentenfehlerbereich nur für Testzwecke | 1 |
| 0x806A80 | Überspannung erkannt | 1 |
| 0x806A81 | Unterspannung erkannt | 1 |
| 0x806A82 | SPNM_HL: Verbauort unplausibel | 0 |
| 0x806A83 | SPNM Pumpe: Leitungsunterbrechung | 0 |
| 0x806A84 | SPNM Pumpe: Überlast oder Kurzschluss | 0 |
| 0x806A85 | Lordose, obere Blase (Ventil 1): Zieldruck wird nicht erreicht | 0 |
| 0x806A86 | Lordose, untere Blase (Ventil 2): Zieldruck wird nicht erreicht | 0 |
| 0x806A87 | Aktivsitz, linke Blase (Ventil 3): Zieldruck wird nicht erreicht | 0 |
| 0x806A88 | Aktivsitz, rechte Blase (Ventil 4): Zieldruck wird nicht erreicht | 0 |
| 0x806A89 | Massage, Blase 1 (Ventil 5): Zieldruck wird nicht erreicht | 0 |
| 0x806A8A | Massage, Blase 2 (Ventil 6): Zieldruck wird nicht erreicht | 0 |
| 0x806A8B | Massage, Blase 3 (Ventil 7): Zieldruck wird nicht erreicht | 0 |
| 0x806A8C | Massage, Blase 4 (Ventil 8): Zieldruck wird nicht erreicht | 0 |
| 0x806A8D | Massage, Blase 5 (Ventil 9): Zieldruck wird nicht erreicht | 0 |
| 0x806A8E | Massage, Blase 6 (Ventil 10): Zieldruck wird nicht erreicht | 0 |
| 0x806A8F | Rotationsblase mitte links (Ventil 11): Zieldruck wird nicht erreicht | 0 |
| 0x806A90 | Rotationsblase mitte rechts (Ventil 12): Zieldruck wird nicht erreicht | 0 |
| 0x806A91 | Rotationsblase oben rechts (Ventil 13): Zieldruck wird nicht erreicht | 0 |
| 0x806A92 | Rotationsblase oben links (Ventil 14): Zieldruck wird nicht erreicht | 0 |
| 0x806A93 | Taster Lordose: Taster hängt | 0 |
| 0x806A95 | Taster Lordose: Leitungsfehler | 0 |
| 0x806A96 | Taste Massage: Taste hängt | 0 |
| 0x806A97 | SPNM: interner Hardwarefehler (Sammelfehler für Ventile und Drucksensoren) | 0 |
| 0x806A99 | Lordose, obere Blase (Ventil 1): Zieldruck wird zu schnell erreicht | 0 |
| 0x806A9A | Lordose, untere Blase (Ventil 2): Zieldruck wird zu schnell erreicht | 0 |
| 0x806A9B | Aktivsitz, linke Blase (Ventil 3): Zieldruck wird zu schnell erreicht | 0 |
| 0x806A9C | Aktivsitz, rechte Blase (Ventil 4): Zieldruck wird zu schnell erreicht | 0 |
| 0x806A9D | Massage, Blase 1 (Ventil 5): Zieldruck wird zu schnell erreicht | 0 |
| 0x806A9E | Massage, Blase 2 (Ventil 6): Zieldruck wird zu schnell erreicht | 0 |
| 0x806A9F | Massage, Blase 3 (Ventil 7): Zieldruck wird zu schnell erreicht | 0 |
| 0x806AA0 | Massage, Blase 4 (Ventil 8): Zieldruck wird zu schnell erreicht | 0 |
| 0x806AA1 | Massage, Blase 5 (Ventil 9): Zieldruck wird zu schnell erreicht | 0 |
| 0x806AA2 | Massage, Blase 6 (Ventil 10): Zieldruck wird zu schnell erreicht | 0 |
| 0x806AA3 | Rotationsblase mitte links (Ventil 11): Zieldruck wird zu schnell erreicht | 0 |
| 0x806AA4 | Rotationsblase mitte rechts (Ventil 12): Zieldruck wird zu schnell erreicht | 0 |
| 0x806AA5 | Rotationsblase oben rechts (Ventil 13): Zieldruck wird zu schnell erreicht | 0 |
| 0x806AA6 | Rotationsblase oben links (Ventil 14): Zieldruck wird zu schnell erreicht | 0 |
| 0x806AA7 | SPNM_HL: Verbauort nicht angelernt | 0 |
| 0x806AA8 | Temperatur im Steuergerät ausserhalb des Betriebsbereichs | 1 |
| 0x806AA9 | Umgebungsdruck ausserhalb des Betriebsbereichs | 1 |
| 0x806AAA | SPNM: Vordruckkanal undicht | 0 |
| 0x806AAB | Drucksensor Vordruckkanal: Druck ausserhalb des zulässigen Bereichs | 1 |
| 0x806AAC | Drucksensor Rotationsblase oben rechts: Druck ausserhalb des zulässigen Bereichs | 1 |
| 0x806AAD | Drucksensor Rotationsblase oben links: Druck ausserhalb des zulässigen Bereichs | 1 |
| 0xDF8468 | BODY-CAN Control Module Bus OFF | 0 |
| 0xDF8BFF | Dummy-Fehlerspeichereintrag im Netzwerkfehlerbereich nur für Testzwecke | 1 |
| 0xDF9400 | Botschaft (0x1A1, Geschwindigkeit Fahrzeug): Ausfall | 1 |
| 0xDF9401 | Botschaft (0x19A, Querbeschleunigung Schwerpunkt): Ausfall | 1 |
| 0xDF9402 | Botschaft (0xAB, Status Crash): Ausfall | 1 |
...
| ORT | ORTTEXT | EREIGNIS_DTC |
| --- | --- | --- |
| 0x5A0015 | Ventil  M1 defekt | 0 |
| 0x5A0016 | Ventil  M2 defekt | 0 |
| 0x5A0017 | Ventil  M3 defekt | 0 |
| 0x5A0018 | Ventil  M4 defekt | 0 |
| 0x5A0019 | Ventil  M5 defekt | 0 |
| 0x5A0020 | Ventil  M6 defekt | 0 |
| 0x5A0021 | Ventil  R1 defekt | 0 |
| 0x5A0022 | Ventil  R2 defekt | 0 |
| 0x5A0023 | Ventil  R1 AS2 defekt | 0 |
| 0x5A0024 | Ventil  R2 AS1 defekt | 0 |
| 0x5A0025 | Ventil  LD1 defekt | 0 |
| 0x5A0026 | Ventil  LD2 defekt | 0 |
| 0x5A0027 | Ventil  AS1 defekt | 0 |
| 0x5A0028 | Ventil  AS2 defekt | 0 |
| 0x5A0029 | Drucksensor Umgebungsdruck defekt | 0 |
| 0x5A0030 | Drucksensor Vordruck defekt | 0 |
| 0x5A0031 | Drucksensor Rotationsblase oben rechts defekt | 0 |
| 0x5A0032 | Drucksensor Rotationsblase oben links defekt | 0 |
| 0x5A0033 | Temperatursensor defekt | 0 |
