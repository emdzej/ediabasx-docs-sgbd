...
| Field | Value |
| --- | --- |
| ECU | Motorrad Schlüsselloses Zugangssystem |
| ORIGIN | BMW UX-EE-2 Dominik_Hecker |
| REVISION | 2.003 |
...
- [RES_0X4009_D](#table-res-0x4009-d) (3 × 10)
- [RES_0X400C_D](#table-res-0x400c-d) (37 × 10)
- [RES_0XB007_R](#table-res-0xb007-r) (1 × 13)
- [RES_0XDC54_D](#table-res-0xdc54-d) (4 × 10)
- [RES_0XE00E_D](#table-res-0xe00e-d) (1 × 10)
- [RES_0XE183_D](#table-res-0xe183-d) (2 × 10)
- [RES_0XE184_D](#table-res-0xe184-d) (2 × 10)
- [RES_0XE185_D](#table-res-0xe185-d) (3 × 10)
- [RES_0XE186_D](#table-res-0xe186-d) (3 × 10)
- [RES_0XE187_D](#table-res-0xe187-d) (2 × 10)
- [SG_FUNKTIONEN](#table-sg-funktionen) (21 × 16)
- [SVK_VERSION_DOP](#table-svk-version-dop) (2 × 2)
- [TAB_CAS_RSSI_COMMANDS](#table-tab-cas-rssi-commands) (3 × 2)
- [TAB_MR_BOLZEN_TREIBER](#table-tab-mr-bolzen-treiber) (4 × 2)
- [TAB_MR_RES_ROUTINESTATUS_SLZ](#table-tab-mr-res-routinestatus-slz) (6 × 2)
- [TAB_MR_SLZ_BOLZEN_POSITION](#table-tab-mr-slz-bolzen-position) (7 × 2)
- [TAB_MR_SLZ_FB_BATT](#table-tab-mr-slz-fb-batt) (4 × 2)
- [TAB_MR_SLZ_MESSLEITUNG](#table-tab-mr-slz-messleitung) (4 × 2)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| PWM_DC_DATA | DATA | high | data[20] | - | - | 1.0 | 1.0 | 0.0 | - | - | PWM-DC-Tabelle |
...
| ARG | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | MIN | MAX | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ID_DATA | DATA | high | data[7] | - | - | 1.0 | 1.0 | 0.0 | - | - | SGBM-Id und HW-Version |
...
| ARG | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | MIN | MAX | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| HERSTELLDATUM_DATA | DATA | high | data[3] | - | - | 1.0 | 1.0 | 0.0 | - | - | Herstelldatum |
...
| ARG | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | MIN | MAX | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| LOCK_DATA | HEX | high | unsigned char | - | - | - | - | - | - | - | Überschreibschutz Huf-Data setzen |
...
| ARG | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | MIN | MAX | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ICT_BYTE | HEX | high | unsigned char | - | - | - | - | - | - | - | ICT Prüfstempel |
...
| ARG | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | MIN | MAX | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ZSB_BYTE_WERT | HEX | high | unsigned char | - | - | - | - | - | - | - | ZSB Prüfbyte |
...
| 0x804001 | Softwarefehler Steuergeraet | 0 |
| 0x804002 | Codierung : Steuergerät ist nicht codiert | 0 |
| 0x804003 | Codierung : Codiersignaturfehler | 0 |
| 0x804004 | Codierung : Codierdatenübertragungsfehler | 0 |
...
| 0x804010 | Fehler Transponderdaten | 0 |
| 0x804011 | Fehler DMEDDE_SK | 0 |
| 0x804013 | Fehler TRSP_SK | 0 |
| 0x804014 | Unbekannter KEY_ID | 0 |
| 0x804015 | Ungültiger Schlüssel | 0 |
| 0x804016 | EMC Modus aktiv | 0 |
| 0x804018 | KL15 Treiber: Kurzschluss nach Masse | 0 |
| 0x804019 | KL15 Treiber: Kurzschluss nach Ubat | 0 |
| 0x80401D | Fehler Tankschalter | 0 |
| 0x80402A | Weckleitung Treiber: Kurzschluss nach Masse | 1 |
| 0x80402B | Vorbedingungen Verriegeln nicht erfüllt | 1 |
...
| ORT | ORTTEXT | EREIGNIS_DTC |
| --- | --- | --- |
| 0x80400F | Fehler Motortreiber | 0 |
| 0x804012 | Fehler HF Empfänger | 0 |
| 0x80401B | Fehler Basisstation | 0 |
| 0x80401C | Fehler LF Antenne | 0 |
| 0x80401E | Fehler Treiber Tankdeckel | 0 |
| 0x80401F | Fehler Verriegelungstaster | 0 |
| 0x804020 | Fehlerhafte BOLT_IN Bedingung | 0 |
| 0x804021 | Fehlerhafte BOLT_OUT Bedingung | 0 |
| 0x804022 | Nachricht 1 EWS-Challenge fehlt | 1 |
| 0x804023 | Nachricht 2 oder 3 EWS-Challenge fehlt | 1 |
| 0x804026 | EWS-Challenge ungültig | 0 |
| 0x804028 | SEK Ueberspannung Batterie | 1 |
| 0x804029 | SEK Unterspannung Batterie | 1 |
| 0x80402C | Fehler KL15-Treiber | 0 |
| 0x80402D | Klemme 15 Signal (HW) ungültig | 0 |
| 0x80402E | Positionsschalter S300 ungültige Signalkombination | 0 |
| 0x80402F | Positionsschalter S301 ungültige Signalkombination | 0 |
| 0x804030 | Motor Kurzschluß nach Plus | 0 |
| 0x804031 | Motor Kurzschluß nach Masse | 0 |
| 0x804032 | Unerwuenschter Steuergeraete Reset | 0 |
| 0x804033 | Motor Open Load oder Ansteuerung defekt | 0 |
| 0xFFFFFF | unbekannter Fehlerort | 0 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_PWM_DC_DATA | DATA | high | data[20] | - | - | 1.0 | 1.0 | 0.0 | PWM-DC-Tabelle |
...
| RESULTNAME | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_ICT_BYTE_WERT | HEX | high | unsigned char | - | - | - | - | - | ICT Prüfstempel |
...
| RESULTNAME | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_ZSB_BYTE_WERT | HEX | high | unsigned char | - | - | - | - | - | ZSB Prüfbyte |
...
| RESULTNAME | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_BOLZEN_TREIBER | 0-n | high | unsigned char | - | TAB_MR_BOLZEN_TREIBER | - | - | - | Zustand Treiber |
| STAT_BOLZEN_TREIBER_PWM_WERT | % | high | unsigned char | - | - | 1.0 | 1.0 | 0.0 | PWM Wert des Treibers |
| STAT_BOLZEN_TREIBER_I_WERT | - | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Strom durch den Treiber |
...
| RESULTNAME | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_WUP_0_WERT | HEX | high | unsigned char | - | - | - | - | - | Schlüsseldaten 1 |
| STAT_WUP_1_WERT | HEX | high | unsigned char | - | - | - | - | - | Schlüsseldaten 2 |
| STAT_WUP_2_WERT | HEX | high | unsigned char | - | - | - | - | - | Schlüsseldaten 3 |
| STAT_PROG_TAG_WERT | HEX | high | unsigned char | - | - | - | - | - | Schlüsseldaten 4 |
| STAT_PROG_MONAT_WERT | HEX | high | unsigned char | - | - | - | - | - | Schlüsseldaten 5 |
| STAT_PROG_JAHR_1_WERT | HEX | high | unsigned char | - | - | - | - | - | Schlüsseldaten 6 |
| STAT_PROG_JAHR_2_WERT | HEX | high | unsigned char | - | - | - | - | - | Schlüsseldaten 7 |
| STAT_ACON1_WERT | HEX | high | unsigned char | - | - | - | - | - | Schlüsseldaten 8 |
| STAT_ACON0_WERT | HEX | high | unsigned char | - | - | - | - | - | Schlüsseldaten 9 |
| STAT_FCON_WERT | HEX | high | unsigned char | - | - | - | - | - | Schlüsseldaten 10 |
| STAT_FCA_WERT | HEX | high | unsigned char | - | - | - | - | - | Schlüsseldaten 11 |
| STAT_FC4L_WERT | HEX | high | unsigned char | - | - | - | - | - | Schlüsseldaten 12 |
| STAT_FC4H_WERT | HEX | high | unsigned char | - | - | - | - | - | Schlüsseldaten 13 |
| STAT_FC3L_WERT | HEX | high | unsigned char | - | - | - | - | - | Schlüsseldaten 14 |
| STAT_FC3H_WERT | HEX | high | unsigned char | - | - | - | - | - | Schlüsseldaten 15 |
| STAT_TEST2_WERT | HEX | high | unsigned char | - | - | - | - | - | Schlüsseldaten 16 |
| STAT_TEST1_WERT | HEX | high | unsigned char | - | - | - | - | - | Schlüsseldaten 17 |
| STAT_ATUNE_WERT | HEX | high | unsigned char | - | - | - | - | - | Schlüsseldaten 18 |
| STAT_SCSEL_WERT | HEX | high | unsigned char | - | - | - | - | - | Schlüsseldaten 19 |
| STAT_BDSEL_WERT | HEX | high | unsigned char | - | - | - | - | - | Schlüsseldaten 20 |
| STAT_TXCON_WERT | HEX | high | unsigned char | - | - | - | - | - | Schlüsseldaten 21 |
| STAT_MRCON_WERT | HEX | high | unsigned char | - | - | - | - | - | Schlüsseldaten 22 |
| STAT_ACON2_WERT | HEX | high | unsigned char | - | - | - | - | - | Schlüsseldaten 23 |
| STAT_SW_VERS_PRE_WERT | HEX | high | unsigned char | - | - | - | - | - | Schlüsseldaten 24 |
| STAT_SW_VERS_SUF_WERT | HEX | high | unsigned char | - | - | - | - | - | Schlüsseldaten 25 |
| STAT_SW_VAR1_WERT | HEX | high | unsigned char | - | - | - | - | - | Schlüsseldaten 26 |
| STAT_SW_VAR2_WERT | HEX | high | unsigned char | - | - | - | - | - | Schlüsseldaten 27 |
| STAT_SW_TAG_WERT | HEX | high | unsigned char | - | - | - | - | - | Schlüsseldaten 28 |
| STAT_SW_MONAT_WERT | HEX | high | unsigned char | - | - | - | - | - | Schlüsseldaten 29 |
| STAT_SW_JAHR_1_WERT | HEX | high | unsigned char | - | - | - | - | - | Schlüsseldaten 30 |
| STAT_SW_JAHR_2_WERT | HEX | high | unsigned char | - | - | - | - | - | Schlüsseldaten 31 |
| STAT_FREQ1_WERT | HEX | high | unsigned char | - | - | - | - | - | Schlüsseldaten 32 |
| STAT_FREQ2_WERT | HEX | high | unsigned char | - | - | - | - | - | Schlüsseldaten 33 |
| STAT_HUF_RESERVIERT_1_WERT | HEX | high | unsigned char | - | - | - | - | - | Schlüsseldaten 34 |
| STAT_HUF_RESERVIERT_2_WERT | HEX | high | unsigned char | - | - | - | - | - | Schlüsseldaten 35 |
| STAT_HUF_RESERVIERT_3_WERT | HEX | high | unsigned char | - | - | - | - | - | Schlüsseldaten 36 |
| STAT_KEY_DATA_CONSISTENT | 0/1 | high | unsigned char | - | - | - | - | - | 0 = Schlüsseldaten nicht gültig, 1 = Schlüsseldaten gültig |

<a id="table-res-0xb007-r"></a>
### RES_0XB007_R
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_NOTENTRIEGELUNG | - | - | + | 0/1 | high | unsigned char | - | - | - | - | - | 0 = Notentriegelung nicht aktiv, 1 = Notentriegelung aktiv |
...
| RESULTNAME | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_SCHALTER_SCHLIESSER | 0/1 | high | unsigned char | - | - | - | - | - | Zustand Schalter Schliesser: 0 = offen, 1 = geschlossen |
| STAT_STAT_WL_DIG | 0/1 | high | unsigned char | - | - | - | - | - | Zustand Weckleitung: 0 = aus, 1 = ein |

<a id="table-res-0xe185-d"></a>
### RES_0XE185_D
...
| RESULTNAME | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_RKE_TASTE_1 | 0/1 | high | unsigned char | - | - | - | - | - | 0 = Taste nicht betätigt, 1 = Taste betätigt |
| STAT_RKE_TASTE_2 | 0/1 | high | unsigned char | - | - | - | - | - | 0 = Taste nicht betätigt, 1 = Taste betätigt |
| STAT_FB_BATTERIE | 0-n | high | unsigned char | - | TAB_MR_SLZ_FB_BATT | - | - | - | Status FB Batterie |

<a id="table-res-0xe186-d"></a>
### RES_0XE186_D
...
| RESULTNAME | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_TD_TREIBER | 0/1 | high | unsigned char | - | - | - | - | - | Zustand Treiber: 0 = aus, 1 = ein |
| STAT_TD_TREIBER_I_WERT | mA | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Strom durch den Tankdeckeltreiber |
| STAT_TD_SENSE | 0-n | high | unsigned char | - | TAB_MR_SLZ_MESSLEITUNG | - | - | - | Zustand Messleitung |

<a id="table-res-0xe187-d"></a>
### RES_0XE187_D
...
| RESULTNAME | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_KL15_TREIBER | 0/1 | high | unsigned char | - | - | - | - | - | Zustand Treiber: 0 = aus, 1 = ein |
| STAT_KL15_TREIBER_I_WERT | mA | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Strom durch den Treiber |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| SLZ_NOTENTRIEGELN_MR | 0xB007 | - | Job zur Freigabe der Entriegelung unabhängig von den internen Schalterstati zur Bolzenpositionserkennung | - | - | - | - | - | - | - | - | - | 31 | - | RES_0xB007_R |
...
| EWS_KL15_MR | 0xE00E | - | Ansteuerung KL15 EWS | - | - | - | - | - | - | - | - | - | 22;2F | ARG_0xE00E_D | RES_0xE00E_D |
| SLZ_ANALOG_IN_MR | 0xE183 | - | Analoge Eingänge am SLZ | - | - | - | - | - | - | - | - | - | 22 | - | RES_0xE183_D |
| SLZ_DIGITAL_IN_MR | 0xE184 | - | Analoge Eingänge am SLZ | - | - | - | - | - | - | - | - | - | 22 | - | RES_0xE184_D |
| SLZ_FERNBEDIENUNG_MR | 0xE185 | - | Job zum Auswerten, ob eine Taste der Fernbedienung (FB) gedrückt ist | - | - | - | - | - | - | - | - | - | 22 | - | RES_0xE185_D |
| SLZ_TANKDECKEL_MR | 0xE186 | - | Job zum Auswerten des Zustandes Tankdeckeltreiber und Tankdeckelhebel | - | - | - | - | - | - | - | - | - | 22 | - | RES_0xE186_D |
| SLZ_KL15_TREIBER | 0xE187 | - | Job zum Auswerten des Zustandes des Klemme 15 Treibers | - | - | - | - | - | - | - | - | - | 22 | - | RES_0xE187_D |
| _HUF_PWM_DC | 0x4000 | - | PWM-DC-Tabelle für ELV-Motor | - | - | - | - | - | - | - | - | - | 2E;22 | ARG_0x4000_D | RES_0x4000_D |
| _HUF_SGBMID | 0x4001 | - | SGBM-ID und HWEL schreiben | - | - | - | - | - | - | - | - | - | 2E | ARG_0x4001_D | - |
| _HUF_HERSTELLDATUM | 0x4002 | - | Herstelldatum schreiben | - | - | - | - | - | - | - | - | - | 2E | ARG_0x4002_D | - |
| _HUF_DATA_LOCK | 0x4003 | - | Überschreibschutz Huf-Data setzen | - | - | - | - | - | - | - | - | - | 2E | ARG_0x4003_D | - |
| _HUF_ICT | 0x4005 | - | ICT-Prüfbyte lesen und schreiben | - | - | - | - | - | - | - | - | - | 22;2E | ARG_0x4005_D | RES_0x4005_D |
| _HUF_ZSB | 0x4006 | - | ZSB Prüfbyte lesen und schreiben | - | - | - | - | - | - | - | - | - | 22;2E | ARG_0x4006_D | RES_0x4006_D |
| _HUF_RESET_COUNTER | 0x4007 | STAT_RESET_COUNTER_WERT | Wert Reset counter | HEX | - | high | unsigned char | - | - | - | - | - | 22 | - | - |
| _SLZ_BOLZEN_POSITION | 0x4008 | STAT_POSITION | Zustand Bolzen Position | 0-n | - | high | unsigned char | TAB_MR_SLZ_BOLZEN_POSITION | - | - | - | - | 22 | - | - |
| _SLZ_BOLZEN_TREIBER | 0x4009 | - | Job zum Auswerten des Zustandes des Motortreibers | - | - | - | - | - | - | - | - | - | 22 | - | RES_0x4009_D |
| _SLZ_WL_TREIBER | 0x400A | STAT_WL_TREIBER | Zustand Treiber 0 = aus, 1 = ein | 0/1 | - | high | unsigned char | - | - | - | - | - | 22 | - | - |
| _SLZ_ANZ_AUTH_VERSUCHE | 0x400B | STAT_ANZ_AUTH_VERSUCHE_WERT | Anzahl Versuche | - | - | high | unsigned char | - | 1.0 | 1.0 | 0.0 | - | 22 | - | - |
| SCHLUESSEL_TRSP_EXTENDED | 0x400C | - | Erweiterte Schlüsseldaten | - | - | - | - | - | - | - | - | - | 22 | - | RES_0x400C_D |
...
<a id="table-tab-cas-rssi-commands"></a>
### TAB_CAS_RSSI_COMMANDS
...
| 0 | Stop RSSI Check |
| 1 | Start RSSI Check |
| 2 | RSSI Daten abfragen |

<a id="table-tab-mr-bolzen-treiber"></a>
### TAB_MR_BOLZEN_TREIBER
...
<a id="table-tab-mr-res-routinestatus-slz"></a>
### TAB_MR_RES_ROUTINESTATUS_SLZ
...
| 0x01 | Routine läuft |
| 0x02 | Schlüssel nicht gefunden |
| 0x03 | Schlüssel mit Fehlern ausgelesen |
| 0x04 | Schlüssel fehlerfrei ausgelesen |
| 0xFF | Routine Status nicht definiert |

<a id="table-tab-mr-slz-bolzen-position"></a>
### TAB_MR_SLZ_BOLZEN_POSITION
...
| 0x03 | Pre-Unlock |
| 0x04 | Entriegelt |
| 0x05 | Schalterzustand ungültig |
| 0xFF | Nicht definiert |

<a id="table-tab-mr-slz-fb-batt"></a>
### TAB_MR_SLZ_FB_BATT
...
<a id="table-tab-mr-slz-messleitung"></a>
### TAB_MR_SLZ_MESSLEITUNG

Dimensions: 4 rows × 2 columns

| WERT | TEXT |
| --- | --- |
| 0x00 | Hebel unbetätigt |
| 0x01 | Hebel betätigt |
| 0x02 | Zustand unbekannt |
| 0xFF | Zustand ungültig |
