...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| MAX_REPROG | unsigned int | maximale Anzahl Programmierungen Es werden die Werte für den Block ausgegeben der noch die geringste Zahl an Reprogrammierungen aufweist |
| NUM_REPROG | unsigned int | Anzahl der erfolgten Programmiervorgaenge |
| _REQUEST | binary | Hex-Auftrag an SG |
| _RESPONSE | binary | Hex-Antwort von SG |
