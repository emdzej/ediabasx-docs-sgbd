...
| Field | Value |
| --- | --- |
| ECU | Regenlichtsensor PL2 LIN |
| ORIGIN | BMW EE51 Eike Recker |
| REVISION | 1.00 |
| AUTHOR | Kostal AEK7 Jäger, Kostal AEK7 Hügle |
...
- [SG_INIT](#job-sg-init) - Startet Neuadaption des RLS an eine Windschutzscheibe (z. B. bei Austausch der Scheibe)  Benötigt nach Jobausführung einen KL.R-Wechsel (Abschalten der Versorgungsspannung), um sich neu einzumessen
- [STATUS_LESEN](#job-status-lesen) - Auslesen der Stati von Strömen, Verstärkungsfaktor, Frontlicht, Umgebungslicht, Heizungstemperatur
- [Status_lesen_Wischertaster](#job-status-lesen-wischertaster) - Auslesen des Steuergeraete-Speichers KWP 2000: $23 ReadMemoryByAddress Modus   : Default
...
Startet Neuadaption des RLS an eine Windschutzscheibe (z. B. bei Austausch der Scheibe)  Benötigt nach Jobausführung einen KL.R-Wechsel (Abschalten der Versorgungsspannung), um sich neu einzumessen
...
Auslesen der Stati von Strömen, Verstärkungsfaktor, Frontlicht, Umgebungslicht, Heizungstemperatur
