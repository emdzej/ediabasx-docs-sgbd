...
| REVISION | 3.001 |
| AUTHOR | BERTRANDT-INGENIEURBUERO-GMBH EE-72 Diek |
| COMMENT | - |
| PACKAGE | 1.72 |
| SPRACHE | deutsch |
...
- [CBSKENNUNG](#table-cbskennung) (25 × 3)
...
- [ARG_0XD11C_D](#table-arg-0xd11c-d) (1 × 12)
...
- [FORTTEXTE](#table-forttexte) (266 × 3)
...
- [RES_0X4001_D](#table-res-0x4001-d) (2 × 10)
...
- [RES_0X4803_D](#table-res-0x4803-d) (1 × 10)
...
- [RES_0XD10B_D](#table-res-0xd10b-d) (2 × 10)
...
- [RES_0XD11C_D](#table-res-0xd11c-d) (1 × 10)
...
- [RES_0XD1D5_D](#table-res-0xd1d5-d) (66 × 10)
- [RES_0XD1D6_D](#table-res-0xd1d6-d) (66 × 10)
- [RES_0XD1D7_D](#table-res-0xd1d7-d) (66 × 10)
- [RES_0XD1D8_D](#table-res-0xd1d8-d) (66 × 10)
- [RES_0XD1D9_D](#table-res-0xd1d9-d) (2 × 10)
- [RES_0XD1DA_D](#table-res-0xd1da-d) (5 × 10)
- [RES_0XDA0C_D](#table-res-0xda0c-d) (1 × 10)
- [RES_0XDA0E_D](#table-res-0xda0e-d) (37 × 10)
...
- [SG_FUNKTIONEN](#table-sg-funktionen) (97 × 16)
...
| ARG | STR | STPR | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | MIN | MAX | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| WARPLISTE | + | - | 0-n | - | unsigned char | - | TAB_WARPLISTE | 1.0 | 1.0 | 0.0 | - | - | Es sind drei Kennlinien möglich: 1. CAF - Codierdaten 2. Werksmesstechnik - Mit einer Kamera vermessene Kennlinie 3. Service - im Service nachjustierte Kennlinie |
...
| ARG | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | MIN | MAX | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| VERBRAUCH | l/100km | high | unsigned int | - | - | 100.0 | 1.0 | 0.0 | 0.0 | 20.0 | Vorgabe von Momentanverbrauch in L/100km. |
...
| 0xB7F71C | Kombi: EEPROM-Lesefehler (Datenintegrität verletzt) | 1 |
| 0xB7F71D | Kombi: EEPROM-Fehler (Auftrag wurde abgewiesen) | 1 |
...
| 0xB7F761 | Kombi: EEPROM-Fehler (Inkonsistenz bei redundantem Datenblock) | 0 |
| 0xB7F762 | Kombi: EEPROM-Fehler (Überlauf der internen Job-Queue) | 0 |
| 0xB7F764 | Kombi: EEPROM-Fehler (Verifikation der geschriebenen Daten fehlgeschlagen) | 0 |
| 0xB7F765 | Kombi: EEPROM-Fehler (Schreibversuch auf schreibgeschützten Datenblock) | 0 |
| 0xB7F766 | Kombi: EEPROM-Lesefehler (Statische Block-ID ungültig) | 0 |
...
| 0xB7F7AF | Kombi: Watchdog-Konfiguration fehlerhaft | 1 |
| 0xB7F7B0 | Kombi: Watchdogabschaltung zurückgewiesen | 1 |
| 0xB7F7B1 | Kombi: Watchdogaufruf unzulässig in aktuellem Kontext | 1 |
| 0xB7F7B2 | Kombi: Watchdogaufruf bei gesperrter Konfiguration | 1 |
| 0xB7F7B3 | Kombi: Watchdogaufruf mit ungültigem Parameter | 1 |
| 0xB7F7B4 | Kombi: Watchdog-Modusumschaltung im Treiber fehlgeschlagen | 1 |
| 0xB7F7B5 | Kombi: Safetycheck bei ungespertem Watchdog | 1 |
| 0xB7F7B6 | Kombi: Watchdog-Modusumschaltung nicht autorisiert | 1 |
| 0xB7F7B7 | Kombi: Watchdog ausgelöst (Überwachungsbedingung erfüllt) | 1 |
| 0xB7F7B8 | Kombi: Watchdog-Modusumschaltung fehlgeschlagen | 1 |
| 0xB7F7D2 | Kombi: Safety Flex-ECC Parity Error | 1 |
...
| 0x1750 | F_UW_BN | - | High | unsigned char | - | 1.0 | 1.0 | 0.0 |
| 0x1751 | F_UW_TN | TEXT | High | 3 | - | 1.0 | 1.0 | 0.0 |
| 0x5615 | STACK_OVERFLOW | TEXT | High | 5 | - | 1.0 | 1.0 | 0.0 |
| 0xXYXY | unbekannte Umweltbedingung | - | - | - | - | - | - | - |
...
| SB | STATUS_TEXT |
| --- | --- |
| 0x00 | ERROR_ANZAHL_ARGUMENTE |
| 0x01 | ERROR_CCM_SYSZEIT_ZU_GROSS |
| 0x02 | ERROR_CCM_GWSZ_ZU_GROSS |
| 0xXY | ERROR_UNKNOWN |
...
| RESULTNAME | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_OFFSET_X_WERT | - | high | signed char | - | - | 1.0 | 1.0 | 0.0 | Verschiebung X-Achse |
| STAT_OFFSET_Y_WERT | - | high | signed char | - | - | 1.0 | 1.0 | 0.0 | Verschiebung Y-Achse |
...
| RESULTNAME | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_DUMMY_WERT | - | high | unsigned char | - | - | 1.0 | 1.0 | 0.0 | Job triggert die Anzeige des No-Signal Bildes im HUD |
...
| RESULTNAME | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_CC_ID_WERT | - | - | unsigned int | - | - | 1.0 | 1.0 | 0.0 | ID der CC-Meldung. |
| STAT_GWSZ_STAND_WERT | km | - | unsigned int | - | - | 8.0 | 1.0 | 0.0 | Kilometerstand beim Auftreten der CC-Meldung Aufloesung: 8km HINWEIS: als Wert wird maximal 524280 ausgegeben. |
...
| RESULTNAME | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_VERBRAUCH_WERT | l/100km | high | unsigned int | - | - | 1.0 | 100.0 | 0.0 | gesetzter Momentanverbrauch in L/100km |
...
| RESULTNAME | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_DURCHSCHNITTSVERBR_KOMFORTMODUS_WERT | l/100km | high | unsigned int | - | - | 1.0 | 10.0 | 0.0 | Durchschnittsverbrauch im Komfortmodus U Komfor in 0,1 l/100km |
| STAT_DURCHSCHNITTSVERBR_ECOPROMODUS_WERT | l/100km | high | unsigned int | - | - | 1.0 | 10.0 | 0.0 | Durchschnittsverbrauch im ECO-Pro Modus U ECO in 0,1 l/100km |
| STAT_DURCHSCHNITTSVERBR_ECOPROMODUS_AKT_SEGELN_WERT | l/100km | high | unsigned int | - | - | 1.0 | 10.0 | 0.0 | Durchschnittsverbrauch im ECO-Pro Modus mit aktiver Segelfunktion U ECO_Segel in 0,1 l/100km |
| STAT_WEGSTRECKE_AKT_SEGELN_WERT | km | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Wegstrecke mit aktivierterSegelfunktion s ECO_Segel |
| STAT_WEGSTRECKE_DEAKT_SEGELN_WERT | km | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Wegstrecke mit deaktivierter Segelfunktion s ECO |
...
| _DISPLAY_POSITIONIERUNG | 0x4000 | - | Display Positionierung | - | - | - | - | - | - | - | - | - | 22 | - | RES_0x4000_D |
| _DISPLAY_POSITIONIERUNG_DZM_TUBE | 0x4001 | - | Display Positionierung der DZM Tube | - | - | - | - | - | - | - | - | - | 22 | - | RES_0x4001_D |
...
| HUD_NO_SIGNAL_SCREEN | 0x4803 | - | HUD_NO_SIGNAL_SCREEN | - | - | - | - | - | - | - | - | - | 2F | - | RES_0x4803_D |
...
| CHECK_CONTROL_MELDUNG_WERT | 0xD10B | - | Auslesen des Check Control-Meldungsspeicher. | - | - | - | - | - | - | - | - | - | 22 | - | RES_0xD10B_D |
...
| KOMBI_KVA | 0xD11C | - | Vorgabe von Momentanverbrauch in L/100km | - | - | - | - | - | - | - | - | - | 2F | ARG_0xD11C_D | RES_0xD11C_D |
...
| VERBRAEUCHE_SKALIERUNG_X | 0xD1D5 | - | Verbräuche Skalierung x | - | - | - | - | - | - | - | - | - | 22 | - | RES_0xD1D5_D |
| VERBRAEUCHE_SKALIERUNG_Y | 0xD1D6 | - | Verbräuche Skalierung y | - | - | - | - | - | - | - | - | - | 22 | - | RES_0xD1D6_D |
| VERBRAEUCHE_SKALIERUNG_Z | 0xD1D7 | - | Verbräuche Skalierung z | - | - | - | - | - | - | - | - | - | 22 | - | RES_0xD1D7_D |
| VERBRAEUCHE_SKALIERUNG_A | 0xD1D8 | - | Verbräuche Skalierung a | - | - | - | - | - | - | - | - | - | 22 | - | RES_0xD1D8_D |
| VERBRAUCHSVORTEIL_HYBRID_AKT_SEGMENT | 0xD1D9 | - | Verbrauch / Verbrauchsvorteil Hybrid aktuelles Segment | - | - | - | - | - | - | - | - | - | 22 | - | RES_0xD1D9_D |
| STATISTIK_SEGELN | 0xD1DA | - | Statistik für Funktion Segeln | - | - | - | - | - | - | - | - | - | 22 | - | RES_0xD1DA_D |
...
| STATUS_HUD_LOGBUCH | 0xDA0E | - | Job liest das Logbuch des HUD aus | - | - | - | - | - | - | - | - | - | 22 | - | RES_0xDA0E_D |
