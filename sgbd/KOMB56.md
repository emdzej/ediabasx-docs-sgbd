...
| REVISION | 3.001 |
| AUTHOR | NSEU System-Engineering Tenev, BMW EI-42 Kuppe |
| COMMENT | SGBD für Kombi PL3 |
| PACKAGE | 1.29 |
| SPRACHE | deutsch |
...
- [STEUERN_TACHO](#job-steuern-tacho) - Tacho auf beliebige Geschwindigkeit (0..300) setzen Aufgrund nicht linearer Tachokennlinie kann es zu Abweichungen zwischen uebergebenem und angezeigtem Wert kommen. KWP2000: $30 InputOutputControlByLocalIdentifier
...
- [IDENT_CIP](#job-ident-cip) - Identdaten CIP lesen KWP2000: $1A ReadECUIdentification .        $8B Ident CIP
- [SERIAL_NUMBER_CIP](#job-serial-number-cip) - Identdaten CIP lesen KWP2000: $1A ReadECUIdentification .        $8C SystemSupplierECUNumber CIP
- [PART_NUMBER_CIP](#job-part-number-cip) - Identdaten CIP lesen KWP2000: $1A ReadECUIdentification .        $8D PartNumber ProdDate CIP
...
| Name | Type | Comment |
| --- | --- | --- |
| BYTE1 | int | Beinhaltet die Angaben bzgl. gewuenschtem Datum-/Zeitformat 0x00 = dd.mm.yy + 24h 0x01 = dd.mm.yy + 12h 0x10 = mm/dd/yy + 24h 0x11 = mm/dd/yy + 12h Kein Parameter = aktuelles Uhrzeit/Datumsformat beibehalten |
...
<a id="job-steuern-leuchten-aus"></a>
### STEUERN_LEUCHTEN_AUS
...
Tacho auf beliebige Geschwindigkeit (0..300) setzen Aufgrund nicht linearer Tachokennlinie kann es zu Abweichungen zwischen uebergebenem und angezeigtem Wert kommen. KWP2000: $30 InputOutputControlByLocalIdentifier
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| TACHOGRENZE | unsigned int | aus Kombi ermittelte letzte Stuetzstelle in km/h Aufgrund der Minispez. Stuetzstellen gibt dieser Wert nicht unbedingt den max. Tachowert wieder. |
| _TEL_ANTWORT | binary | Antwort von SG |
...
| STAT_AKT_KM_STAND_EINH | string | Einheit |
...
| STAT_TAGESZAEHLER_EINH | string | Einheit |
...
| STAT_AKTUELLES_DATUM_EINH | string | Einheit |
| STAT_MODE_WERT | int | CBS-Mode |
| STAT_MODE_TEXT | string | CBS-Mode Text |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| Name | Type | Comment |
| --- | --- | --- |
| STAT_NTC1_WERT | string | Der ADC-Wert des NTC1-Kanals. |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| _TEL_ANTWORT | binary | Antwort von SG |
...
<a id="job-ident-cip"></a>
### IDENT_CIP

Identdaten CIP lesen KWP2000: $1A ReadECUIdentification .        $8B Ident CIP
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| CIP_HW_INDEX | binary | HW-Index des CIP (3 Byte) |
| CIP_SW_NUMBER | binary | HW-Index des CIP (3 Byte) |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |

<a id="job-serial-number-cip"></a>
### SERIAL_NUMBER_CIP

Identdaten CIP lesen KWP2000: $1A ReadECUIdentification .        $8C SystemSupplierECUNumber CIP
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| CIP_SERIAL_NUMBER | binary | Seriennummer des CIP (9 Byte) |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |

<a id="job-part-number-cip"></a>
### PART_NUMBER_CIP

Identdaten CIP lesen KWP2000: $1A ReadECUIdentification .        $8D PartNumber ProdDate CIP
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| CIP_PART_NUMBER | string | Teilenummer des CIP (6 Byte) |
| CIP_PROD_DATE | string | Produktionsdatum des CIP (4 Byte) |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
- [FORTTEXTE](#table-forttexte) (55 × 2)
...
| 0xA3BB | CAN_ID_2FC_ERROR_Ausfall_Botschaft_ZV_Klemmenstatus |
...
| 0xA54C | Rohdaten Fuellstand Tank |
