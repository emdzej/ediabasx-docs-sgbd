...
| Field | Value |
| --- | --- |
| ECU | BM_WIDE Widescreen Bordmonitor |
| ORIGIN | BMW TI-430 Buboltz |
| REVISION | 1.2 |
| AUTHOR | BMW TI-431 Helmich, BMW TI-431 Krueger, BMW TI-431 Holdsclaw |
| COMMENT | BM_WIDE |
| PACKAGE | 0.06 |
| SPRACHE | deutsch |
...
| 0x04 | Kurzschluss NF Leitung 1 (MD L-) |
| 0x05 | Kurzschluss NF Leitung 2 (MD L+) |
| 0x06 | Kurzschluss NF Leitung 3 (MD R-) |
| 0x07 | Kurzschluss NF Leitung 4 (MD R+) |
| 0x08 | K-Bus Fehler beim Senden |
| 0x09 | K-Bus Fehler beim Empfangen |
| 0x16 | Checksummenfehler wegen ploetzlichem Spannungsverlust |
