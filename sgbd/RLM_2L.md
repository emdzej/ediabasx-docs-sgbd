...
| Field | Value |
| --- | --- |
| ECU | Rücklichtmodul Heckklappe 2 Links |
...
- [IORTTEXTE](#table-iorttexte) (69 × 4)
...
| 0x021C08 | Codierung: Steuergerät ist nicht codiert | 0 | - |
| 0x021C09 | Codierung: Fehler bei Codierdatentransaktion aufgetreten | 0 | - |
| 0x021C0A | Codierung: Signatur der Codierdaten ungültig | 0 | - |
| 0x021C0B | Codierung: Codierdaten passen nicht zum Fahrzeug | 0 | - |
| 0x021C0C | Codierung: Unplausible Daten während Codierdatentransaktion | 0 | - |
| 0x021C0D | Codierung: unqualifizierte Daten | 0 | - |
| 0x021C24 | NVM_E_HARDWARE | 0 | - |
| 0x02FF1C | Dummy-Fehlerspeichereintrag im Komponentenfehlerbereich nur für Testzwecke | 1 | - |
| 0x808300 | Unterspannung erkannt | 1 | - |
| 0x808301 | Überspannung erkannt | 1 | - |
| 0x808302 | Überfallalarm: defekt | 0 | - |
| 0x808303 | Fernlichtblinken: defekt | 0 | - |
| 0x808304 | Panik Blinken: defekt | 0 | - |
| 0x808305 | DWA Blinken: defekt | 0 | - |
| 0x808306 | ESS Blinken: defekt | 0 | - |
| 0x808307 | Standlicht: defekt | 0 | - |
| 0x808308 | Follow Me Home: defekt | 0 | - |
| 0x808309 | Welcome Light: defekt | 0 | - |
| 0x80830A | Remote Light: defekt | 0 | - |
| 0x80830B | Goodbye Bremslicht: defekt | 0 | - |
| 0x80830C | Ausgelagerte Leuchte: defekt | 0 | - |
| 0x80830D | Fahrtrichtungsanzeiger: defekt | 0 | - |
| 0x80830E | Tagfahrlicht: defekt | 0 | - |
| 0x80830F | Seitenmarkierungsleuchte: defekt | 0 | - |
| 0x808310 | Parklicht: defekt | 0 | - |
| 0x808311 | Bremslicht: defekt | 0 | - |
| 0x808312 | Nebelschlusslicht: defekt | 0 | - |
| 0x808313 | Rueckfahrlicht: defekt | 0 | - |
| 0x808314 | Bremslicht - Notlaufaktivierung wegen unplausibler Eingangssignale | 1 | - |
| 0x80831E | CAN_TIMEOUT_ERROR | 0 | - |
| 0x80831F | MCAL_PORT_TIMEOUT_ERROR | 0 | - |
| 0x808320 | FLS_Error | 0 | - |
| 0x808328 | GPT_ERROR | 0 | - |
| 0x808329 | MCU_ERROR | 0 | - |
| 0x80832A | WDG_ERROR | 0 | - |
| 0x80832B | WDGM_ERROR | 0 | - |
| 0x808343 | Variant not configured | 0 | - |
| 0x808344 | configuration data invalid combined event | 0 | - |
| 0x808360 | NTC1: Temperatursensor  on board | 0 | - |
| 0x808361 | NTC2: Temperatursensor  combinded event | 0 | - |
| 0x808362 | NTC3: Temperatursensor  combinded event | 0 | - |
| 0x808363 | NTC4: Temperatursensor  combinded event | 0 | - |
| 0xD0050B | B2-CAN Physikalischer Busfehler | 0 | - |
| 0xD00514 | B2-CAN Control Module Bus OFF | 0 | - |
| 0xD00B00 | Botschaft 0x2EB (CTR_LP_EX) - Timeout combined event | 1 | - |
| 0xD00B01 | Botschaft 0x2EB (CTR_LP_EX) - Alive/CRC | 1 | - |
| 0xD00B03 | Botschaft 0x1E4 (CTR_LP_EX_2) - Timeout combined event | 1 | - |
| 0xD00B09 | Botschaft 0x2CA (A_Temp)- Timeout combined event | 1 | - |
| 0xD00B0F | Botschaft 0xCA (CTR_FN_IDC) - Timeout combined event | 1 | - |
| 0xD00B10 | Botschaft 0xCA (CTR_FN_IDC) - Alive/CRC | 1 | - |
| 0xD00B12 | Botschaft 0x328 (Relativzeit) - Timeout combined event | 1 | - |
| 0xD00B15 | Botschaft 0x32 (ST_CENG) - Timeout combined event | 1 | - |
| 0xD00B18 | Botschaft 0x1A1 (V_VEH) - Timeout combined event | 1 | - |
| 0xD00B19 | Botschaft 0x1A1 (V_VEH) - Alive/CRC | 1 | - |
| 0xD00B1B | Botschaft 0x21x (ST_LP_EX_REAR_SAME_SIDE) - Timeout combined event | 1 | - |
| 0xD00B1C | Botschaft 0x21x (ST_LP_EX_REAR_SAME_SIDE) - Alive/CRC combined event | 1 | - |
| 0xD00B25 | Botschaft 0x21x (ST_LP_EX_REAR_OTHER_SIDE_MASTER_1) - Timeout combined event | 1 | - |
| 0xD00B26 | Botschaft 0x21x (ST_LP_EX_REAR_OTHER_SIDE_MASTER_1) - Alive/CRC | 1 | - |
| 0xD00B28 | Botschaft 0x21x (ST_LP_EX_REAR_OTHER_SIDE_SLAVE_2) - Timeout combined event | 1 | - |
| 0xD00B29 | Botschaft 0x21x (ST_LP_EX_REAR_OTHER_SIDE_SLAVE_2) - Alive/CRC | 1 | - |
| 0xD00B2B | Botschaft 0x3C (Con_VEH) - Timeout combined event | 1 | - |
| 0xD00B2C | Botschaft 0x3C (Con_VEH) - Alive/CRC | 1 | - |
| 0xD00B2E | Botschaft 0x2FC (STAT_ZV_KLAPPEN) - Timeout combined event | 1 | - |
| 0xD00BFF | Dummy-Fehlerspeichereintrag im Netzwerkfehlerbereich nur für Testzwecke | 1 | - |
...
| 0x4018 | UWB ALIVE_CRC_ERROR_CTR_LP_EX_2 | 0-n | High | 0xFF | UWB_TAB_ALIVE_CRC_0X1E4_CTR_LP_EX_2 | - | - | - |
...
| 0x4051 | UWB_DEFEKT_ART_STRANGLED4 | 0-n | High | 0xFF | UWB_TAB_DEFEKT_ART_STRANG | - | - | - |
...
Dimensions: 69 rows × 4 columns

| ORT | ORTTEXT | EREIGNIS_DTC | FEHLERKLASSE |
| --- | --- | --- | --- |
| 0x808321 | LED Ausgang 1: Strang | 0 | - |
| 0x808322 | LED Ausgang 2: Strang | 0 | - |
| 0x808323 | LED Ausgang 3: Strang | 0 | - |
| 0x808324 | LED Ausgang 4: Strang | 0 | - |
| 0x808325 | LED Ausgang 5: Strang | 0 | - |
| 0x808326 | LED Ausgang 6: Strang | 0 | - |
| 0x808327 | LED Ausgang 7: Strang | 0 | - |
| 0x80832C | Overvoltage_Segment_Strang_1: Strang  combined event | 0 | - |
| 0x80832D | Overvoltage_Segment_Strang_2: Strang  combined event | 0 | - |
| 0x80832E | Overvoltage_Segment_Strang_3: Strang  combined event | 0 | - |
| 0x80832F | Overvoltage_Segment_Strang_4: Strang  combined event | 0 | - |
| 0x808330 | Overvoltage_Segment_Strang_5: Strang  combined event | 0 | - |
| 0x808331 | Overvoltage_Segment_Strang_6: Strang  combined event | 0 | - |
| 0x808332 | Undervoltage_Segment_Strang_1: Strang  combined event | 0 | - |
| 0x808333 | Undervoltage_Segment_Strang_2: Strang  combined event | 0 | - |
| 0x808334 | Undervoltage_Segment_Strang_3: Strang  combined event | 0 | - |
| 0x808335 | Undervoltage_Segment_Strang_4: Strang  combined event | 0 | - |
| 0x808336 | Undervoltage_Segment_Strang_5: Strang  combined event | 0 | - |
| 0x808337 | Undervoltage_Segment_Strang_6: Strang  combined event | 0 | - |
| 0x808338 | Overvoltage_Segment_Strang_7 | 0 | - |
| 0x808339 | Undervoltage_Segment_Strang_7 | 0 | - |
| 0x80833A | CRC-Checksum Fehler | 0 | - |
| 0x80833B | Booster defekt | 0 | - |
| 0x80833C | ChargePump nicht abschaltbar | 0 | - |
| 0x80833D | Überlauf SPI-Empfangspuffer | 0 | - |
| 0x80833E | Controller nicht abschaltbar | 0 | - |
| 0x80833F | Reset | 0 | - |
| 0x808340 | Watchdog hat Reset ausgelöst | 0 | - |
| 0x808341 | Fehlerhafter Quarz-Betrieb des Controllers | 0 | - |
| 0x808342 | LED Ausgang 8: HSS combined event | 0 | - |
| 0x808345 | FLS_E_COMPARE_FAILED | 0 | - |
| 0x808346 | FLS_E_ERASE_FAILED | 0 | - |
| 0x808347 | FLS_E_READ_FAILED | 0 | - |
| 0x808348 | FLS_E_UNEXPECTED_FLASH_ID | 0 | - |
| 0x808349 | FLS_E_WRITE_FAILED | 0 | - |
| 0x80834A | FLS_E_READ_FAILED_DED | 0 | - |
| 0x80834B | MCU_E_WRITE_TIMOUT_FAILURE | 0 | - |
| 0x80834C | MCU_E_LVI_FAILURE | 0 | - |
| 0x80834D | NVM_E_INTEGRITY_FAILED | 0 | - |
| 0x80834E | NVM_E_LOSS_OF_REDUNDANCY | 0 | - |
| 0x80834F | NVM_E_QUEUE_OVERFLOW | 0 | - |
| 0x808350 | NVM_E_REQ_FAILED | 0 | - |
| 0x808351 | NVM_E_VERIFY_FAILED | 0 | - |
| 0x808352 | NVM_E_WRITE_PROTECTED | 0 | - |
| 0x808353 | NVM_E_WRONG_BLOCK_ID | 0 | - |
| 0x808354 | WDG_E_DISABLE_REJECTED | 0 | - |
| 0x808355 | WDG_E_MODE_FAILED | 0 | - |
| 0x808356 | WDG_E_TRIGGER_TIMEOUT | 0 | - |
| 0x808357 | WDG_E_READBACK_FAILURE | 0 | - |
| 0x808358 | WDGM_E_IMPROPER_CALLER | 0 | - |
| 0x808359 | WDGM_E_MONITORING | 0 | - |
| 0x80835A | WDGM_E_SET_MODE | 0 | - |
| 0xD00B02 | Botschaft 0x2EB (CTR_LP_EX) - Signal combined event | 1 | - |
| 0xD00B05 | Botschaft 0x1E4  (CTR_LP_EX_2) - Signal combined event | 1 | - |
| 0xD00B08 | Botschaft 0x330  Kilometerstand- Signal combined event | 1 | - |
| 0xD00B0B | Botschaft 0x2CA (A_Temp) - Signal combined event | 1 | - |
| 0xD00B0E | Botschaft 0x380 (Fahrgestellnummer) - Signal combined event | 1 | - |
| 0xD00B11 | Botschaft 0xCA (CTR_FN_IDC) - Signal combined event | 1 | - |
| 0xD00B14 | Botschaft 0x328 (Relativzeit) - Signal combined event | 1 | - |
| 0xD00B17 | Botschaft 0x32 (ST_CENG) - Signal combined event | 1 | - |
| 0xD00B1A | Botschaft 0x1A1 (V_VEH) - Signal combined event | 1 | - |
| 0xD00B1D | Botschaft 0x215 (ST_LP_EX_REAR_2_LH) - Signal combined event | 1 | - |
| 0xD00B21 | Botschaft 0x388 (Fahrzeugtyp) - Signal combined event | 1 | - |
| 0xD00B24 | Botschaft 0x3A0 (FZZSTD) - Signal combined event | 1 | - |
| 0xD00B27 | Botschaft 0x215 (ST_LP_EX_REAR_OTHER_SIDE_MASTER_1) - Signal combined event | 1 | - |
| 0xD00B2A | Botschaft 0x215 (ST_LP_EX_REAR_OTHER_SIDE_Slave_2) - Signal combined event | 1 | - |
| 0xD00B2D | Botschaft 0x3C  (Con_VEH) - Signal combined event | 1 | - |
| 0xD00B2F | Botschaft 0x2FC  (STAT_ZV_KLAPPEN) - Signal ST_CT_BTL | 1 | - |
| 0xFFFFFF | unbekannter Fehlerort | 0 | - |
