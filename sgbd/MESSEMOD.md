...
| --- | --- |
| ECU | Messe Modus |
| ORIGIN | BMW UA-70 Hillebrand |
| REVISION | 0.006 |
| AUTHOR | ESG AB-T Stephan_Keitel |
| COMMENT | - |
| PACKAGE | 1.45 |
| SPRACHE | deutsch |
...
| MODE | long | 0: MESSEMODUS_NICHT_AKTIV 1: MESSEMODUS_AKTIV |
...
| ECU_GROBNAME | string | Grobname des Steuergerätes |
...
| STAT_PWF_MESSEMODUS_WERT | long | Ausgabe des Messemodus |
| STAT_PWF_MESSEMODUS_TEXT | string | Text zu STAT_PWF_MESSEMODUS_WERT |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| _REQUEST | binary | Hex-Auftrag an SG |
| _RESPONSE | binary | Hex-Antwort von SG |
