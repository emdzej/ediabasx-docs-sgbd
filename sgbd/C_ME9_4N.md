...
| Field | Value |
| --- | --- |
| ECU | ME9.2 fuer N4 mit EWS 3 |
| ORIGIN | BMW TI-433 Lothar Dennert |
| REVISION | 2.0 |
| AUTHOR | BMW TI-433 Lothar Dennert |
| COMMENT | N/A |
| PACKAGE | 0.92 |
| SPRACHE | @sprache@ |
...
- [INITIALISIERUNG](#job-initialisierung) - Initialisierung / Kommunikationsparameter fuer ME9 automatischer Aufruf beim ersten Zugriff auf die SGBD
