...
| Field | Value |
| --- | --- |
| ECU | Spezial SGBD nur für CIP zur Gateway Steuerung  |
| ORIGIN | BMW VS-42 A.Baer |
| REVISION | 0.10 |
| AUTHOR | BMW VS-40 M.Rowedder |
| COMMENT | Auszug aus flash.prg nur zur Gateway Steuerung im INIT Job |
| PACKAGE | 1.21 |
| SPRACHE | deutsch |
