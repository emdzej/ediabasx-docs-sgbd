...
| Name | Type | Comment |
| --- | --- | --- |
| STAT_ZK1_AKTIV | int | 0=ZK1_NICHT_AKTIV 1=ZK1_AKTIV Kopf-Airbag links |
| STAT_ZK2_AKTIV | int | 0=ZK2_NICHT_AKTIV 1=ZK2_AKTIV Kniepolster links |
...
| ORT | ORTTEXT |
| --- | --- |
| 0x9528 | Watchdog-Reset uP |
| 0x9529 | Clock-Monitor-Reset uP |
| 0x952a | Illegal Opcode uP |
| 0x952b | Falsche Fahrgestellnummer |
| 0x952c | Systemzeitfehler |
| 0x952d | Timeout ID 01H (STVL) |
| 0x952e | Timeout ID 02H |
| 0x952f | Timeout ID 03H (STVR) |
| 0x9530 | Timeout ID 04H |
| 0x9531 | Timeout ID 05H (SBSL) |
| 0x9532 | Timeout ID 06H (SASL) |
| 0x9533 | Timeout ID 07H (SBSR) |
| 0x9534 | Timeout ID 08H (SASR) |
| 0x9535 | Timeout ID 09H (SFZ) |
| 0x9536 | Timeout ID 0AH (SIM) |
| 0x9537 | Timeout ID 0BH (SASL) |
| 0x9538 | Timeout ID 0CH (SASR) |
| 0x9539 | Timeout ID 0DH (SFZ) |
| 0x953a | Timeout ID 0EH |
| 0x953b | Timeout ID 0FH |
| 0x953c | Timeout ID 20H (SSFA) |
| 0x953d | Timeout ID 21H (SSBF) |
| 0x953e | Timeout ID 22H (SSH) |
| 0x953f | Timeout ID 71H (SIM) |
| 0x9540 | Codierdaten Checksummenfehler |
| 0x9541 | Stack Overflow |
| 0x9542 | PDC_3 : zu wenig Telegramme |
| 0x9543 | PDC_3 : Datenfehler in Telegramm |
| 0x9544 | PDC_3 : Uebertragungsfehler |
| 0x9545 | unplausible Crash-Schwere |
| 0x9546 | Kurzschluss oder Unterbrechung H/L-Side-Schalter ZK1 |
| 0x9547 | Kurzschluss ZK1 nach Masse |
| 0x9548 | Kurzschluss ZK1 nach Plus |
| 0x9549 | Widerstand Zuendpille ZK1 zu klein |
| 0x954a | Widerstand Zuendpille ZK1 zu gross |
| 0x954b | Widerstand Zuendpille ZK1 nicht gemessen |
| 0x954c | Unterbrechung ZK1  |
| 0x954d | Spannung ZK1 n.i.O. |
| 0x954e | Zuendkapazitaet ZK1 n.i.O. |
| 0x954f | Codierung/Konfiguration ZK1 unstimmig |
| 0x9550 | Unterbrechung Entladekreis ZK1 |
| 0x9551 | Kurzschluss oder Unterbrechung H/L-Side-Schalter ZK2 |
| 0x9552 | Kurzschluss ZK2 nach Masse |
| 0x9553 | Kurzschluss ZK2 nach Plus |
| 0x9554 | Widerstand Zuendpille ZK2 zu klein |
| 0x9555 | Widerstand Zuendpille ZK2 zu gross |
| 0x9556 | Widerstand Zuendpille ZK2 nicht gemessen |
| 0x9557 | Unterbrechung ZK2 |
| 0x9558 | Spannung ZK2 n.i.O. |
| 0x9559 | Zuendkapazitaet ZK2 n.i.O. |
| 0x955a | Codierung/Konfiguration ZK2 unstimmig |
| 0x955b | Unterbrechung Entladekreis ZK2 |
| 0x955c | Kurzschluss oder Unterbrechung H/L-Side-Schalter ZK3 |
| 0x955d | Kurzschluss ZK3 nach Masse |
| 0x955e | Kurzschluss ZK3 nach Plus |
| 0x955f | Widerstand Zuendpille ZK3 zu klein |
| 0x9560 | Widerstand Zuendpille ZK3 zu gross |
| 0x9561 | Widerstand Zuendpille ZK3 nicht gemessen |
| 0x9562 | Unterbrechung ZK3 |
| 0x9563 | Spannung ZK3 n.i.O. |
| 0x9564 | Zuendkapazitaet ZK3 n.i.O. |
| 0x9565 | Codierung/Konfiguration ZK3 unstimmig |
| 0x9566 | Unterbrechung Entladekreis ZK3 |
| 0x9567 | Kurzschluss oder Unterbrechung H/L-Side-Schalter ZK4 |
| 0x9568 | Kurzschluss ZK4 nach Masse |
| 0x9569 | Kurzschluss ZK4 nach Plus |
| 0x956a | Widerstand Zuendpille ZK4 zu klein |
| 0x956b | Widerstand Zuendpille ZK4 zu gross |
| 0x956c | Widerstand Zuendpille ZK4 nicht gemessen |
| 0x956d | Unterbrechung ZK4 |
| 0x956e | Spannung ZK4 n.i.O. |
| 0x956f | Zuendkapazitaet ZK4 n.i.O. |
| 0x9570 | Codierung/Konfiguration ZK4 unstimmig |
| 0x9571 | Unterbrechung Entladekreis ZK4 |
| 0x9572 | Fehler im Alarmpfad |
| 0x9573 | Fehler Beschleunigungssensor:Offset zu gross (x-Richtung) |
| 0x9574 | Fehler Beschleunigungssensor:Selbsttestwert zu gross (x-Richtung) |
| 0x9575 | Fehler Beschleunigungssensor:Selbsttestwert zu klein (x-Richtung) |
| 0x9576 | Fehler Beschleunigungssensor:Offset zu gross (y-Richtung) |
| 0x9577 | Fehler Beschleunigungssensor:Selbsttestwert zu gross (y-Richtung) |
| 0x9578 | Fehler Beschleunigungssensor:Selbsttestwert zu klein (y-Richtung) |
| 0x9579 | Statusfehler Beschleunigungssensor (y-Richtung) |
| 0x957A | Algorithmus-Parameter inkonsistent |
| 0x957B | EAM-Parameter inkonsistent |
| 0x957C | Zuendversuch erfolgt |
| 0x957D | COP-Watchdog fehlerhaft |
| 0x9592 | Spannungsueberwachung ASE unterer Grenzwert unterschritten |
| 0x9593 | Spannungsueberwachung ASE oberer Grenzwert ueberschritten |
| 0x9594 | Energiesparmode aktiv |
| 0x9595 | Codierung unvollstaendig |
| 0x9589 | Kurzschluss oder Unterbrechung Low-Side-Schalter  ZK1 |
| 0x958A | Kurzschluss oder Unterbrechung High-Side-Schalter ZK1 |
| 0x958B | Kurzschluss oder Unterbrechung Low-Side-Schalter  ZK2 |
| 0x958C | Kurzschluss oder Unterbrechung High-Side-Schalter ZK2 |
| 0x958D | Kurzschluss oder Unterbrechung Low-Side-Schalter  ZK3 |
| 0x958E | Kurzschluss oder Unterbrechung High-Side-Schalter ZK3 |
| 0x958F | Kurzschluss oder Unterbrechung Low-Side-Schalter  ZK4 |
| 0x9590 | Kurzschluss oder Unterbrechung High-Side-Schalter ZK4 |
| 0x9591 | Kommunikation mit Zuend-IC gestoert |
...
| ORT | ORTTEXT |
| --- | --- |
| 0x9580 | Power-On-Reset uP |
| 0x9581 | Diagnose S/E-Modul (Lichtleistung) |
| 0x9582 | SI-Bus: Uebertragungsfehler, CRC-Fehler ERRIF |
| 0x9583 | SI-Bus: Uebertragungsfehler, Formatfehler ILLPIF |
| 0x9584 | SI-Bus: Synchronisierungspuls zu frueh SYNEIF |
| 0x9585 | SI-Bus: Synchronisierung verloren SYNLIF |
| 0x9586 | SI-Bus: Slotmismatch, Timingfehler SLMMIF |
| 0x9587 | SI-Bus: FIFO-Ueberlauf OVRNIF |
| 0x9588 | EMV-Fehler im Zuend-Ic |
| 0x???? | unbekannter Fehlerort |
