...
- [ABGLEICH](#table-abgleich) (11 × 4)
- [RESULTNAMEN](#table-resultnamen) (15 × 5)
...
| --- | --- | --- | --- |
| IMAFLAG | IMA Programmiert Flag | 0xBC | 1 |
| IMAALLE | IMA Alle Injektoren | 0xBB | 32 |
| FGRKLI | FGR/Klimaanlage | 0xCC | 1 |
| FGRMAIN | FGR/Mainswitch | 0xA8 | 1 |
| KLIMA | Klimakompressorabgleich | 0xB1 | 2 |
| LLA | Leerlaufdrehzahl | 0xA3 | 2 |
| ARS | ARS Status-Message | 0x0110 | 1 |
| FSREKM | km-Stand bei FSP-RESET | 0x0120 | 4 |
| PST | Prüfstempel aus EEPROM | 0x1000 | 3 |
| ADDITIV | Additivpumpen-Werte aus EEPROM | 0x5101 | 33 |
| DPF | DPF-Werte aus EEPROM | 0x5000 | 32 |
...
| IGR | _TEL_AUFTRAG_IGR | _TEL_ANTWORT_IGR | _TEL_AUFTRAG_2_IGR | _TEL_ANTWORT_2_IGR |
| LEM | _TEL_AUFTRAG_LEM | _TEL_ANTWORT_LEM | _TEL_AUFTRAG_2_LEM | _TEL_ANTWORT_2_LEM |
| MSA | _TEL_AUFTRAG_MSA | _TEL_ANTWORT_MSA | _TEL_AUFTRAG_2_MSA | _TEL_ANTWORT_2_MSA |
| ADDITIV | _TEL_AUFTRAG_ADDITIV | _TEL_ANTWORT_ADDITIV | _TEL_AUFTRAG_2_ADDITIV | _TEL_ANTWORT_2_ADDITIV |
| DPF | _TEL_AUFTRAG_DPF | _TEL_ANTWORT_DPF | _TEL_AUFTRAG_2_DPF | _TEL_ANTWORT_2_DPF |
