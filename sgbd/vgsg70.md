...
- [WRITE_PWM](#job-write-pwm) - manuelle Vorgabe Motor KWP 2000: $3B WriteDataByLocalIdentifier LID13 Bedingungen: (vFzd = gueltig) und (vFzg &lt; 0.2km/h) Modus   : Default
...
<a id="job-status-systemfunktion"></a>
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_PHY_PIC_KL30_WERT | real | vom PIC erfasste KL30 |
| STAT_PHY_PIC_KL30_EINHEIT | string | Physikalische Einheit |
| STAT_PHY_PIC_KL30G_WERT | real | vom PIC erfasste KL30g |
| STAT_PHY_PIC_KL30G_EINHEIT | string | Physikalische Einheit |
| STAT_PHY_PIC_KL15_WERT | real | vom PIC erfasste KL15 |
| STAT_PHY_PIC_KL15_EINHEIT | string | Physikalische Einheit |
| STAT_PHY_PIC_TEMP_WERT | real | vom PIC erfasste Temperatur |
| STAT_PHY_PIC_TEMP_EINHEIT | string | Physikalische Einheit |
| _TEL_AUFTRAG_1 | binary | Hex-Auftrag an SG |
| _TEL_ANTWORT_1 | binary | Hex-Antwort von SG |
| STAT_ST_KL15_WERT | int | KL15- Status |
| STAT_KL15EIN_WERT | int | Status-KL15(eingeschaltet oder nicht) |
| STAT_UDIAGKL15_WERT | real | KL15- Diagnosespannung |
| STAT_UDIAGKL15_EINHEIT | string | physikalische Einheit |
| STAT_FEL_VKMEIN_WERT | int | VKMein-Fehlerstatus |
| STAT_UDIAGKL30G_WERT | real | KL30G- Diagnosespannung |
| STAT_UDIAGKL30G_EINHEIT | string | physikalische Einheit |
| STAT_UKL30_WERT | real | KL30- Spannung |
| STAT_UKL30_EINHEIT | string | physikalische Einheit |
| _TEL_AUFTRAG_2 | binary | Hex-Auftrag an SG |
| _TEL_ANTWORT_2 | binary | Hex-Antwort von SG |
| STAT_MILE_KM_WERT | long | aktueller Kilometerstand |
| STAT_MILE_KM_EINHEIT | string | physikalische Einheit |
| _TEL_AUFTRAG_3 | binary | Hex-Auftrag an SG |
| _TEL_ANTWORT_3 | binary | Hex-Antwort von SG |
| STAT_V_WHL_FLH_WERT | real | Radgeschwindigkeit vorne links |
| STAT_V_WHL_FLH_EINHEIT | string | physikalische Einheit |
| STAT_V_WHL_FRH_WERT | real | Radgeschwindigkeit vorne rechts |
| STAT_V_WHL_FRH_EINHEIT | string | physikalische Einheit |
| STAT_V_WHL_RLH_WERT | real | Radgeschwindigkeit hinten links |
| STAT_V_WHL_RLH_EINHEIT | string | physikalische Einheit |
| STAT_V_WHL_RRH_WERT | real | Radgeschwindigkeit hinten rechts |
| STAT_V_WHL_RRH_EINHEIT | string | physikalische Einheit |
| _TEL_AUFTRAG_4 | binary | Hex-Auftrag an SG |
| _TEL_ANTWORT_4 | binary | Hex-Antwort von SG |
| STAT_ACV_OPN_WERT | int | ACV_OPN |
| STAT_ST_FNT_WERT | int | Funktionsstatus |
| STAT_FEL_SPERREAKTIV_WERT | int | Fehlerstatus SPerreAktiv |
| STAT_SPERRESTATE_WERT | int | Status SPerre-Zustand |
| STAT_SPERREMAINSTATE_WERT | int | Status SPerre-Main-Zustand |
| STAT_SPERREERROR_WERT | int | SPerre-Error |
| _TEL_AUFTRAG_5 | binary | Hex-Auftrag an SG |
| _TEL_ANTWORT_5 | binary | Hex-Antwort von SG |
| STAT_EP_CAN_WERT | int | Ersatzprogramm - CAN |
| STAT_EP_SPERRE_WERT | int | Ersatzprogram -SPerre |
| STAT_EP_AKTLOGIK_WERT | int | Ersatzprogramm - AKTLOGIK |
| STAT_SF_AKTLOGIK_WERT | int | Ersatzprogram- SF_AKTLOGIK |
| _TEL_AUFTRAG_6 | binary | Hex-Auftrag an SG |
| _TEL_ANTWORT_6 | binary | Hex-Antwort von SG |
| STAT_USM_A_WERT | real | Stellmotorspannung A |
| STAT_USM_A_EINHEIT | string | physikalische Einheit |
| STAT_USM_B_WERT | real | Stellmotorspannung B |
| STAT_USM_B_EINHEIT | string | physikalische Einheit |
| STAT_USM_WERT | real | Stellmotorspannung |
| STAT_USM_EINHEIT | string | physikalische Einheit |
| STAT_DSMPWM_WERT | real | PMW-Ratio |
| STAT_DSMPWM_EINHEIT | string | physikalische Einheit |
| STAT_SM_BRIDGE_TEMP_WERT | int | SM_Bridge_Temp |
| STAT_SM_BRIDGE_TEMP_EINHEIT | string | physikalische Einheit |
| _TEL_AUFTRAG_7 | binary | Hex-Auftrag an SG |
| _TEL_ANTWORT_7 | binary | Hex-Antwort von SG |
| STAT_ISM_A_WERT | real | iSM_A |
| STAT_ISM_A_EINHEIT | string | physikalische Einheit |
| STAT_ISM_B_WERT | real | iSM_B |
| STAT_ISM_B_EINHEIT | string | physikalische Einheit |
| STAT_ISM_WERT | real | iSM |
| STAT_ISM_EINHEIT | string | physikalische Einheit |
| _TEL_AUFTRAG_8 | binary | Hex-Auftrag an SG |
| _TEL_ANTWORT_8 | binary | Hex-Antwort von SG |
| STAT_USM_TEMP_WERT | real | uSM_Temp |
| STAT_USM_TEMP_EINHEIT | string | physikalische Einheit |
| STAT_SM_TEMP_WERT | real | SM_Temp |
| STAT_SM_TEMP_EINHEIT | string | physikalische Einheit |
| _TEL_AUFTRAG_9 | binary | Hex-Auftrag an SG |
| _TEL_ANTWORT_9 | binary | Hex-Antwort von SG |
| STAT_TANKER_WERT | real | TAnker |
| STAT_TANKER_EINHEIT | string | physikalische Einheit |
| STAT_TSTATOR_WERT | real | TSTator |
| STAT_TSTATOR_EINHEIT | string | physikalische Einheit |
| STAT_TB_AKT_WERT | real | TB_Akt |
| STAT_TB_AKT_EINHEIT | string | physikalische Einheit |
| STAT_INT_LSM_FEHLER_RT_WERT | real | Int_Lsm_Fehler_RT |
| STAT_INT_LSM_FEHLER_RT_EINHEIT | string | physikalische Einheit |
| _TEL_AUFTRAG_10 | binary | Hex-Auftrag an SG |
| _TEL_ANTWORT_10 | binary | Hex-Antwort von SG |
| STAT_KORROFFSETKAL_TEMP_WERT | real | KorrOffsetKal_Temp |
| STAT_KORROFFSETKAL_TEMP_EINHEIT | string | physikalische Einheit |
| STAT_KORROFFSETKAL_KM_WERT | real | KorrOffsetKal_km |
| STAT_KORROFFSETKAL_KM_EINHEIT | string | physikalische Einheit |
| STAT_PHISPERRKAL_WERT | real | PhiSperrKal |
| STAT_PHISPERRKAL_EINHEIT | string | physikalische Einheit |
| STAT_DELTAPHISPERREKAL_WERT | real | DeltaPhiSperrKal |
| STAT_DELTAPHISPERREKAL_EINHEIT | string | physikalische Einheit |
| STAT_MSPERRSOLLIN_LIM_WERT | real | MSperrSollIn_Lim |
| STAT_MSPERRSOLLIN_LIM_EINHEIT | string | physikalische Einheit |
| _TEL_AUFTRAG_11 | binary | Hex-Auftrag an SG |
| _TEL_ANTWORT_11 | binary | Hex-Antwort von SG |
| STAT_TICKSM_WERT | int | tickSM |
| STAT_TICKSM_EINHEIT | string | physikalische Einheit |
| STAT_PHISM_WERT | real | phiSM |
| STAT_PHISM_EINHEIT | string | physikalische Einheit |
| STAT_NSM_WERT | real | nSM |
| STAT_NSM_EINHEIT | string | physikalische Einheit |
| _TEL_AUFTRAG_12 | binary | Hex-Auftrag an SG |
| _TEL_ANTWORT_12 | binary | Hex-Antwort von SG |
| STAT_USM_IE_VCC_WERT | real | uSM_IE_VCC |
| STAT_USM_IE_VCC_EINHEIT | string | physikalische Einheit |
| STAT_USM_IE_VCC_R_WERT | real | uSM_IE_VCC_R |
| STAT_USM_IE_VCC_R_EINHEIT | string | physikalische Einheit |
| STAT_USM_IE_IMP_WERT | real | uSM_IE_Imp |
| STAT_USM_IE_IMP_EINHEIT | string | physikalische Einheit |
| STAT_USM_IE_DIR_WERT | real | uSM_IE_Dir |
| STAT_USM_IE_DIR_EINHEIT | string | physikalische Einheit |
| STAT_SM_IE_VCC_EN_WERT | int | SM_IE_VCC_EN |
| _TEL_AUFTRAG_13 | binary | Hex-Auftrag an SG |
| _TEL_ANTWORT_13 | binary | Hex-Antwort von SG |
| STAT_INCPLAUSIBCOUNTER_WERT | int | INCPlausibCounter |
| STAT_WIREERRORCOUNTER_WERT | int | WireErrorCounter |
| _TEL_AUFTRAG_14 | binary | Hex-Auftrag an SG |
...
- [FUMWELTMATRIX](#table-fumweltmatrix) (45 × 5)
...
- [KLEMMENSTATUS](#table-klemmenstatus) (2 × 2)
...
- [FF_N_B](#table-ff-n-b) (1 × 7)
- [FF_O_B](#table-ff-o-b) (1 × 7)
- [FF_P_B](#table-ff-p-b) (1 × 7)
- [ENGINE_1](#table-engine-1) (2 × 2)
- [WMOM_DRV_1](#table-wmom-drv-1) (5 × 2)
- [WMOM_DRV_4](#table-wmom-drv-4) (3 × 2)
- [WMOM_DRV_5](#table-wmom-drv-5) (5 × 2)
