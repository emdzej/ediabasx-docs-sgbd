...
| COMMENT | Conti_Teves ABS Motorrad, Uebernahme MK60 vom E87 |
| PACKAGE | 1.50 |
| SPRACHE | deutsch |
...
- [STATUS_SENSOREN_OFFSET](#job-status-sensoren-offset) - Auslesen der Offsets der Sensoren KWP2000: $21 Read Data by Local ID $02 ESP-Sensor-Offsets Modus  : Default
- [STEUERN_ABS_LAMPE](#job-steuern-abs-lampe) - Ansteuern der ABS-Kontrollleucht KWP2000: $30, $20, $07 InputOutputControlByLocalIdentifier, Lamp activation Kontrollampe ansteuern Modus  : ECUAM - ECUAdjustmentMode Achtung: zuerst das SG mit "DIAGNOSE_MODE ECUAM" in den ECU-Adjustment-Mode bringen, erst dann ist der Job moeglich 
- [STATUS_SPANNUNGEN_SENSOREN](#job-status-spannungen-sensoren) - Auslesen der Spannungen und Stati der Sensoren KWP2000: $21 Read Data by Local ID $06 Sensor-Inputs and Voltages Modus  : Default
- [_STATUS_CAN_FRAMES](#job-status-can-frames) - Auslesen der Stati der Schalter KWP2000: $22 Read data by common identifier Modus  : Default nur fuer Entwicklungszwecke
- [STATUS_DIGITAL](#job-status-digital) - Auslesen der Stati der Schalter KWP2000: $21 Read Data by Local ID $05 Control Switch Status Modus  : Default
- [STEUERN_VENTILE_PUMPE](#job-steuern-ventile-pumpe) - Ansteuern der Steuerventile und der Pumpe KWP2000: $30, $10, $07 InputOutputControlByLocalIdentifier Ausgaenge ansteuern Modus  : ECUAM - ECUAdjustmentMode Achtung: zuerst das SG mit "DIAGNOSE_MODE ECUAM" in den ECU-Adjustment-Mode bringen, erst dann ist der Job moeglich Parameterliste (siehe Tabelle VENTIL_PUMPE) EVV	EinlassVentilVorne AVV	AuslassVentilVorne EVH	EinlassVentilHinten AVH	AuslassVentilHinten TV	TrennVentil EUV	ElektrischesUmschaltVentil PUMPE	Pumpe Zeit	Timer fuer Parametersatz 1 (in 10 msec pro Einheit) 0 oder keine Angabe bedeutet Parametersatz 1 deaktiviert Die Uebergabe des jeweiligen Parameters (z.B.: EVV, EUV...) in den Argumenten 1 bis 7 aktiviert das Bauteil für die im Parameter 8 (Zeit) angegebene Zeit, keine Angabe deaktiviert das Bauteil Die Uebergabe des jeweiligen Parameters in den Argumenten 9 bis 15 aktiviert das Bauteil fuer jeweils 2 Sekunden. "ARG1,ARG2,ARG3,ARG4,ARG5,ARG6,ARG7,Zeit,ARG9,ARG10,ARG11,ARG12,ARG13,ARG14,ARG15,GESAMTZEIT"  Beispiel1 fuer den Parametersatz (jedoch mit StrichPunkt getrennt, nicht mit Komma) "EVV,PUMPE,TV  ,    ,    ,    ,    ,25  ,AVH ,TV   ,EUV  ,     ,     ,     ,     ,      " Damit wird EVV, PUMPE und TV fuer 250 msec aktiviert (alle anderen aus), dann wird AVH, TV und EUV fuer 2 Sekunden aktivert  Beispiel2 fuer den Parametersatz (jedoch mit StrichPunkt getrennt, nicht mit Komma) ",,,,,,,0,,,,,,," Alles aus  Beispiel3 fuer den Parametersatz (jedoch mit StrichPunkt getrennt, nicht mit Komma) "    ,    ,    ,    ,    ,    ,    ,0   ,AVH ,TV   ,EUV  ,     ,     ,     ,     ,20    " Damit wird AVH, TV und EUV fuer 20 Sekunden aktivert, der Auftrag wird zyklisch von der SGBD an das ABS ausgegeben
- [STATUS_VARIANTE](#job-status-variante) - Lesen der angelernten Variante KWP2000: $22 ReadDataByCommonId $30 $00 Fahrzeugcodierung Modus:        Default
- [STEUERN_VARIANTE_RUECKSETZEN](#job-steuern-variante-ruecksetzen) - Loeschen der (ueber CAN vom Kombi) gesetzen Fahrzeugvariante KWP2000: $2E WriteDataByCommonIdentifier $30 $00 Fahrzeugcodierung Modus  : ECUAM - ECUAdjustmentMode Achtung: zuerst das SG mit "DIAGNOSE_MODE ECUAM" in den ECU-Adjustment-Mode bringen, erst dann ist der Job moeglich
...
- [STEUERN_SICHERHEITSMODUS](#job-steuern-sicherheitsmodus) - KWP2000:$27,$03 oder  $27,$07 SecurityAccess service nur fuer Rollenpruefung Berlin deaktiviert die Geschwindigkeitsbeschraenkung des ECU_Adjustment_Modes
...
| STAT_RAD_GESCHW_VORNE_WERT | long | Radgeschwindigkeit vorne |
| STAT_RAD_GESCHW_HINTEN_WERT | long | Radgeschwindigkeit hinten |
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_OFFSET_SENSOR_BEDIENKREIS_VORNE_WERT | real | Offsetwert des Drucksensors im Bedienkreis Vorderrad [Bar] |
| STAT_OFFSET_SENSOR_BEDIENKREIS_HINTEN_WERT | real | Offsetwert des Drucksensors im Bedienkreis Hinterrad [Bar] |
| STAT_OFFSET_SENSOR_RADKREIS_HINTEN_WERT | real | Offsetwert des Drucksensors im Radkreis Hinterrad [Bar] |
| STAT_OFFSET_SENSOR_EINH | string | Einheit des Offsetwerts des Drucksensors [Bar] |
| _TEL_AUFTRAG | binary | Anforderungstelegramm |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |

<a id="job-steuern-abs-lampe"></a>
### STEUERN_ABS_LAMPE
...
<a id="job-status-spannungen-sensoren"></a>
...
| STAT_DRUCK_BEDIENKREIS_VORNE_WERT | real | Druckwert des Drucksensors im Bedienkreis Vorderrad [Bar] |
| STAT_DRUCK_BEDIENKREIS_HINTEN_WERT | real | Druckwert des Drucksensors im Bedienkreis Hinterrad [Bar] |
| STAT_DRUCK_RADKREIS_HINTEN_WERT | real | Druckwert des Drucksensors im Radkreis Hinterrad [Bar] |
| STAT_SPANNUNG_EINH | string | Volt |
| STAT_DRUCK_EINH | string | bar |
| _TEL_AUFTRAG | binary | Anforderungstelegramm |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |

<a id="job-status-can-frames"></a>
### _STATUS_CAN_FRAMES
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| DATEN_HEX | binary | Inhalt der 8 Datenbyte Anzeige Hexadezimal |
| _TEL_AUFTRAG | binary | Anforderungstelegramm |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_BREMSLICHTSCHALTER_VORNE | int | 0 oder 1 |
| STAT_BREMSLICHTSCHALTER_HINTEN | int | 0 oder 1 |
| STAT_ABS_TASTER | int | 0 oder 1 ABS-Schalter aktuell betätigt |
| STAT_ABS_SYSTEM | int | 0 oder 1 ABS-System deaktiviert durch Schalter |
| _TEL_AUFTRAG | binary | Anforderungstelegramm |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |

<a id="job-steuern-ventile-pumpe"></a>
...
| Name | Type | Comment |
| --- | --- | --- |
| STAT_VARIANTE_ABS_WERT | int | abgespeicherte ABS_Variante Fahrzeugcodierung |
| STAT_VARIANTE_ABS_TEXT | string | ABS_Varaiante laut Nachrichtenkatalog table VARIANTE_ABS |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| _TEL_AUFTRAG | binary | Hex-Auftrag an SG |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |

<a id="job-steuern-variante-ruecksetzen"></a>
...
<a id="job-steuern-sicherheitsmodus"></a>
...
- [DIGITAL1](#table-digital1) (1 × 4)
- [DIGITAL2](#table-digital2) (1 × 6)
- [DIGITAL_ABS](#table-digital-abs) (3 × 2)
- [VENTIL_PUMPE](#table-ventil-pumpe) (7 × 2)
- [VARIANTE_ABS](#table-variante-abs) (30 × 2)
