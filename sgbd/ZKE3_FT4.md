...
| Field | Value |
| --- | --- |
| ECU | ZKE III: Fahrertuermodul E53 |
...
- [STATUS_DIGITAL_FT](#job-status-digital-ft) - Status der Digitalsignale der FT E53 (Ein-/Ausgaenge)
- [STATUS_ANALOG_FT](#job-status-analog-ft) - Status der Analogsignale der FT E53
...
| STAT_E_SBKS_AKTIV | int | 0, wenn FALSE / 1, wenn TRUE |
...
| STAT_IFHFT_WERT | real | momentaner Strom im FH-Antrieb FT Bereich: 0 bis 49,0 |
| STAT_IFHFT_EINH | string | Einheit: 'Ampere' |
| STAT_IFTMAX_WERT | real | maximaler Strom im FH-Antrieb FT Bereich: 0 bis 49,0 |
