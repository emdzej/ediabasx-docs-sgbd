...
| --- | --- |
| ECU | MOST_89x |
| ORIGIN | BMW VH-53 Christian Waas |
| REVISION | 0.64 |
| AUTHOR | BMW VH-53 Christian Waas |
...
- [FS_LOESCHEN](#job-fs-loeschen) - Fehlerspeicher loeschen in Abhängigkeit von der Steuergeraete-Gruppe siehe ClearDiagnosticInformation in LH Diagnose Teil 2
...
Fehlerspeicher loeschen in Abhängigkeit von der Steuergeraete-Gruppe siehe ClearDiagnosticInformation in LH Diagnose Teil 2
...
| MOST_SG_ANZAHL | unsigned char | gibt die Anzahl der verbauten MOST-SG'e zurück MOST_SG_ANZAHL = 1: nur RAD2 bzw. CCC, CICR oder M-ASK verbaut |
...
| HFK_RESET_RAD2_MASK_CCC | unsigned char | Reset-Häufigkeit als Zahl für je 5 wirklich gespeicherte Resets im SG wird im Result 1 Reset angezeigt Wertebereich Resets im SG: 0 - 255 Somit Wertebereich für Result: 0 - 51 |
| ERROR_NCE_SG_ADR_1 | unsigned char | Steuergeräte-Adresse in der Umweltbedingung 2 vom CCC bzw. Umweltbedingung 1 vom M-ASK oder Umweltbedingung 1 vom RAD2 Gültiger Wertebereich 0 - 255 Default: 0 (wenn keine Umweltbedingung gespeichert ist) |
| ERROR_NCE_SG_ADR_2 | unsigned char | Steuergeräte-Adresse in der Umweltbedingung 2 vom CCC bzw. Umweltbedingung 1 vom M-ASK oder Umweltbedingung 1 vom RAD2 Gültiger Wertebereich 0 - 255 Default: 0 (wenn keine Umweltbedingung gespeichert ist) |
| ERROR_NCE_SG_ADR_3 | unsigned char | Steuergeräte-Adresse in der Umweltbedingung 2 vom CCC bzw. Umweltbedingung 1 vom M-ASK oder Umweltbedingung 1 vom RAD2 Gültiger Wertebereich 0 - 255 Default: 0 (wenn keine Umweltbedingung gespeichert ist) |
| ERROR_REGISTRY_NEW_ADR_1 | unsigned char | Steuergeräte-Adresse in der Umweltbedingung 2 vom CCC bzw. Umweltbedingung 1 vom M-ASK oder Umweltbedingung 1 vom RAD2 Gültiger Wertebereich 0 - 255 Default: 0 (wenn keine Umweltbedingung gespeichert ist) |
| ERROR_REGISTRY_NEW_ADR_2 | unsigned char | Steuergeräte-Adresse in der Umweltbedingung 2 vom CCC bzw. Umweltbedingung 1 vom M-ASK oder Umweltbedingung 1 vom RAD2 Gültiger Wertebereich 0 - 255 Default: 0 (wenn keine Umweltbedingung gespeichert ist) |
| ERROR_REGISTRY_NEW_ADR_3 | unsigned char | Steuergeräte-Adresse in der Umweltbedingung 2 vom CCC bzw. Umweltbedingung 1 vom M-ASK oder Umweltbedingung 1 vom RAD2 Gültiger Wertebereich 0 - 255 Default: 0 (wenn keine Umweltbedingung gespeichert ist) |
| ERROR_MONITORING_ADR_1 | unsigned char | Steuergeräte-Adresse in der Umweltbedingung 2 vom CCC bzw. Umweltbedingung 1 vom M-ASK oder Umweltbedingung 1 vom RAD2 Gültiger Wertebereich 0 - 255 Default: 0 (wenn keine Umweltbedingung gespeichert ist) |
| ERROR_MONITORING_ADR_2 | unsigned char | Steuergeräte-Adresse in der Umweltbedingung 2 vom CCC bzw. Umweltbedingung 1 vom M-ASK oder Umweltbedingung 1 vom RAD2 Gültiger Wertebereich 0 - 255 Default: 0 (wenn keine Umweltbedingung gespeichert ist) |
| ERROR_MONITORING_ADR_3 | unsigned char | Steuergeräte-Adresse in der Umweltbedingung 2 vom CCC bzw. Umweltbedingung 1 vom M-ASK oder Umweltbedingung 1 vom RAD2 Gültiger Wertebereich 0 - 255 Default: 0 (wenn keine Umweltbedingung gespeichert ist) |
...
| HFK_IPC_OPERATION_RAD2 | unsigned char | Reset-Häufigkeit als Zahl Wertebereich 0 - 255 |
| HFK_IPC_STARTUP_RAD2 | unsigned char | Reset-Häufigkeit als Zahl Wertebereich 0 - 255 |
...
| MOST_RAD2_MASK_CCC | char | Rückgabewert = Summe der Verdächtigungen |
