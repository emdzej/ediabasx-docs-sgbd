...
| Field | Value |
| --- | --- |
| ECU | Sprachverarbeitungssystem |
| ORIGIN | BMW TI-431 Rochal |
| REVISION | 1.03 |
| AUTHOR | Temic Ulm, Michael Hensgens, EE-442 Mike Peters, BMW TI-431 Krueger, BMW TI-431 Rochal |
| COMMENT | SVS_E65 |
| PACKAGE | 1.32 |
| SPRACHE | deutsch |
...
- [STEUERN_SELBSTTEST](#job-steuern-selbsttest) - Start des Selbsttest KWP2000: $31 StartRoutineByLocalIdentifier LH Diagnose Teil 8, Juli 2000 Seite 112 $04 selfTest LH Diagnose Teil 8, Juli 2000 Seite 112 Im Fehlerfall: Eintrag im FS Nummer 54852
- [STEUERN_RESET](#job-steuern-reset) - Reset wird ausgelöst KWP2000: $11 ecuReset LH Diagnose Teil 8, Juli 2000 Seite 51 $FA Stop Watchdogtrigger LH Diagnose Teil 8, Juli 2000 Seite 51 
- [LESEN_SPRACHVARIANTE](#job-lesen-sprachvariante) - Liest Sprachvariante des SVS KWP2000: $21 ReadDataByLocalIdentifier LH Diagnose Teil 8, Juli 2000 Seite 67 $FA systemSupplierSpecific LH Diagnose Teil 8, Juli 2000 Seite 67 
...
Start des Selbsttest KWP2000: $31 StartRoutineByLocalIdentifier LH Diagnose Teil 8, Juli 2000 Seite 112 $04 selfTest LH Diagnose Teil 8, Juli 2000 Seite 112 Im Fehlerfall: Eintrag im FS Nummer 54852
...
Reset wird ausgelöst KWP2000: $11 ecuReset LH Diagnose Teil 8, Juli 2000 Seite 51 $FA Stop Watchdogtrigger LH Diagnose Teil 8, Juli 2000 Seite 51 
...
<a id="job-lesen-sprachvariante"></a>
### LESEN_SPRACHVARIANTE

Liest Sprachvariante des SVS KWP2000: $21 ReadDataByLocalIdentifier LH Diagnose Teil 8, Juli 2000 Seite 67 $FA systemSupplierSpecific LH Diagnose Teil 8, Juli 2000 Seite 67 
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| _LANGUAGE_NR | int | Sprachvariante |
| _LANGUAGE_TXT | string | Sprachvariante als Text table IOrtTexte ORTTEXT |
| _TEL_AUFTRAG | binary | Hex-Auftrag an SG |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
- [I_RESET](#table-i-reset) (5 × 2)
- [I_CHANNELS](#table-i-channels) (3 × 2)
...
| ORT | ORTTEXT |
| --- | --- |
| 0xA288 | Fehler Selbsttest! SVS defekt. |
| 0xD64E | Error_Light_Not_Off |
| 0xD650 | Ringbruchdiagnose wurde durchgefuehrt (Error_Ring_Diagnose). |
| 0xD651 | Lange und/oder häufige Unlocks (Error_Unlock_Long). |
| 0xD652 | Ein Device hat sich wegen Übertemperatur abgeschaltet (Error_Temp_Shutdown). |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 0x01 | NPR | Hex | -- | unsigned char | -- | 1 | 1 | 0 |
...
| 0x05 | Reset | 0-n | -- | 0xFF | I_Reset | - | - | - |
| 0x06 | Device | Hex | -- | unsigned char | -- | 1 | 1 | 0 |
| 0x07 | Command | Hex | -- | unsigned char | -- | 1 | 1 | 0 |
| 0x08 | Channels | 0-n | -- | 0x01 | I_Channels | - | - | - |
| 0xXY | unbekannte Umweltbedingung | 1 | -- | unsigned char | -- | 1 | 1 | 0 |

<a id="table-i-reset"></a>
### I_RESET
