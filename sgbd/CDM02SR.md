...
| Field | Value |
| --- | --- |
| ECU | Coach door module satellite right |
...
- [ARG_0XA135_R](#table-arg-0xa135-r) (2 × 14)
- [BF_CDM_HW_VARIANT](#table-bf-cdm-hw-variant) (1 × 10)
- [BETRIEBSMODE](#table-betriebsmode) (6 × 3)
- [FDETAILSTRUKTUR](#table-fdetailstruktur) (6 × 2)
- [FORTTEXTE](#table-forttexte) (35 × 4)
...
- [RES_0XA15C_R](#table-res-0xa15c-r) (1 × 13)
...
- [TAB_CDM_AUDIO_CONT](#table-tab-cdm-audio-cont) (3 × 2)
- [TAB_CDM_AUDIO_CONTROL](#table-tab-cdm-audio-control) (5 × 2)
...
- [TAB_CDM_VOLUME_BUTTONS](#table-tab-cdm-volume-buttons) (4 × 2)
...
| ARG | STR | STPR | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | MIN | MAX | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| AUDIO | + | - | 0-n | high | unsigned char | - | TAB_CDM_AUDIO_CONT | - | - | - | - | - | Auswahl der Audioseite (wenn im SG eindeutig, dann 0x00; 0x01 für links; 0x02 für rechts) |
| ACTION | + | - | 0-n | high | unsigned char | - | TAB_CDM_AUDIO_CONTROL | - | - | - | - | - | Steuerbefehl |
...
| 0x023D08 | Codierung: Steuergerät ist nicht codiert | 0 | - |
| 0x023D09 | Codierung: Fehler bei Codierdatentransaktion aufgetreten | 0 | - |
| 0x023D0A | Codierung: Signatur der Codierdaten ungültig | 0 | - |
| 0x023D0B | Codierung: Codierdaten passen nicht zum Fahrzeug | 0 | - |
| 0x023D0C | Codierung: Unplausible Daten während Codierdatentransaktion | 0 | - |
| 0x02FF3D | Dummy-Fehlerspeichereintrag im Komponentenfehlerbereich nur für Testzwecke | 1 | - |
| 0x031A00 | Vorhang Seite rechts, Antrieb: Leitungsunterbrechung | 0 | - |
| 0x031A01 | Vorhang Seite rechts, Antrieb: Kurzschluss nach Minus | 0 | - |
| 0x031A02 | Vorhang Seite rechts, Antrieb: Kurzschluss nach Plus | 0 | - |
| 0x031A03 | Vorhang Seite rechts, Antrieb: Fehlfunktion | 0 | - |
| 0x031A04 | Vorhang Seite rechts, Antrieb: Spielschutz | 0 | - |
| 0x031A08 | Vorhang Seite rechts, Hallsensor offen: Kurzschluss nach Minus | 0 | - |
| 0x031A09 | Vorhang Seite rechts, Hallsensor offen: Kurzschluss nach Plus oder Unterbrechung | 0 | - |
| 0x031A0A | Vorhang Seite rechts, Hallsensor offen: Unplausibler Wert | 0 | - |
| 0x031A10 | Vorhang Seite rechts, Hallsensor geschlossen: Kurzschluss nach Minus | 0 | - |
| 0x031A11 | Vorhang Seite rechts, Hallsensor geschlossen: Kurzschluss nach Plus oder Unterbrechung | 0 | - |
| 0x031A12 | Vorhang Seite rechts, Hallsensor geschlossen: Unplausibler Wert | 0 | - |
...
| 0x031AFA | Audio rechts, Volume up Taste: Dauerbetätigung | 0 | - |
| 0x031AFB | Audio rechts, Volume down Taste: Dauerbetätigung | 0 | - |
| 0x807700 | Unterspannung erkannt | 1 | - |
| 0x807701 | Überspannung erkannt | 1 | - |
| 0x807702 | Interner Steuergerätefehler | 0 | - |
| 0xD84468 | BODY-CAN Control Module Bus OFF | 0 | - |
| 0xD84BFF | Dummy-Fehlerspeichereintrag im Netzwerkfehlerbereich nur für Testzwecke | 1 | - |
...
| RESULTNAME | STR | STPR | RRR | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_VOLUME_BUTTONS | - | - | + | 0-n | high | unsigned char | - | TAB_CDM_VOLUME_BUTTONS | - | - | - | Status Volume Buttons |
...
| CDM_AUDIO_CONTROL | 0xA135 | - | steuert die CDM Audiofunktion | - | - | - | - | - | - | - | - | - | 31 | ARG_0xA135_R | - |
| STATUS_VOLUME_BUTTONS | 0xA15C | - | gibt Status der Volume Buttons zurück | - | - | - | - | - | - | - | - | - | 31 | - | RES_0xA15C_R |
...
<a id="table-tab-cdm-audio-cont"></a>
### TAB_CDM_AUDIO_CONT
...
<a id="table-tab-cdm-audio-control"></a>
### TAB_CDM_AUDIO_CONTROL
...
<a id="table-tab-cdm-volume-buttons"></a>
### TAB_CDM_VOLUME_BUTTONS

Dimensions: 4 rows × 2 columns

| WERT | TEXT |
| --- | --- |
| 0x00 | no switch active |
| 0x01 | plus switch active |
| 0x02 | minus switch active |
| 0xFF | Wert ungültig |
