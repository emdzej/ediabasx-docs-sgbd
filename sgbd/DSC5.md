...
| Field | Value |
| --- | --- |
| ECU | Antiblockiersystem u. Dynamisches Stabilitaets Controll 5 E31,E38 |
...
- [INITIALISIERUNG](#job-initialisierung) - Init-Job fuer ABS_DSC5
- [IDENT](#job-ident) - Ident-Daten fuer ABS_DSC5
- [FS_LESEN](#job-fs-lesen) - Fehlerspeicher lesen fuer ABS_DSC5 High-Konzept nach Lastenheft Codierung/Diagnose
- [FS_LOESCHEN](#job-fs-loeschen) - Fehlerspeicher loeschen fuer ABS_DSC5
- [STATUS_IO_LESEN](#job-status-io-lesen) - Status Eingaenge ABS_DSC5
- [COD_LESEN](#job-cod-lesen) - Status Eingaenge ABS_DSC5
- [COD_SCHREIBEN](#job-cod-schreiben) - Status Eingaenge ABS_DSC5
- [DOWNLOAD_STELLGLIED](#job-download-stellglied) - Stellglied ansteuern ABS_DSC5
- [DOWNLOAD_D4_STELLGLIED](#job-download-d4-stellglied) - Stellglied ansteuern ABS_DSC5
- [DOWNLOAD_I_O_DIAGNOSE](#job-download-i-o-diagnose) - I/O-Diagnose ABS_DSC5
- [DOWNLOAD_FUEHLER_EINZELN](#job-download-fuehler-einzeln) - Ansprechschwelle u. Impulsrad ABS_DSC5
- [DOWNLOAD_DREHZHAL](#job-download-drehzhal) - Drehzahl
- [DOWNLOAD_STATISCH](#job-download-statisch) - Statischer Test der Komponenten ABS_DSC5
- [DOWNLOAD_FUEHLER_ALLE](#job-download-fuehler-alle) - Alle Ansprechschwellen u. Impulsraeder ABS_DSC5
- [DOWNLOAD_VAKUUM_LINIE](#job-download-vakuum-linie) - Befuelroutine in Fertigungslinie ABS_DSC5
- [DOWNLOAD_VAKUUM_REPAIR](#job-download-vakuum-repair) - Befuelroutine in Nacharbeit ABS_DSC5
- [DOWNLOAD_FS_RESET](#job-download-fs-reset) - Fehlerspeicher zuruecksetzen ABS_DSC5
- [TEST_D_STELLGLIED](#job-test-d-stellglied) - Digitale Stellglieder ansteuern ABS_DSC5
- [TEST_D4_STELLGLIED](#job-test-d4-stellglied) - Digitale Stellglieder ansteuern ABS_DSC5
- [TEST_ZUENDWINKEL](#job-test-zuendwinkel) - Digitale Stellglieder ansteuern ABS_DSC5
- [TEST_PUMPENLEISTUNG_VORNE](#job-test-pumpenleistung-vorne) - Test der Pumpenfoerderleistung ABS_DSC5
- [TEST_PUMPENLEISTUNG_HINTEN](#job-test-pumpenleistung-hinten) - Test der Pumpenfoerderleistung ABS_DSC5
- [TEST_A_STELLGLIED](#job-test-a-stellglied) - Fuellung ABS_DSC5
- [TEST_I_O_DIAGNOSE](#job-test-i-o-diagnose) - I/O-Diagnose
- [TEST_FUEHLER_EINZELN](#job-test-fuehler-einzeln) - Ansprechschwelle ABS_DSC5
- [TEST_FUEHLER_IMPULS](#job-test-fuehler-impuls) - Test Fuehler u. Impulsrad
- [TEST_DREHZAHL](#job-test-drehzahl) - Test Drehzhal
- [TEST_STATISCH](#job-test-statisch) - Statischer Test der Komponenten ABS_DSC5
- [TEST_FUEHLER_ALLE](#job-test-fuehler-alle) - Alle Ansprechschwellen u. Impulsraeder ABS_DSC5
- [TEST_VAKUUM_LINIE](#job-test-vakuum-linie) - Befuelroutine in Fertigungslinie ABS_DSC5
- [TEST_VAKUUM_REPAIR](#job-test-vakuum-repair) - Befuelroutine in Nacharbeit ABS_DSC5
- [TEST_FS_SCHREIBEN](#job-test-fs-schreiben) - Fehlerspeicher zuruecksetzen
- [TEST_LENKWINKEL](#job-test-lenkwinkel) - Lenkwinkel Initialisierung ABS_DSC5
...
| F_ART_ANZ | int | Anzahl der Fehlerarten bei ABS/DSC5 = 4 |
...
| STAT_AHK_EIN | int | 0 oder 1 |
| STAT_NORM_FUELLUNG_SOLL_WERT | int | Wert in % |
| STAT_NORM_FUELLUNG_EINH | string | Einheit = % |
...
| STAT_LENKWINKEL_WERT | int | Lenkwinekl in Grad, kann + u.- Wert haben |
| STAT_LENKWINKEL_EINH | string | Einheit = Winkelgrad |
| STAT_NORM_FUELLUNG_FAHRER_WERT | int | Wert in % |
| _AUFTRAG1 | binary | Anforderungstelegramm |
| _ANTWORT1 | binary | Antworttelegramm |
...
| --- | --- | --- |
| JOB_STATUS | string | Status der Kommunikation (z.B. ACK) |
| GESCHW_MIN | long | Radgeschwindigkeit bei Beginn d. Tests |
| GESCHW_MAX | long | Radgeschwindigkeit waehrend Test |
| GESCHW_EINH | string | Einheit = km/h |
| V_SPRUNG | long | Geschwindigkeitssprung |
| V_ZAEHLER | int | Anzahl |
| _AUFTRAG1 | binary | Anforderungstelegramm |
| _ANTWORT1 | binary | Antworttelegramm |
| _AUFTRAG2 | binary | Anforderungstelegramm |
| _ANTWORT2 | binary | Antworttelegramm |
