...
| REVISION | 2.01 |
| AUTHOR | BMW EE-412 Maack, BMW TI-431 Rochal, BMW TI-431 Krueger, ALPINE AOEUR Nordalm, EUROSPACE EE-41 Carre |
| COMMENT | Flash-Jobs werden vom CDC E65 nicht unterstützt |
| PACKAGE | 1.23 |
| SPRACHE | deutsch |
...
| 0xD80E | Obwohl Shutdown(Execute) geschickt wurde ging das Licht nicht aus. (Error_Light_Not_Off). |
