...
| Name | Type | Comment |
| --- | --- | --- |
| STAT_ZK1_AKTIV | int | 0=ZK1_NICHT_AKTIV 1=ZK1_AKTIV Gurtkraftbegrenzer vorne links |
...
| 0x9831 | Timeout ID 05H (SBSL) |
| 0x9832 | Timeout ID 06H (SASL) |
| 0x9833 | Timeout ID 07H (SBSR) |
| 0x9834 | Timeout ID 08H (SASR) |
| 0x9835 | Timeout ID 09H (SFZ) |
| 0x9836 | Timeout ID 0AH (SIM) |
| 0x9837 | Timeout ID 0BH (SASL) |
| 0x9838 | Timeout ID 0CH (SASR) |
| 0x9839 | Timeout ID 0DH (SFZ) |
| 0x983a | Timeout ID 0EH |
| 0x983b | Timeout ID 0FH |
| 0x983c | Timeout ID 20H (SSFA) |
| 0x983d | Timeout ID 21H (SSBF) |
| 0x983e | Timeout ID 22H (SSH) |
| 0x983f | Timeout ID 71H (SIM) |
| 0x9840 | Codierdaten Checksummenfehler |
| 0x9841 | Stack Overflow |
...
| 0x984e | Zuendkapazitaet ZK1 n.i.O. |
...
| 0x9859 | Zuendkapazitaet ZK2 n.i.O. |
| 0x985a | Codierung/Konfiguration ZK2 unstimmig |
| 0x985b | Unterbrechung Entladekreis ZK2 |
| 0x985c | Fehler Beschleunigungssensor:Offset zu gross |
| 0x985d | Fehler Beschleunigungssensor:Selbsttestwert zu gross |
| 0x985e | Fehler Beschleunigungssensor:Selbsttestwert zu klein |
| 0x985f | Statusfehler Beschleunigungssensor |
| 0x9860 | Fehler im Alarmpfad |
| 0x9861 | Algorithmus-Parameter inkonsistent |
| 0x9862 | EAM-Parameter inkonsistent |
| 0x9863 | Zuendversuch erfolgt |
| 0x9864 | COP-Watchdog fehlerhaft |
| 0x9871 | Kurzschluss oder Unterbrechung Low-Side-Schalter ZK1 |
| 0x9872 | Kurzschluss oder Unterbrechung High-Side-Schalter ZK1 |
| 0x9873 | Kurzschluss oder Unterbrechung Low-Side-Schalter ZK2 |
| 0x9874 | Kurzschluss oder Unterbrechung High-Side-Schalter ZK2 |
| 0x9875 | Kommunikation mit Zuend-IC gestoert |
| 0x9876 | Spannungsueberwachung ASE unterer Grenzwert unterschritten |
| 0x9877 | Spannungsueberwachung ASE oberer Grenzwert ueberschritten |
| 0x9878 | Energiesparmode aktiv |
| 0x9879 | Codierung unvollstaendig |
...
| ORT | ORTTEXT |
| --- | --- |
| 0x9868 | Power-On-Reset uP |
| 0x9869 | Diagnose S/E-Modul (Lichtleistung) |
| 0x986a | SI-Bus: Uebertragungsfehler, CRC-Fehler ERRIF |
| 0x986b | SI-Bus: Uebertragungsfehler, Formatfehler ILLPIF |
| 0x986c | SI-Bus: Synchronisierungspuls zu frueh SYNEIF |
| 0x986d | SI-Bus: Synchronisierung verloren SYNLIF |
| 0x986e | SI-Bus: Slotmismatch, Timingfehler SLMMIF |
| 0x986f | SI-Bus: FIFO-Ueberlauf OVRNIF |
| 0x9870 | EMV-Fehler im Zuend-Ic |
| 0x???? | unbekannter Fehlerort |
