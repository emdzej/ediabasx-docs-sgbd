...
| --- | --- |
| ECU | PGS E_65_2  |
| ORIGIN | BMW EE-51 Wolfgang Schmidbauer |
| REVISION | 4.000 |
| AUTHOR | Wolfgang Schmidbauer Mikhail, Vaisman Boris Palamari, Siemens SV C, CE CS6 SW |
...
- [IODIGITALSIGNALEFUERSCHREIBEN](#table-iodigitalsignalefuerschreiben) (13 × 3)
...
| ORT | ORTTEXT |
| --- | --- |
| 0xD2C4 | K_CAN_Line_Failure |
| 0xD2C5 | K_CAN_Line_Failure |
| 0xD2C6 | GroundShift |
...
| 0xA06C | Kofferraumantenne_rechts_defekt |
| 0xA06D | Kofferraumantenne_links_defekt |
...
| 0xA088 | TAGE_FAT_Watchdog_Reset |
| 0xA089 | TAGE_FAT_Watchdog_Timer |
| 0xA08A | TAGE_FAT_Abic_reagiert_nicht |
| 0xA08B | TAGE_FAT_Ubat_ausserhalb_ULF |
| 0xA08C | TAGE_FAT_Antennen_defekt |
| 0xA08D | TAGE_FAT_Timeout_Kap_Sensor |
| 0xA08E | TAGE_FAT_Timeout_Dru_Sensor |
| 0xA08F | TAGE_FAT_Timeout_Zug_Sensor |
| 0xA090 | TAGE_FAT_Spielschutz_aktiv |
| 0xA091 | TAGE_FAT_Checksum_EEPROM |
| 0xA092 | TAGE_FAT_Checksum_ROM |
| 0xA093 | TAGE_FAT_Interrupt_unused |
| 0xA094 | TAGE_FAT_ErrorCode_unknown |
| 0xA095 | TAGE_FAT_Coding_TimeoutKBus |
| 0xA096 | TAGE_FAT_WUP_falsche_Antwort |
| 0xA097 | TAGE_FAT_WUP_keine_Antwort |
| 0xA098 | TAGE_HILI_Watchdog_Reset |
| 0xA099 | TAGE_HILI_Watchdog_Timer |
| 0xA09A | TAGE_HILI_Abic_reagiert_nicht |
| 0xA09B | TAGE_HILI_Ubat_ausserhalb_ULF |
| 0xA09C | TAGE_HILI_Antennen_defekt |
| 0xA09D | TAGE_HILI_Timeout_Kap_Sensor |
| 0xA09E | TAGE_HILI_Timeout_Dru_Sensor |
| 0xA09F | TAGE_HILI_Timeout_Zug_Sensor |
| 0xA0A0 | TAGE_HILI_Spielschutz_aktiv |
| 0xA0A1 | TAGE_HILI_Checksum_EEPROM |
| 0xA0A2 | TAGE_HILI_Checksum_ROM |
| 0xA0A3 | TAGE_HILI_Interrupt_unused |
| 0xA0A4 | TAGE_HILI_ErrorCode_unknown |
| 0xA0A5 | TAGE_HILI_Coding_TimeoutKBus |
| 0xA0A6 | TAGE_BFT_WUP_falsche_Antwort |
| 0xA0A7 | TAGE_BFT_WUP_keine_Antwort |
| 0xA0A8 | TAGE_BFT_Watchdog_Reset |
| 0xA0A9 | TAGE_BFT_Watchdog_Timer |
| 0xA0AA | TAGE_BFT_Abic_reagiert_nicht |
| 0xA0AB | TAGE_BFT_Ubat_ausserhalb_ULF |
| 0xA0AC | TAGE_BFT_Antennen_defekt |
| 0xA0AD | TAGE_BFT_Timeout_Kap_Sensor |
| 0xA0AE | TAGE_BFT_Timeout_Dru_Sensor |
| 0xA0AF | TAGE_BFT_Timeout_Zug_Sensor |
| 0xA0B0 | TAGE_BFT_Spielschutz_aktiv |
| 0xA0B1 | TAGE_BFT_Checksum_EEPROM |
| 0xA0B2 | TAGE_BFT_Checksum_ROM |
| 0xA0B3 | TAGE_BFT_Interrupt_unused |
| 0xA0B4 | TAGE_BFT_ErrorCode_unknown |
| 0xA0B5 | TAGE_BFT_Coding_TimeoutKBus |
| 0xA0B6 | TAGE_HILI_WUP_falsche_Antwort |
| 0xA0B7 | TAGE_HILI_WUP_keine_Antwort |
| 0xA0B8 | TAGE_HIRE_Watchdog_Reset |
| 0xA0B9 | TAGE_HIRE_Watchdog_Timer |
| 0xA0BA | TAGE_HIRE_Abic_reagiert_nicht |
| 0xA0BB | TAGE_HIRE_Ubat_ausserhalb_ULF |
| 0xA0BC | TAGE_HIRE_Antennen_defekt |
| 0xA0BD | TAGE_HIRE_Timeout_Kap_Sensor |
| 0xA0BE | TAGE_HIRE_Timeout_Dru_Sensor |
| 0xA0BF | TAGE_HIRE_Timeout_Zug_Sensor |
| 0xA0C0 | TAGE_HIRE_Spielschutz_aktiv |
| 0xA0C1 | TAGE_HIRE_Checksum_EEPROM |
| 0xA0C2 | TAGE_HIRE_Checksum_ROM |
| 0xA0C3 | TAGE_HIRE_Interrupt_unused |
| 0xA0C4 | TAGE_HIRE_ErrorCode_unknown |
| 0xA0C5 | TAGE_HIRE_Coding_TimeoutKBus |
| 0xA0C6 | TAGE_HIRE_WUP_falsche_Antwort |
| 0xA0C7 | TAGE_HIRE_WUP_keine_Antwort |
