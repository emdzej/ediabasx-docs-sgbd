...
| REVISION | 1.005 |
| AUTHOR | Eurospace EI-42 Kuppe, Eurospace EI-42 Mazzawi |
| COMMENT | SGBD fuer E70 Kombi |
| PACKAGE | 1.31 |
| SPRACHE | deutsch |
...
- [STEUERN_TESTBITMAP](#job-steuern-testbitmap) - Testbitmap im Display darstellen KWP2000: $30 InputOutputControlByLocalIdentifier NUR bei KL.30 ausfuehren! Ansonsten Aktivierung der Ganganzeigenueberwachung.
...
- [STATUS_TANKGROESSE](#job-status-tankgroesse) - Groesse des Tank ermitteln.
- [_I320_UIF_KORREKTUR](#job-i320-uif-korrektur) - UIF auf 0x01 korrigieren HINWEIS: Entwicklerjob - Verwendung auf eigene Gefahr!
...
- [_DIMM_KENNL_SCHREIBEN](#job-dimm-kennl-schreiben) - Dimmungs-manipulieren und Steuergeraete Reset ausloesen Uhrzeit und Datum bleibt dabei im Kombi erhalten Nur Kombi E70, I-330 bis I-450 HINWEIS: Entwicklerjob - Verwendung auf eigene Gefahr!
- [KOMBISELBSTTEST_HSAG](#job-kombiselbsttest-hsag) - 1. Flips the coding from Automatic Gear to Manual 2. Reload is applied (Reset wihtout Time) 3. Kombi-Self-Test is applied 4. Flips the coding from Manual Gear to Automatic 4. Reload is applied (Reset wihtout Time) HINWEIS: Entwicklerjob - Verwendung auf eigene Gefahr!
...
Testbitmap im Display darstellen KWP2000: $30 InputOutputControlByLocalIdentifier NUR bei KL.30 ausfuehren! Ansonsten Aktivierung der Ganganzeigenueberwachung.
...
<a id="job-restore-pia-default"></a>
### RESTORE_PIA_DEFAULT
...
<a id="job-status-tankgroesse"></a>
### STATUS_TANKGROESSE

Groesse des Tank ermitteln.
...
| Name | Type | Comment |
| --- | --- | --- |
| STAT_TANK | int | Groesse des Tanks in Litern. |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| _TEL_ANTWORT | binary | Antwort von SG |

<a id="job-i320-uif-korrektur"></a>
### _I320_UIF_KORREKTUR

UIF auf 0x01 korrigieren HINWEIS: Entwicklerjob - Verwendung auf eigene Gefahr!
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| _TEL_ANTWORT | binary | Antwort 1 von SG |
| _TEL_ANTWORT2 | binary | Antwort 2 von SG |
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_ANZAHL_WERT | int | Anahl der CC-IDs im Historyspeicher |
| STAT_GWSZ_STAND_EINH | string | Einheit des GWSZ-Standes HINWEIS: immer km |
| STAT_CC_ID_1 | int | ID der CC-Meldung |
| STAT_GWSZ_STAND_WERT_1 | unsigned long | Kilometerstand beim Auftreten der CC-Meldung Aufloesung: 8km HINWEIS: als Wert wird maximal 524280 ausgegeben. |
| STAT_CC_ID_2 | int | ID der CC-Meldung |
| STAT_GWSZ_STAND_WERT_2 | unsigned long | Kilometerstand beim Auftreten der CC-Meldung Aufloesung: 8km HINWEIS: als Wert wird maximal 524280 ausgegeben. |
| STAT_CC_ID_3 | int | ID der CC-Meldung |
| STAT_GWSZ_STAND_WERT_3 | unsigned long | Kilometerstand beim Auftreten der CC-Meldung Aufloesung: 8km HINWEIS: als Wert wird maximal 524280 ausgegeben. |
| STAT_CC_ID_4 | int | ID der CC-Meldung |
| STAT_GWSZ_STAND_WERT_4 | unsigned long | Kilometerstand beim Auftreten der CC-Meldung Aufloesung: 8km HINWEIS: als Wert wird maximal 524280 ausgegeben. |
| STAT_CC_ID_5 | int | ID der CC-Meldung |
| STAT_GWSZ_STAND_WERT_5 | unsigned long | Kilometerstand beim Auftreten der CC-Meldung Aufloesung: 8km HINWEIS: als Wert wird maximal 524280 ausgegeben. |
| STAT_CC_ID_6 | int | ID der CC-Meldung |
| STAT_GWSZ_STAND_WERT_6 | unsigned long | Kilometerstand beim Auftreten der CC-Meldung Aufloesung: 8km HINWEIS: als Wert wird maximal 524280 ausgegeben. |
| STAT_CC_ID_7 | int | ID der CC-Meldung |
| STAT_GWSZ_STAND_WERT_7 | unsigned long | Kilometerstand beim Auftreten der CC-Meldung Aufloesung: 8km HINWEIS: als Wert wird maximal 524280 ausgegeben. |
| STAT_CC_ID_8 | int | ID der CC-Meldung |
| STAT_GWSZ_STAND_WERT_8 | unsigned long | Kilometerstand beim Auftreten der CC-Meldung Aufloesung: 8km HINWEIS: als Wert wird maximal 524280 ausgegeben. |
| STAT_CC_ID_9 | int | ID der CC-Meldung |
| STAT_GWSZ_STAND_WERT_9 | unsigned long | Kilometerstand beim Auftreten der CC-Meldung Aufloesung: 8km HINWEIS: als Wert wird maximal 524280 ausgegeben. |
| STAT_CC_ID_10 | int | ID der CC-Meldung |
| STAT_GWSZ_STAND_WERT_10 | unsigned long | Kilometerstand beim Auftreten der CC-Meldung Aufloesung: 8km HINWEIS: als Wert wird maximal 524280 ausgegeben. |
| STAT_CC_ID_11 | int | ID der CC-Meldung |
| STAT_GWSZ_STAND_WERT_11 | unsigned long | Kilometerstand beim Auftreten der CC-Meldung Aufloesung: 8km HINWEIS: als Wert wird maximal 524280 ausgegeben. |
| STAT_CC_ID_12 | int | ID der CC-Meldung |
| STAT_GWSZ_STAND_WERT_12 | unsigned long | Kilometerstand beim Auftreten der CC-Meldung Aufloesung: 8km HINWEIS: als Wert wird maximal 524280 ausgegeben. |
| STAT_CC_ID_13 | int | ID der CC-Meldung |
| STAT_GWSZ_STAND_WERT_13 | unsigned long | Kilometerstand beim Auftreten der CC-Meldung Aufloesung: 8km HINWEIS: als Wert wird maximal 524280 ausgegeben. |
| STAT_CC_ID_14 | int | ID der CC-Meldung |
| STAT_GWSZ_STAND_WERT_14 | unsigned long | Kilometerstand beim Auftreten der CC-Meldung Aufloesung: 8km HINWEIS: als Wert wird maximal 524280 ausgegeben. |
| STAT_CC_ID_15 | int | ID der CC-Meldung |
| STAT_GWSZ_STAND_WERT_15 | unsigned long | Kilometerstand beim Auftreten der CC-Meldung Aufloesung: 8km HINWEIS: als Wert wird maximal 524280 ausgegeben. |
| STAT_CC_ID_16 | int | ID der CC-Meldung |
| STAT_GWSZ_STAND_WERT_16 | unsigned long | Kilometerstand beim Auftreten der CC-Meldung Aufloesung: 8km HINWEIS: als Wert wird maximal 524280 ausgegeben. |
| STAT_CC_ID_17 | int | ID der CC-Meldung |
| STAT_GWSZ_STAND_WERT_17 | unsigned long | Kilometerstand beim Auftreten der CC-Meldung Aufloesung: 8km HINWEIS: als Wert wird maximal 524280 ausgegeben. |
| STAT_CC_ID_18 | int | ID der CC-Meldung |
| STAT_GWSZ_STAND_WERT_18 | unsigned long | Kilometerstand beim Auftreten der CC-Meldung Aufloesung: 8km HINWEIS: als Wert wird maximal 524280 ausgegeben. |
| STAT_CC_ID_19 | int | ID der CC-Meldung |
| STAT_GWSZ_STAND_WERT_19 | unsigned long | Kilometerstand beim Auftreten der CC-Meldung Aufloesung: 8km HINWEIS: als Wert wird maximal 524280 ausgegeben. |
| STAT_CC_ID_20 | int | ID der CC-Meldung |
| STAT_GWSZ_STAND_WERT_20 | unsigned long | Kilometerstand beim Auftreten der CC-Meldung Aufloesung: 8km HINWEIS: als Wert wird maximal 524280 ausgegeben. |
| STAT_CC_ID_21 | int | ID der CC-Meldung |
| STAT_GWSZ_STAND_WERT_21 | unsigned long | Kilometerstand beim Auftreten der CC-Meldung Aufloesung: 8km HINWEIS: als Wert wird maximal 524280 ausgegeben. |
| STAT_CC_ID_22 | int | ID der CC-Meldung |
| STAT_GWSZ_STAND_WERT_22 | unsigned long | Kilometerstand beim Auftreten der CC-Meldung Aufloesung: 8km HINWEIS: als Wert wird maximal 524280 ausgegeben. |
| STAT_CC_ID_23 | int | ID der CC-Meldung |
| STAT_GWSZ_STAND_WERT_23 | unsigned long | Kilometerstand beim Auftreten der CC-Meldung Aufloesung: 8km HINWEIS: als Wert wird maximal 524280 ausgegeben. |
| STAT_CC_ID_24 | int | ID der CC-Meldung |
| STAT_GWSZ_STAND_WERT_24 | unsigned long | Kilometerstand beim Auftreten der CC-Meldung Aufloesung: 8km HINWEIS: als Wert wird maximal 524280 ausgegeben. |
| STAT_CC_ID_25 | int | ID der CC-Meldung |
| STAT_GWSZ_STAND_WERT_25 | unsigned long | Kilometerstand beim Auftreten der CC-Meldung Aufloesung: 8km HINWEIS: als Wert wird maximal 524280 ausgegeben. |
| STAT_CC_ID_26 | int | ID der CC-Meldung |
| STAT_GWSZ_STAND_WERT_26 | unsigned long | Kilometerstand beim Auftreten der CC-Meldung Aufloesung: 8km HINWEIS: als Wert wird maximal 524280 ausgegeben. |
| STAT_CC_ID_27 | int | ID der CC-Meldung |
| STAT_GWSZ_STAND_WERT_27 | unsigned long | Kilometerstand beim Auftreten der CC-Meldung Aufloesung: 8km HINWEIS: als Wert wird maximal 524280 ausgegeben. |
| STAT_CC_ID_28 | int | ID der CC-Meldung |
| STAT_GWSZ_STAND_WERT_28 | unsigned long | Kilometerstand beim Auftreten der CC-Meldung Aufloesung: 8km HINWEIS: als Wert wird maximal 524280 ausgegeben. |
| STAT_CC_ID_29 | int | ID der CC-Meldung |
| STAT_GWSZ_STAND_WERT_29 | unsigned long | Kilometerstand beim Auftreten der CC-Meldung Aufloesung: 8km HINWEIS: als Wert wird maximal 524280 ausgegeben. |
| STAT_CC_ID_30 | int | ID der CC-Meldung |
| STAT_GWSZ_STAND_WERT_30 | unsigned long | Kilometerstand beim Auftreten der CC-Meldung Aufloesung: 8km HINWEIS: als Wert wird maximal 524280 ausgegeben. |
| STAT_CC_ID_31 | int | ID der CC-Meldung |
| STAT_GWSZ_STAND_WERT_31 | unsigned long | Kilometerstand beim Auftreten der CC-Meldung Aufloesung: 8km HINWEIS: als Wert wird maximal 524280 ausgegeben. |
| STAT_CC_ID_32 | int | ID der CC-Meldung |
| STAT_GWSZ_STAND_WERT_32 | unsigned long | Kilometerstand beim Auftreten der CC-Meldung Aufloesung: 8km HINWEIS: als Wert wird maximal 524280 ausgegeben. |
| STAT_CC_ID_33 | int | ID der CC-Meldung |
| STAT_GWSZ_STAND_WERT_33 | unsigned long | Kilometerstand beim Auftreten der CC-Meldung Aufloesung: 8km HINWEIS: als Wert wird maximal 524280 ausgegeben. |
| STAT_CC_ID_34 | int | ID der CC-Meldung |
| STAT_GWSZ_STAND_WERT_34 | unsigned long | Kilometerstand beim Auftreten der CC-Meldung Aufloesung: 8km HINWEIS: als Wert wird maximal 524280 ausgegeben. |
| STAT_CC_ID_35 | int | ID der CC-Meldung |
| STAT_GWSZ_STAND_WERT_35 | unsigned long | Kilometerstand beim Auftreten der CC-Meldung Aufloesung: 8km HINWEIS: als Wert wird maximal 524280 ausgegeben. |
| STAT_CC_ID_36 | int | ID der CC-Meldung |
| STAT_GWSZ_STAND_WERT_36 | unsigned long | Kilometerstand beim Auftreten der CC-Meldung Aufloesung: 8km HINWEIS: als Wert wird maximal 524280 ausgegeben. |
| STAT_CC_ID_37 | int | ID der CC-Meldung |
| STAT_GWSZ_STAND_WERT_37 | unsigned long | Kilometerstand beim Auftreten der CC-Meldung Aufloesung: 8km HINWEIS: als Wert wird maximal 524280 ausgegeben. |
| STAT_CC_ID_38 | int | ID der CC-Meldung |
| STAT_GWSZ_STAND_WERT_38 | unsigned long | Kilometerstand beim Auftreten der CC-Meldung Aufloesung: 8km HINWEIS: als Wert wird maximal 524280 ausgegeben. |
| STAT_CC_ID_39 | int | ID der CC-Meldung |
| STAT_GWSZ_STAND_WERT_39 | unsigned long | Kilometerstand beim Auftreten der CC-Meldung Aufloesung: 8km HINWEIS: als Wert wird maximal 524280 ausgegeben. |
| STAT_CC_ID_40 | int | ID der CC-Meldung |
| STAT_GWSZ_STAND_WERT_40 | unsigned long | Kilometerstand beim Auftreten der CC-Meldung Aufloesung: 8km HINWEIS: als Wert wird maximal 524280 ausgegeben. |
| STAT_CC_ID_41 | int | ID der CC-Meldung |
| STAT_GWSZ_STAND_WERT_41 | unsigned long | Kilometerstand beim Auftreten der CC-Meldung Aufloesung: 8km HINWEIS: als Wert wird maximal 524280 ausgegeben. |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
<a id="job-dimm-kennl-schreiben"></a>
### _DIMM_KENNL_SCHREIBEN

Dimmungs-manipulieren und Steuergeraete Reset ausloesen Uhrzeit und Datum bleibt dabei im Kombi erhalten Nur Kombi E70, I-330 bis I-450 HINWEIS: Entwicklerjob - Verwendung auf eigene Gefahr!
...
<a id="job-kombiselbsttest-hsag"></a>
### KOMBISELBSTTEST_HSAG

1. Flips the coding from Automatic Gear to Manual 2. Reload is applied (Reset wihtout Time) 3. Kombi-Self-Test is applied 4. Flips the coding from Manual Gear to Automatic 4. Reload is applied (Reset wihtout Time) HINWEIS: Entwicklerjob - Verwendung auf eigene Gefahr!
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei |
| _TEL_ANTWORT1 | binary | Antwort 1 von SG |
| EEPBLOCK | binary | Block 0x3003 lesen |
| EEPSCHREIB | binary | Schreiben block |
...
- [AL_ID_LST](#table-al-id-lst) (4 × 2)
- [AL_ID_SARS_LST](#table-al-id-sars-lst) (8 × 2)
- [AL_ID_KO_LST](#table-al-id-ko-lst) (16 × 2)
- [AL_ID_CS_LST](#table-al-id-cs-lst) (16 × 2)
...
| 0x05 | keine ID |
| 0x06 | ALIVE Fehler Sicherheitssystem |
| 0x07 | keine ID |
| xy | Eintrag unplausibel |
