...
| 0x9aad | Timeout ID 01H (STVL) |
| 0x9aae | Timeout ID 02H |
| 0x9aaf | Timeout ID 03H (STVR) |
| 0x9ab0 | Timeout ID 04H |
| 0x9ab1 | Timeout ID 05H (SBSL) |
| 0x9ab2 | Timeout ID 06H (SASL) |
| 0x9ab3 | Timeout ID 07H (SBSR) |
| 0x9ab4 | Timeout ID 08H (SASR) |
| 0x9ab5 | Timeout ID 09H (SFZ) |
| 0x9ab6 | Timeout ID 0AH (SIM) |
| 0x9ab7 | Timeout ID 0BH (SASL) |
| 0x9ab8 | Timeout ID 0CH (SASR) |
| 0x9ab9 | Timeout ID 0DH (SFZ) |
| 0x9aba | Timeout ID 0EH |
| 0x9abb | Timeout ID 0FH |
| 0x9abc | Timeout ID 20H (SSFA) |
| 0x9abd | Timeout ID 21H (SSBF) |
| 0x9abe | Timeout ID 22H (SSH) |
| 0x9abf | Timeout ID 71H (SIM) |
| 0x9ac0 | Codierdaten Checksummenfehler |
| 0x9ac1 | Stack Overflow |
...
| 0x9af0 | Energiesparmode aktiv |
| 0x9af1 | Spannungsueberwachung ASE unterer Grenzwert unterschritten |
| 0x9af2 | Spannungsueberwachung ASE oberer Grenzwert ueberschritten |
| 0x9af3 | Codierung unvollstaendig |
