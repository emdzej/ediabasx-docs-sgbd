...
| COMMENT | SGBD fuer Powermodul E65 |
| PACKAGE | 1.21 |
| SPRACHE | deutsch |
...
- [STATUS_BATTERIEKALIBRIERUNGSWERTE](#job-status-batteriekalibrierungswerte) - Auslesen der Batteriekalibrierungswerte *********************************************************** *** Aufgrund einer geaenderten Batteriekalibriermethode *** ***          ist der Job nicht mehr gueltig !!!         *** *********************************************************** KWP2000: $21 ReadDataByLocalIdentifier $24 RecordLocalIdentifier (Identifier value defined by system designer)
...
- [STEUERN_AUSGANG_AUSSCHALTEN](#job-steuern-ausgang-ausschalten) - Ausschalten der Powermodulausgaenge KL30, HHS, KL15, KLR, VAK, VAD oder LM ACHTUNG: Ausgang IB kann nur getoggelt werden, hierfuer bitte den Job STEUERN_AUSGANG_EINSCHALTEN_BZW_TOGGELN verwenden KWP2000: $30 InputOutputControlByLocalIdentifier $XX InputOutputLocalIdentifier des entsprechenden Ausgangs $07 ShortTermAdjustment
- [STEUERN_AUSGANG_EINSCHALTEN_BZW_TOGGELN](#job-steuern-ausgang-einschalten-bzw-toggeln) - Einschalten der Powermodulausgaenge KL30, HHS, KL15, KLR, VAK, VAD, TKLM_E, TKLM_V, HKLM, SCAM_OT, SCAM_UT oder LM bzw. Toggeln des Ausgangs IB KWP2000: $30 InputOutputControlByLocalIdentifier $XX InputOutputLocalIdentifier des entsprechenden Ausgangs $07 ShortTermAdjustment
- [STEUERN_AUSGANG_RETURN_CONTROL](#job-steuern-ausgang-return-control) - Rueckgabe der Kontrolle ueber den Powermodulausgang KL30, HHS, KL15, KLR, VAK, VAD, IB, TKLM_E, TKLM_V, HKLM, SCAM_OT, SCAM_UT oder LM KWP2000: $30 InputOutputControlByLocalIdentifier $XX InputOutputLocalIdentifier des entsprechenden Ausgangs $00 ReturnControlToECU
...
- [STEUERN_MESSEMODE](#job-steuern-messemode) - Messemodus aktivieren/deaktivieren KWP2000: $3B WriteDataByLocalIdentifier $03 recordLocalIdentifier (Ruhestromueberwachung) $XX ein oder aus
- [STATUS_RESETZAEHLER](#job-status-resetzaehler) - Auslesen des Reset-Zaehlers (Adresse $0F00) KWP 2000: $23 ReadMemoryByAddress seg = 00 adr = 0xF00 anz = 1 Modus   : Default
- [CHECK_CODIERDATEN](#job-check-codierdaten) - Codierdaten anhand der Checksumme ueberprufen KWP2000: $22   ReadDataByCommonIdentifier $3000 Codierdaten Modus  : Default KWP2000: $23   ReadMemoryByAddress $0E41 Adresse der Checksumme der Codierdaten
...
<a id="job-status-batteriekalibrierungswerte"></a>
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_BATTERIE_LADUNGSZUSTAND_KAL_WERT | real | Ladungszustand der Batterie bei letzter Kalibrierung *** Aufgrund einer geaenderten Batteriekalibriermethode *** ***       wird der Wert nicht mehr berechnet !!!        *** Bereich: 0 bis 11930,46471 Ah (wird vom SG als u32 in der Einheit [10mA*s] uebergeben) |
| STAT_BATTERIE_LADUNGSZUSTAND_KAL_EINH | string | Ah |
| STAT_BATTERIESPANNUNG_KAL_WERT | real | Batteriespannung bei letzter Kalibrierung *** Aufgrund einer geaenderten Batteriekalibriermethode *** ***       wird der Wert nicht mehr berechnet !!!        *** Bereich: 0 bis 65,535 V |
| STAT_BATTERIESPANNUNG_KAL_EINH | string | Volt |
| STAT_BATTERIESTROM_KAL_WERT | real | Batteriestrom bei letzter Kalibrierung *** Aufgrund einer geaenderten Batteriekalibriermethode *** ***       wird der Wert nicht mehr berechnet !!!        *** Bereich: -21474836,48 A bis 21474836,47 A |
| STAT_BATTERIESTROM_KAL_EINH | string | Ampere |
| STAT_BATTERIETEMPERATUR_KAL_WERT | int | Batterietemperatur bei letzter Kalibrierung *** Aufgrund einer geaenderten Batteriekalibriermethode *** ***       wird der Wert nicht mehr berechnet !!!        *** Bereich: -128 bis 127 [°C] |
| STAT_BATTERIETEMPERATUR_KAL_EINH | string | Grad C |
| STAT_KILOMETERSTAND_KAL_WERT | long | Kilometerstand bei letzter Kalibrierung *** Aufgrund einer geaenderten Batteriekalibriermethode *** ***       wird der Wert nicht mehr berechnet !!!        *** Wertebereich: 0 - 524280 km |
| STAT_KILOMETERSTAND_KAL_EINH | string | km |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| STAT_U_GENERATOR_SOLL_WERT | real | Generatorsollspannung Bereich: 0 bis 65,535 V |
| STAT_U_EINH | string | Volt |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| AUSGANG_LOCAL_ID | string | InputOutputLocalIdentifier des gewaehlten Ausgangs als Hex-String Werte: 0x10 (=KL30), 0x11 (=HHS), 0x12 (=KL15), 0x13 (=KLR), 0x14 (=VAK), 0x15 (=VAD), 0x1C (=LM) table PowermodulAusgaenge WERT |
...
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| AUSGANG | string | Name des gewaehlten Ausgangs table PowermodulAusgaenge TEXT |
| AUSGANG_LOCAL_ID | string | InputOutputLocalIdentifier des gewaehlten Ausgangs als Hex-String Werte: 0x10 (=KL30), 0x11 (=HHS), 0x12 (=KL15), 0x13 (=KLR), 0x14 (=VAK), 0x15 (=VAD), 0x16 (=IB), 0x17 (=TKLM_E), 0x18 (=TKLM_V), 0x19 (=HKLM), 0x1A (=SCAM_OT), 0x1B (=SCAM_UT), 0x1C (=LM) table PowermodulAusgaenge WERT |
| SOLLWERT | string | Eingestellter Wert table DigitalArgument TEXT |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| Name | Type | Comment |
| --- | --- | --- |
| STAT_RESETZAEHLER_WERT | int | ausgelesener Resetzaehler 0 - 255, ohne Anschlag, d.h. nach 255 geht es bei 0 weiter |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |

<a id="job-check-codierdaten"></a>
### CHECK_CODIERDATEN
...
| Name | Type | Comment |
| --- | --- | --- |
| CHECKSUM | string | OKAY, wenn fehlerfrei, WRONG, wenn n.i.O. |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
- [FUMWELTMATRIX](#table-fumweltmatrix) (28 × 5)
...
- [POWERMODULAUSGAENGE](#table-powermodulausgaenge) (26 × 2)
- [HELLAFEHLERCODETEXTE](#table-hellafehlercodetexte) (52 × 4)
