...
| Field | Value |
| --- | --- |
| ECU | Zentrale Bedieneinheit |
| ORIGIN | BMW EI-823 Andreas_Oellinger |
| REVISION | 1.000 |
| AUTHOR | BMW EI-513 Oellinger, OSB-AG EI-513 Schulert, MARQUARDT-GMBH EI |
| COMMENT | - |
| PACKAGE | 1.62 |
| SPRACHE | deutsch |
...
- [RES_0XD136_D](#table-res-0xd136-d) (1 × 10)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| MODUS | 0/1 | high | unsigned char | - | - | - | - | - | - | - | MODUS: Wert egal, nur Dummywert |

<a id="table-arg-0x4210-d"></a>
### ARG_0X4210_D
...
| ARG | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | MIN | MAX | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| HELLIGKEIT | % | high | unsigned char | - | - | 2.53 | 1.0 | 0.0 | 0.0 | 100.0 | Auszugebender Wert in % |
...
| 0xE2C468 | BODY- oder IuK-CAN Control Module Bus OFF | 0 |
...
| ORT | ORTTEXT | EREIGNIS_DTC |
| --- | --- | --- |
| 0x80140D | Botschaft (Fahrzeugzustand, 0x3A0) fehlt | 1 |
| 0x80140E | Signal (Zeit_Sekunde_Zaehler_Relativ, 0x328): ungültig | 1 |
| 0x80140F | Fehler konnte nach maximaler Anzahl von Versuchen nicht gesendet werden | 1 |
| 0x801410 | Puffer für ausgehende Fehlermeldungen ist voll | 1 |
| 0x80142A | Fehler beim Schreiben von NvM Daten | 0 |
| 0x80142B | Fehler beim Lesen von NvM Daten | 0 |
| 0x80142C | Interner NvM Fehler | 0 |
| 0x80142D | Fehler beim Löschen von NvM Daten | 0 |
| 0x80142E | Fehler bei NvM Write All | 0 |
| 0x80142F | Fehlerhafte CONFIG ID (NvM) | 0 |
| 0x801430 | Fehler bei NvM Read All | 0 |
| 0xFFFFFF | unbekannter Fehlerort | 0 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STEUERN_SCHALTPUNKT_AUSGABE | 0x4100 | - | zeigt für alle Tasten demeinsam den Schaltpunkt über die Suchbeleuchtung an | - | - | - | - | - | - | - | - | - | 2E | ARG_0x4100_D | - |
| STATUS_SUCHBELEUCHTUNG | 0x4200 | STAT_HELLIGKEIT_WERT | Aktuelle Helligkeit in % | % | - | High | unsigned char | - | 100.0 | 253.0 | 0.0 | - | 22 | - | - |
| STEUERN_SUCHBELEUCHTUNG | 0x4210 | - | steuert die Suchbeleuchtung mit angegebener Helligkeit in % | - | - | - | - | - | - | - | - | - | 2E | ARG_0x4210_D | - |
| STELLGLIED_POSITIONEN | 0xD134 | - | Stellgliedposition | - | - | - | - | - | - | - | - | - | 2E;22 | ARG_0xD134_D | RES_0xD134_D |
| STELLGLIED_TASTER | 0xD136 | - | Ausgabe der Stellung für Stellglied in Position  gedrückt, ob betätigt oder nicht betätigt. | - | - | - | - | - | - | - | - | - | 2E;22 | ARG_0xD136_D | RES_0xD136_D |
...
| SCHRITTE_ROTRAD | 0xD14E | STAT_REGISTER_ROTRAD_WERT | Ausgabe vom aktuellen Wert für die Stellung des Rotationsrad. Wert 0, wenn Drehgeber nicht konfiguriert wurde | - | - | - | signed int | - | 1.0 | 1.0 | 0.0 | - | 22 | - | - |
