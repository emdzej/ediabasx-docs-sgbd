...
| Field | Value |
| --- | --- |
| ECU | Motorrad Motorsteuerung BMSE2 |
...
- [FORTTEXTE](#table-forttexte) (71 × 3)
...
- [RES_0X6690_D](#table-res-0x6690-d) (4 × 10)
...
- [RES_0XF654_R](#table-res-0xf654-r) (2 × 13)
- [SG_FUNKTIONEN](#table-sg-funktionen) (94 × 16)
- [TAB_MR_MM_ADAPTION_ASC](#table-tab-mr-mm-adaption-asc) (6 × 2)
- [TAB_MR_MM_ASC_MODUS](#table-tab-mr-mm-asc-modus) (7 × 2)
- [TAB_MR_MM_ASC_STATUS](#table-tab-mr-mm-asc-status) (7 × 2)
- [TAB_MR_MM_ASC_TASTER](#table-tab-mr-mm-asc-taster) (4 × 2)
- [TAB_MR_MM_GANG](#table-tab-mr-mm-gang) (9 × 2)
- [TAB_MR_MM_GEPAECKFACH](#table-tab-mr-mm-gepaeckfach) (4 × 2)
...
| 0x3A2000 | EWS4, nicht authorisierte Antwort empfangen | 0 |
| 0x3A2001 | EWS4, CAN Bus Timeout-Fehler | 0 |
| 0x3A2002 | EWS4, Datenspeicher Schreibfehler | 0 |
| 0x3A2003 | EWS4, Datenspeicher Plausibilitätsfehler | 0 |
| 0x3A2004 | EWS4, kein Secret-Key definiert | 0 |
| 0x3A2005 | EWS4, Frame-Fehler | 1 |
...
| 0x3A2050 | Motor-Öl Temperature-Sensor, Kurzschluß nach Masse | 0 |
| 0x3A2051 | Motor-Öl Temperature-Sensor, Kurzschluß nach VBatt/Offene Leitung | 0 |
...
| 0x3A20A0 | Einspritzventil Zylinder 2, Kurzschluß nach Masse/offene Leitung | 0 |
| 0x3A20A1 | Einspritzventil Zylinder 2, Kurzschluß nach VBatt | 0 |
...
| 0x3A20C0 | Zündspule Zylinder 2, Kurzschluß nach Masse/offene Leitung | 0 |
| 0x3A20C1 | Zündspule Zylinder 2, Kurzschluß nach VBatt | 0 |
...
| RESULTNAME | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_ASC_STATUS | 0-n | high | unsigned char | - | TAB_MR_MM_ASC_STATUS | - | - | - | aktueller Status der ASC-Funktion |
| STAT_ASC_MODUS | 0-n | high | unsigned char | - | TAB_MR_MM_ASC_MODUS | - | - | - | gewählter Modus der ASC-Funktion |
| STAT_ASC_TASTER | 0-n | high | unsigned char | - | TAB_MR_MM_ASC_TASTER | - | - | - | ASC-Taster |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_ADAPTION | - | - | + | 0-n | high | unsigned char | - | TAB_MR_MM_ADAPTION_ASC | - | - | - | Status der Adaptions-Routine |
| STAT_ASC_RADIUSKORREKTUR_WERT | - | - | + | mm | high | signed int | - | - | 4000.0 | 65536.0 | 0.0 | gesamte Radiuskorrektur der Reifenradiusadaption in Millimeter |
...
| MM_DIGITAL_ABS_TASTER_MR | 0x6604 | STAT_DIGITAL_ABS_TASTER | Status ABS-Taster: 0 = nicht betätigt, 1 = betätigt | 0/1 | - | high | unsigned char | - | - | - | - | - | 22 | - | - |
...
| MM_DIGITAL_EWS_FREIGABE_MR | 0x660B | STAT_DIGITAL_EWS_FREIGABE | EWS Freigabe: 0 = nicht erteilt, 1 = erteilt | 0/1 | - | high | unsigned char | - | - | - | - | - | 22 | - | - |
...
| MM_DIGITAL_GEPAECKFACH_MR | 0x6612 | STAT_DIGITAL_GEPAECKFACH | Status Gepaeckfach | 0-n | - | high | unsigned char | TAB_MR_MM_GEPAECKFACH | - | - | - | - | 22 | - | - |
...
| MM_BREMSE_ROHWERT_MR | 0x6622 | STAT_BREMSE_ROHWERT_WERT | Spannung Bremsschalter Rohwert | mV | - | high | unsigned int | - | 1.0 | 1.0 | 0.0 | - | 22 | - | - |
| MM_BREMSE_MR | 0x6623 | STAT_BREMSE | Status Bremse: 0 = nicht betätigt, 1 = betätigt | 0/1 | - | high | unsigned char | - | - | - | - | - | 22 | - | - |
...
| MM_OELNIVEAU_SCHALTER_MR | 0x6626 | STAT_OELNIVEAU_SCHALTER | Status Ölniveauschalter: 0 = nicht betätigt, 1= betätigt | 0/1 | - | high | unsigned char | - | - | - | - | - | 22 | - | - |
| MM_OELNIVEAU_MR | 0x6627 | STAT_OELNIVEAU | Status Ölniveau | 0-n | - | high | unsigned int | TAB_MR_MM_OELNIVEAU | - | - | - | - | 22 | - | - |
| MM_OELTEMPERATUR_ROHWERT_MR | 0x6628 | STAT_OELTEMPERATUR_ROHWERT_WERT | Spannung Öltemperatur Rohwert | mV | - | high | unsigned int | - | 488.0 | 100.0 | 0.0 | - | 22 | - | - |
| MM_OELTEMPERATUR_MR | 0x6629 | STAT_OELTEMPERATUR_WERT | Öltemperatur | °C | - | high | unsigned int | - | 1.0 | 1.0 | -40.0 | - | 22 | - | - |
...
| MM_ZYLINDER2_ZUENDZEITPUNKT_MR | 0x6654 | STAT_ZYLINDER2_ZUENDZEITPUNKT_WERT | Zündzeitpunkt Zylinder 2 | ° | - | high | signed int | - | 1.0 | 10.0 | 0.0 | - | 22 | - | - |
| MM_ZYLINDER2_SCHLIESSZEIT_MR | 0x6655 | STAT_ZYLINDER2_SCHLIESSZEIT_WERT | Schließzeit Zylinder 2 | ms | - | high | unsigned int | - | 1.0 | 500.0 | 0.0 | - | 22 | - | - |
| MM_ZYLINDER2_EINSPRITZDAUER_MR | 0x6656 | STAT_ZYLINDER2_EINSPRITZDAUER_WERT | Einspritzdauer Zylinder 2 | ms | - | high | unsigned long | - | 1.0 | 500.0 | 0.0 | - | 22 | - | - |
...
| MM_MODUS_FAHRZEUG_SOLL_MR | 0x668C | STAT_MODUS_FAHRZEUG_SOLL | Fahrzeugmodus Soll | 0-n | - | high | unsigned char | TAB_MR_MM_MODUS_FAHRZEUG | - | - | - | - | 22 | - | - |
| MM_MODUS_FAHRZEUG_IST_MR | 0x668D | STAT_MODUS_FAHRZEUG_IST | Fahrzeugmodus Ist | 0-n | - | high | unsigned char | TAB_MR_MM_MODUS_FAHRZEUG | - | - | - | - | 22 | - | - |
| MM_ASC_MR | 0x6690 | - | Auslesen von ASC-relevanten Werten | - | - | - | - | - | - | - | - | - | 22 | - | RES_0x6690_D |
...
| MM_ASC_ADAPTION_MR | 0xF654 | - | Routine zur Steuerung der Rad-Radius Adaption | - | - | - | - | - | - | - | - | - | 31 | - | RES_0xF654_R |

<a id="table-tab-mr-mm-adaption-asc"></a>
### TAB_MR_MM_ADAPTION_ASC

Dimensions: 6 rows × 2 columns

| WERT | TEXT |
| --- | --- |
| 0x00 | Adaption nicht ausgeführt |
| 0x01 | Adaption läuft |
| 0x02 | Adaption erfolgreich abgeschlossen |
| 0x03 | Adaption fehlgeschlagen |
| 0x04 | Adaption abgebrochen |
| 0xFF | Wert ungültig |

<a id="table-tab-mr-mm-asc-modus"></a>
### TAB_MR_MM_ASC_MODUS
...
<a id="table-tab-mr-mm-asc-status"></a>
### TAB_MR_MM_ASC_STATUS
...
<a id="table-tab-mr-mm-asc-taster"></a>
### TAB_MR_MM_ASC_TASTER
...
<a id="table-tab-mr-mm-gepaeckfach"></a>
### TAB_MR_MM_GEPAECKFACH
...
| 0x01 | geschlossen |
| 0x02 | offen |
| 0x03 | Signal vom Kombi fehlerhaft |
| 0xFF | Wert ungültig |
