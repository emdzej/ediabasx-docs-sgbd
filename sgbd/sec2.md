...
| Field | Value |
| --- | --- |
| ECU | Sicherheitsfahrzeugmodul 2 |
| ORIGIN | BMW EK-6 Schikora |
| REVISION | 0.100 |
| AUTHOR | remes EK-6 Rapp |
| COMMENT | N/A |
| PACKAGE | 0.27 |
| SPRACHE | deutsch |
...
| --- | --- | --- |
| 0x024A00 | Energiesparmode aktiv | 0 |
| 0x02FF4A | Diagnosemaster Testfehler : Application | 1 |
| 0x803BFB | Steuergeraet nicht codiert | 0 |
| 0x803BFC | Codierdatenuebertragung fehlgeschlagen | 0 |
| 0x803BFD | Codierpruefstempel stimmt nicht mit Fahrzeug-VIN ueberein | 0 |
| 0x803BFF | Codierdaten sind nicht plausibel | 0 |
| 0xDB8BFF | Diagnosemaster Testfehler : Netzwerk | 1 |
...
| ORT | ORTTEXT | EREIGNIS_DTC |
| --- | --- | --- |
| 0x4A0401 | DM_Queue_Full | 0 |
| 0x4A0402 | DM_Queue_Deleted | 0 |
| 0x4A1001 | DM_Event_ZeitbotschaftTimeout | 1 |
| 0x4A1002 | DM_Event_Ausfall_FZGzustand | 1 |
| 0x4A2001 | NVM_E_Write_Failed | 0 |
| 0x4A2002 | NVM_E_Read_Failed | 0 |
| 0x4A2003 | NVM_E_Control_Failed | 0 |
| 0x4A2004 | NVM_E_Erase_Failed | 0 |
| 0x4A2006 | NVM_E_Write_All_Failed | 0 |
| 0x4A2007 | NVM_E_Read_All_Failed | 0 |
| 0x4A2010 | NVM_E_Wrong_Config_ID | 0 |
| 0x4A3000 | FLS_E_Erase_Failed | 0 |
| 0x4A3001 | FLS_E_Write_Failed | 0 |
| 0x4A3002 | FLS_E_Read_Failed | 0 |
| 0x4A3003 | FLS_E_Compare_Failed | 0 |
| 0xFFFFFF | unbekannter Fehlerort | 0 |
