...
- [STATUS_BYTE_1](#job-status-byte-1) - KWP2000: $21 ReadDataByLocalIdentifier  RLI = 01h mit dem SGBD-Generator erzeugt
- [STATUS_SHIFTLEV](#job-status-shiftlev) - KWP2000: $21 ReadDataByLocalIdentifier  RLI = 14h mit dem SGBD-Generator erzeugt
- [STATUS_ENG_SPEED](#job-status-eng-speed) - KWP2000: $21 ReadDataByLocalIdentifier  RLI = 0Ch mit dem SGBD-Generator erzeugt
- [STATUS_VEHICLE_SPEED](#job-status-vehicle-speed) - KWP2000: $21 ReadDataByLocalIdentifier  RLI = 13h mit dem SGBD-Generator erzeugt
- [STATUS_REV_OUT_T_M](#job-status-rev-out-t-m) - KWP2000: $21 ReadDataByLocalIdentifier  RLI = 08h mit dem SGBD-Generator erzeugt
- [STATUS_REV_IN_T_M](#job-status-rev-in-t-m) - KWP2000: $21 ReadDataByLocalIdentifier  RLI = 09h mit dem SGBD-Generator erzeugt
- [STATUS_OIL_TEMP_ATF](#job-status-oil-temp-atf) - KWP2000: $21 ReadDataByLocalIdentifier  RLI = 0Ah mit dem SGBD-Generator erzeugt
- [STATUS_IG_VOLTAGE](#job-status-ig-voltage) - KWP2000: $21 ReadDataByLocalIdentifier  RLI = 0Bh mit dem SGBD-Generator erzeugt
- [STATUS_ENG_TORQUE](#job-status-eng-torque) - KWP2000: $21 ReadDataByLocalIdentifier  RLI = 0Dh mit dem SGBD-Generator erzeugt
- [STATUS_ENG_TORQUE_DRIVER_REQUEST](#job-status-eng-torque-driver-request) - KWP2000: $21 ReadDataByLocalIdentifier  RLI = 0Eh mit dem SGBD-Generator erzeugt
- [STATUS_THROTTLE_POSITION](#job-status-throttle-position) - KWP2000: $21 ReadDataByLocalIdentifier  RLI = 0Fh mit dem SGBD-Generator erzeugt
- [STATUS_TORQUE_CONTROL_REQUEST](#job-status-torque-control-request) - KWP2000: $21 ReadDataByLocalIdentifier  RLI = 10H mit dem SGBD-Generator erzeugt
- [STATUS_TORQUE_LIMIT_REQUEST](#job-status-torque-limit-request) - KWP2000: $21 ReadDataByLocalIdentifier  RLI =11h mit dem SGBD-Generator erzeugt
- [STATUS_TORQUE_INCREASE_REQUEST](#job-status-torque-increase-request) - KWP2000: $21 ReadDataByLocalIdentifier   RLI =12h mit dem SGBD-Generator erzeugt
- [STATUS_SLC1_OUT_CURRENT](#job-status-slc1-out-current) - KWP2000: $21 ReadDataByLocalIdentifier  RLI = 02h mit dem SGBD-Generator erzeugt
- [STATUS_SLC2_OUT_CURRENT](#job-status-slc2-out-current) - KWP2000: $21 ReadDataByLocalIdentifier  RLI = 03h mit dem SGBD-Generator erzeugt
- [STATUS_SLC3_OUT_CURRENT](#job-status-slc3-out-current) - KWP2000: $21 ReadDataByLocalIdentifier  RLI = 04h mit dem SGBD-Generator erzeugt
- [STATUS_SLT_OUT_CURRENT](#job-status-slt-out-current) - KWP2000: $21 ReadDataByLocalIdentifier  RLI = 06h mit dem SGBD-Generator erzeugt
- [STATUS_SLU_OUT_CURRENT](#job-status-slu-out-current) - KWP2000: $21 ReadDataByLocalIdentifier  RLI = 07h mit dem SGBD-Generator erzeugt
- [STATUS_SLB1_OUT_CURRENT](#job-status-slb1-out-current) - KWP2000: $21 ReadDataByLocalIdentifier  RLI = 05h mit dem SGBD-Generator erzeugt
- [STATUS_BYTE_3](#job-status-byte-3) - KWP2000: $21 ReadDataByLocalIdentifier  RLI = 15h mit dem SGBD-Generator erzeugt
- [STATUS_BYTE_4](#job-status-byte-4) - KWP2000: $21 ReadDataByLocalIdentifier  RLI = 16h mit dem SGBD-Generator erzeugt
- [STATUS_BYTE_5](#job-status-byte-5) - KWP2000: $21 ReadDataByLocalIdentifier RLI = 17h mit dem SGBD-Generator erzeugt
- [STATUS_BYTE_7](#job-status-byte-7) - KWP2000: $21 ReadDataByLocalIdentifier  RLI = 19h mit dem SGBD-Generator erzeugt
- [STATUS_RAMDATA_READABLE](#job-status-ramdata-readable) - KWP2000: $21 ReadDataByLocalIdentifier  RLI = 7Fh mit dem SGBD-Generator erzeugt
- [STATUS_STATUS_SAFETY_AND_SUBSTITUTE_FUNCTIONS](#job-status-status-safety-and-substitute-functions) - KWP2000: $21 ReadDataByLocalIdentifier  RLI=1Ah mit dem SGBD-Generator erzeugt
- [STATUS_BYTE_6](#job-status-byte-6) - KWP2000: $21 ReadDataByLocalIdentifier RLI = 18h mit dem SGBD-Generator erzeugt
- [STATUS_READ_LEARN_DATA1](#job-status-read-learn-data1) - KWP2000: $23 ReadDataByAddress mit dem SGBD-Generator erzeugt
- [STATUS_READ_LEARN_DATA2](#job-status-read-learn-data2) - KWP2000: $23 ReadDataByAddress mit dem SGBD-Generator erzeugt
- [CLEAR_MODE_COUNTERS](#job-clear-mode-counters) - Clearance of all the Mode Counters KWP2000: $31 StartRoutineByLocalIdentifier LID $20 
...
- [SPEICHER_LESEN_AISIN](#job-speicher-lesen-aisin) - Auslesen des Steuergeraete-Speichers Als Argumente werden uebergeben: Speichersegment, Start-Adresse und Anzahl der Datenbytes  !!! 3 address bytes instead of 4 address bytes !!!  KWP 2000: $23 ReadMemoryByAddress Modus   : Default
- [MODES_COUNTERS_LESEN](#job-modes-counters-lesen) - Status of the COUNTERs for M_MODE/ D_MODE/ SD_MODE/ MD_MODE Start_Address for the RBM job is equal to the address of STATUS_RBM_MMODE_10MS (issued from STATUS_RBM_Tabel)  KWP 2000: $23 ReadMemoryByAddress Modus   : Default
...
- [DAFFILENAME_LESEN](#job-daffilename-lesen) - DafFileName lesen KWP2000: $1A ReadECUIdentification $8A DAFfilename oder alternativ KWP2000: $1A ReadECUIdentification $80 ECUIdentificationDataTable Modus  : Default
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_SHIFT_SOLENOID_S1_OUTPUT | int | 0=OFF / 1=ON |
| STAT_SHIFT_SOLENOID_S2_OUTPUT | int | 0=OFF / 1=ON |
| STAT_SHIFT_LOCK_SOLENOID_OUTPUT | int | 0=OFF / 1=ON |
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_SHIFTLEV_WERT | int | Keine Auswhal aktiv oder verfügbar 'Tip 1' Reichweite 'Tip 2' Reichweite 'Tip 3' Reichweite 'Tip 4' Reichweite 'D' Reichweite 'N' Reichweite 'R' Reichweite 'P' Reichweite 'Tip 5' Reichweite 'Tip 6' Reichweite 'L' Reichweite table Shift_Lever_Position WERT |
| STAT_SHIFTLEV_TEXT | string | Keine Auswhal aktiv oder verfügbar 'Tip 1' Reichweite 'Tip 2' Reichweite 'Tip 3' Reichweite 'Tip 4' Reichweite 'D' Reichweite 'N' Reichweite 'R' Reichweite 'P' Reichweite 'Tip 5' Reichweite 'Tip 6' Reichweite 'L' Reichweite table Shift_Lever_Position TEXT |
| _TEL_AUFTRAG | binary | Hex-Auftrag von SG |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_ENG_SPEED_WERT | real | Engine revolution speed Bereich von 0 [RPM] bis 65535 [RPM] |
| STAT_ENG_SPEED_EINH | string | Engine revolution speed Einheit: RPM |
| _TEL_AUFTRAG | binary | Hex-Auftrag von SG |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_VEHICLE_SPEED_WERT | real | Vehicle speed Bereich von 0 [Km/H] bis 255 [Km/H] |
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_REV_OUT_T_M_WERT | real | Transmission output revolution speed Bereich von 0 [RPM] bis 7650 [RPM] |
| STAT_REV_OUT_T_M_EINH | string | Transmission output revolution speed Einheit: RPM |
| _TEL_AUFTRAG | binary | Hex-Auftrag von SG |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_REV_IN_T_M_WERT | real | Transmission Input revolution speed Bereich von 0 [RPM] bis 7650 [RPM] |
| STAT_REV_IN_T_M_EINH | string | Transmission Input revolution speed Einheit: RPM |
| _TEL_AUFTRAG | binary | Hex-Auftrag von SG |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_OIL_TEMP_ATF_WERT | real | Automatic Transmission Fluid (ATF) Temperature Bereich von -55 [Degree C] bis 200 [Degree C] |
| STAT_OIL_TEMP_ATF_EINH | string | Automatic Transmission Fluid (ATF) Temperature Einheit: Degree C |
| _TEL_AUFTRAG | binary | Hex-Auftrag von SG |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_IG_VOLTAGE_WERT | real | Ignition signal voltage Bereich von 0 [Volt] bis 25.5 [Volt] |
| STAT_IG_VOLTAGE_EINH | string | Ignition signal voltage Einheit: Volt |
| _TEL_AUFTRAG | binary | Hex-Auftrag von SG |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_ENG_TORQUE_WERT | real | Engine Torque Bereich von 0 [%] bis 255 [%] |
| STAT_ENG_TORQUE_EINH | string | Engine Torque Einheit: % |
| _TEL_AUFTRAG | binary | Hex-Auftrag von SG |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_ENG_TORQUE_DRIVER_REQUEST_WERT | real | Engine torque requested by the driver Bereich von 0 [%] bis 255 [%] |
| STAT_ENG_TORQUE_DRIVER_REQUEST_EINH | string | Engine torque requested by the driver Einheit: % |
| _TEL_AUFTRAG | binary | Hex-Auftrag von SG |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_THROTTLE_POSITION_WERT | real | Throttle position ( Accelerator pedal position ) Bereich von 0 [%] bis 255 [%] |
| STAT_THROTTLE_POSITION_EINH | string | Throttle position ( Accelerator pedal position ) Einheit: % |
| _TEL_AUFTRAG | binary | Hex-Auftrag von SG |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_TORQUE_CONTROL_REQUEST_WERT | real | Torque Control treshold requested by the Automatic Transmission Bereich von 0 [%] bis 255 [%] |
| STAT_TORQUE_CONTROL_REQUEST_EINH | string | Torque Control treshold requested by the Automatic Transmission Einheit: % |
| _TEL_AUFTRAG | binary | Hex-Auftrag von SG |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_TORQUE_LIMIT_REQUEST_WERT | real | Torque Limit treshold requested by the Automatic Transmission Bereich von 0 [%] bis 255 [%] |
| STAT_TORQUE_LIMIT_REQUEST_EINH | string | Torque Limit treshold requested by the Automatic Transmission Einheit: % |
| _TEL_AUFTRAG | binary | Hex-Auftrag von SG |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_TORQUE_INCREASE_REQUEST_WERT | real | Torque increase requested by the Automatic Transmission Bereich von 0 [%] bis 255 [%] |
| STAT_TORQUE_INCREASE_REQUEST_EINH | string | Torque increase requested by the Automatic Transmission Einheit: % |
| _TEL_AUFTRAG | binary | Hex-Auftrag von SG |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_SLC1_OUT_CURRENT_WERT | real | SLC1 feedback measured current Bereich von 0 [mA] bis 2550 [mA] |
| STAT_SLC1_OUT_CURRENT_EINH | string | SLC1 feedback measured current Einheit: mA |
| _TEL_AUFTRAG | binary | Hex-Auftrag von SG |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_SLC2_OUT_CURRENT_WERT | real | SLC2 feedback measured current Bereich von 0 [mA] bis 2550 [mA] |
| STAT_SLC2_OUT_CURRENT_EINH | string | SLC2 feedback measured current Einheit: mA |
| _TEL_AUFTRAG | binary | Hex-Auftrag von SG |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_SLC3_OUT_CURRENT_WERT | real | SLC3 feedback measured current Bereich von 0 [mA] bis 2550 [mA] |
| STAT_SLC3_OUT_CURRENT_EINH | string | SLC3 feedback measured current Einheit: mA |
| _TEL_AUFTRAG | binary | Hex-Auftrag von SG |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_SLT_OUT_CURRENT_WERT | real | SLT feedback measured current Bereich von 0 [mA] bis 2550 [mA] |
| STAT_SLT_OUT_CURRENT_EINH | string | SLT feedback measured current Einheit: mA |
| _TEL_AUFTRAG | binary | Hex-Auftrag von SG |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_SLU_OUT_CURRENT_WERT | real | SLU feedback measured current Bereich von 0 [mA] bis 2550 [mA] |
| STAT_SLU_OUT_CURRENT_EINH | string | SLU feedback measured current Einheit: mA |
| _TEL_AUFTRAG | binary | Hex-Auftrag von SG |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_SLB1_OUT_CURRENT_WERT | real | SLB1 feedback measured current Bereich von 0 [mA] bis 2550 [mA] |
| STAT_SLB1_OUT_CURRENT_EINH | string | SLB1 feedback measured current Einheit: mA |
| _TEL_AUFTRAG | binary | Hex-Auftrag von SG |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_BRAKE | int | 0=OFF / 1=ON |
| STAT_TIP_ON | int | 0=OFF / 1=ON |
| STAT_TIP_PLUS | int | 0=OFF / 1=ON |
| STAT_TIP_MINUS | int | 0=OFF / 1=ON |
| STAT_LOCKUP | int | 0=OFF / 1=ON |
| STAT_MIL_REQ | int | 0=OFF / 1=ON |
| STAT_DISPLAY_REQ | int | 0=OFF / 1=ON |
| STAT_WARMUP_CYCLE_ACHIEVEMENT | int | 0=Not achieved / 1=achieved |
| _TEL_AUFTRAG | binary | Hex-Auftrag von SG |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_GEAR_ENGAGEMENT | int | 0=Not achieved / 1=Achieved |
| STAT_TORQ_CONV_WERT | int | keine Lockup Kupplung angezogen Lockup Kupplung schleift Lockup Kupplung anezogen Status unbekannt table Torque_Converter_Status WERT |
| STAT_TORQ_CONV_TEXT | string | keine Lockup Kupplung angezogen Lockup Kupplung schleift Lockup Kupplung anezogen Status unbekannt table Torque_Converter_Status TEXT |
| STAT_AIRCON_STATUS | int | 0=Compressor is passive / 1=Compressor is active |
| STAT_DRIVE_MODE_STATUS_WERT | int | E Mode M Mode D Mode W Mode Dunkel Mode table DRIVE_MODE_STATUS WERT |
| STAT_DRIVE_MODE_STATUS_TEXT | string | E Mode M Mode D Mode W Mode Dunkel Mode table DRIVE_MODE_STATUS TEXT |
| _TEL_AUFTRAG | binary | Hex-Auftrag von SG |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_STATUS_ACTUAL_GEAR_WERT | int | P oder N 1. Gang 2. Gang 3. Gang 4. Gang 5. Gang 6. Gang Reverse Gang table Actual_Gear WERT |
| STAT_STATUS_ACTUAL_GEAR_TEXT | string | P oder N 1. Gang 2. Gang 3. Gang 4. Gang 5. Gang 6. Gang Reverse Gang table Actual_Gear TEXT |
| STAT_GEARSWITCH_ACTIVE | int | 0=Not Active / 1=Acitve |
| STAT_GEARSHIFT_REFUSED | int | 0=Accepted / 1=Refused |
| _TEL_AUFTRAG | binary | Hex-Auftrag von SG |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_GEAR_ERROR_WERT | int | kein Fehler Reverse Gang Fehler 1. E/G Bremse Gang Fehler 1. Gang Fehler 2. Gang Fehler 3. Gang Fehler 4. Gang Fehler 5. Gang Fehler 6. Gang Fehler table Gear_Error WERT |
| STAT_GEAR_ERROR_TEXT | string | kein Fehler Reverse Gang Fehler 1. E/G Bremse Gang Fehler 1. Gang Fehler 2. Gang Fehler 3. Gang Fehler 4. Gang Fehler 5. Gang Fehler 6. Gang Fehler table Gear_Error TEXT |
| _TEL_AUFTRAG | binary | Hex-Auftrag von SG |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| STAT_SLU_OUT_CURRENT_WERT | real | SLU feedback measured current Bereich von 0 [mA] bis 2550 [mA] |
| STAT_SLU_OUT_CURRENT_EINH | string | SLU feedback measured current Einheit: mA |
| STAT_REV_OUT_T_M_WERT | real | Output shaft revolution speed Bereich von 0 [RPM] bis 7650 [RPM] |
| STAT_REV_OUT_T_M_EINH | string | Output shaft revolution speed Einheit: RPM |
| STAT_REV_IN_T_M_WERT | real | Primary shaft revolution speed Bereich von 0 [RPM] bis 7650 [RPM] |
| STAT_REV_IN_T_M_EINH | string | Primary shaft revolution speed Einheit: RPM |
| STAT_OIL_TEMP_ATF_WERT | real | Automatic Transmission Fluid (ATF) Temperature Bereich von -55 [Degree C] bis 200 [Degree C] |
| STAT_OIL_TEMP_ATF_EINH | string | Automatic Transmission Fluid (ATF) Temperature Einheit: Degree C |
| STAT_IG_VOLTAGE_WERT | real | Ignition signal voltage Bereich von 0 [Volt] bis 25.5 [Volt] |
| STAT_IG_VOLTAGE_EINH | string | Ignition signal voltage Einheit: Volt |
...
| STAT_TORQ_CONV_WERT | int | keine Lockup Kupplung angezogen Lockup Kupplung schleift Lockup Kupplung anezogen Status unbekannt table Torque_Converter_Status WERT |
| STAT_TORQ_CONV_TEXT | string | keine Lockup Kupplung angezogen Lockup Kupplung schleift Lockup Kupplung anezogen Status unbekannt table Torque_Converter_Status TEXT |
| STAT_ACTUAL_GEAR_WERT | int | P oder N 1. Gang 2. Gang 3. Gang 4. Gang 5. Gang 6. Gang Reverse Gang table Actual_Gear WERT |
| STAT_ACTUAL_GEAR_TEXT | string | P oder N 1. Gang 2. Gang 3. Gang 4. Gang 5. Gang 6. Gang Reverse Gang table Actual_Gear TEXT |
| STAT_GEARSWITCH_ACTIVE | int | 0=Not Active / 1=Acitve |
| STAT_GEARSHIFT_REFUSED | int | 0=Accepted / 1=Refused |
| STAT_GEAR_ERROR_WERT | int | kein Fehler Reverse Gang Fehler 1. E/G Bremse Gang Fehler 1. Gang Fehler 2. Gang Fehler 3. Gang Fehler 4. Gang Fehler 5. Gang Fehler 6. Gang Fehler table Gear_Error WERT |
| STAT_GEAR_ERROR_TEXT | string | kein Fehler Reverse Gang Fehler 1. E/G Bremse Gang Fehler 1. Gang Fehler 2. Gang Fehler 3. Gang Fehler 4. Gang Fehler 5. Gang Fehler 6. Gang Fehler table Gear_Error TEXT |
...
| STAT_DRIVE_MODE_STATUS_WERT | int | E Mode M Mode D Mode W Mode Dunkel Mode table DRIVE_MODE_STATUS WERT |
| STAT_DRIVE_MODE_STATUS_TEXT | string | E Mode M Mode D Mode W Mode Dunkel Mode table DRIVE_MODE_STATUS TEXT |
| STAT_SHIFT_MAP_PATTERN_WERT | int | WUSP Mode ECONOMY Mode UP SLOPE1  Mode UP SLOPE2  Mode UP SLOPE3  Mode SPORT Mode HOT1 Mode HOT2 Mode SPORT SWITCH Mode Einweg Kupplungsschutz Mode table ShiftMap_pattern WERT |
| STAT_SHIFT_MAP_PATTERN_TEXT | string | WUSP Mode ECONOMY Mode UP SLOPE1  Mode UP SLOPE2  Mode UP SLOPE3  Mode SPORT Mode HOT1 Mode HOT2 Mode SPORT SWITCH Mode Einweg Kupplungsschutz Mode table ShiftMap_pattern TEXT |
| STAT_LIMP_HOME_MODE | int | 0= not active  / 1= active |
| _TEL_AUFTRAG | binary | Hex-Auftrag von SG |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |

<a id="job-status-status-safety-and-substitute-functions"></a>
...
<a id="job-status-read-learn-data1"></a>
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_LEARN_1_WERT | real | Bereich von 0 [0-n] bis 255 [0-n] |
| STAT_LEARN_1_EINH | string | Einheit: 0-n |
| _TEL_AUFTRAG | binary | Hex-Auftrag von SG |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |

<a id="job-status-read-learn-data2"></a>
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_LEARN_2_WERT | real | Bereich von 0 [0-n] bis 255 [0-n] |
| STAT_LEARN_2_EINH | string | Einheit: 0-n |
| _TEL_AUFTRAG | binary | Hex-Auftrag von SG |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |

<a id="job-clear-mode-counters"></a>
### CLEAR_MODE_COUNTERS
...
| Name | Type | Comment |
| --- | --- | --- |
| JOB_STATUS | string | Feedback from ecu telegram OKAY, if no failure  |
| _TEL_ANTWORT | binary | Hex-Answer from TCU |
| _TEL_AUFTRAG | binary | Hex-Request to TCU |
...
| Name | Type | Comment |
| --- | --- | --- |
| JOB_STATUS | string | Feedback from ecu telegram OKAY, if no failure table JobResult STATUS_TEXT |
| _TEL_ANTWORT | binary | Hex-Answer from TCU |
| _TEL_AUFTRAG | binary | Hex-Request to TCU |
...
| --- | --- | --- |
| JOB_STATUS | string | Feedback from ecu telegram OKAY, if no failure table JobResult STATUS_TEXT |
| ANZAHL_FEHLER | int | Number of error codes in error memory  |
| KILOMETERSTAND_AKTUELL | real | Current mileage  |
| KILOMETERSTAND_FS_LOESCHEN | real | Mileage on last FS_Loeschen  |
| _TEL_ANTWORT | binary | Hex-Answer from TCU |
| _TEL_AUFTRAG | binary | Hex-Request to TCU |

<a id="job-speicher-lesen-aisin"></a>
...
| Name | Type | Comment |
| --- | --- | --- |
| DATEN | binary | read out data |
| JOB_STATUS | string | Feedback from ecu telegram OKAY, if no failure table JobResult STATUS_TEXT |
| _TEL_AUFTRAG | binary | Hex-Request to TCU |
| _TEL_ANTWORT | binary | Hex-Answer from TCU |

<a id="job-modes-counters-lesen"></a>
...
| Name | Type | Comment |
| --- | --- | --- |
| M_MODE_WEEK_COUNTER_WERT | int | Value of the WEEK COUNTER for M_MODE |
| M_MODE_WEEK_COUNTER_EINH | string | unit: WEEK |
| M_MODE_DAY_COUNTER_WERT | int | Value of the DAY COUNTER for M_MODE |
| M_MODE_DAY_COUNTER_EINH | string | unit: DAY |
| M_MODE_HOUR_COUNTER_WERT | int | Value of the HOUR COUNTER for M_MODE |
| M_MODE_HOUR_COUNTER_EINH | string | unit: h |
| M_MODE_MINUTE_COUNTER_WERT | int | Value of the MINUTE COUNTER for M_MODE |
| M_MODE_MINUTE_COUNTER_EINH | string | unit: min |
| M_MODE_10MS_COUNTER_WERT | unsigned int | Value of the 10MS COUNTER for M_MODE |
| M_MODE_10MS_COUNTER_EINH | string | unit: ms |
| D_MODE_WEEK_COUNTER_WERT | int | Value of the WEEK COUNTER for D_MODE |
| D_MODE_WEEK_COUNTER_EINH | string | unit: WEEK |
| D_MODE_DAY_COUNTER_WERT | int | Value of the DAY COUNTER for D_MODE |
| D_MODE_DAY_COUNTER_EINH | string | unit: DAY |
| D_MODE_HOUR_COUNTER_WERT | int | Value of the HOUR COUNTER for D_MODE |
| D_MODE_HOUR_COUNTER_EINH | string | unit: h |
| D_MODE_MINUTE_COUNTER_WERT | int | Value of the MINUTE COUNTER for D_MODE |
| D_MODE_MINUTE_COUNTER_EINH | string | unit: min |
| D_MODE_10MS_COUNTER_WERT | unsigned int | Value of the 10MS COUNTER for D_MODE |
| D_MODE_10MS_COUNTER_EINH | string | unit: ms |
| SD_MODE_WEEK_COUNTER_WERT | int | Value of the WEEK COUNTER for SD_MODE |
| SD_MODE_WEEK_COUNTER_EINH | string | unit: WEEK |
| SD_MODE_DAY_COUNTER_WERT | int | Value of the DAY COUNTER for SD_MODE |
| SD_MODE_DAY_COUNTER_EINH | string | unit: DAY |
| SD_MODE_HOUR_COUNTER_WERT | int | Value of the HOUR COUNTER for SD_MODE |
| SD_MODE_HOUR_COUNTER_EINH | string | unit: h |
| SD_MODE_MINUTE_COUNTER_WERT | int | Value of the MINUTE COUNTER for SD_MODE |
| SD_MODE_MINUTE_COUNTER_EINH | string | unit: min |
| SD_MODE_10MS_COUNTER_WERT | unsigned int | Value of the 10MS COUNTER for SD_MODE |
| SD_MODE_10MS_COUNTER_EINH | string | unit: ms |
| MD_MODE_WEEK_COUNTER_WERT | int | Value of the WEEK COUNTER for MD_MODE |
| MD_MODE_WEEK_COUNTER_EINH | string | unit: WEEK |
| MD_MODE_DAY_COUNTER_WERT | int | Value of the DAY COUNTER for MD_MODE |
| MD_MODE_DAY_COUNTER_EINH | string | unit: DAY |
| MD_MODE_HOUR_COUNTER_WERT | int | Value of the HOUR COUNTER for MD_MODE |
| MD_MODE_HOUR_COUNTER_EINH | string | unit: h |
| MD_MODE_MINUTE_COUNTER_WERT | int | Value of the MINUTE COUNTER for MD_MODE |
| MD_MODE_MINUTE_COUNTER_EINH | string | unit: min |
| MD_MODE_10MS_COUNTER_WERT | unsigned int | Value of the 10MS COUNTER for MD_MODE |
| MD_MODE_10MS_COUNTER_EINH | string | unit: ms |
| JOB_STATUS | string | feedback from ecu telegram OKAY, if no failure table JobResult STATUS_TEXT |
| _TEL_AUFTRAG | binary | Hex-Request to TCU |
| _TEL_ANTWORT | binary | Hex-Answer from TCU |
...
| NUMERATOR_SLC1_STUCK | real | Bereich 0x0000...0xFFFF  |
| DENOMINATOR_SLC1_STUCK | real | Bereich 0x0000...0xFFFF  |
| RBM_SLC1_STUCK | real | Bereich 0x0000...0xFFFF  |
| NUMERATOR_SLC2_STUCK | real | Bereich 0x0000...0xFFFF  |
| DENOMINATOR_SLC2_STUCK | real | Bereich 0x0000...0xFFFF  |
| RBM_SLC2_STUCK | real | Bereich 0x0000...0xFFFF  |
| NUMERATOR_SLC3_STUCK | real | Bereich 0x0000...0xFFFF  |
| DENOMINATOR_SLC3_STUCK | real | Bereich 0x0000...0xFFFF  |
| RBM_SLC3_STUCK | real | Bereich 0x0000...0xFFFF  |
| NUMERATOR_SLB1_STUCK | real | Bereich 0x0000...0xFFFF  |
| DENOMINATOR_SLB1_STUCK | real | Bereich 0x0000...0xFFFF  |
| RBM_SLB1_STUCK | real | Bereich 0x0000...0xFFFF  |
| NUMERATOR_SLT_STUCK | real | Bereich 0x0000...0xFFFF  |
| DENOMINATOR_SLT_STUCK | real | Bereich 0x0000...0xFFFF  |
| RBM_SLT_STUCK | real | Bereich 0x0000...0xFFFF  |
| NUMERATOR_SLU_STUCK | real | Bereich 0x0000...0xFFFF  |
| DENOMINATOR_SLU_STUCK | real | Bereich 0x0000...0xFFFF  |
| RBM_SLU_STUCK | real | Bereich 0x0000...0xFFFF  |
| NUMERATOR_OIL_STUCK | real | Bereich 0x0000...0xFFFF  |
| DENOMINATOR_OIL_STUCK | real | Bereich 0x0000...0xFFFF  |
| RBM_OIL_STUCK | real | Bereich 0x0000...0xFFFF  |
...
| NUMERATOR_NCTRL_C1_ENGAGE | real | Bereich 0x0000...0xFFFF  |
| DENOMINATOR_NCTRL_C1_ENGAGE | real | Bereich 0x0000...0xFFFF  |
| RBM_NCTRL_C1_ENGAGE | real | Bereich 0x0000...0xFFFF  |
| NUMERATOR_GEARERROR1 | real | Bereich 0x0000...0xFFFF  |
| DENOMINATOR_GEARERROR1 | real | Bereich 0x0000...0xFFFF  |
| RBM_GEARERROR1 | real | Bereich 0x0000...0xFFFF  |
| NUMERATOR_GEARERROR1EB | real | Bereich 0x0000...0xFFFF  |
| DENOMINATOR_GEARERROR1EB | real | Bereich 0x0000...0xFFFF  |
| RBM_GEARERROR1EB | real | Bereich 0x0000...0xFFFF  |
...
| Name | Type | Comment |
| --- | --- | --- |
| JOB_STATUS | string | Feedback from ecu telegram OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_LOCAL_IDENTIFIER_TEXT | string | Solenoid considered S1,S2,SLC1,SLC2,SLC3,SLB1,SLT,SLU,SHIFTLOCK |
| STAT_CONTROLSTATE_WERT | real | Value of the actual current Range from 0mA to 1000mA |
| STAT_CONTROLSTATE_EINH | string | unit: mA |
| STAT_CONTROLSTATE_TEXT | string | [= ON/OFF] Only used for S1, S2 and Shiftlock |
| _TEL_ANTWORT | binary | Hex-Answer from TCU |
| _TEL_AUFTRAG | binary | Hex-Request to TCU |

<a id="job-daffilename-lesen"></a>
### DAFFILENAME_LESEN
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| DAFFILENAME | string | Daffilename des Steuergeraets |
| _TEL_AUFTRAG | binary | Hex-Auftrag an SG |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
| _TEL_AUFTRAG_2 | binary | Hex-Auftrag an SG |
| _TEL_ANTWORT_2 | binary | Hex-Antwort von SG |
...
- [FUMWELTMATRIX](#table-fumweltmatrix) (95 × 5)
- [FUMWELTTEXTE](#table-fumwelttexte) (20 × 9)
- [FARTTYP](#table-farttyp) (95 × 5)
...
- [STATUS_RBM_TABEL](#table-status-rbm-tabel) (58 × 3)
- [DRIVE_MODE_STATUS](#table-drive-mode-status) (5 × 2)
- [SHIFTMAP_PATTERN](#table-shiftmap-pattern) (12 × 2)
...
- [SPEICHERSEGMENT_AISIN](#table-speichersegment-aisin) (12 × 3)
...
<a id="table-drive-mode-status"></a>
### DRIVE_MODE_STATUS
...
<a id="table-speichersegment-aisin"></a>
