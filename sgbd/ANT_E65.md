...
| REVISION | 1.06 |
| AUTHOR | SiemensVDO Windmueller, BMW EE-41 Beer, BMW TI-431 Krueger, BMW TI-431 Rochal, BMW TI-431 Weber |
| COMMENT | ANT_E65 |
| PACKAGE | 1.32 |
| SPRACHE | deutsch |
...
- [UPDATE_EEP](#job-update-eep) - EEPROM Daten update KWP2000: $3B Modus  : Default
...
- [STEUERN_FREQUENZBAND](#job-steuern-frequenzband) - Tunerfrequenzband einstellen
- [STEUERN_DIVERSITY](#job-steuern-diversity) - Diversity testen KWP2000: $30  DiagInputOutputControlByLocalIdentifier $07  SetIOStatus Modus  : Default
- [TEST_WATCHDOG](#job-test-watchdog) - Watchdog testen KWP2000: $30  DiagInputOutputControlByLocalIdentifier $07  SetIOStatus Modus  : Default
...
<a id="job-update-eep"></a>
### UPDATE_EEP

EEPROM Daten update KWP2000: $3B Modus  : Default
...
<a id="job-steuern-frequenzband"></a>
### STEUERN_FREQUENZBAND

Tunerfrequenzband einstellen

#### Arguments

| Name | Type | Comment |
| --- | --- | --- |
| FREQUENZBAND | unsigned char | Bereich: 0 - 3 0: FM 1: MW 2: LW 3: SW |
...
<a id="job-steuern-diversity"></a>
### STEUERN_DIVERSITY

Diversity testen KWP2000: $30  DiagInputOutputControlByLocalIdentifier $07  SetIOStatus Modus  : Default
...
Watchdog testen KWP2000: $30  DiagInputOutputControlByLocalIdentifier $07  SetIOStatus Modus  : Default
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_QUALITY | int | Quality Bereich: 0...15 (der f�r die AF-Verfolgung massgebliche Wert, entspricht der Summe der gewichteten Einzelfaktoren, 15 = beste Qualit„t) 2-Tuner: Quality = 0 ! |
| STAT_FIELDSTRENGTH | int | Fieldstrength Bereich: 0...15 (4dB-Schritte von 0...60 dBæV) |
| STAT_ANT_PW | int | Antenna Power Supply Bereich: 0 = OFF, 1= ON...15 |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| 0xDAD1 | Lange und/oder häufige Unlocks (Error_Unlock_Long). |
