...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| I_STUFE_WERK | string | table I_STUFE_E87 I_STUFE_TEXT |
| I_STUFE_HO | string | table I_STUFE_E87 I_STUFE_TEXT |
| I_STUFE_HO_BACKUP | string | table I_STUFE_E87 I_STUFE_TEXT |
| _TEL_AUFTRAG | binary | Hex-Auftrag an SG |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| Name | Type | Comment |
| --- | --- | --- |
| I_STUFE_WERK | string | table I_STUFE_E87 I_STUFE_TEXT Entspricht Byte 1 des Pruefstempels |
| I_STUFE_HO | string | table I_STUFE_E87 I_STUFE_TEXT Entspricht Byte 2 des Pruefstempels |
| I_STUFE_HO_BACKUP | string | table I_STUFE_E87 I_STUFE_TEXT Entspricht Byte 3 des Pruefstempels |
...
- [ZUORDNUNGSTABELLE](#table-zuordnungstabelle) (301 × 4)
...
- [I_STUFE_E87](#table-i-stufe-e87) (28 × 2)
...
| 12 .JD. 0041 | D50M57E1 | D_MOTOR | Dieselelektronik DDE 5 6 Zylinder M57 TÜ EU4 |
...
| 12 .59. 0040 | D50M57E1 | D_MOTOR | Dieselelektronik DDE 5 6 Zylinder M57 TÜ EU3-MT |
| 12 .59. 0041 | D50M57E1 | D_MOTOR | Dieselelektronik DDE 5 6 Zylinder M57 TÜ EU3-MT |
| 12 .JD. 0040 | D50M57E1 | D_MOTOR | Dieselelektronik DDE 5 6 Zylinder M57 TÜ EU3-AT EU4 |
