...
| REVISION | 4.020 |
| AUTHOR | ZF TE-PA H.Windberg, ZF ES50 H.Cargiet |
...
- [STATUS_ADAPTIONSPRUEFZAEHLER](#job-status-adaptionspruefzaehler) - Auslesen der AdationsPrüfzähler KWP2000: $21 ReadDataByLocalIdentifier Modus  : Default
- [STEUERN_PULSADAPTIONSWERTE_LOESCHEN](#job-steuern-pulsadaptionswerte-loeschen) - alle Pulsadaptionwerte ruecksetzen KWP2000: $31 StartRoutineByLocalIdentifier Modus  : Default
- [BACKUP_FS_1_10_LESEN](#job-backup-fs-1-10-lesen) - Backup-Fehlerspeicher lesen KWP2000:  ReadDataByLocalIdentifier Modus  : Default
- [BACKUP_FS_11_20_LESEN](#job-backup-fs-11-20-lesen) - Backup-Fehlerspeicher lesen KWP2000:  ReadDataByLocalIdentifier Modus  : Default
- [STEUERN_TRIGGER_FLAG_EIN](#job-steuern-trigger-flag-ein) - Einschalten des CAN Triggers KWP2000: $31 StartRoutineByLocalIdentifier Modus  : Default
- [STEUERN_TRIGGER_FLAG_AUS](#job-steuern-trigger-flag-aus) - Abschalten des CAN Triggers KWP2000: $31 StartRoutineByLocalIdentifier Modus  : Default
- [STATUS_EWS_EGS_LESEN](#job-status-ews-egs-lesen) - Auslesen des Status KWP2000: $21 ReadDataByLocalIdentifier Modus  : Default
- [STEUERN_EWS_EGS](#job-steuern-ews-egs) - Rücksetzen auf jungfräulich KWP2000: $31 StartRoutineByLocalIdentifier Modus  : Default
- [STEUERN_ISN_ZAEHLER_RUECKSETZEN](#job-steuern-isn-zaehler-ruecksetzen) - Rücksetzen des ISN Zählers KWP2000: $31 StartRoutineByLocalIdentifier Modus  : Default
- [STATUS_AUTO_P_EMF3_ZAEHLER](#job-status-auto-p-emf3-zaehler) - Hilferuf in Pos DR KWP2000: $21 Modus  : Default
- [STATUS_CODIERUNG](#job-status-codierung) - Auslesen des Codierstatus KWP2000: $21 ReadDataByLocalIdentifier Modus  : Default
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_SA_ACC_TEXT | string | SA ACC |
| STAT_SA_ACC_WERT | int | i0=0, Fehler=1 |
| STAT_SA_CAS_TEXT | string | SA CAS |
| STAT_SA_CAS_WERT | int | i0=0, Fehler=1 |
| STAT_SA_DME3_TEXT | string | SA DME3 |
| STAT_SA_DME3_WERT | int | i0=0, Fehler=1 |
| STAT_SA_DME2_TEXT | string | SA DME2 |
| STAT_SA_DME2_WERT | int | i0=0, Fehler=1 |
| STAT_SA_DME1_TEXT | string | SA DME1 |
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_NOTENTRIEGELUNG_TEXT | string | Notentriegelung |
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_SYSTEM_NAME_TEXT | string | Name |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
| _TEL_AUFTRAG | binary | Hex-Auftrag an SG |
...
| Name | Type | Comment |
| --- | --- | --- |
| SIGNAL | string | DR7,MV2,MV3,EDS1,EDS2,EDS3,EDS4,EDS5,EDS6,P_LEITUNG,MV4,KOMBI |
...
| Name | Type | Comment |
| --- | --- | --- |
| SIGNAL | string | DR7,MV2,MV3,EDS1,EDS2,EDS3,EDS4,EDS5,EDS6,L1,L2,L3,L4,P_LEITUNG,MV4 |
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_LOCAL_IDENTIFIER_TEXT | string | DR7,MV2,MV3,EDS1,EDS2,EDS3,EDS4,EDS5,EDS6,L1,L2,L3,L4,P_LEITUNG,MV4 |
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_KLEMMENSTATUS_TEXT | string | Klemmenstatus results: Timeoutdiagnose aktiv/Timeoutdiagnose nicht aktiv |
| STAT_ZV_KLAPPENZUSTAND_TEXT | string | ZV Klappenzustand results: Timeoutdiagnose aktiv/Timeoutdiagnose nicht aktiv |
| STAT_DREHMOMENT1_TEXT | string | Drehmoment 1 results: Timeoutdiagnose aktiv/Timeoutdiagnose nicht aktiv |
| STAT_DREHMOMENT2_TEXT | string | Drehmoment 2 results: Timeoutdiagnose aktiv/Timeoutdiagnose nicht aktiv |
| STAT_DREHMOMENT3_TEXT | string | Drehmoment 3 results: Timeoutdiagnose aktiv/Timeoutdiagnose nicht aktiv |
| STAT_MOTORDATEN_TEXT | string | Motordaten results: Timeoutdiagnose aktiv/Timeoutdiagnose nicht aktiv |
| STAT_REGELGESCHWINDIGKEIT_STUEFENTEMPOMAT_TEXT | string | Regelgeschwindigkeit Stufenautomat results: Timeoutdiagnose aktiv/Timeoutdiagnose nicht aktiv |
| STAT_RADGESCHWINDIGKEIT_TEXT | string | Radgeschwindigkeit results: Timeoutdiagnose aktiv/Timeoutdiagnose nicht aktiv |
| STAT_STATUS_DSC_TEXT | string | Status DSC results: Timeoutdiagnose aktiv/Timeoutdiagnose nicht aktiv |
| STAT_GECHWINDIGKEIT_TEXT | string | Geschwindigkeit results: Timeoutdiagnose aktiv/Timeoutdiagnose nicht aktiv |
| STAT_RADTOLERANZABGLEICH_TEXT | string | Reifentoleranzabgleich results: Timeoutdiagnose aktiv/Timeoutdiagnose nicht aktiv |
| STAT_AUSSENTEMPERATUR_RELATIVZEIT_TEXT | string | Aussentemperatur Relativzeit results: Timeoutdiagnose aktiv/Timeoutdiagnose nicht aktiv |
| STAT_DREHMOMENTANFORDERUNG_ACC_TEXT | string | Drehmomentanforderung ACC results: Timeoutdiagnose aktiv/Timeoutdiagnose nicht aktiv |
| STAT_VERZOEGERUNGSANFORDERUNG_EMF_TEXT | string | Verzögerungsanforderung EMF results: Timeoutdiagnose aktiv/Timeoutdiagnose nicht aktiv |
| STAT_KILOMETERSTAND_TEXT | string | Kilometerstand results: Timeoutdiagnose aktiv/Timeoutdiagnose nicht aktiv |
| STAT_SITZBELEGUNG_GURTKONTAKTE_TEXT | string | Sitzbelegung Gurtkontakte results: Timeoutdiagnose aktiv/Timeoutdiagnose nicht aktiv |
| STAT_BEDIENUNG_GETRIEBEWAHLSCHALTER_TEXT | string | Bedienung Getriebewahlschalter results: Timeoutdiagnose aktiv/Timeoutdiagnose nicht aktiv |
| STAT_POWERMANAGEMENT_BATTERIESPANNUNG_TEXT | string | Powermanagement Batteriespannung results: Timeoutdiagnose aktiv/Timeoutdiagnose nicht aktiv |
| STAT_ANHAENGERMODUL_TEXT | string | Anhaengermodul results: Timeoutdiagnose aktiv/Timeoutdiagnose nicht aktiv |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
| _TEL_AUFTRAG | binary | Hex-Auftrag an SG |
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_PF_1_WERT | real | Fuelldruck Adaption Kupplung A |
| STAT_PF_2_WERT | real | Fuelldruck Adaption Kupplung B |
| STAT_PF_3_WERT | real | Fuelldruck Adaption Kupplung C |
| STAT_PF_4_WERT | real | Fuelldruck Adaption Kupplung D |
| STAT_PF_5_WERT | real | Fuelldruck Adaption Kupplung E |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
| _TEL_AUFTRAG | binary | Hex-Auftrag an SG |
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_SF_1_WERT | real | Schnellfuelzeit Adaption Kupplung A |
| STAT_SF_2_WERT | real | Schnellfuelzeit Adaption Kupplung B |
| STAT_SF_3_WERT | real | Schnellfuelzeit Adaption Kupplung C |
| STAT_SF_4_WERT | real | Schnellfuelzeit Adaption Kupplung D |
| STAT_SF_5_WERT | real | Schnellfuelzeit Adaption Kupplung E |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
| _TEL_AUFTRAG | binary | Hex-Auftrag an SG |
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_ADA_1_WERT | real | Beeinflussungs-Adaption GLÜ 12 Schaltung |
| STAT_ADA_2_WERT | real | Beeinflussungs-Adaption GLÜ 23 Schaltung |
| STAT_ADA_3_WERT | real | Beeinflussungs-Adaption GLÜ 34 Schaltung |
| STAT_ADA_4_WERT | real | Beeinflussungs-Adaption GLÜ 45 Schaltung |
| STAT_ADA_5_WERT | real | Beeinflussungs-Adaption GLÜ 56 Schaltung |
| STAT_ADA_6_WERT | real | Beeinflussungs-Adaption GLS 12 Schaltung |
| STAT_ADA_7_WERT | real | Beeinflussungs-Adaption GLS 23 Schaltung |
| STAT_ADA_8_WERT | real | Beeinflussungs-Adaption GLS 34 Schaltung |
| STAT_ADA_9_WERT | real | Beeinflussungs-Adaption GLS 45 Schaltung |
| STAT_ADA_10_WERT | real | Beeinflussungs-Adaption GLS 56 Schaltung |
| STAT_ADA_11_WERT | real | Beeinflussungs-Rueck-Adaption GLS 21 Schaltung |
| STAT_ADA_12_WERT | real | Beeinflussungs-Rueck-Adaption GLS 32 Schaltung |
| STAT_ADA_13_WERT | real | Beeinflussungs-Rueck-Adaption GLS 43 Schaltung |
| STAT_ADA_14_WERT | real | Beeinflussungs-Rueck-Adaption GLS 54 Schaltung |
| STAT_ADA_15_WERT | real | Beeinflussungs-Rueck-Adaption GLS 65 Schaltung |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
| _TEL_AUFTRAG | binary | Hex-Auftrag an SG |
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_SBC_1_WERT | real | NIC Adaptionswert 1 |
| STAT_SBC_2_WERT | real | NIC Adaptionswert 2 |
| STAT_SBC_3_WERT | real | NIC Adaptionswert 3 |
| STAT_SBC_4_WERT | real | NIC Adaptionswert 4 |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
| _TEL_AUFTRAG | binary | Hex-Auftrag an SG |
...
<a id="job-status-adaptionspruefzaehler"></a>
### STATUS_ADAPTIONSPRUEFZAEHLER

Auslesen der AdationsPrüfzähler KWP2000: $21 ReadDataByLocalIdentifier Modus  : Default
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_PRUEFZAEHLER_PF_1 | real | Fuelldruck Adaption Kupplung A |
| STAT_PRUEFZAEHLER_PF_2 | real | Fuelldruck Adaption Kupplung B |
| STAT_PRUEFZAEHLER_PF_3 | real | Fuelldruck Adaption Kupplung C |
| STAT_PRUEFZAEHLER_PF_4 | real | Fuelldruck Adaption Kupplung D |
| STAT_PRUEFZAEHLER_PF_5 | real | Fuelldruck Adaption Kupplung E |
| STAT_PRUEFZAEHLER_SF_1 | real | Schnellfuelzeit Adaption Kupplung A |
| STAT_PRUEFZAEHLER_SF_2 | real | Schnellfuelzeit Adaption Kupplung B |
| STAT_PRUEFZAEHLER_SF_3 | real | Schnellfuelzeit Adaption Kupplung C |
| STAT_PRUEFZAEHLER_SF_4 | real | Schnellfuelzeit Adaption Kupplung D |
| STAT_PRUEFZAEHLER_SF_5 | real | Schnellfuelzeit Adaption Kupplung E |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
| _TEL_AUFTRAG | binary | Hex-Auftrag an SG |

<a id="job-steuern-pulsadaptionswerte-loeschen"></a>
### STEUERN_PULSADAPTIONSWERTE_LOESCHEN

alle Pulsadaptionwerte ruecksetzen KWP2000: $31 StartRoutineByLocalIdentifier Modus  : Default
...
<a id="job-backup-fs-1-10-lesen"></a>
### BACKUP_FS_1_10_LESEN
...
<a id="job-backup-fs-11-20-lesen"></a>
### BACKUP_FS_11_20_LESEN
...
<a id="job-steuern-trigger-flag-ein"></a>
### STEUERN_TRIGGER_FLAG_EIN

Einschalten des CAN Triggers KWP2000: $31 StartRoutineByLocalIdentifier Modus  : Default
...
<a id="job-steuern-trigger-flag-aus"></a>
### STEUERN_TRIGGER_FLAG_AUS

Abschalten des CAN Triggers KWP2000: $31 StartRoutineByLocalIdentifier Modus  : Default
...
Auslesen des Status KWP2000: $21 ReadDataByLocalIdentifier Modus  : Default
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_ISN_PRESENT_WERT | int | EWS Bereich: 0=nicht aktiv  1=aktiv |
| STAT_ISN_PRESENT_TEXT | string | EWS  |
| STAT_ISN_K_RECEIVED_WERT | int | EWS Bereich: 0=nicht aktiv  1=aktiv |
| STAT_ISN_K_RECEIVED_TEXT | string | EWS  |
| STAT_ISN_CAN_RECEIVED_WERT | int | EWS Bereich: 0=nicht aktiv  1=aktiv |
| STAT_ISN_CAN_RECEIVED_TEXT | string | EWS  |
| STAT_AUTHENTICATED_WERT | int | EWS Bereich: 0=nicht aktiv  1=aktiv |
| STAT_AUTHENTICATED_TEXT | string | EWS  |
| STAT_VERSION_WERT | int | Version der EWS_EGS-Schnittstelle Bereich:0b0000...0b1111 |
| STAT_COUNTER_CAN_WERT | int | falsch empfangene ISN der PT_CAN Bereich:0b0000...0b1111 |
| STAT_COUNTER_K_WERT | int | falsch empfangene ISN der K-Line Bereich:0b0000...0b1111 |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
| _TEL_AUFTRAG | binary | Hex-Auftrag an SG |
...
Rücksetzen auf jungfräulich KWP2000: $31 StartRoutineByLocalIdentifier Modus  : Default
...
<a id="job-steuern-isn-zaehler-ruecksetzen"></a>
### STEUERN_ISN_ZAEHLER_RUECKSETZEN

Rücksetzen des ISN Zählers KWP2000: $31 StartRoutineByLocalIdentifier Modus  : Default
...
Hilferuf in Pos DR KWP2000: $21 Modus  : Default
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_ZAEHLER_WERT_DR | real | Bereich:0x00...0xFF  |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
| _TEL_AUFTRAG | binary | Hex-Auftrag an SG |
...
Auslesen des Codierstatus KWP2000: $21 ReadDataByLocalIdentifier Modus  : Default
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_CODIERUNG_WERT | int | CODIERUNG Bereich:0...1 0=SG nicht codiert 1=SG codiert |
| STAT_CODIERUNG_TEXT | string | Codierung  |
| STAT_CODIERUNG_NIC_WERT | int | NIC Bereich: 0=nicht aktiv  1=aktiv |
| STAT_CODIERUNG_NIC_TEXT | string | NIC  |
| STAT_CODIERUNG_EL_INTERLOCK_WERT | int | EL_INTERLOCK Bereich: 0=nicht aktiv  1=aktiv |
| STAT_CODIERUNG_EL_INTERLOCK_TEXT | string | EL_INTERLOCK  |
| STAT_CODIERUNG_MIL_SCAN_TOOL_WERT | int | CODIERUNG Bereich:0...8 |
| STAT_CODIERUNG_MIL_SCAN_TOOL_TEXT | string | Codierung  |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
| _TEL_AUFTRAG | binary | Hex-Auftrag an SG |
...
- [FUMWELTMATRIX](#table-fumweltmatrix) (97 × 5)
- [FUMWELTTEXTE](#table-fumwelttexte) (152 × 9)
- [FARTTYP](#table-farttyp) (97 × 5)
- [FARTTEXTEINDIVIDUELL](#table-farttexteindividuell) (134 × 2)
- [HORTTEXTE](#table-horttexte) (1 × 2)
- [HDETAILSTRUKTUR](#table-hdetailstruktur) (7 × 2)
- [IORTTEXTE](#table-iorttexte) (28 × 2)
- [IDETAILSTRUKTUR](#table-idetailstruktur) (7 × 2)
- [IUMWELTMATRIX](#table-iumweltmatrix) (28 × 5)
- [IUMWELTTEXTE](#table-iumwelttexte) (116 × 9)
- [IARTTYP](#table-iarttyp) (28 × 5)
- [IARTTEXTEINDIVIDUELL](#table-iarttexteindividuell) (43 × 2)
- [CONTROLSTATEUMRECHNUNG](#table-controlstateumrechnung) (4 × 2)
- [IDENTIFIER_LESEN](#table-identifier-lesen) (16 × 5)
- [IDENTIFIER_SETZEN](#table-identifier-setzen) (13 × 5)
- [FORTRBBMW](#table-fortrbbmw) (139 × 2)
- [ERSTELLER](#table-ersteller) (26 × 2)
...
- [RDI_MASSN7](#table-rdi-massn7) (1 × 9)
- [RDI_MASSN6](#table-rdi-massn6) (1 × 9)
- [RDI_MASSN5](#table-rdi-massn5) (1 × 9)
- [RDI_MASSN4](#table-rdi-massn4) (1 × 9)
- [SSK_LEV2L](#table-ssk-lev2l) (1 × 6)
- [SSK_LEV2H](#table-ssk-lev2h) (1 × 6)
...
| 0x507B | 0x01 | sgt_Inp0 | 0x02 | sgt_Out0 |
| 0x507D | 0x05 | sgt_Sig0 | 0x02 | sgt_Out0 |
| 0x5087 | sgt_Inp0 | 0x04 | sgt_Gear0 | 0x06 |
| 0x5089 | sgt_Inp0 | sgt_Sig0 | 0x04 | 0x01 |
| 0x50DD | rdi_massn4 | rdi_massn5 | rdi_massn6 | rdi_massn7 |
| 0x51A6 | 0x05 | 0x04 | sgt_Can0 | 0x0B |
...
| 0xCF33 | 0x0C | 0x04 | sgt_Can0 | 0x05 |
| 0xCF34 | 0x0C | 0x04 | sgt_Can0 | 0x05 |
| 0xCF35 | 0x0C | 0x04 | sgt_Can0 | 0x05 |
...
| 0x4F9D | 0x0C | 0x04 | sgt_Can0 | 0x0B |
| 0x4F9B | 0x0B | 0x01 | 0x03 | 0x07 |
| 0x4F9A | 0x0B | 0x01 | 0x03 | 0x07 |
| 0x4F99 | 0x0B | 0x01 | 0x03 | 0x07 |
| 0x4F98 | 0x0B | 0x01 | 0x03 | 0x07 |
| 0x51B0 | sgt_Sig2 | 0x04 | sgt_Can0 | sgt_Sig3 |
| 0x511B | 0x04 | 0x03 | 0x0E | 0x90 |
| 0x4E90 | sgt_Gear0 | 0x01 | 0x02 | sgt_Out0 |
| 0xCF2E | 0x0C | 0x04 | sgt_Sig3 | 0x90 |
| 0xCF2F | 0x0C | 0x04 | sgt_Sig3 | 0x90 |
| 0xCF30 | 0x0C | 0x04 | sgt_Can0 | 0x03 |
| 0x4FB4 | 0x01 | 0x03 | 0x0C | 0x02 |
| 0x4F6C | 0x0B | 0x01 | sgt_Gear0 | 0x05 |
| 0x4F6D | 0x0B | 0x01 | sgt_Gear0 | 0x05 |
| 0x4E8A | sgt_Gear0 | 0x01 | sgt_Inp0 | sgt_Out0 |
| 0xCF37 | 0x0C | 0x04 | sgt_Can0 | 0x03 |
| 0x5123 | 0x01 | 0x04 | sgt_Can0 | 0x05 |
| 0x4FBE | 0x04 | 0x02 | 0x03 | 0x02 |
| 0x4F73 | 0x03 | 0x05 | 0x01 | 0x04 |
| 0x50DC | sgt_Can0 | 0x04 | sgt_Sig3 | 0x90 |
| 0x4FB8 | ssk_Lev2H | ssk_Lev2L | 0xFE | 0x0E |
| 0x5088 | sgt_Inp0 | 0x17 | 0x03 | 0x01 |
| 0x5120 | 0x05 | 0x04 | 0x01 | 0x03 |
| 0x4F9E | 0x03 | 0x09 | 0x01 | sgt_Gear0 |
| 0x4F9F | 0x03 | 0x09 | 0x0E | sgt_Sig0 |
| 0xFFFF | 0xFF | 0xFF | 0xFF | 0xFF |

<a id="table-fumwelttexte"></a>
### FUMWELTTEXTE

Dimensions: 152 rows × 9 columns
...
| 0x13 | Status Oeltemperatursensor | 0-n | - | 0x03 | TEMP1_TAB | 1 | 1 | 0 |
| 0x14 | Status Substrattemperatursensor | 0-n | - | 0x0B | TEMP2_TAB | 1 | 1 | 0 |
| 0x15 | Status Spannungsregelung (0=iO, 1=niO) | 0/1 | - | 0x10 | - | 1 | 1 | 0 |
| 0x16 | Heissabschaltung in Initphase (0=nein, 1=ja) | 0/1 | - | 0x20 | - | 1 | 1 | 0 |
...
| 0x1D | Getriebeoeltemperatur Neu | Grad C | - | unsigned char | - | 1 | 1 | -40 |
| 0x20 | Zustand WK | 0-n | - | 0x60 | WK_TAB | 1 | 1 | 0 |
| 0x21 | Schaltart | 0-n | - | 0x1F | SA_TAB | 1 | 1 | 0 |
| 0x22 | Sollzustand M1            (0=aus 1=an) | 0/1 | - | 0x80 | - | 1 | 1 | 0 |
| 0x23 | Sollzustand M2            (0=aus 1=an) | 0/1 | - | 0x40 | - | 1 | 1 | 0 |
| 0x24 | Sollzustand M3 Peek Phase (0=aus 1=an) | 0/1 | - | 0x20 | - | 1 | 1 | 0 |
| 0x25 | Sollzustand M3 Hold Phase (0=aus 1=an) | 0/1 | - | 0x10 | - | 1 | 1 | 0 |
| 0x26 | Sollzustand M4            (0=aus 1=an) | 0/1 | - | 0x08 | - | 1 | 1 | 0 |
| 0x30 | Pegel an L1 Pin           (1=low 0=high) | 0/1 | - | 0x80 | - | 1 | 1 | 0 |
| 0x31 | Pegel an L2 Pin           (1=low 0=high) | 0/1 | - | 0x40 | - | 1 | 1 | 0 |
| 0x32 | Pegel an L3 Pin           (1=low 0=high) | 0/1 | - | 0x20 | - | 1 | 1 | 0 |
| 0x33 | Pegel an L4 Pin           (1=low 0=high) | 0/1 | - | 0x10 | - | 1 | 1 | 0 |
| 0x34 | Pegel an Tip+ Pin         (1=low 0=high) | 0/1 | - | 0x08 | - | 1 | 1 | 0 |
| 0x35 | Pegel an Tip- Pin         (1=low 0=high) | 0/1 | - | 0x04 | - | 1 | 1 | 0 |
| 0x36 | Pegel an M-Gassen Pin     (1=low 0=high) | 0/1 | - | 0x02 | - | 1 | 1 | 0 |
| 0x40 | Status Substrattemp.      (0=iO, 1=F/ES) | 0/1 | - | 0x20 | - | 1 | 1 | 0 |
| 0x41 | Status Getriebeoeltemp.   (0=iO, 1=F/ES) | 0/1 | - | 0x10 | - | 1 | 1 | 0 |
| 0x42 | Status Parksperrensensor  (0=iO, 1=F/ES) | 0/1 | - | 0x08 | - | 1 | 1 | 0 |
| 0x43 | Status Positionssensor    (0=iO, 1=F/ES) | 0/1 | - | 0x04 | - | 1 | 1 | 0 |
| 0x44 | Status Turbinendrehzahl   (0=iO, 1=F/ES) | 0/1 | - | 0x02 | - | 1 | 1 | 0 |
| 0x45 | Status Abtriebsdrehzahl   (0=iO, 1=F/ES) | 0/1 | - | 0x01 | - | 1 | 1 | 0 |
| 0x50 | Status Motordrehzahl      (0=iO, 1=F/ES) | 0/1 | - | 0x80 | - | 1 | 1 | 0 |
| 0x51 | Status Fahrpedal          (0=iO, 1=F/ES) | 0/1 | - | 0x40 | - | 1 | 1 | 0 |
| 0x52 | Status Parksperrenanf.    (0=aus,1=ein ) | 0/1 | - | 0x20 | - | 1 | 1 | 0 |
| 0x53 | Status Motoristmoment     (0=iO, 1=F/ES) | 0/1 | - | 0x01 | - | 1 | 1 | 0 |
| 0x60 | Status Bremssignal        (0=iO, 1=F/ES) | 0/1 | - | 0x20 | - | 1 | 1 | 0 |
| 0x61 | Status Drehrichtung       (0=iO, 1=F/ES) | 0/1 | - | 0x10 | - | 1 | 1 | 0 |
| 0x62 | Status Radgeschw HL       (0=iO, 1=F/ES) | 0/1 | - | 0x08 | - | 1 | 1 | 0 |
| 0x63 | Status Radgeschw HR       (0=iO, 1=F/ES) | 0/1 | - | 0x04 | - | 1 | 1 | 0 |
| 0x64 | Status Radgeschw VL       (0=iO, 1=F/ES) | 0/1 | - | 0x02 | - | 1 | 1 | 0 |
| 0x65 | Status Radgeschw VR       (0=iO, 1=F/ES) | 0/1 | - | 0x01 | - | 1 | 1 | 0 |
| 0x70 | Status S-Taster CAN       (0=iO, 1=F/ES) | 0/1 | - | 0x80 | - | 1 | 1 | 0 |
| 0x71 | Status Tip-Taster CAN     (0=iO, 1=F/ES) | 0/1 | - | 0x40 | - | 1 | 1 | 0 |
| 0x72 | Status Position ser. Ltg  (0=iO, 1=F/ES) | 0/1 | - | 0x20 | - | 1 | 1 | 0 |
| 0x73 | Status Position CAN       (0=iO, 1=F/ES) | 0/1 | - | 0x10 | - | 1 | 1 | 0 |
| 0x74 | Status Fahrertuer CAN     (0=iO, 1=F/ES) | 0/1 | - | 0x08 | - | 1 | 1 | 0 |
| 0x75 | Status Fahrersitz CAN     (0=iO, 1=F/ES) | 0/1 | - | 0x04 | - | 1 | 1 | 0 |
| 0x76 | Status Schluessel CAN     (0=iO, 1=F/ES) | 0/1 | - | 0x02 | - | 1 | 1 | 0 |
| 0x77 | Status Kl15 Signal CAN    (0=iO, 1=F/ES) | 0/1 | - | 0x01 | - | 1 | 1 | 0 |
| 0x80 | Standardabsicherung ACC   (0=iO, 1=Fehler) | 0/1 | - | 0x10 | - | 1 | 1 | 0 |
| 0x81 | Standardabsicherung CAS   (0=iO, 1=Fehler) | 0/1 | - | 0x08 | - | 1 | 1 | 0 |
| 0x82 | Standardabsicherung DME3  (0=iO, 1=Fehler) | 0/1 | - | 0x04 | - | 1 | 1 | 0 |
| 0x83 | Standardabsicherung DME2  (0=iO, 1=Fehler) | 0/1 | - | 0x02 | - | 1 | 1 | 0 |
| 0x84 | Standardabsicherung DME1  (0=iO, 1=Fehler) | 0/1 | - | 0x01 | - | 1 | 1 | 0 |
| 0x90 | Status Zuendung | 0-n | - | 0x07 | ZUEND_TAB | 1 | 1 | 0 |
| 0x91 | Abgleichdaten Checksumme  (0=iO, 1=Fehler) | 0/1 | - | 0x10 | - | 1 | 1 | 0 |
| 0x92 | Bootloader Checksumme     (0=iO, 1=Fehler) | 0/1 | - | 0x08 | - | 1 | 1 | 0 |
| 0x93 | Kundenblock Checksumme    (0=iO, 1=Fehler) | 0/1 | - | 0x04 | - | 1 | 1 | 0 |
| 0x94 | Drive Programm Checksumme (0=iO, 1=Fehler) | 0/1 | - | 0x02 | - | 1 | 1 | 0 |
| 0x95 | Drive Daten Checksumme    (0=iO, 1=Fehler) | 0/1 | - | 0x01 | - | 1 | 1 | 0 |
| 0x98 | Daten FastChecksumme      (0=iO, 1=Fehler) | 0/1 | - | 0x02 | - | 1 | 1 | 0 |
| 0x99 | Konstanten FastChecksumme (0=iO, 1=Fehler) | 0/1 | - | 0x01 | - | 1 | 1 | 0 |
| 0xA0 | Stand By Control AUS      (0=iO, 1=aktiv) | 0/1 | - | 0x80 | - | 1 | 1 | 0 |
| 0xA1 | Lowside FETs AUS          (0=iO, 1=aktiv) | 0/1 | - | 0x40 | - | 1 | 1 | 0 |
| 0xA2 | MV4 Lowside AUS           (0=iO, 1=aktiv) | 0/1 | - | 0x20 | - | 1 | 1 | 0 |
| 0xA3 | MV3 Lowside AUS           (0=iO, 1=aktiv) | 0/1 | - | 0x10 | - | 1 | 1 | 0 |
| 0xA4 | Notlaufflag ACC           (0=iO, 1=aktiv) | 0/1 | - | 0x08 | - | 1 | 1 | 0 |
| 0xA5 | Max.Systemdruck           (0=iO, 1=aktiv) | 0/1 | - | 0x04 | - | 1 | 1 | 0 |
| 0xA6 | Minimalbestromung 0mA     (0=iO, 1=aktiv) | 0/1 | - | 0x02 | - | 1 | 1 | 0 |
| 0xA7 | Mechanischer Notlauf      (0=iO, 1=aktiv) | 0/1 | - | 0x01 | - | 1 | 1 | 0 |
| 0xA8 | Schalten in G4 und halten (0=iO, 1=aktiv) | 0/1 | - | 0x80 | - | 1 | 1 | 0 |
| 0xA9 | Schalten in G5 und halten (0=iO, 1=aktiv) | 0/1 | - | 0x40 | - | 1 | 1 | 0 |
| 0xAA | Aktuellen Gang halten     (0=iO, 1=aktiv) | 0/1 | - | 0x20 | - | 1 | 1 | 0 |
| 0xAB | Shift Lock AUS            (0=iO, 1=aktiv) | 0/1 | - | 0x10 | - | 1 | 1 | 0 |
| 0xAC | Nab aus Nrad              (0=iO, 1=aktiv) | 0/1 | - | 0x08 | - | 1 | 1 | 0 |
| 0xAD | Nrad aus Nab              (0=iO, 1=aktiv) | 0/1 | - | 0x04 | - | 1 | 1 | 0 |
| 0xAE | Kein S/M Programm         (0=iO, 1=aktiv) | 0/1 | - | 0x02 | - | 1 | 1 | 0 |
| 0xAF | Wandlerkupplung AUF       (0=iO, 1=aktiv) | 0/1 | - | 0x01 | - | 1 | 1 | 0 |
| 0xB0 | Adaptionswerte AUS        (0=iO, 1=aktiv) | 0/1 | - | 0x80 | - | 1 | 1 | 0 |
| 0xB1 | nicht realisiert                          | 0/1 | - | 0x40 | - | 1 | 1 | 0 |
| 0xB2 | El. Notprogramm G2        (0=iO, 1=aktiv) | 0/1 | - | 0x20 | - | 1 | 1 | 0 |
| 0xB3 | El. Notprogramm G3        (0=iO, 1=aktiv) | 0/1 | - | 0x10 | - | 1 | 1 | 0 |
| 0xB4 | El. Notprogramm G6        (0=iO, 1=aktiv) | 0/1 | - | 0x08 | - | 1 | 1 | 0 |
| 0xB5 | El. Notprogramm G5        (0=iO, 1=aktiv) | 0/1 | - | 0x04 | - | 1 | 1 | 0 |
| 0xB6 | El. Notprogramm G4        (0=iO, 1=aktiv) | 0/1 | - | 0x02 | - | 1 | 1 | 0 |
| 0xB7 | El. Notprogramm G3/G5     (0=iO, 1=aktiv) | 0/1 | - | 0x01 | - | 1 | 1 | 0 |
| 0xB8 | El. Notprogramm G5        (0=iO, 1=aktiv) | 0/1 | - | 0x80 | - | 1 | 1 | 0 |
| 0xB9 | Kein Fahrerwunsch D       (0=iO, 1=aktiv) | 0/1 | - | 0x40 | - | 1 | 1 | 0 |
| 0xBA | Bedingtes Schalten G2     (0=iO, 1=aktiv) | 0/1 | - | 0x20 | - | 1 | 1 | 0 |
| 0xBB | Bedingtes Schalten G1     (0=iO, 1=aktiv) | 0/1 | - | 0x10 | - | 1 | 1 | 0 |
| 0xBC | Bedingtes Schalten G4     (0=iO, 1=aktiv) | 0/1 | - | 0x08 | - | 1 | 1 | 0 |
| 0xBD | Bedingtes Schalten G3     (0=iO, 1=aktiv) | 0/1 | - | 0x04 | - | 1 | 1 | 0 |
| 0xBE | Kein Fahrerwunsch R       (0=iO, 1=aktiv) | 0/1 | - | 0x02 | - | 1 | 1 | 0 |
| 0xBF | Moduliertes Schalten G3   (0=iO, 1=aktiv) | 0/1 | - | 0x01 | - | 1 | 1 | 0 |
| 0xD0 | nicht realisiert                          | 0/1 | - | 0x80 | - | 1 | 1 | 0 |
| 0xD1 | nicht realisiert                          | 0/1 | - | 0x40 | - | 1 | 1 | 0 |
| 0xD2 | nicht realisiert                          | 0/1 | - | 0x20 | - | 1 | 1 | 0 |
| 0xD3 | keine Strangverstärkung   (0=iO, 1=aktiv) | 0/1 | - | 0x10 | - | 1 | 1 | 0 |
| 0xD4 | kein Motoreingriff        (0=iO, 1=aktiv) | 0/1 | - | 0x08 | - | 1 | 1 | 0 |
| 0xD5 | Displayposition deaktiviert (0=iO, 1=aktiv) | 0/1 | - | 0x04 | - | 1 | 1 | 0 |
| 0xD6 | Reduziertes Anfahrmoment  (0=iO, 1=aktiv) | 0/1 | - | 0x02 | - | 1 | 1 | 0 |
| 0xD7 | Position P halten         (0=iO, 1=aktiv) | 0/1 | - | 0x01 | - | 1 | 1 | 0 |
| 0xD8 | nicht realisiert                          | 0/1 | - | 0x80 | - | 1 | 1 | 0 |
| 0xD9 | nicht realisiert                          | 0/1 | - | 0x40 | - | 1 | 1 | 0 |
| 0xDA | nicht realisiert                          | 0/1 | - | 0x20 | - | 1 | 1 | 0 |
| 0xDB | nicht realisiert                          | 0/1 | - | 0x10 | - | 1 | 1 | 0 |
| 0xDC | nicht realisiert                          | 0/1 | - | 0x08 | - | 1 | 1 | 0 |
| 0xDD | nicht realisiert                          | 0/1 | - | 0x04 | - | 1 | 1 | 0 |
| 0xDE | nicht realisiert                          | 0/1 | - | 0x02 | - | 1 | 1 | 0 |
| 0xDF | nicht realisiert                          | 0/1 | - | 0x01 | - | 1 | 1 | 0 |
| 0xE0 | nicht realisiert                          | 0/1 | - | 0x80 | - | 1 | 1 | 0 |
| 0xE1 | nicht realisiert                          | 0/1 | - | 0x40 | - | 1 | 1 | 0 |
| 0xE2 | nicht realisiert                          | 0/1 | - | 0x20 | - | 1 | 1 | 0 |
| 0xE3 | nicht realisiert                          | 0/1 | - | 0x10 | - | 1 | 1 | 0 |
| 0xE4 | nicht realisiert                          | 0/1 | - | 0x08 | - | 1 | 1 | 0 |
| 0xE5 | nicht realisiert                          | 0/1 | - | 0x04 | - | 1 | 1 | 0 |
| 0xE6 | nicht realisiert                          | 0/1 | - | 0x02 | - | 1 | 1 | 0 |
| 0xE7 | nicht realisiert                          | 0/1 | - | 0x01 | - | 1 | 1 | 0 |
| 0xE8 | Systemdruckregler Aus     (0=iO, 1=aktiv) | 0/1 | - | 0x80 | - | 1 | 1 | 0 |
| 0xE9 | WK-Druckregler Aus        (0=iO, 1=aktiv) | 0/1 | - | 0x40 | - | 1 | 1 | 0 |
| 0xEA | nicht realisiert                          | 0/1 | - | 0x20 | - | 1 | 1 | 0 |
| 0xEB | nicht realisiert                          | 0/1 | - | 0x10 | - | 1 | 1 | 0 |
| 0xEC | nicht realisiert                          | 0/1 | - | 0x08 | - | 1 | 1 | 0 |
| 0xED | nicht realisiert                          | 0/1 | - | 0x04 | - | 1 | 1 | 0 |
| 0xEE | nicht realisiert                          | 0/1 | - | 0x02 | - | 1 | 1 | 0 |
| 0xEF | nicht realisiert                          | 0/1 | - | 0x01 | - | 1 | 1 | 0 |
| 0xF0 | Fahrerwunsch vom CAN   (0=iO, 1=aktiv) | 0/1 | - | 0x80 | - | 1 | 1 | 0 |
| 0xF1 | Fahrerwunsch von SZL  (0=iO, 1=aktiv) | 0/1 | - | 0x40 | - | 1 | 1 | 0 |
| 0xF2 | Auto-P Bestimmung  (0=iO, 1=aktiv) | 0/1 | - | 0x20 | - | 1 | 1 | 0 |
| 0xF3 | autom. oder manuelle  (0=iO, 1=aktiv) | 0/1 | - | 0x10 | - | 1 | 1 | 0 |
| 0xF4 | ber. Pos zur Anzeige aus (0=iO, 1=aktiv) | 0/1 | - | 0x08 | - | 1 | 1 | 0 |
...
| --- | --- | --- | --- | --- |
| 0xCF33 | 0x0010 | 0x0020 | 0x0030 | 0x0040 |
| 0xCF34 | 0x0010 | 0x0020 | 0x0030 | 0x0040 |
| 0xCF35 | 0x0010 | 0x0020 | 0x0030 | 0x0040 |
...
| 0x51A6 | 0x0040 | 0x00D7 | 0x00D6 | 0x0040 |
...
| 0x4F72 | 0x0040 | 0x00D9 | 0x0040 | 0x0040 |
| 0x507B | 0x0040 | 0x0078 | 0x0040 | 0x0054 |
...
| 0x5087 | 0x0056 | 0x0056 | 0x0040 | 0x00E6 |
...
| 0x4FBA | 0x00B3 | 0x00B2 | 0x00B1 | 0x00B0 |
| 0x4FBB | 0x00B3 | 0x00B2 | 0x00B1 | 0x00B0 |
| 0x4F9D | 0x0040 | 0x0040 | 0x00CB | 0x00CA |
| 0x4F9B | 0x0051 | 0x0040 | 0x0040 | 0x0040 |
| 0x4F9A | 0x0051 | 0x0040 | 0x0040 | 0x0040 |
| 0x4F99 | 0x0051 | 0x0040 | 0x0040 | 0x0040 |
| 0x4F98 | 0x0051 | 0x0040 | 0x0040 | 0x0040 |
| 0x51B0 | 0x00C9 | 0x0040 | 0x0040 | 0x0040 |
| 0x511B | 0x0040 | 0x0040 | 0x0040 | 0x00CF |
| 0x4E90 | 0x0040 | 0x0069 | 0x0074 | 0x0077 |
| 0xCF2E | 0x0053 | 0x0040 | 0x0040 | 0x0040 |
| 0xCF2F | 0x0040 | 0x0010 | 0x0020 | 0x0030 |
| 0xCF30 | 0x0040 | 0x0010 | 0x0020 | 0x0030 |
| 0x4FB4 | 0x00D5 | 0x00D4 | 0x00D3 | 0x00D2 |
| 0x4F6C | 0x00CD | 0x0040 | 0x0040 | 0x0040 |
| 0x4F6D | 0x0040 | 0x00CE | 0x0040 | 0x00CC |
| 0x4E8A | 0x00D8 | 0x0040 | 0x0040 | 0x0040 |
| 0xCF37 | 0x0010 | 0x0020 | 0x0040 | 0x0040 |
| 0x5123 | 0x00DE | 0x00DD | 0x00DC | 0x00DB |
| 0x4FBE | 0x0040 | 0x0040 | 0x0040 | 0x00DF |
| 0x4F73 | 0x00E0 | 0x0040 | 0x0040 | 0x0040 |
| 0x50DC | 0x0081 | 0x0040 | 0x0040 | 0x0040 |
| 0x4FB8 | 0x0040 | 0x00A7 | 0x0040 | 0x00A5 |
| 0x5088 | 0x0058 | 0x0078 | 0x0040 | 0x0040 |
| 0x5120 | 0x00E1 | 0x0040 | 0x0040 | 0x0040 |
| 0x4F9E | 0x00E4 | 0x00E3 | 0x0040 | 0x00E2 |
| 0x4F9F | 0x0040 | 0x00E5 | 0x0040 | 0x00E2 |
...
| 0x0054 | Parksperrenposition ungültig |
...
| 0x0078 | elektrischer Fehler L3, L4 |
...
| 0x00B0 | Störzähler 1 EDS &gt; Grenzwert |
| 0x00B1 | Störzähler 2 EDS &gt; Grenzwert |
| 0x00B2 | Störzähler 3 EDS &gt; Grenzwert |
| 0x00B3 | Störzähler 4 EDS &gt; Grenzwert |
| 0x00B9 | Exception |
...
| 0x00C4 | Grenzwert der Getriebeölschädigung erreicht |
...
| 0x00CA | Überwachung des Nachrichteninhalts |
| 0x00CB | Überwachung auf Fehlerwert |
| 0x00CC | Level 2 Überwachung |
| 0x00CD | Inhalt Sende-Rücklesebotschaft unplausibel |
| 0x00CE | HPSYS-Plausibilisierung |
| 0x00CF | Codierung war fehlerhaft |
| 0x00D0 | Fehlerwert für Türkontakt ist fehlerhaft |
| 0x00D1 | Fehlerwert für Sitzbelegung ist fehlerhaft |
| 0x00D2 | Schalten ohne Fahrerwunsch |
| 0x00D3 | Schalten nicht möglich trotz Fahrerwunsch |
| 0x00D4 | eingelegte Position ungleich Positionsanzeige |
| 0x00D5 | Bedatungsfehler zwischen Level1 und Level2-Ebene |
| 0x00D6 | Motordrehzahl fehlerhaft |
| 0x00D7 | Motormoment fehlerhaft |
| 0x00D8 | Positionsventil klemmt |
| 0x00D9 | Hillholderfunktion gestört |
| 0x00DB | CAS CAN-Timeout & K-Bus CAS-Timeout |
| 0x00DC | Fehler CAS CAN-Signal & Fehler K-Bus-Signal von CAS |
| 0x00DD | CAS CAN-Timeout & Fehler K-Bus-Signal von CAS |
| 0x00DE | Fehler CAS CAN-Signal & K-Bus CAS Timeout |
| 0x00DF | Erkennung Unterspannungsreset |
| 0x00E0 | Betrieb ausserhalb spezifizierter Grenzen |
| 0x00E1 | Fehler Rückstellung GWS |
| 0x00E2 | Störung der WLC-Funktion |
| 0x00E3 | Bremsverzögerung WLC |
| 0x00E4 | Abbruchbedingung WLC-Funktion |
| 0x00E5 | Überschreitung der  WLC-Anfahrten |
| 0x00E6 | Zähler richtungsgleiche Mehrfachbetätigung Tippschalter überschritten |
...
| 0x510D | 0x04 | 0x01 | sgt_Gear0 | sgt_Sig0 |
| 0x510F | 0x03 | sgt_Sig3 | sgt_Gear0 | sgt_Sig0 |
| 0x5110 | 0x03 | sgt_Sig3 | sgt_Gear0 | sgt_Sig0 |
| 0x5116 | sgt_Inp0 | sgt_Gear0 | 0x03 | 0x01 |
| 0x5117 | sgt_Inp0 | sgt_Gear0 | 0x03 | 0x01 |
...
| 0x507C | 0x05 | sgt_Sig0 | 0x02 | sgt_Out0 |
| 0x51AD | sgt_Gear0 | 0x03 | 0x07 | 0x0E |
| 0x4F6F | sgt_Gear0 | 0x0B | 0x05 | 0x07 |
| 0x4EFD | 0x05 | 0x04 | 0x01 | 0x03 |
| 0x4EFE | 0x05 | 0x04 | 0x01 | 0x03 |
| 0x4F9C | 0x0B | 0x01 | sgt_Gear0 | 0x05 |
| 0x51B2 | 0x03 | sgt_Gear0 | sgt_Sig3 | 0x05 |
| 0x51B1 | 0x03 | sgt_Gear0 | sgt_Sig3 | 0x05 |
| 0x4F6E | 0x0B | 0x01 | sgt_Gear0 | 0x05 |
| 0xCF36 | 0x0C | 0x04 | sgt_Can0 | 0x05 |
| 0x5122 | 0x01 | 0x04 | sgt_Can0 | 0x05 |
| default | 0x01 | 0x02 | -- | -- |
...
| 0xA4 | Notlaufflag ACC           (0=iO, 1=aktiv) | 0/1 | - | 0x08 | - | 1 | 1 | 0 |
| 0xA5 | Max.Systemdruck           (0=iO, 1=aktiv) | 0/1 | - | 0x04 | - | 1 | 1 | 0 |
| 0xA6 | Reduzierung Anfahrbeschl. (0=iO, 1=aktiv) | 0/1 | - | 0x02 | - | 1 | 1 | 0 |
| 0xA7 | Mechanischer Notlauf      (0=iO, 1=aktiv) | 0/1 | - | 0x01 | - | 1 | 1 | 0 |
| 0xA8 | Schalten in G4 und halten (0=iO, 1=aktiv) | 0/1 | - | 0x80 | - | 1 | 1 | 0 |
| 0xA9 | Schalten in G5 und halten (0=iO, 1=aktiv) | 0/1 | - | 0x40 | - | 1 | 1 | 0 |
| 0xAA | Aktuellen Gang halten     (0=iO, 1=aktiv) | 0/1 | - | 0x20 | - | 1 | 1 | 0 |
...
| 0xB0 | Adaptionswerte AUS        (0=iO, 1=aktiv) | 0/1 | - | 0x80 | - | 1 | 1 | 0 |
| 0xB1 | nicht realisiert                          | 0/1 | - | 0x40 | - | 1 | 1 | 0 |
| 0xB2 | nicht realisiert                          | 0/1 | - | 0x20 | - | 1 | 1 | 0 |
| 0xB3 | nicht realisiert                          | 0/1 | - | 0x10 | - | 1 | 1 | 0 |
| 0xB4 | El. Notprogramm G5/G3     (0=iO, 1=aktiv) | 0/1 | - | 0x08 | - | 1 | 1 | 0 |
| 0xB5 | El. Notprogramm G5        (0=iO, 1=aktiv) | 0/1 | - | 0x04 | - | 1 | 1 | 0 |
| 0xB6 | nicht realisiert                          | 0/1 | - | 0x02 | - | 1 | 1 | 0 |
| 0xB7 | nicht realisiert                          | 0/1 | - | 0x01 | - | 1 | 1 | 0 |
| 0xB8 | Position P halten         (0=iO, 1=aktiv) | 0/1 | - | 0x80 | - | 1 | 1 | 0 |
| 0xB9 | Kein Fahrerwunsch D       (0=iO, 1=aktiv) | 0/1 | - | 0x40 | - | 1 | 1 | 0 |
| 0xBA | Bedingtes Schalten G2     (0=iO, 1=aktiv) | 0/1 | - | 0x20 | - | 1 | 1 | 0 |
| 0xBB | Bedingtes Schalten G1     (0=iO, 1=aktiv) | 0/1 | - | 0x10 | - | 1 | 1 | 0 |
| 0xBC | Bedingtes Schalten G4     (0=iO, 1=aktiv) | 0/1 | - | 0x08 | - | 1 | 1 | 0 |
...
| 0xBE | Kein Fahrerwunsch R       (0=iO, 1=aktiv) | 0/1 | - | 0x02 | - | 1 | 1 | 0 |
| 0xBF | Moduliertes Schalten G3   (0=iO, 1=aktiv) | 0/1 | - | 0x01 | - | 1 | 1 | 0 |
| 0xC0 | Zeitpunkt des Resets | 0-n | - | 0x07 | TTCurLast_TAB | 1 | 1 | 0 |
| 0xD1 | zgt_HotByte1 | - | - | unsigned char | - | 1 | 1 | 0 |
| 0xD3 | zgt_HotByte2 | - | - | unsigned char | - | 1 | 1 | 0 |
| 0xFE | nicht definiert | 1 | - | unsigned char | - | 1 | 1 | 0 |
| 0xFF | ohne Bedeutung | 1 | - | unsigned char | - | 1 | 1 | 0 |
| 0xXY | unbekannte Umweltbedingung | 1 | - | unsigned char | - | 1 | 1 | 0 |
...
| 0x510D | 0x009D | 0x0040 | 0x0040 | 0x0040 |
| 0x510F | 0x009E | 0x0040 | 0x0040 | 0x0040 |
| 0x5110 | 0x009F | 0x0040 | 0x0040 | 0x0040 |
| 0x5116 | 0x00A0 | 0x0040 | 0x0040 | 0x0040 |
| 0x5117 | 0x00A1 | 0x0040 | 0x0040 | 0x0040 |
...
| 0x4F9C | 0x00CD | 0x00CE | 0x0040 | 0x00CC |
| 0x51B2 | 0x0040 | 0x0040 | 0x0040 | 0x00D0 |
| 0x51B1 | 0x0040 | 0x0040 | 0x0040 | 0x00D1 |
| 0x4F6E | 0x0040 | 0x00CE | 0x0040 | 0x00CC |
| 0xCF36 | 0x0010 | 0x0020 | 0x0030 | 0x0040 |
| 0x5122 | 0x00DA | 0x0040 | 0x0040 | 0x0040 |
| defaut | 0x0008 | 0x0004 | 0x0002 | 0x0001 |
...
| 0x0092 | Symptom Gangüberwachung |
| 0x009C | Zwangshochschaltung 5-6 durch DME |
| 0x009D | Auto-P wegen CAS |
| 0x009E | Auto-P wegen Absicherung EMF |
| 0x009F | Auto-P wegen Hilferuf EMF |
| 0x00A0 | GWS EInfachfehler |
| 0x00A1 | Zwischenstellung GWS |
| 0x00A2 | Motordrehungleichförmigkeit |
| 0x00A4 | Parksperre fehlerhaft eingelegt |
| 0x00AE | CG122 konnte nicht abschalten |
| 0x00BA | WD Fehlerzähler |
...
| 0x00D0 | Fehlerwert für Türkontakt ist fehlerhaft |
| 0x00D1 | Fehlerwert für Sitzbelegung ist fehlerhaft |
| 0x00DA | falsche oder keine ISN eingegangen |
| 0xFFFF | unbekannte Fehlerart |
...
| IDENTIFIER | SIGNAL | 0X00 | 0X01 | 0X02 |
| --- | --- | --- | --- | --- |
| 0x01 | DR7 | 50mA | 50mA/800mA 1s | 800mA |
...
| UW_ANZ | UW1_NR | UW2_NR | UW3_NR | UW4_NR | UW5_NR | UW6_NR | UW7_NR | UW8_NR |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 8 | 0xD0 | 0xD1 | 0xD2 | 0xD3 | 0xD4 | 0xD5 | 0xD6 | 0xD7 |
...
| UW_ANZ | UW1_NR | UW2_NR | UW3_NR | UW4_NR | UW5_NR | UW6_NR | UW7_NR | UW8_NR |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 8 | 0xD8 | 0xD9 | 0xDA | 0xDB | 0xDC | 0xDD | 0xDE | 0xDF |
...
| UW_ANZ | UW1_NR | UW2_NR | UW3_NR | UW4_NR | UW5_NR | UW6_NR | UW7_NR | UW8_NR |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 8 | 0xE0 | 0xE1 | 0xE2 | 0xE3 | 0xE4 | 0xE5 | 0xE6 | 0xE7 |
...
| UW_ANZ | UW1_NR | UW2_NR | UW3_NR | UW4_NR | UW5_NR | UW6_NR | UW7_NR | UW8_NR |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 8 | 0xE8 | 0xE9 | 0xEA | 0xEB | 0xEC | 0xED | 0xEE | 0xEF |

<a id="table-ssk-lev2l"></a>
### SSK_LEV2L
...
| UW_ANZ | UW1_NR | UW2_NR | UW3_NR | UW4_NR | UW5_NR |
| --- | --- | --- | --- | --- | --- |
| 5 | 0xF0 | 0xF1 | 0xF2 | 0xF3 | 0xF4 |

<a id="table-ssk-lev2h"></a>
### SSK_LEV2H
