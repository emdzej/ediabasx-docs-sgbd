...
| Field | Value |
| --- | --- |
| ECU | Tuerelektronik Beifahrertuer |
...
| STAT_FH_ZU_TAST | char | Status Fenterheber-Taste Zu 1 = ein, 0 = aus |
| STAT_FH_AUF_TAST | char | Status Fensterheber-Taste Auf 1 = ein, 0 = aus |
| STAT_FH_AUTO_TAST | char | Status Fensterheber-Taste Auto 1 = ein, 0 = aus |
...
| STAT_FH_TAST_GESAMT | char | Status Fensterheber-Taste 0 = aus, 1 = zu, 2 = auf, 3 = auto |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| 0x9ba1 | Fensterheber Panik-Modus CC-Meldung aktiv |
| 0x???? | unbekannter Fehlerort |
