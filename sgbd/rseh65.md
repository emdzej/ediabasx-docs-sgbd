...
| Field | Value |
| --- | --- |
| ECU | Rear Seat Entertainment High (ICC) for E65 |
| ORIGIN | BMW ZS-I-23 Winfried Siegl |
| REVISION | 0.01 |
| AUTHOR | remes Systementwicklung WolfgangRapp |
| COMMENT | N/A |
| PACKAGE | 1.25 |
| SPRACHE | deutsch |
...
| ORT | ORTTEXT |
| --- | --- |
| 0xA7A8 | Sync-Fehler vom Eingang MMI |
| 0xA7A9 | Sync-Fehler vom Eingang CIC |
...
| ORT | ORTTEXT |
| --- | --- |
| 0x9308 | Übertemperatur MMX |
| 0x9309 | Monitor 1 Übertemperatur |
| 0x930A | Monitor 2 Übertemperatur |
| 0xFFFF | unbekannter Fehlerort |
