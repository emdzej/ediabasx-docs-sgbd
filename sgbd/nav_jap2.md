...
| Field | Value |
| --- | --- |
| ECU | Japan-Navigationssystem |
| ORIGIN | BMW TI-431 Rochal |
| REVISION | 1.17 |
| AUTHOR | Alpine ELECTRONICS Hendrik Nordalm, BMW EE-423 Alexander Maier, BMW TI-431 Rochal |
| COMMENT | N/A |
| PACKAGE | 1.14 |
| SPRACHE | deutsch |
...
- [IDENT](#job-ident) - Ident-Daten fuer das JNAV
...
- [SYSTEM_RESET](#job-system-reset) - Ausloesen des Resets
...
| Name | Type | Comment |
| --- | --- | --- |
| MODE | int | Mode 0 = Fertigungs-, Transport-, Werkstatt-Mode deaktivieren 1 = Fertigungs-Mode aktivieren 2 = Transport-Mode aktivieren 4 = Werkstatt-Mode aktivieren |
