...
- [STEUERN_MOTOR_KLAPPENPOSITION_BELUEFTUNG](#job-steuern-motor-klappenposition-belueftung) - Ansteuern des Schrittmotors in Prozent 0-100 % Es ist moeglich auch nur einzelne Argumente zu schreiben. Vor dem Ansteuern den Job DIAGNOSE_AUFRECHT aufrufen Nach dem Ansteuern den Job DIAGNOSE_ENDE aufrufen
- [STEUERN_MOTOR_KLAPPENPOSITION_FUSSRAUM](#job-steuern-motor-klappenposition-fussraum) - Ansteuern des Schrittmotors in Prozent 0-100 % Es ist moeglich auch nur einzelne Argumente zu schreiben. Vor dem Ansteuern den Job DIAGNOSE_AUFRECHT aufrufen Nach dem Ansteuern den Job DIAGNOSE_ENDE aufrufen
- [STEUERN_MOTOR_KLAPPENPOSITION_DEFROST](#job-steuern-motor-klappenposition-defrost) - Ansteuern des Schrittmotors in Prozent 0-100 % Es ist moeglich auch nur einzelne Argumente zu schreiben. Vor dem Ansteuern den Job DIAGNOSE_AUFRECHT aufrufen Nach dem Ansteuern den Job DIAGNOSE_ENDE aufrufen
...
- [STEUERN_REGLERGROESSE](#job-steuern-reglergroesse) - Ansteuern der Reglergroesse Y -300 bis +300 % Vor dem Ansteuern den Job DIAGNOSE_AUFECHT aufrufen Nach dem Ansteuern den Job DIAGNOSE_ENDE aufrufen
...
| STAT_MT_WERT | real | Mischtemperaturfuehler |
| STAT_MT_EINH | string | Grad Celsius |
...
| STAT_TEMPERATUR_WERT | real | Temperatureinstellung Drehsteller |
...
| STAT_GEBLAESESPG_WERT | real | Geblaeseleistung |
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei |
| STAT_SOLL_WERT | real | Sollwert Temperatur Innen |
| STAT_SOLL_EINH | string | Grad Celsius |
| STAT_SOLL_KORRIGIERT_WERT | real | Sollwert Temperatur Innen korrigiert |
...
| STAT_Y_EINH | string | % |
| STAT_MTSOLL_WERT | real | Mischtemperatur Sollwert |
| STAT_MTSOLL_EINH | string | Grad Celsius |
| STAT_MT_WERT | real | Mischtemperaturfuehler |
| STAT_MT_EINH | string | Grad Celsius |
| STAT_MT_KORRIGIERT_WERT | real | Mischtemperaturfuehler korrigiert |
| STAT_MT_KORRIGIERT_EINH | string | Grad Celsius |
...
| STAT_FUNKTION_MAXAC_EIN | int | AC Max Betrieb |
...
| STAT_TASTE_MAXAC | int | Taste AC Max Betrieb |
| STAT_TASTE_DEFROST | int | Taste Defrost |
| STAT_TASTE_AUTO | int | Taste Automatikbetrieb |
| TELEGRAMM | binary | Antworttelegramm |
...
<a id="job-steuern-kompressorkupplung"></a>
...
<a id="job-steuern-motor-klappenposition-frischluft"></a>
...
<a id="job-steuern-motor-klappenposition-belueftung"></a>
### STEUERN_MOTOR_KLAPPENPOSITION_BELUEFTUNG
...
<a id="job-steuern-motor-klappenposition-fussraum"></a>
### STEUERN_MOTOR_KLAPPENPOSITION_FUSSRAUM
...
<a id="job-steuern-motor-klappenposition-defrost"></a>
### STEUERN_MOTOR_KLAPPENPOSITION_DEFROST
...
| Name | Type | Comment |
| --- | --- | --- |
| DEFROST | int | Defrostmotor 0 - 100 % oder '' |
| DIAGNOSE_AUFRECHT | string | ja, wenn nicht '' |
...
<a id="job-steuern-motor-klappenposition-mischluft"></a>
...
Ansteuern der Reglergroesse Y -300 bis +300 % Vor dem Ansteuern den Job DIAGNOSE_AUFECHT aufrufen Nach dem Ansteuern den Job DIAGNOSE_ENDE aufrufen

#### Arguments

| Name | Type | Comment |
| --- | --- | --- |
| REGLERGROESSE | int | Reglergroesse Y -300 bis +300 % |
| DIAGNOSE_AUFRECHT | string | ja, wenn nicht '' |
...
<a id="job-steuern-waermestrom"></a>
### STEUERN_WAERMESTROM
