...
| Field | Value |
| --- | --- |
| ECU | Gangwahlschalter LU |
| ORIGIN | BMW EI-841 Uzun |
| REVISION | 2.000 |
| AUTHOR | LEOPOLD-KOSTAL EI-512 Meier |
| COMMENT | - |
| PACKAGE | 1.78 |
| SPRACHE | deutsch |
...
- [ARG_0X4020_D](#table-arg-0x4020-d) (1 × 12)
- [ARG_0XD52F_D](#table-arg-0xd52f-d) (1 × 12)
...
- [CTRL_FUNKTIONS_LEDS](#table-ctrl-funktions-leds) (32 × 2)
- [EL_STATUS_ENTRIEGELUNGSKONTAKT_1](#table-el-status-entriegelungskontakt-1) (5 × 2)
- [EL_STATUS_ENTRIEGELUNGSKONTAKT_2](#table-el-status-entriegelungskontakt-2) (5 × 2)
- [EL_STATUS_PARKKONTAKT_1](#table-el-status-parkkontakt-1) (7 × 2)
- [EL_STATUS_PARKKONTAKT_2](#table-el-status-parkkontakt-2) (7 × 2)
- [FDETAILSTRUKTUR](#table-fdetailstruktur) (6 × 2)
- [FORTTEXTE](#table-forttexte) (52 × 3)
- [FUMWELTTEXTE](#table-fumwelttexte) (11 × 9)
- [IDETAILSTRUKTUR](#table-idetailstruktur) (5 × 2)
- [IO_NIO](#table-io-nio) (3 × 2)
...
- [RES_0X4010_D](#table-res-0x4010-d) (4 × 10)
- [RES_0X4011_D](#table-res-0x4011-d) (2 × 10)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| FUNKTIONSANZEIGE_GETRIEBEPOS | 0-n | high | unsigned char | - | CTRL_FUNKTIONS_LEDS | - | - | - | - | - | Wertetabelle zur gezielten Ansteuerung der Funktions-LEDs |

<a id="table-arg-0xd52f-d"></a>
### ARG_0XD52F_D
...
<a id="table-ctrl-funktions-leds"></a>
### CTRL_FUNKTIONS_LEDS
...
| --- | --- |
| 0 | R, N, D, P, M/S = aus |
| 1 | R = ein; N, D, P, M/S = aus |
| 2 | N = ein; R, D, P, M/S = aus |
| 3 | R, N = ein; D, P, M/S = aus |
| 4 | D = ein; R, N, P, M/S = aus |
| 5 | R, D = ein; N, P, M/S = aus |
| 6 | N, D = ein; R, P, M/S = aus |
| 7 | R, N, D = ein; P, M/S = aus |
| 8 | P = ein; R, N, D, M/S = aus |
| 9 | R, P = ein; N, D, M/S = aus |
| 10 | N, P = ein; R, D, M/S = aus |
| 11 | R, N, P = ein; D, M/S = aus |
| 12 | D, P = ein; R, N, M/S = aus |
| 13 | R, D, P = ein; N, M/S = aus |
| 14 | N, D, P = ein; R, M/S = aus |
| 15 | R, N, D, P = ein; M/S = aus |
| 16 | M/S = ein; R, N, D, P = aus |
| 17 | R, M/S = ein; N, D, P = aus |
| 18 | N, M/S = ein; R, D, P = aus |
| 19 | R, N, M/S = ein; D, P = aus |
| 20 | D, M/S = ein; R, N, P = aus |
| 21 | R, D, M/S = ein; N, P = aus |
| 22 | N, D, M/S = ein; R, P = aus |
| 23 | R, N, D, M/S = ein; P = aus |
| 24 | P, M/S = ein; R, N, D = aus |
| 25 | R, P, M/S = ein; N, D = aus |
| 26 | N, P, M/S = ein; R, D = aus |
| 27 | R, N, P, M/S = ein; D = aus |
| 28 | D, P, M/S = ein; R, N = aus |
| 29 | R, D, P, M/S = ein; N = aus |
| 30 | N, D, P, M/S = ein; R = aus |
| 31 | R, N, D, P, M/S = ein |

<a id="table-el-status-entriegelungskontakt-1"></a>
### EL_STATUS_ENTRIEGELUNGSKONTAKT_1
...
| 0 | unbetätigt |
| 1 | betätigt |
| 2 | Kurzschluß GND / Unterbrechung |
| 3 | Kurzschluß Vcc |
| 0xFF | Wert ungültig |

<a id="table-el-status-entriegelungskontakt-2"></a>
### EL_STATUS_ENTRIEGELUNGSKONTAKT_2
...
| 1 | betätigt |
| 2 | Kurzschluß GND |
| 3 | Kurzschluß Vcc / Unterbrechung |
| 0xFF | Wert ungültig |

<a id="table-el-status-parkkontakt-1"></a>
### EL_STATUS_PARKKONTAKT_1
...
| --- | --- |
| 0 | unbetätigt |
| 1 | Kontakt 1 betätigt |
| 2 | Kontakt 4 betätigt |
| 3 | Kontakt 1&4 betätigt |
| 4 | Kurzschluß GND / Unterbrechung |
| 5 | Kurzschluß Vcc |
| 0xFF | Wert ungültig |

<a id="table-el-status-parkkontakt-2"></a>
### EL_STATUS_PARKKONTAKT_2
...
| --- | --- |
| 0 | unbetätigt |
| 1 | Kontakt 2 betätigt |
| 2 | Kontakt 3 betätigt |
| 3 | Kontakt 2&3 betätigt |
| 4 | Kurzschluß GND |
| 5 | Kurzschluß Vcc / Unterbrechung |
| 0xFF | Wert ungültig |
...
| 0x802681 | Suchbeleuchtung fehlerhaft | 0 |
...
| 0x80268F | Parktaster fehlerhaft | 0 |
| 0x802690 | Entriegelungstaster klemmt | 0 |
| 0x802691 | Entriegelungstaster fehlerhaft | 0 |
...
| 0x802699 | Interne Versorgungsspannung fehlerhaft | 0 |
| 0x80269A | ROM Check fehlerhaft | 0 |
| 0x80269B | Prüfung Prozessor fehlerhaft | 0 |
| 0x80269C | Watchdog defekt | 0 |
| 0x80269D | Prüfung RAM fehlerhaft | 0 |
| 0x80269E | Prüfung Analog/Digital-Wandler fehlerhaft | 0 |
| 0x8026A0 | Drivelogic Wipptaster: klemmt | 0 |
| 0x8026A1 | Drivelogic Wipptaster: defekt | 0 |
| 0x8026A9 | Positionserkennung: Zeitfenster nicht eingehalten | 0 |
...
| 0xE09401 | Botschaft (Daten Anzeige Getriebestrang, 0x3FD) nicht aktuell, Empfänger GWS (FA-CAN), Sender EGS (FA-CAN) | 1 |
| 0xE09402 | Botschaft (Daten Anzeige Getriebestrang, 0x3FD) Prüfsumme falsch, Empfänger GWS (FA-CAN), Sender EGS (FA-CAN) | 1 |
| 0xE09403 | Botschaft (Außentemperatur, 0x2CA) fehlt, Empfänger GWS (FA-CAN), Sender Kombi (FA-CAN) | 1 |
| 0xE09406 | Botschaft (Klemmen, 0x12F) fehlt, Empfänger GWS (FA-CAN), Sender FEM, BDC (FA-CAN) | 1 |
| 0xE09409 | Botschaft (Dimmung, 0x202) fehlt, Empfänger GWS (FA-CAN), Sender FEM, BDC (FA-CAN) | 1 |
| 0xE0940C | Botschaft (LCD Helligkeit Regelung, 0x393) fehlt, Empfänger GWS (FA-CAN), Sender KOMBI (FA-CAN) | 1 |
| 0xE0940F | Botschaft (Geschwindigkeit Fahrzeug, 0x1A1) fehlt, Empfänger GWS (FA-CAN), Sender ICM (FA-CAN) | 1 |
| 0xE09410 | Botschaft (Geschwindigkeit Fahrzeug, 0x1A1) nicht aktuell, Empfänger GWS (FA-CAN), Sender ICM (FA-CAN) | 1 |
| 0xE09412 | Botschaft (Kilometerstand / Reichweite, 0x330) fehlt, Empfänger GWS (FA-CAN), Sender Kombi | 1 |
| 0xE09415 | Botschaft (Relativzeit, 0x328) fehlt, Empfänger GWS (FA-CAN), Sender Kombi (FA-CAN) | 1 |
| 0xE09418 | Botschaft (Fahrzeugzustand, 0x3A0) fehlt, Empfänger GWS (FA-CAN), Sender ZGW (FA-CAN) | 1 |
| 0xE09419 | Botschaft (Daten Antriebsstrang 2, 0x3F9) nicht aktuell, Empfänger GWS (FA-CAN), Sender DME | 1 |
| 0xE09420 | Botschaft (Daten Antriebsstrang 2, 0x3F9) Prüfsumme falsch, Empfänger GWS (FA-CAN), Sender DME | 1 |
| 0xE09421 | Botschaft (Nachlaufzeit KL30 fehlergesteuert, 0x3AC) fehlt, Empfänger GWS (FA-CAN), Sender FEM, BDC | 1 |
| 0xE09424 | Botschaft (Daten Antriebsstrang 2, 0x3F9) fehlt, Empfänger GWS (FA-CAN), Sender (DME) | 1 |
| 0xE09427 | Botschaft (Fahrgestellnummer, 0x380) fehlt, Empfänger GWS (FA-CAN), Sender FEM | 1 |
| 0xE0AC00 | Schnittstelle EGS (Daten Anzeige Getriebestrang, FA-CAN): Signal ungültig | 1 |
| 0xE0AC05 | Schnittstelle CAS (Klemmen): Signal ungültig | 1 |
| 0xE0AC07 | Schnittstelle FEM, BDC (Dimmung): Signal ungültig | 1 |
| 0xE0AC08 | Schnittstelle KOMBI (LCD Helligkeit Regelung): Signal ungültig | 1 |
| 0xE0AC0B | Schnittstelle ICM (Geschwindigkeit Fahrzeug): Signal ungültig | 1 |
| 0xE0AC0D | Schnittstelle EGS (Daten Antriebsstrang 2): Signal ungültig | 1 |
| 0xE0AC0E | Schnittstelle ZGW (Fahrzeugzustand): Signal ungültig | 1 |
| 0xE0AC10 | Schnittstelle FEM, BDC (Nachlaufzeit Klemme 30 fehlergesteuert): Signal ungültig | 1 |
...
| UWNR | UWTEXT | UW_EINH | L/H | UWTYP | NAME | MUL | DIV | ADD |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 0x170C | StatusVersorgungsspannung | mV | High | unsigned int | - | 1.0 | 1.0 | 0.0 |
| 0x4000 | Zeit nach WakeUp | ms | High | unsigned int | - | 1.0 | 1.0 | 0.0 |
| 0x4001 | Außentemperatur | °C | - | signed char | - | 0.5 | 1.0 | -40.0 |
| 0x4002 | Letzter bekannter Kilometerstand | km | High | signed long | - | 1.0 | 1.0 | 0.0 |
| 0x4003 | Hall-Sensoren Code | HEX | High | unsigned int | - | - | - | - |
| 0x4004 | defekter Hall-Sensor | HEX | High | unsigned char | - | - | - | - |
| 0x4005 | Parktaster Status Kontakt 1 | HEX | High | unsigned int | - | - | - | - |
| 0x4006 | Parktaster Status Kontakt 2 | HEX | High | unsigned int | - | - | - | - |
| 0x4009 | Entriegelungstaster Status Kontakt 1 | HEX | High | unsigned int | - | - | - | - |
| 0x400A | Entriegelungstaster Status Kontakt 2 | HEX | High | unsigned int | - | - | - | - |
...
| 0x5E0006 | Funktionsanzeige: LED P fehlerhaft | 0 |
| 0x5E0007 | Funktionsanzeige: LED R fehlerhaft | 0 |
| 0x5E0008 | Funktionsanzeige: LED N fehlerhaft | 0 |
| 0x5E0009 | Funktionsanzeige: LED D fehlerhaft | 0 |
| 0x5E000A | Funktionsanzeige: LED MS fehlerhaft | 0 |
| 0x5E000B | Ablaufkontrolle: Programmablauf gestört | 0 |
| 0xFFFFFF | unbekannter Fehlerort | 0 |
...
| RESULTNAME | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_NOCKENWELLE_WERT | ° | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Absolute Position der Nockenwelle |
| STAT_WINKELPLAUSIB | 0-n | high | unsigned char | - | IO_NIO | - | - | - | Ergebnis Winkelplausibilisierung der Nockenwelle |
| STAT_IIC_COMMUNICATION | 0-n | high | unsigned char | - | IO_NIO | - | - | - | Status I2C-Kommunikation mit dem Winkelsensor |
| STAT_MOTORSTROM_WERT | mA | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | aktuelle Stromaufnahme des Motors |
...
| RESULTNAME | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_KONTAKT_1 | 0-n | high | unsigned char | - | EL_STATUS_ENTRIEGELUNGSKONTAKT_1 | - | - | - | Auswertestatus Entriegelungskontakt_1 |
| STAT_KONTAKT_2 | 0-n | high | unsigned char | - | EL_STATUS_ENTRIEGELUNGSKONTAKT_2 | - | - | - | Auswertestatus Entriegelungskontakt_2 |
...
| RESULTNAME | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_PARKKONTAKT_1 | 0-n | high | unsigned char | - | EL_STATUS_PARKKONTAKT_1 | - | - | - | Informationen zum Parkkontakt_1 |
| STAT_PARKKONTAKT_2 | 0-n | high | unsigned char | - | EL_STATUS_PARKKONTAKT_2 | - | - | - | Informationen zum Parkkontakt_2 |
...
| GWS_ANALYSEDATEN | 0xD52F | - | Versenden von Analysedaten des GWS ein- und ausschalten.Der Diagnosejob darf nur mit vorhergehender Genehmigung durch die entwicklungsseitige Fachabteilung ausgeführt werden. | - | - | - | - | - | - | - | - | - | 2E | ARG_0xD52F_D | - |
...
| RUECKSTELLSYSTEM | 0x4010 | - | Informationen zur Nockenwelle und dem Motor für den Nockenwellenantrieb | - | - | - | - | - | - | - | - | - | 22 | - | RES_0x4010_D |
| ENTRIEGELUNGSTASTER | 0x4011 | - | Informationen zum Entriegelungstaster | - | - | - | - | - | - | - | - | - | 22 | - | RES_0x4011_D |
| STATUS_PARKTASTER | 0x4012 | - | Informationen zum Parktaster | - | - | - | - | - | - | - | - | - | 22 | - | RES_0x4012_D |
| FUNKTIONSANZEIGE | 0x4020 | - | Steuerung der Funktionsanzeige Getriebeposition | - | - | - | - | - | - | - | - | - | 2E | ARG_0x4020_D | - |
