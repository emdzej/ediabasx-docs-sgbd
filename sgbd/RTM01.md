...
| ORIGIN | BMW TI-53 Michael_Baum |
| REVISION | 3.000 |
| AUTHOR | Zielpuls EC-131 Ivanchenko |
| COMMENT | N/A |
| PACKAGE | 1.57 |
| SPRACHE | deutsch |
...
- [BF_DIAGNOS](#table-bf-diagnos) (8 × 10)
...
| STAT_GSM_ANT | 0/1 | - | unsigned char | 0x10 | - | - | - | - | 0- GSM antenna connected, 1- disconnected |
| STAT_GPS_ANT | 0/1 | - | unsigned char | 0x20 | - | - | - | - | 0- GPS antenna connected, 1- disconnected |
...
| RESULTNAME | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_LISTEN_ONLY | 0/1 | - | unsigned char | 0x01 | - | - | - | - | 0- listen only mode not set, 1- is set |
