...
| Field | Value |
| --- | --- |
| ECU | Antiblockiersystem u. Autom. Stabilitaets Control 5 E34/16 |
...
- [INITIALISIERUNG](#job-initialisierung) - Init-Job fuer ABS_ABD5
- [IDENT](#job-ident) - Ident-Daten fuer ABS_ABD5
- [FS_LESEN](#job-fs-lesen) - Fehlerspeicher lesen fuer ABS_ABD5 High-Konzept nach Lastenheft Codierung/Diagnose
- [FS_LOESCHEN](#job-fs-loeschen) - Fehlerspeicher loeschen fuer ABS_ABD5
- [STATUS_IO_LESEN](#job-status-io-lesen) - Status Eingaenge ABS_ABD5
- [DOWNLOAD_STELLGLIED](#job-download-stellglied) - Stellglied ansteuern ABS_ABD5
- [DOWNLOAD_D4_STELLGLIED](#job-download-d4-stellglied) - Stellglied ansteuern ABS_ASC5
- [DOWNLOAD_I_O_DIAGNOSE](#job-download-i-o-diagnose) - I/O-Diagnose ABS_ABD5
- [DOWNLOAD_FUEHLER_EINZELN](#job-download-fuehler-einzeln) - Ansprechschwelle u. Impulsrad ABS_ABD5
- [DOWNLOAD_STATISCH](#job-download-statisch) - Statischer Test der Komponenten ABS_ABD5
- [DOWNLOAD_FUEHLER_ALLE](#job-download-fuehler-alle) - Alle Ansprechschwellen u. Impulsraeder ABS_ABD5
- [DOWNLOAD_VAKUUM_LINIE](#job-download-vakuum-linie) - Befuelroutine in Fertigungslinie ABS_ABD5
- [DOWNLOAD_VAKUUM_REPAIR](#job-download-vakuum-repair) - Befuelroutine in Nacharbeit ABS_ABD5
- [DOWNLOAD_FS_RESET](#job-download-fs-reset) - Fehlerspeicher zuruecksetzen ABS_ABD5
- [TEST_D_STELLGLIED](#job-test-d-stellglied) - Digitale Stellglieder ansteuern ABS_ABD5
...
- [TEST_FUEHLER_EINZELN](#job-test-fuehler-einzeln) - Ansprechschwelle ABS_ABD5
- [TEST_FUEHLER_IMPULS](#job-test-fuehler-impuls) - Test Fuehler u. Impulsrad
- [TEST_STATISCH](#job-test-statisch) - Statischer Test der Komponenten ABS_ABD5
- [TEST_FUEHLER_ALLE](#job-test-fuehler-alle) - Alle Ansprechschwellen u. Impulsraeder ABS_ABD5
- [TEST_VAKUUM_LINIE](#job-test-vakuum-linie) - Befuelroutine in Fertigungslinie ABS_ABD5
- [TEST_VAKUUM_REPAIR](#job-test-vakuum-repair) - Befuelroutine in Nacharbeit ABS_ABD5
...
| F_ART_ANZ | int | Anzahl der Fehlerarten bei ABS/ABD5 = 3 |
| F_UW_ANZ | int | Anzahl der Umweltbedingungen bei ABS/ABD5 = 1 |
...
| STAT_DROSSELKLAPPEN_IST_WERT | long | Mometane Stellung Drosselklappe in % von ??? |
| STAT_DROSSELKLAPPEN_IST_EINH | string | Einheit = % |
...
| STAT_KUPPLUNGSSCHALTER_EIN | int | 0 oder 1 |
| _AUFTRAG1 | binary | Anforderungstelegramm |
| _ANTWORT1 | binary | Antworttelegramm |
...
- [FARTMATRIX](#table-fartmatrix) (36 × 7)
- [FUMWELTMATRIX](#table-fumweltmatrix) (35 × 5)
- [FUMWELTTEXTE](#table-fumwelttexte) (2 × 3)
- [STG_TABELLE](#table-stg-tabelle) (15 × 2)
