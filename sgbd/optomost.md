...
- [STEUERN_KOMMUNIKATIONS_MODE](#job-steuern-kommunikations-mode) - OPPS in Kommunikationsmodus zurücksetzen
- [STEUERN_MOST_MESSMODE](#job-steuern-most-messmode) - Einstellen Messmodus MOST
- [STEUERN_ADS4MOST_MODE](#job-steuern-ads4most-mode) - Kommandos an ADS4MOST Treiber
- [STEUERN_BYTEFLIGHT_MODE](#job-steuern-byteflight-mode) - Kommandos an BYTEFLIGHT
...
OPPS in Kommunikationsmodus zurücksetzen
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei |
| STAT_SPANNUNG_MOST_WERT | int | Boardpower 1 OK 0 Nicht OK |
...
| Name | Type | Comment |
| --- | --- | --- |
| SENDELEISTUNG | int | Angabe der Sendeleistung in db Eingabe von negativen Werten möglich |
...
| Name | Type | Comment |
| --- | --- | --- |
| NUMBER | int | NACHFRAGEN |
| USAGETYPE | int | NACHFRAGEN |
