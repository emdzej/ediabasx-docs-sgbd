...
| COMMENT | Anpassungen von Hirschmann HCC für Sonderablauf COFDM-Update |
| PACKAGE | 1.29 |
| SPRACHE | deutsch |
...
- [STATUS_SW_VERSION](#job-status-sw-version) - Zusätzlicher Job für VID zum Auslesen der COFDM-Version
...
Zusätzlicher Job für VID zum Auslesen der COFDM-Version
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| ID_VERSION | string | COFDM-Version |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
