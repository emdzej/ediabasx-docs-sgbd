...
| Field | Value |
| --- | --- |
| ECU | Dynamische Stabilitaets Control DSC57 |
| ORIGIN | BMW EF-73 Kusch |
| REVISION | 1.14 |
| AUTHOR | BMW TP-421 Hirsch, BMW TP-423 Pollmann, BMW EF-73 Kusch |
| COMMENT | Robert Bosch DSC57 E38/E39/E52/E53/E46-16 |
| PACKAGE | 0.09 |
| SPRACHE | deutsch |
...
- [STATUS_DREHRATE_EMPFINDLICHKEIT](#job-status-drehrate-empfindlichkeit) - Lesen EEPROM
...
- [DOWNLOAD_ECEEPR](#job-download-eceepr)
...
- [TEST_PUMPENLEISTUNG_VORNE](#job-test-pumpenleistung-vorne) - Test der Pumpenfoerderleistung ABS_DSC57
- [TEST_PUMPENLEISTUNG_HINTEN](#job-test-pumpenleistung-hinten) - Test der Pumpenfoerderleistung ABS_DSC57
- [TEST_A_STELLGLIED](#job-test-a-stellglied) - Fuellung ABS_DSC57
...
- [TEST_DREHRATE](#job-test-drehrate) - wird nur beim Sensorwechsel angewandt setzt den Verstaerkungsfaktor auf den Wert 1, dies entspricht 0%
...
- [TEST_ECEEPR_LESEN](#job-test-eceepr-lesen) - Schreiben, Lesesn EEPROM
- [TEST_ECEEPR_SCHREIBEN](#job-test-eceepr-schreiben) - Schreiben, EEPROM
...
<a id="job-status-drehrate-empfindlichkeit"></a>
...
| STAT_DREHRATE_EMPFINDLICHKEIT_WERT | real | Drehrate Verstaerkungsfaktor in % |
| STAT_DREHRATE_EMPFINDLICHKEIT_EINH | string | Einheit = % |
| _AUFTRAG1 | binary | Anforderungstelegramm |
| _ANTWORT1 | binary | Antworttelegramm |
| _AUFTRAG2 | binary | Anforderungstelegramm |
| _ANTWORT2 | binary | Antworttelegramm |
...
| --- | --- | --- |
| JOB_STATUS | string | Status der Kommunikation (z.B. ACK) |
| STATUS_ABGLEICH | string | gibt an, an welcher Stelle der Job verlassen wird |
...
| _TEL_ANTWORT4 | binary | Anforderungstelegramm |
...
<a id="job-test-eceepr-schreiben"></a>
