...
| Field | Value |
| --- | --- |
| ECU | Regensensor (Automatische Intervall Regelung) |
| ORIGIN | BMW TI-430 Stübinger |
| REVISION | 1.11 |
| AUTHOR | BMW TI-433 Gerd Huber, BMW TI-433 Dennert, BMW TI-433 Kuessel |
| COMMENT | N/A |
| PACKAGE | 1.02 |
| SPRACHE | deutsch |
...
- [AIC_INIT_RSK_E46](#job-aic-init-rsk-e46) - Initialisieren des Rueckstellkontaktes !!! nur bei Regensensor E46 !!!
...
<a id="job-aic-init-rsk-e46"></a>
### AIC_INIT_RSK_E46

Initialisieren des Rueckstellkontaktes !!! nur bei Regensensor E46 !!!
...
| --- | --- |
| 0x00 | kein Fehler |
| 0x01 | interner Hardwarefehler |
| 0x02 | keine Adaption an Scheibe moeglich |
| 0x03 | Spannung oder Temperatur ausserhalb Toleranz |
| 0x04 | Kommunikationsprobleme ASIC - Kontroller |
| 0x05 | Ueberwischen nicht erkannt |
| 0x06 | Wischermotor Rueckstellkontakt fehlerhaft |
