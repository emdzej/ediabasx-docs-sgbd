...
| Field | Value |
| --- | --- |
| ECU | Instrumentenkombination |
| ORIGIN | BMW EE-72 Janus_Cogiel |
| REVISION | 9.001 |
...
- [_STEUERN_DET_LOESCHEN](#job-steuern-det-loeschen) - JobHeaderFormat 0x402C FGN_CODIERT Entwicklungsjob
- [_STEUERN_GSS_LOESCHEN](#job-steuern-gss-loeschen) - JobHeaderFormat 0x402C FGN_CODIERT Entwicklungsjob
...
<a id="job-steuern-det-loeschen"></a>
### _STEUERN_DET_LOESCHEN
...
<a id="job-steuern-gss-loeschen"></a>
### _STEUERN_GSS_LOESCHEN
...
- [ARG_0XA4A0_R](#table-arg-0xa4a0-r) (2 × 14)
...
- [RES_0X4801_D](#table-res-0x4801-d) (16 × 10)
- [RES_0X4804_D](#table-res-0x4804-d) (1 × 10)
...
- [RES_0XE4D0_D](#table-res-0xe4d0-d) (38 × 10)
- [RES_0XF120_R](#table-res-0xf120-r) (1 × 13)
- [RES_0XF152_D](#table-res-0xf152-d) (2 × 10)
- [SG_FUNKTIONEN](#table-sg-funktionen) (112 × 16)
...
| ARG | STR | STPR | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | MIN | MAX | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| RESOURCE_ID | + | - | DATA | high | data[4] | - | - | 1.0 | 1.0 | 0.0 | - | - | 00000000 - FFFFFFFF: alle in der SW hinterlegten Resource-IDs |
| STEUERUNG | + | - | DATA | high | data[1] | - | - | 1.0 | 1.0 | 0.0 | - | - | 00h = Resource-ID ins Kombi laden 01h = Resource-ID im Kombi löschen 02h - FFh = negative Antwort (SubFunctionNotSupported) |
...
Dimensions: 408 rows × 4 columns

| ORT | ORTTEXT | EREIGNIS_DTC | FEHLERKLASSE |
| --- | --- | --- | --- |
| 0x026000 | Energiesparmode aktiv | 0 | - |
| 0x026003 | Externe SWT-Prüfbedingung nicht erfüllt | 1 | - |
| 0x026004 | Interne SWT-Prüfung fehlgeschlagen | 0 | - |
...
| 0x026060 | RSU_CLIENT_HW_FEHLER | 0 | - |
| 0x026070 | IPSEC_NICHT_INITIALISIERT | 0 | - |
| 0x026071 | IPSEC_NICHT_VERRIEGELT | 0 | - |
| 0x026072 | IPSEC_FEHLER_AUFGETRETEN | 0 | - |
| 0x026080 | ZERTIFIKATE_UND_BINDINGS_TYP1_WERK_NICHT_BEREIT | 0 | - |
...
| 0xB7F7CF | KOMBI: Fehlerhafte Codierdaten für die LED-Tankanzeige | 1 | - |
| 0xB7F7D0 | KOMBI: Fehlerhafte Codierdaten für die LED-SOC-Anzeige | 1 | - |
| 0xB7F7D1 | KOMBI: Fehlerhafte Codierdaten für die LED-Motortemperaturanzeige | 1 | - |
| 0xB7F7D5 | log and trace aktiviert | 1 | - |
| 0xB7F7D6 | Übertragung des Fahrzeugmodells von Head Unit zu Kombi fehlerhaft. | 1 | - |
| 0xB7F7D7 | Übertragung der Fahrzeugfarbe von der Head Unit zum Kombi fehlerhaft. | 1 | - |
| 0xB7FB06 | Übertragung des xxx von Head Unit zu Kombi fehlerhaft. | 0 | - |
| 0xB7FB07 | Übertragung des xxx von Head Unit zu Kombi fehlerhaft. | 0 | - |
| 0xB7FB0D | Warpingdatenfehler Kombi | 0 | - |
| 0xB7FB10 | HUD nicht gesteckt | 0 | - |
| 0xB7FB1B | Verbleibender/Freier Speicher im HMIVAS hat 10% Marke unterschritten | 0 | - |
| 0xB7FB1D | Verbleibender/Freier VRAM Speicher hat 10% Marke unterschritten | 0 | - |
| 0xB7FB1F | Asset Signaturprüfung fehlgeschlagen | 0 | - |
| 0xE1040A | FA-CAN Control Module Bus OFF | 0 | - |
| 0xE1043F | MOST: Empfänger hat Nachricht nicht abgenommen | 1 | - |
| 0xE10445 | MOST: Reset | 0 | - |
| 0xE10600 | Ethernet: physikalischer Fehler (link off) | 1 | - |
| 0xE10602 | Ethernet: Link-Qualität niedrig | 1 | - |
| 0xE10603 | Ethernet: Kommunikationsfehler (Link-Abbruch) durch Steuergeräte-Reset | 0 | - |
| 0xE10604 | Ethernet: Unerwarteter Link aufgebaut | 1 | - |
| 0xE10610 | Ethernet: unerwartete Link-Abbruch auf Port 0 | 1 | - |
...
| 0xE11467 | Botschaft (Winkel Fahrpedal, 0x0D9) fehlt, Empfänger KOMBI, Sender DME/DDE/CCU | 1 | - |
...
| 0xE11577 | Botschaft Bedarfsorientierter Service, Meldung vom CBS-Teilnehmer (DPF oder OPF) ist ausgefallen | 1 | - |
...
| 0xE11589 | Botschaft (Status Bedienelement Bremsassistent, 0x31E) fehlt, Empfänger KOMBI, Sender BDC | 1 | - |
...
| 0xE11594 | Botschaft (Anzeige Fahrerassistenzsystem Modus, 0x1DF) fehlt, Empfänger KOMBI, Sender SAS2018 | 1 | - |
| 0xE11595 | Botschaft Bedarfsorientierter Service, Meldung vom CBS-Teilnehmer (Getriebeoel) ist ausgefallen | 1 | - |
| 0xE11596 | Botschaft (Anzeige Fahrerassistenzsystem Querführung 2, 0x21D) fehlt, Empfänger KOMBI, Sender SAS | 1 | - |
| 0xE11597 | Botschaft (Steuerung Konfiguration FAS 5, 0x385) fehlt, Empfänger KOMBI, Sender BDC_Body | 1 | - |
| 0xE11598 | Botschaft (Status M-Drive 3, 0x405) fehlt, Empfänger KOMBI, Sender DME | 1 | - |
| 0xE11599 | Botschaft (Status RSU Zustand, 0x220) fehlt, Empfänger KOMBI, Sender BDC | 1 | - |
| 0xE1159A | Botschaft (Status RSU Zustand, 0x220) Prüfsumme falsch, Empfänger KOMBI, Sender BDC | 1 | - |
| 0xE1159B | Botschaft (Status RSU Zustand, 0x220) nicht aktuell, Empfänger KOMBI, Sender BDC | 1 | - |
| 0xE1159C | Botschaft (Anzeige Checkcontrol HVS, 0x295) fehlt, Empfänger KOMBI, Sender HVS | 1 | - |
| 0xE1159D | Botschaft (Anzeige Checkcontrol HVS, 0x295) Prüfsumme falsch, Empfänger KOMBI, Sender HVS | 1 | - |
| 0xE1159E | Botschaft (Anzeige Checkcontrol HVS, 0x295) nicht aktuell, Empfänger KOMBI, Sender HVS | 1 | - |
| 0xE1159F | Botschaft (Status Fahrzeug Klang 2, 0x35D) fehlt, Empfänger KOMBI, Sender VSG 2 | 1 | - |
| 0xE115A0 | Botschaft (Status Fahrzeug Klang 2, 0x35D) nicht aktuell, Empfänger KOMBI, Sender VSG 2 | 1 | - |
| 0xE115A1 | Botschaft (GPS Datum MOST, 0x456) fehlt, Empfänger KOMBI, Sender MGU | 1 | - |
| 0xE115A2 | Botschaft (GPS Uhrzeit MOST, 0x457) fehlt, Empfänger KOMBI, Sender MGU | 1 | - |
| 0xE115A3 | Botschaft (Status FAS, 0x232) fehlt, Empfänger KOMBI, Sender BDC | 1 | - |
| 0xE115A4 | Botschaft (Status BFS, 0x22A) fehlt, Empfänger KOMBI, Sender BDC | 1 | - |
| 0xE115A6 | Botschaft (Status RCP, 0x29D) fehlt, Empfänger KOMBI, Sender iCAM2 | 1 | - |
| 0xE115A7 | Botschaft (Konfiguration SOC Hold, 0x350) fehlt, Empfänger KOMBI, Sender DME1 | 1 | - |
| 0xE115A8 | Botschaft (Anzeige Schalter Fahrdynamik Sport 2, 0x284) fehlt, Empfänger KOMBI, Sender DME1 | 1 | - |
| 0xE115A9 | Botschaft (Status Zentralverriegelung Tür Schloss, 0xEC) fehlt, Empfänger KOMBI, Sender iCam2 | 1 | - |
| 0xE115B6 | Botschaft (Status FASH, 0x236) fehlt, Empfänger KOMBI, Sender BDC | 1 | - |
| 0xE115B7 | Botschaft (Status BFSH, 0x22E) fehlt, Empfänger KOMBI, Sender BDC | 1 | - |
...
| 0xE12C38 | Schnittstelle DME/DDE/CCU (Winkel Fahrpedal, 0x0D9): Signal ungültig | 1 | - |
...
| 0xE12C97 | Botschaft Bedarfsorientierter Service, Meldung vom CBS-Teilnehmer (DPF oder OPF): Signal ungültig | 1 | - |
...
| 0xE12CA9 | Schnittstelle BDC (Status Bedienelement Bremsassistent, 0x31E): Signal ungültig | 1 | - |
...
| 0xE12CB3 | Schnittstelle SAS2018 (Anzeige Fahrerassistenzsystem Modus, 0x1DF): Signal ungültig | 1 | - |
| 0xE12CB4 | Botschaft Bedarfsorientierter Service, Meldung vom CBS-Teilnehmer (Getriebeoel): Signal ungültig | 1 | - |
| 0xE12CB5 | Schnittstelle SAS (Anzeige Fahrerassistenzsystem Querführung 2, 0x21D): Signal ungültig | 1 | - |
| 0xE12CB6 | Schnittstelle MGU (Bedienung Komfiguration Kombi 5, 0x3CE): Signal ungültig | 1 | - |
| 0xE12CB7 | Schnittstelle BDC_Body (Steuerung Komfiguration FAS 5, 0x385): Signal ungültig | 1 | - |
| 0xE12CB8 | Schnittstelle DME (Status M-Drive 3, 0x405): Signal ungültig | 1 | - |
| 0xE12CB9 | Schnittstelle BDC (Status RSU Zustand, 0x220): Signal ungültig | 1 | - |
| 0xE12CBA | Schnittstelle VSG 2 (Status Fahrzeug Klang 2, 0x35D): Signal ungültig | 1 | - |
| 0xE12CBD | Schnittstelle BDC (Status FAS, 0x232): Signal ungültig | 1 | - |
| 0xE12CBE | Schnittstelle BDC (Status BFS, 0x22A): Signal ungültig | 1 | - |
| 0xE12CC0 | Schnittstelle iCAM2 (Status RCP, 0x29D): Signal ungültig | 1 | - |
| 0xE12CC1 | Schnittstelle DSC, SAS (Anzeige Vorausschau, 0x2EC): Signal ungültig | 1 | - |
| 0xE12CC2 | Schnittstelle DME1 (Konfiguration SOC Hold, 0x350): Signal ungültig | 1 | - |
| 0xE12CC3 | Schnittstelle DME1 (Anzeige Schalter Fahrdynamik Sport 2, 0x284): Signal fehlt | 1 | - |
| 0xE12CC4 | Schnittstelle iCam2 (Status Zentralverriegelung Tür Schloss, 0xEC): Signal ungültig | 1 | - |
| 0xE12CC5 | Schnittstelle BDC (Status FASH, 0x236): Signal ungültig | 1 | - |
| 0xE12CC6 | Schnittstelle BDC (Status BFSH, 0x22E): Signal ungültig | 1 | - |
...
Dimensions: 210 rows × 4 columns

| ORT | ORTTEXT | EREIGNIS_DTC | FEHLERKLASSE |
| --- | --- | --- | --- |
| 0x806030 | Fehler in der SW-Funktion (FSCSM) | 0 | - |
...
| 0xB7F790 | Kombi: Kodierparameter BC-Rolle wiedersprechen sich | 0 | - |
...
| 0xB7F7A0 | HUD: Hardware interner Fehler | 0 | - |
...
| 0xB7F7CC | Beim Wechsel einer Zeitzone wird dieser DTC von der FuBi Zeit getriggert | 0 | - |
| 0xB7F7CD | Bei der Übernahme eines neuen Winter- / Sommerzeit-Offsets wird dieser DTC von der Zeit-FUBI getriggert | 0 | - |
| 0xB7F7CE | Bei einem unplausiblen UTC-Zeit-Sprung vom ATM oder HU wird dieser DTC getriggert | 0 | - |
| 0xB7F7D3 | Unplausible Anzeige der Zeit und ungültige UTC-Zeit | 0 | - |
| 0xB7F7D4 | Kombi HW-Fehler: Lüfter ist blockiert | 1 | - |
| 0xB7F7D8 | RSU_CLIENT_ABLAUFFEHLER | 0 | - |
| 0xB7F7D9 | RSU_CLIENT_ABLAUFFEHLER_OFT | 0 | - |
| 0xB7F7DA | manuelle Uhrzeit-Einstellung: beim Stellen der Uhrzeit wird dieser DTC aus der FuBi Zeit getriggert | 0 | - |
| 0xB7F7DB | manuelle Uhrzeit-Einstellung: bei Stellen eines manuellen ZZ-Offsets wird dieser DTC aus der FuBi Zeit getriggert | 0 | - |
| 0xB7F7DC | manuelle Uhrzeit-Einstellung: mit der Korrektur der Anzeige-Zeit im Bezug zur UTC-Zeit wird dieser DTC aus der FuBi Zeit getriggert | 0 | - |
| 0xB7F7DD | automatische Uhrzeit-Einstellung: mit dem Wechsel von einer manuellen Uhrzeit-Einstellung auf eine automatische Uhrzeit-Einstellung wird dieser DTC aus der FuBi Zeit getriggert | 0 | - |
| 0xB7F7DE | manuelle Uhrzeit-Einstellung: bei der Umschaltung von automatischer Uhrzeit-Einstellung zu einer manuellen Uhrzeit-Einstellung wird dieser DTC aus der FuBi Zeit getriggert | 0 | - |
| 0xB7F7DF | RSU: mit der Initialisierung der Applikationen nach einem Remote Software Update wird dieser DTC aus der FuBi Zeit getriggert | 0 | - |
| 0xB7F7E0 | Bei der Anzeige der --- aufgrund eines RAM-Verlustes wird der DTC aus der FuBi Zeit getriggert. | 0 | - |
| 0xB7F7E1 | manuelle Uhrzeit-Einstellung: beim Stellen des Datums wird dieser DTC aus der FuBi Zeit getriggert | 0 | - |
| 0xB7F7E2 | Kombi: Infofehler 11 | 0 | - |
| 0xB7F7E3 | Kombi: Infofehler 12 | 0 | - |
| 0xB7F7E4 | Kombi: Infofehler 13 | 0 | - |
| 0xB7F7E5 | Kombi: Infofehler 14 | 0 | - |
| 0xB7F7E6 | Kombi: Infofehler 15 | 0 | - |
| 0xB7F7E7 | Kombi: Infofehler 16 | 0 | - |
| 0xB7F7E8 | Kombi: Infofehler 17 | 0 | - |
| 0xB7F7E9 | Kombi: Infofehler 18 | 0 | - |
| 0xB7F7EA | Kombi: Infofehler 19 | 0 | - |
| 0xB7F7EB | Kombi: Infofehler 20 | 0 | - |
| 0xB7F7EC | Kombi: Infofehler 21 | 0 | - |
| 0xB7F7ED | Kombi: Infofehler 22 | 0 | - |
| 0xB7F7EE | Kombi: Infofehler 23 | 0 | - |
| 0xB7F7EF | Kombi: Infofehler 24 | 0 | - |
| 0xB7F7F0 | Kombi: Infofehler 25 | 0 | - |
| 0xB7F7F1 | Kombi: Infofehler 26 | 0 | - |
| 0xB7F7F2 | Kombi: Infofehler 27 | 0 | - |
| 0xB7F7F3 | Kombi: Infofehler 28 | 0 | - |
| 0xB7F7F4 | Kombi: Infofehler 29 | 0 | - |
| 0xB7F7F5 | Kombi: Infofehler 30 | 0 | - |
| 0xB7F7F6 | Kombi: Infofehler 31 | 0 | - |
| 0xB7F7F7 | Kombi: Infofehler 32 | 0 | - |
| 0xB7F7F8 | Kombi: Infofehler 33 | 0 | - |
| 0xB7F7F9 | Kombi: Infofehler 34 | 0 | - |
| 0xB7F7FA | Kombi: Infofehler 35 | 0 | - |
| 0xB7F7FB | Kombi: Infofehler 36 | 0 | - |
| 0xB7F7FC | Kombi: Infofehler 37 | 0 | - |
| 0xB7F7FD | Kombi: Infofehler 38 | 0 | - |
| 0xB7F7FE | Kombi: Infofehler 39 | 0 | - |
| 0xB7F7FF | Kombi: Infofehler 40 | 0 | - |
| 0xB7FB00 | Fehler in der SW-Funktion (RDA FSCSM) | 0 | - |
| 0xB7FB01 | Kombi: Kennung unplausibel | 0 | - |
| 0xB7FB02 | Kombi: Kennung unplausibel 4 | 0 | - |
| 0xB7FB03 | Kombi: Kilometerstand unplausibel | 0 | - |
| 0xB7FB04 | Kombi: Kilometerstand unplausibel 4 | 0 | - |
| 0xB7FB05 | Bei der Übernahme eines neuen Winter- / Sommerzeit-Offsets wird dieser DTC von der Zeit-FUBI getriggert | 0 | - |
| 0xB7FB09 | GSS: Fehler beim Zugriff auf eine safety-relevante Ressource im NAND-Speicher. | 0 | - |
| 0xB7FB0A | GSS: unerlaubter Zugriff auf ein safety-relevantes Modul im NOR-Speicher. | 0 | - |
| 0xB7FB0B | GSS: unerlaubter Zugriff auf ein safety-relevantes Modul im RAM-Speicher. | 0 | - |
| 0xB7FB0C | Stecker: Steckverbindung zwischen KSS und TFT-Display ist unterbrochen. | 0 | - |
| 0xB7FB0E | TIMEOUT Kommunikationsfehler auf die interne Ganganzeige IPC Nachrichten | 0 | - |
| 0xB7FB0F | TIMEOUT Kommunikationsfehler auf die interne CCM IPC Nachrichten | 0 | - |
| 0xB7FB1C | Verbleibender/Freier Speicher im HMIVAS hat 30% Marke unterschritten | 0 | - |
| 0xB7FB1E | Verbleibender/Freier VRAM Speicher hat 30% Marke unterschritten | 0 | - |
| 0xE10601 | Ethernet: CRC Fehler | 1 | - |
| 0xE10605 | Ethernet-Frameverlust | 1 | - |
| 0xE10606 | Ethernet ARP-Eintrag verworfen | 1 | - |
| 0xE10607 | IPv4-Adresskonflikt (duplizierte DHCP-Adresse erkannt) | 1 | - |
| 0xE106E1 | SOME/IP Fehler | 1 | - |
| 0xE106E2 | SOME/IP Fehler | 1 | - |
| 0xE106E3 | SOME/IP Fehler | 1 | - |
| 0xE106E5 | SOME/IP Fehler | 1 | - |
...
| 0xE12CAB | Schnittstelle MGU (Bedienung Uhrzeit Datum UTC , 0x3AA): Signal ungültig | 1 | - |
| 0xE12CAC | Schnittstelle MGU (Bedienung Datum Winterzeit Sommerzeit, 0x3AB): Signal ungültig | 1 | - |
| 0xE12CAD | Schnittstelle ICM_QL/DSC (Wegstrecke Fahrzeug,0x2BB): Signal ungültig | 1 | - |
| 0xE12CAE | Schnittstelle ICM_QL/DSC (Wegstrecke Fahrzeug,0x2BB): Signal ungültig | 1 | - |
| 0xE12CB1 | Schnittstelle ATM (GPS Datum CAN, 0x40E): Signal ungültig | 1 | - |
| 0xE12CB2 | Schnittstelle ATM (GPS Uhrzeit CAN, 0x40F): Signal ungültig | 1 | - |
| 0xE12CBB | Schnittstelle MGU (GPS Datum MOST, 0x456): Signal ungültig | 1 | - |
| 0xE12CBC | Schnittstelle MGU (GPS Uhrzeit MOST, 0x457): Signal ungültig | 1 | - |
| 0xFFFFFF | unbekannter Fehlerort | 0 | - |
...
| 0x4019 | ECHTZEITUHR | s | High | unsigned char | - | 1.0 | 1.0 | 0.0 |
| 0xXYXY | unbekannte Umweltbedingung | - | - | - | - | - | - | - |
...
| RESULTNAME | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_TANK_BLOCK_1_DATA | DATA | high | data[67] | - | - | 1.0 | 1.0 | 0.0 | Block 3006 Tank aus dem CAF lesen |
| STAT_TANK_VOLUMEN_WERT | l | high | unsigned char | - | - | 1.0 | 2.0 | 0.0 | Ausgabe des maximalen Tankvolumens |
| STAT_TANK_BLOCK_2_DATA | DATA | high | data[60] | - | - | 1.0 | 1.0 | 0.0 | Block 3006 Tank aus dem CAF lesen (Rest) |
...
| RESULTNAME | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_HUD_USER0_BRIGHT_WERT | - | high | unsigned char | - | - | 1.0 | 1.0 | 0.0 | - |
| STAT_HUD_USER0_HEIGHT_WERT | - | high | unsigned char | - | - | 1.0 | 1.0 | 0.0 | - |
| STAT_HUD_USER0_ROTATION_WERT | - | high | unsigned char | - | - | 1.0 | 1.0 | 0.0 | - |
| STAT_HUD_USER0_FUNKTION_WERT | - | high | signed int | - | - | 1.0 | 1.0 | 0.0 | - |
| STAT_HUD_USER1_BRIGHT_WERT | - | high | unsigned char | - | - | 1.0 | 1.0 | 0.0 | - |
| STAT_HUD_USER1_HEIGHT_WERT | - | high | unsigned char | - | - | 1.0 | 1.0 | 0.0 | - |
| STAT_HUD_USER1_ROTATION_WERT | - | high | unsigned char | - | - | 1.0 | 1.0 | 0.0 | - |
| STAT_HUD_USER1_FUNKTION_WERT | - | high | signed int | - | - | 1.0 | 1.0 | 0.0 | - |
| STAT_HUD_USER2_BRIGHT_WERT | - | high | unsigned char | - | - | 1.0 | 1.0 | 0.0 | - |
| STAT_HUD_USER2_HEIGHT_WERT | - | high | unsigned char | - | - | 1.0 | 1.0 | 0.0 | - |
| STAT_HUD_USER2_ROTATION_WERT | - | high | unsigned char | - | - | 1.0 | 1.0 | 0.0 | - |
| STAT_HUD_USER2_FUNKTION_WERT | - | high | signed int | - | - | 1.0 | 1.0 | 0.0 | - |
| STAT_HUD_GUEST_BRIGHT_WERT | - | high | unsigned char | - | - | 1.0 | 1.0 | 0.0 | - |
| STAT_HUD_GUEST_HEIGHT_WERT | - | high | unsigned char | - | - | 1.0 | 1.0 | 0.0 | - |
| STAT_HUD_GUEST_ROTATION_WERT | - | high | unsigned char | - | - | 1.0 | 1.0 | 0.0 | - |
| STAT_HUD_GUEST_FUNKTION_WERT | - | high | signed int | - | - | 1.0 | 1.0 | 0.0 | - |

<a id="table-res-0x4804-d"></a>
### RES_0X4804_D
...
| RESULTNAME | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_DUMMY_WERT | - | high | unsigned char | - | - | 1.0 | 1.0 | 0.0 | Job führt zur Anzeige des Start-Up Bildes im HUD. |
...
| RESULTNAME | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_ANZAHL_WERT | - | high | unsigned char | - | - | 1.0 | 1.0 | 0.0 | Anzahl in der SW definierten Resourcen |
| STAT_RESERVE_DATA | DATA | high | data[3] | - | - | 1.0 | 1.0 | 0.0 | Reserve |
| STAT_ID_1_DATA | DATA | high | data[4] | - | - | 1.0 | 1.0 | 0.0 | ID |
| STAT_HASH_HU_1_DATA | DATA | high | data[16] | - | - | 1.0 | 1.0 | 0.0 | Hash-Wert HU |
| STAT_HASH_KOMBI_1_DATA | DATA | high | data[16] | - | - | 1.0 | 1.0 | 0.0 | Hash-Wert Kombi |
| STAT_GRAFIK_QUELLE_1_DATA | DATA | high | data[1] | - | - | 1.0 | 1.0 | 0.0 | Grafikquelle |
| STAT_ZAEHLER_1_DATA | DATA | high | data[2] | - | - | 1.0 | 1.0 | 0.0 | Speicher-Schreibzyklen-Zähler |
| STAT_RESERVE_1_DATA | DATA | high | data[1] | - | - | 1.0 | 1.0 | 0.0 | Reserve (00h) |
| STAT_ID_2_DATA | DATA | high | data[4] | - | - | 1.0 | 1.0 | 0.0 | ID |
| STAT_HASH_HU_2_DATA | DATA | high | data[16] | - | - | 1.0 | 1.0 | 0.0 | Hash-Wert HU |
| STAT_HASH_KOMBI_2_DATA | DATA | high | data[16] | - | - | 1.0 | 1.0 | 0.0 | Hash-Wert Kombi |
| STAT_GRAFIK_QUELLE_2_DATA | DATA | high | data[1] | - | - | 1.0 | 1.0 | 0.0 | Grafikquelle |
| STAT_ZAEHLER_2_DATA | DATA | high | data[2] | - | - | 1.0 | 1.0 | 0.0 | Speicher-Schreibzyklen-Zähler |
| STAT_RESERVE_2_DATA | DATA | high | data[1] | - | - | 1.0 | 1.0 | 0.0 | Reserve (00h) |
| STAT_ID_3_DATA | DATA | high | data[4] | - | - | 1.0 | 1.0 | 0.0 | ID |
| STAT_HASH_HU_3_DATA | DATA | high | data[16] | - | - | 1.0 | 1.0 | 0.0 | Hash-Wert HU |
| STAT_HASH_KOMBI_3_DATA | DATA | high | data[16] | - | - | 1.0 | 1.0 | 0.0 | Hash-Wert Kombi |
| STAT_GRAFIK_QUELLE_3_DATA | DATA | high | data[1] | - | - | 1.0 | 1.0 | 0.0 | Grafikquelle |
| STAT_ZAEHLER_3_DATA | DATA | high | data[2] | - | - | 1.0 | 1.0 | 0.0 | Speicher-Schreibzyklen-Zähler |
| STAT_RESERVE_3_DATA | DATA | high | data[1] | - | - | 1.0 | 1.0 | 0.0 | Reserve (00h) |
| STAT_ID_4_DATA | DATA | high | data[4] | - | - | 1.0 | 1.0 | 0.0 | ID |
| STAT_HASH_HU_4_DATA | DATA | high | data[16] | - | - | 1.0 | 1.0 | 0.0 | Hash-Wert HU |
| STAT_HASH_KOMBI_4_DATA | DATA | high | data[16] | - | - | 1.0 | 1.0 | 0.0 | Hash-Wert Kombi |
| STAT_GRAFIK_QUELLE_4_DATA | DATA | high | data[1] | - | - | 1.0 | 1.0 | 0.0 | Grafikquelle |
| STAT_ZAEHLER_4_DATA | DATA | high | data[2] | - | - | 1.0 | 1.0 | 0.0 | Speicher-Schreibzyklen-Zähler |
| STAT_RESERVE_4_DATA | DATA | high | data[1] | - | - | 1.0 | 1.0 | 0.0 | Reserve (00h) |
| STAT_ID_5_DATA | DATA | high | data[4] | - | - | 1.0 | 1.0 | 0.0 | ID |
| STAT_HASH_HU_5_DATA | DATA | high | data[16] | - | - | 1.0 | 1.0 | 0.0 | Hash-Wert HU |
| STAT_HASH_KOMBI_5_DATA | DATA | high | data[16] | - | - | 1.0 | 1.0 | 0.0 | Hash-Wert Kombi |
| STAT_GRAFIK_QUELLE_5_DATA | DATA | high | data[1] | - | - | 1.0 | 1.0 | 0.0 | Grafikquelle |
| STAT_ZAEHLER_5_DATA | DATA | high | data[2] | - | - | 1.0 | 1.0 | 0.0 | Speicher-Schreibzyklen-Zähler |
| STAT_RESERVE_5_DATA | DATA | high | data[1] | - | - | 1.0 | 1.0 | 0.0 | Reserve (00h) |
| STAT_ID_6_DATA | DATA | high | data[4] | - | - | 1.0 | 1.0 | 0.0 | ID |
| STAT_HASH_HU_6_DATA | DATA | high | data[16] | - | - | 1.0 | 1.0 | 0.0 | Hash-Wert HU |
| STAT_HASH_KOMBI_6_DATA | DATA | high | data[16] | - | - | 1.0 | 1.0 | 0.0 | Hash-Wert Kombi |
| STAT_GRAFIK_QUELLE_6_DATA | DATA | high | data[1] | - | - | 1.0 | 1.0 | 0.0 | Grafikquelle |
| STAT_ZAEHLER_6_DATA | DATA | high | data[2] | - | - | 1.0 | 1.0 | 0.0 | Speicher-Schreibzyklen-Zähler |
| STAT_RESERVE_6_DATA | DATA | high | data[1] | - | - | 1.0 | 1.0 | 0.0 | Reserve (00h) |
...
Dimensions: 112 rows × 16 columns
...
| HUD_PIA | 0x4801 | - | HUD_PIA | - | - | - | - | - | - | - | - | - | 22 | - | RES_0x4801_D |
| HUD_SYSTEMDATENEINBLENDUNG | 0x4802 | - | HUD_SYSTEMDATENEINBLENDUNG | - | - | - | - | - | - | - | - | - | 2E | ARG_0x4802_D | - |
| HUD_START_UP_SCREEN | 0x4804 | - | HUD_START_UP_SCREEN | - | - | - | - | - | - | - | - | - | 2F | - | RES_0x4804_D |
...
| KOMBI_TRIGGER_DATENTRANSFER | 0xA4A0 | - | Trigger für das Kombi, Grafikdaten von der HU anzufordern, empfangen und speichern | - | - | - | - | - | - | - | - | - | 31 | ARG_0xA4A0_R | - |
...
| KOMBI_GRAFIK_DATEN | 0xE4D0 | - | Aktuelle Grafikdaten aus dem Kombi lesen (Ein Schreiben der daten ist nicht möglich) | - | - | - | - | - | - | - | - | - | 22 | - | RES_0xE4D0_D |
