...
| STAT_DKPADAPT_TEXT | string | Status Fahrwertgeberadaption |
| STAT_DKPADAPT_ZUST | string | Status Fahrwertgeberadaption |
| STAT_DKPADAPT_WERT | long | Status Fahrwertgeberadaption |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
| _TEL_AUFTRAG | binary | Hex-Auftrag an SG |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
...
| STAT_FZGM_AKTUELL_MODUS_TEXT | string | Rain, Sport, Race, Slick aktuell aktiver Fahrzeugmodus Dieser Wert gibt den Wert der 4 niederwertigsten Bits (Bits 0 bis 3) des hochwertigsten Byte (Byte 2) von „eeprom_fzgmspeicher1“ aus, folgende Wertetabelle gilt: 1 = Rain, 2 = Sport, 3 = Race, 4 = Slick |
...
| STAT_FZGM_ZWEITLETZT_MODUS_TEXT | string | Rain, Sport, Race, Slick im vorletzten Fahrzyklus aktiver Fahrzeugmodus Dieser Wert gibt den Wert der 4 niederwertigsten Bits (Bits 0 bis 3) des hochwertigsten Byte (Byte 2) von „eeprom_fzgmspeicher2“ aus, folgende Wertetabelle gilt: 1 = Rain, 2 = Sport, 3 = Race, 4 = Slick |
...
| STAT_FZGM_DRITTLETZT_MODUS_TEXT | string | Rain, Sport, Race, Slick im drittletzten Fahrzyklus aktiver Fahrzeugmodus Dieser Wert gibt den Wert der 4 niederwertigsten Bits (Bits 0 bis 3) des hochwertigsten Byte (Byte 2) von „eeprom_fzgmspeicher3“ aus, folgende Wertetabelle gilt: 1 = Rain, 2 = Sport, 3 = Race, 4 = Slick |
...
| STAT_FZGM_VIERTLETZT_MODUS_TEXT | string | Rain, Sport, Race, Slick im viertletzten Fahrzyklus aktiver Fahrzeugmodus Dieser Wert gibt den Wert der 4 niederwertigsten Bits (Bits 0 bis 3) des hochwertigsten Byte (Byte 2) von „eeprom_fzgmspeicher4“ aus, folgende Wertetabelle gilt: 1 = Rain, 2 = Sport, 3 = Race, 4 = Slick |
...
- [FORTTEXTE](#table-forttexte) (101 × 2)
- [FDETAILSTRUKTUR](#table-fdetailstruktur) (7 × 2)
- [FARTTEXTEERWEITERT](#table-farttexteerweitert) (7 × 3)
- [FUMWELTMATRIX](#table-fumweltmatrix) (101 × 5)
- [HORTTEXTE](#table-horttexte) (1 × 2)
- [HDETAILSTRUKTUR](#table-hdetailstruktur) (7 × 2)
- [IORTTEXTE](#table-iorttexte) (1 × 2)
- [IDETAILSTRUKTUR](#table-idetailstruktur) (7 × 2)
- [FUMWELTTEXTE](#table-fumwelttexte) (108 × 9)
- [TAB_ADAPTIONSWERTE](#table-tab-adaptionswerte) (47 × 8)
...
- [TAB_FAHRZEUGMODUS](#table-tab-fahrzeugmodus) (5 × 2)
