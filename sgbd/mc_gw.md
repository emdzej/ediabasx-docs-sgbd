...
| Field | Value |
| --- | --- |
| ECU | MOST/CAN-Gateway E65 (MC_GW) |
| ORIGIN | BMW TI-431 Dennert |
| REVISION | 1.05 |
| AUTHOR | BMW TI-431 Dennert, BMW EE-44 Muehlbauer, BMW TI-430 Gelfert |
| COMMENT | Fuer die komplette Diagnose des MMI/GT ist die SGBD mmi_gt notwendig |
| PACKAGE | 1.32 |
| SPRACHE | deutsch |
...
- [STEUERN_DISPLAYHELLIGKEIT](#job-steuern-displayhelligkeit) - Steuern der Displayhelligkeit KWP2000: $30 InputOutputControlByLocalIdentifier $01 inputOutputLocalIdentifier $07 shortTermAdjustment Modus  : Default
- [STEUERN_SELBSTTEST](#job-steuern-selbsttest) - Ansteuerung des Selbsttests fuer den Gateway-Rechner Bei Erkennung eines Fehlverhaltens erfolgt ein Eintrag im Shadow-Fehlerspeicher. Tritt der gleiche Fehler waehrend des Selbsttests 3mal hintereinander auf, erfolgt ein Eintrag im Primaer-Fehlerspeicher. KWP2000: $31 StartRoutineByLocalIdentifier $04 routineLocalIdentifier (selfTest) Modus  : Default
...
- [STATUS_ANALOG_UMGEBUNGSHELLIGKEIT](#job-status-analog-umgebungshelligkeit) - Auslesen des Wertes des Helligkeitssensors im MMI/GT KWP2000: $30 InputOutputControlByLocalIdentifier $02 inputOutputLocalIdentifier $07 shortTermAdjustment Modus  : Default
- [STATUS_ANALOG_TEMPERATUR](#job-status-analog-temperatur) - Status der Temperaturwerte im MMI-Rechner und am CCT/LCD KWP2000: $30 InputOutputControlByLocalIdentifier $03 inputOutputLocalIdentifier $07 shortTermAdjustment Modus  : Default
...
<a id="job-steuern-displayhelligkeit"></a>
### STEUERN_DISPLAYHELLIGKEIT

Steuern der Displayhelligkeit KWP2000: $30 InputOutputControlByLocalIdentifier $01 inputOutputLocalIdentifier $07 shortTermAdjustment Modus  : Default

#### Arguments

| Name | Type | Comment |
| --- | --- | --- |
| DISPLAYHELLIGKEIT | string | Einzustellende Displayhelligkeit table DisplayHelligkeit NAME |
...
| Name | Type | Comment |
| --- | --- | --- |
| TEMP_RELEASE | unsigned char | Unterschreiten: MMI und Display werden eingeschaltet |
| TEMP_WARM | unsigned char | hat derzeit keine Auswirkung |
| TEMP_HIGH | unsigned char | Überschreiten: MMI und Display werden abgeschaltet Unterschreiten: MOST wird eingeschaltet |
| TEMP_CRIT | unsigned char | Überschreiten: MOST wird abgeschaltet |
...
<a id="job-status-analog-umgebungshelligkeit"></a>
### STATUS_ANALOG_UMGEBUNGSHELLIGKEIT

Auslesen des Wertes des Helligkeitssensors im MMI/GT KWP2000: $30 InputOutputControlByLocalIdentifier $02 inputOutputLocalIdentifier $07 shortTermAdjustment Modus  : Default
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_UMG_HELLIGKEIT_WERT | unsigned int | Zahlenwert der Umgebungshelligkeit am MMI/GT Byteorder: High / Low |
| STAT_UMG_HELLIGKEIT_EINH | string | Einheit von STAT_UMG_HELLIGKEIT_WERT (lux) |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |

<a id="job-status-analog-temperatur"></a>
### STATUS_ANALOG_TEMPERATUR

Status der Temperaturwerte im MMI-Rechner und am CCT/LCD KWP2000: $30 InputOutputControlByLocalIdentifier $03 inputOutputLocalIdentifier $07 shortTermAdjustment Modus  : Default
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_TEMP_FOT_WERT | char | Zahlenwert der FOT-Temperatur Byteorder: High / Low |
| STAT_TEMP_FOT_EINH | string | Einheit von STAT_TEMP_FOT_WERT (Grad C) |
| STAT_TEMP_LCD_WERT | char | Zahlenwert der CCT/LCD-Temperatur Byteorder: High / Low |
| STAT_TEMP_LCD_EINH | string | Einheit von STAT_TEMP_LCD_WERT (Grad C) |
...
| Name | Type | Comment |
| --- | --- | --- |
| STAT_TEMP_RELEASE | unsigned char | Unterschreiten: MMI und Display werden eingeschaltet |
| STAT_TEMP_WARM | unsigned char | Hat derzeit keine Bedeutung |
| STAT_TEMP_HIGH | unsigned char | Überschreiten: MMI und Display werden abgeschaltet Unterschreiten: MOST wird eingeschaltet |
| STAT_TEMP_CRIT | unsigned char | Überschreiten: MOST wird abgeschaltet |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
- [SHADOWDTC](#table-shadowdtc) (14 × 2)
- [IORTTEXTE](#table-iorttexte) (22 × 2)
- [IDETAILSTRUKTUR](#table-idetailstruktur) (4 × 2)
- [IUMWELTMATRIX](#table-iumweltmatrix) (19 × 5)
- [IUMWELTTEXTE](#table-iumwelttexte) (11 × 9)
- [TDISPLAYHELLIGKEIT](#table-tdisplayhelligkeit) (6 × 3)
...
| ORT | ORTTEXT |
| --- | --- |
| 0xA168 | Fehler MOST/CAN-Gateway |
| 0xA169 | Fehler LCD/Inverter MMIGT |
| 0xA16B | FeTraWe-Mode für MOST-Verbund ist aktiv |
| 0xE184 | CAN-Low, Physikalischer Busfehler |
| 0xE187 | Controller, Bus off |
...
| 0x02 | Temperatur CCT/LCD | Grad C | high | signed int | -- | 1 | 1 | 0 |
| 0x03 | Bordnetzspannung | Volt | high | unsigned int | -- | 1 | 10 | 0 |
| 0x04 | Fehlerursache | 0-n | high | 0xFFFF | ShadowDTC | -- | -- | -- |
| 0x21 | NPR | Hex | high | unsigned int | -- | 1 | 1 | 0 |
...
| WERT | UWTEXT |
| --- | --- |
| 0xA170 | Fehler IPC Startup (DTC 0xA170) |
| 0xA171 | Fehler IPC Operation (DTC 0xA171) |
| 0xA172 | Fehler Laden FPGA (DTC 0xA172) |
| 0xA173 | Fehler OS8104 (DTC 0xA173) |
| 0xA174 | Fehler FLASH-ROM (DTC 0xA174) |
| 0xA175 | Fehler RAM (DTC 0xA175) |
| 0xA176 | Fehler EEPROM (DTC 0xA176) |
| 0xA177 | MMI-Rechner Temperatur zu hoch (DTC 0xA177) |
| 0xA17A | Fehler Ausgang FPGA (DTC 0xA17A) |
| 0xA17B | Fehler Safety-Signal (DTC 0xA17B) |
| 0xA17C | Fehler UInverter (DTC 0xA17C) |
| 0xA17D | Fehler Temperatursensor LCD (DTC 0xA17D) |
| 0xA17E | CCT/LCD Temperatur zu hoch (DTC 0xA17E) |
| 0xA180 | Pufferueberlauf Empfangspuffer (DTC 0xA180) |
...
| 0xA173 | Fehler OS8104 |
| 0xA174 | Fehler FLASH-ROM |
| 0xA175 | Fehler RAM |
| 0xA176 | Fehler EEPROM |
| 0xA177 | MMI-Rechner Temperatur zu hoch |
| 0xA17A | Fehler Ausgang FPGA |
| 0xA17B | Fehler Safety-Signal |
| 0xA17C | Fehler UInverter |
| 0xA17D | Fehler Temperatursensor LCD |
| 0xA17E | CCT/LCD Temperatur zu hoch |
...
| 0xA176 | 0x01 | 0x03 | -- | -- |
| 0xA177 | 0x01 | 0x03 | -- | -- |
| 0xA17A | 0x01 | 0x02 | 0x03 | -- |
| 0xA17B | 0x01 | 0x02 | 0x03 | -- |
| 0xA17C | 0x01 | 0x02 | 0x03 | -- |
| 0xA17D | 0x01 | 0x02 | 0x03 | -- |
| 0xA17E | 0x01 | 0x02 | 0x03 | -- |
| 0xA180 | 0x04 | -- | -- | -- |
| 0x9308 | 0x21 | -- | -- | -- |
| 0x930B | 0x22 | 0x23 | 0x24 | 0x25 |
| 0x930F | 0x26 | -- | -- | -- |
| 0x9310 | 0x22 | 0x23 | 0x24 | 0x25 |
| default | -- | -- | -- | -- |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 0x01 | Temperatur MMI-Rechner | Grad C | high | signed int | -- | 1 | 1 | 0 |
| 0x02 | Temperatur LCD | Grad C | high | signed int | -- | 1 | 1 | 0 |
| 0x03 | Bordnetzspannung | Volt | high | unsigned int | -- | 1 | 10 | 0 |
| 0x04 | Bustyp | Hex | high | unsigned int | -- | 1 | 1 | 0 |
| 0x21 | Resetursache | Hex | high | unsigned int | -- | 1 | 1 | 0 |
| 0x22 | Logische-Knotenadresse | Hex | high | unsigned int | -- | 1 | 1 | 0 |
| 0x23 | FBlockID | Hex | high | unsigned int | -- | 1 | 1 | 0 |
| 0x24 | InstID | Hex | high | unsigned int | -- | 1 | 1 | 0 |
| 0x25 | FktID | Hex | high | unsigned int | -- | 1 | 1 | 0 |
| 0x26 | Diagnoseadresse | Hex | high | unsigned int | -- | 1 | 1 | 0 |
| 0xXY | unbekannte Umweltbedingung | 1 | -- | unsigned int | -- | 1 | 1 | 0 |

<a id="table-tdisplayhelligkeit"></a>
### TDISPLAYHELLIGKEIT
...
| NAME | MASKE | TEXT |
| --- | --- | --- |
| Aus | 0x00 | Displayhelligkeit aus |
| 25% | 0x19 | Displayhelligkeit 25% |
| 50% | 0x32 | Displayhelligkeit 50% |
| 75% | 0x48 | Displayhelligkeit 75% |
| 100% | 0x64 | Displayhelligkeit 100% |
| Normal | 0xFF | Normale Display-Regelung einschalten |
