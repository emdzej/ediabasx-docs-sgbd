...
| Field | Value |
| --- | --- |
| ECU | Einstiegshilfe Beifahrerseite E46 |
...
- [INITIALISIERUNG](#job-initialisierung) - Init-Job fuer B_SM46 automatischer Aufruf beim ersten Zugriff auf SGBD
- [IDENT](#job-ident) - Ident-Daten fuer das B_SM46
...
- [STATUS_2_LESEN](#job-status-2-lesen) - Stati des B_SM46
