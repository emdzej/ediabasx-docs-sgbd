...
- [NUR_CODIERDATEN_SCHREIBEN_LEAR](#job-nur-codierdaten-schreiben-lear) - Beschreiben der Default-Codierdaten KWP2000: $2E WriteDataByCommonIdentifier $30xx Codierdaten Default schreiben Modus  : Default
...
- [LWR_LESEN](#job-lwr-lesen) - Lesen eines Codierdatensatzes zur Unterscheidung zwischen dynamischer, automatischer und manueller LWR bis FSV 5.5.2 KWP2000: $22   ReadDataByCommonIdentifier $3000 - $3EFF CodingDataSet
- [STATUS_LWR_LESEN](#job-status-lwr-lesen) - Lesen eines Codierdatensatzes zur Unterscheidung zwischen dynamischer, automatischer und manueller LWR ab FSV 5.6.0 KWP2000: $22   ReadDataByCommonIdentifier $3400 - $3EFF CodingDataSet
...
- [NUR_CODE_IN_EEPROM_SCHREIBEN_LEAR](#job-nur-code-in-eeprom-schreiben-lear) - Beschreiben der Default-Codierdaten KWP2000: $2E WriteDataByCommonIdentifier $31xx Code in EEPROM schreiben Modus  : Default
- [AUTHENTISIERUNG_EINFACH_LEAR](#job-authentisierung-einfach-lear) - Authentisierung einfach fuer Development KWP2000: $31 StartRoutineByLocalIdentifier $07 RequestForAuthentication $08 ReleaseAuthentication Modus  : Default
...
- [NUR_CODIERDATEN_LESEN_KOMPLETT_LEAR](#job-nur-codierdaten-lesen-komplett-lear) - Auslesen der kompletten Codierdaten KWP 2000: $22 ReadDataByCommonIdentifier funktioniert nur bis FSV 5.5.2 Modus  : Default
...
- [HERSTELLER_DATEN_SCHREIBEN_LEAR](#job-hersteller-daten-schreiben-lear) - Schreiben der Herstellerdaten KWP2000: $2E WriteDataByCommonIdentifier $0004 Herstellerdaten schreiben
- [HERSTELLER_DATEN_LESEN_LEAR](#job-hersteller-daten-lesen-lear) - Auslesen der Herstellerdaten KWP2000: $22 ReadDataByCommonIdentifier $0004 Herstellerdaten lesen
...
- [EEPROM_SCHREIBEN_LEAR](#job-eeprom-schreiben-lear) - Schreiben der Kodierdaten KWP2000: $2E WriteDataByCommonIdentifier $30xx Codierdaten schreiben bis FSV 5.5.2 $31xx Code in EEPROM schreiben $34xx Codierdaten schreiben ab FSV 5.7.0 Modus  : Default
...
- [STATUS_LWR_POSITION](#job-status-lwr-position) - KWP2000: $30 InputOutputControlByLocalIdentifier $01 ReportCurrentState $0F STATUS_LWR_POSITION
...
- [STATUS_FAHRZEUGNEIGUNG](#job-status-fahrzeugneigung) - KWP2000: $30 InputOutputControlByLocalIdentifier $01 ReportCurrentState $18 STATUS_FAHRZEUGNEIGUNG
...
- [STEUERN_LAMPEN_ALLE_LEAR](#job-steuern-lampen-alle-lear) - KWP2000: $30 InputOutputControlByLocalIdentifier $07 ShortTermAdjustment $01 Dimmwert an PWM-Port Status von LM-E6X schreiben
- [FLASH_PROG_STATUS_SCHREIBEN_LEAR](#job-flash-prog-status-schreiben-lear) - Flashprogrammierstatus schreiben KWP2000: $3B WriteDataByLocalIdentifier $02 FlashProgrammierstatus auf 1 setzen Modus  : Default
...
- [RESET_KURZSCHLUSS_SPERRE](#job-reset-kurzschluss-sperre) - Kurzschlusssperre ueber Diagnose ausschalten KWP2000: $30 InputOutputControlByLocalIdentifier $07 ShortTermAdjustment $13 Kurzschlusssperre ausschalten Status von LM-E6X schreiben
...
- [WARTEZEIT_LEAR](#job-wartezeit-lear) - Wartezeit
- [READ_CAN_BUS_ERROR_LEAR](#job-read-can-bus-error-lear) - KWP 2000: $21 ReadDataByLocalIdentifier $03 CAN_BUS_ERROR Modus   : Default
- [CLR_CAN_BUS_ERROR_LEAR](#job-clr-can-bus-error-lear) - KWP2000: $3B WriteDataByLocalIdentifier $03 CAN_BUS_ERROR Modus  : Default
- [READ_REGISTER_U435_LEAR](#job-read-register-u435-lear) - KWP 2000: $21 ReadDataByLocalIdentifier $03 READ_REGISTER_U435 Modus   : Default
- [WRITE_REGISTER_U435_LEAR](#job-write-register-u435-lear) - KWP2000: $3B WriteDataByLocalIdentifier $03 WRITE_REGISTER_U435 Modus  : Default
- [_CODIERDATEN_3000_LESEN_KOMPLETT_LEAR](#job-codierdaten-3000-lesen-komplett-lear) - Auslesen der kompletten Codierdaten im 3000-Bereich Auslesen der LM-Codierdaten bis FSV 5.5.1 KWP 2000: $22 ReadDataByCommonIdentifier Modus  : Default
- [_CODIERDATEN_3400_LESEN_KOMPLETT_LEAR](#job-codierdaten-3400-lesen-komplett-lear) - Auslesen der kompletten Codierdaten im 3400-Bereich Auslesen der LM-Codierdaten ab FSV 5.6.0 KWP 2000: $22 ReadDataByCommonIdentifier Modus  : Default
...
- [_CODIERDATEN_3000_SCHREIBEN_AUS_DATEI_LEAR](#job-codierdaten-3000-schreiben-aus-datei-lear) - Beschreiben der Default-Codierdaten Beschreiben der LM-Codierdaten bis FSV 5.5.2 KWP2000: $2E WriteDataByCommonIdentifier $30xx Codierdaten, Default Modus  : Default
- [_CODIERDATEN_3400_SCHREIBEN_AUS_DATEI_LEAR](#job-codierdaten-3400-schreiben-aus-datei-lear) - Beschreiben der Default-Codierdaten Beschreiben der LM-Codierdaten ab FSV 5.6.0 KWP2000: $2E WriteDataByCommonIdentifier $34xx Codierdaten, Default Modus  : Default
...
| Name | Type | Comment |
| --- | --- | --- |
| BLOCK | string | Bereich: 30xx und 31xx und 34xx |
...
Lesen eines Codierdatensatzes zur Unterscheidung zwischen dynamischer, automatischer und manueller LWR bis FSV 5.5.2 KWP2000: $22   ReadDataByCommonIdentifier $3000 - $3EFF CodingDataSet
...
Lesen eines Codierdatensatzes zur Unterscheidung zwischen dynamischer, automatischer und manueller LWR ab FSV 5.6.0 KWP2000: $22   ReadDataByCommonIdentifier $3400 - $3EFF CodingDataSet
...
| Name | Type | Comment |
| --- | --- | --- |
| STAT_KEINE_LWR | unsigned char | 0 oder 1, ob LWR aktiv |
...
<a id="job-nur-codierdaten-lesen-komplett-lear"></a>
### NUR_CODIERDATEN_LESEN_KOMPLETT_LEAR

Auslesen der kompletten Codierdaten KWP 2000: $22 ReadDataByCommonIdentifier funktioniert nur bis FSV 5.5.2 Modus  : Default
...
Schreiben der Kodierdaten KWP2000: $2E WriteDataByCommonIdentifier $30xx Codierdaten schreiben bis FSV 5.5.2 $31xx Code in EEPROM schreiben $34xx Codierdaten schreiben ab FSV 5.7.0 Modus  : Default

#### Arguments

| Name | Type | Comment |
| --- | --- | --- |
| CODIERDATEN_DATEI | string | Dateiname mit Kodierdaten Datei muss in ediabas/ecu liegen bei leerem Argument wird die Datei cod_lm.dat codiert letztes Zeichen muss ein LF sein |
...
KWP2000: $30 InputOutputControlByLocalIdentifier $01 ReportCurrentState $0F STATUS_LWR_POSITION
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_STATUS_LWR_POSITION | int | STATUS_LWR_POSITION auslesen |
| STAT_LWR_SOLL_POSITION | int | STATUS_LWR_SOLL_POSITION auslesen |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
KWP2000: $30 InputOutputControlByLocalIdentifier $01 ReportCurrentState $18 STATUS_FAHRZEUGNEIGUNG
...
| STAT_SML_VORN_SHORT_CIRCUIT_COUNTER_MAX | int | Seitenmarkierungslicht VORN SHORT_CIRCUIT_COUNTER_MAX |
...
Auslesen der kompletten Codierdaten im 3000-Bereich Auslesen der LM-Codierdaten bis FSV 5.5.1 KWP 2000: $22 ReadDataByCommonIdentifier Modus  : Default
...
| Name | Type | Comment |
| --- | --- | --- |
| CODIERDATEN_LM | string | die kompletten Codierdaten im 3000-Bereich (LM bis FSV 5.5.1) |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
Auslesen der kompletten Codierdaten im 3400-Bereich Auslesen der LM-Codierdaten ab FSV 5.6.0 KWP 2000: $22 ReadDataByCommonIdentifier Modus  : Default
...
| Name | Type | Comment |
| --- | --- | --- |
| CODIERDATEN_LM | string | die kompletten Codierdaten im 3400-Bereich (LM ab FSV 5.6.0) |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
Beschreiben der Default-Codierdaten Beschreiben der LM-Codierdaten bis FSV 5.5.2 KWP2000: $2E WriteDataByCommonIdentifier $30xx Codierdaten, Default Modus  : Default
...
Beschreiben der Default-Codierdaten Beschreiben der LM-Codierdaten ab FSV 5.6.0 KWP2000: $2E WriteDataByCommonIdentifier $34xx Codierdaten, Default Modus  : Default
...
- [IORTTEXTE](#table-iorttexte) (45 × 2)
- [IDETAILSTRUKTUR](#table-idetailstruktur) (4 × 2)
- [IUMWELTMATRIX](#table-iumweltmatrix) (42 × 5)
...
| 0x9CBD | Tiefentladungsschutz der Batterie: Abschaltung Standlicht |
| 0x9CBE | Tiefentladungsschutz der Batterie: Abschaltung Parklicht |
| 0x9CBF | Batterie tiefentladen |
| 0x9CC0 | Unkonsistenz: Softwareversion und Codierindex |
...
| 0xE519 | Alive-Signal vom ALC-System fehlt |
| 0xE51A | Telegramm Fernlichtassistent Timeout |
...
| 0x05 | ERR_LAMPE | 0-n | - | 0x7F | Err_Lampe | 1 | 1 | 0 |
...
| 0x9332 | Alive-Signal vom ALC-System fehlt |
| 0x9333 | RLS Grund: Dunkelheit aber Abblendlicht aus |
| 0xFFFF | unbekannter Fehlerort |
