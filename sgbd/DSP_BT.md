...
- [INITIALISIERUNG](#job-initialisierung) - Init-Job fuer DSP-BT
- [IDENT](#job-ident) - Ident-Daten fuer DSP-BT
- [STAT_TASTEN](#job-stat-tasten) - Status aller Tasten am DSP Bedienteil abfragen
...
| STAT_SET_TASTE_EIN | int | SET Taste betaetigt ? |
| STAT_PFEIL_TASTE_EIN | int | &gt;&gt; Taste betaetigt ? |
| STAT_LINKS_TASTE_EIN | int | &lt; Taste betaetigt ? |
