...
| Field | Value |
| --- | --- |
| ECU | genaue Bezeichnung des SG |
| ORIGIN | BMW Abteilung Name |
| REVISION | 0.13 |
| AUTHOR | Firma Abteilung Name |
| COMMENT | MOST-Muster-SGBD fuer E65 |
| PACKAGE | 1.03 |
| SPRACHE | deutsch |
...
| ORT | ORTTEXT |
| --- | --- |
| 0xC94C | Ein Device hat die Monitoringnachricht nicht abgenommen oder bestätigt. (Error_Monitoring). |
| 0xC94D | Weckendes Device hat 3 mal erfolglos versucht das Netzwerk zu wecken. (Error_WakeUp_Failed). |
| 0xC94E | Obwohl Shutdown(Execute) geschickt wurde, ging das Licht nicht aus. (Error_Light_Not_Off). |
| 0xC94F | Zentrale Registry stimmt nicht mit der Sollkonfiguration ueberein (Error_Registry_New). |
| 0xC950 | Ringbruchdiagnose wurde durchgefuehrt (Error_Ring_Diagnose). |
| 0xC951 | Lange und/oder häufige Unlocks (Error_Unlock_Long). |
| 0xC952 | Ein Device hat sich wegen Uebertemperatur abgeschaltet (Error_Temp_Shutdown). |
