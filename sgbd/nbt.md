...
- [STEUERN_REPAIR_HMI_MINI](#job-steuern-repair-hmi-mini) - job to delete a special Mini HMI file file and thus repairing that Mini HMI in F-branch shows only two-colour HMI IMPORTANT: ONLY USE IN F_BRANCH 11/13, never in 03/14 or later!
- [STEUERN_POSITIONING_REPAIR](#job-steuern-positioning-repair) - jpb to delete the navi persistency and repair NBT positioning problem based on shell naiv.sh
- [STEUERN_POSITIONING_REPAIR_NBT_ASIA](#job-steuern-positioning-repair-nbt-asia) - job to delete the navi persistency and repair NBT positioning problem based on shell naiv.sh only execute on NBT Asia Veriants
...
- [STATUS_HU_NBT_CHECK_IBA_ASIEN](#job-status-hu-nbt-check-iba-asien) - Spezial-job um zu testen, ob die Asien IBA auf dem Gerät ist
- [STATUS_HU_NBT_FIRMWARE_VERSIONS](#job-status-hu-nbt-firmware-versions) - Ausgabe der Version der Firmware Versionen NBT
- [DIAGTUNNELLING_UDS](#job-diagtunnelling-uds) - complete tunneling of UDS telegrams
- [LESEN_PROVISIONING_DATA](#job-lesen-provisioning-data) - Lesen der Provisionierungsdaten Modus	 : Default
...
- [STEUERN_REPAIR_HMI_MINI_2](#job-steuern-repair-hmi-mini-2) - second job to fix Mini HMI grey (2-color) problem job now deletes corrupt ColorDefinitions.h.opt in /opt/hmi/data/ro/mini/view/ Supplier also writes 11/13 this file and sets fileflag ColorDefinitions.h.opt.fixed only if the job doesn't find the fileflag execution is possible problem only exists in F-Branch 11/13 IMPORTANT: ONLY USE IN F_BRANCH 11/13, never in 03/14 or later!
...
- [_STATUS_UART](#job-status-uart) - Liefert die HW-Variante der Headunit
- [STATUS_VERSION_GATEWAYTABELLE](#job-status-version-gatewaytabelle) - Lesen der Versionsnummer der Gateway-Tabelle
- [STEUERN_BORDERLINE_REPAIR](#job-steuern-borderline-repair) - repairs borderline issue by creating borderline ini file with germany setting
...
- [STEUERN_ERASE_ERRORMEMORY_PERSISTENCE](#job-steuern-erase-errormemory-persistence) - Job to delete error memory in case of error
- [STEUERN_FIX_SDARS_TRANSPORTMODE_OFF](#job-steuern-fix-sdars-transportmode-off) - Test job based on repair.sh
...
| Name | Type | Comment |
| --- | --- | --- |
| HU_HWVARIANTE_NAME | string | table Prozessklassen BEZEICHNUNG Text-Angabe der Prozessklasse |
| SGBM_IDENTIFIER | string | Angabe SGBM-ID der Prozessklasse |
| VERSION | string | Angabe der Version der Prozessklasse |
...
<a id="job-steuern-repair-hmi-mini"></a>
### STEUERN_REPAIR_HMI_MINI

job to delete a special Mini HMI file file and thus repairing that Mini HMI in F-branch shows only two-colour HMI IMPORTANT: ONLY USE IN F_BRANCH 11/13, never in 03/14 or later!
...
<a id="job-steuern-positioning-repair"></a>
### STEUERN_POSITIONING_REPAIR

jpb to delete the navi persistency and repair NBT positioning problem based on shell naiv.sh

#### Arguments

| Name | Type | Comment |
| --- | --- | --- |
| ARG_MODE | unsigned char | 0: just deleteting navi persistency , no reset 1: deleteting navi persistency , with reset 2: recommended:  deleteting navi persistency with switching to Bootloader and back |
...
<a id="job-steuern-positioning-repair-nbt-asia"></a>
### STEUERN_POSITIONING_REPAIR_NBT_ASIA

job to delete the navi persistency and repair NBT positioning problem based on shell naiv.sh only execute on NBT Asia Veriants

#### Arguments

| Name | Type | Comment |
| --- | --- | --- |
| ARG_MODE | unsigned char | 0: delete data and reset 1: if HU is in application mode, hu is reset to bootloader mode,if HU is in bootloader mode, the data is removed and HU is reset in application mode 2: recommended: go to Bootloader, delete data and switch back to application |
...
<a id="job-status-hu-nbt-check-iba-asien"></a>
### STATUS_HU_NBT_CHECK_IBA_ASIEN

Spezial-job um zu testen, ob die Asien IBA auf dem Gerät ist
...
| Name | Type | Comment |
| --- | --- | --- |
| STAT_CHECK_IBA_ASIEN | unsigned char | Ergebnis des Tests |
| STAT_CHECK_IBA_ASIEN_TEXT | string | Ergebnis des Tests |
| JOB_STATUS | string | "OKAY", wenn fehlerfrei |
| _RESPONSE_0 | binary | Hex-Antwort von SG |

<a id="job-status-hu-nbt-firmware-versions"></a>
### STATUS_HU_NBT_FIRMWARE_VERSIONS

Ausgabe der Version der Firmware Versionen NBT
...
| Name | Type | Comment |
| --- | --- | --- |
| STAT_DAB_FW_VERSION | string | Version der DAB Firmware |
| STAT_INIC_FW_VERSION | string | Version der INIC Firmware |
| STAT_IOC_POWER_BTLD_VERSION | string | Version der IOC Power BTLD |
| STAT_IOC_POWER_SW_VERSION | string | Version der IOC Power SW |
| STAT_IOC_DIAG_FW_VERSION | string | Version der IOC Diag Firmware |
| STAT_GPS_FW_VERSION | string | Version der GPS Firmware |
| JOB_STATUS | string | "OKAY", wenn fehlerfrei |
| _REQUEST | binary | Hex-Auftrag an SG |
| _RESPONSE | binary | Hex-Antwort von SG |
...
<a id="job-lesen-provisioning-data"></a>
### LESEN_PROVISIONING_DATA

Lesen der Provisionierungsdaten Modus	 : Default

#### Arguments

| Name | Type | Comment |
| --- | --- | --- |
| ARG_TYPE | unsigned char | Welche Daten gelesen werden sollen 0x01 DPAS 0x02 DAS 0x03 OTA |
| ARG_INDEX | unsigned char | Index des Provisioningsatzes (für DPAS und DAS) von 0-9 |
...
<a id="job-steuern-repair-hmi-mini-2"></a>
### STEUERN_REPAIR_HMI_MINI_2

second job to fix Mini HMI grey (2-color) problem job now deletes corrupt ColorDefinitions.h.opt in /opt/hmi/data/ro/mini/view/ Supplier also writes 11/13 this file and sets fileflag ColorDefinitions.h.opt.fixed only if the job doesn't find the fileflag execution is possible problem only exists in F-Branch 11/13 IMPORTANT: ONLY USE IN F_BRANCH 11/13, never in 03/14 or later!
...
| Name | Type | Comment |
| --- | --- | --- |
| ARG_TYPE | unsigned char | Welche Daten geschrieben werden sollen 0x03 OTA |
...
| Name | Type | Comment |
| --- | --- | --- |
| STAT_KOMP_ID | string | Kompatibilitätskennung für HDD Downloadsystem 'NBT-HB' (NBT ECE, US) 'NBT-APN' (NBT China, Korea) 'NBT-JAP' (NBT Japan) 'ENTRY_NAV' (EntryNav) |
| JOB_STATUS | string | "OKAY", wenn fehlerfrei |
| _REQUEST | binary | Hex-Auftrag an SG |
| _RESPONSE | binary | Hex-Antwort von SG |
...
| Name | Type | Comment |
| --- | --- | --- |
| STAT_UART_ACTIVATION_STATE_WERT | unsigned char | Returns the state of the serial traces |
| STAT_UART_ACTIVATION_STATE_TEXT | string | Returns the state of the serial traces as text |
| JOB_STATUS | string | "OKAY", wenn fehlerfrei |
| _REQUEST | binary | Hex-Auftrag an SG |
| _RESPONSE | binary | Hex-Antwort von SG |
...
<a id="job-steuern-borderline-repair"></a>
### STEUERN_BORDERLINE_REPAIR

repairs borderline issue by creating borderline ini file with germany setting
...
| Name | Type | Comment |
| --- | --- | --- |
| STAT_REPAIR_WERT | int | 0 - REPAIR_DONE, 1 - COULD_NOT_MOUNT_HDD, 255-NOT_DEFINED |
| STAT_REPAIR_TEXT | string | REPAIR_DONE, COULD_NOT_MOUNT_HDD, NOT_DEFINED |
| JOB_STATUS | string | "OKAY", wenn fehlerfrei |
| _RESPONSE | binary | Hex-Antwort von SG |
...
<a id="job-steuern-erase-errormemory-persistence"></a>
### STEUERN_ERASE_ERRORMEMORY_PERSISTENCE

Job to delete error memory in case of error
...
<a id="job-steuern-fix-sdars-transportmode-off"></a>
### STEUERN_FIX_SDARS_TRANSPORTMODE_OFF
...
| Name | Type | Comment |
| --- | --- | --- |
| ARG_UART_ACTIVATION_STATE | unsigned char | Desired state uart, 0x00 off, 0x01 on |
...
- [VERBAUORTTABELLE](#table-verbauorttabelle) (252 × 3)
...
- [ARG_0XA014_R](#table-arg-0xa014-r) (1 × 14)
- [ARG_0XA018_R](#table-arg-0xa018-r) (1 × 14)
- [ARG_0XA019_R](#table-arg-0xa019-r) (1 × 14)
...
- [ARG_0XA031_R](#table-arg-0xa031-r) (1 × 14)
...
- [ARG_0XA03E_R](#table-arg-0xa03e-r) (2 × 14)
...
- [ARG_0XD05F_D](#table-arg-0xd05f-d) (1 × 12)
- [ARG_0XD060_D](#table-arg-0xd060-d) (1 × 12)
- [ARG_0XD0A3_D](#table-arg-0xd0a3-d) (1 × 12)
- [ARG_0XD0A9_D](#table-arg-0xd0a9-d) (2 × 12)
...
- [ARG_0XF015_R](#table-arg-0xf015-r) (17 × 14)
...
- [FUMWELTTEXTE](#table-fumwelttexte) (193 × 9)
...
- [RES_0XA019_R](#table-res-0xa019-r) (35 × 13)
...
- [RES_0XA031_R](#table-res-0xa031-r) (1 × 13)
...
- [RES_0XA03E_R](#table-res-0xa03e-r) (2 × 13)
...
- [RES_0XA0AF_R](#table-res-0xa0af-r) (3 × 13)
...
- [RES_0XD016_D](#table-res-0xd016-d) (2 × 10)
...
- [RES_0XD03A_D](#table-res-0xd03a-d) (2 × 10)
...
- [RES_0XD05D_D](#table-res-0xd05d-d) (4 × 10)
- [RES_0XD05E_D](#table-res-0xd05e-d) (9 × 10)
- [RES_0XD05F_D](#table-res-0xd05f-d) (2 × 10)
- [RES_0XD060_D](#table-res-0xd060-d) (1 × 10)
- [RES_0XD063_D](#table-res-0xd063-d) (2 × 10)
- [RES_0XD065_D](#table-res-0xd065-d) (3 × 10)
- [RES_0XD066_D](#table-res-0xd066-d) (3 × 10)
...
- [RES_0XD0A8_D](#table-res-0xd0a8-d) (24 × 10)
- [RES_0XD0A9_D](#table-res-0xd0a9-d) (8 × 10)
...
- [RES_0XF015_R](#table-res-0xf015-r) (20 × 13)
- [RES_0XF023_R](#table-res-0xf023-r) (1 × 13)
- [SG_FUNKTIONEN](#table-sg-funktionen) (164 × 16)
...
- [TAB_0X4267](#table-tab-0x4267) (1 × 2)
...
- [TAB_RESETDATABASES](#table-tab-resetdatabases) (14 × 2)
...
- [TAB_UARTACTIVATIONSTATE](#table-tab-uartactivationstate) (3 × 2)
...
| ARG | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | MIN | MAX | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ARG_WLAN_ACTIVATION | 0-n | high | unsigned char | - | TAB_EIN_AUS | 1.0 | 1.0 | 0.0 | - | - | Aktivierungswert Werte aus der Tabelle TAB_EIN_AUS |

<a id="table-arg-0xd0a9-d"></a>
### ARG_0XD0A9_D
...
| ARG | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | MIN | MAX | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ARG_WLAN_WHITELIST_POSITION | - | high | unsigned char | - | - | 1.0 | 1.0 | 0.0 | - | - | Position des neuen Eintrags in die whitelist. Es sind maximal 8 Einträge in die whitelist möglich. Der Wert muss also zwischen 0x00 und 0x07 liegen. |
| ARG_WLAN_NEWENTRY | DATA | high | data[6] | - | - | 1.0 | 1.0 | 0.0 | - | - | MAC Adresse des neuen Geräts |
...
| ARG | STR | STPR | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | MIN | MAX | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ARG_NUMBER_PARTITIONS | + | - | MByte | high | unsigned char | - | - | 1.0 | 1.0 | 0.0 | - | - | Number of partitions that must be created |
| ARG_SIZE_PARTITION_1 | + | - | MByte | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | - | - | ssssssss long size of partition 1 (Navi DB) in Mbytes |
| ARG_SIZE_PARTITION_2 | + | - | MByte | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | - | - | Size of partition 2 (Gracenote eCDDB) in Mbytes |
| ARG_SIZE_PARTITION_3 | + | - | MByte | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | - | - | Size of partition 3 (IBA, logistic data, speech) in Mbytes |
| ARG_SIZE_PARTITION_4 | + | - | MByte | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | - | - | Size of partition 4 (user data) in Mbytes |
| ARG_SIZE_PARTITION_5 | + | - | MByte | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | - | - | Size of partition 5 (entertainment server) in Mbytes |
| ARG_SIZE_PARTITION_6 | + | - | MByte | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | - | - | Size of partition 6 (reserved for development) in Mbytes |
| ARG_SIZE_PARTITION_7 | + | - | MByte | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | - | - | Size of partition 7 in Mbytes (reserved for future use) |
| ARG_SIZE_PARTITION_8 | + | - | MByte | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | - | - | Size of partition 8 in Mbytes (reserved for future use) |
| ARG_SIZE_PARTITION_9 | + | - | MByte | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | - | - | Size of partition 9 in Mbytes (reserved for future use) |
| ARG_SIZE_PARTITION_10 | + | - | MByte | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | - | - | Size of partition 10 in Mbytes (reserved for future use) |
| ARG_SIZE_PARTITION_11 | + | - | MByte | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | - | - | Size of partition 11 in Mbytes (reserved for future use) |
| ARG_SIZE_PARTITION_12 | + | - | MByte | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | - | - | Size of partition 12 in Mbytes (reserved for future use) |
| ARG_SIZE_PARTITION_13 | + | - | MByte | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | - | - | Size of partition 13 in Mbytes (reserved for future use) |
| ARG_SIZE_PARTITION_14 | + | - | MByte | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | - | - | Size of partition 14 in Mbytes (reserved for future use) |
| ARG_SIZE_PARTITION_15 | + | - | MByte | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | - | - | Size of partition 15 in Mbytes (reserved for future use) |
| ARG_SIZE_PARTITION_16 | + | - | MByte | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | - | - | Size of partition 16 in Mbytes (reserved for future use) |
...
| 0xB7F8D5 | USB-Verbindung zwischen Head-Unit und TCB: keine Verbindung | 0 |
...
| 0xE1CC02 | Signal Rückwaertsgang: unplausibel | 1 |
| 0xE1CC03 | Signal Rückwärtsgang: nicht vorhanden | 1 |
| 0xE1CC04 | Externes Signal GierGeschwindigkeit: Fehler | 1 |
...
| 0x4245 | AMP_GYRO_CPU/OMAP5_HDD_DVD/BD_GPU_FOT_TEMP | Text | High | 1 | - | 1.0 | 1.0 | 0.0 |
...
| 0x101721 | USB-Verbindung zwischen Headunit zum TCB: Keine Antwort auf Ping | 0 |
...
| 0x101751 | 3D Sensor: Starke Beschleunigung der HU | 0 |
...
| 0x101770 | Calculation error of the navigation computer | 0 |
...
| RESULTNAME | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_FIRMWARE_SECURITY_PROCESSOR_TEXT | TEXT | - | string | - | - | 1.0 | 1.0 | 0.0 | Firmware version of the security processor |
| STAT_FIRMWARE_AUDIO_PROCESSOR_TEXT | TEXT | - | string | - | - | 1.0 | 1.0 | 0.0 | Firrmware version of the audio processor  |
| STAT_BASEBAND_IC_VERSION_TEXT | TEXT | - | string | - | - | 1.0 | 1.0 | 0.0 | Baseband IC version |
| STAT_MODULE_UC_SOFTWARE_VERSION_TEXT | TEXT | - | string | - | - | 1.0 | 1.0 | 0.0 | Module µC software version |
| STAT_FIRMWARE_PRODUCT_ID_TEXT | TEXT | - | string | - | - | 1.0 | 1.0 | 0.0 | Firmware version of the product_id |
| STAT_FIRMWARE_DATE_CODE_VERSION_TEXT | TEXT | - | string | - | - | 1.0 | 1.0 | 0.0 | Firmware version of the date code |
| STAT_FIRMWARE_TIME_CODE_VERSION_TEXT | TEXT | - | string | - | - | 1.0 | 1.0 | 0.0 | Firmware version of the time code |
| STAT_GCI_VERSION_TEXT | TEXT | - | string | - | - | 1.0 | 1.0 | 0.0 | GCI version |
| STAT_DATA_SERVICES_PROGRAM_GUIDE_VERSION_TEXT | TEXT | - | string | - | - | 1.0 | 1.0 | 0.0 | Data services program guide version |

<a id="table-res-0xd05f-d"></a>
### RES_0XD05F_D
...
| RESULTNAME | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_WLAN_ACTIVATION | 0-n | high | unsigned char | - | TAB_EIN_AUS | 1.0 | 1.0 | 0.0 | Aktivierungswert als Integer Werte aus der Tabelle TAB_EIN_AUS |

<a id="table-res-0xd0a8-d"></a>
### RES_0XD0A8_D
...
| RESULTNAME | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_WLAN_WHITELIST_1_DATA | DATA | high | data[6] | - | - | 1.0 | 1.0 | 0.0 | MAC Adresse des Geräts |
| STAT_WLAN_WHITELIST_2_DATA | DATA | high | data[6] | - | - | 1.0 | 1.0 | 0.0 | MAC Adresse des Geräts |
| STAT_WLAN_WHITELIST_3_DATA | DATA | high | data[6] | - | - | 1.0 | 1.0 | 0.0 | MAC Adresse des Geräts |
| STAT_WLAN_WHITELIST_4_DATA | DATA | high | data[6] | - | - | 1.0 | 1.0 | 0.0 | MAC Adresse des Geräts |
| STAT_WLAN_WHITELIST_5_DATA | DATA | high | data[6] | - | - | 1.0 | 1.0 | 0.0 | MAC Adresse des Geräts |
| STAT_WLAN_WHITELIST_6_DATA | DATA | high | data[6] | - | - | 1.0 | 1.0 | 0.0 | MAC Adresse des Geräts |
| STAT_WLAN_WHITELIST_7_DATA | DATA | high | data[6] | - | - | 1.0 | 1.0 | 0.0 | MAC Adresse des Geräts |
| STAT_WLAN_WHITELIST_8_DATA | DATA | high | data[6] | - | - | 1.0 | 1.0 | 0.0 | MAC Adresse des Geräts |
...
| RESULTNAME | STR | STPR | RRR | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_PARTITION_HDD | - | - | + | 0-n | high | unsigned char | - | - | 1.0 | 1.0 | 0.0 | Status of the partitioning process as integer |
| STAT_HDD_SIZE_WERT | - | - | + | - | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | STAT_HDD_SIZE_WERT |
| STAT_NUMBER_PARTITIONS_WERT | - | - | + | - | high | unsigned char | - | - | 1.0 | 1.0 | 0.0 | Number of partitions that are available |
| STAT_SIZE_PARTITION_1_WERT | - | - | + | - | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Size of partition 1 (Navi DB) in Mbytes |
| STAT_SIZE_PARTITION_2_WERT | - | - | + | - | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Size of partition 2 (Gracenote eCDDB) in Mbytes |
| STAT_SIZE_PARTITION_3_WERT | - | - | + | - | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Size of partition 3 (IBA, logistic data, speech) in Mbytes |
| STAT_SIZE_PARTITION_4_WERT | - | - | + | - | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Size of partition 3 (IBA, logistic data, speech) in Mbytes |
| STAT_SIZE_PARTITION_5_WERT | - | - | + | - | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Size of partition 5 (entertainment server) in Mbytes |
| STAT_SIZE_PARTITION_6_WERT | - | - | + | - | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Size of partition 6 (reserved for development) in Mbytes |
| STAT_SIZE_PARTITION_7_WERT | - | - | + | - | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Size of partition 7 in Mbytes |
| STAT_SIZE_PARTITION_8_WERT | - | - | + | - | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Size of partition 8 in Mbytes |
| STAT_SIZE_PARTITION_9_WERT | - | - | + | - | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Size of partition 9 in Mbytes |
| STAT_SIZE_PARTITION_10_WERT | - | - | + | - | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Size of partition 10 in Mbytes |
| STAT_SIZE_PARTITION_11_WERT | - | - | + | - | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Size of partition 11 in Mbytes |
| STAT_SIZE_PARTITION_12_WERT | - | - | + | - | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Size of partition 12 in Mbytes |
| STAT_SIZE_PARTITION_13_WERT | - | - | + | - | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Size of partition 13 in Mbytes |
| STAT_SIZE_PARTITION_14_WERT | - | - | + | - | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Size of partition 14 in Mbytes |
| STAT_SIZE_PARTITION_15_WERT | - | - | + | - | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Size of partition 15  in Mbytes |
| STAT_SIZE_PARTITION_16_WERT | - | - | + | - | high | unsigned long | - | - | 1.0 | 1.0 | 0.0 | Size of partition 16 in Mbytes |
| STAT_PARTITION_ERROR | - | - | + | 0-n | high | unsigned char | - | - | 1.0 | 1.0 | 0.0 | Error that occurred during the partitioning process as integer |
...
Dimensions: 164 rows × 16 columns
...
| FAULT_TRACKING | 0xA014 | - | not defined in diagnosis database | - | - | - | - | - | - | - | - | - | 31 | ARG_0xA014_R | - |
| TEST_ANTENNE | 0xA018 | - | Startet und bewertet die Prüfung für eine oder mehrere Antennen. | - | - | - | - | - | - | - | - | - | 31 | ARG_0xA018_R | RES_0xA018_R |
| TEST_AUXVERBINDUNG | 0xA019 | - | Testet, ob die Aux-Anschlüsse verbaut sind. | - | - | - | - | - | - | - | - | - | 31 | ARG_0xA019_R | RES_0xA019_R |
...
| NAVI_TESTMAP | 0xA031 | - | Aktiviert oder deaktiviert die Testkarte(n). Dies erfolgt normalerweise durch Freigabe bzw. Sperrung des Speicherbereichs der Festplatte. | - | - | - | - | - | - | - | - | - | 31 | ARG_0xA031_R | RES_0xA031_R |
...
| SDARS_GENERATOR_FREQUENCY | 0xA03E | - | Einstellen eines Sinustons. | - | - | - | - | - | - | - | - | - | 31 | ARG_0xA03E_R | RES_0xA03E_R |
...
| WLAN_CLEAR_WHITELIST | 0xA0A7 | - | Löscht alle Einträge in der Whitelist | - | - | - | - | - | - | - | - | - | 31 | - | - |
...
| PROVISIONING_DATA | 0xA0AF | - | Provisioning Telematikdienste | - | - | - | - | - | - | - | - | - | 31 | - | RES_0xA0AF_R |
...
| STATUS_SDARS_ESN | 0xD005 | STAT_SDARS_ESN_TEXT | die 12stellige ESN, z.B. AB1234V12345 | TEXT | - | - | string[12] | - | 1.0 | 1.0 | 0.0 | - | 22 | - | - |
...
| STATUS_FB_TASTE | 0xD016 | - | Test der Functional Bookmarks. | - | - | - | - | - | - | - | - | - | 22 | - | RES_0xD016_D |
...
| STATUS_GYRO | 0xD03A | - | Liest die Spannung des Gyro | - | - | - | - | - | - | - | - | - | 22 | - | RES_0xD03A_D |
...
| STATUS_SDARS_SIGNAL_QUALITY | 0xD05D | - | Auslesen der Qualitaet der Signalwerte. | - | - | - | - | - | - | - | - | - | 22 | - | RES_0xD05D_D |
| SDARS_FIRMWARE_VERSIONS | 0xD05E | - | liest Firmware Werte aus dem SDARS modul | - | - | - | - | - | - | - | - | - | 22 | - | RES_0xD05E_D |
| SDARS_CHANNEL | 0xD05F | - | liest und setzt den SDARS Kanal | - | - | - | - | - | - | - | - | - | 22;2E | ARG_0xD05F_D | RES_0xD05F_D |
| SDARS_TUNER_MODE | 0xD060 | - | liest und setzt den Tuner Mode. | - | - | - | - | - | - | - | - | - | 22;2E | ARG_0xD060_D | RES_0xD060_D |
| SDARS_BER_MODE | 0xD061 | STAT_SDARS_BER_MODE | - | 0-n | - | - | unsigned char | TSdarsBerMode | 1.0 | 1.0 | 0.0 | - | 22 | - | - |
| STATUS_SDARS_BER | 0xD062 | STAT_SDARS_BER_WERT | Die aktuelle BER | - | - | high | motorola float | - | 1.0 | 1.0 | 0.0 | - | 22 | - | - |
| STATUS_INTERNAL_ACCELERATION_SENSOR | 0xD063 | - | Returns if the internal acceleration sensor is working on the basis of the voltage value. | - | - | - | - | - | - | - | - | - | 22 | - | RES_0xD063_D |
| STATUS_ROUTE_DOWNLOAD | 0xD065 | - | not defined in diagnosis database | - | - | - | - | - | - | - | - | - | 22 | - | RES_0xD065_D |
| STATUS_POI_DOWNLOAD | 0xD066 | - | not defined in diagnosis database | - | - | - | - | - | - | - | - | - | 22 | - | RES_0xD066_D |
...
| WLAN_SIGNALTEST | 0xD0A8 | - | gibt Resultat des Signal Qualitätstest zurück | - | - | - | - | - | - | - | - | - | 22 | - | RES_0xD0A8_D |
| WLAN_WHITELIST | 0xD0A9 | - | whitelist des WLAN Moduls | - | - | - | - | - | - | - | - | - | 22;2E | ARG_0xD0A9_D | RES_0xD0A9_D |
...
| PROVISIONING_PARAMETER | 0xD0CE | - | Provisionierungsparameter | - | - | - | - | - | - | - | - | - | 22 | - | RES_0xD0CE_D |
...
| STATUS_LAST_DESTINATIONS_FIRST_DATA_SET | 0xD0D6 | - | Reads out the last 16 destinations to fill the Last Call State message | - | - | - | - | - | - | - | - | - | 22 | - | RES_0xD0D6_D |
| STATUS_LAST_DESTINATIONS_SECOND_DATA_SET | 0xD0E0 | - | Reads out the information for the preferred charging station, intermodal connection points and ISO country code | - | - | - | - | - | - | - | - | - | 22 | - | RES_0xD0E0_D |
...
| PARTITION_HDD | 0xF015 | - | Returns the partitioning status of the Hard Disk Drive | - | - | - | - | - | - | - | - | - | 31 | ARG_0xF015_R | RES_0xF015_R |
...
<a id="table-tab-uartactivationstate"></a>
### TAB_UARTACTIVATIONSTATE
