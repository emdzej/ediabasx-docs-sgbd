...
| Field | Value |
| --- | --- |
| ECU | Test auf MASK Navi 6521 |
| ORIGIN | Hays EI-44 Hr.Bubb |
| REVISION | 0.004 |
| AUTHOR | Hays EI-44 Hr.Bubb |
| COMMENT | N/A |
| PACKAGE | 1.29 |
| SPRACHE | deutsch |
...
| Name | Type | Comment |
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei ERROR_TIMEOUT_ABBRUCH, ERROR_UNBEKANNTE_HARDWARE oder ERROR_WRITE_PMBUS_EEPROM, sonst |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
| GERAETE_NUMMER | string | Hex-Antwort von SG |
