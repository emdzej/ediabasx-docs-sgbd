...
| Field | Value |
| --- | --- |
| ECU | Top HIFI Verstärker |
| ORIGIN | BMW EI-41 JoannisToptsis |
| REVISION | 2.000 |
| AUTHOR | HarmanBecker EEA ChristianFenzl, HarmanBecker EEA ChristianKnot |
| COMMENT | - |
| PACKAGE | 1.49 |
| SPRACHE | deutsch |
...
| 0xD6C43F | Empfängerknoten: hat Nachricht nicht abgenommen; Puffer voll | 0 |
| 0xD6C440 | Überwachungsschaltung hat Reset ausgelöst | 0 |
| 0xD6C442 | Sender- Empfängerbaustein (FOT): Temperatur übersteigt kritische Schwelle | 0 |
| 0xD6C445 | AMPT: MOST Reset | 0 |
...
| UWNR | UWTEXT | UW_EINH | L/H | UWTYP | NAME | MUL | DIV | ADD |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 0x1707 | Diagnose Addresse | Hex | high | unsigned char | - | 1 | 1 | 0 |
| 0x1708 | Klemmenstatus | Hex | high | unsigned char | - | 1 | 1 | 0 |
| 0x1709 | MOST Message Header | text | - | 6 | - | - | - | - |
| 0x170A | Temperatur Sender - Emfpängerbaustein (FOT) | Hex | high | unsigned char | - | 1 | 1 | 0 |
| 0x170B | Node Position Register | Hex | high | unsigned char | - | 1 | 1 | 0 |
| 0x170C | Spannung Batterie | mVolt | high | unsigned int | - | 1 | 1 | 0 |
| 0x170D | MemMirror | Hex | high | unsigned char | - | 1 | 1 | 0 |
| 0x170E | MostMesErrorCodeInfo | Hex | high | unsigned int | - | 1 | 1 | 0 |
| 0x1721 | Reset Reason | Hex | high | unsigned char | - | 1 | 1 | 0 |
| 0x172D | MOSTMesOpType | Hex | high | unsigned int | - | 1 | 1 | 0 |
| 0x172E | HighSyncConnectionTable | Hex | high | unsigned int | - | 1 | 1 | 0 |
| 0x172F | NotificationTable | Hex | high | unsigned int | - | 1 | 1 | 0 |
...
| 0x1707 | Diagnose Addresse | Hex | high | unsigned char | - | 1 | 1 | 0 |
| 0x1708 | Klemmenstatus | Hex | high | unsigned char | - | 1 | 1 | 0 |
| 0x1709 | MOST-Messageheader | text | high | 6 | - | 1 | 1 | 0 |
| 0x170A | Temperatur Sender - Emfpängerbaustein (FOT) | Hex | high | unsigned char | - | 1 | 1 | 0 |
| 0x170B | Node Position Register | Hex | high | unsigned char | - | 1 | 1 | 0 |
| 0x170C | Spannung Batterie | mVolt | high | unsigned int | - | 1 | 1 | 0 |
| 0x170D | MemMirror | Hex | high | unsigned char | - | 1 | 1 | 0 |
| 0x171E | MostMesErrorCodeInfo | Hex | high | unsigned int | - | 1 | 1 | 0 |
| 0x1721 | Reset Reason | Hex | high | unsigned char | - | 1 | 1 | 0 |
| 0x172D | MOSTMesOpType | Hex | high | unsigned int | - | 1 | 1 | 0 |
| 0x172E | HighSyncConnectionTable | Hex | high | unsigned int | - | 1 | 1 | 0 |
| 0x172F | NotificationTable | Hex | high | unsigned int | - | 1 | 1 | 0 |
