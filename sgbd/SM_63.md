...
- [GATEWAY_KOSTAL_E63](#job-gateway-kostal-e63) - Diagnosegateway CAN-&gt;K-Bus KWP2000: $A5 unpackDS2ServiceRequest Id  Modus  : all Diagnoseanfrage wird auf K-Bus durchgereicht (Gateway)
- [ID_LESEN_FA_KOSTAL_E63](#job-id-lesen-fa-kostal-e63) - Fahrersitz (E46) identifizieren KWP2000: $A5 unpackDS2ServiceRequest Id   Modus  : all
- [ID_LESEN_BF_KOSTAL_E63](#job-id-lesen-bf-kostal-e63) - Beifahrersitz (E46) identifizieren KWP2000: $A5 unpackDS2ServiceRequest Id   Modus  : all
...
<a id="job-gateway-kostal-e63"></a>
### GATEWAY_KOSTAL_E63

Diagnosegateway CAN-&gt;K-Bus KWP2000: $A5 unpackDS2ServiceRequest Id  Modus  : all Diagnoseanfrage wird auf K-Bus durchgereicht (Gateway)

#### Arguments

| Name | Type | Comment |
| --- | --- | --- |
| ECU_ADRESS | char | $72: Fahrer $DA: Beifahrer  Zieladresse auf K-Bus |
| LENGTH | char | Anzahl Datenbytes auf K-Bus |
| CONTROL_BYTE | char | Job-ID auf K-Bus |
...
<a id="job-id-lesen-fa-kostal-e63"></a>
### ID_LESEN_FA_KOSTAL_E63
...
<a id="job-id-lesen-bf-kostal-e63"></a>
### ID_LESEN_BF_KOSTAL_E63
