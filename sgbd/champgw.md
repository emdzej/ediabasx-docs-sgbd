...
| Field | Value |
| --- | --- |
| ECU | CHAMPGW im Geraet Champ Visteon  |
| ORIGIN | BMW EI-44 Hr.Striebel |
| REVISION | 3.005 |
...
- [READ_DEVIDS_CURRENT_REGISTRY](#job-read-devids-current-registry) - Auslesen der DEVIDS der Current Registry KWP2000: $21 ReadDataByLocalIdentifier $AC recordLocalIdentifier Modus   : Default
...
- [READ_FBLOCKS_CURRENT_REGISTRY](#job-read-fblocks-current-registry) - Auslesen der FBlockIDs einer DEVID der Current Registry KWP2000: $21 ReadDataByLocalIdentifier $C2 recordLocalIdentifier Modus   : Default
...
- [STATUS_MCGW](#job-status-mcgw) - Status des MCGW enabled oder disabled KWP2000: $21 ReadDataByLocalIdentifier $0F LocalIdentifier (statusMCGW) Modus  : Default
...
Auslesen der DEVIDS der Current Registry KWP2000: $21 ReadDataByLocalIdentifier $AC recordLocalIdentifier Modus   : Default
...
Auslesen der FBlockIDs einer DEVID der Current Registry KWP2000: $21 ReadDataByLocalIdentifier $C2 recordLocalIdentifier Modus   : Default
...
| STAT_MODE_TEXT | string | table TEnergiesparMode NAME |
| STAT_MODE | int | 0 for OFF or values of table TEnergiesparMode MASKE |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
<a id="job-status-mcgw"></a>
### STATUS_MCGW

Status des MCGW enabled oder disabled KWP2000: $21 ReadDataByLocalIdentifier $0F LocalIdentifier (statusMCGW) Modus  : Default
...
| Name | Type | Comment |
| --- | --- | --- |
| STAT_MCGW | unsigned char | 0x00 Gateway is enabled (function disablemcgw is inactive)  0x01 Gateway is disabled (function disablemcgw is active) |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
- [TENERGIESPARMODE](#table-tenergiesparmode) (4 × 2)
...
| ORT | ORTTEXT |
| --- | --- |
| 0xA168 | A168 VIP_Micro_ Fault |
| 0xA169 | A169 VIP_ROM_Fault |
| 0xA16A | A16A VIP_EEPROM_Fault |
| 0xA16B | A16B VIP_GW_CRC_Fault |
| 0xA16C | A16C IPC_Com_Fault |
| 0xA16E | A16E Tuner_Com_Fault |
| 0xA16F | A16F VIP_Fan_Fault |
| 0xA170 | A170 Energiesparmode aktiv |
| 0xE184 | E184 K-CAN Leitungsfehler |
| 0xE187 | E187 CAN Controller |
| 0xE18C | E18C Device hat die Monitoringnachricht nicht abgenommen oder bestaetigt. (Error_Monitoring). |
| 0xE18D | E18D Weckendes Device hat 3 mal erfolglos versucht das Netzwerk zu wecken. (Error_WakeUp_Failed). |
| 0xE18E | E18E Obwohl Shutdown(Execute) geschickt wurde ging das Licht nicht aus. (Error_Light_Not_Off). |
| 0xE18F | E18F Zentrale Registry stimmt nicht mit der Sollkonfiguration ueberein (Error_Registry_New). |
| 0xE190 | E190 Ringbruchdiagnose wurde durchgefuehrt (Error_Ring_Diagnose). |
| 0xE192 | E192 Ein Device hat sich wegen Uebertemperatur abgeschaltet (Error_Temp_Shutdown). |
...
| 0x03 | Lüfter Hz IST | Hex | -- | unsigned char | - | - | - | - |
| 0x04 | Lüfter Hz SOLL | Hex | - | unsigned char | - | - | - | - |
| 0x05 | Fehlerursache | Hex | high | unsigned int | - | - | - | - |
| 0x21 | Diagnoseadresse | Hex | - | unsigned char | - | 1 | 1 | 0 |
| 0x22 | NPR | Hex | - | unsigned char | - | 1 | 1 | 0 |
| 0xFF | unbekannte Umweltbedingung | 1 | - | unsigned int | - | - | - | - |
...
| ORT | ORTTEXT |
| --- | --- |
| 0xA180 | A180 VIP_RAM_Fault |
| 0xA181 | A181 VIP_Micro_Initialization_Fault |
| 0xA182 | A182 FOT_Temperature_Fault |
| 0xA183 | A183 VIP_Checksum_Error |
| 0xA184 | A184 Reference_Buffer_Fault |
| 0xA185 | A185 Com_Server_Queue_Overflow |
| 0xA186 | A186 IPC_Dispatcher_Fault |
| 0xA187 | A187 MOST_Dispatcher_Fault |
| 0xA188 | A188 Internal_Dispatcher_Fault |
| 0xA189 | A189 Local_Registry_Fault |
| 0xA18A | A18A Netservices_Fault |
| 0xA18B | A18B Nachlauf-Stromversorgung Zeitüberschreitung |
| 0xA18C | A18C External_Registry_Fault |
| 0xA18E | A18E Invalid Length of MOST message |
| 0xA18F | A18F VIP_ROM_Fault |
| 0xA190 | A190 VIP_EEPROM_Fault |
| 0xA191 | A191 VIP_GW_CRC_Fault |
| 0xA192 | A192 IPC_Com_Fault |
| 0xA193 | A193 VIP_Fan_Fault |
| 0xA194 | A194 Clamp_Status_Fault |
| 0xA195 | A195 Com_Server_Startup_Fault |
| 0xA197 | A197 HOST Reset |
| 0x9308 | 9308 Device bekam Reset (Error_Reset). |
| 0x9309 | 9309 Bis zum Auftreten des Timeouts konnte kein Licht bzw. kein stabiler Lock erkannt werden (Error_NSInit_Timeout). |
| 0x930A | 930A Device ist im Zustand Normal Operation und das Licht am Eingang geht ohne Vorankuendigung aus (Error_Sudden_light_off). |
| 0x930B | 930B Anfragendes Device bekommt keine Antwort obwohl Partner vorhanden ist (Error_Device_No_Answer). |
| 0x930C | 930C Kurze Unlocks (Error_Unlock_Short). |
| 0x930D | 930D Kein Broadcast Configuration(Status) vom Networkmaster erhalten (Error_t_CfgStatus). |
| 0x930F | 930F Ein Device hat im laufenden Betrieb seinen Bypass All geschlossen (Error_NCE). |
| 0x9310 | 9310 Empfaenger hat eine Nachricht nicht abgenommen (Error_NAK). |
| 0x9311 | 9311 Lange und/oder haeufige Unlocks (Error_Unlock_Long) |
| 0xFFFF | unbekannter Fehlerort |
...
| 0xA18E | 0x21 | 0x22 | 0x23 | 0x24 |
| 0xA18F | 0x01 | 0x02 | - | - |
| 0xA190 | 0x01 | 0x02 | - | - |
| 0xA191 | 0x01 | 0x02 | - | - |
| 0xA193 | 0x01 | 0x02 | 0x04 | 0x05 |
| 0xA197 | 0x29 | 0x29 | 0x30 | - |
| 0x9308 | 0x03 | 0x28 | 0x29 | 0x30 |
...
| 0x04 | Lüfter Hz IST | Hex | -- | unsigned char | - | - | - | - |
| 0x05 | Lüfter Hz SOLL | Hex | - | unsigned char | - | - | - | - |
| 0x06 | Queue ID | Hex | - | unsigned char | - | - | - | - |
| 0x21 | Logische-Kotenadresse | Hex | high | unsigned int | - | 1 | 1 | 0 |
| 0x22 | FBlockID | Hex | high | unsigned char | - | 1 | 1 | 0 |
| 0x23 | InstID | Hex | high | unsigned char | - | 1 | 1 | 0 |
| 0x24 | FktID | Hex | high | unsigned int | - | 1 | 1 | 0 |
| 0x25 | Diagnoseadresse | Hex | high | unsigned char | - | 1 | 1 | 0 |
| 0x26 | Weckgrund | Hex | high | unsigned char | - | 1 | 1 | 0 |
| 0x27 | Einschlaf Fehlerursache | Hex | high | unsigned char | - | 1 | 1 | 0 |
| 0x28 | Task-Signatur | Hex | high | unsigned char | - | 1 | 1 | 0 |
| 0x29 | 4 Bytes ResetInfo as long | Hex | - | signed long | - | 1 | 1 | 0 |
| 0x30 | 1 Byte ResetInfo as char | Hex | - | unsigned char | - | 1 | 1 | 0 |
