...
- [STATUS_ANALOG](#job-status-analog) - Auslesen der Stati von analoge Signale KWP2000: $30 InputOutputControlByLocalIdentifier $01 ReportCurrentState Modus  : Default  table AnalogSignaleLesen NAME =&gt; Identifier aus Tab holen =&gt; DIV-Faktor aus Tab holen =&gt; ADD-Faktor aus Tab holen
- [STATUS_DIGITAL](#job-status-digital) - Auslesen der Stati von digitale Signale KWP2000: $30 InputOutputControlByLocalIdentifier $28 IOLoacalIdentifier $01 ReportCurrentState Modus  : Default
- [STEUERN_DIGITAL](#job-steuern-digital) - Ansteuern von I/O DigitalSignal mit DIGITALWERT KWP2000: $30 InputOutputControlByLocalIdentifier $07 ShortTermAdjustment Ohne DIGITALWERT-&gt;Return Control To ECU KWP2000: $30 InputOutputControlByLocalIdentifier $00 ReturnControlToECU Modus  : Default
- [STEUERN_GESAMT](#job-steuern-gesamt) - Ansteuern von I/O DigitalSignal mit DIGITALWERT KWP2000: $30 InputOutputControlByLocalIdentifier $07 ShortTermAdjustment Ohne DIGITALWERT-&gt;Return Control To ECU KWP2000: $30 InputOutputControlByLocalIdentifier $00 ReturnControlToECU Modus  : Default
- [STATUS_CAN_DISKRET](#job-status-can-diskret) - Auslesen der Stati von CAN Signale KWP2000: $30 InputOutputControlByLocalIdentifier $01 ReportCurrentState Modus  : Default  table CANDiskretSignale NAME =&gt; Identifier aus Tab holen =&gt; DIV-Faktor aus Tab holen =&gt; ADD-Faktor aus Tab holen
- [STEUERN_CAN_DISKRET](#job-steuern-can-diskret) - Ansteuern von CAN Signale mit CAN_WERT KWP2000: $30 InputOutputControlByLocalIdentifier $07 ShortTermAdjusttment Ohne CAN_WERT -&gt; ReturnControlToECU $00 ReturnControlToECU Modus  : Default
- [INT_STATUS_CAN_SIGNAL](#job-int-status-can-signal) - Auslesen der Stati von CAN Signale KWP2000: $30 InputOutputControlByLocalIdentifier Parameter: $01 ReportCurrentState Modus  : Default
- [INT_STEUERN_CAN_SIGNAL](#job-int-steuern-can-signal) - Ansteuern von CAN Signale mit CAN_WERT KWP2000: $30 InputOutputControlByLocalIdentifier Parameter: $07 ShortTermAdjusttment Ohne CAN_WERT -&gt; ReturnControlToECU Parameter: $00 ReturnControlToECU Modus  : Default
- [INT_STATUS_ANALOG_EINZELN](#job-int-status-analog-einzeln) - Auslesen der Stati von analogen Signalen KWP2000: $30 InputOutputControlByLocalIdentifier $01 ReportCurrentState Modus  : Default
- [INT_STATUS_DIGITAL_EINZELN](#job-int-status-digital-einzeln) - Auslesen der Stati von digitale Signale KWP2000: $30 InputOutputControlByLocalIdentifier $01 ReportCurrentState Modus  : Default
- [INT_STATUS_DIGITAL_LAMPEN](#job-int-status-digital-lampen) - Auslesen der Stati von digitale Signale KWP2000: $30 InputOutputControlByLocalIdentifier $20 IOLocalIdentifier $01 ReportCurrentState Modus  : Default
- [INT_STEUERN_DIGITAL_EINZELN](#job-int-steuern-digital-einzeln) - Ansteuern von I/O DigitalSignal mit DIGITALWERT KWP2000: $30 InputOutputControlByLocalIdentifier $07 ShortTermAdjustment Ohne DIGITALWERT-&gt;Return Control To ECU KWP2000: $30 InputOutputControlByLocalIdentifier $00 ReturnControlToECU Modus  : Default
- [INT_STEUERN_PROGRAMMCODE](#job-int-steuern-programmcode) - Schreibt 32 Byte "Programm-Code" KWP2000: $2E WriteDataByCommonIdentifier CommonIdentifier=3001...3008 Modus  : Default
- [ECU_RESET](#job-ecu-reset) - Reset der ECU KWP2000: $11 EcuReset Modus  : Default
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_BREMSLICHT_SENSE_WERT | real | Eingang Bremslichter |
| STAT_RUECKFAHRLICHT_SENSE_WERT | real | Eingang Rueckfahrlicht |
| STAT_NEBELSCHLUSSLEUCHTE_SENSE_WERT | real | Eingang Nebelschlussleuchte |
| STAT_SCHLUSSLEUCHTE_L_SENSE_WERT | real | Eingang Schlussleuchte links |
| STAT_VBAT_WERT | real | Eingang Batteriespannung |
| STAT_BLINKER_RECHTS_SENSE_WERT | real | Eingang Blinker rechts |
| STAT_SCHLUSSLEUCHTE_R_SENSE_WERT | real | Eingang Schlussleuchte rechts |
| STAT_BLINKER_LINKS_SENSE_WERT | real | Eingang Blinker links |
| STAT_SPANNUNG_EINH | string | Einheit |
| STAT_STROM_EINH | string | Einheit |
| STAT_DIGITS_EINH | string | Einheit |
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_BL_IN | int | Eingang Bremse (direkt) Bereich: 0/1 |
| STAT_NERR0_IN | int | Eingang CAN-Error (vom CAN-Chip) Bereich: 0/1 |
| STAT_RXCAN_IN | int | Eingang CAN-Receive (CAN-Bus Empfangsleitung) Bereich: 0/1 |
| STAT_BL_OUT | int | Ausgang Bremslicht Bereich: 0/1 |
| STAT_KL30_MONITOR_OUT | int | Aktivierung der Kl. 30 Überwachung Bereich: 0/1 |
| STAT_RFL_OUT | int | Ausgang Rueckfahrlicht Bereich: 0/1 |
| STAT_NSL_OUT | int | Ausgang Nebelschlussleuchte Bereich: 0/1 |
| STAT_SL_LI_OUT | int | Ausgang Schlusslicht links Bereich: 0/1 |
| STAT_BLK_RE_OUT | int | Ausgang Fahrtrichtungsanzeige rechts Bereich: 1/0 (invertiert) |
| STAT_SL_RE_OUT | int | Ausgang Schlusslicht rechts Bereich: 0/1 |
| STAT_BLK_LI_OUT | int | Ausgang Fahrtrichtungsanzeige links Bereich: 1/0 (invertiert) |
| STAT_FLASH_VP_OUT | int | Ausgang Programmierspannung f. Flash Bereich: 0/1 |
| STAT_HOLD_OUT | int | Ausgang Power-Hold Spannungsregler Bereich: 0/1 |
| STAT_PP5_OUT | int | Ausgang Port PP5 (unbenutzt) Bereich: 0/1 |
| STAT_STB0_OUT | int | Ausgang Strobe des CAN-Bus Transceivers Bereich: 0/1 |
| STAT_EN0_OUT | int | Ausgang Enable des CAN-Bus Transceivers Bereich: 0/1 |
| STAT_CANTX_OUT | int | Ausgang Sendeleitung CAN-Bus Bereich: 0/1 |
| STAT_HOOK_IN | int | Eingang Hook Status Line Bereich: 0/1 |
| STAT_HOOK_HB_IN | int | Hook Line Heart Beat vorhanden Bereich: 0/1 |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_KL__R_CAN | string | Status CAN-Signal Klemme R |
| STAT_KL_15_CAN | string | Status CAN-Signal Klemme 15 |
| STAT_CT_BRPD_CAN | string | Status CAN-Signal Kontakt Bremspedal |
| STAT_IDC_STOP_CAN | string | Status CAN-Signal Blinken Stop |
| STAT_BLK_CAN | string | Status CAN-Signal Blinken |
| STAT_CLK_BLK_CAN | string | CAN-Signal Takt Blinken |
| STAT_RFL_CAN | string | CAN-Signal Status Rueckfahrscheinwerfer |
| STAT_KZL_CAN | string | CAN-Signal Status Kennzeichenleuchten |
| STAT_NSL_CAN | string | CAN-Signal Status Nebelschlussleuchten |
| STAT_SL_CAN | string | CAN-Signal Status Standlicht |
| STAT_PL_R_CAN | string | CAN-Signal Status Standlicht rechts |
| STAT_PL_L_CAN | string | CAN-Signal Status Standlicht links |
| STAT_STANDVERBR_CAN | string | CAN-Signal Status Standverbraucher |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
<a id="job-int-status-can-signal"></a>
...
<a id="job-int-steuern-can-signal"></a>
...
<a id="job-int-status-analog-einzeln"></a>
...
<a id="job-int-status-digital-einzeln"></a>
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_VALUE | int | Bereich: 0/1 |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |

<a id="job-int-status-digital-lampen"></a>
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_BREMSLICHT_IN | int | Bereich: 0/1 |
| STAT_BREMSLICHT_OUT | int | Bereich: 0/1 |
| STAT_PA1_OUT | int | Bereich: 0/1 |
| STAT_RUECKFAHRLICHT_OUT | int | Bereich: 0/1 |
| STAT_NEBELSCHLUSSLEUCHTE_OUT | int | Bereich: 0/1 |
| STAT_SCHLUSSLEUCHTE_LINKS_OUT | int | Bereich: 0 /1 |
| STAT_BLINKER_RECHTS_OUT | int | Bereich: 0/1 |
| STAT_SCHLUSSLEUCHTE_RECHTS_OUT | int | Bereich: 0/1 |
| STAT_BLINKER_LINKS_OUT | int | Bereich: 0/1 |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |

<a id="job-int-steuern-digital-einzeln"></a>
...
<a id="job-int-steuern-programmcode"></a>
...
- [DIGITALSIGNALELESEN](#table-digitalsignalelesen) (19 × 3)
- [DIGITALSIGNALESCHREIBEN](#table-digitalsignaleschreiben) (11 × 3)
- [ANALOGSIGNALELESEN](#table-analogsignalelesen) (8 × 6)
- [CANSIGNALEINT](#table-cansignaleint) (2 × 10)
- [CANDISKRETSIGNALE](#table-candiskretsignale) (13 × 3)
- [CANSUB](#table-cansub) (20 × 3)
- [ANALOGS](#table-analogs) (8 × 6)
...
<a id="table-digitalsignalelesen"></a>
### DIGITALSIGNALELESEN
...
<a id="table-digitalsignaleschreiben"></a>
...
<a id="table-analogsignalelesen"></a>
### ANALOGSIGNALELESEN
