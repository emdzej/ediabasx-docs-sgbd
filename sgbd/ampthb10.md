...
| Field | Value |
| --- | --- |
| ECU | Top Amp mit ASD-Verwendung |
| ORIGIN | BMW EI-41 JoannisToptsis |
| REVISION | 2.000 |
| AUTHOR | HarmanBecker CoC_AMP ChristianKnott, HarmanBecker CoC_AMP Chris |
| COMMENT | - |
| PACKAGE | 1.49 |
| SPRACHE | deutsch |
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| SW_VERSION_CU | string | Controller Urloader Version xx.yy.zz xx = Major yy = Minor zz = Bugfix |
| SW_VERSION_CF | string | Controller Flasher Version xx.yy.zz xx = Major yy = Minor zz = Bugfix |
| SW_VERSION_CA | string | Controller Audio Application xx.yy.zz xx = Major yy = Minor zz = Bugfix |
| SW_VERSION_CB | string | Controller H/B BIOS Version xx.yy.zz xx = Major yy = Minor zz = Bugfix |
| SW_VERSION_DU | string | DSP Urloader Version xx.yy.zz xx = Major yy = Minor zz = Bugfix |
| SW_VERSION_DF | string | DSP Flasher Version xx.yy.zz xx = Major yy = Minor zz = Bugfix |
| SW_VERSION_DA | string | DSP Audio Application Version xx.yy.zz xx = Major yy = Minor zz = Bugfix |
| SW_VERSION_DB | string | DSP H/B BIOS Version xx.yy.zz xx = Major yy = Minor zz = Bugfix |
| SW_VERSION_DS | string | DSP DataSet Version xx.yy.zz xx = Major yy = Minor zz = Bugfix |
| SW_VERSION_MST | string | INIC firmware Version xx.yy.zz xx = Major yy = Minor zz = Bugfix |
| SW_VERSION_NS | string | MOST NetServices Version xx.yy.zz xx = Major yy = Minor zz = Bugfix |
| SW_VERSION_HW | string | INIC Hardware Version xx xx = Major |
| SW_VERSION_CS | string | INIC ConfigString Version xx.yy.zz xx = Major yy = Minor zz = Bugfix |
| SW_VERSION_P | string | Lattice Power Controller Version xx.yy.zz xx = Major yy = Minor zz = Bugfix |
...
| _REQUEST_CB | binary | Hex-Auftrag an SG |
| _RESPONSE_CB | binary | Hex-Antwort von SG |
| _REQUEST_DU | binary | Hex-Auftrag an SG |
| _RESPONSE_DU | binary | Hex-Antwort von SG |
| _REQUEST_DF | binary | Hex-Auftrag an SG |
| _RESPONSE_DF | binary | Hex-Antwort von SG |
| _REQUEST_DA | binary | Hex-Auftrag an SG |
| _RESPONSE_DA | binary | Hex-Antwort von SG |
| _REQUEST_DB | binary | Hex-Auftrag an SG |
| _RESPONSE_DB | binary | Hex-Antwort von SG |
| _REQUEST_DS | binary | Hex-Auftrag an SG |
| _RESPONSE_DS | binary | Hex-Antwort von SG |
| _REQUEST_MST | binary | Hex-Auftrag an SG |
| _RESPONSE_MST | binary | Hex-Antwort von SG |
| _REQUEST_P | binary | Hex-Auftrag an SG |
| _RESPONSE_P | binary | Hex-Antwort von SG |
...
- [ARG_0XD05B_D](#table-arg-0xd05b-d) (2 × 12)
...
- [RES_0XD05B_D](#table-res-0xd05b-d) (2 × 10)
- [RES_0XD09C_D](#table-res-0xd09c-d) (2 × 10)
...
- [TAB_SENSOR_TEMP_DOP](#table-tab-sensor-temp-dop) (2 × 2)
- [TAB_WAKE_UP_STATUS_DOP](#table-tab-wake-up-status-dop) (3 × 2)
...
| ARG_KANAL | - | - | unsigned long | - | - | 1.0 | 1.0 | 0.0 | - | - | Kanalnummer Tabelle TAudioKanal |
...
| ARG | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | MIN | MAX | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ARG_AUDIOQUELLE | 0-n | high | unsigned char | - | TAB_ASD_AUDIOQUELLEN | 1.0 | 1.0 | 0.0 | - | - | Signalwahl für MUTE: 0 = alle Signale 1 = ASD-Signal 2 = Entertainment-Signale Achtung: Bei TOPHIFI muss das Entertainment-Signal seperat  im TOPHIFI-Verstärker stummgeschaltet werden |
| ARG_DEMUTE | 0-n | high | unsigned char | - | TDemuteStatus | 1.0 | 1.0 | 0.0 | - | - | 0 = Stummschaltung aus 1 = Stummschalten ein |
...
| 0xD6C443 | MOST-Steuergerät: Abschaltung Übertemperatur | 1 |
...
| 0x930005 | Diagnose-Master-Client: Telegramm Systemzeit nicht firstgerecht erhalten | 1 |
...
| 0xB7F495 | Entwickler-EQ: ungültige Checksumm | 0 |
| 0xFFFFFF | unbekannter Fehlerort | 0 |
...
| RESULTNAME | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_LEVEL_WERT | - | - | char | - | - | 1.0 | 1.0 | 0.0 | -96..0 dB |
| STAT_KANAL | 0-n | - | unsigned long | - | TAudioKanal | 1.0 | 1.0 | 0.0 | Kanalnummer |
...
| RESULTNAME | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_DEMUTE_ASD | 0-n | high | unsigned char | - | TDemuteStatus | 1.0 | 1.0 | 0.0 | Status vom ASD-Signal: 0 = Stummschaltung aus 1 = Stummschaltung ein |
| STAT_DEMUTE_ENTERTAINMENT | 0-n | high | unsigned char | - | TDemuteStatus | 1.0 | 1.0 | 0.0 | Status vom Entertainment-Signal: 0 = Stummschaltung aus 1 = Stummschaltung ein |
...
| LAUTSPRECHER_AUSGANG | 0xD05B | - | Verstellt und liest gleichzeitig Kanal und Lautstärke | - | - | - | - | - | - | - | - | - | 22;2E | ARG_0xD05B_D | RES_0xD05B_D |
| ASD_AUDIOQUELLE | 0xD09C | - | Audioquelle für MUTE | - | - | - | - | - | - | - | - | - | 22;2E | ARG_0xD09C_D | RES_0xD09C_D |
...
<a id="table-tab-sensor-temp-dop"></a>
### TAB_SENSOR_TEMP_DOP
...
<a id="table-tab-wake-up-status-dop"></a>
### TAB_WAKE_UP_STATUS_DOP
...
| 1 | Steuergeraet hat geweckt |
| 2 | Steuergeraet wurde geweckt |
