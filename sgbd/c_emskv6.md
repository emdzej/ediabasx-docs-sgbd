...
| Field | Value |
| --- | --- |
| ECU | C_SGBD R40 Kv6 EMS |
| ORIGIN | D.Gamble EE-62 |
| REVISION | 1.04 |
| AUTHOR | Rover EE-62 Dave Gamble, Rover SSL A.Hoddinott |
| COMMENT | Supports 6 coil ECU, KW2000 / KW2000* |
| PACKAGE | N/A |
| SPRACHE | English |
...
- [IDENT](#job-ident) - Ident-Daten fuer KV6
- [SECURITY_ACCESS](#job-security-access) - Wake-up and security-access
- [DIAGNOSE_ENDE](#job-diagnose-ende) - Diagnose beenden
- [ECU_RESET](#job-ecu-reset) - ECU will reset AFTER +ve response Needed to exit boot code after SECURITY_ACCESS(0x85)
...
| Name | Type | Comment |
| --- | --- | --- |
| SESSION | int | Optional Diagnostics session (e.g. 0x85 for programming session) |
