...
- [TEST_TONE_START](#job-test-tone-start) - Sending of a test tone, to be stopped by TEST_TONE_STOP (Setzen des Codierbits) KWP 2000: $1A Ident KWP 2000: $23 ReadMemoryByAddress KWP 2000: $31 StartRoutineByLocalIdentifier KWP 2000: $23 ReadMemoryByAddress Modus   : Default
- [TEST_TONE_STOP](#job-test-tone-stop) - Sending of a test tone, to be stopped by TEST_TONE_STOP
- [SDARS_TEMPERATUR_LESEN](#job-sdars-temperatur-lesen) - Sending of a test tone, to be stopped by TEST_TONE_STOP
- [STATUS_ANT_PRUEFUNG](#job-status-ant-pruefung) - Anntenna open, short circuit or okay
...
<a id="job-test-tone-start"></a>
### TEST_TONE_START

Sending of a test tone, to be stopped by TEST_TONE_STOP (Setzen des Codierbits) KWP 2000: $1A Ident KWP 2000: $23 ReadMemoryByAddress KWP 2000: $31 StartRoutineByLocalIdentifier KWP 2000: $23 ReadMemoryByAddress Modus   : Default
...
<a id="job-test-tone-stop"></a>
### TEST_TONE_STOP

Sending of a test tone, to be stopped by TEST_TONE_STOP
...
<a id="job-sdars-temperatur-lesen"></a>
### SDARS_TEMPERATUR_LESEN
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_TEMPERATUR_WERT | int | Wert in HEX |
| STAT_TEMPERATUR_EINHEIT | string | HEX |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |

<a id="job-status-ant-pruefung"></a>
### STATUS_ANT_PRUEFUNG

Anntenna open, short circuit or okay
...
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
| STAT_ANTENNE_1 | int | 0-connected |
| STAT_ANTENNE_1_TEXT | string | text result corresponding to STAT_ANTENNE_1 |
| STAT_ANTENNE_2 | int | 0-connected |
| STAT_ANTENNE_2_TEXT | string | text result corresponding to STAT_ANTENNE_1 |
...
- [TSTATUSTERRESTICANTENNA](#table-tstatusterresticantenna) (3 × 2)
- [TSTATUSSATELLITEANTENNA](#table-tstatussatelliteantenna) (4 × 2)
...
| ORT | ORTTEXT |
| --- | --- |
| 0xA530 | Error_Power_Supply_Fault. |
| 0xA531 | Error_Micro_Fault. |
| 0xA532 | Error_IC_Fault. |
| 0xA536 | Error_SatAntenna_Open_Circuit. |
| 0xA537 | Error_SatAntenna_Short_Circuit. |
| 0xA538 | Error_TerAntenna_OpenOrShort_Circuit. |
| 0xDE0E | Obwohl Shutdown(Execute) geschickt wurde ging das Licht nicht aus. (Error_Light_Not_Off). |
| 0xDE10 | Ringbruchdiagnose wurde durchgefuehrt (Error_Ring_Diagnose). |
| 0xDE11 | Lange und/oder haeufige Unlocks (Error_Unlock_Long). |
| 0xDE12 | Ein Device hat sich wegen Uebertemperatur abgeschaltet (Error_Temp_Shutdown). |
...
| 0x9309 | Applikation hat sich wegen Übertemperatur abgeschaltet. 80C &lt; temp &lt; 85C (Error_Temp_Application_Off). |
...
<a id="table-tstatusterresticantenna"></a>
### TSTATUSTERRESTICANTENNA
...
| --- | --- |
| 0x00 | Angeschlossen |
| 0x01 | Nicht angeschlossen oder Kurzschluss |
| Fehler | nicht definiert |

<a id="table-tstatussatelliteantenna"></a>
### TSTATUSSATELLITEANTENNA
