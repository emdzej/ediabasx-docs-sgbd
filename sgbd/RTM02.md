...
| Field | Value |
| --- | --- |
| ECU | Realtime Monitor |
| ORIGIN | BMW EC-131 Björn_Stark |
| REVISION | 1.001 |
| AUTHOR | ESG AB-H2 B.Scholtyssek |
| COMMENT | N/A |
| PACKAGE | 1.62 |
| SPRACHE | deutsch |
...
- [BF_DIAGNOS](#table-bf-diagnos) (6 × 10)
- [BF_INTERNAL_ERR](#table-bf-internal-err) (5 × 10)
...
- [RES_0XFD01_D](#table-res-0xfd01-d) (3 × 10)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_RTM | 0/1 | - | unsigned char | 0x01 | - | - | - | - | 0- RTM ready, 1- RTM not ready |
| STAT_CAN | 0/1 | - | unsigned char | 0x02 | - | - | - | - | 0- all CAN connected, 1- one CAN disconnected |
| STAT_LED | 0/1 | - | unsigned char | 0x04 | - | - | - | - | 0- LED connected, 1- LED disconnected |
| STAT_HIGH_VOLTAGE | 0/1 | - | unsigned char | 0x08 | - | - | - | - | 0- High voltage on, 1- High voltage off |
...
| RESULTNAME | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STAT_LISTEN_ONLY | 0/1 | - | unsigned char | 0x01 | - | - | - | - | 0- fuse not blown, 1- fuse blown |
| STAT_SIMCARD | 0/1 | - | unsigned char | 0x02 | - | - | - | - | 0- Simcard no error, 1- error |
| STAT_MODE | 0/1 | - | unsigned char | 0x04 | - | - | - | - | 0- normal mode, 1- production mode |
...
| RESULTNAME | EINHEIT | L/H | DATENTYP | MASKE | NAME | MUL | DIV | ADD | INFO |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| - | BIT | - | BITFIELD | - | BF_DIAGNOS | - | - | - | - |
| - | BIT | - | BITFIELD | - | BF_INTERNAL_ERR | - | - | - | - |
| DUMMY_RESULT | DATA | - | data[1] | - | - | - | - | - | not used |
...
| RTM_HW_VERSION_READ | 0xFD02 | STAT_HW_VERSION_DATA | HW-Version | DATA | - | - | data[3] | - | - | - | - | - | 22 | - | - |
| RTM_SW_VERSION_READ | 0xFD03 | STAT_SW_VERSION_DATA | SW-Version | DATA | - | - | data[3] | - | - | - | - | - | 22 | - | - |
...
| WERT | TEXT |
| --- | --- |
| 0x00 | set normal mode |
| 0x01 | set production mode |
| 0x04 | set listen only mode |
| 0x09 | reserved |
