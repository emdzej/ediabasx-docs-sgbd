...
| Field | Value |
| --- | --- |
| ECU | Satellit Fahrzeug Zentrum E60 |
| ORIGIN | BMW TI-430 R.Gall |
| REVISION | 2.03 |
| AUTHOR | BMW EE-53 Manuel Kahmann, Michael Burget (Fa. Berata), BMW TI-430 R.Gall |
| COMMENT | Serienstand |
| PACKAGE | 1.32 |
| SPRACHE | deutsch |
...
- [STATUS_ROLLOVER_SOFTWAREVERSION_LESEN](#job-status-rollover-softwareversion-lesen) - Status Rollover Softwareversion lesen KWP2000: $22 SG spezifische Daten lesen $00 Status Rollover Softwareversion lesen $1B Modus  : Default
- [STATUS_ROLLOVER_EDR_SPEICHER_LESEN](#job-status-rollover-edr-speicher-lesen) - Status Rollover EDR-Speicher lesen KWP2000: $22 SG spezifische Daten lesen $00 Status Rollover EDR-Speicher lesen $1C Modus  : Default
- [STEUERN_ROLLOVER_ARMING_TEST](#job-steuern-rollover-arming-test) - Steuern Rollover Arming-Test KWP2000: $31 SG spezifische Routine starten $47 Steuern Rollover Arming-Test Modus  : Default
...
<a id="job-status-rollover-softwareversion-lesen"></a>
### STATUS_ROLLOVER_SOFTWAREVERSION_LESEN

Status Rollover Softwareversion lesen KWP2000: $22 SG spezifische Daten lesen $00 Status Rollover Softwareversion lesen $1B Modus  : Default
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_DATEN_VERFUEGBARKEIT_WERT | unsigned int | 0x00: Alle Daten verfügbar 0x01: Softwareversion Hilfsprozessor nicht verfuegbar 0xff: Rollover software nicht aktiv codiert |
| STAT_DATEN_VERFUEGBARKEIT_TEXT | string | 0x00: Alle Daten verfügbar 0x01: Softwareversion Hilfsprozessor nicht verfuegbar 0xff: Rollover software nicht aktiv codiert |
| STAT_AUX_MICRO_SW_REV | unsigned int | Hilfsprozessor Softwareversion |
| STAT_MAIN_MICRO_SW_REV | unsigned int | Hauptprozessor Softwareversion |
| STAT_MAIN_MICRO_SW_INDEX | unsigned int | Hauptprozessor Softwareindex |
| STAT_MAIN_MICRO_SW_TAG | unsigned int | Hauptprozessor Software Produktionstag |
| STAT_MAIN_MICRO_SW_MONAT | unsigned int | Hauptprozessor Software Produktionsmonat |
| STAT_MAIN_MICRO_SW_JAHR | unsigned int | Hauptprozessor Software Produktionsjahr |
| STAT_DELPHI_INTERNAL | binary | Nur fuer Entwicklung Reserviert Delphi 11 Byte |
| STAT_VERSION_KALIBRIERDATEN | unsigned int | RO Kalibrierdatenversion |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |

<a id="job-status-rollover-edr-speicher-lesen"></a>
### STATUS_ROLLOVER_EDR_SPEICHER_LESEN

Status Rollover EDR-Speicher lesen KWP2000: $22 SG spezifische Daten lesen $00 Status Rollover EDR-Speicher lesen $1C Modus  : Default
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_DATENSATZ_0_WERT | unsigned int | 0x01: Datensatz leer 0x02: Aufzeichnung laeuft 0x03: Datensatz geschrieben 0x0F: Status unbekannt |
| STAT_DATENSATZ_0_TEXT | string | 0x01: Datensatz leer 0x02: Aufzeichnung laeuft 0x03: Datensatz geschrieben 0x0F: Status unbekannt |
| STAT_DATENSATZ_1_WERT | unsigned int | 0x01: Datensatz leer 0x02: Aufzeichnung laeuft 0x03: Datensatz geschrieben 0x0F: Status unbekannt |
| STAT_DATENSATZ_1_TEXT | string | 0x01: Datensatz leer 0x02: Aufzeichnung laeuft 0x03: Datensatz geschrieben 0x0F: Status unbekannt |
| STAT_DATENSATZ_2_WERT | unsigned int | 0x01: Datensatz leer 0x02: Aufzeichnung laeuft 0x03: Datensatz geschrieben 0x0F: Status unbekannt |
| STAT_DATENSATZ_2_TEXT | string | 0x01: Datensatz leer 0x02: Aufzeichnung laeuft 0x03: Datensatz geschrieben 0x0F: Status unbekannt |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |

<a id="job-steuern-rollover-arming-test"></a>
### STEUERN_ROLLOVER_ARMING_TEST

Steuern Rollover Arming-Test KWP2000: $31 SG spezifische Routine starten $47 Steuern Rollover Arming-Test Modus  : Default

#### Arguments

| Name | Type | Comment |
| --- | --- | --- |
| ARMING_TEST_START_STOP | unsigned int | 01: Rollover Arming-Test starten 02: Rollover Arming-Test stoppen, falls aktiv |
...
| STAT_SPG_U_ASE_WERT | real | Spannungsueberwachung U ASE |
| STAT_SPG_U_ASE_EINH | string | Spannungsueberwachung U ASE |
| STAT_KM_AKTUELL_WERT | unsigned int | aktueller Kilometerstand |
...
| STAT_EXCP_RO_ALGO_INIT_NOK | unsigned int | Ausnahme bei Initialisierung des Rollover-Algo 0: Initialisierung beendet 1: Initialisierung des Algo nicht beendet oder bei SFZ-5 nicht durchgeführt Byte 29, Bit 0 Nur fuer Entwicklung |
| STAT_EXCP_RO_SENSOR_TEST_NOK | unsigned int | Ausnahme bei Eigendiagnose der Rollover-Sensoren 0: Test beendet 1: Test nicht beendet oder nicht durchgeführt Byte 29, Bit 1 Nur fuer Entwicklung |
| STAT_EXCP_RO_ALGO_DO_NOT_USE | unsigned int | Ausnahme bei Ausführung der Rollover-Algorithmen: Rollover-s/w ist suspendiert 0: Rollover-s/w ist noch aktiv 1: "Not-use" Rollover-s/w ist zur Zeit nicht aktiv (mögliche Ursache: ein Fehler ist aufgetreten, der eine Abschaltung erzwingt oder es liegt Hardware des SFZ-5 vor oder es wurde der Rollover durch Codierung abgeschaltet Byte 29, Bit 2 Nur fuer Entwicklung |
| STAT_EXCP_RO_FORMALER_FEHLER | unsigned int | Ausnahme - Formaler Fehler an der Schnittstelle des Rollover 0: kein Fehler in den Returnwerten entdeckt 1: Fehlerhafter Returnwert, Kombination von Werten unplausibel Byte 29, Bit 3 Nur fuer Entwicklung |
| STAT_EXCP_RO_ALGO_NICHT_OPERATIV | unsigned int | Ausnahme - Rollover-Algorithmus nicht operativ 0: Rollover-Algo ist aktiv, die Auslöseinformation ist verfügbar 1: Rollover-Algo ist nicht aktiv, keine Deploy-Info verfügbar Byte 29, Bit 4 Nur fuer Entwicklung |
| STAT_EXCP_RO_HIGH_G_ARMING_TEST | unsigned int | Ausnahme High-G-Arming: Signal auf Arming-Pfad wurde im High-G-Y-Beschl.-Selbstest nicht gemessen 0: Test des Arming-Pfades erfolgreich durchgeführt 1: Test nicht durchgeführt oder es ist ein Fehler aufgetreten Byte 29, Bit 5 Nur fuer Entwicklung |
| STAT_EXCP_RO_DISABLED | unsigned int | Rollover-Modul wurde über Codierung ausgeschaltet 0: Rollover-Modul aktiv - Default für E64 1: Rollover-Modul nicht aktiv - Default für E60 Byte 29, Bit 6 |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| Name | Type | Comment |
| --- | --- | --- |
| STAT_ZK1_AKTIV | int | 0=ZK1_NICHT_AKTIV 1=ZK1_AKTIV Endbeschlagstrammer |
...
| 0x9ac1 | Codierung unvollstaendig |
...
| 0x9b09 | U-ASE-Ueberwachung unterer Grenzwert unterschritten |
| 0x9b10 | U-ASE-Ueberwachung oberer Grenzwert ueberschritten |
| 0x9b11 | Rollover-Modul Schnittstellen-Fehler unzulaessiger Fehlercode |
| 0x9b12 | Rollover-Modul fehlerhafte Kalibrierdaten |
| 0x9b13 | Rollover-Modul Hilfsprozessor nicht verfuegbar |
| 0x9b14 | Rollover-Modul Schnittstellen-Fehler unzulaessiger Aufruf |
| 0x9b15 | Rollover-Modul Schnittstellen-Fehler unzulaessige Reihenfolge der Aufrufe |
...
| 0x9b25 | Rollover-Modul Schnittstellen-Fehler unzulaessige Daten aus Rollover-Modul |
| 0x9b26 | Rollover-Modul Codierung fuer Aktivierung des Rollover fehlerhaft |
...
| 0x9b42 | Rollover-Modul Signal auf Arming-Leitung fehlerhaft |
...
| 0x9b28 | Rollover-Modul High-G Arming-Pfad Test nicht durchgefuehrt |
| 0x9b29 | FeTraWe aktiv |
| 0x9b2f | Rollover-Modul Ausloese-Entscheidung aber kein Arming |
| 0x9b30 | Rollover-Modul Schnittstellen-Fehler Messwerterfassung |
| 0x9b31 | U-ASE-Überwachung inaktiv codiert |
| 0x9b34 | Rollover-Modul EDR Aufzeichnung unvollstaendig |
...
| 0x9b41 | Rollover-Modul maximale Laufzeit ueberschritten |
| 0x???? | unbekannter Fehlerort |
