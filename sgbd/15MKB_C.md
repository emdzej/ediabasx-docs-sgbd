...
| ORIGIN | Softing GmbH |
| REVISION | 1.5 |
| AUTHOR | Softing GmbH, Roman Marziw |
| COMMENT | N/A |
| PACKAGE | N/A |
...
- [FLASH_TST_LOESCHEN](#job-flash-tst-loeschen) - Flash  - Zellen loeschen
...
| Name | Type | Comment |
| --- | --- | --- |
| ADRESSE | long | Programmierdaten: enthalten Adressinfo |
| ANZAHL | long | Programmierdaten: enthalten Adressinfo |
| LOESCH_DAUER | int | max. Dauer des Loeschvorgangs im SG in sec |
...
| ORT | ORTTEXT |
| --- | --- |
| 0x0105 | sensore pressione ambiente |
| 0x0110 | sensore temperatura aria aspirata |
| 0x0115 | sensore temperatura motore |
| 0x0120 | potenziometro corpo farfallato |
| 0x0121 | regolazione corpo farfallato veloce |
| 0x0130 | sonda lambda |
| 0x0135 | sonda lambda riscaldamento |
| 0x0201 | valvola injezione |
| 0x0230 | pompa benzina |
| 0x0335 | segnale albero motore |
| 0x0443 | valvola sviato serbatoio benzina |
| 0x0480 | ventola |
| 0x0500 | segnale velocita |
| 0x0505 | regolatore giri minimo |
| 0x0560 | segnale carico batteria |
| 0x0601 | emulazione E2 |
| 0x0603 | prova centralina (SGS) |
| 0x0608 | connessione voltaggio corpo farfallato |
| 0x0655 | spia temperatura motore |
| 0x1510 | ventola |
| 0x1600 | prova centralina (SGS) |
| 0x9997 | regolazione corpo farfallato veloce |
| 0x9999 | spia temperatura motore |
| 0x???? | errore sconosciuto |
