...
- [READ_DEVIDS_CURRENT_REGISTRY](#job-read-devids-current-registry) - Auslesen der DEVIDS der Current Registry KWP2000: $21 ReadDataByLocalIdentifier $C3 recordLocalIdentifier Modus   : Default
...
- [READ_FBLOCKS_CURRENT_REGISTRY](#job-read-fblocks-current-registry) - Auslesen der FBlockIDs einer DEVID der Current Registry KWP2000: $21 ReadDataByLocalIdentifier $C4 recordLocalIdentifier Modus   : Default
...
- [STATUS_FB_TASTE](#job-status-fb-taste) - Check if a bezel button is pressed or touched KWP2000: $21 ReadDataByLocalIdentifier $C2 recordLocalIdentifier Modus  : Default
...
- [STEUERN_FB_CALIBRATION](#job-steuern-fb-calibration) - This job stores the calibration data to the HeadUnit used for the bezel KWP2000: $3B WriteDataByLocalIdentifier $10 localIdentifier Modus  : Default
...
- [STEUERN_NOTFALL_EJECT](#job-steuern-notfall-eject) - Notfall Auswurf KWP2000: $31 StartRoutineByLocalIdentifier $31 RoutineIdentifier Modus  : Default
...
- [STATUS_CHECK_ADC](#job-status-check-adc) - Datenbyte 0x1E05 u. 6 prüfen KWP2000: $31 StartRoutineByLocalIdentifier $FA systemSupplierSpecific $39 localIdentifier Modus  : Default
- [STEUERN_LOGISTIK_7546_7552](#job-steuern-logistik-7546-7552) - HW* und ZB-Nummer vom 7546 und 7552 anpassen (falls nötig) KWP2000: $31 StartRoutineByLocalIdentifier $FA systemSupplierSpecific $37 localIdentifier Modus  : Default
...
Auslesen der DEVIDS der Current Registry KWP2000: $21 ReadDataByLocalIdentifier $C3 recordLocalIdentifier Modus   : Default
...
Auslesen der FBlockIDs einer DEVID der Current Registry KWP2000: $21 ReadDataByLocalIdentifier $C4 recordLocalIdentifier Modus   : Default
...
| --- | --- | --- |
| DEVICEID | string | Logische MOST-Deviceadresse 4-stellig leer lassen wenn DIAG_ADRESSE genutzt wird Beispiel: 0101 |
| DIAG_ADRESSE | unsigned char | Diagnose Steuergeräteadresse (alternativ zu logischer Deviceadresse) Beispiel: 0x62 result RIT_LINE_0xXX string Xte-RIT-Zeile |
...
Check if a bezel button is pressed or touched KWP2000: $21 ReadDataByLocalIdentifier $C2 recordLocalIdentifier Modus  : Default
...
| Name | Type | Comment |
| --- | --- | --- |
| STAT_WAKEUP_REASON | string | Weckgrund table TWakeupReason REASON |
| STAT_ASLEEPERROR_REASON | string | Einschlaf Fehlerursache table TASleeperrorReason REASON |
| STAT_ASLEEPERROR_FLAGS | string | Additional Flags for ASLEEPERROR_REASON |
| STAT_TASK_SIGNATURE | string | Task Signature (only valid if: AsleeperrorReason = 0x02 = 'GW- or MMI task is not ready for sleep') table TTaskSignature TASK |
| STAT_DIAGFBLOCK_TEXT | string | DiagFBlock and InstID (only valid if: AsleeperrorReason = 0x08 = 'MOST-Bus is not ready for sleep') |
| STAT_DIAGFBLOCK_INSTID | string | InstID (see DIAGFBLOCK_TEXT) |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| STAT_LUEFTER_DREHZAHL | unsigned int | Drehzahl pro Sekunde |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| STAT_RADON_WERT | int | Value of the RADON signal, logical 1 or 0 |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
<a id="job-steuern-fb-calibration"></a>
### STEUERN_FB_CALIBRATION

This job stores the calibration data to the HeadUnit used for the bezel KWP2000: $3B WriteDataByLocalIdentifier $10 localIdentifier Modus  : Default

#### Arguments

| Name | Type | Comment |
| --- | --- | --- |
| ARG_CALIBRATIONDATA | binary | Calibration data stream. Format defined by supplier |
...
<a id="job-steuern-notfall-eject"></a>
### STEUERN_NOTFALL_EJECT

Notfall Auswurf KWP2000: $31 StartRoutineByLocalIdentifier $31 RoutineIdentifier Modus  : Default
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_RESULT | string | "OKAY" oder "OKAY - HWINDEX erhöht", wenn fehlerfreI oder ERROR_WRITE_PMBUS_EEPROM, sonst |
| _TEL_AUFTRAG | binary | Hex-Auftrag an SG |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
Datenbyte 0x1E05 u. 6 prüfen KWP2000: $31 StartRoutineByLocalIdentifier $FA systemSupplierSpecific $39 localIdentifier Modus  : Default
...
<a id="job-steuern-logistik-7546-7552"></a>
### STEUERN_LOGISTIK_7546_7552

HW* und ZB-Nummer vom 7546 und 7552 anpassen (falls nötig) KWP2000: $31 StartRoutineByLocalIdentifier $FA systemSupplierSpecific $37 localIdentifier Modus  : Default
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_RESULT | string | "OKAY" oder "OKAY - HW*-Nummer geändert", wenn fehlerfrei oder ERROR_WRITE_PMBUS_EEPROM, sonst |
| GERAETETYP | string | Nummer des Geräts (z.B. 7502) |
| _TEL_AUFTRAG | binary | Hex-Auftrag an SG |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
| _TEL_ANTWORT2 | binary | Hex-Auftrag an SG (HW*-Nummer abfragen) |
...
- [IORTTEXTE](#table-iorttexte) (43 × 2)
- [IDETAILSTRUKTUR](#table-idetailstruktur) (7 × 2)
- [IUMWELTMATRIX](#table-iumweltmatrix) (29 × 5)
...
- [TFBTASTE_GEDRUECKT](#table-tfbtaste-gedrueckt) (4 × 2)
...
| 0xA16C | FB_Communication_Error |
| 0xA16D | FB_Defect_Error |
| 0xE184 | CAN Low |
| 0xE187 | CAN Controller |
| 0xE188 | Keinen Klemmenstatus empfangen |
...
| 0x05 | Fehlerursache | Hex | high | unsigned int | - | - | - | - |
...
| 0xA178 | CAN Overrun |
| 0xA179 | CAN RX BUFFER |
| 0xA17B | MOST Tx internal message |
| 0xA17C | Task Queue overflow |
| 0xA17D | Error_GW_Table |
| 0xA17E | Error_Power |
| 0xA17F | Error_IPC_Queue_Ovfl |
...
| 0xA18C | FB_Protocol_Error |
| 0xA18D | FB_Alive_Error |
| 0xA18E | FB_Version_Error |
| 0xA18F | FB_Software_Error |
| 0xA190 | StandBy- Mode active |
| 0xA191 | FB_Defect_Error |
...
| 0x09 | DeviceID | Hex | high | unsigned int | - | 1 | 1 | 0 |
| 0x0A | Fehlerursache | Hex | high | unsigned int | - | - | - | - |
| 0x0B | Fehlercode DSP | Hex | high | unsigned int | - | 1 | 1 | 0 |
...
| 0x29 | Trap Flag Register | Hex | high | unsigned int | - | 1 | 1 | 0 |
...
| MASKE | NAME |
| --- | --- |
| 0x00 | Taste nicht gedrückt |
| 0x01 | Taste berührt |
| 0x02 | Taste gedrückt |
| 0xFF | Tastenstatus unbekannt |
