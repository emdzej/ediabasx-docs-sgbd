...
| Field | Value |
| --- | --- |
| ECU | BMW F10 Hifi Verstärker |
| ORIGIN | BMW EI-41 HenningKelch |
| REVISION | 1.002 |
| AUTHOR | HarmanBecker EEA ChristianKnott |
| COMMENT | N/A |
| PACKAGE | 1.12 |
| SPRACHE | deutsch |
...
- [STEUERN_PMMODUS_SW_VERSION](#job-steuern-pmmodus-sw-version) - Read SW Versions UDS: $31    RoutineControl $01    startRoutine $F0 00 RoutineIdentifier PM Mode $FF    Developer Functions $20    Version $xx    Sort $00    Get Status $0D    PM Mode Endmarker
...
- [STATUS_AUDIOKANAELE](#job-status-audiokanaele) - $22 0xD003 AUDIOKANAELE
- [STEUERN_AUDIOKANAELE](#job-steuern-audiokanaele) - (nur im Diagnosemodus)  $2E 0xD003 AUDIOKANAELE
- [STEUERN_SINUSGENERATOR_EIN](#job-steuern-sinusgenerator-ein) - (nur im Diagnosemodus)  $31 0xA001 SINUSGENERATOR
- [STEUERN_SINUSGENERATOR_AUS](#job-steuern-sinusgenerator-aus) - (nur im Diagnosemodus)  $31 0xA001 SINUSGENERATOR
- [STEUERN_LEISTUNGSZUSTAENDE_EIN](#job-steuern-leistungszustaende-ein) - UDS $31       RoutineControl 01       startRoutine A0 6F    RoutineId Leistungszustände XX       Leistungszustand
- [STEUERN_LEISTUNGSZUSTAENDE_AUS](#job-steuern-leistungszustaende-aus) - UDS $31       RoutineControl 02       stopRoutine A0 6F    RoutineId Leistungszustände
- [STEUERN_LEISTUNGSZUSTAENDE_LESEN](#job-steuern-leistungszustaende-lesen) - UDS $31       RoutineControl 03       startRoutine A0 6F    RoutineId Leistungszustände
...
| SW_VERSION_CBC | string | SW Version Controller Bios-Control xx.yy.zz xx = Major yy = Minor zz = Bugfix |
| SW_VERSION_DBC | string | SW Version DSP Bios-Control xx.yy.zz xx = Major yy = Minor zz = Bugfix |
...
| _REQUEST_CBC | binary | Hex-Auftrag an SG |
| _RESPONSE_CBC | binary | Hex-Antwort von SG |
| _REQUEST_DBC | binary | Hex-Auftrag an SG |
| _RESPONSE_DBC | binary | Hex-Antwort von SG |
...
| Name | Type | Comment |
| --- | --- | --- |
| STAT_KANAL | unsigned long | Kanalnummer |
| STAT_KANAL_TEXT | string | Kanalnummer |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| _REQUEST | binary | Hex-Auftrag an SG |
| _RESPONSE | binary | Hex-Antwort von SG |
...
(nur im Diagnosemodus)  $2E 0xD003 AUDIOKANAELE

#### Arguments

| Name | Type | Comment |
| --- | --- | --- |
| ARG_KANAL | unsigned long | Kanalnummer Anzahl aktiver Lautsprecher (Bitweise Kombination aller Lautsprecher) 0x00000000  alle Kanäle 0x00000001  Mittel-/Hochtöner links vorne       33/34 0x00000002  Mittel-/Hochtöner rechts vorne      11/12 0x00000004  Center                              39/40 0x00000008  NV 0x00000010  NV 0x00000020  Hochtöner hinten links              31/32 0x00000040  Hochtöner hinten rechts             13/21 0x00000080  Zentralbass links                   03/04 0x00000100  Zentralbass rechts                  22/23 0x00000200  NV (reserviert  Kanal 8 )           41/42 |
...
(nur im Diagnosemodus)  $31 0xA001 SINUSGENERATOR
...
| ARG_KANAL | int | Kanalnummer Anzahl aktiver Lautsprecher (Bitweise Kombination aller Lautsprecher) 0x00000000  alle Kanäle 0x00000001  Mittel-/Hochtöner links vorne       33/34 0x00000002  Mittel-/Hochtöner rechts vorne      11/12 0x00000004  Center                              39/40 0x00000008  NV 0x00000010  NV 0x00000020  Hochtöner hinten links              31/32 0x00000040  Hochtöner hinten rechts             13/21 0x00000080  Zentralbass links                   03/04 0x00000100  Zentralbass rechts                  22/23 0x00000200  NV (reserviert  Kanal 8 )           41/42 |
...
UDS $31       RoutineControl 01       startRoutine A0 6F    RoutineId Leistungszustände XX       Leistungszustand

#### Arguments

| Name | Type | Comment |
| --- | --- | --- |
| LEISTUNGSZUSTAND | string | Leistungszustände Tabelle TAB_AMP_LEISTUNGSZUSTAND Zustände:    0x01 Default 0x02 MSA_Start |
...
UDS $31       RoutineControl 02       stopRoutine A0 6F    RoutineId Leistungszustände
...
<a id="job-steuern-leistungszustaende-lesen"></a>
### STEUERN_LEISTUNGSZUSTAENDE_LESEN

UDS $31       RoutineControl 03       startRoutine A0 6F    RoutineId Leistungszustände
...
| Name | Type | Comment |
| --- | --- | --- |
| LEISTUNGSZUSTAND | string | Leistungszustände Tabelle TAB_AMP_LEISTUNGSZUSTAND interner Leistungszustand des Verstärkers |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| _REQUEST | binary | Hex-Auftrag an SG |
| _RESPONSE | binary | Hex-Antwort von SG |
...
- [FORTTEXTE](#table-forttexte) (17 × 3)
- [FDETAILSTRUKTUR](#table-fdetailstruktur) (6 × 2)
- [IORTTEXTE](#table-iorttexte) (13 × 3)
- [IDETAILSTRUKTUR](#table-idetailstruktur) (4 × 2)
- [SG_FUNKTIONEN](#table-sg-funktionen) (5 × 16)
...
| --- | --- | --- |
| 0xD6CBFF | DM_TEST_COM | 1 |
| 0x02FF37 | DM_TEST_APPL | 1 |
...
| 0xD6C40B | K-CAN Bus | 0 |
| 0xD6C414 | K-CAN Control Module Bus OFF | 0 |
...
| 0xB7F495 | Entwickler-EQ: ungueltige Checksumme | 0 |
| 0xFFFFFF | unbekannter Fehlerort | 0 |
