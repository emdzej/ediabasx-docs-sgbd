...
| Field | Value |
| --- | --- |
| ECU | Verstärker Low Cost (Buslos) Diagnose |
| ORIGIN | BMW TI-533 Eckhart |
| REVISION | 1.100 |
| AUTHOR | BMW TI-533 Weber, BMW TI-533 Eckhart |
| COMMENT | N/A |
| PACKAGE | 1.17 |
| SPRACHE | deutsch |
...
- [STEUERN_AUDIOKANAELE_HIFI_LC_UDS](#job-steuern-audiokanaele-hifi-lc-uds) - Schaltet die Kanalsteuerung im Hifi Low Cost Verstärker. dazu werden Sinusgenerator und Rad-On Steuerung des Radios benutzt.
...
| Name | Type | Comment |
| --- | --- | --- |
| ARG_CHANNEL | unsigned int | Legt den Audiokanal fest, auf dem geroutet wird Tabelle TAB_AMP_LC_MAIN_TABLE Defaultwert: 0 Hinweis: 0 beendet den Diagnosemodus |
| ARG_LEVEL | unsigned char | Legt den Pegel fesr Defaultwert: 0x40 |
| ARG_FREQ | unsigned int | Legt die Frequenz nach dem Diagnosemodus fest Defaultwert: 0 Hinweis: 0 keine Ausgabe |
| ARG_DURATION | unsigned int | Legt die Dauer der Frequenz nach dem Diagnosemodus fest Defaultwert: 0, 0=Keine Ausgabe |

#### Results

| Name | Type | Comment |
| --- | --- | --- |
| STAT_CHANNEL | unsigned int | Kanal, der geroutet werden sollte |
| STAT_CHANNEL_TEXT | string | Kanal, der gerotet werden sollte |
...
- [TAB_AMP_LC_FREQ](#table-tab-amp-lc-freq) (4 × 2)
...
| CHANNEL | CHANNEL_TEXT | FREQ1 | FREQ2 | FREQ3 |
| --- | --- | --- | --- | --- |
| 0 | Diagnose aus | 0xFF | 0xFF | 0xFF |
| 1 | Vorne Links | 1 | 2 | 1 |
| 2 | Vorne Rechts | 1 | 2 | 3 |
| 4 | Center | 2 | 3 | 1 |
| 32 | Hinten Links | 1 | 3 | 1 |
| 64 | Hinten Rechts | 1 | 3 | 2 |
| 128 | Zentralbass Links | 2 | 1 | 2 |
| 256 | Zentralbass Rechts | 2 | 1 | 3 |
| 512 | Reserve | 2 | 3 | 2 |
| 0xFF | Nicht definiert | 0xFF | 0xFF | 0xFF |
