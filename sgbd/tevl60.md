...
| 0x9632 | Timeout ID 06H (SASL) |
| 0x9633 | Timeout ID 07H (SBSR) |
| 0x9634 | Timeout ID 08H (SASR) |
| 0x9635 | Timeout ID 09H (SFZ) |
| 0x9636 | Timeout ID 0AH (SIM) |
| 0x9637 | Timeout ID 0BH (SASL) |
| 0x9638 | Timeout ID 0CH (SASR) |
| 0x9639 | Timeout ID 0DH (SFZ) |
| 0x963a | Timeout ID 0EH |
| 0x963b | Timeout ID 0FH |
| 0x963c | Timeout ID 20H (SSFA) |
| 0x963d | Timeout ID 21H (SSBF) |
| 0x963e | Timeout ID 22H (SSH) |
...
| 0x964e | Zuendkapazitaet ZK1 n.i.O. |
...
| 0x9659 | Zuendkapazitaet ZK2 n.i.O. |
