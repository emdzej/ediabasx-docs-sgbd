...
| Field | Value |
| --- | --- |
| ECU | Audio-System-Kontroller E65 (ASK) |
| ORIGIN | BMW TI-431 Weber |
| REVISION | 1.13 |
| AUTHOR | BMW EI-41 Busch/Menjon/Kocic |
| COMMENT | ASK_E65 |
| PACKAGE | 1.32 |
| SPRACHE | deutsch |
...
- [Read_Current_Registry](#job-read-current-registry) - Auslesen der Registry vom ASK KWP2000: $21 ReadDataByLocalIdentifier $B0 Registry Modus   : Default
- [Read_Default_Registry](#job-read-default-registry) - Auslesen der Registry vom ASK KWP2000: $21 ReadDataByLocalIdentifier LH Diagnose Teil 8, Januar 2000 Seite 67 $B1 Default Registry Modus   : Default
- [STEUERN_AUDIOKANAELE](#job-steuern-audiokanaele) - Ansteuern von einem AudioKanal KWP2000: $30 InputOutputControlByLocalIdentifier $07 ShortTermAdjustment Modus  : Default
- [STEUERN_KLANGZEICHEN](#job-steuern-klangzeichen) - Ausloesen eines Klangzeichens KWP2000: $30 InputOutputControlByLocalIdentifier $07 ShortTermAdjustment Modus  : Default
- [STEUERN_VOLUMEAUDIO](#job-steuern-volumeaudio) - Einstellen der Audio Lautstaerke KWP2000: $30 InputOutputControlByLocalIdentifier $07 ShortTermAdjustment Modus  : Default
- [STEUERN_LINEAR](#job-steuern-linear) - Ton Einstellungen werde auf Linear gesetzt KWP2000: $30 InputOutputControlByLocalIdentifier $07 ShortTermAdjustment Modus  : Default
- [STEUERN_ZENTRALE_REGISTRY_SOLLKONFIGURATION](#job-steuern-zentrale-registry-sollkonfiguration) - Ausgelesene Zentrale Registry wird als Sollkonfiguration abgespeichert KWP2000: $30 InputOutputControlByLocalIdentifier $07 ShortTermAdjustment Modus  : Default
- [STATUS_GERAETE_TEMPERATUR](#job-status-geraete-temperatur) - Auslesen der Temperatur im ASK KWP2000: $30 InputOutputControlByLocalIdentifier $07 ShortTermAdjustment Modus  : Default
...
- [STATUS_LESEN_LAUFWERK_ASK](#job-status-lesen-laufwerk-ask) - Auslesen des verbauten Laufwerkes im ASK KWP2000: $21 ReadDataByLocalIdentifier $B3 recordLocalIdentifier Modus  : Default
...
- [STATUS_SEARCH_FBLOCK](#job-status-search-fblock) - Suche Fblock,InstID KWP2000: $21 ReadDataByLocalIdentifier $B0 recordLocalIdentifier (CurrentRegistry)
...
Auslesen der Registry vom ASK KWP2000: $21 ReadDataByLocalIdentifier $B0 Registry Modus   : Default
...
Auslesen der Registry vom ASK KWP2000: $21 ReadDataByLocalIdentifier LH Diagnose Teil 8, Januar 2000 Seite 67 $B1 Default Registry Modus   : Default
...
Ansteuern von einem AudioKanal KWP2000: $30 InputOutputControlByLocalIdentifier $07 ShortTermAdjustment Modus  : Default

#### Arguments

| Name | Type | Comment |
| --- | --- | --- |
| AUDIOKANAL | string | NF Ausgabe nur auf dem gewaehlten Kanal  table KanalArgument |
...
Ausloesen eines Klangzeichens KWP2000: $30 InputOutputControlByLocalIdentifier $07 ShortTermAdjustment Modus  : Default

#### Arguments

| Name | Type | Comment |
| --- | --- | --- |
| KLANGZEICHEN | string | Ausloesen des gewaehlten Klangzeichens table KlangzeichenArgument |
...
Einstellen der Audio Lautstaerke KWP2000: $30 InputOutputControlByLocalIdentifier $07 ShortTermAdjustment Modus  : Default

#### Arguments

| Name | Type | Comment |
| --- | --- | --- |
| VOLUME | string | Ausgewaehlte Audio Lautstaerke  table VolumeAudioArgument |
...
Ton Einstellungen werde auf Linear gesetzt KWP2000: $30 InputOutputControlByLocalIdentifier $07 ShortTermAdjustment Modus  : Default
...
Ausgelesene Zentrale Registry wird als Sollkonfiguration abgespeichert KWP2000: $30 InputOutputControlByLocalIdentifier $07 ShortTermAdjustment Modus  : Default
...
Auslesen der Temperatur im ASK KWP2000: $30 InputOutputControlByLocalIdentifier $07 ShortTermAdjustment Modus  : Default
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_AUDIO_SYSTEM | string | hifi - oder tophifi-system |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |

<a id="job-status-lesen-laufwerk-ask"></a>
### STATUS_LESEN_LAUFWERK_ASK

Auslesen des verbauten Laufwerkes im ASK KWP2000: $21 ReadDataByLocalIdentifier $B3 recordLocalIdentifier Modus  : Default
...
Suche Fblock,InstID KWP2000: $21 ReadDataByLocalIdentifier $B0 recordLocalIdentifier (CurrentRegistry)
...
- [TFBLOCKIDTEXTE](#table-tfblockidtexte) (32 × 2)
- [KANALARGUMENT](#table-kanalargument) (11 × 3)
- [AUDIOVARIANTE](#table-audiovariante) (4 × 2)
- [LAUFWERKSVARIANTE](#table-laufwerksvariante) (4 × 2)
- [KLANGZEICHENARGUMENT](#table-klangzeichenargument) (7 × 3)
- [VOLUMEAUDIOARGUMENT](#table-volumeaudioargument) (28 × 2)
...
| ORT | ORTTEXT |
| --- | --- |
| 0xD8CD | Weckendes Device hat 3 mal erfolglos versucht das Netzwerk zu wecken. (Error_WakeUp_Failed). |
| 0xD8CE | Obwohl Shutdown(Execute) geschickt wurde, ging das Licht nicht aus. (Error_Light_Not_Off). |
| 0xD8CF | Zentrale Registry stimmt nicht mit der Sollkonfiguration ueberein (Error_Registry_New). |
| 0xD8D0 | Ringbruchdiagnose wurde durchgefuehrt (Error_Ring_Diagnose). |
| 0xD8D1 | Lange und/oder häufige Unlocks (Error_Unlock_Long). |
| 0xD8D2 | Ein Device hat sich wegen Uebertemperatur abgeschaltet (Error_Temp_Shutdown). |
| 0xA188 | DSP defekt (Error_DSP_Funktion)  |
| 0xA189 | Endstufen IC defekt (Error_Audio_Amplifier_IC)   |
| 0xA18A | Laufwerk defekt (Error_Single_Player)   |
...
| --- | --- | --- | --- | --- |
| 0xD8CF | 0x01 | 0xFF | 0xFF | 0xFF |
| 0xD8CD | 0x01 | 0xFF | 0xFF | 0xFF |
| 0xD8D0 | 0x02 | 0xFF | 0xFF | 0xFF |
| 0xD8D2 | 0xFF | 0xFF | 0xFF | 0xFF |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 0x01 | Diagnoseadresse | Hex | high | unsigned int | - | 1 | 1 | 0 |
| 0x02 | NPR | Hex | high | unsigned int | - | 1 | 1 | 0 |
| 0x03 | Logische-Kotenadresse | Hex | high | unsigned int | - | 1 | 1 | 0 |
| 0x04 | FBlockID | Hex | high | unsigned int | - | 1 | 1 | 0 |
| 0x05 | InstID | Hex | high | unsigned int | - | 1 | 1 | 0 |
| 0x06 | FktID | Hex | high | unsigned int | - | 1 | 1 | 0 |
| 0xFF | ohne Bedeutung | Hex | high | unsigned int | - | 1 | 1 | 0 |
...
| 0x9311 | Error_CS: ASK hat beim Aufstarten einen Checksummenfehler erkannt |
| 0x9312 | Error_UT: ASK hat Uebertemperatur erkannt |
| 0x9313 | Error_SPG: ASK hat bei Selbsttest Unterspannung Klemme 30 erkannt |
| 0x9314 | Error_Loudness: ASK hat Loudnessfehler eines Verstärkers detektiert |
| 0x9317 | Ein Device hat die Monitoringnachricht nicht abgenommen oder bestätigt. (Error_Monitoring). |
| 0xFFFF | unbekannter Fehlerort |
...
| 0x930F | 0x05 | 0xFF | 0xFF | 0xFF |
| 0x9310 | 0x01 | 0x02 | 0x03 | 0x04 |
| 0x9317 | 0x05 | 0x02 | 0x03 | 0x04 |
| default | 0xFF | 0xFF | 0xFF | 0xFF |
...
| UWNR | UWTEXT | UW_EINH | L/H | UWTYP | NAME | MUL | DIV | ADD |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 0x01 | Logische-Kotenadresse | Hex | high | unsigned int | - | 1 | 1 | 0 |
| 0x02 | FBlockID | Hex | high | unsigned int | - | 1 | 1 | 0 |
| 0x03 | InstID | Hex | high | unsigned int | - | 1 | 1 | 0 |
| 0x04 | FktID | Hex | high | unsigned int | - | 1 | 1 | 0 |
| 0x05 | Diagnoseadresse | Hex | high | unsigned int | - | 1 | 1 | 0 |
| 0xFF | ohne Bedeutung | Hex | high | unsigned int | - | 1 | 1 | 0 |
| 0xXY | unbekannte Umweltbedingung | 1 | high | unsigned int | - | 1 | 1 | 0 |
...
<a id="table-laufwerksvariante"></a>
### LAUFWERKSVARIANTE
...
<a id="table-klangzeichenargument"></a>
### KLANGZEICHENARGUMENT
...
<a id="table-volumeaudioargument"></a>
### VOLUMEAUDIOARGUMENT
...
| PDC/LS = 0x84 | 0x84 |
| Gong/LS = 0x85 | 0x85 |
| DAB FM follow up/LS  = 0x90 | 0x90 |
| DAB FM follow up/KHL = 0x91 | 0x91 |
| DAB FM follow up/KHR = 0x92 | 0x92 |
| Fehler = 0xXY | 0xXY |
