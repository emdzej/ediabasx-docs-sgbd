...
| REVISION | 1.023 |
| AUTHOR | BMW_AG UX-EE-1 Stoffregen, ESG UX-EE-1 Sergl, BMW_AG UX-EE-1 Krimmer |
...
- [_STATUS_KONFIGURATION](#job-status-konfiguration) - Lesen der Konfigurationsparameter der ZFE Achtung: Dieser Job war ursprünglich nur als Entwicklungsjob gedacht, wird aber mittlerweile von VS und in INPA verwendet! Deshalb darf dieser Job nicht gelöscht werden!! KWP2000:      $22 ReadDataByCommonIdentifier $300B DataGroup Configuration Parameter (EEPROM) Modus:        Default
...
- [STATUS_KALIBRIERUNG_FOLIENGEBER](#job-status-kalibrierung-foliengeber) - Status Kalibrierung des Foliengebers KWP2000:      $23 ReadMemoryByAddress $000000 Adresse $03 NVRAM $01 Länge 1 Byte Modus:        Default
...
- [STEUERN_RUECKLICHT](#job-steuern-ruecklicht) - Ruecklicht direkt ansteuern Vorbedingung: Ausführung des Jobs STEUERN_VORBEREITEN KWP2000:      $30 InputOutputControlByLocalIdentifier $04 Analog Output Signals (siehe ControlState.xls) $07 ShortTermAdjustment $01 c_KL58_rear Modus:        Default
...
- [STEUERN_VORBEREITEN_KALIBRIERUNG_FOLIENGEBER](#job-steuern-vorbereiten-kalibrierung-foliengeber) - Vorbereiten zur Kalibrierung des Foliengebers KWP2000:      $3D WriteMemoryByAddress $000000 Adresse $03 NVRAM $01 Länge 1 Byte $FF Seuergeraete reset ausloesen KWP2000:      $11 ECUReset $01 PowerOn Modus:        Default
- [STEUERN_START_KALIBRIERUNG_FOLIENGEBER](#job-steuern-start-kalibrierung-foliengeber) - Start der Prozedur zur Kalibrierung des Foliengebers KWP2000:      $3D WriteMemoryByAddress $000000 Adresse $03 NVRAM $01 Länge 1 Byte $FE Modus:        Default
...
| STAT_C_LICENSE_PLATE_BULB | int | 0.. mit Kennzeichenleuchte 1.. ohne Kennzeichenleuchte |
| STAT_C_HANDLERHEAT_PRESENT | int | 0.. mit Griffheizung 1.. ohne Griffheizung |
| STAT_C_KL56B1_OFF_56A_ON | int | 0.. aktiv 1.. nicht aktiv |
| STAT_C_KL56B2_OFF_56A_ON | int | 0.. aktiv 1.. nicht aktiv |
| STAT_C_SEAT_HEAT_DRV_PRESENT | int | 0.. aktiv 1.. nicht aktiv |
| STAT_C_SEAT_HEAT_PAS_PRESENT | int | 0.. aktiv 1.. nicht aktiv |
| STAT_C_ESA_ZSVO_PRESENT | int | 0.. aktiv 1.. nicht aktiv |
| STAT_C_ESA_FBHI_PRESENT | int | 0.. aktiv 1.. nicht aktiv |
| STAT_C_ESA_ZSHI_PRESENT | int | 0.. aktiv 1.. nicht aktiv |
| STAT_C_ESA_DSHI_PRESENT | int | 0.. aktiv 1.. nicht aktiv |
| STAT_C_WINDSCREEN_PRESENT | int | 0.. aktiv 1.. nicht aktiv |
...
| STAT_C_BRAKE_PAD_PRESENT | int | 0.. aktiv 1.. nicht aktiv |
| _TEL_AUFTRAG | binary | Hex-Auftrag an SG |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| STAT_C_LICENCE_PLATE | int | Kennzeichenleuchte |
| STAT_C_KLBR | int | Blinker rechts |
| STAT_C_KLBL | int | Blinker links |
| STAT_KL61_ENA | int | Generator Vorerregung |
| STAT_C_AUX_FET | int | 1.FET Steckdose Wenn STAT_C_AUX_FET und STAT_KLR1_FET aktiv -&gt; Steckdose aktiv |
| STAT_KLR1_FET | int | 2.FET Steckdose Wenn STAT_C_AUX_FET und STAT_KLR1_FET aktiv -&gt; Steckdose aktiv |
| STAT_WAKE_UP_LINE | int | WakeUp-Line |
| STAT_C_POT_FLS | int | Spannungsversorgung für FLS-Potentiometer |
| _TEL_AUFTRAG | binary | Hex-Auftrag an SG |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| STAT_PWM_KL58_REAR_WERT | real | PWM-Wert Ruecklicht Bereich: 0 bis 100 [%] |
...
| STAT_FLS_TYP | int | Tankgeberart: 0.. Hebelgeber 1.. Foliengeber |
...
Status Kalibrierung des Foliengebers KWP2000:      $23 ReadMemoryByAddress $000000 Adresse $03 NVRAM $01 Länge 1 Byte Modus:        Default
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_KALIBRIERUNG_TEXT | string | Speicherinhalt ab Adresse 0x00 im EEPROM table Status_Kalibrierung STATUS_TEXT |
| STAT_KALIBRIERUNG_WERT | char | Speicherinhalt ab Adresse 0x00 im EEPROM table Status_Kalibrierung STATUS_NUMMER |
| _TEL_AUFTRAG | binary | Hex-Auftrag an SG |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
Ruecklicht direkt ansteuern Vorbedingung: Ausführung des Jobs STEUERN_VORBEREITEN KWP2000:      $30 InputOutputControlByLocalIdentifier $04 Analog Output Signals (siehe ControlState.xls) $07 ShortTermAdjustment $01 c_KL58_rear Modus:        Default
...
<a id="job-steuern-vorbereiten-kalibrierung-foliengeber"></a>
### STEUERN_VORBEREITEN_KALIBRIERUNG_FOLIENGEBER

Vorbereiten zur Kalibrierung des Foliengebers KWP2000:      $3D WriteMemoryByAddress $000000 Adresse $03 NVRAM $01 Länge 1 Byte $FF Seuergeraete reset ausloesen KWP2000:      $11 ECUReset $01 PowerOn Modus:        Default
...
Start der Prozedur zur Kalibrierung des Foliengebers KWP2000:      $3D WriteMemoryByAddress $000000 Adresse $03 NVRAM $01 Länge 1 Byte $FE Modus:        Default
...
- [STATUS_KALIBRIERUNG](#table-status-kalibrierung) (4 × 3)
...
| 0xA304 | Kennzeichenleuchte Kurzschluß |
| 0xA305 | Kennzeichenleuchte Leitungsunterbrechung |
...
| 0xA30F | Klemme R Kurzschluß |
| 0xA312 | Signal Füllstand_Tank_Motorrad ungültig |
| 0xA313 | Signal Status_Lampendefekte_Motorrad ungültig |
| 0xA314 | Signal Status_Kl15_Motorrad ungültig |
| 0xA315 | Signal Status_Ausgang Kl56a_Motorrad ungültig |
| 0xA316 | Signal Status_Schalter_Fussbremse_Motorrad ungültig |
| 0xA317 | Signal Status_Schalter_Handbremse_Motorrad ungültig |
| 0xA318 | Signal Status_Blinken_ZFE_Motorrad ungültig |
| 0xA319 | CAN Bus Off |
...
<a id="table-status-kalibrierung"></a>
### STATUS_KALIBRIERUNG
...
| --- | --- | --- |
| 0xFF | 1 | Kalibrierung ist vorbereitet |
| 0xFE | 2 | Kalibrierung wird durchgeführt |
| 0xFD | 3 | Kalibrierung ist abgeschlossen |
| 0xXY | -1 | nicht gültig |
