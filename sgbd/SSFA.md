...
| STAT_HALLSCH_GTE_AKTUELLER_WERT | unsigned int | Hall-Schalter Gurtrageerkennung: aktueller Messwert Bereich: 0-255 |
| STAT_HALLSCH_GTE_AKTUELLER_EINH | string | Hall-Schalter Gurtrageerkennung: Einheit: (Ink)kremente |
| STAT_HALLSCH_GTE | unsigned int | Hall-Schalter Gurtrageerkennung: 0x00: Schalter offen 0x01: Schalter geschlossen 0x02: Unterbrechung 0x04: Kurzschluss Speziell fuer VS |
...
| STAT_SBE | unsigned int | Status Sitzbelegungserkennung Bit 0-2: Gewichtsklasse (0x*7 = Fehler) Bei SBE1 nur: unbelegt: 000 belegt: 011 Bit 3: frei Bit 4: Kurzschluss Bit 5: Unterbrechung Bit 6: Kommunikationsfehler Bit 7: Belegung undefiniert |
...
| Name | Type | Comment |
| --- | --- | --- |
| STAT_ZK1_AKTIV | int | 0=ZK1_NICHT_AKTIV 1=ZK1_AKTIV Gurtstrammer Fahrer |
| STAT_ZK2_AKTIV | int | 0=ZK2_NICHT_AKTIV 1=ZK2_AKTIV Aktive Kopfstuetze Fahrer |
...
| ORT | ORTTEXT |
| --- | --- |
| 0x9728 | Watchdog-Reset uP |
| 0x9729 | Clock-Monitor-Reset uP |
| 0x972a | Illegal Opcode uP |
| 0x972b | Falsche Fahrgestellnummer |
| 0x972c | Systemzeitfehler |
| 0x972d | Timeout ID 01H (STVL) |
| 0x972e | Timeout ID 02H |
| 0x972f | Timeout ID 03H (STVR) |
| 0x9730 | Timeout ID 04H |
| 0x9731 | Timeout ID 05H (SBSL) |
| 0x9732 | Timeout ID 06H (SASL) |
| 0x9733 | Timeout ID 07H (SBSR) |
| 0x9734 | Timeout ID 08H (SASR) |
| 0x9735 | Timeout ID 09H (SFZ) |
| 0x9736 | Timeout ID 0AH (SIM) |
| 0x9737 | Timeout ID 0BH (SASL) |
| 0x9738 | Timeout ID 0CH (SASR) |
| 0x9739 | Timeout ID 0DH (SFZ) |
| 0x973a | Timeout ID 0EH |
| 0x973b | Timeout ID 0FH |
| 0x973c | Timeout ID 20H (SSFA) |
| 0x973d | Timeout ID 21H (SSBF) |
| 0x973e | Timeout ID 22H (SSH) |
| 0x973f | Timeout ID 71H (SIM) |
| 0x9740 | Codierdaten Checksummenfehler |
| 0x9741 | Stack Overflow |
| 0x9742 | PDC_3 : zu wenig Telegramme |
| 0x9743 | PDC_3 : Datenfehler in Telegramm |
| 0x9744 | PDC_3 : Uebertragungsfehler |
| 0x9745 | unplausible Crash-Schwere |
| 0x9746 | Kurzschluss oder Unterbrechung H/L-Side-Schalter ZK1 |
| 0x9747 | Kurzschluss ZK1 nach Masse |
| 0x9748 | Kurzschluss ZK1 nach Plus |
| 0x9749 | Widerstand Zuendpille ZK1 zu klein |
| 0x974a | Widerstand Zuendpille ZK1 zu gross |
| 0x974b | Widerstand Zuendpille ZK1 nicht gemessen |
| 0x974c | Unterbrechung ZK1 |
| 0x974d | Spannung ZK1 n.i.O. |
| 0x974e | Zuendkapazitaet ZK1 n.i.O. |
| 0x974f | Codierung/Konfiguration ZK1 unstimmig |
| 0x9750 | Unterbrechung Entladekreis ZK1 |
| 0x9751 | Kurzschluss oder Unterbrechung H/L-Side-Schalter ZK2 |
| 0x9752 | Kurzschluss ZK2 nach Masse |
| 0x9753 | Kurzschluss ZK2 nach Plus |
| 0x9754 | Widerstand Zuendpille ZK2 zu klein |
| 0x9755 | Widerstand Zuendpille ZK2 zu gross |
| 0x9756 | Widerstand Zuendpille ZK2 nicht gemessen |
| 0x9757 | Unterbrechung ZK2 |
| 0x9758 | Spannung ZK2 n.i.O. |
| 0x9759 | Zuendkapazitaet ZK2 n.i.O. |
| 0x975a | Codierung/Konfiguration ZK2 unstimmig |
| 0x975b | Unterbrechung Entladekreis ZK2 |
| 0x975c | Gurtschlossschalter 1 Kurzschluss |
| 0x975d | Gurtschlossschalter 1 Unterbrechung |
| 0x975e | Fehler im Alarmpfad |
| 0x9763 | Unterbrechung SBE1 |
| 0x9764 | Kurzschluss SBE1 |
| 0x9765 | Kommunikationsstoerung SBE1 |
| 0x9766 | Algorithmus-Parameter inkonsistent |
| 0x9767 | EAM-Parameter inkonsistent |
| 0x9768 | Zuendversuch erfolgt |
| 0x9769 | COP-Watchdog fehlerhaft |
| 0x976a | Kurzschluss oder Unterbrechung Low-Side-Schalter ZK1 |
| 0x976b | Kurzschluss oder Unterbrechung High-Side-Schalter ZK1 |
| 0x976c | Kurzschluss oder Unterbrechung Low-Side-Schalter ZK2 |
| 0x976d | Kurzschluss oder Unterbrechung High-Side-Schalter ZK2 |
| 0x976e | Kommunikation mit Zuend-IC gestoert |
| 0x977a | Energiesparmode aktiv |
| 0x977b | Hallschalter : Kurzschluss |
| 0x977c | Hallschalter : unplausibler Messwert |
| 0x977d | Hallschalter : Unterbrechung |
| 0x977e | Spannungsueberwachung ASE unterer Grenzwert unterschritten |
| 0x977f | Spannungsueberwachung ASE oberer Grenzwert ueberschritten |
| 0x9780 | Codierung unvollstaendig |
...
| ORT | ORTTEXT |
| --- | --- |
| 0x9770 | Power-On-Reset uP |
| 0x9771 | Diagnose S/E-Modul (Lichtleistung) |
| 0x9772 | SI-Bus: Uebertragungsfehler, CRC-Fehler ERRIF |
| 0x9773 | SI-Bus: Uebertragungsfehler, Formatfehler ILLPIF |
| 0x9774 | SI-Bus: Synchronisierungspuls zu frueh SYNEIF |
| 0x9775 | SI-Bus: Synchronisierung verloren SYNLIF |
| 0x9776 | SI-Bus: Slotmismatch, Timingfehler SLMMIF |
| 0x9777 | SI-Bus: FIFO-Ueberlauf OVRNIF |
| 0x9778 | Unterspannung OCE |
| 0x9779 | EMV-Fehler im Zuend-Ic |
| 0x???? | unbekannter Fehlerort |
