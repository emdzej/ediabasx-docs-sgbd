...
| --- | --- |
| ECU | MRIABS3 |
| ORIGIN | BMW UX-EF-4 Mayer_Anton |
| REVISION | 1.008 |
| AUTHOR | BMW_AG UX-EE-1 Stefan_Krimmer_UX-EE-1 |
| COMMENT | Nur fuer Bosch 9ME (K46) |
| PACKAGE | 1.66 |
| SPRACHE | deutsch |
...
- [STEUERN_USV](#job-steuern-usv) - Activating USV KWP2000: $30 InputOutputControlByLocalId $04 Local ID actuator test $07 InputOutputControlParameter Implementation see Appendix B: Acutator Table Modus:        Default
- [STEUERN_HSV](#job-steuern-hsv) - Activating HSV KWP2000: $30 InputOutputControlByLocalId $04 Local ID actuator test $07 InputOutputControlParameter Implementation see Appendix B: Acutator Table Modus:        Default
- [STEUERN_RESET_VARIANT](#job-steuern-reset-variant) - Reset Coding Variant KWP2000: $2E $30 $00 $FF Default (Reset)
- [STATUS_VARIANT](#job-status-variant) - Reading of the learnt Variant KWP2000:      $22 ReadDataByCommonId $00$01 internal variant value Modus:        Default
...
- [STATUS_CAN_INPUT](#job-status-can-input) - Reads CAN Input KWP2000: $21 ReadDataByLocalIdentifier $04 CAN Input Modus: Default
- [STATUS_MU_JUMP_COUNTER](#job-status-mu-jump-counter) - Return Mu-jump counter value It is incremented in case ABS recognized Hi-mu to Low mu surface transition KWP2000: $21 ReadDataByLocalIdentifier $05 Mu-Jump Counter Modus: Default
...
| DELAY_TIME | unsigned char | 0..255 [s] pump activation delay time the value 0 and value 255 causes no pump activation by sending 0xFF to ECU |
...
| Name | Type | Comment |
| --- | --- | --- |
| DATA | binary | 20 (!) DataBytes for Job Argument  *************************************************************** DATA_LAYOUT: ***************************************************************  \| Byte  \|  Contents                                \|  Value    \| --------------------------------------------------------------- 1,2      1.Activation value (HB,LB)                 xx xx (Hex) 3,4      1.Actuator number (HB,LB)                  xx xx (Hex) 5,6      2.Activation value (HB,LB)                 xx xx (Hex) 7,8      2.Actuator number (HB,LB)                  xx xx (Hex) 9,10     Waiting time between activations (HB,LB)   xx xx (Hex) .        resolution 10ms/Bit, max 327 sec           . 11,12    3.Activation value (HB,LB)                 xx xx (Hex) 13,14    3.Actuator number (HB,LB)                  xx xx (Hex) 15,16    4.Activation value (HB,LB)                 xx xx (Hex) 17,18    4.Actuator number (HB,LB)                  xx xx (Hex) 19,20    Waiting time after 2.activation (HB,LB)    xx xx (Hex) .        resolution 10ms/Bit                        .    *************************************************************** ACTUATOR TABLE (see also Appendix A in specification): ***************************************************************  \|N°  \| Channel                     \| Resolution/Remarks (value) \| ---------------------------------------------------------------- 0000  No activation ---------------------------------------------------------------- 0022  Pump-motor relais             FFFF: on .     Return pump (MRA)             0000: off ---------------------------------------------------------------- 0028  Joint activation of all EVs   0 = not selected .     .                             1 = selected .     .                             Bit4: EV rear .     .                             Bit6: EV front .     .                             Bit8-15: Intensity in 1% per Bit .     .                                      00 = off .     .                                      01 - FF = on ---------------------------------------------------------------- 002A  Joint activation of all AVs   0 = not selected .     .                             1 = selected .     .                             Bit5: AV rear .     .                             Bit7: AV front .     .                             Bit8-15: Intensity in 1% per Bit .     .                                      00 = off .     .                                      01 - FF = on ---------------------------------------------------------------- 0030  EV front (EV-V)               0000: off .     .                             0001-FFF: on .     .                             Resolution: 1% per Bit ---------------------------------------------------------------- 0032  AV front (AV-V)               0000: off .     .                             0001-FFF: on .     .                             Resolution: 1% per Bit ---------------------------------------------------------------- 0038  EV rear (EV-H)                0000: off .     .                             0001-FFF: on .     .                             Resolution: 1% per Bit ---------------------------------------------------------------- 003A  AV rear (AV-H)                0000: off .     .                             0001-FFF: on .     .                             Resolution: 1% per Bit ---------------------------------------------------------------- 0050  USV rear (USV)                0000: off .     .                             0001-FFF: on .     .                             Resolution: 1% per Bit ---------------------------------------------------------------- 0054  HSV rear (HSV)                0000: off .     .                             0001-FFF: on .     .                             Resolution: 1% per Bit ---------------------------------------------------------------- 005E  Disable Valve-Protection      A5: disable shut down .     .                             00: enable shut down ---------------------------------------------------------------- 0064  Disable VR-shut down          A5: disable shut down .     .                             00: enable shut down ---------------------------------------------------------------- 0068  Disable abort of diagnosis    FF: disable shut down .     by speed limit                00: enable abort  Note: The AVs are used as a switch valve. When the activation value is not 0%, the software set it to 100% automatically |
...
<a id="job-steuern-usv"></a>
### STEUERN_USV

Activating USV KWP2000: $30 InputOutputControlByLocalId $04 Local ID actuator test $07 InputOutputControlParameter Implementation see Appendix B: Acutator Table Modus:        Default
...
<a id="job-steuern-hsv"></a>
### STEUERN_HSV

Activating HSV KWP2000: $30 InputOutputControlByLocalId $04 Local ID actuator test $07 InputOutputControlParameter Implementation see Appendix B: Acutator Table Modus:        Default
...
<a id="job-steuern-reset-variant"></a>
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_FZG_CODE_NR | int | Fahrzeugcodierung |
...
| STAT_BRAKE_SWITCH_FRONT | int | internal brake switch front |
| STAT_BRAKE_SWITCH_FRONT_FAILURE | int | internal failure brake switch front |
| STAT_BRAKE_SWITCH_REAR | int | internal brake switch rear |
| STAT_BRAKE_SWITCH_REAR_FAILURE | int | internal failure brake switch rear |
| _TEL_AUFTRAG | binary | Hex-Auftrag an SG |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| STAT_MASTERCYLINDER_FRONT_PRESSURE_VALUE | real | Only at Bosch 9M! Pressure MasterCylinder Front -42.5..435 [Bar] |
| STAT_MASTERCYLINDER_REAR_PRESSURE_VALUE | real | Only at Bosch 9M! Pressure MasterCylinder Rear -42.5..435 [Bar] |
| STAT_WHEELCYLINDER_FRONT_PRESSURE_VALUE | real | Only at Bosch 9M! Pressure WheelCylinder Front -42.5..435 [Bar] |
| STAT_WHEELCYLINDER_REAR_PRESSURE_VALUE | real | Only at Bosch 9M! Pressure WheelCylinder Rear -42.5..435 [Bar] |
| STAT_PRESSURE_UNIT | string | Only at Bosch 9M! Bar |
| _TEL_AUFTRAG | binary | Hex-Auftrag an SG |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |

<a id="job-status-can-input"></a>
### STATUS_CAN_INPUT
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_MILEAGE_VALUE | unsigned long | current mileage |
| STAT_MILEAGE_UNIT | string | km |
| STAT_ABS_OFF_SWITCH | int | ABS OFF switch status |
| STAT_ABS_OFF_SWITCH_TEXT | string | ABS OFF switch text |
| STAT_CHASSIS_VARIANT | unsigned char | variant of chassis |
| STAT_CHASSIS_VARIANT_TEXT | string | variant of chassis table Variante_ABS TEXT |
| STAT_VEHICLE_MODE | unsigned char | actual vehicle mode |
| STAT_VEHICLE_MODE_TEXT | string | actual vehicle mode table Vehicle_Mode TEXT |
| _TEL_AUFTRAG | binary | Hex-Auftrag an SG |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |

<a id="job-status-mu-jump-counter"></a>
...
| Name | Type | Comment |
| --- | --- | --- |
| STAT_MU_JUMP_FRONT_COUNTER | unsigned int | Mu-Jump counter of front wheel |
| STAT_MU_JUMP_REAR_COUNTER | unsigned int | Mu-Jump counter of rear wheel |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| _TEL_AUFTRAG | binary | Hex-Auftrag an SG |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
<a id="job-supplier-serial-number"></a>
### SUPPLIER_SERIAL_NUMBER

report supplier serialnumber KWP2000: $1A ReadECUIdentification $96 Robert Bosch ECU ID Modus  : Default
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| SERIALNUMBER | string | Bosch serialnumber complete string - 29 Bytes |
| PRODUCTION_PLANT | string | Bosch production plant - 3 Bytes |
| PRODUCTION_LINE | string | Bosch production line - 2 Bytes |
| PRODUCTION_POSITION | string | Bosch production position - 3 Bytes |
| PRODUCTION_COUNTER | string | Bosch production counter - 5 Bytes |
| PRODUCTION_YEAR | string | Bosch production year - 2 Bytes |
| PRODUCTION_MONTH | string | Bosch production month - 2 Bytes |
| PRODUCTION_DAY | string | Bosch production day - 2 Bytes |
| PARTNUMBER | string | Bosch partnumber - 10 Bytes |
| _TEL_AUFTRAG | binary | Hex-Auftrag an SG |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |

<a id="job-status-offset-pressure-sensor"></a>
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_MASTERCYLINDER_FRONT_VALUE | real | offest pressure sensor mastercylinder front -42.5..425 bar |
| STAT_MASTERCYLINDER_REAR_VALUE | real | offest pressure sensor mastercylinder rear -42.5..425 bar |
| STAT_WHEELCYLINDER_FRONT_VALUE | real | offest pressure sensor wheelcylinder front -42.5..425 bar |
| STAT_WHEELCYLINDER_REAR_VALUE | real | offest pressure sensor wheelcylinder rear -42.5..425 bar |
| STAT_OFFSET_PRESSURE_SENSOR_UNIT | string | bar |
| _TEL_AUFTRAG | binary | Hex-Auftrag an SG |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |

<a id="job-steuern-calibration-pressure-sensor"></a>
...
- [STATUS_EVACFILL_AND_REPAIRBLEEDING](#table-status-evacfill-and-repairbleeding) (6 × 2)
- [STATUS_WSS_MISS_TEETH](#table-status-wss-miss-teeth) (4 × 2)
- [VARIANTE_ABS](#table-variante-abs) (5 × 2)
- [VARIANTE_DATENSATZ](#table-variante-datensatz) (4 × 2)
- [VEHICLE_MODE](#table-vehicle-mode) (5 × 2)
...
| 0x63B9 | Umschaltventil USV |
| 0x63BA | Trennventil HSV |
| 0x63C1 | Steuergerät: interner Fehler |
| 0x630C | Sensorbox falsch montiert |
| 0x630D | Sensorbox Signale unplausibel |
| 0x630E | Sensorbox Signale ungueltig |
| 0x630F | Sensorbox Offset Fehler |
| 0x635C | Radschlupf |
| 0x638C | Pumpenmotor |
| 0x6324 | Impulsgeber vorn, Signal: unplausibel |
| 0x6322 | Impulsgeber vorn elektrisch defekt |
| 0x6340 | Impulsgeber hinten, Signal: unplausibel |
| 0x633E | Impulsgeber hinten elektrisch defekt |
| 0x635E | Impulsgeber Spannungsversorgung, Kurzschluss nach Batterie Plus |
| 0x6398 | Einlassventil vorn |
| 0x63B3 | Einlassventil hinten |
| 0x6371 | Drucksensor vorne unplausibel |
| 0x6370 | Drucksensor interne Spannungsversorgung defekt |
| 0x6372 | Drucksensor hinten unplausibel |
| 0x6365 | Drucksensor Steuerkreis vorne elektrisch defekt |
| 0x6361 | Drucksensor Steuerkreis vorne Offset Fehler |
| 0x6367 | Drucksensor Steuerkreis hinten elektrisch defekt |
| 0x6364 | Drucksensor Steuerkreis hinten Offset Fehler |
| 0x6368 | Drucksensor Radkreis vorne elektrisch defekt |
| 0x6363 | Drucksensor Radkreis vorne Offset Fehler |
| 0x6362 | Drucksensor Radkreis hinten elektrisch defekt |
| 0x6366 | Drucksensor Radkreis hinten Offset Fehler |
| 0xE933 | CAN Time Out ZFE_2 |
| 0xE904 | CAN Time Out SEB_ID1, SEB_ID4, SEB_ID7 |
| 0xE936 | CAN Time Out MOD_VEH |
| 0xE932 | CAN Time Out KOMBI_DATA |
| 0xE935 | CAN Time Out ENGINE_2 |
| 0xE934 | CAN Time Out ENGINE_1 |
| 0xE905 | CAN Nachrichtenlaengenueberwachung SEB_ID1, SEB_ID4, SEB_ID_7 |
| 0xE931 | CAN Nachricht Sendefehler |
| 0xE90A | CAN Nachricht SEB_ID7 Signalfehler |
| 0xE909 | CAN Nachricht SEB_ID4 Signalfehler |
| 0xE908 | CAN Nachricht SEB_ID1 Signalfehler |
| 0xE911 | CAN Initialisierung: fehlerhaft |
| 0xE907 | CAN Checksummen Fehler SEB_ID1, SEB_ID4, SEB_ID7 |
| 0xE938 | CAN Checksummen Fehler MOD_VEH |
| 0xE921 | CAN Bus Off |
| 0xE906 | CAN Alive Zaehler SEB_ID1, SEB_ID4, SEB_ID7 |
| 0xE937 | CAN Alive Zaehler Fehler MOD_VEH |
| 0xE930 | Brodnetz Unterspannung Kurzzeiterkennung |
| 0x63BD | Bordnetz Unterspannung |
| 0x63BE | Bordnetz Unterspannung Langzeiterkennung |
| 0x63BC | Bordnetz Ueberspannung |
| 0xE939 | Bordnetz Ueberspannung Kurzzeiterkennung |
| 0x639D | Auslassventil vorn |
| 0x63B8 | Auslassventil hinten |
| 0x63C2 | ABS-AUS-Taster Ueberwachung |
| 0x6341 | 100 Zaehne Sensorrad erkannt |
...
| 0xA1 | K46 |
| 0xA2 | K42 ohne ABS Pro |
| 0xA3 | K42 mit ABS Pro |
| 0xFF | nicht gültig |
...
| --- | --- |
| 0x01 | K46 |
| 0x02 | K42 ohne ABS Pro |
| 0x03 | K42 mit ABS Pro |
| 0xXY | ungültig |

<a id="table-vehicle-mode"></a>
### VEHICLE_MODE

Dimensions: 5 rows × 2 columns

| VEH_MODE | VEH_MODE_TEXT |
| --- | --- |
| 0x01 | Slick |
| 0x02 | Race |
| 0x03 | Sport |
