...
| COMMENT | Kennfeldprogrammierung DME DS2/Flash MDS43 |
| PACKAGE | N/A |
| SPRACHE | deutsch |
...
- [SPEICHER_SECURITY_KEYS_LESEN](#job-speicher-security-keys-lesen) - Security Keys auslesen
...
<a id="job-speicher-security-keys-lesen"></a>
### SPEICHER_SECURITY_KEYS_LESEN

Security Keys auslesen
...
| --- | --- | --- |
| JOB_STATUS | string | "OKAY", wenn fehlerfrei |
| STAT_SECURITY_KEYS_WERT | int | Status Security Keys Wert |
| STAT_SECURITY_KEYS_TEXT | string | Status Security Keys |
