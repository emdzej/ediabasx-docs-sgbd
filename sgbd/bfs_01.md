...
| Field | Value |
| --- | --- |
| ECU | Sitzsteuergeraet_Beifahrer |
...
| 0x02FF6E | DM_TEST_APPL,  DTC für Absicherung Funktion Diagnosemaster (wird durch Telegramm gesetzt, nie durch Funktionssoftware) | 0 |
...
| 0x802B92 | Motor SLV: Überlast oder Kurzschluss Motor oder Kurzschluss Low-Side nach Plus oder Kurzschluss High-Side nach Minus | 0 |
| 0x802B93 | Motor SLV: Kurzschluss Low-Side nach Minus oder Unterbrechung | 0 |
| 0x802B94 | Motor SHV: Überlast oder Kurzschluss Motor oder Kurzschluss Low-Side nach Plus oder Kurzschluss High-Side nach Minus | 0 |
| 0x802B95 | Motor SHV: Kurzschluss Low-Side nach Minus oder Unterbrechung | 0 |
| 0x802B96 | Motor LNV: Überlast oder Kurzschluss Motor oder Kurzschluss Low-Side nach Plus oder Kurzschluss High-Side nach Minus | 0 |
| 0x802B97 | Motor LNV: Kurzschluss Low-Side nach Minus oder Unterbrechung | 0 |
| 0x802B98 | Motor SNV: Überlast oder Kurzschluss Motor oder Kurzschluss Low-Side nach Plus oder Kurzschluss High-Side nach Minus | 0 |
| 0x802B99 | Motor SNV: Kurzschluss Low-Side nach Minus oder Unterbrechung | 0 |
| 0x802B9A | Motor KHV: Überlast oder Kurzschluss Motor oder Kurzschluss Low-Side nach Plus oder Kurzschluss High-Side nach Minus | 0 |
| 0x802B9B | Motor KHV: Kurzschluss Low-Side nach Minus oder Unterbrechung | 0 |
| 0x802B9C | Motor FEH: Überlast oder Kurzschluss Motor oder Kurzschluss Low-Side nach Plus oder Kurzschluss High-Side nach Minus | 0 |
| 0x802B9D | Motor FEH: Kurzschluss Low-Side nach Minus oder Unterbrechung | 0 |
| 0x802B9E | Motor STV: Überlast oder Kurzschluss Motor oder Kurzschluss Low-Side nach Plus oder Kurzschluss High-Side nach Minus | 0 |
| 0x802B9F | Motor STV: Kurzschluss Low-Side nach Minus oder Unterbrechung | 0 |
| 0x802BA0 | Motor LBV: Überlast oder Kurzschluss Motor oder Kurzschluss Low-Side nach Plus oder Kurzschluss High-Side nach Minus | 0 |
| 0x802BA1 | Motor LBV: Kurzschluss Low-Side nach Minus oder Unterbrechung | 0 |
| 0x802BA2 | Motor LKV: Überlast oder Kurzschluss Motor oder Kurzschluss Low-Side nach Plus oder Kurzschluss High-Side nach Minus | 0 |
...
| 0x802BC1 | Schalter FEH: Beidseitiger Kurzschluss nach Minus | 0 |
| 0x802BC2 | Schalter FEH: Schalter hängt | 0 |
...
| 0x802BD5 | Schalter LIN: Fehler Überlastung PWM (Beleuchtung) | 0 |
| 0x802BD6 | Schalter LIN: Fehler im EEPROM | 0 |
| 0x802C00 | Codierung: Steuergerät nicht codiert | 0 |
...
| 0x802C06 | Kennfeld Sitzbelüftung: eingeschränkte Verstellung wegen fehlender Kalibrierung (SLV hinten und/oder SNV oben) | 0 |
| 0x802C07 | Schalter LIN: Falsche Variant ID | 0 |
| 0x802C08 | PIA: Portierung wegen fehlender Kalibrierung eingeschränkt | 0 |
...
| 0x802C14 | Interner Steuergrätefehler: EEPROM defekt | 0 |
...
| 0x802C1A | Gepaeckraumschalter LIN: Schalter hängt | 0 |
| 0x802C1B | Gepaeckraumschalter LIN: Fehler Überlastung PWM (Beleuchtung) | 0 |
| 0x802C1C | Gepaeckraumschalter LIN: Fehler im EEPROM | 0 |
| 0x802C1D | Gepaeckraumschalter LIN: Falsche Variant ID | 0 |
| 0x802C1F | F07 Fondsitz Multifunktion : eingeschränkte Verstellung wegen fehlender Kalibrierung (SLV vorne und/oder LNV hinten) | 0 |
| 0x802C20 | Motor SLV: Abschaltung durch Motorverstellzeitbegrenzung | 0 |
| 0x802C21 | Motor SHV: Abschaltung durch Motorverstellzeitbegrenzung | 0 |
| 0x802C22 | Motor LNV: Abschaltung durch Motorverstellzeitbegrenzung | 0 |
| 0x802C23 | Motor SNV: Abschaltung durch Motorverstellzeitbegrenzung | 0 |
| 0x802C24 | Motor KHV: Abschaltung durch Motorverstellzeitbegrenzung | 0 |
| 0x802C25 | Motor FEH: Abschaltung durch Motorverstellzeitbegrenzung | 0 |
| 0x802C26 | Motor STV: Abschaltung durch Motorverstellzeitbegrenzung | 0 |
| 0x802C27 | Motor LBV: Abschaltung durch Motorverstellzeitbegrenzung | 0 |
| 0x802C28 | Motor LKV: Abschaltung durch Motorverstellzeitbegrenzung | 0 |
| 0x802C29 | Kennfeld Lehnenklappung: eingeschränkte Verstellung wegen fehlender Kalibrierung (SLV hinten und/oder SHV unten und/oder KHV unten) | 0 |
| 0x802C2A | Kennfeld KHV: eingeschränkte Verstellung wegen fehlender Kalibrierung (SHV unten und/oder LNV vorne und/oder KHV unten) | 0 |
| 0xE4840B | K-CAN Bus: Defekt erkannt | 0 |
| 0xE48414 | K-CAN: Control Module Bus OFF | 0 |
| 0xE48BFF | DM_TEST_COM,  DTC für Absicherung Funktion Diagnosemaster (wird durch Telegramm gesetzt, nie durch Funktionssoftware) | 0 |
| 0xE48C1E | LIN-Bus: Sitzverstellschalter antwortet nicht | 0 |
| 0xE48C1F | LIN-Bus: Gepaeckraumschalter antwortet nicht | 0 |
...
| 0x6E0012 | DM_Queue_FULL | 0 |
| 0x6E0013 | DM_Queue_DELETED | 0 |
