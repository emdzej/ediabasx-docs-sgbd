...
- [FORTTEXTE](#table-forttexte) (88 × 4)
...
- [RES_0XD3ED_D](#table-res-0xd3ed-d) (34 × 10)
...
| 0x8050EB | Verdeck, Inkrementalgeber Antrieb links VSW 12.3: Unterbrechung oder Kurzschluss | 0 | - |
| 0x8050EC | Verdeck, Inkrementalgeber Antrieb links VSW 12.3: Signal ungültig | 0 | - |
| 0x8050EE | Verdeck, Inkrementalgeber Antrieb rechts VSW 12.4: Unterbrechung oder Kurzschluss | 0 | - |
| 0x8050EF | Verdeck, Inkrementalgeber Antrieb rechts VSW 12.4: Signal ungültig | 0 | - |
...
| STAT_SENSOR_1_HAUPTANTRIEB_LINKS | 0-n | high | unsigned char | - | TAB_CV_SENSORIK_ZUSTAND | - | - | - | Sensorzustand (siehe TAB_CV_SENSORIK_ZUSTAND) |
| STAT_SENSOR_2_HAUPTANTRIEB_LINKS | 0-n | high | unsigned char | - | TAB_CV_SENSORIK_ZUSTAND | - | - | - | Sensorzustand (siehe TAB_CV_SENSORIK_ZUSTAND) |
| STAT_INK_POSITION_HAUPTANTRIEB_LINKS_WERT | - | high | signed int | - | - | 1.0 | 1.0 | 0.0 | Anzahl der Inkremente |
| STAT_SENSOR_1_HAUPTANTRIEB_RECHTS | 0-n | high | unsigned char | - | TAB_CV_SENSORIK_ZUSTAND | - | - | - | Sensorzustand (siehe TAB_CV_SENSORIK_ZUSTAND) |
| STAT_SENSOR_2_HAUPTANTRIEB_RECHTS | 0-n | high | unsigned char | - | TAB_CV_SENSORIK_ZUSTAND | - | - | - | Sensorzustand (siehe TAB_CV_SENSORIK_ZUSTAND) |
...
| STAT_SENSOR_RESERVE7 | 0-n | high | unsigned char | - | TAB_CV_SENSORIK_ZUSTAND | - | - | - | Sensorzustand (siehe TAB_CV_SENSORIK_ZUSTAND) |
...
| STAT_SENSOR_1_HAUPTANTRIEB_LINKS_LETZT_EIN | 0/1 | high | unsigned char | - | - | - | - | - | Schaltzustand des Sensors (0: nicht betätigt; 1: betätigt) |
| STAT_SENSOR_2_HAUPTANTRIEB_LINKS_LETZT_EIN | 0/1 | high | unsigned char | - | - | - | - | - | Schaltzustand des Sensors (0: nicht betätigt; 1: betätigt) |
| STAT_INK_POSITION_HAUPTANTRIEB_LINKS_LETZT_WERT | Inkremente | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Anzahl der Inkremente |
| STAT_SENSOR_1_HAUPTANTRIEB_RECHTS_LETZT_EIN | 0/1 | high | unsigned char | - | - | - | - | - | Schaltzustand des Sensors (0: nicht betätigt; 1: betätigt) |
| STAT_SENSOR_2_HAUPTANTRIEB_RECHTS_LETZT_EIN | 0/1 | high | unsigned char | - | - | - | - | - | Schaltzustand des Sensors (0: nicht betätigt; 1: betätigt) |
...
| STAT_SENSOR_1_HAUPTANTRIEB_LINKS_MAX_EIN | 0/1 | high | unsigned char | - | - | - | - | - | Schaltzustand des Sensors (0: nicht betätigt; 1: betätigt) |
| STAT_SENSOR_2_HAUPTANTRIEB_LINKS_MAX_EIN | 0/1 | high | unsigned char | - | - | - | - | - | Schaltzustand des Sensors (0: nicht betätigt; 1: betätigt) |
| STAT_INK_POSITION_HAUPTANTRIEB_LINKS_MAX_WERT | Inkremente | high | unsigned int | - | - | 1.0 | 1.0 | 0.0 | Anzahl der Inkremente |
| STAT_SENSOR_1_HAUPTANTRIEB_RECHTS_MAX_EIN | 0/1 | high | unsigned char | - | - | - | - | - | Schaltzustand des Sensors (0: nicht betätigt; 1: betätigt) |
| STAT_SENSOR_2_HAUPTANTRIEB_RECHTS_MAX_EIN | 0/1 | high | unsigned char | - | - | - | - | - | Schaltzustand des Sensors (0: nicht betätigt; 1: betätigt) |
