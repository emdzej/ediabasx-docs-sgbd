...
| Field | Value |
| --- | --- |
| ECU | L4 Single Slot MMC E70 |
| ORIGIN | BMW EI-41 Uwe Henkel |
| REVISION | 3.013 |
| AUTHOR | ALPINE_Electronics AOGE-MN Dünzelmann, ALPINE_Electronics AOEUR |
| COMMENT | N/A |
| PACKAGE | 1.45 |
| SPRACHE | deutsch |
...
- [STATUS_BETRIEBSSTUNDEN_LESEN](#job-status-betriebsstunden-lesen) - Auslesen des Betriebsstunden Zählers KWP2000: $21 ReadDataByLocalIdentifier $01 RLI Modus: Default
- [STATUS_CD_LADEZYCLEN_LESEN](#job-status-cd-ladezyclen-lesen) - Auslesen des CD ladezyclen Zählers KWP2000: $21 ReadDataByLocalIdentifier $02 RLI Modus: Default
- [STEUERN_EJECT_ALL](#job-steuern-eject-all) - Eject all media KWP2000: $31 StartRoutineByLocalIdentifier $20 Eject All Modus  : Default
- [SER_NR_DOM_LESEN](#job-ser-nr-dom-lesen) - Seriennummer 14-stellig lesen KWP2000: $21 ReadDataByLocalldentifier $E0 Local ID SER_NR_DOM Modus  : Default
- [STATUS_CD_MD_CDC](#job-status-cd-md-cdc) - Start ATC Diagnosis KWP2000: $21ReadDataByLocalIdentifier $0D Playback Quality Modus  : Default
- [STEUERN_TRACK_NUMBER](#job-steuern-track-number) - Set the track for ATS  Diagnosis KWP2000: $31 StartRoutineByLocalIdentifier $2A Set Track Modus  : Default
- [STEUERN_TRANSPORTMODE](#job-steuern-transportmode) - Set the internal transportmode KWP2000: $31 StartRoutineByLocalIdentifier $30 Set Transportmode Modus  : Default
...
<a id="job-status-betriebsstunden-lesen"></a>
### STATUS_BETRIEBSSTUNDEN_LESEN

Auslesen des Betriebsstunden Zählers KWP2000: $21 ReadDataByLocalIdentifier $01 RLI Modus: Default
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_STUNDEN | string | Betriebsstunden |
| STAT_EINHEIT | string | Einheit der Betriebsstunden |
| STAT_TEXT | string | Erklärung |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |

<a id="job-status-cd-ladezyclen-lesen"></a>
### STATUS_CD_LADEZYCLEN_LESEN

Auslesen des CD ladezyclen Zählers KWP2000: $21 ReadDataByLocalIdentifier $02 RLI Modus: Default
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| STAT_ZYCLEN | string | Ladezyclen |
| STAT_EINHEIT | string | Einheit der Ladezyclen |
| STAT_TEXT | string | Erklärung |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |

<a id="job-steuern-eject-all"></a>
### STEUERN_EJECT_ALL

Eject all media KWP2000: $31 StartRoutineByLocalIdentifier $20 Eject All Modus  : Default
...
Seriennummer 14-stellig lesen KWP2000: $21 ReadDataByLocalldentifier $E0 Local ID SER_NR_DOM Modus  : Default
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| SER_NR_DOM | string | Seriennummer 14-string |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |

<a id="job-status-cd-md-cdc"></a>
### STATUS_CD_MD_CDC

Start ATC Diagnosis KWP2000: $21ReadDataByLocalIdentifier $0D Playback Quality Modus  : Default
...
| --- | --- | --- |
| JOB_STATUS | string | OKAY, wenn fehlerfrei |
| STAT_DISC_IDENT | string | Test Disc ID Number |
| STAT_DIGITAL_PLAYBACK_QUALITY_WERT | unsigned char | Quality Value |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |

<a id="job-steuern-track-number"></a>
### STEUERN_TRACK_NUMBER

Set the track for ATS  Diagnosis KWP2000: $31 StartRoutineByLocalIdentifier $2A Set Track Modus  : Default

#### Arguments

| Name | Type | Comment |
| --- | --- | --- |
| ARG_TRACK | int | Tracknumber for the ATC diagnosis |
...
Set the internal transportmode KWP2000: $31 StartRoutineByLocalIdentifier $30 Set Transportmode Modus  : Default
...
- [UWSPANNUNG](#table-uwspannung) (4 × 2)
...
| 0x9D4B | Fehler Eject |
| 0x9D4C | Fehler ATC Diagnosis |
| 0x9D4D | Fehler Doppelte Einführung |
| 0x9D4E | Fehler Safety Mode |
| 0xD550 | Fehler Ring Diagnose |
| 0xD552 | Fehler Temp_Shut_Down |
| 0xD553 | Fehler MOST Channel |
| 0xD54E | Fehler_Light_Not_Off |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 0x01 | Logische Knoten Addresse | Hex | high | unsigned int | -- | 1 | 1 | 0 |
| 0x02 | FBlockID | Hex | -- | unsigned char | -- | 1 | 1 | 0 |
| 0x03 | InstID | Hex | -- | unsigned char | -- | 1 | 1 | 0 |
| 0x04 | FktID | Hex | high | unsigned int | -- | 1 | 1 | 0 |
| 0x05 | Diagnose Addresse | Hex | -- | unsigned char | -- | 1 | 1 | 0 |
| 0x06 | NPR | Hex | -- | unsigned char | -- | 1 | 1 | 0 |
| 0x10 | Spannung Kl30 | 0-n | -- | 0x03 | UWSpannung | - | - | - |
| 0x11 | Temperature Pickup | 0-n | -- | 0xFF | UWTemperatur | - | - | - |
| 0x12 | Disk Id Byte 1 - 4 | Hex | high | signed long | - | - | - | - |
| 0x13 | Disk Id Byte 5 - 6 | Hex | high | signed int | - | - | - | - |
| 0x14 | Disk Id Byte 7 | Hex | high | signed char | - | - | - | - |
| 0x15 | Quality Level | Hex | high | unsigned char | - | - | - | - |
| 0xXY | Unbekannted ext. Umweltbedingung | 1 | -- | unsigned char | -- | 1 | 1 | 0 |
...
| 0x10 | Spannung Kl30 | 0-n | -- | 0x03 | UWSpannung | - | - | - |
| 0x11 | Temperature Pickup | 0-n | -- | 0xFF | UWTemperatur | - | - | - |
| 0xXY | Unbekannte ext. Umweltbedingung | 1 | -- | unsigned char | -- | 1 | 1 | 0 |

<a id="table-uwspannung"></a>
### UWSPANNUNG
...
| WERT | UWTEXT |
| --- | --- |
| 0x00 | Normale Betriebsspannung 9 - 16 Volt |
| 0x01 | Überspannung &gt; 16 Volt |
| 0x02 | Unterspannung  &lt; 9 Volt |
| 0xXY | Betriebsspannung nicht definiert |
...
| 0xFE | -2 Grad C |
| 0xFF | -1 Grad C |
| 0xXY | Pickup Temperatur nicht definiert |
