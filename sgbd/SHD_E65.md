...
- [RESET_AUTH](#job-reset-auth) - Löschen der signalbezogenen Authentisierung KWP2000: $31 startRoutineByLocalIdentifier
- [DIAGNOSTIC_MOVE](#job-diagnostic-move) - Steuern den Motor KWP2000: $31 startRoutineByLocalIdentifier
- [ECU_RESET](#job-ecu-reset) - Reset der ECU KWP2000: $11 EcuReset Modus  : Default
- [STATUS_SCHALTER](#job-status-schalter) - Shhalterzustand abfragen KWP2000: $21 ReadDatabyLocalIdentifier
...
- [AIF_DEL](#job-aif-del) - Löschen des AIF Feldes auf Adresse 0x12 KWP 2000: $3D WriteMemoryByAddress Modus   : Default
...
| RESULT | string | Dekodierte Funktionswert |
...
| Name | Type | Comment |
| --- | --- | --- |
| STAT_SCHALTER_NR | int | STAT_SCHALTER_NR |
| STAT_SCHALTER_TEXT | string | table Schalter_Text NR TEXT |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| Name | Type | Comment |
| --- | --- | --- |
| STAT_TEMPWICKL_WERT | real | Ausgelesene Wert in GRAD CELSIUS |
| STAT_TEMPWICKL_EINH | string | Einheit (Grad Celsius) |
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| _TEL_ANTWORT | binary | Hex-Antwort von SG |
...
| JOB_STATUS | string | OKAY, wenn fehlerfrei table JobResult STATUS_TEXT |
| SERIENNUMMER | long |  |
| _TEL_ANTWORT | binary | Hex-Antwort von SG AIF schreiben |
...
- [IODIGITALSIGNALEFUERLESEN](#table-iodigitalsignalefuerlesen) (34 × 3)
- [IODIGITALSIGNALEFUERSCHREIBEN](#table-iodigitalsignalefuerschreiben) (2 × 3)
- [ANALOGSIGNALEFUERLESEN](#table-analogsignalefuerlesen) (4 × 7)
- [GERAET](#table-geraet) (3 × 3)
- [FUNKTION_CFL](#table-funktion-cfl) (128 × 3)
